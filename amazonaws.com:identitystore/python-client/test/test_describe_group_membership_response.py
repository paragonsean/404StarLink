...
class TestDescribeGroupMembershipResponse(unittest.TestCase):
    """DescribeGroupMembershipResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeGroupMembershipResponse:
        """Test DescribeGroupMembershipResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeGroupMembershipResponse`
        """
        model = DescribeGroupMembershipResponse()
        if include_optional:
            return DescribeGroupMembershipResponse(
                identity_store_id = None,
                membership_id = None,
                group_id = None,
                member_id = openapi_client.models.member_id.MemberId(
                    user_id = null, )
            )
        else:
            return DescribeGroupMembershipResponse(
    ...
    def testDescribeGroupMembershipResponse(self):
        """Test DescribeGroupMembershipResponse"""
