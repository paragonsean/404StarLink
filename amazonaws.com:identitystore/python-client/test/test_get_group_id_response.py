...
class TestGetGroupIdResponse(unittest.TestCase):
    """GetGroupIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGroupIdResponse:
        """Test GetGroupIdResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGroupIdResponse`
        """
        model = GetGroupIdResponse()
        if include_optional:
    ...
    def testGetGroupIdResponse(self):
        """Test GetGroupIdResponse"""
