...
class TestGetUserIdRequestAlternateIdentifier(unittest.TestCase):
    """GetUserIdRequestAlternateIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserIdRequestAlternateIdentifier:
        """Test GetUserIdRequestAlternateIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserIdRequestAlternateIdentifier`
        """
        model = GetUserIdRequestAlternateIdentifier()
        if include_optional:
            return GetUserIdRequestAlternateIdentifier(
                external_id = None,
    ...
    def testGetUserIdRequestAlternateIdentifier(self):
        """Test GetUserIdRequestAlternateIdentifier"""
