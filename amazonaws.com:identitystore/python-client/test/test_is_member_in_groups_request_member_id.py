...
class TestIsMemberInGroupsRequestMemberId(unittest.TestCase):
    """IsMemberInGroupsRequestMemberId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IsMemberInGroupsRequestMemberId:
        """Test IsMemberInGroupsRequestMemberId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IsMemberInGroupsRequestMemberId`
        """
        model = IsMemberInGroupsRequestMemberId()
        if include_optional:
            return IsMemberInGroupsRequestMemberId(
                user_id = None
            )
        else:
            return IsMemberInGroupsRequestMemberId(
    ...
    def testIsMemberInGroupsRequestMemberId(self):
        """Test IsMemberInGroupsRequestMemberId"""
