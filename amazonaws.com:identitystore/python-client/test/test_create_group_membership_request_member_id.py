...
class TestCreateGroupMembershipRequestMemberId(unittest.TestCase):
    """CreateGroupMembershipRequestMemberId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateGroupMembershipRequestMemberId:
        """Test CreateGroupMembershipRequestMemberId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateGroupMembershipRequestMemberId`
        """
        model = CreateGroupMembershipRequestMemberId()
        if include_optional:
            return CreateGroupMembershipRequestMemberId(
                user_id = None
            )
        else:
            return CreateGroupMembershipRequestMemberId(
    ...
    def testCreateGroupMembershipRequestMemberId(self):
        """Test CreateGroupMembershipRequestMemberId"""
