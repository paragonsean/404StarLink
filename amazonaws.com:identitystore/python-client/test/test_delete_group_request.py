...
class TestDeleteGroupRequest(unittest.TestCase):
    """DeleteGroupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteGroupRequest:
        """Test DeleteGroupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteGroupRequest`
        """
    ...
    def testDeleteGroupRequest(self):
        """Test DeleteGroupRequest"""
