...
class TestListGroupMembershipsForMemberResponse(unittest.TestCase):
    """ListGroupMembershipsForMemberResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGroupMembershipsForMemberResponse:
        """Test ListGroupMembershipsForMemberResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGroupMembershipsForMemberResponse`
        """
        model = ListGroupMembershipsForMemberResponse()
        if include_optional:
    ...
    def testListGroupMembershipsForMemberResponse(self):
        """Test ListGroupMembershipsForMemberResponse"""
