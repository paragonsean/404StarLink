...
class TestListGroupMembershipsForMemberRequest(unittest.TestCase):
    """ListGroupMembershipsForMemberRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGroupMembershipsForMemberRequest:
        """Test ListGroupMembershipsForMemberRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGroupMembershipsForMemberRequest`
        """
        model = ListGroupMembershipsForMemberRequest()
        if include_optional:
    ...
    def testListGroupMembershipsForMemberRequest(self):
        """Test ListGroupMembershipsForMemberRequest"""
