...
class TestGetUserIdResponse(unittest.TestCase):
    """GetUserIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetUserIdResponse:
        """Test GetUserIdResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetUserIdResponse`
        """
    ...
    def testGetUserIdResponse(self):
        """Test GetUserIdResponse"""
