...
class TestDeleteGroupMembershipRequest(unittest.TestCase):
    """DeleteGroupMembershipRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteGroupMembershipRequest:
        """Test DeleteGroupMembershipRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteGroupMembershipRequest`
        """
        model = DeleteGroupMembershipRequest()
        if include_optional:
    ...
    def testDeleteGroupMembershipRequest(self):
        """Test DeleteGroupMembershipRequest"""
