...
class TestGroupMembershipExistenceResult(unittest.TestCase):
    """GroupMembershipExistenceResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupMembershipExistenceResult:
        """Test GroupMembershipExistenceResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupMembershipExistenceResult`
        """
        model = GroupMembershipExistenceResult()
        if include_optional:
            return GroupMembershipExistenceResult(
                group_id = None,
                member_id = None,
                membership_exists = None
            )
        else:
            return GroupMembershipExistenceResult(
        )
    ...
    def testGroupMembershipExistenceResult(self):
        """Test GroupMembershipExistenceResult"""
