...
class TestGetGroupMembershipIdRequest(unittest.TestCase):
    """GetGroupMembershipIdRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGroupMembershipIdRequest:
        """Test GetGroupMembershipIdRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGroupMembershipIdRequest`
        """
        model = GetGroupMembershipIdRequest()
        if include_optional:
            return GetGroupMembershipIdRequest(
    ...
    def testGetGroupMembershipIdRequest(self):
        """Test GetGroupMembershipIdRequest"""
