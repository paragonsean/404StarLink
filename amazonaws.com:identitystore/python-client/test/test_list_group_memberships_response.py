...
class TestListGroupMembershipsResponse(unittest.TestCase):
    """ListGroupMembershipsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGroupMembershipsResponse:
        """Test ListGroupMembershipsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGroupMembershipsResponse`
        """
        model = ListGroupMembershipsResponse()
        if include_optional:
    ...
    def testListGroupMembershipsResponse(self):
        """Test ListGroupMembershipsResponse"""
