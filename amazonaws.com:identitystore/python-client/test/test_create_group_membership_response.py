...
class TestCreateGroupMembershipResponse(unittest.TestCase):
    """CreateGroupMembershipResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateGroupMembershipResponse:
        """Test CreateGroupMembershipResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateGroupMembershipResponse`
        """
        model = CreateGroupMembershipResponse()
        if include_optional:
    ...
    def testCreateGroupMembershipResponse(self):
        """Test CreateGroupMembershipResponse"""
