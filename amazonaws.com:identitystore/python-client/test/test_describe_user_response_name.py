...
class TestDescribeUserResponseName(unittest.TestCase):
    """DescribeUserResponseName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeUserResponseName:
        """Test DescribeUserResponseName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeUserResponseName`
        """
        model = DescribeUserResponseName()
        if include_optional:
            return DescribeUserResponseName(
                formatted = None,
                family_name = None,
                given_name = None,
                middle_name = None,
    ...
    def testDescribeUserResponseName(self):
        """Test DescribeUserResponseName"""
