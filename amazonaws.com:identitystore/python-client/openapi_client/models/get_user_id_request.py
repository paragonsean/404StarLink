...
class GetUserIdRequest(BaseModel):
    ...
    alternate_identifier: GetUserIdRequestAlternateIdentifier = Field(alias="AlternateIdentifier")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AlternateIdentifier": GetUserIdRequestAlternateIdentifier.from_dict(obj["AlternateIdentifier"]) if obj.get("AlternateIdentifier") is not None else None
        })
        return _obj
