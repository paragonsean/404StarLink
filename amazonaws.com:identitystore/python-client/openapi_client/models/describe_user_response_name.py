...
class DescribeUserResponseName(BaseModel):
    """
    DescribeUserResponseName
    """ # noqa: E501
    formatted: Optional[Any] = Field(default=None, alias="Formatted")
    family_name: Optional[Any] = Field(default=None, alias="FamilyName")
    given_name: Optional[Any] = Field(default=None, alias="GivenName")
    middle_name: Optional[Any] = Field(default=None, alias="MiddleName")
    honorific_prefix: Optional[Any] = Field(default=None, alias="HonorificPrefix")
    honorific_suffix: Optional[Any] = Field(default=None, alias="HonorificSuffix")
