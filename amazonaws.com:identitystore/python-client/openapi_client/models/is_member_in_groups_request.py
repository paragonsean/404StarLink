...
class IsMemberInGroupsRequest(BaseModel):
    ...
    member_id: IsMemberInGroupsRequestMemberId = Field(alias="MemberId")
    group_ids: Any = Field(alias="GroupIds")
    __properties: ClassVar[List[str]] = ["IdentityStoreId", "MemberId", "GroupIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "MemberId": IsMemberInGroupsRequestMemberId.from_dict(obj["MemberId"]) if obj.get("MemberId") is not None else None,
