...
class Address(BaseModel):
    ...
    locality: Optional[Any] = Field(default=None, alias="Locality")
    ...
    primary: Optional[Any] = Field(default=None, alias="Primary")
    __properties: ClassVar[List[str]] = ["StreetAddress", "Locality", "Region", "PostalCode", "Country", "Formatted", "Type", "Primary"]
