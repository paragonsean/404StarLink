...
class TestTaskrouterV1WorkspaceWorker(unittest.TestCase):
    """TaskrouterV1WorkspaceWorker unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskrouterV1WorkspaceWorker:
        """Test TaskrouterV1WorkspaceWorker
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskrouterV1WorkspaceWorker`
        """
        model = TaskrouterV1WorkspaceWorker()
        if include_optional:
    ...
    def testTaskrouterV1WorkspaceWorker(self):
        """Test TaskrouterV1WorkspaceWorker"""
