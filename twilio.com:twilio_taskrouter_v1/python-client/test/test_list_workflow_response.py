...
class TestListWorkflowResponse(unittest.TestCase):
    """ListWorkflowResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListWorkflowResponse:
        """Test ListWorkflowResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListWorkflowResponse`
        """
        ...
        if include_optional:
            return ListWorkflowResponse(
                meta = openapi_client.models.list_workspace_response_meta.ListWorkspaceResponse_meta(
                    ...
                    url = '', ),
                workflows = [
                    openapi_client.models.taskrouter/v1/workspace/workflow.taskrouter.v1.workspace.workflow(
    ...
    def testListWorkflowResponse(self):
        """Test ListWorkflowResponse"""
