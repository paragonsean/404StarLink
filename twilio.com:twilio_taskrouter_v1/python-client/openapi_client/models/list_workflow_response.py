...
class ListWorkflowResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["meta", "workflows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflows": [TaskrouterV1WorkspaceWorkflow.from_dict(_item) for _item in obj["workflows"]] if obj.get("workflows") is not None else None
        })
        return _obj
