...
class TaskrouterV1WorkspaceWorkerWorkerStatistics(BaseModel):
    ...
    cumulative: Optional[Any] = Field(default=None, description="An object that contains the cumulative statistics for the Worker.")
    realtime: Optional[Any] = Field(default=None, description="An object that contains the real-time statistics for the Worker.")
    url: Optional[StrictStr] = Field(default=None, description="The absolute URL of the Worker statistics resource.")
    ...
    __properties: ClassVar[List[str]] = ["account_sid", "cumulative", "realtime", "url", "workspace_sid"]
