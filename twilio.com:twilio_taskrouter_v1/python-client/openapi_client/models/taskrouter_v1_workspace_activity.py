...
class TaskrouterV1WorkspaceActivity(BaseModel):
    ...
    """ # noqa: E501
    account_sid: Optional[Annotated[str, Field(min_length=34, strict=True, max_length=34)]] = Field(default=None, description="The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Activity resource.")
    available: Optional[StrictBool] = Field(default=None, description="Whether the Worker is eligible to receive a Task when it occupies the Activity. A value of `true`, `1`, or `yes` indicates the Activity is available. All other values indicate that it is not. The value cannot be changed after the Activity is created.")
    ...
    friendly_name: Optional[StrictStr] = Field(default=None, description="The string that you assigned to describe the Activity resource.")
    links: Optional[Dict[str, Any]] = None
    sid: Optional[Annotated[str, Field(min_length=34, strict=True, max_length=34)]] = Field(default=None, description="The unique string that we created to identify the Activity resource.")
    url: Optional[StrictStr] = Field(default=None, description="The absolute URL of the Activity resource.")
    workspace_sid: Optional[Annotated[str, Field(min_length=34, strict=True, max_length=34)]] = Field(default=None, description="The SID of the Workspace that contains the Activity.")
    __properties: ClassVar[List[str]] = ["account_sid", "available", "date_created", "date_updated", "friendly_name", "links", "sid", "url", "workspace_sid"]
