...
class ListTaskReservationResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reservations": [TaskrouterV1WorkspaceTaskTaskReservation.from_dict(_item) for _item in obj["reservations"]] if obj.get("reservations") is not None else None
        })
        return _obj
