...
class TaskrouterV1WorkspaceWorkerWorkerInstanceStatistics(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="The absolute URL of the WorkerChannel statistics resource.")
    ...
    __properties: ClassVar[List[str]] = ["account_sid", "cumulative", "url", "worker_sid", "workspace_sid"]
