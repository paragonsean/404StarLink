...
class ListTaskResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["meta", "tasks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [TaskrouterV1WorkspaceTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
