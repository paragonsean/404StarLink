...
class TaskrouterV1WorkspaceWorkerWorkersRealTimeStatistics(BaseModel):
    ...
    total_workers: Optional[StrictInt] = Field(default=None, description="The total number of Workers.")
    ...
    __properties: ClassVar[List[str]] = ["account_sid", "activity_statistics", "total_workers", "url", "workspace_sid"]
