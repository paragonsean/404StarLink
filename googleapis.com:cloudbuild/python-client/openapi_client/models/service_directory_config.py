...
class ServiceDirectoryConfig(BaseModel):
    ...
    """ # noqa: E501
    service: Optional[StrictStr] = Field(default=None, description="The Service Directory service name. Format: projects/{project}/locations/{location}/namespaces/{namespace}/services/{service}.")
