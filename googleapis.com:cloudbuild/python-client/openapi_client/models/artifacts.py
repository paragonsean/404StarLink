...
class Artifacts(BaseModel):
    ...
    npm_packages: Optional[List[NpmPackage]] = Field(default=None, description="A list of npm packages to be uploaded to Artifact Registry upon successful completion of all build steps. Npm packages in the specified paths will be uploaded to the specified Artifact Registry repository using the builder service account's credentials. If any packages fail to be pushed, the build is marked FAILURE.", alias="npmPackages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "npmPackages": [NpmPackage.from_dict(_item) for _item in obj["npmPackages"]] if obj.get("npmPackages") is not None else None,
