...
class TestGitLabConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GitLabConfig:
        """Test GitLabConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GitLabConfig`
        """
        model = GitLabConfig()
        if include_optional:
            return GitLabConfig(
