...
public class AuthenticateCognitoActionConfig {
  ...
  public AuthenticateCognitoActionConfig() {
  }

  public AuthenticateCognitoActionConfig userPoolArn(String userPoolArn) {
  ...
  public AuthenticateCognitoActionConfig userPoolClientId(String userPoolClientId) {
  ...
  public AuthenticateCognitoActionConfig userPoolDomain(String userPoolDomain) {
  ...
  public AuthenticateCognitoActionConfig sessionCookieName(String sessionCookieName) {
  ...
  public AuthenticateCognitoActionConfig scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  public AuthenticateCognitoActionConfig sessionTimeout(Integer sessionTimeout) {
  ...
  public AuthenticateCognitoActionConfig authenticationRequestExtraParams(Map authenticationRequestExtraParams) {
  ...
  public AuthenticateCognitoActionConfig onUnauthenticatedRequest(AuthenticateCognitoActionConditionalBehaviorEnum onUnauthenticatedRequest) {
  ...
  public boolean equals(Object o) {
    ...
    AuthenticateCognitoActionConfig authenticateCognitoActionConfig = (AuthenticateCognitoActionConfig) o;
    return Objects.equals(this.userPoolArn, authenticateCognitoActionConfig.userPoolArn) &&
        Objects.equals(this.userPoolClientId, authenticateCognitoActionConfig.userPoolClientId) &&
        Objects.equals(this.userPoolDomain, authenticateCognitoActionConfig.userPoolDomain) &&
        Objects.equals(this.sessionCookieName, authenticateCognitoActionConfig.sessionCookieName) &&
        Objects.equals(this.scope, authenticateCognitoActionConfig.scope) &&
        Objects.equals(this.sessionTimeout, authenticateCognitoActionConfig.sessionTimeout) &&
        Objects.equals(this.authenticationRequestExtraParams, authenticateCognitoActionConfig.authenticationRequestExtraParams) &&
        Objects.equals(this.onUnauthenticatedRequest, authenticateCognitoActionConfig.onUnauthenticatedRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthenticateCognitoActionConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthenticateCognitoActionConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticateCognitoActionConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthenticateCognitoActionConfig is not found in the empty JSON string", AuthenticateCognitoActionConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthenticateCognitoActionConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AuthenticateCognitoActionConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthenticateCognitoActionConfig.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthenticateCognitoActionConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthenticateCognitoActionConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthenticateCognitoActionConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthenticateCognitoActionConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthenticateCognitoActionConfig>() {
           @Override
           public void write(JsonWriter out, AuthenticateCognitoActionConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthenticateCognitoActionConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthenticateCognitoActionConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthenticateCognitoActionConfig
   * @throws IOException if the JSON string is invalid with respect to AuthenticateCognitoActionConfig
   */
  public static AuthenticateCognitoActionConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthenticateCognitoActionConfig.class);
  }

  /**
   * Convert an instance of AuthenticateCognitoActionConfig to an JSON string
   *
   * @return JSON string
   */
