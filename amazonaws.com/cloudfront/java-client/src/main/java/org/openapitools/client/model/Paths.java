...
public class Paths {
  ...
  public Paths quantity(Integer quantity) {
  ...
  public boolean equals(Object o) {
    ...
    Paths paths = (Paths) o;
    return Objects.equals(this.quantity, paths.quantity) &&
        Objects.equals(this.items, paths.items);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : Paths.openapiRequiredFields) {
