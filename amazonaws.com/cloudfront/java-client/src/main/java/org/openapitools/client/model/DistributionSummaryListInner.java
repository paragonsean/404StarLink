...
public class DistributionSummaryListInner {
  ...
  public DistributionSummaryListInner aliases(CreateDistribution20181105RequestDistributionConfigAliases aliases) {
  ...
  public DistributionSummaryListInner originGroups(CreateDistribution20181105RequestDistributionConfigOriginGroups originGroups) {
  ...
  public DistributionSummaryListInner defaultCacheBehavior(CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior defaultCacheBehavior) {
  ...
  public DistributionSummaryListInner viewerCertificate(CreateDistribution20181105RequestDistributionConfigViewerCertificate viewerCertificate) {
  ...
  public DistributionSummaryListInner restrictions(CreateDistribution20181105RequestDistributionConfigRestrictions restrictions) {
