...
public class CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior {
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior() {
  }

  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior targetOriginId(String targetOriginId) {
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior forwardedValues(DefaultCacheBehaviorForwardedValues forwardedValues) {
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior trustedSigners(DefaultCacheBehaviorTrustedSigners trustedSigners) {
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior viewerProtocolPolicy(ViewerProtocolPolicy viewerProtocolPolicy) {
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior minTTL(Integer minTTL) {
    this.minTTL = minTTL;
    return this;
  }
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior allowedMethods(AllowedMethods allowedMethods) {
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior smoothStreaming(Boolean smoothStreaming) {
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior defaultTTL(Integer defaultTTL) {
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior maxTTL(Integer maxTTL) {
    this.maxTTL = maxTTL;
    return this;
  }
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior compress(Boolean compress) {
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior lambdaFunctionAssociations(DefaultCacheBehaviorLambdaFunctionAssociations lambdaFunctionAssociations) {
  ...
  public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior fieldLevelEncryptionId(String fieldLevelEncryptionId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior createDistribution20181105RequestDistributionConfigDefaultCacheBehavior = (CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior) o;
    return Objects.equals(this.targetOriginId, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.targetOriginId) &&
        Objects.equals(this.forwardedValues, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.forwardedValues) &&
        Objects.equals(this.trustedSigners, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.trustedSigners) &&
        Objects.equals(this.viewerProtocolPolicy, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.viewerProtocolPolicy) &&
        Objects.equals(this.minTTL, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.minTTL) &&
        Objects.equals(this.allowedMethods, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.allowedMethods) &&
        Objects.equals(this.smoothStreaming, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.smoothStreaming) &&
        Objects.equals(this.defaultTTL, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.defaultTTL) &&
        Objects.equals(this.maxTTL, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.maxTTL) &&
        Objects.equals(this.compress, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.compress) &&
        Objects.equals(this.lambdaFunctionAssociations, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.lambdaFunctionAssociations) &&
        Objects.equals(this.fieldLevelEncryptionId, createDistribution20181105RequestDistributionConfigDefaultCacheBehavior.fieldLevelEncryptionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior is not found in the empty JSON string", CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior>() {
           @Override
           public void write(JsonWriter out, CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior
   * @throws IOException if the JSON string is invalid with respect to CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior
   */
  public static CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior.class);
  }

  /**
   * Convert an instance of CreateDistribution20181105RequestDistributionConfigDefaultCacheBehavior to an JSON string
   *
   * @return JSON string
   */
