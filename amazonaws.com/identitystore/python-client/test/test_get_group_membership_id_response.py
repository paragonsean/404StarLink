...
class TestGetGroupMembershipIdResponse(unittest.TestCase):
    """GetGroupMembershipIdResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGroupMembershipIdResponse:
        """Test GetGroupMembershipIdResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGroupMembershipIdResponse`
        """
        model = GetGroupMembershipIdResponse()
        if include_optional:
    ...
    def testGetGroupMembershipIdResponse(self):
        """Test GetGroupMembershipIdResponse"""
