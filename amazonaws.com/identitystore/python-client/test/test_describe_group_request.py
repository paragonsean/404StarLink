...
class TestDescribeGroupRequest(unittest.TestCase):
    """DescribeGroupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeGroupRequest:
        """Test DescribeGroupRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeGroupRequest`
        """
    ...
    def testDescribeGroupRequest(self):
        """Test DescribeGroupRequest"""
