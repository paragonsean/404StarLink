...
class TestIsMemberInGroupsRequest(unittest.TestCase):
    """IsMemberInGroupsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IsMemberInGroupsRequest:
        """Test IsMemberInGroupsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IsMemberInGroupsRequest`
        """
        model = IsMemberInGroupsRequest()
        if include_optional:
    ...
    def testIsMemberInGroupsRequest(self):
        """Test IsMemberInGroupsRequest"""
