...
class TestCreateGroupMembershipRequest(unittest.TestCase):
    """CreateGroupMembershipRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateGroupMembershipRequest:
        """Test CreateGroupMembershipRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateGroupMembershipRequest`
        """
        model = CreateGroupMembershipRequest()
        if include_optional:
    ...
    def testCreateGroupMembershipRequest(self):
        """Test CreateGroupMembershipRequest"""
