...
class TestIsMemberInGroupsResponse(unittest.TestCase):
    """IsMemberInGroupsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IsMemberInGroupsResponse:
        """Test IsMemberInGroupsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IsMemberInGroupsResponse`
        """
        model = IsMemberInGroupsResponse()
        if include_optional:
    ...
    def testIsMemberInGroupsResponse(self):
        """Test IsMemberInGroupsResponse"""
