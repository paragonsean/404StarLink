...
class TestAlternateIdentifierUniqueAttribute(unittest.TestCase):
    """AlternateIdentifierUniqueAttribute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlternateIdentifierUniqueAttribute:
        """Test AlternateIdentifierUniqueAttribute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlternateIdentifierUniqueAttribute`
        """
        model = AlternateIdentifierUniqueAttribute()
        if include_optional:
            return AlternateIdentifierUniqueAttribute(
                attribute_path = None,
    ...
    def testAlternateIdentifierUniqueAttribute(self):
        """Test AlternateIdentifierUniqueAttribute"""
