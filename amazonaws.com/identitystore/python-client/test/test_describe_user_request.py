...
class TestDescribeUserRequest(unittest.TestCase):
    """DescribeUserRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeUserRequest:
        """Test DescribeUserRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeUserRequest`
        """
        model = DescribeUserRequest()
        if include_optional:
    ...
    def testDescribeUserRequest(self):
        """Test DescribeUserRequest"""
