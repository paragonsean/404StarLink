...
class TestAlternateIdentifierExternalId(unittest.TestCase):
    """AlternateIdentifierExternalId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlternateIdentifierExternalId:
        """Test AlternateIdentifierExternalId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlternateIdentifierExternalId`
        """
        model = AlternateIdentifierExternalId()
        if include_optional:
            return AlternateIdentifierExternalId(
                issuer = None,
                id = None
            )
        else:
    ...
    def testAlternateIdentifierExternalId(self):
        """Test AlternateIdentifierExternalId"""
