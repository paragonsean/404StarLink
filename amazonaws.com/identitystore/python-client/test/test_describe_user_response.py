...
class TestDescribeUserResponse(unittest.TestCase):
    """DescribeUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeUserResponse:
        """Test DescribeUserResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeUserResponse`
        """
        model = DescribeUserResponse()
        if include_optional:
    ...
    def testDescribeUserResponse(self):
        """Test DescribeUserResponse"""
