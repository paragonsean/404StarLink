...
class TestDescribeGroupMembershipRequest(unittest.TestCase):
    """DescribeGroupMembershipRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeGroupMembershipRequest:
        """Test DescribeGroupMembershipRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeGroupMembershipRequest`
        """
        model = DescribeGroupMembershipRequest()
        if include_optional:
            return DescribeGroupMembershipRequest(
    ...
    def testDescribeGroupMembershipRequest(self):
        """Test DescribeGroupMembershipRequest"""
