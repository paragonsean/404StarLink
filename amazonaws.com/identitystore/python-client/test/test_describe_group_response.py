...
class TestDescribeGroupResponse(unittest.TestCase):
    """DescribeGroupResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeGroupResponse:
        """Test DescribeGroupResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeGroupResponse`
        """
    ...
    def testDescribeGroupResponse(self):
        """Test DescribeGroupResponse"""
