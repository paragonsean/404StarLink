...
class TestListGroupsRequest(unittest.TestCase):
    """ListGroupsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListGroupsRequest:
        """Test ListGroupsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListGroupsRequest`
        """
    ...
    def testListGroupsRequest(self):
        """Test ListGroupsRequest"""
