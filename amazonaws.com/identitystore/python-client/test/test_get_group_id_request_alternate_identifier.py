...
class TestGetGroupIdRequestAlternateIdentifier(unittest.TestCase):
    """GetGroupIdRequestAlternateIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetGroupIdRequestAlternateIdentifier:
        """Test GetGroupIdRequestAlternateIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetGroupIdRequestAlternateIdentifier`
        """
        model = GetGroupIdRequestAlternateIdentifier()
        if include_optional:
            return GetGroupIdRequestAlternateIdentifier(
                external_id = None,
    ...
    def testGetGroupIdRequestAlternateIdentifier(self):
        """Test GetGroupIdRequestAlternateIdentifier"""
