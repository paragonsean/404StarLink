...
class DescribeGroupMembershipResponse(BaseModel):
    ...
    member_id: MemberId = Field(alias="MemberId")
    __properties: ClassVar[List[str]] = ["IdentityStoreId", "MembershipId", "GroupId", "MemberId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "MemberId": MemberId.from_dict(obj["MemberId"]) if obj.get("MemberId") is not None else None
        })
        return _obj
