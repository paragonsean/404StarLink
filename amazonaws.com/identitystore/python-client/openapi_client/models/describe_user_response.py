...
class DescribeUserResponse(BaseModel):
    ...
    external_ids: Optional[Any] = Field(default=None, alias="ExternalIds")
    name: Optional[DescribeUserResponseName] = Field(default=None, alias="Name")
    display_name: Optional[Any] = Field(default=None, alias="DisplayName")
    nick_name: Optional[Any] = Field(default=None, alias="NickName")
    profile_url: Optional[Any] = Field(default=None, alias="ProfileUrl")
    emails: Optional[Any] = Field(default=None, alias="Emails")
    addresses: Optional[Any] = Field(default=None, alias="Addresses")
    phone_numbers: Optional[Any] = Field(default=None, alias="PhoneNumbers")
    user_type: Optional[Any] = Field(default=None, alias="UserType")
    title: Optional[Any] = Field(default=None, alias="Title")
    preferred_language: Optional[Any] = Field(default=None, alias="PreferredLanguage")
    ...
    __properties: ClassVar[List[str]] = ["UserName", "UserId", "ExternalIds", "Name", "DisplayName", "NickName", "ProfileUrl", "Emails", "Addresses", "PhoneNumbers", "UserType", "Title", "PreferredLanguage", "Locale", "Timezone", "IdentityStoreId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Name": DescribeUserResponseName.from_dict(obj["Name"]) if obj.get("Name") is not None else None,
