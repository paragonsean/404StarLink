...
class GetGroupIdRequest(BaseModel):
    ...
    alternate_identifier: GetGroupIdRequestAlternateIdentifier = Field(alias="AlternateIdentifier")
    __properties: ClassVar[List[str]] = ["IdentityStoreId", "AlternateIdentifier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of alternate_identifier
        if self.alternate_identifier:
            _dict['AlternateIdentifier'] = self.alternate_identifier.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AlternateIdentifier": GetGroupIdRequestAlternateIdentifier.from_dict(obj["AlternateIdentifier"]) if obj.get("AlternateIdentifier") is not None else None
        })
        return _obj
