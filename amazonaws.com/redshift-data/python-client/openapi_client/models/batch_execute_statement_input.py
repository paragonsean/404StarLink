...
class BatchExecuteStatementInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ClientToken", "ClusterIdentifier", "Database", "DbUser", "SecretArn", "Sqls", "StatementName", "WithEvent", "WorkgroupName"]
