...
class TestExecuteStatementInput(unittest.TestCase):
    """ExecuteStatementInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteStatementInput:
        """Test ExecuteStatementInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteStatementInput`
        """
        model = ExecuteStatementInput()
        if include_optional:
    ...
    def testExecuteStatementInput(self):
        """Test ExecuteStatementInput"""
