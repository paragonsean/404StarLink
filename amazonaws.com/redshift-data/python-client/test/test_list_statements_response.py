...
class TestListStatementsResponse(unittest.TestCase):
    """ListStatementsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListStatementsResponse:
        """Test ListStatementsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListStatementsResponse`
        """
        model = ListStatementsResponse()
        if include_optional:
    ...
    def testListStatementsResponse(self):
        """Test ListStatementsResponse"""
