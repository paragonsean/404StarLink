...
class TestExecuteStatementOutput(unittest.TestCase):
    """ExecuteStatementOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExecuteStatementOutput:
        """Test ExecuteStatementOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExecuteStatementOutput`
        """
        model = ExecuteStatementOutput()
        if include_optional:
    ...
    def testExecuteStatementOutput(self):
        """Test ExecuteStatementOutput"""
