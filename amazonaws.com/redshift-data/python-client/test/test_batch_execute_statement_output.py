...
class TestBatchExecuteStatementOutput(unittest.TestCase):
    """BatchExecuteStatementOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchExecuteStatementOutput:
        """Test BatchExecuteStatementOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchExecuteStatementOutput`
        """
        model = BatchExecuteStatementOutput()
        if include_optional:
    ...
    def testBatchExecuteStatementOutput(self):
        """Test BatchExecuteStatementOutput"""
