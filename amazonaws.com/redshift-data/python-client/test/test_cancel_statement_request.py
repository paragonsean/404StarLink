...
class TestCancelStatementRequest(unittest.TestCase):
    """CancelStatementRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CancelStatementRequest:
        """Test CancelStatementRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelStatementRequest`
        """
        model = CancelStatementRequest()
        if include_optional:
    ...
    def testCancelStatementRequest(self):
        """Test CancelStatementRequest"""
