...
class TestGetStatementResultRequest(unittest.TestCase):
    """GetStatementResultRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStatementResultRequest:
        """Test GetStatementResultRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStatementResultRequest`
        """
    ...
    def testGetStatementResultRequest(self):
        """Test GetStatementResultRequest"""
