...
public class EndpointIBMDb2Settings {
  ...
  public EndpointIBMDb2Settings() {
  }

  public EndpointIBMDb2Settings databaseName(String databaseName) {
  ...
  public EndpointIBMDb2Settings password(String password) {
  ...
  public EndpointIBMDb2Settings port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public EndpointIBMDb2Settings serverName(String serverName) {
  ...
  public EndpointIBMDb2Settings setDataCaptureChanges(Boolean setDataCaptureChanges) {
  ...
  public EndpointIBMDb2Settings currentLsn(String currentLsn) {
  ...
  public EndpointIBMDb2Settings maxKBytesPerRead(Integer maxKBytesPerRead) {
  ...
  public EndpointIBMDb2Settings username(String username) {
  ...
  public EndpointIBMDb2Settings secretsManagerAccessRoleArn(String secretsManagerAccessRoleArn) {
  ...
  public EndpointIBMDb2Settings secretsManagerSecretId(String secretsManagerSecretId) {
  ...
  public boolean equals(Object o) {
    ...
    EndpointIBMDb2Settings endpointIBMDb2Settings = (EndpointIBMDb2Settings) o;
    return Objects.equals(this.databaseName, endpointIBMDb2Settings.databaseName) &&
        Objects.equals(this.password, endpointIBMDb2Settings.password) &&
        Objects.equals(this.port, endpointIBMDb2Settings.port) &&
        Objects.equals(this.serverName, endpointIBMDb2Settings.serverName) &&
        Objects.equals(this.setDataCaptureChanges, endpointIBMDb2Settings.setDataCaptureChanges) &&
        Objects.equals(this.currentLsn, endpointIBMDb2Settings.currentLsn) &&
        Objects.equals(this.maxKBytesPerRead, endpointIBMDb2Settings.maxKBytesPerRead) &&
        Objects.equals(this.username, endpointIBMDb2Settings.username) &&
        Objects.equals(this.secretsManagerAccessRoleArn, endpointIBMDb2Settings.secretsManagerAccessRoleArn) &&
        Objects.equals(this.secretsManagerSecretId, endpointIBMDb2Settings.secretsManagerSecretId);
  }
  ...
  public String toString() {
    ...
    sb.append("class EndpointIBMDb2Settings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EndpointIBMDb2Settings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointIBMDb2Settings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointIBMDb2Settings is not found in the empty JSON string", EndpointIBMDb2Settings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EndpointIBMDb2Settings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointIBMDb2Settings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointIBMDb2Settings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointIBMDb2Settings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointIBMDb2Settings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointIBMDb2Settings.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointIBMDb2Settings>() {
           @Override
           public void write(JsonWriter out, EndpointIBMDb2Settings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EndpointIBMDb2Settings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EndpointIBMDb2Settings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EndpointIBMDb2Settings
   * @throws IOException if the JSON string is invalid with respect to EndpointIBMDb2Settings
   */
  public static EndpointIBMDb2Settings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointIBMDb2Settings.class);
  }

  /**
   * Convert an instance of EndpointIBMDb2Settings to an JSON string
   *
   * @return JSON string
   */
