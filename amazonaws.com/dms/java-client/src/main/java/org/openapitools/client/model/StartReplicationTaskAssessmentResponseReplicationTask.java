...
public class StartReplicationTaskAssessmentResponseReplicationTask {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask() {
  }

  public StartReplicationTaskAssessmentResponseReplicationTask replicationTaskIdentifier(String replicationTaskIdentifier) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask sourceEndpointArn(String sourceEndpointArn) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask targetEndpointArn(String targetEndpointArn) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask replicationInstanceArn(String replicationInstanceArn) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask migrationType(MigrationTypeValue migrationType) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask tableMappings(String tableMappings) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask replicationTaskSettings(String replicationTaskSettings) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask status(String status) {
    this.status = status;
    return this;
  }
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask lastFailureMessage(String lastFailureMessage) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask stopReason(String stopReason) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask replicationTaskCreationDate(OffsetDateTime replicationTaskCreationDate) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask replicationTaskStartDate(OffsetDateTime replicationTaskStartDate) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask cdcStartPosition(String cdcStartPosition) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask cdcStopPosition(String cdcStopPosition) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask recoveryCheckpoint(String recoveryCheckpoint) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask replicationTaskArn(String replicationTaskArn) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask replicationTaskStats(ReplicationTaskReplicationTaskStats replicationTaskStats) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask taskData(String taskData) {
  ...
  public StartReplicationTaskAssessmentResponseReplicationTask targetReplicationInstanceArn(String targetReplicationInstanceArn) {
  ...
  public boolean equals(Object o) {
    ...
    StartReplicationTaskAssessmentResponseReplicationTask startReplicationTaskAssessmentResponseReplicationTask = (StartReplicationTaskAssessmentResponseReplicationTask) o;
    return Objects.equals(this.replicationTaskIdentifier, startReplicationTaskAssessmentResponseReplicationTask.replicationTaskIdentifier) &&
        Objects.equals(this.sourceEndpointArn, startReplicationTaskAssessmentResponseReplicationTask.sourceEndpointArn) &&
        Objects.equals(this.targetEndpointArn, startReplicationTaskAssessmentResponseReplicationTask.targetEndpointArn) &&
        Objects.equals(this.replicationInstanceArn, startReplicationTaskAssessmentResponseReplicationTask.replicationInstanceArn) &&
        Objects.equals(this.migrationType, startReplicationTaskAssessmentResponseReplicationTask.migrationType) &&
        Objects.equals(this.tableMappings, startReplicationTaskAssessmentResponseReplicationTask.tableMappings) &&
        Objects.equals(this.replicationTaskSettings, startReplicationTaskAssessmentResponseReplicationTask.replicationTaskSettings) &&
        Objects.equals(this.status, startReplicationTaskAssessmentResponseReplicationTask.status) &&
        Objects.equals(this.lastFailureMessage, startReplicationTaskAssessmentResponseReplicationTask.lastFailureMessage) &&
        Objects.equals(this.stopReason, startReplicationTaskAssessmentResponseReplicationTask.stopReason) &&
        Objects.equals(this.replicationTaskCreationDate, startReplicationTaskAssessmentResponseReplicationTask.replicationTaskCreationDate) &&
        Objects.equals(this.replicationTaskStartDate, startReplicationTaskAssessmentResponseReplicationTask.replicationTaskStartDate) &&
        Objects.equals(this.cdcStartPosition, startReplicationTaskAssessmentResponseReplicationTask.cdcStartPosition) &&
        Objects.equals(this.cdcStopPosition, startReplicationTaskAssessmentResponseReplicationTask.cdcStopPosition) &&
        Objects.equals(this.recoveryCheckpoint, startReplicationTaskAssessmentResponseReplicationTask.recoveryCheckpoint) &&
        Objects.equals(this.replicationTaskArn, startReplicationTaskAssessmentResponseReplicationTask.replicationTaskArn) &&
        Objects.equals(this.replicationTaskStats, startReplicationTaskAssessmentResponseReplicationTask.replicationTaskStats) &&
        Objects.equals(this.taskData, startReplicationTaskAssessmentResponseReplicationTask.taskData) &&
        Objects.equals(this.targetReplicationInstanceArn, startReplicationTaskAssessmentResponseReplicationTask.targetReplicationInstanceArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartReplicationTaskAssessmentResponseReplicationTask {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartReplicationTaskAssessmentResponseReplicationTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartReplicationTaskAssessmentResponseReplicationTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartReplicationTaskAssessmentResponseReplicationTask is not found in the empty JSON string", StartReplicationTaskAssessmentResponseReplicationTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartReplicationTaskAssessmentResponseReplicationTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartReplicationTaskAssessmentResponseReplicationTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartReplicationTaskAssessmentResponseReplicationTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartReplicationTaskAssessmentResponseReplicationTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartReplicationTaskAssessmentResponseReplicationTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartReplicationTaskAssessmentResponseReplicationTask.class));

       return (TypeAdapter<T>) new TypeAdapter<StartReplicationTaskAssessmentResponseReplicationTask>() {
           @Override
           public void write(JsonWriter out, StartReplicationTaskAssessmentResponseReplicationTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartReplicationTaskAssessmentResponseReplicationTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartReplicationTaskAssessmentResponseReplicationTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartReplicationTaskAssessmentResponseReplicationTask
   * @throws IOException if the JSON string is invalid with respect to StartReplicationTaskAssessmentResponseReplicationTask
   */
  public static StartReplicationTaskAssessmentResponseReplicationTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartReplicationTaskAssessmentResponseReplicationTask.class);
  }

  /**
   * Convert an instance of StartReplicationTaskAssessmentResponseReplicationTask to an JSON string
   *
   * @return JSON string
   */
