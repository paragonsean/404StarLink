...
public class ModifyEndpointMessageMongoDbSettings {
  ...
  public ModifyEndpointMessageMongoDbSettings() {
  }

  public ModifyEndpointMessageMongoDbSettings username(String username) {
  ...
  public ModifyEndpointMessageMongoDbSettings password(String password) {
  ...
  public ModifyEndpointMessageMongoDbSettings serverName(String serverName) {
  ...
  public ModifyEndpointMessageMongoDbSettings port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public ModifyEndpointMessageMongoDbSettings databaseName(String databaseName) {
  ...
  public ModifyEndpointMessageMongoDbSettings authType(AuthTypeValue authType) {
  ...
  public ModifyEndpointMessageMongoDbSettings authMechanism(AuthMechanismValue authMechanism) {
  ...
  public ModifyEndpointMessageMongoDbSettings nestingLevel(NestingLevelValue nestingLevel) {
  ...
  public ModifyEndpointMessageMongoDbSettings extractDocId(String extractDocId) {
  ...
  public ModifyEndpointMessageMongoDbSettings docsToInvestigate(String docsToInvestigate) {
  ...
  public ModifyEndpointMessageMongoDbSettings authSource(String authSource) {
  ...
  public ModifyEndpointMessageMongoDbSettings kmsKeyId(String kmsKeyId) {
  ...
  public ModifyEndpointMessageMongoDbSettings secretsManagerAccessRoleArn(String secretsManagerAccessRoleArn) {
  ...
  public ModifyEndpointMessageMongoDbSettings secretsManagerSecretId(String secretsManagerSecretId) {
  ...
  public boolean equals(Object o) {
    ...
    ModifyEndpointMessageMongoDbSettings modifyEndpointMessageMongoDbSettings = (ModifyEndpointMessageMongoDbSettings) o;
    return Objects.equals(this.username, modifyEndpointMessageMongoDbSettings.username) &&
        Objects.equals(this.password, modifyEndpointMessageMongoDbSettings.password) &&
        Objects.equals(this.serverName, modifyEndpointMessageMongoDbSettings.serverName) &&
        Objects.equals(this.port, modifyEndpointMessageMongoDbSettings.port) &&
        Objects.equals(this.databaseName, modifyEndpointMessageMongoDbSettings.databaseName) &&
        Objects.equals(this.authType, modifyEndpointMessageMongoDbSettings.authType) &&
        Objects.equals(this.authMechanism, modifyEndpointMessageMongoDbSettings.authMechanism) &&
        Objects.equals(this.nestingLevel, modifyEndpointMessageMongoDbSettings.nestingLevel) &&
        Objects.equals(this.extractDocId, modifyEndpointMessageMongoDbSettings.extractDocId) &&
        Objects.equals(this.docsToInvestigate, modifyEndpointMessageMongoDbSettings.docsToInvestigate) &&
        Objects.equals(this.authSource, modifyEndpointMessageMongoDbSettings.authSource) &&
        Objects.equals(this.kmsKeyId, modifyEndpointMessageMongoDbSettings.kmsKeyId) &&
        Objects.equals(this.secretsManagerAccessRoleArn, modifyEndpointMessageMongoDbSettings.secretsManagerAccessRoleArn) &&
        Objects.equals(this.secretsManagerSecretId, modifyEndpointMessageMongoDbSettings.secretsManagerSecretId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModifyEndpointMessageMongoDbSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModifyEndpointMessageMongoDbSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyEndpointMessageMongoDbSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModifyEndpointMessageMongoDbSettings is not found in the empty JSON string", ModifyEndpointMessageMongoDbSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyEndpointMessageMongoDbSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifyEndpointMessageMongoDbSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModifyEndpointMessageMongoDbSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModifyEndpointMessageMongoDbSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModifyEndpointMessageMongoDbSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModifyEndpointMessageMongoDbSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<ModifyEndpointMessageMongoDbSettings>() {
           @Override
           public void write(JsonWriter out, ModifyEndpointMessageMongoDbSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModifyEndpointMessageMongoDbSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModifyEndpointMessageMongoDbSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModifyEndpointMessageMongoDbSettings
   * @throws IOException if the JSON string is invalid with respect to ModifyEndpointMessageMongoDbSettings
   */
  public static ModifyEndpointMessageMongoDbSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModifyEndpointMessageMongoDbSettings.class);
  }

  /**
   * Convert an instance of ModifyEndpointMessageMongoDbSettings to an JSON string
   *
   * @return JSON string
   */
