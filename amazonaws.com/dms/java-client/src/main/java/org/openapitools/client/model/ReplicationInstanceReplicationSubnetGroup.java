...
public class ReplicationInstanceReplicationSubnetGroup {
  ...
  public ReplicationInstanceReplicationSubnetGroup() {
  }

  public ReplicationInstanceReplicationSubnetGroup replicationSubnetGroupIdentifier(String replicationSubnetGroupIdentifier) {
  ...
  public ReplicationInstanceReplicationSubnetGroup replicationSubnetGroupDescription(String replicationSubnetGroupDescription) {
  ...
  public ReplicationInstanceReplicationSubnetGroup vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public ReplicationInstanceReplicationSubnetGroup subnetGroupStatus(String subnetGroupStatus) {
  ...
  public ReplicationInstanceReplicationSubnetGroup subnets(List subnets) {
  ...
  public ReplicationInstanceReplicationSubnetGroup supportedNetworkTypes(List supportedNetworkTypes) {
  ...
  public boolean equals(Object o) {
    ...
    ReplicationInstanceReplicationSubnetGroup replicationInstanceReplicationSubnetGroup = (ReplicationInstanceReplicationSubnetGroup) o;
    return Objects.equals(this.replicationSubnetGroupIdentifier, replicationInstanceReplicationSubnetGroup.replicationSubnetGroupIdentifier) &&
        Objects.equals(this.replicationSubnetGroupDescription, replicationInstanceReplicationSubnetGroup.replicationSubnetGroupDescription) &&
        Objects.equals(this.vpcId, replicationInstanceReplicationSubnetGroup.vpcId) &&
        Objects.equals(this.subnetGroupStatus, replicationInstanceReplicationSubnetGroup.subnetGroupStatus) &&
        Objects.equals(this.subnets, replicationInstanceReplicationSubnetGroup.subnets) &&
        Objects.equals(this.supportedNetworkTypes, replicationInstanceReplicationSubnetGroup.supportedNetworkTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReplicationInstanceReplicationSubnetGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplicationInstanceReplicationSubnetGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplicationInstanceReplicationSubnetGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplicationInstanceReplicationSubnetGroup is not found in the empty JSON string", ReplicationInstanceReplicationSubnetGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplicationInstanceReplicationSubnetGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplicationInstanceReplicationSubnetGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplicationInstanceReplicationSubnetGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplicationInstanceReplicationSubnetGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplicationInstanceReplicationSubnetGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplicationInstanceReplicationSubnetGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplicationInstanceReplicationSubnetGroup>() {
           @Override
           public void write(JsonWriter out, ReplicationInstanceReplicationSubnetGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplicationInstanceReplicationSubnetGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplicationInstanceReplicationSubnetGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplicationInstanceReplicationSubnetGroup
   * @throws IOException if the JSON string is invalid with respect to ReplicationInstanceReplicationSubnetGroup
   */
  public static ReplicationInstanceReplicationSubnetGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplicationInstanceReplicationSubnetGroup.class);
  }

  /**
   * Convert an instance of ReplicationInstanceReplicationSubnetGroup to an JSON string
   *
   * @return JSON string
   */
