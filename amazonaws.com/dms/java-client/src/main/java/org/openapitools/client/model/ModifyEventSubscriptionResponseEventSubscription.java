...
public class ModifyEventSubscriptionResponseEventSubscription {
  ...
  public ModifyEventSubscriptionResponseEventSubscription() {
  }

  public ModifyEventSubscriptionResponseEventSubscription customerAwsId(String customerAwsId) {
  ...
  public ModifyEventSubscriptionResponseEventSubscription custSubscriptionId(String custSubscriptionId) {
  ...
  public ModifyEventSubscriptionResponseEventSubscription snsTopicArn(String snsTopicArn) {
  ...
  public ModifyEventSubscriptionResponseEventSubscription status(String status) {
    this.status = status;
    return this;
  }
  ...
  public ModifyEventSubscriptionResponseEventSubscription subscriptionCreationTime(String subscriptionCreationTime) {
  ...
  public ModifyEventSubscriptionResponseEventSubscription sourceType(String sourceType) {
  ...
  public ModifyEventSubscriptionResponseEventSubscription sourceIdsList(List sourceIdsList) {
  ...
  public ModifyEventSubscriptionResponseEventSubscription eventCategoriesList(List eventCategoriesList) {
  ...
  public ModifyEventSubscriptionResponseEventSubscription enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    ModifyEventSubscriptionResponseEventSubscription modifyEventSubscriptionResponseEventSubscription = (ModifyEventSubscriptionResponseEventSubscription) o;
    return Objects.equals(this.customerAwsId, modifyEventSubscriptionResponseEventSubscription.customerAwsId) &&
        Objects.equals(this.custSubscriptionId, modifyEventSubscriptionResponseEventSubscription.custSubscriptionId) &&
        Objects.equals(this.snsTopicArn, modifyEventSubscriptionResponseEventSubscription.snsTopicArn) &&
        Objects.equals(this.status, modifyEventSubscriptionResponseEventSubscription.status) &&
        Objects.equals(this.subscriptionCreationTime, modifyEventSubscriptionResponseEventSubscription.subscriptionCreationTime) &&
        Objects.equals(this.sourceType, modifyEventSubscriptionResponseEventSubscription.sourceType) &&
        Objects.equals(this.sourceIdsList, modifyEventSubscriptionResponseEventSubscription.sourceIdsList) &&
        Objects.equals(this.eventCategoriesList, modifyEventSubscriptionResponseEventSubscription.eventCategoriesList) &&
        Objects.equals(this.enabled, modifyEventSubscriptionResponseEventSubscription.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModifyEventSubscriptionResponseEventSubscription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModifyEventSubscriptionResponseEventSubscription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyEventSubscriptionResponseEventSubscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModifyEventSubscriptionResponseEventSubscription is not found in the empty JSON string", ModifyEventSubscriptionResponseEventSubscription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyEventSubscriptionResponseEventSubscription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifyEventSubscriptionResponseEventSubscription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModifyEventSubscriptionResponseEventSubscription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModifyEventSubscriptionResponseEventSubscription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModifyEventSubscriptionResponseEventSubscription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModifyEventSubscriptionResponseEventSubscription.class));

       return (TypeAdapter<T>) new TypeAdapter<ModifyEventSubscriptionResponseEventSubscription>() {
           @Override
           public void write(JsonWriter out, ModifyEventSubscriptionResponseEventSubscription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModifyEventSubscriptionResponseEventSubscription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModifyEventSubscriptionResponseEventSubscription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModifyEventSubscriptionResponseEventSubscription
   * @throws IOException if the JSON string is invalid with respect to ModifyEventSubscriptionResponseEventSubscription
   */
  public static ModifyEventSubscriptionResponseEventSubscription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModifyEventSubscriptionResponseEventSubscription.class);
  }

  /**
   * Convert an instance of ModifyEventSubscriptionResponseEventSubscription to an JSON string
   *
   * @return JSON string
   */
