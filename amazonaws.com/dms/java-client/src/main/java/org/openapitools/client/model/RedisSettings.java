...
public class RedisSettings {
  ...
  public RedisSettings serverName(String serverName) {
  ...
  public RedisSettings port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public RedisSettings sslSecurityProtocol(SslSecurityProtocolValue sslSecurityProtocol) {
  ...
  public RedisSettings authType(RedisAuthTypeValue authType) {
  ...
  public RedisSettings authUserName(String authUserName) {
  ...
  public RedisSettings authPassword(String authPassword) {
  ...
  public RedisSettings sslCaCertificateArn(String sslCaCertificateArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.serverName, redisSettings.serverName) &&
        Objects.equals(this.port, redisSettings.port) &&
        Objects.equals(this.sslSecurityProtocol, redisSettings.sslSecurityProtocol) &&
        Objects.equals(this.authType, redisSettings.authType) &&
        Objects.equals(this.authUserName, redisSettings.authUserName) &&
        Objects.equals(this.authPassword, redisSettings.authPassword) &&
        Objects.equals(this.sslCaCertificateArn, redisSettings.sslCaCertificateArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RedisSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedisSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedisSettings is not found in the empty JSON string", RedisSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedisSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedisSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RedisSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedisSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedisSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedisSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedisSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<RedisSettings>() {
           @Override
           public void write(JsonWriter out, RedisSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RedisSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RedisSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RedisSettings
   * @throws IOException if the JSON string is invalid with respect to RedisSettings
   */
  public static RedisSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedisSettings.class);
  }

  /**
   * Convert an instance of RedisSettings to an JSON string
   *
   * @return JSON string
   */
