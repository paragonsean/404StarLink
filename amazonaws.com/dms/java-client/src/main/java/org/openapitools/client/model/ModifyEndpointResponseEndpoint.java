...
public class ModifyEndpointResponseEndpoint {
  ...
  public ModifyEndpointResponseEndpoint() {
  }

  public ModifyEndpointResponseEndpoint endpointIdentifier(String endpointIdentifier) {
  ...
  public ModifyEndpointResponseEndpoint endpointType(ReplicationEndpointTypeValue endpointType) {
  ...
  public ModifyEndpointResponseEndpoint engineName(String engineName) {
  ...
  public ModifyEndpointResponseEndpoint engineDisplayName(String engineDisplayName) {
  ...
  public ModifyEndpointResponseEndpoint username(String username) {
  ...
  public ModifyEndpointResponseEndpoint serverName(String serverName) {
  ...
  public ModifyEndpointResponseEndpoint port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public ModifyEndpointResponseEndpoint databaseName(String databaseName) {
  ...
  public ModifyEndpointResponseEndpoint extraConnectionAttributes(String extraConnectionAttributes) {
  ...
  public ModifyEndpointResponseEndpoint status(String status) {
    this.status = status;
    return this;
  }
  ...
  public ModifyEndpointResponseEndpoint kmsKeyId(String kmsKeyId) {
  ...
  public ModifyEndpointResponseEndpoint endpointArn(String endpointArn) {
  ...
  public ModifyEndpointResponseEndpoint certificateArn(String certificateArn) {
  ...
  public ModifyEndpointResponseEndpoint sslMode(DmsSslModeValue sslMode) {
  ...
  public ModifyEndpointResponseEndpoint serviceAccessRoleArn(String serviceAccessRoleArn) {
  ...
  public ModifyEndpointResponseEndpoint externalTableDefinition(String externalTableDefinition) {
  ...
  public ModifyEndpointResponseEndpoint externalId(String externalId) {
  ...
  public ModifyEndpointResponseEndpoint dynamoDbSettings(EndpointDynamoDbSettings dynamoDbSettings) {
  ...
  public ModifyEndpointResponseEndpoint s3Settings(EndpointS3Settings s3Settings) {
  ...
  public ModifyEndpointResponseEndpoint dmsTransferSettings(EndpointDmsTransferSettings dmsTransferSettings) {
  ...
  public ModifyEndpointResponseEndpoint mongoDbSettings(EndpointMongoDbSettings mongoDbSettings) {
  ...
  public ModifyEndpointResponseEndpoint kinesisSettings(EndpointKinesisSettings kinesisSettings) {
  ...
  public ModifyEndpointResponseEndpoint kafkaSettings(EndpointKafkaSettings kafkaSettings) {
  ...
  public ModifyEndpointResponseEndpoint elasticsearchSettings(EndpointElasticsearchSettings elasticsearchSettings) {
  ...
  public ModifyEndpointResponseEndpoint neptuneSettings(EndpointNeptuneSettings neptuneSettings) {
  ...
  public ModifyEndpointResponseEndpoint redshiftSettings(EndpointRedshiftSettings redshiftSettings) {
  ...
  public ModifyEndpointResponseEndpoint postgreSQLSettings(EndpointPostgreSQLSettings postgreSQLSettings) {
  ...
  public ModifyEndpointResponseEndpoint mySQLSettings(EndpointMySQLSettings mySQLSettings) {
  ...
  public ModifyEndpointResponseEndpoint oracleSettings(EndpointOracleSettings oracleSettings) {
  ...
  public ModifyEndpointResponseEndpoint sybaseSettings(EndpointSybaseSettings sybaseSettings) {
  ...
  public ModifyEndpointResponseEndpoint microsoftSQLServerSettings(EndpointMicrosoftSQLServerSettings microsoftSQLServerSettings) {
  ...
  public ModifyEndpointResponseEndpoint ibMDb2Settings(EndpointIBMDb2Settings ibMDb2Settings) {
  ...
  public ModifyEndpointResponseEndpoint docDbSettings(DocDbSettings docDbSettings) {
  ...
  public ModifyEndpointResponseEndpoint redisSettings(EndpointRedisSettings redisSettings) {
  ...
  public ModifyEndpointResponseEndpoint gcpMySQLSettings(CreateEndpointMessageGcpMySQLSettings gcpMySQLSettings) {
  ...
  public boolean equals(Object o) {
    ...
    ModifyEndpointResponseEndpoint modifyEndpointResponseEndpoint = (ModifyEndpointResponseEndpoint) o;
    return Objects.equals(this.endpointIdentifier, modifyEndpointResponseEndpoint.endpointIdentifier) &&
        Objects.equals(this.endpointType, modifyEndpointResponseEndpoint.endpointType) &&
        Objects.equals(this.engineName, modifyEndpointResponseEndpoint.engineName) &&
        Objects.equals(this.engineDisplayName, modifyEndpointResponseEndpoint.engineDisplayName) &&
        Objects.equals(this.username, modifyEndpointResponseEndpoint.username) &&
        Objects.equals(this.serverName, modifyEndpointResponseEndpoint.serverName) &&
        Objects.equals(this.port, modifyEndpointResponseEndpoint.port) &&
        Objects.equals(this.databaseName, modifyEndpointResponseEndpoint.databaseName) &&
        Objects.equals(this.extraConnectionAttributes, modifyEndpointResponseEndpoint.extraConnectionAttributes) &&
        Objects.equals(this.status, modifyEndpointResponseEndpoint.status) &&
        Objects.equals(this.kmsKeyId, modifyEndpointResponseEndpoint.kmsKeyId) &&
        Objects.equals(this.endpointArn, modifyEndpointResponseEndpoint.endpointArn) &&
        Objects.equals(this.certificateArn, modifyEndpointResponseEndpoint.certificateArn) &&
        Objects.equals(this.sslMode, modifyEndpointResponseEndpoint.sslMode) &&
        Objects.equals(this.serviceAccessRoleArn, modifyEndpointResponseEndpoint.serviceAccessRoleArn) &&
        Objects.equals(this.externalTableDefinition, modifyEndpointResponseEndpoint.externalTableDefinition) &&
        Objects.equals(this.externalId, modifyEndpointResponseEndpoint.externalId) &&
        Objects.equals(this.dynamoDbSettings, modifyEndpointResponseEndpoint.dynamoDbSettings) &&
        Objects.equals(this.s3Settings, modifyEndpointResponseEndpoint.s3Settings) &&
        Objects.equals(this.dmsTransferSettings, modifyEndpointResponseEndpoint.dmsTransferSettings) &&
        Objects.equals(this.mongoDbSettings, modifyEndpointResponseEndpoint.mongoDbSettings) &&
        Objects.equals(this.kinesisSettings, modifyEndpointResponseEndpoint.kinesisSettings) &&
        Objects.equals(this.kafkaSettings, modifyEndpointResponseEndpoint.kafkaSettings) &&
        Objects.equals(this.elasticsearchSettings, modifyEndpointResponseEndpoint.elasticsearchSettings) &&
        Objects.equals(this.neptuneSettings, modifyEndpointResponseEndpoint.neptuneSettings) &&
        Objects.equals(this.redshiftSettings, modifyEndpointResponseEndpoint.redshiftSettings) &&
        Objects.equals(this.postgreSQLSettings, modifyEndpointResponseEndpoint.postgreSQLSettings) &&
        Objects.equals(this.mySQLSettings, modifyEndpointResponseEndpoint.mySQLSettings) &&
        Objects.equals(this.oracleSettings, modifyEndpointResponseEndpoint.oracleSettings) &&
        Objects.equals(this.sybaseSettings, modifyEndpointResponseEndpoint.sybaseSettings) &&
        Objects.equals(this.microsoftSQLServerSettings, modifyEndpointResponseEndpoint.microsoftSQLServerSettings) &&
        Objects.equals(this.ibMDb2Settings, modifyEndpointResponseEndpoint.ibMDb2Settings) &&
        Objects.equals(this.docDbSettings, modifyEndpointResponseEndpoint.docDbSettings) &&
        Objects.equals(this.redisSettings, modifyEndpointResponseEndpoint.redisSettings) &&
        Objects.equals(this.gcpMySQLSettings, modifyEndpointResponseEndpoint.gcpMySQLSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModifyEndpointResponseEndpoint {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModifyEndpointResponseEndpoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyEndpointResponseEndpoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModifyEndpointResponseEndpoint is not found in the empty JSON string", ModifyEndpointResponseEndpoint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyEndpointResponseEndpoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifyEndpointResponseEndpoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModifyEndpointResponseEndpoint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModifyEndpointResponseEndpoint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModifyEndpointResponseEndpoint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModifyEndpointResponseEndpoint.class));

       return (TypeAdapter<T>) new TypeAdapter<ModifyEndpointResponseEndpoint>() {
           @Override
           public void write(JsonWriter out, ModifyEndpointResponseEndpoint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModifyEndpointResponseEndpoint read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModifyEndpointResponseEndpoint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModifyEndpointResponseEndpoint
   * @throws IOException if the JSON string is invalid with respect to ModifyEndpointResponseEndpoint
   */
  public static ModifyEndpointResponseEndpoint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModifyEndpointResponseEndpoint.class);
  }

  /**
   * Convert an instance of ModifyEndpointResponseEndpoint to an JSON string
   *
   * @return JSON string
   */
