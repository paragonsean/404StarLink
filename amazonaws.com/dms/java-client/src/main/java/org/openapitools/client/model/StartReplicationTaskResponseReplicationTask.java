...
public class StartReplicationTaskResponseReplicationTask {
  ...
  public StartReplicationTaskResponseReplicationTask() {
  }

  public StartReplicationTaskResponseReplicationTask replicationTaskIdentifier(String replicationTaskIdentifier) {
  ...
  public StartReplicationTaskResponseReplicationTask sourceEndpointArn(String sourceEndpointArn) {
  ...
  public StartReplicationTaskResponseReplicationTask targetEndpointArn(String targetEndpointArn) {
  ...
  public StartReplicationTaskResponseReplicationTask replicationInstanceArn(String replicationInstanceArn) {
  ...
  public StartReplicationTaskResponseReplicationTask migrationType(MigrationTypeValue migrationType) {
  ...
  public StartReplicationTaskResponseReplicationTask tableMappings(String tableMappings) {
  ...
  public StartReplicationTaskResponseReplicationTask replicationTaskSettings(String replicationTaskSettings) {
  ...
  public StartReplicationTaskResponseReplicationTask status(String status) {
    this.status = status;
    return this;
  }
  ...
  public StartReplicationTaskResponseReplicationTask lastFailureMessage(String lastFailureMessage) {
  ...
  public StartReplicationTaskResponseReplicationTask stopReason(String stopReason) {
  ...
  public StartReplicationTaskResponseReplicationTask replicationTaskCreationDate(OffsetDateTime replicationTaskCreationDate) {
  ...
  public StartReplicationTaskResponseReplicationTask replicationTaskStartDate(OffsetDateTime replicationTaskStartDate) {
  ...
  public StartReplicationTaskResponseReplicationTask cdcStartPosition(String cdcStartPosition) {
  ...
  public StartReplicationTaskResponseReplicationTask cdcStopPosition(String cdcStopPosition) {
  ...
  public StartReplicationTaskResponseReplicationTask recoveryCheckpoint(String recoveryCheckpoint) {
  ...
  public StartReplicationTaskResponseReplicationTask replicationTaskArn(String replicationTaskArn) {
  ...
  public StartReplicationTaskResponseReplicationTask replicationTaskStats(ReplicationTaskReplicationTaskStats replicationTaskStats) {
  ...
  public StartReplicationTaskResponseReplicationTask taskData(String taskData) {
  ...
  public StartReplicationTaskResponseReplicationTask targetReplicationInstanceArn(String targetReplicationInstanceArn) {
  ...
  public boolean equals(Object o) {
    ...
    StartReplicationTaskResponseReplicationTask startReplicationTaskResponseReplicationTask = (StartReplicationTaskResponseReplicationTask) o;
    return Objects.equals(this.replicationTaskIdentifier, startReplicationTaskResponseReplicationTask.replicationTaskIdentifier) &&
        Objects.equals(this.sourceEndpointArn, startReplicationTaskResponseReplicationTask.sourceEndpointArn) &&
        Objects.equals(this.targetEndpointArn, startReplicationTaskResponseReplicationTask.targetEndpointArn) &&
        Objects.equals(this.replicationInstanceArn, startReplicationTaskResponseReplicationTask.replicationInstanceArn) &&
        Objects.equals(this.migrationType, startReplicationTaskResponseReplicationTask.migrationType) &&
        Objects.equals(this.tableMappings, startReplicationTaskResponseReplicationTask.tableMappings) &&
        Objects.equals(this.replicationTaskSettings, startReplicationTaskResponseReplicationTask.replicationTaskSettings) &&
        Objects.equals(this.status, startReplicationTaskResponseReplicationTask.status) &&
        Objects.equals(this.lastFailureMessage, startReplicationTaskResponseReplicationTask.lastFailureMessage) &&
        Objects.equals(this.stopReason, startReplicationTaskResponseReplicationTask.stopReason) &&
        Objects.equals(this.replicationTaskCreationDate, startReplicationTaskResponseReplicationTask.replicationTaskCreationDate) &&
        Objects.equals(this.replicationTaskStartDate, startReplicationTaskResponseReplicationTask.replicationTaskStartDate) &&
        Objects.equals(this.cdcStartPosition, startReplicationTaskResponseReplicationTask.cdcStartPosition) &&
        Objects.equals(this.cdcStopPosition, startReplicationTaskResponseReplicationTask.cdcStopPosition) &&
        Objects.equals(this.recoveryCheckpoint, startReplicationTaskResponseReplicationTask.recoveryCheckpoint) &&
        Objects.equals(this.replicationTaskArn, startReplicationTaskResponseReplicationTask.replicationTaskArn) &&
        Objects.equals(this.replicationTaskStats, startReplicationTaskResponseReplicationTask.replicationTaskStats) &&
        Objects.equals(this.taskData, startReplicationTaskResponseReplicationTask.taskData) &&
        Objects.equals(this.targetReplicationInstanceArn, startReplicationTaskResponseReplicationTask.targetReplicationInstanceArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartReplicationTaskResponseReplicationTask {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StartReplicationTaskResponseReplicationTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StartReplicationTaskResponseReplicationTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StartReplicationTaskResponseReplicationTask is not found in the empty JSON string", StartReplicationTaskResponseReplicationTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StartReplicationTaskResponseReplicationTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StartReplicationTaskResponseReplicationTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StartReplicationTaskResponseReplicationTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StartReplicationTaskResponseReplicationTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StartReplicationTaskResponseReplicationTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StartReplicationTaskResponseReplicationTask.class));

       return (TypeAdapter<T>) new TypeAdapter<StartReplicationTaskResponseReplicationTask>() {
           @Override
           public void write(JsonWriter out, StartReplicationTaskResponseReplicationTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StartReplicationTaskResponseReplicationTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StartReplicationTaskResponseReplicationTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StartReplicationTaskResponseReplicationTask
   * @throws IOException if the JSON string is invalid with respect to StartReplicationTaskResponseReplicationTask
   */
  public static StartReplicationTaskResponseReplicationTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StartReplicationTaskResponseReplicationTask.class);
  }

  /**
   * Convert an instance of StartReplicationTaskResponseReplicationTask to an JSON string
   *
   * @return JSON string
   */
