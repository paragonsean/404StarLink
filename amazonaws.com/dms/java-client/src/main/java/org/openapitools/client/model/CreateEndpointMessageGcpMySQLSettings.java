...
public class CreateEndpointMessageGcpMySQLSettings {
  ...
  public CreateEndpointMessageGcpMySQLSettings() {
  }

  public CreateEndpointMessageGcpMySQLSettings afterConnectScript(String afterConnectScript) {
  ...
  public CreateEndpointMessageGcpMySQLSettings cleanSourceMetadataOnMismatch(Boolean cleanSourceMetadataOnMismatch) {
  ...
  public CreateEndpointMessageGcpMySQLSettings databaseName(String databaseName) {
  ...
  public CreateEndpointMessageGcpMySQLSettings eventsPollInterval(Integer eventsPollInterval) {
  ...
  public CreateEndpointMessageGcpMySQLSettings targetDbType(TargetDbType targetDbType) {
  ...
  public CreateEndpointMessageGcpMySQLSettings maxFileSize(Integer maxFileSize) {
  ...
  public CreateEndpointMessageGcpMySQLSettings parallelLoadThreads(Integer parallelLoadThreads) {
  ...
  public CreateEndpointMessageGcpMySQLSettings password(String password) {
  ...
  public CreateEndpointMessageGcpMySQLSettings port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public CreateEndpointMessageGcpMySQLSettings serverName(String serverName) {
  ...
  public CreateEndpointMessageGcpMySQLSettings serverTimezone(String serverTimezone) {
  ...
  public CreateEndpointMessageGcpMySQLSettings username(String username) {
  ...
  public CreateEndpointMessageGcpMySQLSettings secretsManagerAccessRoleArn(String secretsManagerAccessRoleArn) {
  ...
  public CreateEndpointMessageGcpMySQLSettings secretsManagerSecretId(String secretsManagerSecretId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateEndpointMessageGcpMySQLSettings createEndpointMessageGcpMySQLSettings = (CreateEndpointMessageGcpMySQLSettings) o;
    return Objects.equals(this.afterConnectScript, createEndpointMessageGcpMySQLSettings.afterConnectScript) &&
        Objects.equals(this.cleanSourceMetadataOnMismatch, createEndpointMessageGcpMySQLSettings.cleanSourceMetadataOnMismatch) &&
        Objects.equals(this.databaseName, createEndpointMessageGcpMySQLSettings.databaseName) &&
        Objects.equals(this.eventsPollInterval, createEndpointMessageGcpMySQLSettings.eventsPollInterval) &&
        Objects.equals(this.targetDbType, createEndpointMessageGcpMySQLSettings.targetDbType) &&
        Objects.equals(this.maxFileSize, createEndpointMessageGcpMySQLSettings.maxFileSize) &&
        Objects.equals(this.parallelLoadThreads, createEndpointMessageGcpMySQLSettings.parallelLoadThreads) &&
        Objects.equals(this.password, createEndpointMessageGcpMySQLSettings.password) &&
        Objects.equals(this.port, createEndpointMessageGcpMySQLSettings.port) &&
        Objects.equals(this.serverName, createEndpointMessageGcpMySQLSettings.serverName) &&
        Objects.equals(this.serverTimezone, createEndpointMessageGcpMySQLSettings.serverTimezone) &&
        Objects.equals(this.username, createEndpointMessageGcpMySQLSettings.username) &&
        Objects.equals(this.secretsManagerAccessRoleArn, createEndpointMessageGcpMySQLSettings.secretsManagerAccessRoleArn) &&
        Objects.equals(this.secretsManagerSecretId, createEndpointMessageGcpMySQLSettings.secretsManagerSecretId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEndpointMessageGcpMySQLSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateEndpointMessageGcpMySQLSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEndpointMessageGcpMySQLSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEndpointMessageGcpMySQLSettings is not found in the empty JSON string", CreateEndpointMessageGcpMySQLSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEndpointMessageGcpMySQLSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateEndpointMessageGcpMySQLSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEndpointMessageGcpMySQLSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEndpointMessageGcpMySQLSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEndpointMessageGcpMySQLSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEndpointMessageGcpMySQLSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEndpointMessageGcpMySQLSettings>() {
           @Override
           public void write(JsonWriter out, CreateEndpointMessageGcpMySQLSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateEndpointMessageGcpMySQLSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateEndpointMessageGcpMySQLSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateEndpointMessageGcpMySQLSettings
   * @throws IOException if the JSON string is invalid with respect to CreateEndpointMessageGcpMySQLSettings
   */
  public static CreateEndpointMessageGcpMySQLSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEndpointMessageGcpMySQLSettings.class);
  }

  /**
   * Convert an instance of CreateEndpointMessageGcpMySQLSettings to an JSON string
   *
   * @return JSON string
   */
