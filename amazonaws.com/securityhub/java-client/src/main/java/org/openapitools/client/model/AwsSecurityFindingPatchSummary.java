...
public class AwsSecurityFindingPatchSummary {
  ...
  public AwsSecurityFindingPatchSummary() {
  }

  public AwsSecurityFindingPatchSummary id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AwsSecurityFindingPatchSummary installedCount(Integer installedCount) {
  ...
  public AwsSecurityFindingPatchSummary missingCount(Integer missingCount) {
  ...
  public AwsSecurityFindingPatchSummary failedCount(Integer failedCount) {
  ...
  public AwsSecurityFindingPatchSummary installedOtherCount(Integer installedOtherCount) {
  ...
  public AwsSecurityFindingPatchSummary installedRejectedCount(Integer installedRejectedCount) {
  ...
  public AwsSecurityFindingPatchSummary installedPendingReboot(Integer installedPendingReboot) {
  ...
  public AwsSecurityFindingPatchSummary operationStartTime(String operationStartTime) {
  ...
  public AwsSecurityFindingPatchSummary operationEndTime(String operationEndTime) {
  ...
  public AwsSecurityFindingPatchSummary rebootOption(String rebootOption) {
  ...
  public AwsSecurityFindingPatchSummary operation(String operation) {
  ...
  public boolean equals(Object o) {
    ...
    AwsSecurityFindingPatchSummary awsSecurityFindingPatchSummary = (AwsSecurityFindingPatchSummary) o;
    return Objects.equals(this.id, awsSecurityFindingPatchSummary.id) &&
        Objects.equals(this.installedCount, awsSecurityFindingPatchSummary.installedCount) &&
        Objects.equals(this.missingCount, awsSecurityFindingPatchSummary.missingCount) &&
        Objects.equals(this.failedCount, awsSecurityFindingPatchSummary.failedCount) &&
        Objects.equals(this.installedOtherCount, awsSecurityFindingPatchSummary.installedOtherCount) &&
        Objects.equals(this.installedRejectedCount, awsSecurityFindingPatchSummary.installedRejectedCount) &&
        Objects.equals(this.installedPendingReboot, awsSecurityFindingPatchSummary.installedPendingReboot) &&
        Objects.equals(this.operationStartTime, awsSecurityFindingPatchSummary.operationStartTime) &&
        Objects.equals(this.operationEndTime, awsSecurityFindingPatchSummary.operationEndTime) &&
        Objects.equals(this.rebootOption, awsSecurityFindingPatchSummary.rebootOption) &&
        Objects.equals(this.operation, awsSecurityFindingPatchSummary.operation);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsSecurityFindingPatchSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsSecurityFindingPatchSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsSecurityFindingPatchSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsSecurityFindingPatchSummary is not found in the empty JSON string", AwsSecurityFindingPatchSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsSecurityFindingPatchSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsSecurityFindingPatchSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AwsSecurityFindingPatchSummary.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsSecurityFindingPatchSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsSecurityFindingPatchSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsSecurityFindingPatchSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsSecurityFindingPatchSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsSecurityFindingPatchSummary>() {
           @Override
           public void write(JsonWriter out, AwsSecurityFindingPatchSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsSecurityFindingPatchSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsSecurityFindingPatchSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsSecurityFindingPatchSummary
   * @throws IOException if the JSON string is invalid with respect to AwsSecurityFindingPatchSummary
   */
  public static AwsSecurityFindingPatchSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsSecurityFindingPatchSummary.class);
  }

  /**
   * Convert an instance of AwsSecurityFindingPatchSummary to an JSON string
   *
   * @return JSON string
   */
