...
public class AwsSecurityFindingAction {
  ...
  public AwsSecurityFindingAction() {
  }

  public AwsSecurityFindingAction actionType(String actionType) {
  ...
  public AwsSecurityFindingAction networkConnectionAction(ActionNetworkConnectionAction networkConnectionAction) {
  ...
  public AwsSecurityFindingAction awsApiCallAction(ActionAwsApiCallAction awsApiCallAction) {
  ...
  public AwsSecurityFindingAction dnsRequestAction(ActionDnsRequestAction dnsRequestAction) {
  ...
  public AwsSecurityFindingAction portProbeAction(ActionPortProbeAction portProbeAction) {
  ...
  public boolean equals(Object o) {
    ...
    AwsSecurityFindingAction awsSecurityFindingAction = (AwsSecurityFindingAction) o;
    return Objects.equals(this.actionType, awsSecurityFindingAction.actionType) &&
        Objects.equals(this.networkConnectionAction, awsSecurityFindingAction.networkConnectionAction) &&
        Objects.equals(this.awsApiCallAction, awsSecurityFindingAction.awsApiCallAction) &&
        Objects.equals(this.dnsRequestAction, awsSecurityFindingAction.dnsRequestAction) &&
        Objects.equals(this.portProbeAction, awsSecurityFindingAction.portProbeAction);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsSecurityFindingAction {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsSecurityFindingAction
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsSecurityFindingAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsSecurityFindingAction is not found in the empty JSON string", AwsSecurityFindingAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsSecurityFindingAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsSecurityFindingAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsSecurityFindingAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsSecurityFindingAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsSecurityFindingAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsSecurityFindingAction.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsSecurityFindingAction>() {
           @Override
           public void write(JsonWriter out, AwsSecurityFindingAction value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsSecurityFindingAction read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsSecurityFindingAction given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsSecurityFindingAction
   * @throws IOException if the JSON string is invalid with respect to AwsSecurityFindingAction
   */
  public static AwsSecurityFindingAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsSecurityFindingAction.class);
  }

  /**
   * Convert an instance of AwsSecurityFindingAction to an JSON string
   *
   * @return JSON string
   */
