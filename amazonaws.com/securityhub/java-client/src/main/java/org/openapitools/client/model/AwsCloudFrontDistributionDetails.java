...
public class AwsCloudFrontDistributionDetails {
  ...
  public AwsCloudFrontDistributionDetails cacheBehaviors(AwsCloudFrontDistributionDetailsCacheBehaviors cacheBehaviors) {
  ...
  public AwsCloudFrontDistributionDetails defaultCacheBehavior(AwsCloudFrontDistributionDetailsDefaultCacheBehavior defaultCacheBehavior) {
  ...
  public AwsCloudFrontDistributionDetails defaultRootObject(String defaultRootObject) {
  ...
  public AwsCloudFrontDistributionDetails domainName(String domainName) {
  ...
  public AwsCloudFrontDistributionDetails etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public AwsCloudFrontDistributionDetails lastModifiedTime(String lastModifiedTime) {
  ...
  public AwsCloudFrontDistributionDetails logging(AwsCloudFrontDistributionDetailsLogging logging) {
  ...
  public AwsCloudFrontDistributionDetails origins(AwsCloudFrontDistributionDetailsOrigins origins) {
  ...
  public AwsCloudFrontDistributionDetails originGroups(AwsCloudFrontDistributionDetailsOriginGroups originGroups) {
  ...
  public AwsCloudFrontDistributionDetails viewerCertificate(AwsCloudFrontDistributionDetailsViewerCertificate viewerCertificate) {
  ...
  public AwsCloudFrontDistributionDetails status(String status) {
    this.status = status;
    return this;
  }
  ...
  public AwsCloudFrontDistributionDetails webAclId(String webAclId) {
  ...
  public boolean equals(Object o) {
    ...
    AwsCloudFrontDistributionDetails awsCloudFrontDistributionDetails = (AwsCloudFrontDistributionDetails) o;
    return Objects.equals(this.cacheBehaviors, awsCloudFrontDistributionDetails.cacheBehaviors) &&
        Objects.equals(this.defaultCacheBehavior, awsCloudFrontDistributionDetails.defaultCacheBehavior) &&
        Objects.equals(this.defaultRootObject, awsCloudFrontDistributionDetails.defaultRootObject) &&
        Objects.equals(this.domainName, awsCloudFrontDistributionDetails.domainName) &&
        Objects.equals(this.etag, awsCloudFrontDistributionDetails.etag) &&
        Objects.equals(this.lastModifiedTime, awsCloudFrontDistributionDetails.lastModifiedTime) &&
        Objects.equals(this.logging, awsCloudFrontDistributionDetails.logging) &&
        Objects.equals(this.origins, awsCloudFrontDistributionDetails.origins) &&
        Objects.equals(this.originGroups, awsCloudFrontDistributionDetails.originGroups) &&
        Objects.equals(this.viewerCertificate, awsCloudFrontDistributionDetails.viewerCertificate) &&
        Objects.equals(this.status, awsCloudFrontDistributionDetails.status) &&
        Objects.equals(this.webAclId, awsCloudFrontDistributionDetails.webAclId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsCloudFrontDistributionDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsCloudFrontDistributionDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsCloudFrontDistributionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsCloudFrontDistributionDetails is not found in the empty JSON string", AwsCloudFrontDistributionDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsCloudFrontDistributionDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsCloudFrontDistributionDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsCloudFrontDistributionDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsCloudFrontDistributionDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsCloudFrontDistributionDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsCloudFrontDistributionDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsCloudFrontDistributionDetails>() {
           @Override
           public void write(JsonWriter out, AwsCloudFrontDistributionDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsCloudFrontDistributionDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsCloudFrontDistributionDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsCloudFrontDistributionDetails
   * @throws IOException if the JSON string is invalid with respect to AwsCloudFrontDistributionDetails
   */
  public static AwsCloudFrontDistributionDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsCloudFrontDistributionDetails.class);
  }

  /**
   * Convert an instance of AwsCloudFrontDistributionDetails to an JSON string
   *
   * @return JSON string
   */
