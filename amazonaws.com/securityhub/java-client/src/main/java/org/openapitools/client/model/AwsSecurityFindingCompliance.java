...
public class AwsSecurityFindingCompliance {
  ...
  public AwsSecurityFindingCompliance() {
  }

  public AwsSecurityFindingCompliance status(ComplianceStatus status) {
    this.status = status;
    return this;
  }
  ...
  public AwsSecurityFindingCompliance relatedRequirements(List relatedRequirements) {
  ...
  public AwsSecurityFindingCompliance statusReasons(List statusReasons) {
  ...
  public AwsSecurityFindingCompliance securityControlId(String securityControlId) {
  ...
  public AwsSecurityFindingCompliance associatedStandards(List associatedStandards) {
  ...
  public boolean equals(Object o) {
    ...
    AwsSecurityFindingCompliance awsSecurityFindingCompliance = (AwsSecurityFindingCompliance) o;
    return Objects.equals(this.status, awsSecurityFindingCompliance.status) &&
        Objects.equals(this.relatedRequirements, awsSecurityFindingCompliance.relatedRequirements) &&
        Objects.equals(this.statusReasons, awsSecurityFindingCompliance.statusReasons) &&
        Objects.equals(this.securityControlId, awsSecurityFindingCompliance.securityControlId) &&
        Objects.equals(this.associatedStandards, awsSecurityFindingCompliance.associatedStandards);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsSecurityFindingCompliance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsSecurityFindingCompliance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsSecurityFindingCompliance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsSecurityFindingCompliance is not found in the empty JSON string", AwsSecurityFindingCompliance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsSecurityFindingCompliance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsSecurityFindingCompliance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsSecurityFindingCompliance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsSecurityFindingCompliance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsSecurityFindingCompliance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsSecurityFindingCompliance.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsSecurityFindingCompliance>() {
           @Override
           public void write(JsonWriter out, AwsSecurityFindingCompliance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsSecurityFindingCompliance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsSecurityFindingCompliance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsSecurityFindingCompliance
   * @throws IOException if the JSON string is invalid with respect to AwsSecurityFindingCompliance
   */
  public static AwsSecurityFindingCompliance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsSecurityFindingCompliance.class);
  }

  /**
   * Convert an instance of AwsSecurityFindingCompliance to an JSON string
   *
   * @return JSON string
   */
