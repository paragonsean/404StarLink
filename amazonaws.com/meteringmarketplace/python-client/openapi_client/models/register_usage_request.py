...
class RegisterUsageRequest(BaseModel):
    ...
    public_key_version: Any = Field(alias="PublicKeyVersion")
    nonce: Optional[Any] = Field(default=None, alias="Nonce")
    __properties: ClassVar[List[str]] = ["ProductCode", "PublicKeyVersion", "Nonce"]
