...
class UsageRecordResultUsageRecord(BaseModel):
    """
    UsageRecordResultUsageRecord
    """ # noqa: E501
    timestamp: Any = Field(alias="Timestamp")
    customer_identifier: Any = Field(alias="CustomerIdentifier")
    dimension: Any = Field(alias="Dimension")
    ...
    __properties: ClassVar[List[str]] = ["Timestamp", "CustomerIdentifier", "Dimension", "Quantity", "UsageAllocations"]
