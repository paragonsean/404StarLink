...
class MeterUsageRequest(BaseModel):
    ...
    MeterUsageRequest
    """ # noqa: E501
    product_code: Any = Field(alias="ProductCode")
    timestamp: Any = Field(alias="Timestamp")
    usage_dimension: Any = Field(alias="UsageDimension")
    usage_quantity: Optional[Any] = Field(default=None, alias="UsageQuantity")
    dry_run: Optional[Any] = Field(default=None, alias="DryRun")
    usage_allocations: Optional[Any] = Field(default=None, alias="UsageAllocations")
    __properties: ClassVar[List[str]] = ["ProductCode", "Timestamp", "UsageDimension", "UsageQuantity", "DryRun", "UsageAllocations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "UsageDimension": obj.get("UsageDimension"),
            "UsageQuantity": obj.get("UsageQuantity"),
            "DryRun": obj.get("DryRun"),
            "UsageAllocations": obj.get("UsageAllocations")
        })
        return _obj
