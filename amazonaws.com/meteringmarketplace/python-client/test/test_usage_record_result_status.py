...
from openapi_client.models.usage_record_result_status import UsageRecordResultStatus

class TestUsageRecordResultStatus(unittest.TestCase):
    """UsageRecordResultStatus unit test stubs"""
    ...
    def testUsageRecordResultStatus(self):
        """Test UsageRecordResultStatus"""
        # inst = UsageRecordResultStatus()
