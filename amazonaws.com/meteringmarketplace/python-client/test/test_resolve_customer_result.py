...
class TestResolveCustomerResult(unittest.TestCase):
    """ResolveCustomerResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResolveCustomerResult:
        """Test ResolveCustomerResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResolveCustomerResult`
        """
        model = ResolveCustomerResult()
        if include_optional:
    ...
    def testResolveCustomerResult(self):
        """Test ResolveCustomerResult"""
