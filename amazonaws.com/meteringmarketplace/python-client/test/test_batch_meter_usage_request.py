...
class TestBatchMeterUsageRequest(unittest.TestCase):
    """BatchMeterUsageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchMeterUsageRequest:
        """Test BatchMeterUsageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchMeterUsageRequest`
        """
        model = BatchMeterUsageRequest()
        if include_optional:
    ...
    def testBatchMeterUsageRequest(self):
        """Test BatchMeterUsageRequest"""
