...
class TestUsageAllocation(unittest.TestCase):
    """UsageAllocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageAllocation:
        """Test UsageAllocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageAllocation`
        """
        model = UsageAllocation()
        if include_optional:
            return UsageAllocation(
                allocated_usage_quantity = None,
                tags = None
            )
        else:
            return UsageAllocation(
