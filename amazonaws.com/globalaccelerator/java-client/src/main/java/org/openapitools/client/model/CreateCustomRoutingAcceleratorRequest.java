...
public class CreateCustomRoutingAcceleratorRequest {
  ...
  public CreateCustomRoutingAcceleratorRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateCustomRoutingAcceleratorRequest ipAddressType(IpAddressType ipAddressType) {
  ...
  public CreateCustomRoutingAcceleratorRequest ipAddresses(List ipAddresses) {
  ...
  public CreateCustomRoutingAcceleratorRequest enabled(Boolean enabled) {
  ...
  public CreateCustomRoutingAcceleratorRequest idempotencyToken(String idempotencyToken) {
  ...
  public CreateCustomRoutingAcceleratorRequest tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateCustomRoutingAcceleratorRequest createCustomRoutingAcceleratorRequest = (CreateCustomRoutingAcceleratorRequest) o;
    return Objects.equals(this.name, createCustomRoutingAcceleratorRequest.name) &&
        Objects.equals(this.ipAddressType, createCustomRoutingAcceleratorRequest.ipAddressType) &&
        Objects.equals(this.ipAddresses, createCustomRoutingAcceleratorRequest.ipAddresses) &&
        Objects.equals(this.enabled, createCustomRoutingAcceleratorRequest.enabled) &&
        Objects.equals(this.idempotencyToken, createCustomRoutingAcceleratorRequest.idempotencyToken) &&
        Objects.equals(this.tags, createCustomRoutingAcceleratorRequest.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateCustomRoutingAcceleratorRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCustomRoutingAcceleratorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCustomRoutingAcceleratorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCustomRoutingAcceleratorRequest is not found in the empty JSON string", CreateCustomRoutingAcceleratorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCustomRoutingAcceleratorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCustomRoutingAcceleratorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCustomRoutingAcceleratorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCustomRoutingAcceleratorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCustomRoutingAcceleratorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCustomRoutingAcceleratorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCustomRoutingAcceleratorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCustomRoutingAcceleratorRequest>() {
           @Override
           public void write(JsonWriter out, CreateCustomRoutingAcceleratorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCustomRoutingAcceleratorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCustomRoutingAcceleratorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCustomRoutingAcceleratorRequest
   * @throws IOException if the JSON string is invalid with respect to CreateCustomRoutingAcceleratorRequest
   */
  public static CreateCustomRoutingAcceleratorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCustomRoutingAcceleratorRequest.class);
  }

  /**
   * Convert an instance of CreateCustomRoutingAcceleratorRequest to an JSON string
   *
   * @return JSON string
   */
