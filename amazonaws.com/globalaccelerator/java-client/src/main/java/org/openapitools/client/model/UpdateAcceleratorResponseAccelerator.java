...
public class UpdateAcceleratorResponseAccelerator {
  ...
  public UpdateAcceleratorResponseAccelerator() {
  }

  public UpdateAcceleratorResponseAccelerator acceleratorArn(String acceleratorArn) {
  ...
  public UpdateAcceleratorResponseAccelerator name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateAcceleratorResponseAccelerator ipAddressType(IpAddressType ipAddressType) {
  ...
  public UpdateAcceleratorResponseAccelerator enabled(Boolean enabled) {
  ...
  public UpdateAcceleratorResponseAccelerator ipSets(List ipSets) {
    this.ipSets = ipSets;
    return this;
  }
  ...
  public UpdateAcceleratorResponseAccelerator dnsName(String dnsName) {
  ...
  public UpdateAcceleratorResponseAccelerator status(AcceleratorStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateAcceleratorResponseAccelerator createdTime(OffsetDateTime createdTime) {
  ...
  public UpdateAcceleratorResponseAccelerator lastModifiedTime(OffsetDateTime lastModifiedTime) {
  ...
  public UpdateAcceleratorResponseAccelerator dualStackDnsName(String dualStackDnsName) {
  ...
  public UpdateAcceleratorResponseAccelerator events(List events) {
    this.events = events;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateAcceleratorResponseAccelerator updateAcceleratorResponseAccelerator = (UpdateAcceleratorResponseAccelerator) o;
    return Objects.equals(this.acceleratorArn, updateAcceleratorResponseAccelerator.acceleratorArn) &&
        Objects.equals(this.name, updateAcceleratorResponseAccelerator.name) &&
        Objects.equals(this.ipAddressType, updateAcceleratorResponseAccelerator.ipAddressType) &&
        Objects.equals(this.enabled, updateAcceleratorResponseAccelerator.enabled) &&
        Objects.equals(this.ipSets, updateAcceleratorResponseAccelerator.ipSets) &&
        Objects.equals(this.dnsName, updateAcceleratorResponseAccelerator.dnsName) &&
        Objects.equals(this.status, updateAcceleratorResponseAccelerator.status) &&
        Objects.equals(this.createdTime, updateAcceleratorResponseAccelerator.createdTime) &&
        Objects.equals(this.lastModifiedTime, updateAcceleratorResponseAccelerator.lastModifiedTime) &&
        Objects.equals(this.dualStackDnsName, updateAcceleratorResponseAccelerator.dualStackDnsName) &&
        Objects.equals(this.events, updateAcceleratorResponseAccelerator.events);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAcceleratorResponseAccelerator {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAcceleratorResponseAccelerator
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAcceleratorResponseAccelerator.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAcceleratorResponseAccelerator is not found in the empty JSON string", UpdateAcceleratorResponseAccelerator.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAcceleratorResponseAccelerator.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAcceleratorResponseAccelerator` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAcceleratorResponseAccelerator.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAcceleratorResponseAccelerator' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAcceleratorResponseAccelerator> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAcceleratorResponseAccelerator.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAcceleratorResponseAccelerator>() {
           @Override
           public void write(JsonWriter out, UpdateAcceleratorResponseAccelerator value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAcceleratorResponseAccelerator read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAcceleratorResponseAccelerator given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAcceleratorResponseAccelerator
   * @throws IOException if the JSON string is invalid with respect to UpdateAcceleratorResponseAccelerator
   */
  public static UpdateAcceleratorResponseAccelerator fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAcceleratorResponseAccelerator.class);
  }

  /**
   * Convert an instance of UpdateAcceleratorResponseAccelerator to an JSON string
   *
   * @return JSON string
   */
