...
public class DescribeAcceleratorResponseAccelerator {
  ...
  public DescribeAcceleratorResponseAccelerator() {
  }

  public DescribeAcceleratorResponseAccelerator acceleratorArn(String acceleratorArn) {
  ...
  public DescribeAcceleratorResponseAccelerator name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribeAcceleratorResponseAccelerator ipAddressType(IpAddressType ipAddressType) {
  ...
  public DescribeAcceleratorResponseAccelerator enabled(Boolean enabled) {
  ...
  public DescribeAcceleratorResponseAccelerator ipSets(List ipSets) {
    this.ipSets = ipSets;
    return this;
  }
  ...
  public DescribeAcceleratorResponseAccelerator dnsName(String dnsName) {
  ...
  public DescribeAcceleratorResponseAccelerator status(AcceleratorStatus status) {
    this.status = status;
    return this;
  }
  ...
  public DescribeAcceleratorResponseAccelerator createdTime(OffsetDateTime createdTime) {
  ...
  public DescribeAcceleratorResponseAccelerator lastModifiedTime(OffsetDateTime lastModifiedTime) {
  ...
  public DescribeAcceleratorResponseAccelerator dualStackDnsName(String dualStackDnsName) {
  ...
  public DescribeAcceleratorResponseAccelerator events(List events) {
    this.events = events;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeAcceleratorResponseAccelerator describeAcceleratorResponseAccelerator = (DescribeAcceleratorResponseAccelerator) o;
    return Objects.equals(this.acceleratorArn, describeAcceleratorResponseAccelerator.acceleratorArn) &&
        Objects.equals(this.name, describeAcceleratorResponseAccelerator.name) &&
        Objects.equals(this.ipAddressType, describeAcceleratorResponseAccelerator.ipAddressType) &&
        Objects.equals(this.enabled, describeAcceleratorResponseAccelerator.enabled) &&
        Objects.equals(this.ipSets, describeAcceleratorResponseAccelerator.ipSets) &&
        Objects.equals(this.dnsName, describeAcceleratorResponseAccelerator.dnsName) &&
        Objects.equals(this.status, describeAcceleratorResponseAccelerator.status) &&
        Objects.equals(this.createdTime, describeAcceleratorResponseAccelerator.createdTime) &&
        Objects.equals(this.lastModifiedTime, describeAcceleratorResponseAccelerator.lastModifiedTime) &&
        Objects.equals(this.dualStackDnsName, describeAcceleratorResponseAccelerator.dualStackDnsName) &&
        Objects.equals(this.events, describeAcceleratorResponseAccelerator.events);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAcceleratorResponseAccelerator {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAcceleratorResponseAccelerator
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAcceleratorResponseAccelerator.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAcceleratorResponseAccelerator is not found in the empty JSON string", DescribeAcceleratorResponseAccelerator.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAcceleratorResponseAccelerator.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAcceleratorResponseAccelerator` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAcceleratorResponseAccelerator.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAcceleratorResponseAccelerator' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAcceleratorResponseAccelerator> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAcceleratorResponseAccelerator.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAcceleratorResponseAccelerator>() {
           @Override
           public void write(JsonWriter out, DescribeAcceleratorResponseAccelerator value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAcceleratorResponseAccelerator read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAcceleratorResponseAccelerator given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAcceleratorResponseAccelerator
   * @throws IOException if the JSON string is invalid with respect to DescribeAcceleratorResponseAccelerator
   */
  public static DescribeAcceleratorResponseAccelerator fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAcceleratorResponseAccelerator.class);
  }

  /**
   * Convert an instance of DescribeAcceleratorResponseAccelerator to an JSON string
   *
   * @return JSON string
   */
