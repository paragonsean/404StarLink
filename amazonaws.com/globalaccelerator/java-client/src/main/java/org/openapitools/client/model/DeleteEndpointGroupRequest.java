...
public class DeleteEndpointGroupRequest {
  ...
  public DeleteEndpointGroupRequest endpointGroupArn(String endpointGroupArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endpointGroupArn, deleteEndpointGroupRequest.endpointGroupArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteEndpointGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteEndpointGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteEndpointGroupRequest is not found in the empty JSON string", DeleteEndpointGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteEndpointGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteEndpointGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteEndpointGroupRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteEndpointGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteEndpointGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteEndpointGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteEndpointGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteEndpointGroupRequest>() {
           @Override
           public void write(JsonWriter out, DeleteEndpointGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteEndpointGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteEndpointGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteEndpointGroupRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteEndpointGroupRequest
   */
  public static DeleteEndpointGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteEndpointGroupRequest.class);
  }

  /**
   * Convert an instance of DeleteEndpointGroupRequest to an JSON string
   *
   * @return JSON string
   */
