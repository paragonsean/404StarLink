...
public class DenyCustomRoutingTrafficRequest {
  ...
  public static final String SERIALIZED_NAME_DENY_ALL_TRAFFIC_TO_ENDPOINT = "DenyAllTrafficToEndpoint";
  @SerializedName(SERIALIZED_NAME_DENY_ALL_TRAFFIC_TO_ENDPOINT)
  private Boolean denyAllTrafficToEndpoint;

  public DenyCustomRoutingTrafficRequest() {
  }

  public DenyCustomRoutingTrafficRequest endpointGroupArn(String endpointGroupArn) {
  ...
  public DenyCustomRoutingTrafficRequest endpointId(String endpointId) {
  ...
  public DenyCustomRoutingTrafficRequest destinationAddresses(List destinationAddresses) {
  ...
  public DenyCustomRoutingTrafficRequest destinationPorts(List destinationPorts) {
  ...
  public DenyCustomRoutingTrafficRequest denyAllTrafficToEndpoint(Boolean denyAllTrafficToEndpoint) {
    this.denyAllTrafficToEndpoint = denyAllTrafficToEndpoint;
    return this;
  }

  /**
   * Get denyAllTrafficToEndpoint
  ...
  public void setDenyAllTrafficToEndpoint(Boolean denyAllTrafficToEndpoint) {
    this.denyAllTrafficToEndpoint = denyAllTrafficToEndpoint;
  }
  ...
  public boolean equals(Object o) {
    ...
    DenyCustomRoutingTrafficRequest denyCustomRoutingTrafficRequest = (DenyCustomRoutingTrafficRequest) o;
    return Objects.equals(this.endpointGroupArn, denyCustomRoutingTrafficRequest.endpointGroupArn) &&
        Objects.equals(this.endpointId, denyCustomRoutingTrafficRequest.endpointId) &&
        Objects.equals(this.destinationAddresses, denyCustomRoutingTrafficRequest.destinationAddresses) &&
        Objects.equals(this.destinationPorts, denyCustomRoutingTrafficRequest.destinationPorts) &&
        Objects.equals(this.denyAllTrafficToEndpoint, denyCustomRoutingTrafficRequest.denyAllTrafficToEndpoint);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endpointGroupArn, endpointId, destinationAddresses, destinationPorts, denyAllTrafficToEndpoint);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DenyCustomRoutingTrafficRequest {\n");
    ...
    sb.append("    denyAllTrafficToEndpoint: ").append(toIndentedString(denyAllTrafficToEndpoint)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("DenyAllTrafficToEndpoint");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DenyCustomRoutingTrafficRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DenyCustomRoutingTrafficRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DenyCustomRoutingTrafficRequest is not found in the empty JSON string", DenyCustomRoutingTrafficRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DenyCustomRoutingTrafficRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DenyCustomRoutingTrafficRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DenyCustomRoutingTrafficRequest.openapiRequiredFields) {
      ...
      // validate the optional field `DenyAllTrafficToEndpoint`
      if (jsonObj.get("DenyAllTrafficToEndpoint") != null && !jsonObj.get("DenyAllTrafficToEndpoint").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("DenyAllTrafficToEndpoint"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DenyCustomRoutingTrafficRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DenyCustomRoutingTrafficRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DenyCustomRoutingTrafficRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DenyCustomRoutingTrafficRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DenyCustomRoutingTrafficRequest>() {
           @Override
           public void write(JsonWriter out, DenyCustomRoutingTrafficRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DenyCustomRoutingTrafficRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DenyCustomRoutingTrafficRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DenyCustomRoutingTrafficRequest
   * @throws IOException if the JSON string is invalid with respect to DenyCustomRoutingTrafficRequest
   */
  public static DenyCustomRoutingTrafficRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DenyCustomRoutingTrafficRequest.class);
  }

  /**
   * Convert an instance of DenyCustomRoutingTrafficRequest to an JSON string
   *
   * @return JSON string
   */
