...
public class DescribeEndpointGroupRequest {
  ...
  public DescribeEndpointGroupRequest endpointGroupArn(String endpointGroupArn) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeEndpointGroupRequest describeEndpointGroupRequest = (DescribeEndpointGroupRequest) o;
    return Objects.equals(this.endpointGroupArn, describeEndpointGroupRequest.endpointGroupArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeEndpointGroupRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeEndpointGroupRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeEndpointGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeEndpointGroupRequest is not found in the empty JSON string", DescribeEndpointGroupRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeEndpointGroupRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeEndpointGroupRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeEndpointGroupRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeEndpointGroupRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeEndpointGroupRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeEndpointGroupRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeEndpointGroupRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeEndpointGroupRequest>() {
           @Override
           public void write(JsonWriter out, DescribeEndpointGroupRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeEndpointGroupRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeEndpointGroupRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeEndpointGroupRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeEndpointGroupRequest
   */
  public static DescribeEndpointGroupRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeEndpointGroupRequest.class);
  }

  /**
   * Convert an instance of DescribeEndpointGroupRequest to an JSON string
   *
   * @return JSON string
   */
