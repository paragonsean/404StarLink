...
public class ListAcceleratorsResponse {
  ...
  public ListAcceleratorsResponse accelerators(List accelerators) {
  ...
  public ListAcceleratorsResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accelerators, listAcceleratorsResponse.accelerators) &&
        Objects.equals(this.nextToken, listAcceleratorsResponse.nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListAcceleratorsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListAcceleratorsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAcceleratorsResponse is not found in the empty JSON string", ListAcceleratorsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListAcceleratorsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListAcceleratorsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAcceleratorsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAcceleratorsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAcceleratorsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAcceleratorsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAcceleratorsResponse>() {
           @Override
           public void write(JsonWriter out, ListAcceleratorsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListAcceleratorsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListAcceleratorsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListAcceleratorsResponse
   * @throws IOException if the JSON string is invalid with respect to ListAcceleratorsResponse
   */
  public static ListAcceleratorsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAcceleratorsResponse.class);
  }

  /**
   * Convert an instance of ListAcceleratorsResponse to an JSON string
   *
   * @return JSON string
   */
