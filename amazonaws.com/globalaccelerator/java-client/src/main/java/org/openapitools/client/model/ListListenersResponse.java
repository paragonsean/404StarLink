...
public class ListListenersResponse {
  ...
  public ListListenersResponse listeners(List listeners) {
  ...
  public ListListenersResponse nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.listeners, listListenersResponse.listeners) &&
        Objects.equals(this.nextToken, listListenersResponse.nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListListenersResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListListenersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListListenersResponse is not found in the empty JSON string", ListListenersResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListListenersResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListListenersResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListListenersResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListListenersResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListListenersResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListListenersResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListListenersResponse>() {
           @Override
           public void write(JsonWriter out, ListListenersResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListListenersResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListListenersResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListListenersResponse
   * @throws IOException if the JSON string is invalid with respect to ListListenersResponse
   */
  public static ListListenersResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListListenersResponse.class);
  }

  /**
   * Convert an instance of ListListenersResponse to an JSON string
   *
   * @return JSON string
   */
