...
public class UpdateCustomRoutingAcceleratorRequest {
  ...
  public UpdateCustomRoutingAcceleratorRequest acceleratorArn(String acceleratorArn) {
  ...
  public UpdateCustomRoutingAcceleratorRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateCustomRoutingAcceleratorRequest ipAddressType(IpAddressType ipAddressType) {
  ...
  public UpdateCustomRoutingAcceleratorRequest enabled(Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateCustomRoutingAcceleratorRequest updateCustomRoutingAcceleratorRequest = (UpdateCustomRoutingAcceleratorRequest) o;
    return Objects.equals(this.acceleratorArn, updateCustomRoutingAcceleratorRequest.acceleratorArn) &&
        Objects.equals(this.name, updateCustomRoutingAcceleratorRequest.name) &&
        Objects.equals(this.ipAddressType, updateCustomRoutingAcceleratorRequest.ipAddressType) &&
        Objects.equals(this.enabled, updateCustomRoutingAcceleratorRequest.enabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateCustomRoutingAcceleratorRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateCustomRoutingAcceleratorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCustomRoutingAcceleratorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateCustomRoutingAcceleratorRequest is not found in the empty JSON string", UpdateCustomRoutingAcceleratorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCustomRoutingAcceleratorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCustomRoutingAcceleratorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateCustomRoutingAcceleratorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateCustomRoutingAcceleratorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateCustomRoutingAcceleratorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateCustomRoutingAcceleratorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateCustomRoutingAcceleratorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateCustomRoutingAcceleratorRequest>() {
           @Override
           public void write(JsonWriter out, UpdateCustomRoutingAcceleratorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateCustomRoutingAcceleratorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateCustomRoutingAcceleratorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateCustomRoutingAcceleratorRequest
   * @throws IOException if the JSON string is invalid with respect to UpdateCustomRoutingAcceleratorRequest
   */
  public static UpdateCustomRoutingAcceleratorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateCustomRoutingAcceleratorRequest.class);
  }

  /**
   * Convert an instance of UpdateCustomRoutingAcceleratorRequest to an JSON string
   *
   * @return JSON string
   */
