...
public class DeprovisionByoipCidrResponse {
  ...
  public DeprovisionByoipCidrResponse byoipCidr(AdvertiseByoipCidrResponseByoipCidr byoipCidr) {
  ...
  public boolean equals(Object o) {
    ...
    DeprovisionByoipCidrResponse deprovisionByoipCidrResponse = (DeprovisionByoipCidrResponse) o;
    return Objects.equals(this.byoipCidr, deprovisionByoipCidrResponse.byoipCidr);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeprovisionByoipCidrResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeprovisionByoipCidrResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeprovisionByoipCidrResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeprovisionByoipCidrResponse is not found in the empty JSON string", DeprovisionByoipCidrResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeprovisionByoipCidrResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeprovisionByoipCidrResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeprovisionByoipCidrResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeprovisionByoipCidrResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeprovisionByoipCidrResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeprovisionByoipCidrResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeprovisionByoipCidrResponse>() {
           @Override
           public void write(JsonWriter out, DeprovisionByoipCidrResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeprovisionByoipCidrResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeprovisionByoipCidrResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeprovisionByoipCidrResponse
   * @throws IOException if the JSON string is invalid with respect to DeprovisionByoipCidrResponse
   */
  public static DeprovisionByoipCidrResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeprovisionByoipCidrResponse.class);
  }

  /**
   * Convert an instance of DeprovisionByoipCidrResponse to an JSON string
   *
   * @return JSON string
   */
