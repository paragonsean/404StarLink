...
public class ListListenersRequest {
  ...
  public ListListenersRequest acceleratorArn(String acceleratorArn) {
  ...
  public ListListenersRequest maxResults(Integer maxResults) {
  ...
  public ListListenersRequest nextToken(String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acceleratorArn, listListenersRequest.acceleratorArn) &&
        Objects.equals(this.maxResults, listListenersRequest.maxResults) &&
        Objects.equals(this.nextToken, listListenersRequest.nextToken);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListListenersRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListListenersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListListenersRequest is not found in the empty JSON string", ListListenersRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListListenersRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListListenersRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListListenersRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListListenersRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListListenersRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListListenersRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListListenersRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListListenersRequest>() {
           @Override
           public void write(JsonWriter out, ListListenersRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListListenersRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListListenersRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListListenersRequest
   * @throws IOException if the JSON string is invalid with respect to ListListenersRequest
   */
  public static ListListenersRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListListenersRequest.class);
  }

  /**
   * Convert an instance of ListListenersRequest to an JSON string
   *
   * @return JSON string
   */
