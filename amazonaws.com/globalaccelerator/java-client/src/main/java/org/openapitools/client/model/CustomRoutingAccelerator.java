...
public class CustomRoutingAccelerator {
  ...
  public CustomRoutingAccelerator acceleratorArn(String acceleratorArn) {
  ...
  public CustomRoutingAccelerator name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CustomRoutingAccelerator ipAddressType(IpAddressType ipAddressType) {
  ...
  public CustomRoutingAccelerator enabled(Boolean enabled) {
  ...
  public CustomRoutingAccelerator ipSets(List ipSets) {
    this.ipSets = ipSets;
    return this;
  }
  ...
  public CustomRoutingAccelerator dnsName(String dnsName) {
  ...
  public CustomRoutingAccelerator status(CustomRoutingAcceleratorStatus status) {
    this.status = status;
    return this;
  }
  ...
  public CustomRoutingAccelerator createdTime(OffsetDateTime createdTime) {
  ...
  public CustomRoutingAccelerator lastModifiedTime(OffsetDateTime lastModifiedTime) {
  ...
  public boolean equals(Object o) {
    ...
    CustomRoutingAccelerator customRoutingAccelerator = (CustomRoutingAccelerator) o;
    return Objects.equals(this.acceleratorArn, customRoutingAccelerator.acceleratorArn) &&
        Objects.equals(this.name, customRoutingAccelerator.name) &&
        Objects.equals(this.ipAddressType, customRoutingAccelerator.ipAddressType) &&
        Objects.equals(this.enabled, customRoutingAccelerator.enabled) &&
        Objects.equals(this.ipSets, customRoutingAccelerator.ipSets) &&
        Objects.equals(this.dnsName, customRoutingAccelerator.dnsName) &&
        Objects.equals(this.status, customRoutingAccelerator.status) &&
        Objects.equals(this.createdTime, customRoutingAccelerator.createdTime) &&
        Objects.equals(this.lastModifiedTime, customRoutingAccelerator.lastModifiedTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomRoutingAccelerator {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomRoutingAccelerator
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomRoutingAccelerator.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomRoutingAccelerator is not found in the empty JSON string", CustomRoutingAccelerator.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomRoutingAccelerator.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomRoutingAccelerator` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomRoutingAccelerator.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomRoutingAccelerator' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomRoutingAccelerator> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomRoutingAccelerator.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomRoutingAccelerator>() {
           @Override
           public void write(JsonWriter out, CustomRoutingAccelerator value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomRoutingAccelerator read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomRoutingAccelerator given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomRoutingAccelerator
   * @throws IOException if the JSON string is invalid with respect to CustomRoutingAccelerator
   */
  public static CustomRoutingAccelerator fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomRoutingAccelerator.class);
  }

  /**
   * Convert an instance of CustomRoutingAccelerator to an JSON string
   *
   * @return JSON string
   */
