...
public class CustomRoutingDestinationDescription {
  ...
  public CustomRoutingDestinationDescription fromPort(Integer fromPort) {
  ...
  public CustomRoutingDestinationDescription toPort(Integer toPort) {
    this.toPort = toPort;
    return this;
  }
  ...
  public CustomRoutingDestinationDescription protocols(List protocols) {
  ...
  public boolean equals(Object o) {
    ...
    CustomRoutingDestinationDescription customRoutingDestinationDescription = (CustomRoutingDestinationDescription) o;
    return Objects.equals(this.fromPort, customRoutingDestinationDescription.fromPort) &&
        Objects.equals(this.toPort, customRoutingDestinationDescription.toPort) &&
        Objects.equals(this.protocols, customRoutingDestinationDescription.protocols);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomRoutingDestinationDescription {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomRoutingDestinationDescription
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomRoutingDestinationDescription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomRoutingDestinationDescription is not found in the empty JSON string", CustomRoutingDestinationDescription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomRoutingDestinationDescription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomRoutingDestinationDescription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomRoutingDestinationDescription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomRoutingDestinationDescription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomRoutingDestinationDescription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomRoutingDestinationDescription.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomRoutingDestinationDescription>() {
           @Override
           public void write(JsonWriter out, CustomRoutingDestinationDescription value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomRoutingDestinationDescription read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomRoutingDestinationDescription given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomRoutingDestinationDescription
   * @throws IOException if the JSON string is invalid with respect to CustomRoutingDestinationDescription
   */
  public static CustomRoutingDestinationDescription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomRoutingDestinationDescription.class);
  }

  /**
   * Convert an instance of CustomRoutingDestinationDescription to an JSON string
   *
   * @return JSON string
   */
