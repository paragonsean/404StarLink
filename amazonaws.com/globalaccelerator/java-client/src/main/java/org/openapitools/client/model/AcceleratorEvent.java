...
public class AcceleratorEvent {
  ...
  public AcceleratorEvent message(String message) {
  ...
  public AcceleratorEvent timestamp(OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    AcceleratorEvent acceleratorEvent = (AcceleratorEvent) o;
    return Objects.equals(this.message, acceleratorEvent.message) &&
        Objects.equals(this.timestamp, acceleratorEvent.timestamp);
  }
  ...
  public String toString() {
    ...
    sb.append("class AcceleratorEvent {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AcceleratorEvent
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AcceleratorEvent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AcceleratorEvent is not found in the empty JSON string", AcceleratorEvent.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AcceleratorEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AcceleratorEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AcceleratorEvent.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AcceleratorEvent' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AcceleratorEvent> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AcceleratorEvent.class));

       return (TypeAdapter<T>) new TypeAdapter<AcceleratorEvent>() {
           @Override
           public void write(JsonWriter out, AcceleratorEvent value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AcceleratorEvent read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AcceleratorEvent given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AcceleratorEvent
   * @throws IOException if the JSON string is invalid with respect to AcceleratorEvent
   */
  public static AcceleratorEvent fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AcceleratorEvent.class);
  }

  /**
   * Convert an instance of AcceleratorEvent to an JSON string
   *
   * @return JSON string
   */
