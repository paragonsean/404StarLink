...
public class DescribeAcceleratorRequest {
  ...
  public DescribeAcceleratorRequest acceleratorArn(String acceleratorArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acceleratorArn, describeAcceleratorRequest.acceleratorArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAcceleratorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAcceleratorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAcceleratorRequest is not found in the empty JSON string", DescribeAcceleratorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAcceleratorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAcceleratorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeAcceleratorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAcceleratorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAcceleratorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAcceleratorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAcceleratorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAcceleratorRequest>() {
           @Override
           public void write(JsonWriter out, DescribeAcceleratorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAcceleratorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAcceleratorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAcceleratorRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeAcceleratorRequest
   */
  public static DescribeAcceleratorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAcceleratorRequest.class);
  }

  /**
   * Convert an instance of DescribeAcceleratorRequest to an JSON string
   *
   * @return JSON string
   */
