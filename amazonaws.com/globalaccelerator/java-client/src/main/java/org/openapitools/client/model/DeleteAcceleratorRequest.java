...
public class DeleteAcceleratorRequest {
  ...
  public DeleteAcceleratorRequest acceleratorArn(String acceleratorArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.acceleratorArn, deleteAcceleratorRequest.acceleratorArn);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteAcceleratorRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteAcceleratorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteAcceleratorRequest is not found in the empty JSON string", DeleteAcceleratorRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteAcceleratorRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteAcceleratorRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteAcceleratorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteAcceleratorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteAcceleratorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteAcceleratorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteAcceleratorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteAcceleratorRequest>() {
           @Override
           public void write(JsonWriter out, DeleteAcceleratorRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteAcceleratorRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteAcceleratorRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteAcceleratorRequest
   * @throws IOException if the JSON string is invalid with respect to DeleteAcceleratorRequest
   */
  public static DeleteAcceleratorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteAcceleratorRequest.class);
  }

  /**
   * Convert an instance of DeleteAcceleratorRequest to an JSON string
   *
   * @return JSON string
   */
