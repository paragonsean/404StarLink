...
class StartReplicationRequest(BaseModel):
    ...
    """ # noqa: E501
    source_server_id: Annotated[str, Field(min_length=19, strict=True, max_length=19)] = Field(description="ID of source server on which to start replication.", alias="sourceServerID")
