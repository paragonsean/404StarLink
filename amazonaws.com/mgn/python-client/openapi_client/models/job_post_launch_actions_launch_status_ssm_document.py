...
class JobPostLaunchActionsLaunchStatusSsmDocument(BaseModel):
    """
    JobPostLaunchActionsLaunchStatusSsmDocument
    """ # noqa: E501
    action_name: Any = Field(alias="actionName")
    ...
    ssm_document_name: Any = Field(alias="ssmDocumentName")
    timeout_seconds: Optional[Any] = Field(default=None, alias="timeoutSeconds")
    __properties: ClassVar[List[str]] = ["actionName", "externalParameters", "mustSucceedForCutover", "parameters", "ssmDocumentName", "timeoutSeconds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ssmDocumentName": obj.get("ssmDocumentName"),
