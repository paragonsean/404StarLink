...
class MarkAsArchivedRequest(BaseModel):
    ...
    """ # noqa: E501
    source_server_id: Annotated[str, Field(min_length=19, strict=True, max_length=19)] = Field(description="Mark as archived by Source Server ID.", alias="sourceServerID")
