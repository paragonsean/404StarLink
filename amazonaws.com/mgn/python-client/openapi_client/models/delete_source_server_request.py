...
class DeleteSourceServerRequest(BaseModel):
    ...
    """ # noqa: E501
    source_server_id: Annotated[str, Field(min_length=19, strict=True, max_length=19)] = Field(description="Request to delete Source Server from service by Server ID.", alias="sourceServerID")
