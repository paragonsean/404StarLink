...
class TemplateActionDocument(BaseModel):
    ...
    operating_system: Optional[Any] = Field(default=None, alias="operatingSystem")
    order: Optional[Any] = None
    parameters: Optional[Any] = None
    timeout_seconds: Optional[Any] = Field(default=None, alias="timeoutSeconds")
    __properties: ClassVar[List[str]] = ["actionID", "actionName", "active", "category", "description", "documentIdentifier", "documentVersion", "externalParameters", "mustSucceedForCutover", "operatingSystem", "order", "parameters", "timeoutSeconds"]
