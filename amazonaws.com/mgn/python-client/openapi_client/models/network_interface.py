...
class NetworkInterface(BaseModel):
    ...
    is_primary: Optional[Any] = Field(default=None, alias="isPrimary")
    mac_address: Optional[Any] = Field(default=None, alias="macAddress")
    __properties: ClassVar[List[str]] = ["ips", "isPrimary", "macAddress"]
