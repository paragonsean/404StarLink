...
class ImportTaskErrorErrorData(BaseModel):
    """
    ...
    row_number: Optional[Any] = Field(default=None, alias="rowNumber")
    ...
    __properties: ClassVar[List[str]] = ["applicationID", "ec2LaunchTemplateID", "rawError", "rowNumber", "sourceServerID", "waveID"]
