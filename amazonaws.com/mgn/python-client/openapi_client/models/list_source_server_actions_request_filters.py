...
class ListSourceServerActionsRequestFilters(BaseModel):
    """
    ListSourceServerActionsRequestFilters
    """ # noqa: E501
    action_ids: Optional[Any] = Field(default=None, alias="actionIDs")
    __properties: ClassVar[List[str]] = ["actionIDs"]
