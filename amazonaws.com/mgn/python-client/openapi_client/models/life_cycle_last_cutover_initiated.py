...
class LifeCycleLastCutoverInitiated(BaseModel):
    ...
    """ # noqa: E501
    api_call_date_time: Optional[Any] = Field(default=None, alias="apiCallDateTime")
    job_id: Optional[Any] = Field(default=None, alias="jobID")
    __properties: ClassVar[List[str]] = ["apiCallDateTime", "jobID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apiCallDateTime": obj.get("apiCallDateTime"),
            "jobID": obj.get("jobID")
        })
        return _obj
