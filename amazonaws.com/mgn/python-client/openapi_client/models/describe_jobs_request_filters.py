...
class DescribeJobsRequestFilters(BaseModel):
    ...
    """ # noqa: E501
    from_date: Optional[Any] = Field(default=None, alias="fromDate")
    job_ids: Optional[Any] = Field(default=None, alias="jobIDs")
    to_date: Optional[Any] = Field(default=None, alias="toDate")
    __properties: ClassVar[List[str]] = ["fromDate", "jobIDs", "toDate"]
