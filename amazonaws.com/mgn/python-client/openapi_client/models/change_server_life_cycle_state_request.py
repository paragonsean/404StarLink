...
class ChangeServerLifeCycleStateRequest(BaseModel):
    ...
    """ # noqa: E501
    life_cycle: ChangeServerLifeCycleStateRequestLifeCycle = Field(alias="lifeCycle")
    source_server_id: Annotated[str, Field(min_length=19, strict=True, max_length=19)] = Field(description="The request to change the source server migration lifecycle state by source server ID.", alias="sourceServerID")
    __properties: ClassVar[List[str]] = ["lifeCycle", "sourceServerID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lifeCycle": ChangeServerLifeCycleStateRequestLifeCycle.from_dict(obj["lifeCycle"]) if obj.get("lifeCycle") is not None else None,
