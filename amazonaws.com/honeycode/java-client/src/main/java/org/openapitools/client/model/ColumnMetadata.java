...
public class ColumnMetadata {
  ...
  public ColumnMetadata format(Format format) {
    this.format = format;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, columnMetadata.name) &&
        Objects.equals(this.format, columnMetadata.format);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ColumnMetadata
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColumnMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ColumnMetadata.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ColumnMetadata` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
