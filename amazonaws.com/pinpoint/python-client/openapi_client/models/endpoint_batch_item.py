...
class EndpointBatchItem(BaseModel):
    ...
    user: Optional[UpdateEndpointRequestEndpointRequestUser] = Field(default=None, alias="User")
    __properties: ClassVar[List[str]] = ["Address", "Attributes", "ChannelType", "Demographic", "EffectiveDate", "EndpointStatus", "Id", "Location", "Metrics", "OptOut", "RequestId", "User"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "User": UpdateEndpointRequestEndpointRequestUser.from_dict(obj["User"]) if obj.get("User") is not None else None
        })
        return _obj
