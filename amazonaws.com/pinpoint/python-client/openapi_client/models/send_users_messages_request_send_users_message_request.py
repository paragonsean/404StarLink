...
class SendUsersMessagesRequestSendUsersMessageRequest(BaseModel):
    """
    ...
    users: Optional[Any] = Field(default=None, alias="Users")
    __properties: ClassVar[List[str]] = ["Context", "MessageConfiguration", "TemplateConfiguration", "TraceId", "Users"]
