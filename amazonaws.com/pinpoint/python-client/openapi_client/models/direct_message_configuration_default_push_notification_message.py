...
class DirectMessageConfigurationDefaultPushNotificationMessage(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Action", "Body", "Data", "SilentPush", "Substitutions", "Title", "Url"]
