...
class UpdateVoiceTemplateRequestVoiceTemplateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Body", "DefaultSubstitutions", "LanguageCode", "tags", "TemplateDescription", "VoiceId"]
