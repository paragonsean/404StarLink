...
class SegmentResponseImportDefinition(BaseModel):
    """
    SegmentResponseImportDefinition
    """ # noqa: E501
    channel_counts: Optional[Any] = Field(default=None, alias="ChannelCounts")
    ...
    __properties: ClassVar[List[str]] = ["ChannelCounts", "ExternalId", "Format", "RoleArn", "S3Url", "Size"]
