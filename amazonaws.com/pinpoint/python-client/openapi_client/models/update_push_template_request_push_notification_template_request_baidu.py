...
class UpdatePushTemplateRequestPushNotificationTemplateRequestBaidu(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Action", "Body", "ImageIconUrl", "ImageUrl", "RawContent", "SmallImageIconUrl", "Sound", "Title", "Url"]
