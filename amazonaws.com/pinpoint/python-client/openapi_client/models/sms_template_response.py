...
class SMSTemplateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Arn", "Body", "CreationDate", "DefaultSubstitutions", "LastModifiedDate", "RecommenderId", "tags", "TemplateDescription", "TemplateName", "TemplateType", "Version"]
