...
class UpdateSmsTemplateRequestSMSTemplateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Body", "DefaultSubstitutions", "RecommenderId", "tags", "TemplateDescription"]
