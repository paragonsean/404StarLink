...
class CreateRecommenderConfigurationRequestCreateRecommenderConfiguration(BaseModel):
    """
    ...
    recommendation_provider_role_arn: Optional[Any] = Field(default=None, alias="RecommendationProviderRoleArn")
    recommendation_provider_uri: Optional[Any] = Field(default=None, alias="RecommendationProviderUri")
