...
class ConditionalSplitActivityCondition(BaseModel):
    """
    ConditionalSplitActivityCondition
    """ # noqa: E501
    conditions: Optional[Any] = Field(default=None, alias="Conditions")
    operator: Optional[Any] = Field(default=None, alias="Operator")
