...
class DirectMessageConfigurationBaiduMessage(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Action", "Body", "Data", "IconReference", "ImageIconUrl", "ImageUrl", "RawContent", "SilentPush", "SmallImageIconUrl", "Sound", "Substitutions", "TimeToLive", "Title", "Url"]
