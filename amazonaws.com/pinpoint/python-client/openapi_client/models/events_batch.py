...
class EventsBatch(BaseModel):
    ...
    """ # noqa: E501
    endpoint: EventsBatchEndpoint = Field(alias="Endpoint")
    events: Any = Field(alias="Events")
    __properties: ClassVar[List[str]] = ["Endpoint", "Events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Endpoint": EventsBatchEndpoint.from_dict(obj["Endpoint"]) if obj.get("Endpoint") is not None else None,
