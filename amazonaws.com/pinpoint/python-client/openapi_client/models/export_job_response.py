...
class ExportJobResponse(BaseModel):
    ...
    definition: ExportJobResponseDefinition = Field(alias="Definition")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Definition": ExportJobResponseDefinition.from_dict(obj["Definition"]) if obj.get("Definition") is not None else None,
