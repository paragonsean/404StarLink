...
class BaiduChannelResponse(BaseModel):
    ...
    credential: Any = Field(alias="Credential")
    ...
    __properties: ClassVar[List[str]] = ["ApplicationId", "CreationDate", "Credential", "Enabled", "HasCredential", "Id", "IsArchived", "LastModifiedBy", "LastModifiedDate", "Platform", "Version"]
