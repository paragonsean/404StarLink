...
class SimpleConditionEventCondition(BaseModel):
    """
    SimpleConditionEventCondition
    """ # noqa: E501
    dimensions: Optional[EventConditionDimensions] = Field(default=None, alias="Dimensions")
    message_activity: Optional[Any] = Field(default=None, alias="MessageActivity")
    __properties: ClassVar[List[str]] = ["Dimensions", "MessageActivity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Dimensions": EventConditionDimensions.from_dict(obj["Dimensions"]) if obj.get("Dimensions") is not None else None,
            "MessageActivity": obj.get("MessageActivity")
        })
        return _obj
