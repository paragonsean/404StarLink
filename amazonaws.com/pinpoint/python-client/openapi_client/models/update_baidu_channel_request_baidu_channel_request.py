...
class UpdateBaiduChannelRequestBaiduChannelRequest(BaseModel):
    """
    Specifies the status and settings of the Baidu (Baidu Cloud Push) channel for an application.
    """ # noqa: E501
    api_key: Optional[Any] = Field(default=None, alias="ApiKey")
    enabled: Optional[Any] = Field(default=None, alias="Enabled")
    secret_key: Optional[Any] = Field(default=None, alias="SecretKey")
    __properties: ClassVar[List[str]] = ["ApiKey", "Enabled", "SecretKey"]
