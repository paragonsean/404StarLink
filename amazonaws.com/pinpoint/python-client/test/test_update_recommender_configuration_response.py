...
class TestUpdateRecommenderConfigurationResponse(unittest.TestCase):
    """UpdateRecommenderConfigurationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateRecommenderConfigurationResponse:
        """Test UpdateRecommenderConfigurationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateRecommenderConfigurationResponse`
        """
        model = UpdateRecommenderConfigurationResponse()
        if include_optional:
    ...
    def testUpdateRecommenderConfigurationResponse(self):
        """Test UpdateRecommenderConfigurationResponse"""
