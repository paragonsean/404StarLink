...
class TestGetRecommenderConfigurationResponse(unittest.TestCase):
    """GetRecommenderConfigurationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetRecommenderConfigurationResponse:
        """Test GetRecommenderConfigurationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetRecommenderConfigurationResponse`
        """
        model = GetRecommenderConfigurationResponse()
        if include_optional:
    ...
    def testGetRecommenderConfigurationResponse(self):
        """Test GetRecommenderConfigurationResponse"""
