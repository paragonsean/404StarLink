...
class InvokeDeviceMethodResponse(BaseModel):
    ...
    """ # noqa: E501
    device_method_response: Optional[Any] = Field(default=None, alias="DeviceMethodResponse")
    __properties: ClassVar[List[str]] = ["DeviceMethodResponse"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "DeviceMethodResponse": obj.get("DeviceMethodResponse")
        })
        return _obj
