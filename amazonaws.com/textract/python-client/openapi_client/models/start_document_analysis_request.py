...
class StartDocumentAnalysisRequest(BaseModel):
    ...
    output_config: Optional[StartDocumentAnalysisRequestOutputConfig] = Field(default=None, alias="OutputConfig")
    kms_key_id: Optional[Any] = Field(default=None, alias="KMSKeyId")
    queries_config: Optional[QueriesConfig] = Field(default=None, alias="QueriesConfig")
    __properties: ClassVar[List[str]] = ["DocumentLocation", "FeatureTypes", "ClientRequestToken", "JobTag", "NotificationChannel", "OutputConfig", "KMSKeyId", "QueriesConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "OutputConfig": StartDocumentAnalysisRequestOutputConfig.from_dict(obj["OutputConfig"]) if obj.get("OutputConfig") is not None else None,
            "KMSKeyId": obj.get("KMSKeyId"),
            "QueriesConfig": QueriesConfig.from_dict(obj["QueriesConfig"]) if obj.get("QueriesConfig") is not None else None
        })
        return _obj
