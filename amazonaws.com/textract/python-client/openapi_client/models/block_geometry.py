...
class BlockGeometry(BaseModel):
    ...
    BlockGeometry
    """ # noqa: E501
    bounding_box: Optional[GeometryBoundingBox] = Field(default=None, alias="BoundingBox")
    polygon: Optional[Any] = Field(default=None, alias="Polygon")
    __properties: ClassVar[List[str]] = ["BoundingBox", "Polygon"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "BoundingBox": GeometryBoundingBox.from_dict(obj["BoundingBox"]) if obj.get("BoundingBox") is not None else None,
