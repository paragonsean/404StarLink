...
class GetExpenseAnalysisResponse(BaseModel):
    ...
    """ # noqa: E501
    document_metadata: Optional[GetExpenseAnalysisResponseDocumentMetadata] = Field(default=None, alias="DocumentMetadata")
    job_status: Optional[Any] = Field(default=None, alias="JobStatus")
    next_token: Optional[Any] = Field(default=None, alias="NextToken")
    expense_documents: Optional[Any] = Field(default=None, alias="ExpenseDocuments")
    ...
    analyze_expense_model_version: Optional[Any] = Field(default=None, alias="AnalyzeExpenseModelVersion")
    __properties: ClassVar[List[str]] = ["DocumentMetadata", "JobStatus", "NextToken", "ExpenseDocuments", "Warnings", "StatusMessage", "AnalyzeExpenseModelVersion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "DocumentMetadata": GetExpenseAnalysisResponseDocumentMetadata.from_dict(obj["DocumentMetadata"]) if obj.get("DocumentMetadata") is not None else None,
            "JobStatus": JobStatus.from_dict(obj["JobStatus"]) if obj.get("JobStatus") is not None else None,
            "NextToken": obj.get("NextToken"),
            "ExpenseDocuments": obj.get("ExpenseDocuments"),
            "Warnings": obj.get("Warnings"),
            "StatusMessage": obj.get("StatusMessage"),
            "AnalyzeExpenseModelVersion": obj.get("AnalyzeExpenseModelVersion")
        })
        return _obj
