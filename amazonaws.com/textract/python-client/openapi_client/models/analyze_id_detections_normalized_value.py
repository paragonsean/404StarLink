...
class AnalyzeIDDetectionsNormalizedValue(BaseModel):
    """
    AnalyzeIDDetectionsNormalizedValue
    """ # noqa: E501
    value: Optional[Any] = Field(default=None, alias="Value")
    value_type: Optional[Any] = Field(default=None, alias="ValueType")
    __properties: ClassVar[List[str]] = ["Value", "ValueType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Value": obj.get("Value"),
            "ValueType": ValueType.from_dict(obj["ValueType"]) if obj.get("ValueType") is not None else None
        })
        return _obj
