...
class StartLendingAnalysisRequest(BaseModel):
    ...
    """ # noqa: E501
    document_location: DocumentLocation = Field(alias="DocumentLocation")
    ...
    notification_channel: Optional[NotificationChannel] = Field(default=None, alias="NotificationChannel")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "DocumentLocation": DocumentLocation.from_dict(obj["DocumentLocation"]) if obj.get("DocumentLocation") is not None else None,
