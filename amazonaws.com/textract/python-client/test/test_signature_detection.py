...
class TestSignatureDetection(unittest.TestCase):
    """SignatureDetection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignatureDetection:
        """Test SignatureDetection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignatureDetection`
        """
    ...
    def testSignatureDetection(self):
        """Test SignatureDetection"""
