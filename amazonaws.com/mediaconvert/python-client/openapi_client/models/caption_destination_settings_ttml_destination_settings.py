...
class CaptionDestinationSettingsTtmlDestinationSettings(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "StylePassthrough": TtmlStylePassthrough.from_dict(obj["StylePassthrough"]) if obj.get("StylePassthrough") is not None else None
        })
        return _obj
