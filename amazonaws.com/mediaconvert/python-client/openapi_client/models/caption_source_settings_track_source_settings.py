...
class CaptionSourceSettingsTrackSourceSettings(BaseModel):
    """
    CaptionSourceSettingsTrackSourceSettings
    """ # noqa: E501
    track_number: Optional[Any] = Field(default=None, alias="TrackNumber")
    __properties: ClassVar[List[str]] = ["TrackNumber"]
