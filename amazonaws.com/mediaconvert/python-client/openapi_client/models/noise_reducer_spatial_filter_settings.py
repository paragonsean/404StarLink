...
class NoiseReducerSpatialFilterSettings(BaseModel):
    ...
    """ # noqa: E501
    post_filter_sharpen_strength: Optional[Any] = Field(default=None, alias="PostFilterSharpenStrength")
    speed: Optional[Any] = Field(default=None, alias="Speed")
    strength: Optional[Any] = Field(default=None, alias="Strength")
    __properties: ClassVar[List[str]] = ["PostFilterSharpenStrength", "Speed", "Strength"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PostFilterSharpenStrength": obj.get("PostFilterSharpenStrength"),
            "Speed": obj.get("Speed"),
