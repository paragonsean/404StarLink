...
class EsamSettingsSignalProcessingNotification(BaseModel):
    """
    EsamSettingsSignalProcessingNotification
    """ # noqa: E501
    scc_xml: Optional[Any] = Field(default=None, alias="SccXml")
    __properties: ClassVar[List[str]] = ["SccXml"]
