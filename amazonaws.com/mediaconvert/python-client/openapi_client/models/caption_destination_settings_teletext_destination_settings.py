...
class CaptionDestinationSettingsTeletextDestinationSettings(BaseModel):
    """
    CaptionDestinationSettingsTeletextDestinationSettings
    """ # noqa: E501
    page_number: Optional[Any] = Field(default=None, alias="PageNumber")
    page_types: Optional[Any] = Field(default=None, alias="PageTypes")
    __properties: ClassVar[List[str]] = ["PageNumber", "PageTypes"]
