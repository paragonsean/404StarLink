...
class JobTiming(BaseModel):
    ...
    JobTiming
    """ # noqa: E501
    finish_time: Optional[Any] = Field(default=None, alias="FinishTime")
    start_time: Optional[Any] = Field(default=None, alias="StartTime")
    submit_time: Optional[Any] = Field(default=None, alias="SubmitTime")
    __properties: ClassVar[List[str]] = ["FinishTime", "StartTime", "SubmitTime"]
