...
class EsamSettingsManifestConfirmConditionNotification(BaseModel):
    """
    EsamSettingsManifestConfirmConditionNotification
    """ # noqa: E501
    mcc_xml: Optional[Any] = Field(default=None, alias="MccXml")
    __properties: ClassVar[List[str]] = ["MccXml"]
