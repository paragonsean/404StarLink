...
class VideoPreprocessorImageInserter(BaseModel):
    """
    VideoPreprocessorImageInserter
    """ # noqa: E501
    insertable_images: Optional[Any] = Field(default=None, alias="InsertableImages")
    sdr_reference_white_level: Optional[Any] = Field(default=None, alias="SdrReferenceWhiteLevel")
    __properties: ClassVar[List[str]] = ["InsertableImages", "SdrReferenceWhiteLevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "InsertableImages": obj.get("InsertableImages"),
