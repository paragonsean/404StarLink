...
class CreateJobRequestSettingsTimedMetadataInsertion(BaseModel):
    """
    CreateJobRequestSettingsTimedMetadataInsertion
    """ # noqa: E501
    id3_insertions: Optional[Any] = Field(default=None, alias="Id3Insertions")
    __properties: ClassVar[List[str]] = ["Id3Insertions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Id3Insertions": obj.get("Id3Insertions")
        })
        return _obj
