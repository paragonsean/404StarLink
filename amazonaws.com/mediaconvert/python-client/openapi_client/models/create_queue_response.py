...
class CreateQueueResponse(BaseModel):
    ...
    CreateQueueResponse
    """ # noqa: E501
    queue: Optional[CreateQueueResponseQueue] = Field(default=None, alias="Queue")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Queue": CreateQueueResponseQueue.from_dict(obj["Queue"]) if obj.get("Queue") is not None else None
        })
        return _obj
