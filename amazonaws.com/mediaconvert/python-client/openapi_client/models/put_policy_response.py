...
class PutPolicyResponse(BaseModel):
    ...
    PutPolicyResponse
    """ # noqa: E501
    policy: Optional[GetPolicyResponsePolicy] = Field(default=None, alias="Policy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Policy": GetPolicyResponsePolicy.from_dict(obj["Policy"]) if obj.get("Policy") is not None else None
        })
        return _obj
