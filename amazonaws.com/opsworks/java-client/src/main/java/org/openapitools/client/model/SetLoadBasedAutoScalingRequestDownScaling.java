...
public class SetLoadBasedAutoScalingRequestDownScaling {
  ...
  public SetLoadBasedAutoScalingRequestDownScaling() {
  }

  public SetLoadBasedAutoScalingRequestDownScaling instanceCount(Integer instanceCount) {
  ...
  public SetLoadBasedAutoScalingRequestDownScaling thresholdsWaitTime(Integer thresholdsWaitTime) {
  ...
  public SetLoadBasedAutoScalingRequestDownScaling ignoreMetricsTime(Integer ignoreMetricsTime) {
  ...
  public SetLoadBasedAutoScalingRequestDownScaling cpuThreshold(Double cpuThreshold) {
  ...
  public SetLoadBasedAutoScalingRequestDownScaling memoryThreshold(Double memoryThreshold) {
  ...
  public SetLoadBasedAutoScalingRequestDownScaling loadThreshold(Double loadThreshold) {
  ...
  public SetLoadBasedAutoScalingRequestDownScaling alarms(List alarms) {
    this.alarms = alarms;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SetLoadBasedAutoScalingRequestDownScaling setLoadBasedAutoScalingRequestDownScaling = (SetLoadBasedAutoScalingRequestDownScaling) o;
    return Objects.equals(this.instanceCount, setLoadBasedAutoScalingRequestDownScaling.instanceCount) &&
        Objects.equals(this.thresholdsWaitTime, setLoadBasedAutoScalingRequestDownScaling.thresholdsWaitTime) &&
        Objects.equals(this.ignoreMetricsTime, setLoadBasedAutoScalingRequestDownScaling.ignoreMetricsTime) &&
        Objects.equals(this.cpuThreshold, setLoadBasedAutoScalingRequestDownScaling.cpuThreshold) &&
        Objects.equals(this.memoryThreshold, setLoadBasedAutoScalingRequestDownScaling.memoryThreshold) &&
        Objects.equals(this.loadThreshold, setLoadBasedAutoScalingRequestDownScaling.loadThreshold) &&
        Objects.equals(this.alarms, setLoadBasedAutoScalingRequestDownScaling.alarms);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetLoadBasedAutoScalingRequestDownScaling {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetLoadBasedAutoScalingRequestDownScaling
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetLoadBasedAutoScalingRequestDownScaling.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetLoadBasedAutoScalingRequestDownScaling is not found in the empty JSON string", SetLoadBasedAutoScalingRequestDownScaling.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetLoadBasedAutoScalingRequestDownScaling.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetLoadBasedAutoScalingRequestDownScaling` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetLoadBasedAutoScalingRequestDownScaling.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetLoadBasedAutoScalingRequestDownScaling' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetLoadBasedAutoScalingRequestDownScaling> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetLoadBasedAutoScalingRequestDownScaling.class));

       return (TypeAdapter<T>) new TypeAdapter<SetLoadBasedAutoScalingRequestDownScaling>() {
           @Override
           public void write(JsonWriter out, SetLoadBasedAutoScalingRequestDownScaling value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetLoadBasedAutoScalingRequestDownScaling read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetLoadBasedAutoScalingRequestDownScaling given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetLoadBasedAutoScalingRequestDownScaling
   * @throws IOException if the JSON string is invalid with respect to SetLoadBasedAutoScalingRequestDownScaling
   */
  public static SetLoadBasedAutoScalingRequestDownScaling fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetLoadBasedAutoScalingRequestDownScaling.class);
  }

  /**
   * Convert an instance of SetLoadBasedAutoScalingRequestDownScaling to an JSON string
   *
   * @return JSON string
   */
