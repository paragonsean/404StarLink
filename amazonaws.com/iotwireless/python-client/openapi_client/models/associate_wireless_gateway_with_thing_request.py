...
class AssociateWirelessGatewayWithThingRequest(BaseModel):
    ...
    """ # noqa: E501
    thing_arn: StrictStr = Field(description="The ARN of the thing to associate with the wireless gateway.", alias="ThingArn")
    __properties: ClassVar[List[str]] = ["ThingArn"]
