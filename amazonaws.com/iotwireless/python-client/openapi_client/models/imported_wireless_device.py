...
class ImportedWirelessDevice(BaseModel):
    ...
    """ # noqa: E501
    sidewalk: Optional[ImportedWirelessDeviceSidewalk] = Field(default=None, alias="Sidewalk")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Sidewalk": ImportedWirelessDeviceSidewalk.from_dict(obj["Sidewalk"]) if obj.get("Sidewalk") is not None else None
        })
        return _obj
