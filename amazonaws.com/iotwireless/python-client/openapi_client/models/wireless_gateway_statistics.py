...
class WirelessGatewayStatistics(BaseModel):
    ...
    lo_ra_wan: Optional[WirelessGatewayStatisticsLoRaWAN] = Field(default=None, alias="LoRaWAN")
    last_uplink_received_at: Optional[Any] = Field(default=None, alias="LastUplinkReceivedAt")
    __properties: ClassVar[List[str]] = ["Arn", "Id", "Name", "Description", "LoRaWAN", "LastUplinkReceivedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LoRaWAN": WirelessGatewayStatisticsLoRaWAN.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None,
