...
class UpdateWirelessDeviceImportTaskRequest(BaseModel):
    ...
    """ # noqa: E501
    sidewalk: UpdateWirelessDeviceImportTaskRequestSidewalk = Field(alias="Sidewalk")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Sidewalk": UpdateWirelessDeviceImportTaskRequestSidewalk.from_dict(obj["Sidewalk"]) if obj.get("Sidewalk") is not None else None
        })
        return _obj
