...
class GatewayListItem(BaseModel):
    ...
    """ # noqa: E501
    gateway_id: Any = Field(alias="GatewayId")
    downlink_frequency: Any = Field(alias="DownlinkFrequency")
    __properties: ClassVar[List[str]] = ["GatewayId", "DownlinkFrequency"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DownlinkFrequency": obj.get("DownlinkFrequency")
        })
        return _obj
