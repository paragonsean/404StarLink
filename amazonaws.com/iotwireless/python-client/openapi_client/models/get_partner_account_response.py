...
class GetPartnerAccountResponse(BaseModel):
    ...
    """ # noqa: E501
    sidewalk: Optional[GetPartnerAccountResponseSidewalk] = Field(default=None, alias="Sidewalk")
    account_linked: Optional[Any] = Field(default=None, alias="AccountLinked")
    __properties: ClassVar[List[str]] = ["Sidewalk", "AccountLinked"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Sidewalk": GetPartnerAccountResponseSidewalk.from_dict(obj["Sidewalk"]) if obj.get("Sidewalk") is not None else None,
            "AccountLinked": obj.get("AccountLinked")
        })
        return _obj
