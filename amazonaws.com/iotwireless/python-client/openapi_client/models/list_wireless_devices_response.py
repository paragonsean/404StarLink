...
class ListWirelessDevicesResponse(BaseModel):
    ...
    wireless_device_list: Optional[Any] = Field(default=None, alias="WirelessDeviceList")
    __properties: ClassVar[List[str]] = ["NextToken", "WirelessDeviceList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "WirelessDeviceList": obj.get("WirelessDeviceList")
        })
        return _obj
