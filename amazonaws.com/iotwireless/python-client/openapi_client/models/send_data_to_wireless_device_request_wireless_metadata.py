...
class SendDataToWirelessDeviceRequestWirelessMetadata(BaseModel):
    """
    SendDataToWirelessDeviceRequestWirelessMetadata
    """ # noqa: E501
    lo_ra_wan: Optional[SendDataToWirelessDeviceRequestWirelessMetadataLoRaWAN] = Field(default=None, alias="LoRaWAN")
    sidewalk: Optional[SendDataToWirelessDeviceRequestWirelessMetadataSidewalk] = Field(default=None, alias="Sidewalk")
    __properties: ClassVar[List[str]] = ["LoRaWAN", "Sidewalk"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LoRaWAN": SendDataToWirelessDeviceRequestWirelessMetadataLoRaWAN.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None,
            "Sidewalk": SendDataToWirelessDeviceRequestWirelessMetadataSidewalk.from_dict(obj["Sidewalk"]) if obj.get("Sidewalk") is not None else None
        })
        return _obj
