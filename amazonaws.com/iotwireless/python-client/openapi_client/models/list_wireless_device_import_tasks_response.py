...
class ListWirelessDeviceImportTasksResponse(BaseModel):
    ...
    wireless_device_import_task_list: Optional[Any] = Field(default=None, alias="WirelessDeviceImportTaskList")
    __properties: ClassVar[List[str]] = ["NextToken", "WirelessDeviceImportTaskList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "WirelessDeviceImportTaskList": obj.get("WirelessDeviceImportTaskList")
        })
        return _obj
