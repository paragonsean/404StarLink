...
class CreateDeviceProfileRequest(BaseModel):
    ...
    lo_ra_wan: Optional[CreateDeviceProfileRequestLoRaWAN] = Field(default=None, alias="LoRaWAN")
    ...
    sidewalk: Optional[Dict[str, Any]] = Field(default=None, description="Sidewalk object for creating a device profile.", alias="Sidewalk")
    __properties: ClassVar[List[str]] = ["Name", "LoRaWAN", "Tags", "ClientRequestToken", "Sidewalk"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Name": obj.get("Name"),
            "LoRaWAN": CreateDeviceProfileRequestLoRaWAN.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None,
