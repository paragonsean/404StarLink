...
class CreateWirelessGatewayRequest(BaseModel):
    ...
    lo_ra_wan: CreateWirelessGatewayRequestLoRaWAN = Field(alias="LoRaWAN")
    ...
    __properties: ClassVar[List[str]] = ["Name", "Description", "LoRaWAN", "Tags", "ClientRequestToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LoRaWAN": CreateWirelessGatewayRequestLoRaWAN.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None,
