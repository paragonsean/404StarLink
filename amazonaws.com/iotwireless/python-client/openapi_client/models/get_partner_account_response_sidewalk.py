...
class GetPartnerAccountResponseSidewalk(BaseModel):
    """
    GetPartnerAccountResponseSidewalk
    """ # noqa: E501
    amazon_id: Optional[Any] = Field(default=None, alias="AmazonId")
    fingerprint: Optional[Any] = Field(default=None, alias="Fingerprint")
    arn: Optional[Any] = Field(default=None, alias="Arn")
    __properties: ClassVar[List[str]] = ["AmazonId", "Fingerprint", "Arn"]
