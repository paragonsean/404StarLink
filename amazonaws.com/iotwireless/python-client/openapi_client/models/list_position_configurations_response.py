...
class ListPositionConfigurationsResponse(BaseModel):
    ...
    """ # noqa: E501
    position_configuration_list: Optional[Any] = Field(default=None, alias="PositionConfigurationList")
    next_token: Optional[Any] = Field(default=None, alias="NextToken")
    __properties: ClassVar[List[str]] = ["PositionConfigurationList", "NextToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PositionConfigurationList": obj.get("PositionConfigurationList"),
