...
class CreateServiceProfileRequest(BaseModel):
    ...
    lo_ra_wan: Optional[CreateServiceProfileRequestLoRaWAN] = Field(default=None, alias="LoRaWAN")
    ...
    __properties: ClassVar[List[str]] = ["Name", "LoRaWAN", "Tags", "ClientRequestToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Name": obj.get("Name"),
            "LoRaWAN": CreateServiceProfileRequestLoRaWAN.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None,
