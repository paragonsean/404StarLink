...
class ListWirelessGatewayTaskDefinitionsResponse(BaseModel):
    ...
    task_definitions: Optional[Any] = Field(default=None, alias="TaskDefinitions")
    __properties: ClassVar[List[str]] = ["NextToken", "TaskDefinitions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "TaskDefinitions": obj.get("TaskDefinitions")
        })
        return _obj
