...
class ListDevicesForWirelessDeviceImportTaskResponse(BaseModel):
    ...
    imported_wireless_device_list: Optional[Any] = Field(default=None, alias="ImportedWirelessDeviceList")
    __properties: ClassVar[List[str]] = ["NextToken", "DestinationName", "ImportedWirelessDeviceList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ImportedWirelessDeviceList": obj.get("ImportedWirelessDeviceList")
        })
        return _obj
