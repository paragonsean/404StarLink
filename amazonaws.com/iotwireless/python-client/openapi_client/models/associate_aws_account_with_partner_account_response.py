...
class AssociateAwsAccountWithPartnerAccountResponse(BaseModel):
    ...
    """ # noqa: E501
    sidewalk: Optional[AssociateAwsAccountWithPartnerAccountResponseSidewalk] = Field(default=None, alias="Sidewalk")
    arn: Optional[Any] = Field(default=None, alias="Arn")
    __properties: ClassVar[List[str]] = ["Sidewalk", "Arn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Sidewalk": AssociateAwsAccountWithPartnerAccountResponseSidewalk.from_dict(obj["Sidewalk"]) if obj.get("Sidewalk") is not None else None,
            "Arn": obj.get("Arn")
        })
        return _obj
