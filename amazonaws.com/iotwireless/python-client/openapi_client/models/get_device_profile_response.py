...
class GetDeviceProfileResponse(BaseModel):
    ...
    lo_ra_wan: Optional[GetDeviceProfileResponseLoRaWAN] = Field(default=None, alias="LoRaWAN")
    sidewalk: Optional[GetDeviceProfileResponseSidewalk] = Field(default=None, alias="Sidewalk")
    __properties: ClassVar[List[str]] = ["Arn", "Name", "Id", "LoRaWAN", "Sidewalk"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Name": obj.get("Name"),
            "Id": obj.get("Id"),
            "LoRaWAN": GetDeviceProfileResponseLoRaWAN.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None,
            "Sidewalk": GetDeviceProfileResponseSidewalk.from_dict(obj["Sidewalk"]) if obj.get("Sidewalk") is not None else None
        })
        return _obj
