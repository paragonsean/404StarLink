...
class UpdateEventConfigurationByResourceTypesRequestProximity(BaseModel):
    """
    UpdateEventConfigurationByResourceTypesRequestProximity
    """ # noqa: E501
    sidewalk: Optional[UpdateEventConfigurationByResourceTypesRequestProximitySidewalk] = Field(default=None, alias="Sidewalk")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Sidewalk": UpdateEventConfigurationByResourceTypesRequestProximitySidewalk.from_dict(obj["Sidewalk"]) if obj.get("Sidewalk") is not None else None
        })
        return _obj
