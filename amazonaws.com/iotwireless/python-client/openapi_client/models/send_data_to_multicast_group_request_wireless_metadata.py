...
class SendDataToMulticastGroupRequestWirelessMetadata(BaseModel):
    """
    Wireless metadata that is to be sent to multicast group.
    """ # noqa: E501
    lo_ra_wan: Optional[LoRaWANMulticastMetadata] = Field(default=None, alias="LoRaWAN")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LoRaWAN": LoRaWANMulticastMetadata.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None
        })
        return _obj
