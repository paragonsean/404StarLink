...
class GetWirelessGatewayResponse(BaseModel):
    ...
    lo_ra_wan: Optional[GetWirelessGatewayResponseLoRaWAN] = Field(default=None, alias="LoRaWAN")
    ...
    __properties: ClassVar[List[str]] = ["Name", "Id", "Description", "LoRaWAN", "Arn", "ThingName", "ThingArn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LoRaWAN": GetWirelessGatewayResponseLoRaWAN.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None,
            "Arn": obj.get("Arn"),
