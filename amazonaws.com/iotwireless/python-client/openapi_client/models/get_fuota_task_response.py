...
class GetFuotaTaskResponse(BaseModel):
    ...
    """ # noqa: E501
    arn: Optional[Annotated[str, Field(strict=True, max_length=128)]] = Field(default=None, description="The arn of a FUOTA task.", alias="Arn")
    id: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="The ID of a FUOTA task.", alias="Id")
    status: Optional[FuotaTaskStatus] = Field(default=None, alias="Status")
    ...
    lo_ra_wan: Optional[LoRaWANFuotaTaskGetInfo] = Field(default=None, alias="LoRaWAN")
    ...
    __properties: ClassVar[List[str]] = ["Arn", "Id", "Status", "Name", "Description", "LoRaWAN", "FirmwareUpdateImage", "FirmwareUpdateRole", "CreatedAt", "RedundancyPercent", "FragmentSizeBytes", "FragmentIntervalMS"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LoRaWAN": LoRaWANFuotaTaskGetInfo.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None,
