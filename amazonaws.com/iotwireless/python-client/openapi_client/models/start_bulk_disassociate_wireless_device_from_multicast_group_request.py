...
class StartBulkDisassociateWirelessDeviceFromMulticastGroupRequest(BaseModel):
    ...
    """ # noqa: E501
    query_string: Optional[Annotated[str, Field(strict=True, max_length=4096)]] = Field(default=None, description="Query string used to search for wireless devices as part of the bulk associate and disassociate process.", alias="QueryString")
    ...
    __properties: ClassVar[List[str]] = ["QueryString", "Tags"]
