...
class UpdateEventConfigurationByResourceTypesRequestDeviceRegistrationState(BaseModel):
    """
    UpdateEventConfigurationByResourceTypesRequestDeviceRegistrationState
    """ # noqa: E501
    sidewalk: Optional[UpdateEventConfigurationByResourceTypesRequestDeviceRegistrationStateSidewalk] = Field(default=None, alias="Sidewalk")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Sidewalk": UpdateEventConfigurationByResourceTypesRequestDeviceRegistrationStateSidewalk.from_dict(obj["Sidewalk"]) if obj.get("Sidewalk") is not None else None
        })
        return _obj
