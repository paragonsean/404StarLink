...
class ListNetworkAnalyzerConfigurationsResponse(BaseModel):
    ...
    network_analyzer_configuration_list: Optional[Any] = Field(default=None, alias="NetworkAnalyzerConfigurationList")
    __properties: ClassVar[List[str]] = ["NextToken", "NetworkAnalyzerConfigurationList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "NetworkAnalyzerConfigurationList": obj.get("NetworkAnalyzerConfigurationList")
        })
        return _obj
