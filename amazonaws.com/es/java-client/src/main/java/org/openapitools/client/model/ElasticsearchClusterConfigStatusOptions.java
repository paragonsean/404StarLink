...
public class ElasticsearchClusterConfigStatusOptions {
  ...
  public ElasticsearchClusterConfigStatusOptions() {
  }

  public ElasticsearchClusterConfigStatusOptions instanceType(ESPartitionInstanceType instanceType) {
  ...
  public ElasticsearchClusterConfigStatusOptions instanceCount(Integer instanceCount) {
  ...
  public ElasticsearchClusterConfigStatusOptions dedicatedMasterEnabled(Boolean dedicatedMasterEnabled) {
  ...
  public ElasticsearchClusterConfigStatusOptions zoneAwarenessEnabled(Boolean zoneAwarenessEnabled) {
  ...
  public ElasticsearchClusterConfigStatusOptions zoneAwarenessConfig(CreateElasticsearchDomainRequestElasticsearchClusterConfigZoneAwarenessConfig zoneAwarenessConfig) {
  ...
  public ElasticsearchClusterConfigStatusOptions dedicatedMasterType(ESPartitionInstanceType dedicatedMasterType) {
  ...
  public ElasticsearchClusterConfigStatusOptions dedicatedMasterCount(Integer dedicatedMasterCount) {
  ...
  public ElasticsearchClusterConfigStatusOptions warmEnabled(Boolean warmEnabled) {
  ...
  public ElasticsearchClusterConfigStatusOptions warmType(ESWarmPartitionInstanceType warmType) {
  ...
  public ElasticsearchClusterConfigStatusOptions warmCount(Integer warmCount) {
  ...
  public ElasticsearchClusterConfigStatusOptions coldStorageOptions(CreateElasticsearchDomainRequestElasticsearchClusterConfigColdStorageOptions coldStorageOptions) {
  ...
  public boolean equals(Object o) {
    ...
    ElasticsearchClusterConfigStatusOptions elasticsearchClusterConfigStatusOptions = (ElasticsearchClusterConfigStatusOptions) o;
    return Objects.equals(this.instanceType, elasticsearchClusterConfigStatusOptions.instanceType) &&
        Objects.equals(this.instanceCount, elasticsearchClusterConfigStatusOptions.instanceCount) &&
        Objects.equals(this.dedicatedMasterEnabled, elasticsearchClusterConfigStatusOptions.dedicatedMasterEnabled) &&
        Objects.equals(this.zoneAwarenessEnabled, elasticsearchClusterConfigStatusOptions.zoneAwarenessEnabled) &&
        Objects.equals(this.zoneAwarenessConfig, elasticsearchClusterConfigStatusOptions.zoneAwarenessConfig) &&
        Objects.equals(this.dedicatedMasterType, elasticsearchClusterConfigStatusOptions.dedicatedMasterType) &&
        Objects.equals(this.dedicatedMasterCount, elasticsearchClusterConfigStatusOptions.dedicatedMasterCount) &&
        Objects.equals(this.warmEnabled, elasticsearchClusterConfigStatusOptions.warmEnabled) &&
        Objects.equals(this.warmType, elasticsearchClusterConfigStatusOptions.warmType) &&
        Objects.equals(this.warmCount, elasticsearchClusterConfigStatusOptions.warmCount) &&
        Objects.equals(this.coldStorageOptions, elasticsearchClusterConfigStatusOptions.coldStorageOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class ElasticsearchClusterConfigStatusOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ElasticsearchClusterConfigStatusOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ElasticsearchClusterConfigStatusOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ElasticsearchClusterConfigStatusOptions is not found in the empty JSON string", ElasticsearchClusterConfigStatusOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ElasticsearchClusterConfigStatusOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ElasticsearchClusterConfigStatusOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ElasticsearchClusterConfigStatusOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ElasticsearchClusterConfigStatusOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ElasticsearchClusterConfigStatusOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ElasticsearchClusterConfigStatusOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<ElasticsearchClusterConfigStatusOptions>() {
           @Override
           public void write(JsonWriter out, ElasticsearchClusterConfigStatusOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ElasticsearchClusterConfigStatusOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ElasticsearchClusterConfigStatusOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ElasticsearchClusterConfigStatusOptions
   * @throws IOException if the JSON string is invalid with respect to ElasticsearchClusterConfigStatusOptions
   */
  public static ElasticsearchClusterConfigStatusOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ElasticsearchClusterConfigStatusOptions.class);
  }

  /**
   * Convert an instance of ElasticsearchClusterConfigStatusOptions to an JSON string
   *
   * @return JSON string
   */
