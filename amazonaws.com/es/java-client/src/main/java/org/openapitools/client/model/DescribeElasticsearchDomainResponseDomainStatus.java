...
public class DescribeElasticsearchDomainResponseDomainStatus {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus() {
  }

  public DescribeElasticsearchDomainResponseDomainStatus domainId(String domainId) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus domainName(String domainName) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus ARN(String ARN) {
    this.ARN = ARN;
    return this;
  }
  ...
  public DescribeElasticsearchDomainResponseDomainStatus created(Boolean created) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus deleted(Boolean deleted) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus endpoint(String endpoint) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus endpoints(Map endpoints) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus processing(Boolean processing) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus upgradeProcessing(Boolean upgradeProcessing) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus elasticsearchVersion(String elasticsearchVersion) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus elasticsearchClusterConfig(ElasticsearchDomainStatusElasticsearchClusterConfig elasticsearchClusterConfig) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus ebSOptions(ElasticsearchDomainStatusEBSOptions ebSOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus accessPolicies(String accessPolicies) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus snapshotOptions(ElasticsearchDomainStatusSnapshotOptions snapshotOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus vpCOptions(ElasticsearchDomainStatusVPCOptions vpCOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus cognitoOptions(ElasticsearchDomainStatusCognitoOptions cognitoOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus encryptionAtRestOptions(ElasticsearchDomainStatusEncryptionAtRestOptions encryptionAtRestOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus nodeToNodeEncryptionOptions(ElasticsearchDomainStatusNodeToNodeEncryptionOptions nodeToNodeEncryptionOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus advancedOptions(Map advancedOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus logPublishingOptions(Map logPublishingOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus serviceSoftwareOptions(ElasticsearchDomainStatusServiceSoftwareOptions serviceSoftwareOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus domainEndpointOptions(ElasticsearchDomainStatusDomainEndpointOptions domainEndpointOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus advancedSecurityOptions(ElasticsearchDomainStatusAdvancedSecurityOptions advancedSecurityOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus autoTuneOptions(ElasticsearchDomainStatusAutoTuneOptions autoTuneOptions) {
  ...
  public DescribeElasticsearchDomainResponseDomainStatus changeProgressDetails(ElasticsearchDomainStatusChangeProgressDetails changeProgressDetails) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeElasticsearchDomainResponseDomainStatus describeElasticsearchDomainResponseDomainStatus = (DescribeElasticsearchDomainResponseDomainStatus) o;
    return Objects.equals(this.domainId, describeElasticsearchDomainResponseDomainStatus.domainId) &&
        Objects.equals(this.domainName, describeElasticsearchDomainResponseDomainStatus.domainName) &&
        Objects.equals(this.ARN, describeElasticsearchDomainResponseDomainStatus.ARN) &&
        Objects.equals(this.created, describeElasticsearchDomainResponseDomainStatus.created) &&
        Objects.equals(this.deleted, describeElasticsearchDomainResponseDomainStatus.deleted) &&
        Objects.equals(this.endpoint, describeElasticsearchDomainResponseDomainStatus.endpoint) &&
        Objects.equals(this.endpoints, describeElasticsearchDomainResponseDomainStatus.endpoints) &&
        Objects.equals(this.processing, describeElasticsearchDomainResponseDomainStatus.processing) &&
        Objects.equals(this.upgradeProcessing, describeElasticsearchDomainResponseDomainStatus.upgradeProcessing) &&
        Objects.equals(this.elasticsearchVersion, describeElasticsearchDomainResponseDomainStatus.elasticsearchVersion) &&
        Objects.equals(this.elasticsearchClusterConfig, describeElasticsearchDomainResponseDomainStatus.elasticsearchClusterConfig) &&
        Objects.equals(this.ebSOptions, describeElasticsearchDomainResponseDomainStatus.ebSOptions) &&
        Objects.equals(this.accessPolicies, describeElasticsearchDomainResponseDomainStatus.accessPolicies) &&
        Objects.equals(this.snapshotOptions, describeElasticsearchDomainResponseDomainStatus.snapshotOptions) &&
        Objects.equals(this.vpCOptions, describeElasticsearchDomainResponseDomainStatus.vpCOptions) &&
        Objects.equals(this.cognitoOptions, describeElasticsearchDomainResponseDomainStatus.cognitoOptions) &&
        Objects.equals(this.encryptionAtRestOptions, describeElasticsearchDomainResponseDomainStatus.encryptionAtRestOptions) &&
        Objects.equals(this.nodeToNodeEncryptionOptions, describeElasticsearchDomainResponseDomainStatus.nodeToNodeEncryptionOptions) &&
        Objects.equals(this.advancedOptions, describeElasticsearchDomainResponseDomainStatus.advancedOptions) &&
        Objects.equals(this.logPublishingOptions, describeElasticsearchDomainResponseDomainStatus.logPublishingOptions) &&
        Objects.equals(this.serviceSoftwareOptions, describeElasticsearchDomainResponseDomainStatus.serviceSoftwareOptions) &&
        Objects.equals(this.domainEndpointOptions, describeElasticsearchDomainResponseDomainStatus.domainEndpointOptions) &&
        Objects.equals(this.advancedSecurityOptions, describeElasticsearchDomainResponseDomainStatus.advancedSecurityOptions) &&
        Objects.equals(this.autoTuneOptions, describeElasticsearchDomainResponseDomainStatus.autoTuneOptions) &&
        Objects.equals(this.changeProgressDetails, describeElasticsearchDomainResponseDomainStatus.changeProgressDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeElasticsearchDomainResponseDomainStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeElasticsearchDomainResponseDomainStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeElasticsearchDomainResponseDomainStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeElasticsearchDomainResponseDomainStatus is not found in the empty JSON string", DescribeElasticsearchDomainResponseDomainStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeElasticsearchDomainResponseDomainStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeElasticsearchDomainResponseDomainStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DescribeElasticsearchDomainResponseDomainStatus.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeElasticsearchDomainResponseDomainStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeElasticsearchDomainResponseDomainStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeElasticsearchDomainResponseDomainStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeElasticsearchDomainResponseDomainStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeElasticsearchDomainResponseDomainStatus>() {
           @Override
           public void write(JsonWriter out, DescribeElasticsearchDomainResponseDomainStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeElasticsearchDomainResponseDomainStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeElasticsearchDomainResponseDomainStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeElasticsearchDomainResponseDomainStatus
   * @throws IOException if the JSON string is invalid with respect to DescribeElasticsearchDomainResponseDomainStatus
   */
  public static DescribeElasticsearchDomainResponseDomainStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeElasticsearchDomainResponseDomainStatus.class);
  }

  /**
   * Convert an instance of DescribeElasticsearchDomainResponseDomainStatus to an JSON string
   *
   * @return JSON string
   */
