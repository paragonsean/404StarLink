...
public class DomainPackageDetails {
  ...
  public DomainPackageDetails() {
  }

  public DomainPackageDetails packageID(String packageID) {
  ...
  public DomainPackageDetails packageName(String packageName) {
  ...
  public DomainPackageDetails packageType(PackageType packageType) {
  ...
  public DomainPackageDetails lastUpdated(OffsetDateTime lastUpdated) {
  ...
  public DomainPackageDetails domainName(String domainName) {
  ...
  public DomainPackageDetails domainPackageStatus(DomainPackageStatus domainPackageStatus) {
  ...
  public DomainPackageDetails packageVersion(String packageVersion) {
  ...
  public DomainPackageDetails referencePath(String referencePath) {
  ...
  public DomainPackageDetails errorDetails(DomainPackageDetailsErrorDetails errorDetails) {
  ...
  public boolean equals(Object o) {
    ...
    DomainPackageDetails domainPackageDetails = (DomainPackageDetails) o;
    return Objects.equals(this.packageID, domainPackageDetails.packageID) &&
        Objects.equals(this.packageName, domainPackageDetails.packageName) &&
        Objects.equals(this.packageType, domainPackageDetails.packageType) &&
        Objects.equals(this.lastUpdated, domainPackageDetails.lastUpdated) &&
        Objects.equals(this.domainName, domainPackageDetails.domainName) &&
        Objects.equals(this.domainPackageStatus, domainPackageDetails.domainPackageStatus) &&
        Objects.equals(this.packageVersion, domainPackageDetails.packageVersion) &&
        Objects.equals(this.referencePath, domainPackageDetails.referencePath) &&
        Objects.equals(this.errorDetails, domainPackageDetails.errorDetails);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainPackageDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainPackageDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainPackageDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainPackageDetails is not found in the empty JSON string", DomainPackageDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainPackageDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainPackageDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainPackageDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainPackageDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainPackageDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainPackageDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainPackageDetails>() {
           @Override
           public void write(JsonWriter out, DomainPackageDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainPackageDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainPackageDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainPackageDetails
   * @throws IOException if the JSON string is invalid with respect to DomainPackageDetails
   */
  public static DomainPackageDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainPackageDetails.class);
  }

  /**
   * Convert an instance of DomainPackageDetails to an JSON string
   *
   * @return JSON string
   */
