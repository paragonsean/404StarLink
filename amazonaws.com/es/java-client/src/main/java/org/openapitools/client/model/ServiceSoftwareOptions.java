...
public class ServiceSoftwareOptions {
  ...
  public ServiceSoftwareOptions currentVersion(String currentVersion) {
  ...
  public ServiceSoftwareOptions newVersion(String newVersion) {
  ...
  public ServiceSoftwareOptions updateAvailable(Boolean updateAvailable) {
  ...
  public ServiceSoftwareOptions cancellable(Boolean cancellable) {
  ...
  public ServiceSoftwareOptions updateStatus(DeploymentStatus updateStatus) {
  ...
  public ServiceSoftwareOptions description(String description) {
  ...
  public ServiceSoftwareOptions automatedUpdateDate(OffsetDateTime automatedUpdateDate) {
  ...
  public ServiceSoftwareOptions optionalDeployment(Boolean optionalDeployment) {
  ...
  public boolean equals(Object o) {
    ...
    ServiceSoftwareOptions serviceSoftwareOptions = (ServiceSoftwareOptions) o;
    return Objects.equals(this.currentVersion, serviceSoftwareOptions.currentVersion) &&
        Objects.equals(this.newVersion, serviceSoftwareOptions.newVersion) &&
        Objects.equals(this.updateAvailable, serviceSoftwareOptions.updateAvailable) &&
        Objects.equals(this.cancellable, serviceSoftwareOptions.cancellable) &&
        Objects.equals(this.updateStatus, serviceSoftwareOptions.updateStatus) &&
        Objects.equals(this.description, serviceSoftwareOptions.description) &&
        Objects.equals(this.automatedUpdateDate, serviceSoftwareOptions.automatedUpdateDate) &&
        Objects.equals(this.optionalDeployment, serviceSoftwareOptions.optionalDeployment);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServiceSoftwareOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceSoftwareOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceSoftwareOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ServiceSoftwareOptions is not found in the empty JSON string", ServiceSoftwareOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceSoftwareOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ServiceSoftwareOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ServiceSoftwareOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ServiceSoftwareOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ServiceSoftwareOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ServiceSoftwareOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<ServiceSoftwareOptions>() {
           @Override
           public void write(JsonWriter out, ServiceSoftwareOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ServiceSoftwareOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ServiceSoftwareOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ServiceSoftwareOptions
   * @throws IOException if the JSON string is invalid with respect to ServiceSoftwareOptions
   */
  public static ServiceSoftwareOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ServiceSoftwareOptions.class);
  }

  /**
   * Convert an instance of ServiceSoftwareOptions to an JSON string
   *
   * @return JSON string
   */
