...
public class InboundCrossClusterSearchConnection {
  ...
  public InboundCrossClusterSearchConnection() {
  }

  public InboundCrossClusterSearchConnection sourceDomainInfo(CreateOutboundCrossClusterSearchConnectionResponseSourceDomainInfo sourceDomainInfo) {
  ...
  public InboundCrossClusterSearchConnection destinationDomainInfo(CreateOutboundCrossClusterSearchConnectionResponseDestinationDomainInfo destinationDomainInfo) {
  ...
  public InboundCrossClusterSearchConnection crossClusterSearchConnectionId(String crossClusterSearchConnectionId) {
  ...
  public InboundCrossClusterSearchConnection connectionStatus(InboundCrossClusterSearchConnectionConnectionStatus connectionStatus) {
  ...
  public boolean equals(Object o) {
    ...
    InboundCrossClusterSearchConnection inboundCrossClusterSearchConnection = (InboundCrossClusterSearchConnection) o;
    return Objects.equals(this.sourceDomainInfo, inboundCrossClusterSearchConnection.sourceDomainInfo) &&
        Objects.equals(this.destinationDomainInfo, inboundCrossClusterSearchConnection.destinationDomainInfo) &&
        Objects.equals(this.crossClusterSearchConnectionId, inboundCrossClusterSearchConnection.crossClusterSearchConnectionId) &&
        Objects.equals(this.connectionStatus, inboundCrossClusterSearchConnection.connectionStatus);
  }
  ...
  public String toString() {
    ...
    sb.append("class InboundCrossClusterSearchConnection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to InboundCrossClusterSearchConnection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InboundCrossClusterSearchConnection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InboundCrossClusterSearchConnection is not found in the empty JSON string", InboundCrossClusterSearchConnection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InboundCrossClusterSearchConnection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InboundCrossClusterSearchConnection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InboundCrossClusterSearchConnection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InboundCrossClusterSearchConnection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InboundCrossClusterSearchConnection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InboundCrossClusterSearchConnection.class));

       return (TypeAdapter<T>) new TypeAdapter<InboundCrossClusterSearchConnection>() {
           @Override
           public void write(JsonWriter out, InboundCrossClusterSearchConnection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public InboundCrossClusterSearchConnection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of InboundCrossClusterSearchConnection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of InboundCrossClusterSearchConnection
   * @throws IOException if the JSON string is invalid with respect to InboundCrossClusterSearchConnection
   */
  public static InboundCrossClusterSearchConnection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InboundCrossClusterSearchConnection.class);
  }

  /**
   * Convert an instance of InboundCrossClusterSearchConnection to an JSON string
   *
   * @return JSON string
   */
