...
public class ChangeProgressStatusDetails {
  ...
  public ChangeProgressStatusDetails() {
  }

  public ChangeProgressStatusDetails changeId(String changeId) {
  ...
  public ChangeProgressStatusDetails startTime(OffsetDateTime startTime) {
  ...
  public ChangeProgressStatusDetails status(OverallChangeStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ChangeProgressStatusDetails pendingProperties(List pendingProperties) {
  ...
  public ChangeProgressStatusDetails completedProperties(List completedProperties) {
  ...
  public ChangeProgressStatusDetails totalNumberOfStages(Integer totalNumberOfStages) {
  ...
  public ChangeProgressStatusDetails changeProgressStages(List changeProgressStages) {
  ...
  public boolean equals(Object o) {
    ...
    ChangeProgressStatusDetails changeProgressStatusDetails = (ChangeProgressStatusDetails) o;
    return Objects.equals(this.changeId, changeProgressStatusDetails.changeId) &&
        Objects.equals(this.startTime, changeProgressStatusDetails.startTime) &&
        Objects.equals(this.status, changeProgressStatusDetails.status) &&
        Objects.equals(this.pendingProperties, changeProgressStatusDetails.pendingProperties) &&
        Objects.equals(this.completedProperties, changeProgressStatusDetails.completedProperties) &&
        Objects.equals(this.totalNumberOfStages, changeProgressStatusDetails.totalNumberOfStages) &&
        Objects.equals(this.changeProgressStages, changeProgressStatusDetails.changeProgressStages);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChangeProgressStatusDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChangeProgressStatusDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChangeProgressStatusDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChangeProgressStatusDetails is not found in the empty JSON string", ChangeProgressStatusDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChangeProgressStatusDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChangeProgressStatusDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChangeProgressStatusDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChangeProgressStatusDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChangeProgressStatusDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChangeProgressStatusDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ChangeProgressStatusDetails>() {
           @Override
           public void write(JsonWriter out, ChangeProgressStatusDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChangeProgressStatusDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChangeProgressStatusDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChangeProgressStatusDetails
   * @throws IOException if the JSON string is invalid with respect to ChangeProgressStatusDetails
   */
  public static ChangeProgressStatusDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChangeProgressStatusDetails.class);
  }

  /**
   * Convert an instance of ChangeProgressStatusDetails to an JSON string
   *
   * @return JSON string
   */
