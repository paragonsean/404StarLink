...
public class CreateElasticsearchDomainRequestElasticsearchClusterConfig {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig() {
  }

  public CreateElasticsearchDomainRequestElasticsearchClusterConfig instanceType(ESPartitionInstanceType instanceType) {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig instanceCount(Integer instanceCount) {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig dedicatedMasterEnabled(Boolean dedicatedMasterEnabled) {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig zoneAwarenessEnabled(Boolean zoneAwarenessEnabled) {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig zoneAwarenessConfig(CreateElasticsearchDomainRequestElasticsearchClusterConfigZoneAwarenessConfig zoneAwarenessConfig) {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig dedicatedMasterType(ESPartitionInstanceType dedicatedMasterType) {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig dedicatedMasterCount(Integer dedicatedMasterCount) {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig warmEnabled(Boolean warmEnabled) {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig warmType(ESWarmPartitionInstanceType warmType) {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig warmCount(Integer warmCount) {
  ...
  public CreateElasticsearchDomainRequestElasticsearchClusterConfig coldStorageOptions(CreateElasticsearchDomainRequestElasticsearchClusterConfigColdStorageOptions coldStorageOptions) {
  ...
  public boolean equals(Object o) {
    ...
    CreateElasticsearchDomainRequestElasticsearchClusterConfig createElasticsearchDomainRequestElasticsearchClusterConfig = (CreateElasticsearchDomainRequestElasticsearchClusterConfig) o;
    return Objects.equals(this.instanceType, createElasticsearchDomainRequestElasticsearchClusterConfig.instanceType) &&
        Objects.equals(this.instanceCount, createElasticsearchDomainRequestElasticsearchClusterConfig.instanceCount) &&
        Objects.equals(this.dedicatedMasterEnabled, createElasticsearchDomainRequestElasticsearchClusterConfig.dedicatedMasterEnabled) &&
        Objects.equals(this.zoneAwarenessEnabled, createElasticsearchDomainRequestElasticsearchClusterConfig.zoneAwarenessEnabled) &&
        Objects.equals(this.zoneAwarenessConfig, createElasticsearchDomainRequestElasticsearchClusterConfig.zoneAwarenessConfig) &&
        Objects.equals(this.dedicatedMasterType, createElasticsearchDomainRequestElasticsearchClusterConfig.dedicatedMasterType) &&
        Objects.equals(this.dedicatedMasterCount, createElasticsearchDomainRequestElasticsearchClusterConfig.dedicatedMasterCount) &&
        Objects.equals(this.warmEnabled, createElasticsearchDomainRequestElasticsearchClusterConfig.warmEnabled) &&
        Objects.equals(this.warmType, createElasticsearchDomainRequestElasticsearchClusterConfig.warmType) &&
        Objects.equals(this.warmCount, createElasticsearchDomainRequestElasticsearchClusterConfig.warmCount) &&
        Objects.equals(this.coldStorageOptions, createElasticsearchDomainRequestElasticsearchClusterConfig.coldStorageOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateElasticsearchDomainRequestElasticsearchClusterConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateElasticsearchDomainRequestElasticsearchClusterConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateElasticsearchDomainRequestElasticsearchClusterConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateElasticsearchDomainRequestElasticsearchClusterConfig is not found in the empty JSON string", CreateElasticsearchDomainRequestElasticsearchClusterConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateElasticsearchDomainRequestElasticsearchClusterConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateElasticsearchDomainRequestElasticsearchClusterConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateElasticsearchDomainRequestElasticsearchClusterConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateElasticsearchDomainRequestElasticsearchClusterConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateElasticsearchDomainRequestElasticsearchClusterConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateElasticsearchDomainRequestElasticsearchClusterConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateElasticsearchDomainRequestElasticsearchClusterConfig>() {
           @Override
           public void write(JsonWriter out, CreateElasticsearchDomainRequestElasticsearchClusterConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateElasticsearchDomainRequestElasticsearchClusterConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateElasticsearchDomainRequestElasticsearchClusterConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateElasticsearchDomainRequestElasticsearchClusterConfig
   * @throws IOException if the JSON string is invalid with respect to CreateElasticsearchDomainRequestElasticsearchClusterConfig
   */
  public static CreateElasticsearchDomainRequestElasticsearchClusterConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateElasticsearchDomainRequestElasticsearchClusterConfig.class);
  }

  /**
   * Convert an instance of CreateElasticsearchDomainRequestElasticsearchClusterConfig to an JSON string
   *
   * @return JSON string
   */
