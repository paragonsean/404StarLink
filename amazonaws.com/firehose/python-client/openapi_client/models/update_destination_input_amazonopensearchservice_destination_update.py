...
class UpdateDestinationInputAmazonopensearchserviceDestinationUpdate(BaseModel):
    """
    ...
    buffering_hints: Optional[AmazonopensearchserviceDestinationUpdateBufferingHints] = Field(default=None, alias="BufferingHints")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "BufferingHints": AmazonopensearchserviceDestinationUpdateBufferingHints.from_dict(obj["BufferingHints"]) if obj.get("BufferingHints") is not None else None,
