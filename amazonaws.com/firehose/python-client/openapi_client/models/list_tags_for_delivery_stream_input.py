...
class ListTagsForDeliveryStreamInput(BaseModel):
    ...
    exclusive_start_tag_key: Optional[Any] = Field(default=None, alias="ExclusiveStartTagKey")
    limit: Optional[Any] = Field(default=None, alias="Limit")
    __properties: ClassVar[List[str]] = ["DeliveryStreamName", "ExclusiveStartTagKey", "Limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ExclusiveStartTagKey": obj.get("ExclusiveStartTagKey"),
            "Limit": obj.get("Limit")
        })
        return _obj
