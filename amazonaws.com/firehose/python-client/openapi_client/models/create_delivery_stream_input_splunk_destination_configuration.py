...
class CreateDeliveryStreamInputSplunkDestinationConfiguration(BaseModel):
    """
    CreateDeliveryStreamInputSplunkDestinationConfiguration
    """ # noqa: E501
    hec_endpoint: Any = Field(alias="HECEndpoint")
    hec_endpoint_type: Any = Field(alias="HECEndpointType")
    hec_token: Any = Field(alias="HECToken")
    hec_acknowledgment_timeout_in_seconds: Optional[Any] = Field(default=None, alias="HECAcknowledgmentTimeoutInSeconds")
    retry_options: Optional[SplunkDestinationConfigurationRetryOptions] = Field(default=None, alias="RetryOptions")
    ...
    __properties: ClassVar[List[str]] = ["HECEndpoint", "HECEndpointType", "HECToken", "HECAcknowledgmentTimeoutInSeconds", "RetryOptions", "S3BackupMode", "S3Configuration", "ProcessingConfiguration", "CloudWatchLoggingOptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "RetryOptions": SplunkDestinationConfigurationRetryOptions.from_dict(obj["RetryOptions"]) if obj.get("RetryOptions") is not None else None,
