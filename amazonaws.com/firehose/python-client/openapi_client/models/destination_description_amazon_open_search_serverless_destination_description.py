...
class DestinationDescriptionAmazonOpenSearchServerlessDestinationDescription(BaseModel):
    """
    ...
    buffering_hints: Optional[AmazonOpenSearchServerlessDestinationDescriptionBufferingHints] = Field(default=None, alias="BufferingHints")
    retry_options: Optional[AmazonOpenSearchServerlessDestinationDescriptionRetryOptions] = Field(default=None, alias="RetryOptions")
    ...
    __properties: ClassVar[List[str]] = ["RoleARN", "CollectionEndpoint", "IndexName", "BufferingHints", "RetryOptions", "S3BackupMode", "S3DestinationDescription", "ProcessingConfiguration", "CloudWatchLoggingOptions", "VpcConfigurationDescription"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "BufferingHints": AmazonOpenSearchServerlessDestinationDescriptionBufferingHints.from_dict(obj["BufferingHints"]) if obj.get("BufferingHints") is not None else None,
            "RetryOptions": AmazonOpenSearchServerlessDestinationDescriptionRetryOptions.from_dict(obj["RetryOptions"]) if obj.get("RetryOptions") is not None else None,
