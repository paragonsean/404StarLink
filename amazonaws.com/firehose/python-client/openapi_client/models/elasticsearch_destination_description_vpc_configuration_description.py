...
class ElasticsearchDestinationDescriptionVpcConfigurationDescription(BaseModel):
    """
    ElasticsearchDestinationDescriptionVpcConfigurationDescription
    """ # noqa: E501
    subnet_ids: Any = Field(alias="SubnetIds")
    role_arn: Any = Field(alias="RoleARN")
    security_group_ids: Any = Field(alias="SecurityGroupIds")
    vpc_id: Any = Field(alias="VpcId")
    __properties: ClassVar[List[str]] = ["SubnetIds", "RoleARN", "SecurityGroupIds", "VpcId"]
