...
class AmazonOpenSearchServerlessDestinationConfigurationRetryOptions(BaseModel):
    """
    AmazonOpenSearchServerlessDestinationConfigurationRetryOptions
    """ # noqa: E501
    duration_in_seconds: Optional[Any] = Field(default=None, alias="DurationInSeconds")
