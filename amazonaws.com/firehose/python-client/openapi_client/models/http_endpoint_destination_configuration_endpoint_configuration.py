...
class HttpEndpointDestinationConfigurationEndpointConfiguration(BaseModel):
    """
    HttpEndpointDestinationConfigurationEndpointConfiguration
    """ # noqa: E501
    url: Any = Field(alias="Url")
    name: Optional[Any] = Field(default=None, alias="Name")
    access_key: Optional[Any] = Field(default=None, alias="AccessKey")
    __properties: ClassVar[List[str]] = ["Url", "Name", "AccessKey"]
