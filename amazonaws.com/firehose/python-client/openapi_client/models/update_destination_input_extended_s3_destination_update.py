...
class UpdateDestinationInputExtendedS3DestinationUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["RoleARN", "BucketARN", "Prefix", "ErrorOutputPrefix", "BufferingHints", "CompressionFormat", "EncryptionConfiguration", "CloudWatchLoggingOptions", "ProcessingConfiguration", "S3BackupMode", "S3BackupUpdate", "DataFormatConversionConfiguration", "DynamicPartitioningConfiguration"]
