...
class ExtendedS3DestinationConfigurationDynamicPartitioningConfiguration(BaseModel):
    """
    ExtendedS3DestinationConfigurationDynamicPartitioningConfiguration
    """ # noqa: E501
    retry_options: Optional[DynamicPartitioningConfigurationRetryOptions] = Field(default=None, alias="RetryOptions")
    enabled: Optional[Any] = Field(default=None, alias="Enabled")
    __properties: ClassVar[List[str]] = ["RetryOptions", "Enabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "RetryOptions": DynamicPartitioningConfigurationRetryOptions.from_dict(obj["RetryOptions"]) if obj.get("RetryOptions") is not None else None,
