...
import org.openapitools.client.model.DescribeDatasetImportJobResponseDatasetImportJob;
...
public class DescribeDatasetImportJobResponse {
  public static final String SERIALIZED_NAME_DATASET_IMPORT_JOB = "datasetImportJob";
  @SerializedName(SERIALIZED_NAME_DATASET_IMPORT_JOB)
  private DescribeDatasetImportJobResponseDatasetImportJob datasetImportJob;

  public DescribeDatasetImportJobResponse() {
  }

  public DescribeDatasetImportJobResponse datasetImportJob(DescribeDatasetImportJobResponseDatasetImportJob datasetImportJob) {
    this.datasetImportJob = datasetImportJob;
    return this;
  }

  /**
   * Get datasetImportJob
   * @return datasetImportJob
   */
  @javax.annotation.Nullable
  public DescribeDatasetImportJobResponseDatasetImportJob getDatasetImportJob() {
    return datasetImportJob;
  }

  public void setDatasetImportJob(DescribeDatasetImportJobResponseDatasetImportJob datasetImportJob) {
    this.datasetImportJob = datasetImportJob;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.datasetImportJob, describeDatasetImportJobResponse.datasetImportJob);
  }

  @Override
  public int hashCode() {
    return Objects.hash(datasetImportJob);
  }
  ...
  public String toString() {
    ...
    sb.append("    datasetImportJob: ").append(toIndentedString(datasetImportJob)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("datasetImportJob");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `datasetImportJob`
      if (jsonObj.get("datasetImportJob") != null && !jsonObj.get("datasetImportJob").isJsonNull()) {
        DescribeDatasetImportJobResponseDatasetImportJob.validateJsonElement(jsonObj.get("datasetImportJob"));
      }
  }
