...
class ListPriceListsRequest(BaseModel):
    ...
    """ # noqa: E501
    service_code: Any = Field(alias="ServiceCode")
    effective_date: Any = Field(alias="EffectiveDate")
    region_code: Optional[Any] = Field(default=None, alias="RegionCode")
    currency_code: Any = Field(alias="CurrencyCode")
    next_token: Optional[Any] = Field(default=None, alias="NextToken")
    max_results: Optional[Any] = Field(default=None, alias="MaxResults")
    __properties: ClassVar[List[str]] = ["ServiceCode", "EffectiveDate", "RegionCode", "CurrencyCode", "NextToken", "MaxResults"]
