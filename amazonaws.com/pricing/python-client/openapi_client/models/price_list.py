...
class PriceList(BaseModel):
    ...
    """ # noqa: E501
    price_list_arn: Optional[Any] = Field(default=None, alias="PriceListArn")
    region_code: Optional[Any] = Field(default=None, alias="RegionCode")
    currency_code: Optional[Any] = Field(default=None, alias="CurrencyCode")
    file_formats: Optional[Any] = Field(default=None, alias="FileFormats")
    __properties: ClassVar[List[str]] = ["PriceListArn", "RegionCode", "CurrencyCode", "FileFormats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PriceListArn": obj.get("PriceListArn"),
