...
class TestGetPriceListFileUrlResponse(unittest.TestCase):
    """GetPriceListFileUrlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPriceListFileUrlResponse:
        """Test GetPriceListFileUrlResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPriceListFileUrlResponse`
        """
        model = GetPriceListFileUrlResponse()
        if include_optional:
    ...
    def testGetPriceListFileUrlResponse(self):
        """Test GetPriceListFileUrlResponse"""
