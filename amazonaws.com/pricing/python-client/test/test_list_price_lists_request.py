...
class TestListPriceListsRequest(unittest.TestCase):
    """ListPriceListsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListPriceListsRequest:
        """Test ListPriceListsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListPriceListsRequest`
        """
        model = ListPriceListsRequest()
        if include_optional:
    ...
    def testListPriceListsRequest(self):
        """Test ListPriceListsRequest"""
