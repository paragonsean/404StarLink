...
class TestDescribeServicesResponse(unittest.TestCase):
    """DescribeServicesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeServicesResponse:
        """Test DescribeServicesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeServicesResponse`
        """
    ...
    def testDescribeServicesResponse(self):
        """Test DescribeServicesResponse"""
