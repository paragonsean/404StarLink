...
class TestGetAttributeValuesRequest(unittest.TestCase):
    """GetAttributeValuesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAttributeValuesRequest:
        """Test GetAttributeValuesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAttributeValuesRequest`
        """
    ...
    def testGetAttributeValuesRequest(self):
        """Test GetAttributeValuesRequest"""
