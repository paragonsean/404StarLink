...
class TestAcceptTermsOfServiceResponse(unittest.TestCase):
    """AcceptTermsOfServiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcceptTermsOfServiceResponse:
        """Test AcceptTermsOfServiceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AcceptTermsOfServiceResponse`
        """
        model = AcceptTermsOfServiceResponse()
        if include_optional:
    ...
    def testAcceptTermsOfServiceResponse(self):
        """Test AcceptTermsOfServiceResponse"""
