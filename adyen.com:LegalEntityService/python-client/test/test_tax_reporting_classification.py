...
class TestTaxReportingClassification(unittest.TestCase):
    """TaxReportingClassification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxReportingClassification:
        """Test TaxReportingClassification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaxReportingClassification`
        """
        model = TaxReportingClassification()
        if include_optional:
    ...
    def testTaxReportingClassification(self):
        """Test TaxReportingClassification"""
