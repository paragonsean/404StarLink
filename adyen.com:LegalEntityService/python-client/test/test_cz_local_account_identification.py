...
class TestCZLocalAccountIdentification(unittest.TestCase):
    """CZLocalAccountIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CZLocalAccountIdentification:
        """Test CZLocalAccountIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CZLocalAccountIdentification`
        """
        model = CZLocalAccountIdentification()
        if include_optional:
    ...
    def testCZLocalAccountIdentification(self):
        """Test CZLocalAccountIdentification"""
