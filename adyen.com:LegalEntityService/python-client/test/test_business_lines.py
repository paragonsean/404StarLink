...
class TestBusinessLines(unittest.TestCase):
    """BusinessLines unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessLines:
        """Test BusinessLines
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessLines`
        """
        model = BusinessLines()
        if include_optional:
            return BusinessLines(
                business_lines = [
                    openapi_client.models.business_line.BusinessLine(
                        capability = '', 
                        id = '', 
                        industry_code = '', 
                        legal_entity_id = '', 
                        ...
                        source_of_funds = openapi_client.models.source_of_funds.SourceOfFunds(
                            acquiring_business_line_id = '', 
                            adyen_processed_funds = True, 
                            description = '', 
                            type = 'business', ), 
                        web_data = [
                            openapi_client.models.web_data.WebData(
                                web_address = '', 
                                web_address_id = '', )
                            ], 
                        web_data_exemption = openapi_client.models.web_data_exemption.WebDataExemption(
