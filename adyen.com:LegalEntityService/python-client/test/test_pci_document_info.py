...
class TestPciDocumentInfo(unittest.TestCase):
    """PciDocumentInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PciDocumentInfo:
        """Test PciDocumentInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PciDocumentInfo`
        """
        model = PciDocumentInfo()
        if include_optional:
