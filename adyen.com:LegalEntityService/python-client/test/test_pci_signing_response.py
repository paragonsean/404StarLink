...
class TestPciSigningResponse(unittest.TestCase):
    """PciSigningResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PciSigningResponse:
        """Test PciSigningResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PciSigningResponse`
        """
        model = PciSigningResponse()
        if include_optional:
    ...
    def testPciSigningResponse(self):
        """Test PciSigningResponse"""
