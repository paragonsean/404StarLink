...
class TestCapabilitySettings(unittest.TestCase):
    """CapabilitySettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CapabilitySettings:
        """Test CapabilitySettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CapabilitySettings`
        """
    ...
    def testCapabilitySettings(self):
        """Test CapabilitySettings"""
