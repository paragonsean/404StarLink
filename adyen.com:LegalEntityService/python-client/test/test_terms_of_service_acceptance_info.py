...
class TestTermsOfServiceAcceptanceInfo(unittest.TestCase):
    """TermsOfServiceAcceptanceInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TermsOfServiceAcceptanceInfo:
        """Test TermsOfServiceAcceptanceInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TermsOfServiceAcceptanceInfo`
        """
        model = TermsOfServiceAcceptanceInfo()
        if include_optional:
    ...
    def testTermsOfServiceAcceptanceInfo(self):
        """Test TermsOfServiceAcceptanceInfo"""
