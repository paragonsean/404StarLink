...
class TestOnboardingLink(unittest.TestCase):
    """OnboardingLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnboardingLink:
        """Test OnboardingLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnboardingLink`
        """
