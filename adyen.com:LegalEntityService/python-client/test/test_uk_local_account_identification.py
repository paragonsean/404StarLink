...
class TestUKLocalAccountIdentification(unittest.TestCase):
    """UKLocalAccountIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UKLocalAccountIdentification:
        """Test UKLocalAccountIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UKLocalAccountIdentification`
        """
        model = UKLocalAccountIdentification()
        if include_optional:
    ...
    def testUKLocalAccountIdentification(self):
        """Test UKLocalAccountIdentification"""
