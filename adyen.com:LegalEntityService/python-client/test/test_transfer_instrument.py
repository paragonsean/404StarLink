...
class TestTransferInstrument(unittest.TestCase):
    """TransferInstrument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferInstrument:
        """Test TransferInstrument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferInstrument`
        """
        model = TransferInstrument()
        if include_optional:
            return TransferInstrument(
                bank_account = openapi_client.models.bank_account_info.BankAccountInfo(
                    account_identification = null, 
                    account_type = '', 
                    country_code = '', ),
                capabilities = {
                    'key' : openapi_client.models.supporting_entity_capability.SupportingEntityCapability(
                        allowed = True, 
                        id = '', 
                        requested = True, 
                        verification_status = '', )
    ...
    def testTransferInstrument(self):
        """Test TransferInstrument"""
