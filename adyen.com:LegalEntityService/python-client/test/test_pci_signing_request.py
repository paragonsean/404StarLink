...
class TestPciSigningRequest(unittest.TestCase):
    """PciSigningRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PciSigningRequest:
        """Test PciSigningRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PciSigningRequest`
        """
        model = PciSigningRequest()
        if include_optional:
    ...
    def testPciSigningRequest(self):
        """Test PciSigningRequest"""
