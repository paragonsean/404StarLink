...
class TestBirthData(unittest.TestCase):
    """BirthData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BirthData:
        """Test BirthData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BirthData`
        """
        model = BirthData()
        if include_optional:
            return BirthData(
