...
class TestGetPciQuestionnaireResponse(unittest.TestCase):
    """GetPciQuestionnaireResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPciQuestionnaireResponse:
        """Test GetPciQuestionnaireResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPciQuestionnaireResponse`
        """
        model = GetPciQuestionnaireResponse()
        if include_optional:
    ...
    def testGetPciQuestionnaireResponse(self):
        """Test GetPciQuestionnaireResponse"""
