...
class TestVerificationErrorRecursive(unittest.TestCase):
    """VerificationErrorRecursive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerificationErrorRecursive:
        """Test VerificationErrorRecursive
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VerificationErrorRecursive`
        """
        model = VerificationErrorRecursive()
        if include_optional:
    ...
    def testVerificationErrorRecursive(self):
        """Test VerificationErrorRecursive"""
