...
class TestOwnerEntity(unittest.TestCase):
    """OwnerEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OwnerEntity:
        """Test OwnerEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OwnerEntity`
        """
        model = OwnerEntity()
        if include_optional:
            return OwnerEntity(
