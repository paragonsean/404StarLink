...
class TestTransferInstrumentReference(unittest.TestCase):
    """TransferInstrumentReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferInstrumentReference:
        """Test TransferInstrumentReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferInstrumentReference`
        """
        model = TransferInstrumentReference()
        if include_optional:
    ...
    def testTransferInstrumentReference(self):
        """Test TransferInstrumentReference"""
