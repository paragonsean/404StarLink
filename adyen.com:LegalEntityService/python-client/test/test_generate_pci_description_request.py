...
class TestGeneratePciDescriptionRequest(unittest.TestCase):
    """GeneratePciDescriptionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneratePciDescriptionRequest:
        """Test GeneratePciDescriptionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneratePciDescriptionRequest`
        """
        model = GeneratePciDescriptionRequest()
        if include_optional:
    ...
    def testGeneratePciDescriptionRequest(self):
        """Test GeneratePciDescriptionRequest"""
