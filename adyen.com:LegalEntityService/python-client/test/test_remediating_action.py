...
class TestRemediatingAction(unittest.TestCase):
    """RemediatingAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemediatingAction:
        """Test RemediatingAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemediatingAction`
        """
        model = RemediatingAction()
        if include_optional:
    ...
    def testRemediatingAction(self):
        """Test RemediatingAction"""
