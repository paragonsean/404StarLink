...
class TestOnboardingLinkInfo(unittest.TestCase):
    """OnboardingLinkInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnboardingLinkInfo:
        """Test OnboardingLinkInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnboardingLinkInfo`
        """
        model = OnboardingLinkInfo()
        if include_optional:
    ...
    def testOnboardingLinkInfo(self):
        """Test OnboardingLinkInfo"""
