...
class TestGetTermsOfServiceAcceptanceInfosResponse(unittest.TestCase):
    """GetTermsOfServiceAcceptanceInfosResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTermsOfServiceAcceptanceInfosResponse:
        """Test GetTermsOfServiceAcceptanceInfosResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTermsOfServiceAcceptanceInfosResponse`
        """
        model = GetTermsOfServiceAcceptanceInfosResponse()
        if include_optional:
            return GetTermsOfServiceAcceptanceInfosResponse(
                data = [
                    openapi_client.models.terms_of_service_acceptance_info.TermsOfServiceAcceptanceInfo(
                        accepted_by = '', 
                        accepted_for = '', 
    ...
    def testGetTermsOfServiceAcceptanceInfosResponse(self):
        """Test GetTermsOfServiceAcceptanceInfosResponse"""
