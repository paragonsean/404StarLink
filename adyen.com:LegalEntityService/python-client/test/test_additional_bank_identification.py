...
class TestAdditionalBankIdentification(unittest.TestCase):
    """AdditionalBankIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdditionalBankIdentification:
        """Test AdditionalBankIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalBankIdentification`
        """
        model = AdditionalBankIdentification()
        if include_optional:
    ...
    def testAdditionalBankIdentification(self):
        """Test AdditionalBankIdentification"""
