...
class GetTermsOfServiceDocumentResponse(BaseModel):
    ...
    """ # noqa: E501
    document: Optional[StrictStr] = Field(default=None, description="The Terms of Service document in Base64-encoded format.")
    ...
    __properties: ClassVar[List[str]] = ["document", "id", "language", "termsOfServiceDocumentId", "type"]
