...
class OnboardingThemes(BaseModel):
    ...
    OnboardingThemes
    """ # noqa: E501
    next: Optional[StrictStr] = Field(default=None, description="The next page. Only present if there is a next page.")
    previous: Optional[StrictStr] = Field(default=None, description="The previous page. Only present if there is a previous page.")
    themes: List[OnboardingTheme] = Field(description="List of onboarding themes.")
    __properties: ClassVar[List[str]] = ["next", "previous", "themes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "themes": [OnboardingTheme.from_dict(_item) for _item in obj["themes"]] if obj.get("themes") is not None else None
        })
        return _obj
