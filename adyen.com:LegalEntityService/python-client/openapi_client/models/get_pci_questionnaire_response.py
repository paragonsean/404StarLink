...
class GetPciQuestionnaireResponse(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="The generated questionnaire in a base64 encoded format.")
    created_at: Optional[datetime] = Field(default=None, description="The date the questionnaire was created, in ISO 8601 extended format. For example, 2022-12-18T10:15:30+01:00", alias="createdAt")
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the signed questionnaire.")
    valid_until: Optional[datetime] = Field(default=None, description="The expiration date of the questionnaire, in ISO 8601 extended format. For example, 2022-12-18T10:15:30+01:00", alias="validUntil")
    __properties: ClassVar[List[str]] = ["content", "createdAt", "id", "validUntil"]
