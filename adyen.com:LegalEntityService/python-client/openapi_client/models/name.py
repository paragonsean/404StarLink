...
class Name(BaseModel):
    ...
    Name
    """ # noqa: E501
    first_name: StrictStr = Field(description="The individual's first name.", alias="firstName")
    infix: Optional[StrictStr] = Field(default=None, description="The infix in the individual's name, if any.")
    last_name: StrictStr = Field(description="The individual's last name.", alias="lastName")
    __properties: ClassVar[List[str]] = ["firstName", "infix", "lastName"]
