...
class OnboardingLink(BaseModel):
    ...
    OnboardingLink
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="The URL of the hosted onboarding page where you need to redirect your user. This URL expires after 4 minutes and can only be used once.  If the link expires, you need to create a new link.")
