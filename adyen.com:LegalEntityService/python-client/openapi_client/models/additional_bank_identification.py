...
class AdditionalBankIdentification(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The value of the additional bank identification.")
    type: Optional[StrictStr] = Field(default=None, description="The type of additional bank identification, depending on the country.  Possible values:   * **gbSortCode**: The 6-digit [UK sort code](https://en.wikipedia.org/wiki/Sort_code), without separators or spaces  * **usRoutingNumber**: The 9-digit [routing number](https://en.wikipedia.org/wiki/ABA_routing_transit_number), without separators or spaces.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['gbSortCode', 'usRoutingNumber']):
            raise ValueError("must be one of enum values ('gbSortCode', 'usRoutingNumber')")
        return value
