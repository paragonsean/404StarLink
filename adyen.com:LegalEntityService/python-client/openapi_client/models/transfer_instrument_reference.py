...
class TransferInstrumentReference(BaseModel):
    ...
    """ # noqa: E501
    account_identifier: StrictStr = Field(description="The masked IBAN or bank account number.", alias="accountIdentifier")
    id: StrictStr = Field(description="The unique identifier of the resource.")
    real_last_four: Optional[StrictStr] = Field(default=None, description="Four last digits of the bank account number.", alias="realLastFour")
    __properties: ClassVar[List[str]] = ["accountIdentifier", "id", "realLastFour"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "realLastFour": obj.get("realLastFour")
        })
        return _obj
