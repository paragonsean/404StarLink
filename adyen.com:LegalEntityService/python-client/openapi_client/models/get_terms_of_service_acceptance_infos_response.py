...
class GetTermsOfServiceAcceptanceInfosResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[TermsOfServiceAcceptanceInfo]] = Field(default=None, description="The Terms of Service acceptance information.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [TermsOfServiceAcceptanceInfo.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
