...
class BirthData(BaseModel):
    ...
    BirthData
    """ # noqa: E501
    date_of_birth: Optional[StrictStr] = Field(default=None, description="The individual's date of birth, in YYYY-MM-DD format.", alias="dateOfBirth")
    __properties: ClassVar[List[str]] = ["dateOfBirth"]
