...
class WebDataExemption(BaseModel):
    ...
    WebDataExemption
    """ # noqa: E501
    reason: Optional[StrictStr] = Field(default=None, description="The reason why the web data was not provided. Possible value: **noOnlinePresence**.")
    ...
    def reason_validate_enum(cls, value):
        ...
        if value not in set(['noOnlinePresence']):
            raise ValueError("must be one of enum values ('noOnlinePresence')")
        return value
