...
class PciSigningRequest(BaseModel):
    ...
    PciSigningRequest
    """ # noqa: E501
    pci_template_references: List[StrictStr] = Field(description="The array of Adyen-generated unique identifiers for the questionnaires.", alias="pciTemplateReferences")
    signed_by: StrictStr = Field(description="The [legal entity ID](https://docs.adyen.com/api-explorer/#/legalentity/latest/post/legalEntities__resParam_id) of the individual who signs the PCI questionnaire.", alias="signedBy")
    __properties: ClassVar[List[str]] = ["pciTemplateReferences", "signedBy"]
