...
class PhoneNumber(BaseModel):
    ...
    PhoneNumber
    """ # noqa: E501
    number: StrictStr = Field(description="The full phone number, including the country code. For example, **+3112345678**.")
    type: Optional[StrictStr] = Field(default=None, description="The type of phone number.  Possible values: **mobile**, **landline**, **sip**, **fax.** ")
