...
class AcceptTermsOfServiceRequest(BaseModel):
    ...
    """ # noqa: E501
    accepted_by: Optional[StrictStr] = Field(default=None, description="The unique identifier of the user accepting the Terms of Service.", alias="acceptedBy")
    ip_address: Optional[StrictStr] = Field(default=None, description="The IP address of the user accepting the Terms of Service.", alias="ipAddress")
    __properties: ClassVar[List[str]] = ["acceptedBy", "ipAddress"]
