...
class StockData(BaseModel):
    ...
    StockData
    """ # noqa: E501
    market_identifier: Optional[StrictStr] = Field(default=None, description="The four-digit [Market Identifier Code](https://en.wikipedia.org/wiki/Market_Identifier_Code) of the stock market where the organization's stocks are traded.", alias="marketIdentifier")
    stock_number: Optional[StrictStr] = Field(default=None, description="The 12-digit International Securities Identification Number (ISIN) of the company, without dashes (-).", alias="stockNumber")
    ticker_symbol: Optional[StrictStr] = Field(default=None, description="The stock ticker symbol.", alias="tickerSymbol")
    __properties: ClassVar[List[str]] = ["marketIdentifier", "stockNumber", "tickerSymbol"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "marketIdentifier": obj.get("marketIdentifier"),
            "stockNumber": obj.get("stockNumber"),
