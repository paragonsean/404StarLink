...
class Amount(BaseModel):
    ...
    Amount
    """ # noqa: E501
    currency: Optional[StrictStr] = Field(default=None, description="The type of currency. Must be EUR (or EUR equivalent)")
    value: Optional[StrictInt] = Field(default=None, description="Total value of amount. Must be >= 0")
