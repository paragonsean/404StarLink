...
class GetTermsOfServiceDocumentRequest(BaseModel):
    ...
    """ # noqa: E501
    language: Optional[StrictStr] = Field(default=None, description="The language to be used for the Terms of Service document, specified by the two letter [ISO 639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language code. For example, **nl** for Dutch.")
    type: Optional[StrictStr] = Field(default=None, description="The type of Terms of Service.")
    __properties: ClassVar[List[str]] = ["language", "type"]
