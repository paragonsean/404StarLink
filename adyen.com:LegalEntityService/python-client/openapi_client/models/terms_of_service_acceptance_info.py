...
class TermsOfServiceAcceptanceInfo(BaseModel):
    ...
    accepted_for: Optional[StrictStr] = Field(default=None, description="The unique identifier of the legal entity for which the Terms of Service are accepted.", alias="acceptedFor")
    created_at: Optional[datetime] = Field(default=None, description="The date when the Terms of Service were accepted.", alias="createdAt")
    id: Optional[StrictStr] = Field(default=None, description="An Adyen-generated reference for the accepted Terms of Service.")
    type: Optional[StrictStr] = Field(default=None, description="The type of Terms of Service.")
    __properties: ClassVar[List[str]] = ["acceptedBy", "acceptedFor", "createdAt", "id", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "acceptedFor": obj.get("acceptedFor"),
