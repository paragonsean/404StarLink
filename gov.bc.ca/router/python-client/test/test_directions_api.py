...
class TestDirectionsApi(unittest.TestCase):
    ...
    def test_directions_output_format_get(self) -> None:
    ...
    def test_directions_output_format_post(self) -> None:
    ...
    def test_optimal_directions_output_format_get(self) -> None:
    ...
    def test_optimal_directions_output_format_post(self) -> None:
    ...
    def test_truck_directions_output_format_get(self) -> None:
    ...
    def test_truck_directions_output_format_post(self) -> None:
    ...
    def test_truck_optimal_directions_output_format_get(self) -> None:
    ...
    def test_truck_optimal_directions_output_format_post(self) -> None:
