...
from openapi_client.api.distance_api import DistanceApi


class TestDistanceApi(unittest.TestCase):
    """DistanceApi unit test stubs"""

    def setUp(self) -> None:
        self.api = DistanceApi()

    def tearDown(self) -> None:
        pass

    def test_distance_between_pairs_output_format_get(self) -> None:
    ...
    def test_distance_between_pairs_output_format_post(self) -> None:
    ...
    def test_distance_output_format_get(self) -> None:
    ...
    def test_distance_output_format_post(self) -> None:
    ...
    def test_truck_distance_between_pairs_output_format_get(self) -> None:
    ...
    def test_truck_distance_between_pairs_output_format_post(self) -> None:
    ...
    def test_truck_distance_output_format_get(self) -> None:
    ...
    def test_truck_distance_output_format_post(self) -> None:
