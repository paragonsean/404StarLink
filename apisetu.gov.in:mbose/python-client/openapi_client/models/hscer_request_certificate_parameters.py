...
class HscerRequestCertificateParameters(BaseModel):
    """
    HscerRequestCertificateParameters
    """ # noqa: E501
    full_name: StrictStr = Field(description="Full name", alias="FullName")
    rroll: StrictStr = Field(description="Roll No", alias="RROLL")
    year: StrictStr = Field(description="Year", alias="YEAR")
    __properties: ClassVar[List[str]] = ["FullName", "RROLL", "YEAR"]
