...
class TestInsightList(unittest.TestCase):
    """InsightList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InsightList:
        """Test InsightList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InsightList`
        """
        model = InsightList()
        if include_optional:
            return InsightList(
