...
class Report(BaseModel):
    ...
    state: Optional[StrictStr] = Field(default=None, description="Report creation state.")
    summary: Optional[ReportSummary] = None
    type: Optional[StrictStr] = Field(default=None, description="Report type.")
    update_time: Optional[StrictStr] = Field(default=None, description="Output only. Last update timestamp.", alias="updateTime")
    __properties: ClassVar[List[str]] = ["createTime", "description", "displayName", "name", "state", "summary", "type", "updateTime"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['STATE_UNSPECIFIED', 'PENDING', 'SUCCEEDED', 'FAILED']):
            raise ValueError("must be one of enum values ('STATE_UNSPECIFIED', 'PENDING', 'SUCCEEDED', 'FAILED')")
        return value
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['TYPE_UNSPECIFIED', 'TOTAL_COST_OF_OWNERSHIP']):
            raise ValueError("must be one of enum values ('TYPE_UNSPECIFIED', 'TOTAL_COST_OF_OWNERSHIP')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "state": obj.get("state"),
            "summary": ReportSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
            "type": obj.get("type"),
