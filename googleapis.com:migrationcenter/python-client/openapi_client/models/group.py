...
class Group(BaseModel):
    ...
    """ # noqa: E501
    create_time: Optional[StrictStr] = Field(default=None, description="Output only. The timestamp when the group was created.", alias="createTime")
    ...
    name: Optional[StrictStr] = Field(default=None, description="Output only. The name of the group.")
    update_time: Optional[StrictStr] = Field(default=None, description="Output only. The timestamp when the group was last updated.", alias="updateTime")
    __properties: ClassVar[List[str]] = ["createTime", "description", "displayName", "labels", "name", "updateTime"]
