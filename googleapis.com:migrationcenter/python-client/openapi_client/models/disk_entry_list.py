...
class DiskEntryList(BaseModel):
    """
    VM disks.
    """ # noqa: E501
    entries: Optional[List[DiskEntry]] = Field(default=None, description="Disk entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [DiskEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
