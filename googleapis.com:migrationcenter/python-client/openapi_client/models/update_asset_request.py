...
class UpdateAssetRequest(BaseModel):
    ...
    update_mask: Optional[StrictStr] = Field(default=None, description="Required. Field mask is used to specify the fields to be overwritten in the `Asset` resource by the update. The values specified in the `update_mask` field are relative to the resource, not the full request. A field will be overwritten if it is in the mask. A single * value in the mask lets you to overwrite all fields.", alias="updateMask")
    __properties: ClassVar[List[str]] = ["asset", "requestId", "updateMask"]
