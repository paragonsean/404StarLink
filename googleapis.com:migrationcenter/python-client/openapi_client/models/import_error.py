...
class ImportError(BaseModel):
    ...
    """ # noqa: E501
    error_details: Optional[StrictStr] = Field(default=None, description="The error information.", alias="errorDetails")
    severity: Optional[StrictStr] = Field(default=None, description="The severity of the error.")
    __properties: ClassVar[List[str]] = ["errorDetails", "severity"]
