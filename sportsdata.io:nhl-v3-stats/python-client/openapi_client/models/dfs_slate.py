...
class DfsSlate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["DfsSlateGames", "DfsSlatePlayers", "IsMultiDaySlate", "NumberOfGames", "Operator", "OperatorDay", "OperatorGameType", "OperatorName", "OperatorSlateID", "OperatorStartTime", "RemovedByOperator", "SalaryCap", "SlateID", "SlateRosterSlots"]
