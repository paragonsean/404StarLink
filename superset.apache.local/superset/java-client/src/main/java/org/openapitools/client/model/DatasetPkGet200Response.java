...
public class DatasetPkGet200Response {
  ...
  private DatasetRestApiGet result;
  ...
  public DatasetPkGet200Response() {
  }

  public DatasetPkGet200Response descriptionColumns(AnnotationLayerGet200ResponseDescriptionColumns descriptionColumns) {
  ...
  public DatasetPkGet200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DatasetPkGet200Response labelColumns(AnnotationLayerGet200ResponseLabelColumns labelColumns) {
  ...
  public DatasetPkGet200Response result(DatasetRestApiGet result) {
    this.result = result;
    return this;
  }
  ...
  public DatasetPkGet200Response showColumns(List<String> showColumns) {
    this.showColumns = showColumns;
    return this;
  }

  public DatasetPkGet200Response addShowColumnsItem(String showColumnsItem) {
  ...
  public DatasetPkGet200Response showTitle(String showTitle) {
  ...
  public boolean equals(Object o) {
    ...
    DatasetPkGet200Response datasetPkGet200Response = (DatasetPkGet200Response) o;
    return Objects.equals(this.descriptionColumns, datasetPkGet200Response.descriptionColumns) &&
        Objects.equals(this.id, datasetPkGet200Response.id) &&
        Objects.equals(this.labelColumns, datasetPkGet200Response.labelColumns) &&
        Objects.equals(this.result, datasetPkGet200Response.result) &&
        Objects.equals(this.showColumns, datasetPkGet200Response.showColumns) &&
        Objects.equals(this.showTitle, datasetPkGet200Response.showTitle);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatasetPkGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DatasetPkGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DatasetPkGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatasetPkGet200Response is not found in the empty JSON string", DatasetPkGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DatasetPkGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DatasetPkGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        DatasetRestApiGet.validateJsonElement(jsonObj.get("result"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatasetPkGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatasetPkGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatasetPkGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatasetPkGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DatasetPkGet200Response>() {
           @Override
           public void write(JsonWriter out, DatasetPkGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DatasetPkGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DatasetPkGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DatasetPkGet200Response
   * @throws IOException if the JSON string is invalid with respect to DatasetPkGet200Response
   */
  public static DatasetPkGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatasetPkGet200Response.class);
  }

  /**
   * Convert an instance of DatasetPkGet200Response to an JSON string
   *
   * @return JSON string
   */
