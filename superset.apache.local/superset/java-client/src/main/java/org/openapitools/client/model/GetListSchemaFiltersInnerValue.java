...
public class GetListSchemaFiltersInnerValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(GetListSchemaFiltersInnerValue.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetListSchemaFiltersInnerValue.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetListSchemaFiltersInnerValue' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetListSchemaFiltersInnerValue>() {
                @Override
                public void write(JsonWriter out, GetListSchemaFiltersInnerValue value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: BigDecimal, Boolean, List<Object>, String");
                }

                @Override
                public GetListSchemaFiltersInnerValue read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        GetListSchemaFiltersInnerValue ret = new GetListSchemaFiltersInnerValue();
                    ...
                    throw new IOException(String.format("Failed deserialization for GetListSchemaFiltersInnerValue: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public GetListSchemaFiltersInnerValue(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return GetListSchemaFiltersInnerValue.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * BigDecimal, Boolean, List<Object>, String
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be BigDecimal, Boolean, List<Object>, String");
    }
     ...
     * BigDecimal, Boolean, List<Object>, String
     *
     * @return The actual instance (BigDecimal, Boolean, List<Object>, String)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetListSchemaFiltersInnerValue
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for GetListSchemaFiltersInnerValue with anyOf schemas: BigDecimal, Boolean, List<Object>, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of GetListSchemaFiltersInnerValue given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of GetListSchemaFiltersInnerValue
     * @throws IOException if the JSON string is invalid with respect to GetListSchemaFiltersInnerValue
     */
    public static GetListSchemaFiltersInnerValue fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, GetListSchemaFiltersInnerValue.class);
    }

    /**
     * Convert an instance of GetListSchemaFiltersInnerValue to an JSON string
     *
     * @return JSON string
     */
