...
import org.openapitools.client.model.ChartRestApiGet;
...
public class ChartPkGet200Response {
  ...
  private ChartRestApiGet result;
  ...
  public ChartPkGet200Response() {
  }

  public ChartPkGet200Response descriptionColumns(AnnotationLayerGet200ResponseDescriptionColumns descriptionColumns) {
  ...
  public ChartPkGet200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ChartPkGet200Response labelColumns(AnnotationLayerGet200ResponseLabelColumns labelColumns) {
  ...
  public ChartPkGet200Response result(ChartRestApiGet result) {
    this.result = result;
    return this;
  }
  ...
  public ChartPkGet200Response showColumns(List<String> showColumns) {
    this.showColumns = showColumns;
    return this;
  }

  public ChartPkGet200Response addShowColumnsItem(String showColumnsItem) {
  ...
  public ChartPkGet200Response showTitle(String showTitle) {
  ...
  public boolean equals(Object o) {
    ...
    ChartPkGet200Response chartPkGet200Response = (ChartPkGet200Response) o;
    return Objects.equals(this.descriptionColumns, chartPkGet200Response.descriptionColumns) &&
        Objects.equals(this.id, chartPkGet200Response.id) &&
        Objects.equals(this.labelColumns, chartPkGet200Response.labelColumns) &&
        Objects.equals(this.result, chartPkGet200Response.result) &&
        Objects.equals(this.showColumns, chartPkGet200Response.showColumns) &&
        Objects.equals(this.showTitle, chartPkGet200Response.showTitle);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChartPkGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChartPkGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChartPkGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChartPkGet200Response is not found in the empty JSON string", ChartPkGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChartPkGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChartPkGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        ChartRestApiGet.validateJsonElement(jsonObj.get("result"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChartPkGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChartPkGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChartPkGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChartPkGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ChartPkGet200Response>() {
           @Override
           public void write(JsonWriter out, ChartPkGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChartPkGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChartPkGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChartPkGet200Response
   * @throws IOException if the JSON string is invalid with respect to ChartPkGet200Response
   */
  public static ChartPkGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChartPkGet200Response.class);
  }

  /**
   * Convert an instance of ChartPkGet200Response to an JSON string
   *
   * @return JSON string
   */
