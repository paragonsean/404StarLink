...
public class ChartRestApiPut {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cacheTimeout, dashboards, datasourceId, datasourceType, description, owners, params, queryContext, sliceName, vizType);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChartRestApiPut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChartRestApiPut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChartRestApiPut is not found in the empty JSON string", ChartRestApiPut.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChartRestApiPut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ChartRestApiPut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the optional field `datasource_type`
      if (jsonObj.get("datasource_type") != null && !jsonObj.get("datasource_type").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChartRestApiPut.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChartRestApiPut' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChartRestApiPut> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChartRestApiPut.class));

       return (TypeAdapter<T>) new TypeAdapter<ChartRestApiPut>() {
           @Override
           public void write(JsonWriter out, ChartRestApiPut value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ChartRestApiPut read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ChartRestApiPut given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ChartRestApiPut
   * @throws IOException if the JSON string is invalid with respect to ChartRestApiPut
   */
  public static ChartRestApiPut fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChartRestApiPut.class);
  }

  /**
   * Convert an instance of ChartRestApiPut to an JSON string
   *
   * @return JSON string
   */
