...
public class LogPkGet200Response {
  ...
  public LogPkGet200Response() {
  }

  public LogPkGet200Response descriptionColumns(AnnotationLayerGet200ResponseDescriptionColumns descriptionColumns) {
  ...
  public LogPkGet200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public LogPkGet200Response labelColumns(AnnotationLayerGet200ResponseLabelColumns labelColumns) {
  ...
  public LogPkGet200Response result(LogRestApiGet result) {
    this.result = result;
    return this;
  }
  ...
  public LogPkGet200Response showColumns(List<String> showColumns) {
    this.showColumns = showColumns;
    return this;
  }

  public LogPkGet200Response addShowColumnsItem(String showColumnsItem) {
  ...
  public LogPkGet200Response showTitle(String showTitle) {
  ...
  public boolean equals(Object o) {
    ...
    LogPkGet200Response logPkGet200Response = (LogPkGet200Response) o;
    return Objects.equals(this.descriptionColumns, logPkGet200Response.descriptionColumns) &&
        Objects.equals(this.id, logPkGet200Response.id) &&
        Objects.equals(this.labelColumns, logPkGet200Response.labelColumns) &&
        Objects.equals(this.result, logPkGet200Response.result) &&
        Objects.equals(this.showColumns, logPkGet200Response.showColumns) &&
        Objects.equals(this.showTitle, logPkGet200Response.showTitle);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogPkGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LogPkGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogPkGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LogPkGet200Response is not found in the empty JSON string", LogPkGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LogPkGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LogPkGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        LogRestApiGet.validateJsonElement(jsonObj.get("result"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LogPkGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LogPkGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LogPkGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LogPkGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<LogPkGet200Response>() {
           @Override
           public void write(JsonWriter out, LogPkGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LogPkGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LogPkGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LogPkGet200Response
   * @throws IOException if the JSON string is invalid with respect to LogPkGet200Response
   */
  public static LogPkGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LogPkGet200Response.class);
  }

  /**
   * Convert an instance of LogPkGet200Response to an JSON string
   *
   * @return JSON string
   */
