...
public class ReportScheduleRestApiPost {
  ...
  public ReportScheduleRestApiPost() {
  }

  public ReportScheduleRestApiPost active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  public ReportScheduleRestApiPost chart(Integer chart) {
    this.chart = chart;
    return this;
  }
  ...
  public ReportScheduleRestApiPost contextMarkdown(String contextMarkdown) {
  ...
  public ReportScheduleRestApiPost creationMethod(Object creationMethod) {
  ...
  public ReportScheduleRestApiPost crontab(String crontab) {
  ...
  public ReportScheduleRestApiPost dashboard(Integer dashboard) {
  ...
  public ReportScheduleRestApiPost database(Integer database) {
  ...
  public ReportScheduleRestApiPost description(String description) {
  ...
  public ReportScheduleRestApiPost gracePeriod(Integer gracePeriod) {
  ...
  public ReportScheduleRestApiPost logRetention(Integer logRetention) {
  ...
  public ReportScheduleRestApiPost name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ReportScheduleRestApiPost owners(List<Integer> owners) {
    this.owners = owners;
    return this;
  }

  public ReportScheduleRestApiPost addOwnersItem(Integer ownersItem) {
    if (this.owners == null) {
  ...
  public ReportScheduleRestApiPost recipients(List<ReportRecipient> recipients) {
    this.recipients = recipients;
    return this;
  }

  public ReportScheduleRestApiPost addRecipientsItem(ReportRecipient recipientsItem) {
  ...
  public ReportScheduleRestApiPost reportFormat(ReportFormatEnum reportFormat) {
  ...
  public ReportScheduleRestApiPost sql(String sql) {
    this.sql = sql;
    return this;
  }
  ...
  public ReportScheduleRestApiPost timezone(String timezone) {
  ...
  public ReportScheduleRestApiPost type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ReportScheduleRestApiPost validatorConfigJson(ValidatorConfigJSON validatorConfigJson) {
  ...
  public ReportScheduleRestApiPost validatorType(ValidatorTypeEnum validatorType) {
  ...
  public ReportScheduleRestApiPost workingTimeout(Integer workingTimeout) {
  ...
  public boolean equals(Object o) {
    ...
    ReportScheduleRestApiPost reportScheduleRestApiPost = (ReportScheduleRestApiPost) o;
    return Objects.equals(this.active, reportScheduleRestApiPost.active) &&
        Objects.equals(this.chart, reportScheduleRestApiPost.chart) &&
        Objects.equals(this.contextMarkdown, reportScheduleRestApiPost.contextMarkdown) &&
        Objects.equals(this.creationMethod, reportScheduleRestApiPost.creationMethod) &&
        Objects.equals(this.crontab, reportScheduleRestApiPost.crontab) &&
        Objects.equals(this.dashboard, reportScheduleRestApiPost.dashboard) &&
        Objects.equals(this.database, reportScheduleRestApiPost.database) &&
        Objects.equals(this.description, reportScheduleRestApiPost.description) &&
        Objects.equals(this.gracePeriod, reportScheduleRestApiPost.gracePeriod) &&
        Objects.equals(this.logRetention, reportScheduleRestApiPost.logRetention) &&
        Objects.equals(this.name, reportScheduleRestApiPost.name) &&
        Objects.equals(this.owners, reportScheduleRestApiPost.owners) &&
        Objects.equals(this.recipients, reportScheduleRestApiPost.recipients) &&
        Objects.equals(this.reportFormat, reportScheduleRestApiPost.reportFormat) &&
        Objects.equals(this.sql, reportScheduleRestApiPost.sql) &&
        Objects.equals(this.timezone, reportScheduleRestApiPost.timezone) &&
        Objects.equals(this.type, reportScheduleRestApiPost.type) &&
        Objects.equals(this.validatorConfigJson, reportScheduleRestApiPost.validatorConfigJson) &&
        Objects.equals(this.validatorType, reportScheduleRestApiPost.validatorType) &&
        Objects.equals(this.workingTimeout, reportScheduleRestApiPost.workingTimeout);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReportScheduleRestApiPost {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReportScheduleRestApiPost
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReportScheduleRestApiPost.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportScheduleRestApiPost is not found in the empty JSON string", ReportScheduleRestApiPost.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReportScheduleRestApiPost.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReportScheduleRestApiPost` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReportScheduleRestApiPost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportScheduleRestApiPost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportScheduleRestApiPost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportScheduleRestApiPost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportScheduleRestApiPost.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportScheduleRestApiPost>() {
           @Override
           public void write(JsonWriter out, ReportScheduleRestApiPost value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReportScheduleRestApiPost read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReportScheduleRestApiPost given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReportScheduleRestApiPost
   * @throws IOException if the JSON string is invalid with respect to ReportScheduleRestApiPost
   */
  public static ReportScheduleRestApiPost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportScheduleRestApiPost.class);
  }

  /**
   * Convert an instance of ReportScheduleRestApiPost to an JSON string
   *
   * @return JSON string
   */
