...
import org.openapitools.client.model.AnnotationLayerRestApiGet;
...
public class AnnotationLayerPkGet200Response {
  ...
  private AnnotationLayerRestApiGet result;
  ...
  public AnnotationLayerPkGet200Response() {
  }

  public AnnotationLayerPkGet200Response descriptionColumns(AnnotationLayerGet200ResponseDescriptionColumns descriptionColumns) {
  ...
  public AnnotationLayerPkGet200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AnnotationLayerPkGet200Response labelColumns(AnnotationLayerGet200ResponseLabelColumns labelColumns) {
  ...
  public AnnotationLayerPkGet200Response result(AnnotationLayerRestApiGet result) {
    this.result = result;
    return this;
  }
  ...
  public AnnotationLayerPkGet200Response showColumns(List<String> showColumns) {
    this.showColumns = showColumns;
    return this;
  }

  public AnnotationLayerPkGet200Response addShowColumnsItem(String showColumnsItem) {
  ...
  public AnnotationLayerPkGet200Response showTitle(String showTitle) {
  ...
  public boolean equals(Object o) {
    ...
    AnnotationLayerPkGet200Response annotationLayerPkGet200Response = (AnnotationLayerPkGet200Response) o;
    return Objects.equals(this.descriptionColumns, annotationLayerPkGet200Response.descriptionColumns) &&
        Objects.equals(this.id, annotationLayerPkGet200Response.id) &&
        Objects.equals(this.labelColumns, annotationLayerPkGet200Response.labelColumns) &&
        Objects.equals(this.result, annotationLayerPkGet200Response.result) &&
        Objects.equals(this.showColumns, annotationLayerPkGet200Response.showColumns) &&
        Objects.equals(this.showTitle, annotationLayerPkGet200Response.showTitle);
  }
  ...
  public String toString() {
    ...
    sb.append("class AnnotationLayerPkGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AnnotationLayerPkGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnnotationLayerPkGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnnotationLayerPkGet200Response is not found in the empty JSON string", AnnotationLayerPkGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AnnotationLayerPkGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AnnotationLayerPkGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        AnnotationLayerRestApiGet.validateJsonElement(jsonObj.get("result"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AnnotationLayerPkGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AnnotationLayerPkGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AnnotationLayerPkGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AnnotationLayerPkGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AnnotationLayerPkGet200Response>() {
           @Override
           public void write(JsonWriter out, AnnotationLayerPkGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AnnotationLayerPkGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AnnotationLayerPkGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AnnotationLayerPkGet200Response
   * @throws IOException if the JSON string is invalid with respect to AnnotationLayerPkGet200Response
   */
  public static AnnotationLayerPkGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AnnotationLayerPkGet200Response.class);
  }

  /**
   * Convert an instance of AnnotationLayerPkGet200Response to an JSON string
   *
   * @return JSON string
   */
