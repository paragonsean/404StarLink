...
import org.openapitools.client.model.QueryRestApiGet;
...
public class QueryPkGet200Response {
  ...
  private QueryRestApiGet result;
  ...
  public QueryPkGet200Response() {
  }

  public QueryPkGet200Response descriptionColumns(AnnotationLayerGet200ResponseDescriptionColumns descriptionColumns) {
  ...
  public QueryPkGet200Response id(String id) {
    this.id = id;
    return this;
  }
  ...
  public QueryPkGet200Response labelColumns(AnnotationLayerGet200ResponseLabelColumns labelColumns) {
  ...
  public QueryPkGet200Response result(QueryRestApiGet result) {
    this.result = result;
    return this;
  }
  ...
  public QueryPkGet200Response showColumns(List<String> showColumns) {
    this.showColumns = showColumns;
    return this;
  }

  public QueryPkGet200Response addShowColumnsItem(String showColumnsItem) {
  ...
  public QueryPkGet200Response showTitle(String showTitle) {
  ...
  public boolean equals(Object o) {
    ...
    QueryPkGet200Response queryPkGet200Response = (QueryPkGet200Response) o;
    return Objects.equals(this.descriptionColumns, queryPkGet200Response.descriptionColumns) &&
        Objects.equals(this.id, queryPkGet200Response.id) &&
        Objects.equals(this.labelColumns, queryPkGet200Response.labelColumns) &&
        Objects.equals(this.result, queryPkGet200Response.result) &&
        Objects.equals(this.showColumns, queryPkGet200Response.showColumns) &&
        Objects.equals(this.showTitle, queryPkGet200Response.showTitle);
  }
  ...
  public String toString() {
    ...
    sb.append("class QueryPkGet200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to QueryPkGet200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!QueryPkGet200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in QueryPkGet200Response is not found in the empty JSON string", QueryPkGet200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!QueryPkGet200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `QueryPkGet200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("result") != null && !jsonObj.get("result").isJsonNull()) {
        QueryRestApiGet.validateJsonElement(jsonObj.get("result"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!QueryPkGet200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'QueryPkGet200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<QueryPkGet200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(QueryPkGet200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<QueryPkGet200Response>() {
           @Override
           public void write(JsonWriter out, QueryPkGet200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public QueryPkGet200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of QueryPkGet200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of QueryPkGet200Response
   * @throws IOException if the JSON string is invalid with respect to QueryPkGet200Response
   */
  public static QueryPkGet200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, QueryPkGet200Response.class);
  }

  /**
   * Convert an instance of QueryPkGet200Response to an JSON string
   *
   * @return JSON string
   */
