...
class HIUConsentNotificationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["acknowledgement", "error", "requestId", "resp", "timestamp"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.acknowledgement:
            for _item_acknowledgement in self.acknowledgement:
                if _item_acknowledgement:
                    _items.append(_item_acknowledgement.to_dict())
