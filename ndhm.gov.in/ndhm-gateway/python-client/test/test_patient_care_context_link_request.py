    ...
    def make_instance(self, include_optional) -> PatientCareContextLinkRequest:
        ...
        if include_optional:
            return PatientCareContextLinkRequest(
                link = openapi_client.models.patient_care_context_link.PatientCareContextLink(
                    access_token = '', 
                    patient = openapi_client.models.patient_care_context_link_patient.PatientCareContextLink_patient(
                        care_contexts = [
                            openapi_client.models.care_context_representation.CareContextRepresentation(
                                display = '', 
                                reference_number = '', )
                            ], 
                        display = '', 
