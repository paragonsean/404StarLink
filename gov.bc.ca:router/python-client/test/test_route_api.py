...
class TestRouteApi(unittest.TestCase):
    ...
    def test_optimal_route_output_format_get(self) -> None:
    ...
    def test_optimal_route_output_format_post(self) -> None:
    ...
    def test_route_output_format_get(self) -> None:
    ...
    def test_route_output_format_post(self) -> None:
    ...
    def test_truck_optimal_route_output_format_get(self) -> None:
    ...
    def test_truck_optimal_route_output_format_post(self) -> None:
    ...
    def test_truck_route_output_format_get(self) -> None:
    ...
    def test_truck_route_output_format_post(self) -> None:
