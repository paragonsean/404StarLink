...
public class GoogleChromeManagementV1TelemetryDevice {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(audioStatusReport, batteryInfo, batteryStatusReport, bootPerformanceReport, cpuInfo, cpuStatusReport, customer, deviceId, graphicsInfo, graphicsStatusReport, memoryInfo, memoryStatusReport, name, networkDiagnosticsReport, networkInfo, networkStatusReport, orgUnitId, osUpdateStatus, peripheralsReport, serialNumber, storageInfo, storageStatusReport, thunderboltInfo);
  }
