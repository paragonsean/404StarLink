...
public class Connection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authConfig, configVariables, connectorVersion, createTime, description, destinationConfigs, envoyImageLocation, imageLocation, labels, lockConfig, logConfig, name, nodeConfig, serviceAccount, serviceDirectory, sslConfig, status, suspended, updateTime);
  }
