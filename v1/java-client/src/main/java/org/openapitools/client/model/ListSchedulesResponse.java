...
public class ListSchedulesResponse {
  ...
  public ListSchedulesResponse nextPageToken(String nextPageToken) {
  ...
  public ListSchedulesResponse schedules(List<Schedule> schedules) {
  ...
  public ListSchedulesResponse unreachable(List<String> unreachable) {
    this.unreachable = unreachable;
    return this;
  }

  public ListSchedulesResponse addUnreachableItem(String unreachableItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextPageToken, listSchedulesResponse.nextPageToken) &&
        Objects.equals(this.schedules, listSchedulesResponse.schedules) &&
        Objects.equals(this.unreachable, listSchedulesResponse.unreachable);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nextPageToken, schedules, unreachable);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListSchedulesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListSchedulesResponse is not found in the empty JSON string", ListSchedulesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListSchedulesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListSchedulesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ListSchedulesResponse>() {
           @Override
           public void write(JsonWriter out, ListSchedulesResponse value) throws IOException {
