...
public class ConnectorVersion {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authConfigTemplates, configVariableTemplates, createTime, destinationConfigTemplates, displayName, egressControlConfig, labels, launchStage, name, releaseVersion, roleGrant, roleGrants, sslConfigTemplate, supportedRuntimeFeatures, updateTime);
  }
