...
public class Note {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attestation, build, compliance, createTime, deployment, discovery, dsseAttestation, expirationTime, image, kind, longDescription, name, _package, relatedNoteNames, relatedUrl, shortDescription, updateTime, upgrade, vulnerability, vulnerabilityAssessment);
  }
