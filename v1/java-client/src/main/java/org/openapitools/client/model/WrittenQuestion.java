...
public class WrittenQuestion {
  ...
  private AnsweringBody answeringBody;
  ...
  private Member correctingMember;
  ...
  private List<GroupedQuestion> groupedQuestionsDates;
  ...
  public WrittenQuestion answerIsCorrection(Boolean answerIsCorrection) {
  ...
  public WrittenQuestion answerIsHolding(Boolean answerIsHolding) {
  ...
  public WrittenQuestion answerText(String answerText) {
  ...
  public WrittenQuestion answeringBody(AnsweringBody answeringBody) {
   ...
   */
  @javax.annotation.Nullable
  public AnsweringBody getAnsweringBody() {
    return answeringBody;
  }

  public void setAnsweringBody(AnsweringBody answeringBody) {
    this.answeringBody = answeringBody;
  }


  public WrittenQuestion answeringBodyId(Integer answeringBodyId) {
  ...
  public WrittenQuestion answeringMember(Member answeringMember) {
  ...
  public WrittenQuestion answeringMemberId(Integer answeringMemberId) {
  ...
  public WrittenQuestion askingMemberId(Integer askingMemberId) {
  ...
  public WrittenQuestion attachmentCount(Integer attachmentCount) {
  ...
  public WrittenQuestion correctingMember(Member correctingMember) {
   ...
   */
  @javax.annotation.Nullable
  public Member getCorrectingMember() {
    return correctingMember;
  }

  public void setCorrectingMember(Member correctingMember) {
    this.correctingMember = correctingMember;
  }


  public WrittenQuestion correctingMemberId(Integer correctingMemberId) {
  ...
  public WrittenQuestion dateAnswered(OffsetDateTime dateAnswered) {
  ...
  public WrittenQuestion dateForAnswer(OffsetDateTime dateForAnswer) {
  ...
  public WrittenQuestion dateTabled(OffsetDateTime dateTabled) {
  ...
  public WrittenQuestion groupedQuestions(List<String> groupedQuestions) {
    this.groupedQuestions = groupedQuestions;
    return this;
  }

  public WrittenQuestion addGroupedQuestionsItem(String groupedQuestionsItem) {
  ...
  public WrittenQuestion groupedQuestionsDates(List<GroupedQuestion> groupedQuestionsDates) {
    this.groupedQuestionsDates = groupedQuestionsDates;
    return this;
  }

  public WrittenQuestion addGroupedQuestionsDatesItem(GroupedQuestion groupedQuestionsDatesItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<GroupedQuestion> getGroupedQuestionsDates() {
    return groupedQuestionsDates;
  }

  public void setGroupedQuestionsDates(List<GroupedQuestion> groupedQuestionsDates) {
    this.groupedQuestionsDates = groupedQuestionsDates;
  }


  public WrittenQuestion heading(String heading) {
  ...
  public WrittenQuestion house(House house) {
    this.house = house;
    return this;
  }
  ...
  public WrittenQuestion id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public WrittenQuestion isNamedDay(Boolean isNamedDay) {
  ...
  public WrittenQuestion isWithdrawn(Boolean isWithdrawn) {
  ...
  public WrittenQuestion memberHasInterest(Boolean memberHasInterest) {
  ...
  public WrittenQuestion questionText(String questionText) {
  ...
  public WrittenQuestion uin(String uin) {
    this.uin = uin;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    WrittenQuestion writtenQuestion = (WrittenQuestion) o;
    return Objects.equals(this.answerIsCorrection, writtenQuestion.answerIsCorrection) &&
        Objects.equals(this.answerIsHolding, writtenQuestion.answerIsHolding) &&
        Objects.equals(this.answerText, writtenQuestion.answerText) &&
        Objects.equals(this.answeringBody, writtenQuestion.answeringBody) &&
        Objects.equals(this.answeringBodyId, writtenQuestion.answeringBodyId) &&
        Objects.equals(this.answeringMember, writtenQuestion.answeringMember) &&
        Objects.equals(this.answeringMemberId, writtenQuestion.answeringMemberId) &&
        Objects.equals(this.askingMemberId, writtenQuestion.askingMemberId) &&
        Objects.equals(this.attachmentCount, writtenQuestion.attachmentCount) &&
        Objects.equals(this.correctingMember, writtenQuestion.correctingMember) &&
        Objects.equals(this.correctingMemberId, writtenQuestion.correctingMemberId) &&
        Objects.equals(this.dateAnswered, writtenQuestion.dateAnswered) &&
        Objects.equals(this.dateForAnswer, writtenQuestion.dateForAnswer) &&
        Objects.equals(this.dateTabled, writtenQuestion.dateTabled) &&
        Objects.equals(this.groupedQuestions, writtenQuestion.groupedQuestions) &&
        Objects.equals(this.groupedQuestionsDates, writtenQuestion.groupedQuestionsDates) &&
        Objects.equals(this.heading, writtenQuestion.heading) &&
        Objects.equals(this.house, writtenQuestion.house) &&
        Objects.equals(this.id, writtenQuestion.id) &&
        Objects.equals(this.isNamedDay, writtenQuestion.isNamedDay) &&
        Objects.equals(this.isWithdrawn, writtenQuestion.isWithdrawn) &&
        Objects.equals(this.memberHasInterest, writtenQuestion.memberHasInterest) &&
        Objects.equals(this.questionText, writtenQuestion.questionText) &&
        Objects.equals(this.uin, writtenQuestion.uin);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(answerIsCorrection, answerIsHolding, answerText, answeringBody, answeringBodyId, answeringMember, answeringMemberId, askingMemberId, attachmentCount, correctingMember, correctingMemberId, dateAnswered, dateForAnswer, dateTabled, groupedQuestions, groupedQuestionsDates, heading, house, id, isNamedDay, isWithdrawn, memberHasInterest, questionText, uin);
  }
  ...
  public String toString() {
    ...
    sb.append("class WrittenQuestion {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to WrittenQuestion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WrittenQuestion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WrittenQuestion is not found in the empty JSON string", WrittenQuestion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WrittenQuestion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WrittenQuestion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("answeringBody") != null && !jsonObj.get("answeringBody").isJsonNull()) {
        AnsweringBody.validateJsonElement(jsonObj.get("answeringBody"));
      }
      // validate the optional field `answeringMember`
      if (jsonObj.get("answeringMember") != null && !jsonObj.get("answeringMember").isJsonNull()) {
        Member.validateJsonElement(jsonObj.get("answeringMember"));
      }
      // validate the optional field `correctingMember`
      if (jsonObj.get("correctingMember") != null && !jsonObj.get("correctingMember").isJsonNull()) {
        Member.validateJsonElement(jsonObj.get("correctingMember"));
      }
      ...
      if (jsonObj.get("groupedQuestionsDates") != null && !jsonObj.get("groupedQuestionsDates").isJsonNull()) {
        ...
        if (jsonArraygroupedQuestionsDates != null) {
          ...
          for (int i = 0; i < jsonArraygroupedQuestionsDates.size(); i++) {
            GroupedQuestion.validateJsonElement(jsonArraygroupedQuestionsDates.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WrittenQuestion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WrittenQuestion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WrittenQuestion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WrittenQuestion.class));

       return (TypeAdapter<T>) new TypeAdapter<WrittenQuestion>() {
           @Override
           public void write(JsonWriter out, WrittenQuestion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WrittenQuestion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of WrittenQuestion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of WrittenQuestion
   * @throws IOException if the JSON string is invalid with respect to WrittenQuestion
   */
  public static WrittenQuestion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WrittenQuestion.class);
  }

  /**
   * Convert an instance of WrittenQuestion to an JSON string
   *
   * @return JSON string
   */
