...
public class PackageNote {
  ...
  public PackageNote architecture(ArchitectureEnum architecture) {
  ...
  public PackageNote cpeUri(String cpeUri) {
    this.cpeUri = cpeUri;
    return this;
  }
  ...
  public PackageNote description(String description) {
  ...
  public PackageNote digest(List<Digest> digest) {
    this.digest = digest;
    return this;
  }

  public PackageNote addDigestItem(Digest digestItem) {
    if (this.digest == null) {
  ...
  public PackageNote distribution(List<Distribution> distribution) {
    this.distribution = distribution;
    return this;
  }

  public PackageNote addDistributionItem(Distribution distributionItem) {
  ...
  public PackageNote license(License license) {
  ...
  public PackageNote maintainer(String maintainer) {
  ...
  public PackageNote name(String name) {
    this.name = name;
    return this;
  }
  ...
  public PackageNote packageType(String packageType) {
  ...
  public PackageNote url(String url) {
    this.url = url;
    return this;
  }
  ...
  public PackageNote version(Version version) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.architecture, packageNote.architecture) &&
        Objects.equals(this.cpeUri, packageNote.cpeUri) &&
        Objects.equals(this.description, packageNote.description) &&
        Objects.equals(this.digest, packageNote.digest) &&
        Objects.equals(this.distribution, packageNote.distribution) &&
        Objects.equals(this.license, packageNote.license) &&
        Objects.equals(this.maintainer, packageNote.maintainer) &&
        Objects.equals(this.name, packageNote.name) &&
        Objects.equals(this.packageType, packageNote.packageType) &&
        Objects.equals(this.url, packageNote.url) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to PackageNote
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PackageNote.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PackageNote is not found in the empty JSON string", PackageNote.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PackageNote.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PackageNote` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PackageNote.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PackageNote' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PackageNote> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PackageNote.class));

       return (TypeAdapter<T>) new TypeAdapter<PackageNote>() {
           @Override
           public void write(JsonWriter out, PackageNote value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PackageNote read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PackageNote given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PackageNote
   * @throws IOException if the JSON string is invalid with respect to PackageNote
   */
  public static PackageNote fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PackageNote.class);
  }

  /**
   * Convert an instance of PackageNote to an JSON string
   *
   * @return JSON string
   */
