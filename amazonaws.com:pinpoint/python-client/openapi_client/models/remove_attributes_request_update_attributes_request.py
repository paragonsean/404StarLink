...
class RemoveAttributesRequestUpdateAttributesRequest(BaseModel):
    """
    Specifies one or more attributes to remove from all the endpoints that are associated with an application.
    """ # noqa: E501
    blacklist: Optional[Any] = Field(default=None, alias="Blacklist")
    __properties: ClassVar[List[str]] = ["Blacklist"]
