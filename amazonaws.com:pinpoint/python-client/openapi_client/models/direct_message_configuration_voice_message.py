...
class DirectMessageConfigurationVoiceMessage(BaseModel):
    """
    ...
    voice_id: Optional[Any] = Field(default=None, alias="VoiceId")
    __properties: ClassVar[List[str]] = ["Body", "LanguageCode", "OriginationNumber", "Substitutions", "VoiceId"]
