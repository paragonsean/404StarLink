...
class VoiceTemplateResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Arn", "Body", "CreationDate", "DefaultSubstitutions", "LanguageCode", "LastModifiedDate", "tags", "TemplateDescription", "TemplateName", "TemplateType", "Version", "VoiceId"]
