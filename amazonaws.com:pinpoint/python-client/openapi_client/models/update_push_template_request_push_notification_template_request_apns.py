...
class UpdatePushTemplateRequestPushNotificationTemplateRequestAPNS(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Action", "Body", "MediaUrl", "RawContent", "Sound", "Title", "Url"]
