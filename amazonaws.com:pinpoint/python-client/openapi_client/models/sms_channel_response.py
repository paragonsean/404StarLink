...
class SMSChannelResponse(BaseModel):
    ...
    promotional_messages_per_second: Optional[Any] = Field(default=None, alias="PromotionalMessagesPerSecond")
    sender_id: Optional[Any] = Field(default=None, alias="SenderId")
    short_code: Optional[Any] = Field(default=None, alias="ShortCode")
    transactional_messages_per_second: Optional[Any] = Field(default=None, alias="TransactionalMessagesPerSecond")
    version: Optional[Any] = Field(default=None, alias="Version")
    __properties: ClassVar[List[str]] = ["ApplicationId", "CreationDate", "Enabled", "HasCredential", "Id", "IsArchived", "LastModifiedBy", "LastModifiedDate", "Platform", "PromotionalMessagesPerSecond", "SenderId", "ShortCode", "TransactionalMessagesPerSecond", "Version"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "PromotionalMessagesPerSecond": obj.get("PromotionalMessagesPerSecond"),
            "SenderId": obj.get("SenderId"),
            "ShortCode": obj.get("ShortCode"),
            "TransactionalMessagesPerSecond": obj.get("TransactionalMessagesPerSecond"),
