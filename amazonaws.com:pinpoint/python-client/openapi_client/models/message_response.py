...
class MessageResponse(BaseModel):
    ...
    endpoint_result: Optional[Any] = Field(default=None, alias="EndpointResult")
    request_id: Optional[Any] = Field(default=None, alias="RequestId")
    result: Optional[Any] = Field(default=None, alias="Result")
    __properties: ClassVar[List[str]] = ["ApplicationId", "EndpointResult", "RequestId", "Result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "EndpointResult": obj.get("EndpointResult"),
