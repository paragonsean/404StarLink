...
class EventStream(BaseModel):
    ...
    destination_stream_arn: Any = Field(alias="DestinationStreamArn")
    ...
    last_updated_by: Optional[Any] = Field(default=None, alias="LastUpdatedBy")
    role_arn: Any = Field(alias="RoleArn")
    __properties: ClassVar[List[str]] = ["ApplicationId", "DestinationStreamArn", "ExternalId", "LastModifiedDate", "LastUpdatedBy", "RoleArn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DestinationStreamArn": obj.get("DestinationStreamArn"),
