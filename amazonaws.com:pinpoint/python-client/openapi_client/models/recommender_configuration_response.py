...
class RecommenderConfigurationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Attributes", "CreationDate", "Description", "Id", "LastModifiedDate", "Name", "RecommendationProviderIdType", "RecommendationProviderRoleArn", "RecommendationProviderUri", "RecommendationTransformerUri", "RecommendationsDisplayName", "RecommendationsPerMessage"]
