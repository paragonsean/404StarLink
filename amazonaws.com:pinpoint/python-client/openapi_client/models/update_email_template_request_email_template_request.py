...
class UpdateEmailTemplateRequestEmailTemplateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["DefaultSubstitutions", "HtmlPart", "RecommenderId", "Subject", "tags", "TemplateDescription", "TextPart"]
