...
class UpdateApplicationSettingsRequestWriteApplicationSettingsRequestCampaignHook(BaseModel):
    """
    UpdateApplicationSettingsRequestWriteApplicationSettingsRequestCampaignHook
    """ # noqa: E501
    lambda_function_name: Optional[Any] = Field(default=None, alias="LambdaFunctionName")
    mode: Optional[Any] = Field(default=None, alias="Mode")
    web_url: Optional[Any] = Field(default=None, alias="WebUrl")
    __properties: ClassVar[List[str]] = ["LambdaFunctionName", "Mode", "WebUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LambdaFunctionName": obj.get("LambdaFunctionName"),
