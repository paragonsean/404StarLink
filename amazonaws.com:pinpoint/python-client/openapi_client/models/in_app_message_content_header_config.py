...
class InAppMessageContentHeaderConfig(BaseModel):
    """
    InAppMessageContentHeaderConfig
    """ # noqa: E501
    alignment: Any = Field(alias="Alignment")
    header: Any = Field(alias="Header")
    text_color: Any = Field(alias="TextColor")
    __properties: ClassVar[List[str]] = ["Alignment", "Header", "TextColor"]
