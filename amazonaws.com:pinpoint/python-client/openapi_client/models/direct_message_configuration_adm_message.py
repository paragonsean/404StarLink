...
class DirectMessageConfigurationADMMessage(BaseModel):
    """
    ...
    consolidation_key: Optional[Any] = Field(default=None, alias="ConsolidationKey")
    data: Optional[Any] = Field(default=None, alias="Data")
    expires_after: Optional[Any] = Field(default=None, alias="ExpiresAfter")
    icon_reference: Optional[Any] = Field(default=None, alias="IconReference")
    ...
    md5: Optional[Any] = Field(default=None, alias="MD5")
    raw_content: Optional[Any] = Field(default=None, alias="RawContent")
    silent_push: Optional[Any] = Field(default=None, alias="SilentPush")
    small_image_icon_url: Optional[Any] = Field(default=None, alias="SmallImageIconUrl")
    ...
    __properties: ClassVar[List[str]] = ["Action", "Body", "ConsolidationKey", "Data", "ExpiresAfter", "IconReference", "ImageIconUrl", "ImageUrl", "MD5", "RawContent", "SilentPush", "SmallImageIconUrl", "Sound", "Substitutions", "Title", "Url"]
