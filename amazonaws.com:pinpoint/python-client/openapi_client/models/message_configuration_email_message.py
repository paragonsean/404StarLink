...
class MessageConfigurationEmailMessage(BaseModel):
    """
    ...
    html_body: Optional[Any] = Field(default=None, alias="HtmlBody")
    title: Optional[Any] = Field(default=None, alias="Title")
    __properties: ClassVar[List[str]] = ["Body", "FromAddress", "HtmlBody", "Title"]
