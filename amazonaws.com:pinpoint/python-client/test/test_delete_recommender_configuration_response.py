...
class TestDeleteRecommenderConfigurationResponse(unittest.TestCase):
    """DeleteRecommenderConfigurationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteRecommenderConfigurationResponse:
        """Test DeleteRecommenderConfigurationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteRecommenderConfigurationResponse`
        """
        model = DeleteRecommenderConfigurationResponse()
        if include_optional:
    ...
    def testDeleteRecommenderConfigurationResponse(self):
        """Test DeleteRecommenderConfigurationResponse"""
