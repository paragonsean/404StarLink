...
class AnalyzeIDDetections(BaseModel):
    ...
    normalized_value: Optional[AnalyzeIDDetectionsNormalizedValue] = Field(default=None, alias="NormalizedValue")
    confidence: Optional[Any] = Field(default=None, alias="Confidence")
    __properties: ClassVar[List[str]] = ["Text", "NormalizedValue", "Confidence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Text": obj.get("Text"),
            "NormalizedValue": AnalyzeIDDetectionsNormalizedValue.from_dict(obj["NormalizedValue"]) if obj.get("NormalizedValue") is not None else None,
