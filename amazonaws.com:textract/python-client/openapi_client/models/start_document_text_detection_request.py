...
class StartDocumentTextDetectionRequest(BaseModel):
    ...
    output_config: Optional[StartDocumentTextDetectionRequestOutputConfig] = Field(default=None, alias="OutputConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "OutputConfig": StartDocumentTextDetectionRequestOutputConfig.from_dict(obj["OutputConfig"]) if obj.get("OutputConfig") is not None else None,
