...
class DetectDocumentTextRequest(BaseModel):
    ...
    """ # noqa: E501
    document: DetectDocumentTextRequestDocument = Field(alias="Document")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Document": DetectDocumentTextRequestDocument.from_dict(obj["Document"]) if obj.get("Document") is not None else None
        })
        return _obj
