...
class LendingResultPageClassification(BaseModel):
    """
    LendingResultPageClassification
    """ # noqa: E501
    page_type: Any = Field(alias="PageType")
    page_number: Any = Field(alias="PageNumber")
    __properties: ClassVar[List[str]] = ["PageType", "PageNumber"]
