...
class TestGetPriceListFileUrlRequest(unittest.TestCase):
    """GetPriceListFileUrlRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPriceListFileUrlRequest:
        """Test GetPriceListFileUrlRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPriceListFileUrlRequest`
        """
        model = GetPriceListFileUrlRequest()
        if include_optional:
            return GetPriceListFileUrlRequest(
                price_list_arn = None,
                file_format = None
            )
        else:
    ...
    def testGetPriceListFileUrlRequest(self):
        """Test GetPriceListFileUrlRequest"""
