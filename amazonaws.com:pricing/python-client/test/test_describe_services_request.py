...
class TestDescribeServicesRequest(unittest.TestCase):
    """DescribeServicesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeServicesRequest:
        """Test DescribeServicesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeServicesRequest`
        """
    ...
    def testDescribeServicesRequest(self):
        """Test DescribeServicesRequest"""
