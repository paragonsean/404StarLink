...
class TestListTaskChannelResponse(unittest.TestCase):
    """ListTaskChannelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListTaskChannelResponse:
        """Test ListTaskChannelResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListTaskChannelResponse`
        """
        model = ListTaskChannelResponse()
        if include_optional:
            return ListTaskChannelResponse(
                channels = [
                    openapi_client.models.taskrouter/v1/workspace/task_channel.taskrouter.v1.workspace.task_channel(
    ...
    def testListTaskChannelResponse(self):
        """Test ListTaskChannelResponse"""
