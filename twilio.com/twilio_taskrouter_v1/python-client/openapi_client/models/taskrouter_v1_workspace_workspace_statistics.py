...
class TaskrouterV1WorkspaceWorkspaceStatistics(BaseModel):
    ...
    cumulative: Optional[Any] = Field(default=None, description="An object that contains the cumulative statistics for the Workspace.")
    realtime: Optional[Any] = Field(default=None, description="An object that contains the real-time statistics for the Workspace.")
