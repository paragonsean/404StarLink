...
class TaskrouterV1WorkspaceWorkflowWorkflowStatistics(BaseModel):
    ...
    cumulative: Optional[Any] = Field(default=None, description="An object that contains the cumulative statistics for the Workflow.")
    realtime: Optional[Any] = Field(default=None, description="An object that contains the real-time statistics for the Workflow.")
    ...
    __properties: ClassVar[List[str]] = ["account_sid", "cumulative", "realtime", "url", "workflow_sid", "workspace_sid"]
