...
class ListWorkspaceResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["meta", "workspaces"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workspaces": [TaskrouterV1Workspace.from_dict(_item) for _item in obj["workspaces"]] if obj.get("workspaces") is not None else None
        })
        return _obj
