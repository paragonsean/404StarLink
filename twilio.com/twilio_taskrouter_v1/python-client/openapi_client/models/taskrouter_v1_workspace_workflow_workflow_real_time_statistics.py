...
class TaskrouterV1WorkspaceWorkflowWorkflowRealTimeStatistics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account_sid", "longest_task_waiting_age", "longest_task_waiting_sid", "tasks_by_priority", "tasks_by_status", "total_tasks", "url", "workflow_sid", "workspace_sid"]
