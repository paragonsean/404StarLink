...
class ListWorkerResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["meta", "workers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workers": [TaskrouterV1WorkspaceWorker.from_dict(_item) for _item in obj["workers"]] if obj.get("workers") is not None else None
        })
        return _obj
