...
class ListWorkerReservationResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["meta", "reservations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reservations": [TaskrouterV1WorkspaceWorkerWorkerReservation.from_dict(_item) for _item in obj["reservations"]] if obj.get("reservations") is not None else None
        })
        return _obj
