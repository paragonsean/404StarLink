...
class ListWorkerChannelResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["channels", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "channels": [TaskrouterV1WorkspaceWorkerWorkerChannel.from_dict(_item) for _item in obj["channels"]] if obj.get("channels") is not None else None,
