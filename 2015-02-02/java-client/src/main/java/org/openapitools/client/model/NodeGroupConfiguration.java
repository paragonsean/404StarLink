...
public class NodeGroupConfiguration {
  ...
  public NodeGroupConfiguration nodeGroupId(String nodeGroupId) {
  ...
  public NodeGroupConfiguration slots(String slots) {
    this.slots = slots;
    return this;
  }
  ...
  public NodeGroupConfiguration replicaCount(Integer replicaCount) {
  ...
  public NodeGroupConfiguration primaryAvailabilityZone(String primaryAvailabilityZone) {
  ...
  public NodeGroupConfiguration replicaAvailabilityZones(List replicaAvailabilityZones) {
  ...
  public NodeGroupConfiguration primaryOutpostArn(String primaryOutpostArn) {
  ...
  public NodeGroupConfiguration replicaOutpostArns(List replicaOutpostArns) {
  ...
  public boolean equals(Object o) {
    ...
    NodeGroupConfiguration nodeGroupConfiguration = (NodeGroupConfiguration) o;
    return Objects.equals(this.nodeGroupId, nodeGroupConfiguration.nodeGroupId) &&
        Objects.equals(this.slots, nodeGroupConfiguration.slots) &&
        Objects.equals(this.replicaCount, nodeGroupConfiguration.replicaCount) &&
        Objects.equals(this.primaryAvailabilityZone, nodeGroupConfiguration.primaryAvailabilityZone) &&
        Objects.equals(this.replicaAvailabilityZones, nodeGroupConfiguration.replicaAvailabilityZones) &&
        Objects.equals(this.primaryOutpostArn, nodeGroupConfiguration.primaryOutpostArn) &&
        Objects.equals(this.replicaOutpostArns, nodeGroupConfiguration.replicaOutpostArns);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeGroupConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeGroupConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeGroupConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeGroupConfiguration is not found in the empty JSON string", NodeGroupConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeGroupConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeGroupConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeGroupConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeGroupConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeGroupConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeGroupConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeGroupConfiguration>() {
           @Override
           public void write(JsonWriter out, NodeGroupConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeGroupConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeGroupConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeGroupConfiguration
   * @throws IOException if the JSON string is invalid with respect to NodeGroupConfiguration
   */
  public static NodeGroupConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeGroupConfiguration.class);
  }

  /**
   * Convert an instance of NodeGroupConfiguration to an JSON string
   *
   * @return JSON string
   */
