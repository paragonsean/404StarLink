...
public class NodeSnapshotNodeGroupConfiguration {
  ...
  public NodeSnapshotNodeGroupConfiguration() {
  }

  public NodeSnapshotNodeGroupConfiguration nodeGroupId(String nodeGroupId) {
  ...
  public NodeSnapshotNodeGroupConfiguration slots(String slots) {
    this.slots = slots;
    return this;
  }
  ...
  public NodeSnapshotNodeGroupConfiguration replicaCount(Integer replicaCount) {
  ...
  public NodeSnapshotNodeGroupConfiguration primaryAvailabilityZone(String primaryAvailabilityZone) {
  ...
  public NodeSnapshotNodeGroupConfiguration replicaAvailabilityZones(List replicaAvailabilityZones) {
  ...
  public NodeSnapshotNodeGroupConfiguration primaryOutpostArn(String primaryOutpostArn) {
  ...
  public NodeSnapshotNodeGroupConfiguration replicaOutpostArns(List replicaOutpostArns) {
  ...
  public boolean equals(Object o) {
    ...
    NodeSnapshotNodeGroupConfiguration nodeSnapshotNodeGroupConfiguration = (NodeSnapshotNodeGroupConfiguration) o;
    return Objects.equals(this.nodeGroupId, nodeSnapshotNodeGroupConfiguration.nodeGroupId) &&
        Objects.equals(this.slots, nodeSnapshotNodeGroupConfiguration.slots) &&
        Objects.equals(this.replicaCount, nodeSnapshotNodeGroupConfiguration.replicaCount) &&
        Objects.equals(this.primaryAvailabilityZone, nodeSnapshotNodeGroupConfiguration.primaryAvailabilityZone) &&
        Objects.equals(this.replicaAvailabilityZones, nodeSnapshotNodeGroupConfiguration.replicaAvailabilityZones) &&
        Objects.equals(this.primaryOutpostArn, nodeSnapshotNodeGroupConfiguration.primaryOutpostArn) &&
        Objects.equals(this.replicaOutpostArns, nodeSnapshotNodeGroupConfiguration.replicaOutpostArns);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeSnapshotNodeGroupConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeSnapshotNodeGroupConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeSnapshotNodeGroupConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeSnapshotNodeGroupConfiguration is not found in the empty JSON string", NodeSnapshotNodeGroupConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeSnapshotNodeGroupConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeSnapshotNodeGroupConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeSnapshotNodeGroupConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeSnapshotNodeGroupConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeSnapshotNodeGroupConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeSnapshotNodeGroupConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeSnapshotNodeGroupConfiguration>() {
           @Override
           public void write(JsonWriter out, NodeSnapshotNodeGroupConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeSnapshotNodeGroupConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeSnapshotNodeGroupConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeSnapshotNodeGroupConfiguration
   * @throws IOException if the JSON string is invalid with respect to NodeSnapshotNodeGroupConfiguration
   */
  public static NodeSnapshotNodeGroupConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeSnapshotNodeGroupConfiguration.class);
  }

  /**
   * Convert an instance of NodeSnapshotNodeGroupConfiguration to an JSON string
   *
   * @return JSON string
   */
