...
public class NodeGroupMemberUpdateStatus {
  ...
  public NodeGroupMemberUpdateStatus() {
  }

  public NodeGroupMemberUpdateStatus cacheClusterId(String cacheClusterId) {
  ...
  public NodeGroupMemberUpdateStatus cacheNodeId(String cacheNodeId) {
  ...
  public NodeGroupMemberUpdateStatus nodeUpdateStatus(NodeUpdateStatus nodeUpdateStatus) {
  ...
  public NodeGroupMemberUpdateStatus nodeDeletionDate(OffsetDateTime nodeDeletionDate) {
  ...
  public NodeGroupMemberUpdateStatus nodeUpdateStartDate(OffsetDateTime nodeUpdateStartDate) {
  ...
  public NodeGroupMemberUpdateStatus nodeUpdateEndDate(OffsetDateTime nodeUpdateEndDate) {
  ...
  public NodeGroupMemberUpdateStatus nodeUpdateInitiatedBy(NodeUpdateInitiatedBy nodeUpdateInitiatedBy) {
  ...
  public NodeGroupMemberUpdateStatus nodeUpdateInitiatedDate(OffsetDateTime nodeUpdateInitiatedDate) {
  ...
  public NodeGroupMemberUpdateStatus nodeUpdateStatusModifiedDate(OffsetDateTime nodeUpdateStatusModifiedDate) {
  ...
  public boolean equals(Object o) {
    ...
    NodeGroupMemberUpdateStatus nodeGroupMemberUpdateStatus = (NodeGroupMemberUpdateStatus) o;
    return Objects.equals(this.cacheClusterId, nodeGroupMemberUpdateStatus.cacheClusterId) &&
        Objects.equals(this.cacheNodeId, nodeGroupMemberUpdateStatus.cacheNodeId) &&
        Objects.equals(this.nodeUpdateStatus, nodeGroupMemberUpdateStatus.nodeUpdateStatus) &&
        Objects.equals(this.nodeDeletionDate, nodeGroupMemberUpdateStatus.nodeDeletionDate) &&
        Objects.equals(this.nodeUpdateStartDate, nodeGroupMemberUpdateStatus.nodeUpdateStartDate) &&
        Objects.equals(this.nodeUpdateEndDate, nodeGroupMemberUpdateStatus.nodeUpdateEndDate) &&
        Objects.equals(this.nodeUpdateInitiatedBy, nodeGroupMemberUpdateStatus.nodeUpdateInitiatedBy) &&
        Objects.equals(this.nodeUpdateInitiatedDate, nodeGroupMemberUpdateStatus.nodeUpdateInitiatedDate) &&
        Objects.equals(this.nodeUpdateStatusModifiedDate, nodeGroupMemberUpdateStatus.nodeUpdateStatusModifiedDate);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeGroupMemberUpdateStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeGroupMemberUpdateStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeGroupMemberUpdateStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeGroupMemberUpdateStatus is not found in the empty JSON string", NodeGroupMemberUpdateStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeGroupMemberUpdateStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeGroupMemberUpdateStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeGroupMemberUpdateStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeGroupMemberUpdateStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeGroupMemberUpdateStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeGroupMemberUpdateStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeGroupMemberUpdateStatus>() {
           @Override
           public void write(JsonWriter out, NodeGroupMemberUpdateStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeGroupMemberUpdateStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeGroupMemberUpdateStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeGroupMemberUpdateStatus
   * @throws IOException if the JSON string is invalid with respect to NodeGroupMemberUpdateStatus
   */
  public static NodeGroupMemberUpdateStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeGroupMemberUpdateStatus.class);
  }

  /**
   * Convert an instance of NodeGroupMemberUpdateStatus to an JSON string
   *
   * @return JSON string
   */
