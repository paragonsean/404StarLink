...
public class CreateWorkloadInput {
  ...
  private CreateWorkloadInputDiscoveryConfig discoveryConfig;

  public static final String SERIALIZED_NAME_APPLICATIONS = "Applications";
  @SerializedName(SERIALIZED_NAME_APPLICATIONS)
  private List applications;

  public CreateWorkloadInput() {
  }

  public CreateWorkloadInput workloadName(String workloadName) {
  ...
  public CreateWorkloadInput description(String description) {
  ...
  public CreateWorkloadInput environment(WorkloadEnvironment environment) {
  ...
  public CreateWorkloadInput accountIds(List<String> accountIds) {
    this.accountIds = accountIds;
    return this;
  }

  public CreateWorkloadInput addAccountIdsItem(String accountIdsItem) {
  ...
  public CreateWorkloadInput awsRegions(List<String> awsRegions) {
    this.awsRegions = awsRegions;
    return this;
  }

  public CreateWorkloadInput addAwsRegionsItem(String awsRegionsItem) {
  ...
  public CreateWorkloadInput nonAwsRegions(List<String> nonAwsRegions) {
    this.nonAwsRegions = nonAwsRegions;
    return this;
  }

  public CreateWorkloadInput addNonAwsRegionsItem(String nonAwsRegionsItem) {
  ...
  public CreateWorkloadInput pillarPriorities(List<String> pillarPriorities) {
    this.pillarPriorities = pillarPriorities;
    return this;
  }

  public CreateWorkloadInput addPillarPrioritiesItem(String pillarPrioritiesItem) {
  ...
  public CreateWorkloadInput architecturalDesign(String architecturalDesign) {
  ...
  public CreateWorkloadInput reviewOwner(String reviewOwner) {
  ...
  public CreateWorkloadInput industryType(String industryType) {
  ...
  public CreateWorkloadInput industry(String industry) {
  ...
  public CreateWorkloadInput lenses(List<String> lenses) {
    this.lenses = lenses;
    return this;
  }

  public CreateWorkloadInput addLensesItem(String lensesItem) {
    if (this.lenses == null) {
  ...
  public CreateWorkloadInput notes(String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public CreateWorkloadInput clientRequestToken(String clientRequestToken) {
  ...
  public CreateWorkloadInput tags(Map tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateWorkloadInput discoveryConfig(CreateWorkloadInputDiscoveryConfig discoveryConfig) {
   ...
   */
  @javax.annotation.Nullable
  public CreateWorkloadInputDiscoveryConfig getDiscoveryConfig() {
    return discoveryConfig;
  }

  public void setDiscoveryConfig(CreateWorkloadInputDiscoveryConfig discoveryConfig) {
    this.discoveryConfig = discoveryConfig;
  }


  public CreateWorkloadInput applications(List applications) {
  ...
  public boolean equals(Object o) {
    ...
    CreateWorkloadInput createWorkloadInput = (CreateWorkloadInput) o;
    return Objects.equals(this.workloadName, createWorkloadInput.workloadName) &&
        Objects.equals(this.description, createWorkloadInput.description) &&
        Objects.equals(this.environment, createWorkloadInput.environment) &&
        Objects.equals(this.accountIds, createWorkloadInput.accountIds) &&
        Objects.equals(this.awsRegions, createWorkloadInput.awsRegions) &&
        Objects.equals(this.nonAwsRegions, createWorkloadInput.nonAwsRegions) &&
        Objects.equals(this.pillarPriorities, createWorkloadInput.pillarPriorities) &&
        Objects.equals(this.architecturalDesign, createWorkloadInput.architecturalDesign) &&
        Objects.equals(this.reviewOwner, createWorkloadInput.reviewOwner) &&
        Objects.equals(this.industryType, createWorkloadInput.industryType) &&
        Objects.equals(this.industry, createWorkloadInput.industry) &&
        Objects.equals(this.lenses, createWorkloadInput.lenses) &&
        Objects.equals(this.notes, createWorkloadInput.notes) &&
        Objects.equals(this.clientRequestToken, createWorkloadInput.clientRequestToken) &&
        Objects.equals(this.tags, createWorkloadInput.tags) &&
        Objects.equals(this.discoveryConfig, createWorkloadInput.discoveryConfig) &&
        Objects.equals(this.applications, createWorkloadInput.applications);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workloadName, description, environment, accountIds, awsRegions, nonAwsRegions, pillarPriorities, architecturalDesign, reviewOwner, industryType, industry, lenses, notes, clientRequestToken, tags, discoveryConfig, applications);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateWorkloadInput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateWorkloadInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateWorkloadInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateWorkloadInput is not found in the empty JSON string", CreateWorkloadInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateWorkloadInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateWorkloadInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateWorkloadInput.openapiRequiredFields) {
      ...
      if (jsonObj.get("DiscoveryConfig") != null && !jsonObj.get("DiscoveryConfig").isJsonNull()) {
        CreateWorkloadInputDiscoveryConfig.validateJsonElement(jsonObj.get("DiscoveryConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateWorkloadInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateWorkloadInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateWorkloadInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateWorkloadInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateWorkloadInput>() {
           @Override
           public void write(JsonWriter out, CreateWorkloadInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateWorkloadInput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateWorkloadInput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateWorkloadInput
   * @throws IOException if the JSON string is invalid with respect to CreateWorkloadInput
   */
  public static CreateWorkloadInput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateWorkloadInput.class);
  }

  /**
   * Convert an instance of CreateWorkloadInput to an JSON string
   *
   * @return JSON string
   */
