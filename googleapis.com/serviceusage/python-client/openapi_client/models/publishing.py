...
class Publishing(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["apiShortName", "codeownerGithubTeams", "docTagPrefix", "documentationUri", "githubLabel", "librarySettings", "methodSettings", "newIssueUri", "organization", "protoReferenceDocumentationUri"]
    ...
    def organization_validate_enum(cls, value):
        ...
        if value not in set(['CLIENT_LIBRARY_ORGANIZATION_UNSPECIFIED', 'CLOUD', 'ADS', 'PHOTOS', 'STREET_VIEW', 'SHOPPING']):
            raise ValueError("must be one of enum values ('CLIENT_LIBRARY_ORGANIZATION_UNSPECIFIED', 'CLOUD', 'ADS', 'PHOTOS', 'STREET_VIEW', 'SHOPPING')")
        return value
