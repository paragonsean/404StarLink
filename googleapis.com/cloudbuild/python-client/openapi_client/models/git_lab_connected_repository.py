...
class GitLabConnectedRepository(BaseModel):
    ...
    """ # noqa: E501
    parent: Optional[StrictStr] = Field(default=None, description="The name of the `GitLabConfig` that added connected repository. Format: `projects/{project}/locations/{location}/gitLabConfigs/{config}`")
    repo: Optional[GitLabRepositoryId] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "repo": GitLabRepositoryId.from_dict(obj["repo"]) if obj.get("repo") is not None else None,
