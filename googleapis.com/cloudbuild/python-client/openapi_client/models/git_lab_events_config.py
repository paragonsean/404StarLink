...
class GitLabEventsConfig(BaseModel):
    """
    GitLabEventsConfig describes the configuration of a trigger that creates a build whenever a GitLab event is received.
    """ # noqa: E501
    gitlab_config: Optional[GitLabConfig] = Field(default=None, alias="gitlabConfig")
    gitlab_config_resource: Optional[StrictStr] = Field(default=None, description="The GitLab config resource that this trigger config maps to.", alias="gitlabConfigResource")
    project_namespace: Optional[StrictStr] = Field(default=None, description="Namespace of the GitLab project.", alias="projectNamespace")
    pull_request: Optional[PullRequestFilter] = Field(default=None, alias="pullRequest")
    push: Optional[PushFilter] = None
    __properties: ClassVar[List[str]] = ["gitlabConfig", "gitlabConfigResource", "projectNamespace", "pullRequest", "push"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of gitlab_config
        if self.gitlab_config:
            _dict['gitlabConfig'] = self.gitlab_config.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "gitlabConfig": GitLabConfig.from_dict(obj["gitlabConfig"]) if obj.get("gitlabConfig") is not None else None,
            "gitlabConfigResource": obj.get("gitlabConfigResource"),
            "projectNamespace": obj.get("projectNamespace"),
