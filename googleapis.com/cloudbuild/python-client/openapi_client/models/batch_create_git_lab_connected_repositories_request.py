...
class BatchCreateGitLabConnectedRepositoriesRequest(BaseModel):
    """
    RPC request object accepted by BatchCreateGitLabConnectedRepositories RPC method.
    """ # noqa: E501
    requests: Optional[List[CreateGitLabConnectedRepositoryRequest]] = Field(default=None, description="Required. Requests to connect GitLab repositories.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [CreateGitLabConnectedRepositoryRequest.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj
