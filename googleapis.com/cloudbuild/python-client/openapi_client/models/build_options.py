...
class BuildOptions(BaseModel):
    ...
    log_streaming_option: Optional[StrictStr] = Field(default=None, description="Option to define build log streaming behavior to Google Cloud Storage.", alias="logStreamingOption")
    ...
    volumes: Optional[List[Volume]] = Field(default=None, description="Global list of volumes to mount for ALL build steps Each volume is created as an empty volume prior to starting the build process. Upon completion of the build, volumes and their contents are discarded. Global volume names and paths cannot conflict with the volumes defined a build step. Using a global volume in a build with only one step is not valid as it is indicative of a build request with an incorrect configuration.")
    ...
    __properties: ClassVar[List[str]] = ["defaultLogsBucketBehavior", "diskSizeGb", "dynamicSubstitutions", "env", "logStreamingOption", "logging", "machineType", "pool", "requestedVerifyOption", "secretEnv", "sourceProvenanceHash", "substitutionOption", "volumes", "workerPool"]
    ...
    def machine_type_validate_enum(cls, value):
        ...
        if value not in set(['UNSPECIFIED', 'N1_HIGHCPU_8', 'N1_HIGHCPU_32', 'E2_HIGHCPU_8', 'E2_HIGHCPU_32']):
            raise ValueError("must be one of enum values ('UNSPECIFIED', 'N1_HIGHCPU_8', 'N1_HIGHCPU_32', 'E2_HIGHCPU_8', 'E2_HIGHCPU_32')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pool": PoolOption.from_dict(obj["pool"]) if obj.get("pool") is not None else None,
