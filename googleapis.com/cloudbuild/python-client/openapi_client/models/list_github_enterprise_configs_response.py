...
class ListGithubEnterpriseConfigsResponse(BaseModel):
    """
    RPC response object returned by ListGithubEnterpriseConfigs RPC method.
    """ # noqa: E501
    configs: Optional[List[GitHubEnterpriseConfig]] = Field(default=None, description="A list of GitHubEnterpriseConfigs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "configs": [GitHubEnterpriseConfig.from_dict(_item) for _item in obj["configs"]] if obj.get("configs") is not None else None
        })
        return _obj
