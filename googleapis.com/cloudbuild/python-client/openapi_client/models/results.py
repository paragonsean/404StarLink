...
class Results(BaseModel):
    ...
    npm_packages: Optional[List[UploadedNpmPackage]] = Field(default=None, description="Npm packages uploaded to Artifact Registry at the end of the build.", alias="npmPackages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "npmPackages": [UploadedNpmPackage.from_dict(_item) for _item in obj["npmPackages"]] if obj.get("npmPackages") is not None else None,
