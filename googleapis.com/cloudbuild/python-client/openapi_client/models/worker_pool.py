...
class WorkerPool(BaseModel):
    ...
    private_pool_v1_config: Optional[PrivatePoolV1Config] = Field(default=None, alias="privatePoolV1Config")
    ...
    __properties: ClassVar[List[str]] = ["annotations", "createTime", "deleteTime", "displayName", "etag", "name", "privatePoolV1Config", "state", "uid", "updateTime"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['STATE_UNSPECIFIED', 'CREATING', 'RUNNING', 'DELETING', 'DELETED', 'UPDATING']):
            raise ValueError("must be one of enum values ('STATE_UNSPECIFIED', 'CREATING', 'RUNNING', 'DELETING', 'DELETED', 'UPDATING')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of private_pool_v1_config
        if self.private_pool_v1_config:
            _dict['privatePoolV1Config'] = self.private_pool_v1_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "etag": obj.get("etag"),
            "name": obj.get("name"),
            "privatePoolV1Config": PrivatePoolV1Config.from_dict(obj["privatePoolV1Config"]) if obj.get("privatePoolV1Config") is not None else None,
            "state": obj.get("state"),
            "uid": obj.get("uid"),
