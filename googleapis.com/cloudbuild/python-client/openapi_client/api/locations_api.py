...
class LocationsApi:
    ...
    def cloudbuild_locations_regional_webhook(
        self,
        location: Annotated[StrictStr, Field(description="Required. The location where the webhook should be sent.")],
        ...
        webhook_key: Annotated[Optional[StrictStr], Field(description="For GitHub Enterprise webhooks, this key is used to associate the webhook request with the GitHubEnterpriseConfig to use for validation.")] = None,
        ...
        :param location: Required. The location where the webhook should be sent. (required)
        :type location: str
        ...
        :param webhook_key: For GitHub Enterprise webhooks, this key is used to associate the webhook request with the GitHubEnterpriseConfig to use for validation.
        ...
        _param = self._cloudbuild_locations_regional_webhook_serialize(
            location=location,
            xgafv=xgafv,
    ...
    @validate_call
    def cloudbuild_locations_regional_webhook_with_http_info(
        self,
        location: Annotated[StrictStr, Field(description="Required. The location where the webhook should be sent.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    @validate_call
    def cloudbuild_locations_regional_webhook_without_preload_content(
        self,
        location: Annotated[StrictStr, Field(description="Required. The location where the webhook should be sent.")],
        xgafv: Annotated[Optional[StrictStr], Field(description="V1 error format.")] = None,
        access_token: Annotated[Optional[StrictStr], Field(description="OAuth access token.")] = None,
    ...
    def _cloudbuild_locations_regional_webhook_serialize(
        self,
        location,
        xgafv,
        access_token,
        ...
        if webhook_key is not None:
            ...
            _query_params.append(('webhookKey', webhook_key))
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/{location}/regionalWebhook',
