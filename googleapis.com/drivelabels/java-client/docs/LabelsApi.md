...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GoogleAppsDriveLabelsV2ListLabelsResponse result = apiInstance.drivelabelsLabelsList($xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, customer, languageCode, minimumRole, pageSize, pageToken, publishedOnly, useAdminAccess, view);
      System.out.println(result);
    } catch (ApiException e) {
