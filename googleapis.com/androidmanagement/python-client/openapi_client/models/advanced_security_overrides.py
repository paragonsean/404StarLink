...
class AdvancedSecurityOverrides(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["commonCriteriaMode", "developerSettings", "googlePlayProtectVerifyApps", "personalAppsThatCanReadWorkNotifications", "untrustedAppsPolicy"]
