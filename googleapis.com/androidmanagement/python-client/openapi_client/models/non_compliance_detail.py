...
class NonComplianceDetail(BaseModel):
    ...
    def installation_failure_reason_validate_enum(cls, value):
        ...
        if value not in set(['INSTALLATION_FAILURE_REASON_UNSPECIFIED', 'INSTALLATION_FAILURE_REASON_UNKNOWN', 'IN_PROGRESS', 'NOT_FOUND', 'NOT_COMPATIBLE_WITH_DEVICE', 'NOT_APPROVED', 'PERMISSIONS_NOT_ACCEPTED', 'NOT_AVAILABLE_IN_COUNTRY', 'NO_LICENSES_REMAINING', 'NOT_ENROLLED', 'USER_INVALID']):
            raise ValueError("must be one of enum values ('INSTALLATION_FAILURE_REASON_UNSPECIFIED', 'INSTALLATION_FAILURE_REASON_UNKNOWN', 'IN_PROGRESS', 'NOT_FOUND', 'NOT_COMPATIBLE_WITH_DEVICE', 'NOT_APPROVED', 'PERMISSIONS_NOT_ACCEPTED', 'NOT_AVAILABLE_IN_COUNTRY', 'NO_LICENSES_REMAINING', 'NOT_ENROLLED', 'USER_INVALID')")
        return value
    ...
    def non_compliance_reason_validate_enum(cls, value):
        ...
        if value not in set(['NON_COMPLIANCE_REASON_UNSPECIFIED', 'API_LEVEL', 'MANAGEMENT_MODE', 'USER_ACTION', 'INVALID_VALUE', 'APP_NOT_INSTALLED', 'UNSUPPORTED', 'APP_INSTALLED', 'PENDING', 'APP_INCOMPATIBLE', 'APP_NOT_UPDATED']):
            raise ValueError("must be one of enum values ('NON_COMPLIANCE_REASON_UNSPECIFIED', 'API_LEVEL', 'MANAGEMENT_MODE', 'USER_ACTION', 'INVALID_VALUE', 'APP_NOT_INSTALLED', 'UNSUPPORTED', 'APP_INSTALLED', 'PENDING', 'APP_INCOMPATIBLE', 'APP_NOT_UPDATED')")
        return value
    ...
    def specific_non_compliance_reason_validate_enum(cls, value):
        ...
        if value not in set(['SPECIFIC_NON_COMPLIANCE_REASON_UNSPECIFIED', 'PASSWORD_POLICIES_USER_CREDENTIALS_CONFIRMATION_REQUIRED', 'PASSWORD_POLICIES_PASSWORD_EXPIRED', 'PASSWORD_POLICIES_PASSWORD_NOT_SUFFICIENT', 'ONC_WIFI_INVALID_VALUE', 'ONC_WIFI_API_LEVEL']):
            raise ValueError("must be one of enum values ('SPECIFIC_NON_COMPLIANCE_REASON_UNSPECIFIED', 'PASSWORD_POLICIES_USER_CREDENTIALS_CONFIRMATION_REQUIRED', 'PASSWORD_POLICIES_PASSWORD_EXPIRED', 'PASSWORD_POLICIES_PASSWORD_NOT_SUFFICIENT', 'ONC_WIFI_INVALID_VALUE', 'ONC_WIFI_API_LEVEL')")
        return value
