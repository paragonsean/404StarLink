...
class ApplicationReport(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["applicationSource", "displayName", "events", "installerPackageName", "keyedAppStates", "packageName", "packageSha256Hash", "signingKeyCertFingerprints", "state", "versionCode", "versionName"]
