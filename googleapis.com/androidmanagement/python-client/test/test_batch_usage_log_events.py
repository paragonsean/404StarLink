...
class TestBatchUsageLogEvents(unittest.TestCase):
    """BatchUsageLogEvents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchUsageLogEvents:
        """Test BatchUsageLogEvents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchUsageLogEvents`
        """
        model = BatchUsageLogEvents()
        if include_optional:
            return BatchUsageLogEvents(
                device = '',
                retrieval_time = '',
                usage_log_events = [
                    openapi_client.models.usage_log_event.UsageLogEvent(
    ...
    def testBatchUsageLogEvents(self):
        """Test BatchUsageLogEvents"""
