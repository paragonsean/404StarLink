...
public class GroupsCountResult {
  ...
  public GroupsCountResult accountCountErrors(List<AccountCountError> accountCountErrors) {
    this.accountCountErrors = accountCountErrors;
    return this;
  }

  public GroupsCountResult addAccountCountErrorsItem(AccountCountError accountCountErrorsItem) {
  ...
  public GroupsCountResult accountCounts(List<AccountCount> accountCounts) {
    this.accountCounts = accountCounts;
    return this;
  }

  public GroupsCountResult addAccountCountsItem(AccountCount accountCountsItem) {
  ...
  public GroupsCountResult matchingAccountsCount(String matchingAccountsCount) {
  ...
  public GroupsCountResult nonQueryableAccounts(List<String> nonQueryableAccounts) {
    this.nonQueryableAccounts = nonQueryableAccounts;
    return this;
  }

  public GroupsCountResult addNonQueryableAccountsItem(String nonQueryableAccountsItem) {
  ...
  public GroupsCountResult queriedAccountsCount(String queriedAccountsCount) {
  ...
  public boolean equals(Object o) {
    ...
    GroupsCountResult groupsCountResult = (GroupsCountResult) o;
    return Objects.equals(this.accountCountErrors, groupsCountResult.accountCountErrors) &&
        Objects.equals(this.accountCounts, groupsCountResult.accountCounts) &&
        Objects.equals(this.matchingAccountsCount, groupsCountResult.matchingAccountsCount) &&
        Objects.equals(this.nonQueryableAccounts, groupsCountResult.nonQueryableAccounts) &&
        Objects.equals(this.queriedAccountsCount, groupsCountResult.queriedAccountsCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsCountResult {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GroupsCountResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupsCountResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupsCountResult is not found in the empty JSON string", GroupsCountResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GroupsCountResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GroupsCountResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupsCountResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupsCountResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupsCountResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupsCountResult.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupsCountResult>() {
           @Override
           public void write(JsonWriter out, GroupsCountResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GroupsCountResult read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GroupsCountResult given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GroupsCountResult
   * @throws IOException if the JSON string is invalid with respect to GroupsCountResult
   */
  public static GroupsCountResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupsCountResult.class);
  }

  /**
   * Convert an instance of GroupsCountResult to an JSON string
   *
   * @return JSON string
   */
