...
class TestMigrationInsight(unittest.TestCase):
    """MigrationInsight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MigrationInsight:
        """Test MigrationInsight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MigrationInsight`
        """
        model = MigrationInsight()
        if include_optional:
