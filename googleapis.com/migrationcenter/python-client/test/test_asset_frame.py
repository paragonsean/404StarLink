...
class TestAssetFrame(unittest.TestCase):
    """AssetFrame unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssetFrame:
        """Test AssetFrame
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssetFrame`
        """
        model = AssetFrame()
        if include_optional:
            return AssetFrame(
