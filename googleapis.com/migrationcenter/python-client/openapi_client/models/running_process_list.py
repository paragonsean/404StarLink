...
class RunningProcessList(BaseModel):
    ...
    """ # noqa: E501
    processes: Optional[List[RunningProcess]] = Field(default=None, description="Running process entries.")
    __properties: ClassVar[List[str]] = ["processes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "processes": [RunningProcess.from_dict(_item) for _item in obj["processes"]] if obj.get("processes") is not None else None
        })
        return _obj
