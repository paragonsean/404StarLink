...
class AggregationResultHistogram(BaseModel):
    """
    The result of a bucketed histogram aggregation.
    """ # noqa: E501
    buckets: Optional[List[AggregationResultHistogramBucket]] = Field(default=None, description="Buckets in the histogram. There will be `n+1` buckets matching `n` lower bounds in the request. The first bucket will be from -infinity to the first bound. Subsequent buckets will be between one bound and the next. The final bucket will be from the final bound to infinity.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buckets": [AggregationResultHistogramBucket.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None
        })
        return _obj
