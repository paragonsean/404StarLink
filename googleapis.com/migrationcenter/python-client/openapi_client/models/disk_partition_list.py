...
class DiskPartitionList(BaseModel):
    """
    Disk partition list.
    """ # noqa: E501
    entries: Optional[List[DiskPartition]] = Field(default=None, description="Partition entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [DiskPartition.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj

from openapi_client.models.disk_partition import DiskPartition
# TODO: Rewrite to not use raise_errors
DiskPartitionList.model_rebuild(raise_errors=False)
