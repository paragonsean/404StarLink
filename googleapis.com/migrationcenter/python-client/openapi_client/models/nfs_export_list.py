...
class NfsExportList(BaseModel):
    """
    NFS exports.
    """ # noqa: E501
    entries: Optional[List[NfsExport]] = Field(default=None, description="NFS export entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [NfsExport.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
