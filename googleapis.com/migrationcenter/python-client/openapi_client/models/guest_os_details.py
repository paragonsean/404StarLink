...
class GuestOsDetails(BaseModel):
    """
    Information from Guest-level collections.
    """ # noqa: E501
    config: Optional[GuestConfigDetails] = None
    runtime: Optional[GuestRuntimeDetails] = None
    __properties: ClassVar[List[str]] = ["config", "runtime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": GuestConfigDetails.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "runtime": GuestRuntimeDetails.from_dict(obj["runtime"]) if obj.get("runtime") is not None else None
        })
        return _obj
