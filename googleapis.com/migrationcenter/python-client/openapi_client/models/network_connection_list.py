...
class NetworkConnectionList(BaseModel):
    ...
    """ # noqa: E501
    entries: Optional[List[NetworkConnection]] = Field(default=None, description="Network connection entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [NetworkConnection.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
