...
class VirtualMachinePreferences(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["commitmentPlan", "computeEnginePreferences", "regionPreferences", "sizingOptimizationStrategy"]
    ...
    def sizing_optimization_strategy_validate_enum(cls, value):
        ...
        if value not in set(['SIZING_OPTIMIZATION_STRATEGY_UNSPECIFIED', 'SIZING_OPTIMIZATION_STRATEGY_SAME_AS_SOURCE', 'SIZING_OPTIMIZATION_STRATEGY_MODERATE', 'SIZING_OPTIMIZATION_STRATEGY_AGGRESSIVE']):
            raise ValueError("must be one of enum values ('SIZING_OPTIMIZATION_STRATEGY_UNSPECIFIED', 'SIZING_OPTIMIZATION_STRATEGY_SAME_AS_SOURCE', 'SIZING_OPTIMIZATION_STRATEGY_MODERATE', 'SIZING_OPTIMIZATION_STRATEGY_AGGRESSIVE')")
        return value
