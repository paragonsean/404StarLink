...
class ReportSummaryGroupPreferenceSetFinding(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "displayName", "machineFinding", "machinePreferences", "monthlyCostCompute", "monthlyCostNetworkEgress", "monthlyCostOsLicense", "monthlyCostOther", "monthlyCostStorage", "monthlyCostTotal", "preferredRegion", "pricingTrack", "topPriority"]
