...
> GoogleHomeEnterpriseSdmV1ListDevicesResponse smartdevicemanagementEnterprisesDevicesList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, pageSize, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer pageSize = 56; // Integer | Optional requested page size. Server may return fewer devices than requested. If unspecified, server will pick an appropriate default.
    String pageToken = "pageToken_example"; // String | Optional token of the page to retrieve.
    try {
      GoogleHomeEnterpriseSdmV1ListDevicesResponse result = apiInstance.smartdevicemanagementEnterprisesDevicesList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, pageSize, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
...
| **pageSize** | **Integer**| Optional requested page size. Server may return fewer devices than requested. If unspecified, server will pick an appropriate default. | [optional] |
| **pageToken** | **String**| Optional token of the page to retrieve. | [optional] |
...
> GoogleHomeEnterpriseSdmV1ListStructuresResponse smartdevicemanagementEnterprisesStructuresList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, pageSize, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer pageSize = 56; // Integer | Requested page size. Server may return fewer structures than requested. If unspecified, server will pick an appropriate default.
    String pageToken = "pageToken_example"; // String | The token of the page to retrieve.
    try {
      GoogleHomeEnterpriseSdmV1ListStructuresResponse result = apiInstance.smartdevicemanagementEnterprisesStructuresList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, filter, pageSize, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
...
| **pageSize** | **Integer**| Requested page size. Server may return fewer structures than requested. If unspecified, server will pick an appropriate default. | [optional] |
...
> GoogleHomeEnterpriseSdmV1ListRoomsResponse smartdevicemanagementEnterprisesStructuresRoomsList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, pageSize, pageToken)
...
public class Example {
  public static void main(String[] args) {
    ...
    String uploadProtocol = "uploadProtocol_example"; // String | Upload protocol for media (e.g. \"raw\", \"multipart\").
    String uploadType = "uploadType_example"; // String | Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    Integer pageSize = 56; // Integer | Requested page size. Server may return fewer rooms than requested. If unspecified, server will pick an appropriate default.
    String pageToken = "pageToken_example"; // String | The token of the page to retrieve.
    try {
      GoogleHomeEnterpriseSdmV1ListRoomsResponse result = apiInstance.smartdevicemanagementEnterprisesStructuresRoomsList(parent, $xgafv, accessToken, alt, paramCallback, fields, key, oauthToken, prettyPrint, quotaUser, uploadProtocol, uploadType, pageSize, pageToken);
      System.out.println(result);
    } catch (ApiException e) {
...
| **uploadProtocol** | **String**| Upload protocol for media (e.g. \&quot;raw\&quot;, \&quot;multipart\&quot;). | [optional] |
| **uploadType** | **String**| Legacy upload protocol for media (e.g. \&quot;media\&quot;, \&quot;multipart\&quot;). | [optional] |
| **pageSize** | **Integer**| Requested page size. Server may return fewer rooms than requested. If unspecified, server will pick an appropriate default. | [optional] |
| **pageToken** | **String**| The token of the page to retrieve. | [optional] |
