...
class ContactCenter(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["adminUser", "ccaipManagedUsers", "createTime", "customerDomainPrefix", "displayName", "instanceConfig", "labels", "name", "samlParams", "state", "updateTime", "uris", "userEmail"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['STATE_UNSPECIFIED', 'STATE_DEPLOYING', 'STATE_DEPLOYED', 'STATE_TERMINATING', 'STATE_FAILED', 'STATE_TERMINATING_FAILED', 'STATE_TERMINATED']):
            raise ValueError("must be one of enum values ('STATE_UNSPECIFIED', 'STATE_DEPLOYING', 'STATE_DEPLOYED', 'STATE_TERMINATING', 'STATE_FAILED', 'STATE_TERMINATING_FAILED', 'STATE_TERMINATED')")
        return value
