...
class TestListContactCentersResponse(unittest.TestCase):
    """ListContactCentersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListContactCentersResponse:
        """Test ListContactCentersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListContactCentersResponse`
        """
        model = ListContactCentersResponse()
        if include_optional:
            return ListContactCentersResponse(
                contact_centers = [
                    openapi_client.models.contact_center.ContactCenter(
    ...
    def testListContactCentersResponse(self):
        """Test ListContactCentersResponse"""
