...
class TestUpdateInstanceConfigMetadata(unittest.TestCase):
    """UpdateInstanceConfigMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateInstanceConfigMetadata:
        """Test UpdateInstanceConfigMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateInstanceConfigMetadata`
        """
        model = UpdateInstanceConfigMetadata()
        if include_optional:
    ...
    def testUpdateInstanceConfigMetadata(self):
        """Test UpdateInstanceConfigMetadata"""
