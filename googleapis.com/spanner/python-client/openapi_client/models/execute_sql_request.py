...
class ExecuteSqlRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dataBoostEnabled", "paramTypes", "params", "partitionToken", "queryMode", "queryOptions", "requestOptions", "resumeToken", "seqno", "sql", "transaction"]
