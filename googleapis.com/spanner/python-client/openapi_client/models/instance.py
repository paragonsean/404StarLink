...
class Instance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["config", "createTime", "displayName", "endpointUris", "freeInstanceMetadata", "instanceType", "labels", "name", "nodeCount", "processingUnits", "state", "updateTime"]
