...
class Database(BaseModel):
    ...
    enable_drop_protection: Optional[StrictBool] = Field(default=None, description="Whether drop protection is enabled for this database. Defaults to false, if not set.", alias="enableDropProtection")
