...
public class SecurityContext {
   ...
   */
  @JsonAdapter(SecuritiesEnum.Adapter.class)
  public enum SecuritiesEnum {
    ...
    public static SecuritiesEnum fromValue(String value) {
      for (SecuritiesEnum b : SecuritiesEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<SecuritiesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SecuritiesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SecuritiesEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SecuritiesEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      SecuritiesEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_SECURITIES = "securities";
  @SerializedName(SERIALIZED_NAME_SECURITIES)
  private List<SecuritiesEnum> securities = new ArrayList<>();

  public SecurityContext() {
  }

  public SecurityContext securities(List<SecuritiesEnum> securities) {
    this.securities = securities;
    return this;
  }

  public SecurityContext addSecuritiesItem(SecuritiesEnum securitiesItem) {
  ...
  public List<SecuritiesEnum> getSecurities() {
    return securities;
  }

  public void setSecurities(List<SecuritiesEnum> securities) {
    this.securities = securities;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.securities, securityContext.securities);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("securities") != null && !jsonObj.get("securities").isJsonNull() && !jsonObj.get("securities").isJsonArray()) {
