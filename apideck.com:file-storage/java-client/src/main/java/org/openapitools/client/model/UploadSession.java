...
public class UploadSession {
  ...
  public static final String SERIALIZED_NAME_PARALLEL_UPLOAD_SUPPORTED = "parallel_upload_supported";
  @SerializedName(SERIALIZED_NAME_PARALLEL_UPLOAD_SUPPORTED)
  ...
  public static final String SERIALIZED_NAME_UPLOADED_BYTE_RANGE = "uploaded_byte_range";
  @SerializedName(SERIALIZED_NAME_UPLOADED_BYTE_RANGE)
  ...
  public UploadSession(
     ...
     String id, 
     Boolean parallelUploadSupported, 
     BigDecimal partSize, 
     Boolean success, 
     String uploadedByteRange
  ) {
    this();
   ...
   */
  @javax.annotation.Nullable
  public Boolean getParallelUploadSupported() {
    return parallelUploadSupported;
  }
   ...
   */
  @javax.annotation.Nullable
  public String getUploadedByteRange() {
    return uploadedByteRange;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.expiresAt, uploadSession.expiresAt) &&
        Objects.equals(this.id, uploadSession.id) &&
        Objects.equals(this.parallelUploadSupported, uploadSession.parallelUploadSupported) &&
        Objects.equals(this.partSize, uploadSession.partSize) &&
        Objects.equals(this.success, uploadSession.success) &&
        Objects.equals(this.uploadedByteRange, uploadSession.uploadedByteRange);
  }

  @Override
  public int hashCode() {
    return Objects.hash(expiresAt, id, parallelUploadSupported, partSize, success, uploadedByteRange);
  }
  ...
  public String toString() {
    ...
    sb.append("    parallelUploadSupported: ").append(toIndentedString(parallelUploadSupported)).append("\n");
    sb.append("    partSize: ").append(toIndentedString(partSize)).append("\n");
    sb.append("    success: ").append(toIndentedString(success)).append("\n");
    sb.append("    uploadedByteRange: ").append(toIndentedString(uploadedByteRange)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("parallel_upload_supported");
    openapiFields.add("part_size");
    openapiFields.add("success");
    openapiFields.add("uploaded_byte_range");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("uploaded_byte_range") != null && !jsonObj.get("uploaded_byte_range").isJsonNull()) && !jsonObj.get("uploaded_byte_range").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `uploaded_byte_range` to be a primitive type in the JSON string but got `%s`", jsonObj.get("uploaded_byte_range").toString()));
      }
  }
