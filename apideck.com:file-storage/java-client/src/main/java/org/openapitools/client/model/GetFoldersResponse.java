...
public class GetFoldersResponse {
  ...
  public GetFoldersResponse data(List<Folder> data) {
    this.data = data;
    return this;
  }

  public GetFoldersResponse addDataItem(Folder dataItem) {
    if (this.data == null) {
  ...
  public GetFoldersResponse links(Links links) {
    this.links = links;
    return this;
  }
  ...
  public GetFoldersResponse meta(Meta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public GetFoldersResponse operation(String operation) {
  ...
  public GetFoldersResponse resource(String resource) {
  ...
  public GetFoldersResponse service(String service) {
  ...
  public GetFoldersResponse statusCode(Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getFoldersResponse.data) &&
        Objects.equals(this.links, getFoldersResponse.links) &&
        Objects.equals(this.meta, getFoldersResponse.meta) &&
        Objects.equals(this.operation, getFoldersResponse.operation) &&
        Objects.equals(this.resource, getFoldersResponse.resource) &&
        Objects.equals(this.service, getFoldersResponse.service) &&
        Objects.equals(this.status, getFoldersResponse.status) &&
        Objects.equals(this.statusCode, getFoldersResponse.statusCode);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFoldersResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFoldersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFoldersResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFoldersResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
