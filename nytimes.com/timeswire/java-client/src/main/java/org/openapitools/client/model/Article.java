...
public class Article {
  ...
  public static final String SERIALIZED_NAME_BLOG_NAME = "blog_name";
  @SerializedName(SERIALIZED_NAME_BLOG_NAME)
  ...
  public Article blogName(String blogName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._abstract, article._abstract) &&
        Objects.equals(this.blogName, article.blogName) &&
        ...
        Objects.equals(this.headline, article.headline) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_abstract, blogName, byline, createdDate, desFacet, geoFacet, headline, itemType, kicker, materialTypeFacet, multimedia, orgFacet, perFacet, publishedDate, relatedUrls, section, shortUrl, source, subsection, thumbnailStandard, title, updatedDate, url);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("blog_name") != null && !jsonObj.get("blog_name").isJsonNull()) && !jsonObj.get("blog_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `blog_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("blog_name").toString()));
      }
      ...
      if ((jsonObj.get("org_facet") != null && !jsonObj.get("org_facet").isJsonNull()) && !jsonObj.get("org_facet").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `org_facet` to be a primitive type in the JSON string but got `%s`", jsonObj.get("org_facet").toString()));
      }
      // ensure the optional json data is an array if present
