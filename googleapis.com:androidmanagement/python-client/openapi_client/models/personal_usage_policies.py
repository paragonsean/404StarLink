...
class PersonalUsagePolicies(BaseModel):
    ...
    max_days_with_work_off: Optional[StrictInt] = Field(default=None, description="Controls how long the work profile can stay off. The duration must be at least 3 days.", alias="maxDaysWithWorkOff")
