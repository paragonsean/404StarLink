...
class Command(BaseModel):
    ...
    new_password: Optional[StrictStr] = Field(default=None, description="For commands of type RESET_PASSWORD, optionally specifies the new password.", alias="newPassword")
    ...
    __properties: ClassVar[List[str]] = ["clearAppsDataParams", "clearAppsDataStatus", "createTime", "duration", "errorCode", "newPassword", "resetPasswordFlags", "type", "userName"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['COMMAND_TYPE_UNSPECIFIED', 'LOCK', 'RESET_PASSWORD', 'REBOOT', 'RELINQUISH_OWNERSHIP', 'CLEAR_APP_DATA']):
            raise ValueError("must be one of enum values ('COMMAND_TYPE_UNSPECIFIED', 'LOCK', 'RESET_PASSWORD', 'REBOOT', 'RELINQUISH_OWNERSHIP', 'CLEAR_APP_DATA')")
        return value
