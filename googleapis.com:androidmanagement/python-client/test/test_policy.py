    ...
    def make_instance(self, include_optional) -> Policy:
        ...
        if include_optional:
            return Policy(
                ...
                permitted_input_methods = openapi_client.models.package_name_list.PackageNameList(
                    package_names = [
                        ''
                        ], ),
                ...
                short_support_message = openapi_client.models.user_facing_message.UserFacingMessage(
                    default_message = '', 
                    localized_messages = {
                        'key' : ''
                        }, ),
