...
import org.openapitools.client.model.TokenResource;
...
public class CreateTokenResponse {
  ...
  private TokenResource data;

  public static final String SERIALIZED_NAME_INCLUDED = "included";
  @SerializedName(SERIALIZED_NAME_INCLUDED)
  private List<GroupResource> included = new ArrayList<>();
  ...
  public CreateTokenResponse data(TokenResource data) {
    this.data = data;
    return this;
  }
  ...
  public TokenResource getData() {
    return data;
  }

  public void setData(TokenResource data) {
    this.data = data;
  }


  public CreateTokenResponse included(List<GroupResource> included) {
    this.included = included;
    return this;
  }

  public CreateTokenResponse addIncludedItem(GroupResource includedItem) {
  ...
  public List<GroupResource> getIncluded() {
    return included;
  }

  public void setIncluded(List<GroupResource> included) {
    this.included = included;
  }


  public CreateTokenResponse meta(CreateOrUpdateMetaResponse meta) {
    this.meta = meta;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createTokenResponse.data) &&
        Objects.equals(this.included, createTokenResponse.included) &&
        Objects.equals(this.meta, createTokenResponse.meta);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (String requiredField : CreateTokenResponse.openapiRequiredFields) {
      ...
      TokenResource.validateJsonElement(jsonObj.get("data"));
      if (jsonObj.get("included") != null && !jsonObj.get("included").isJsonNull()) {
        ...
        if (jsonArrayincluded != null) {
          ...
          for (int i = 0; i < jsonArrayincluded.size(); i++) {
            GroupResource.validateJsonElement(jsonArrayincluded.get(i));
          };
        }
      }
