...
class DataReplicationInitiationStep(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": DataReplicationInitiationStepName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "status": DataReplicationInitiationStepStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
