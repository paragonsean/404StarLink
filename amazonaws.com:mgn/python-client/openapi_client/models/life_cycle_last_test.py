...
class LifeCycleLastTest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "finalized": LifeCycleLastTestFinalized.from_dict(obj["finalized"]) if obj.get("finalized") is not None else None,
            "initiated": LifeCycleLastTestInitiated.from_dict(obj["initiated"]) if obj.get("initiated") is not None else None,
            "reverted": LifeCycleLastTestReverted.from_dict(obj["reverted"]) if obj.get("reverted") is not None else None
        })
        return _obj
