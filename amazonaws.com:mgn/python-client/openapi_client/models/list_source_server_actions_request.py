...
class ListSourceServerActionsRequest(BaseModel):
    ...
    """ # noqa: E501
    filters: Optional[ListSourceServerActionsRequestFilters] = None
    max_results: Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]] = Field(default=None, description="Maximum amount of items to return when listing source server post migration custom actions.", alias="maxResults")
    next_token: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=2048)]] = Field(default=None, description="Next token to use when listing source server post migration custom actions.", alias="nextToken")
    ...
    __properties: ClassVar[List[str]] = ["filters", "maxResults", "nextToken", "sourceServerID"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": ListSourceServerActionsRequestFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
