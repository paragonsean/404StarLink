...
class LaunchConfigurationTemplateSmallVolumeConf(BaseModel):
    """
    LaunchConfigurationTemplateSmallVolumeConf
    """ # noqa: E501
    iops: Optional[Any] = None
    throughput: Optional[Any] = None
    volume_type: Optional[Any] = Field(default=None, alias="volumeType")
    __properties: ClassVar[List[str]] = ["iops", "throughput", "volumeType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "volumeType": VolumeType.from_dict(obj["volumeType"]) if obj.get("volumeType") is not None else None
        })
        return _obj
