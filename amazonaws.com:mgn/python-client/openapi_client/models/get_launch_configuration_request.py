...
class GetLaunchConfigurationRequest(BaseModel):
    ...
    """ # noqa: E501
    source_server_id: Annotated[str, Field(min_length=19, strict=True, max_length=19)] = Field(description="Request to get Launch Configuration information by Source Server ID.", alias="sourceServerID")
    __properties: ClassVar[List[str]] = ["sourceServerID"]
