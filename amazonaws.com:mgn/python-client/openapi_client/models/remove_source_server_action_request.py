...
class RemoveSourceServerActionRequest(BaseModel):
    ...
    """ # noqa: E501
    action_id: Annotated[str, Field(min_length=1, strict=True, max_length=64)] = Field(description="Source server post migration custom action ID to remove.", alias="actionID")
    source_server_id: Annotated[str, Field(min_length=19, strict=True, max_length=19)] = Field(description="Source server ID of the post migration custom action to remove.", alias="sourceServerID")
    __properties: ClassVar[List[str]] = ["actionID", "sourceServerID"]
