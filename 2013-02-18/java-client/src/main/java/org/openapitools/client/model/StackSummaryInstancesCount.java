...
public class StackSummaryInstancesCount {
  ...
  public StackSummaryInstancesCount() {
  }

  public StackSummaryInstancesCount assigning(Integer assigning) {
  ...
  public StackSummaryInstancesCount booting(Integer booting) {
  ...
  public StackSummaryInstancesCount connectionLost(Integer connectionLost) {
  ...
  public StackSummaryInstancesCount deregistering(Integer deregistering) {
  ...
  public StackSummaryInstancesCount online(Integer online) {
    this.online = online;
    return this;
  }
  ...
  public StackSummaryInstancesCount pending(Integer pending) {
  ...
  public StackSummaryInstancesCount rebooting(Integer rebooting) {
  ...
  public StackSummaryInstancesCount registered(Integer registered) {
  ...
  public StackSummaryInstancesCount registering(Integer registering) {
  ...
  public StackSummaryInstancesCount requested(Integer requested) {
  ...
  public StackSummaryInstancesCount runningSetup(Integer runningSetup) {
  ...
  public StackSummaryInstancesCount setupFailed(Integer setupFailed) {
  ...
  public StackSummaryInstancesCount shuttingDown(Integer shuttingDown) {
  ...
  public StackSummaryInstancesCount startFailed(Integer startFailed) {
  ...
  public StackSummaryInstancesCount stopFailed(Integer stopFailed) {
  ...
  public StackSummaryInstancesCount stopped(Integer stopped) {
  ...
  public StackSummaryInstancesCount stopping(Integer stopping) {
  ...
  public StackSummaryInstancesCount terminated(Integer terminated) {
  ...
  public StackSummaryInstancesCount terminating(Integer terminating) {
  ...
  public StackSummaryInstancesCount unassigning(Integer unassigning) {
  ...
  public boolean equals(Object o) {
    ...
    StackSummaryInstancesCount stackSummaryInstancesCount = (StackSummaryInstancesCount) o;
    return Objects.equals(this.assigning, stackSummaryInstancesCount.assigning) &&
        Objects.equals(this.booting, stackSummaryInstancesCount.booting) &&
        Objects.equals(this.connectionLost, stackSummaryInstancesCount.connectionLost) &&
        Objects.equals(this.deregistering, stackSummaryInstancesCount.deregistering) &&
        Objects.equals(this.online, stackSummaryInstancesCount.online) &&
        Objects.equals(this.pending, stackSummaryInstancesCount.pending) &&
        Objects.equals(this.rebooting, stackSummaryInstancesCount.rebooting) &&
        Objects.equals(this.registered, stackSummaryInstancesCount.registered) &&
        Objects.equals(this.registering, stackSummaryInstancesCount.registering) &&
        Objects.equals(this.requested, stackSummaryInstancesCount.requested) &&
        Objects.equals(this.runningSetup, stackSummaryInstancesCount.runningSetup) &&
        Objects.equals(this.setupFailed, stackSummaryInstancesCount.setupFailed) &&
        Objects.equals(this.shuttingDown, stackSummaryInstancesCount.shuttingDown) &&
        Objects.equals(this.startFailed, stackSummaryInstancesCount.startFailed) &&
        Objects.equals(this.stopFailed, stackSummaryInstancesCount.stopFailed) &&
        Objects.equals(this.stopped, stackSummaryInstancesCount.stopped) &&
        Objects.equals(this.stopping, stackSummaryInstancesCount.stopping) &&
        Objects.equals(this.terminated, stackSummaryInstancesCount.terminated) &&
        Objects.equals(this.terminating, stackSummaryInstancesCount.terminating) &&
        Objects.equals(this.unassigning, stackSummaryInstancesCount.unassigning);
  }
  ...
  public String toString() {
    ...
    sb.append("class StackSummaryInstancesCount {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to StackSummaryInstancesCount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StackSummaryInstancesCount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StackSummaryInstancesCount is not found in the empty JSON string", StackSummaryInstancesCount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StackSummaryInstancesCount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `StackSummaryInstancesCount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StackSummaryInstancesCount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StackSummaryInstancesCount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StackSummaryInstancesCount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StackSummaryInstancesCount.class));

       return (TypeAdapter<T>) new TypeAdapter<StackSummaryInstancesCount>() {
           @Override
           public void write(JsonWriter out, StackSummaryInstancesCount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public StackSummaryInstancesCount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of StackSummaryInstancesCount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of StackSummaryInstancesCount
   * @throws IOException if the JSON string is invalid with respect to StackSummaryInstancesCount
   */
  public static StackSummaryInstancesCount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StackSummaryInstancesCount.class);
  }

  /**
   * Convert an instance of StackSummaryInstancesCount to an JSON string
   *
   * @return JSON string
   */
