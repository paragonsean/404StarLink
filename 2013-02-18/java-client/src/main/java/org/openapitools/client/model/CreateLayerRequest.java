...
import org.openapitools.client.model.CreateLayerRequestCustomRecipes;
import org.openapitools.client.model.CreateLayerRequestLifecycleEventConfiguration;
...
public class CreateLayerRequest {
  ...
  private CreateLayerRequestCustomRecipes customRecipes;
  ...
  private CreateLayerRequestLifecycleEventConfiguration lifecycleEventConfiguration;

  public CreateLayerRequest() {
  }

  public CreateLayerRequest stackId(String stackId) {
  ...
  public CreateLayerRequest type(LayerType type) {
    this.type = type;
    return this;
  }
  ...
  public CreateLayerRequest name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateLayerRequest shortname(String shortname) {
  ...
  public CreateLayerRequest attributes(Map attributes) {
  ...
  public CreateLayerRequest cloudWatchLogsConfiguration(CreateLayerRequestCloudWatchLogsConfiguration cloudWatchLogsConfiguration) {
  ...
  public CreateLayerRequest customInstanceProfileArn(String customInstanceProfileArn) {
  ...
  public CreateLayerRequest customJson(String customJson) {
  ...
  public CreateLayerRequest customSecurityGroupIds(List customSecurityGroupIds) {
  ...
  public CreateLayerRequest packages(List packages) {
  ...
  public CreateLayerRequest volumeConfigurations(List volumeConfigurations) {
  ...
  public CreateLayerRequest enableAutoHealing(Boolean enableAutoHealing) {
  ...
  public CreateLayerRequest autoAssignElasticIps(Boolean autoAssignElasticIps) {
  ...
  public CreateLayerRequest autoAssignPublicIps(Boolean autoAssignPublicIps) {
  ...
  public CreateLayerRequest customRecipes(CreateLayerRequestCustomRecipes customRecipes) {
   ...
   */
  @javax.annotation.Nullable
  public CreateLayerRequestCustomRecipes getCustomRecipes() {
    return customRecipes;
  }

  public void setCustomRecipes(CreateLayerRequestCustomRecipes customRecipes) {
    this.customRecipes = customRecipes;
  }


  public CreateLayerRequest installUpdatesOnBoot(Boolean installUpdatesOnBoot) {
  ...
  public CreateLayerRequest useEbsOptimizedInstances(Boolean useEbsOptimizedInstances) {
  ...
  public CreateLayerRequest lifecycleEventConfiguration(CreateLayerRequestLifecycleEventConfiguration lifecycleEventConfiguration) {
   ...
   */
  @javax.annotation.Nullable
  public CreateLayerRequestLifecycleEventConfiguration getLifecycleEventConfiguration() {
    return lifecycleEventConfiguration;
  }

  public void setLifecycleEventConfiguration(CreateLayerRequestLifecycleEventConfiguration lifecycleEventConfiguration) {
    this.lifecycleEventConfiguration = lifecycleEventConfiguration;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateLayerRequest createLayerRequest = (CreateLayerRequest) o;
    return Objects.equals(this.stackId, createLayerRequest.stackId) &&
        Objects.equals(this.type, createLayerRequest.type) &&
        Objects.equals(this.name, createLayerRequest.name) &&
        Objects.equals(this.shortname, createLayerRequest.shortname) &&
        Objects.equals(this.attributes, createLayerRequest.attributes) &&
        Objects.equals(this.cloudWatchLogsConfiguration, createLayerRequest.cloudWatchLogsConfiguration) &&
        Objects.equals(this.customInstanceProfileArn, createLayerRequest.customInstanceProfileArn) &&
        Objects.equals(this.customJson, createLayerRequest.customJson) &&
        Objects.equals(this.customSecurityGroupIds, createLayerRequest.customSecurityGroupIds) &&
        Objects.equals(this.packages, createLayerRequest.packages) &&
        Objects.equals(this.volumeConfigurations, createLayerRequest.volumeConfigurations) &&
        Objects.equals(this.enableAutoHealing, createLayerRequest.enableAutoHealing) &&
        Objects.equals(this.autoAssignElasticIps, createLayerRequest.autoAssignElasticIps) &&
        Objects.equals(this.autoAssignPublicIps, createLayerRequest.autoAssignPublicIps) &&
        Objects.equals(this.customRecipes, createLayerRequest.customRecipes) &&
        Objects.equals(this.installUpdatesOnBoot, createLayerRequest.installUpdatesOnBoot) &&
        Objects.equals(this.useEbsOptimizedInstances, createLayerRequest.useEbsOptimizedInstances) &&
        Objects.equals(this.lifecycleEventConfiguration, createLayerRequest.lifecycleEventConfiguration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(stackId, type, name, shortname, attributes, cloudWatchLogsConfiguration, customInstanceProfileArn, customJson, customSecurityGroupIds, packages, volumeConfigurations, enableAutoHealing, autoAssignElasticIps, autoAssignPublicIps, customRecipes, installUpdatesOnBoot, useEbsOptimizedInstances, lifecycleEventConfiguration);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateLayerRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateLayerRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateLayerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateLayerRequest is not found in the empty JSON string", CreateLayerRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateLayerRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateLayerRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateLayerRequest.openapiRequiredFields) {
      ...
      // validate the required field `Shortname`
      ...
      if (jsonObj.get("CustomRecipes") != null && !jsonObj.get("CustomRecipes").isJsonNull()) {
        CreateLayerRequestCustomRecipes.validateJsonElement(jsonObj.get("CustomRecipes"));
      }
      ...
      if (jsonObj.get("LifecycleEventConfiguration") != null && !jsonObj.get("LifecycleEventConfiguration").isJsonNull()) {
        CreateLayerRequestLifecycleEventConfiguration.validateJsonElement(jsonObj.get("LifecycleEventConfiguration"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateLayerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateLayerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateLayerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateLayerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateLayerRequest>() {
           @Override
           public void write(JsonWriter out, CreateLayerRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateLayerRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateLayerRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateLayerRequest
   * @throws IOException if the JSON string is invalid with respect to CreateLayerRequest
   */
  public static CreateLayerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateLayerRequest.class);
  }

  /**
   * Convert an instance of CreateLayerRequest to an JSON string
   *
   * @return JSON string
   */
