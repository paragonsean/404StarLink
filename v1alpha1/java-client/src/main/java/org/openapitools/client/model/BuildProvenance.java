...
public class BuildProvenance {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(buildOptions, builderVersion, builtArtifacts, commands, createTime, creator, finishTime, id, logsBucket, projectId, sourceProvenance, startTime, triggerId);
  }
