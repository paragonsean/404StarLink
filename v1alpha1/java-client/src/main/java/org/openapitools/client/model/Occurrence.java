...
import org.openapitools.client.model.BuildDetails;
...
import org.openapitools.client.model.VulnerabilityDetails;
...
public class Occurrence {
  ...
  public static final String SERIALIZED_NAME_BUILD_DETAILS = "buildDetails";
  @SerializedName(SERIALIZED_NAME_BUILD_DETAILS)
  ...
  public static final String SERIALIZED_NAME_VULNERABILITY_DETAILS = "vulnerabilityDetails";
  @SerializedName(SERIALIZED_NAME_VULNERABILITY_DETAILS)
  private VulnerabilityDetails vulnerabilityDetails;

  public Occurrence() {
  }

  public Occurrence attestation(Attestation attestation) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attestation, buildDetails, compliance, createTime, deployment, derivedImage, discovered, dsseAttestation, envelope, installation, kind, name, noteName, remediation, resource, resourceUrl, sbom, sbomReference, spdxFile, spdxPackage, spdxRelationship, updateTime, upgrade, vulnerabilityDetails);
  }
  ...
  static {
    ...
    openapiFields.add("buildDetails");
    ...
    openapiFields.add("vulnerabilityDetails");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("buildDetails") != null && !jsonObj.get("buildDetails").isJsonNull()) {
        BuildDetails.validateJsonElement(jsonObj.get("buildDetails"));
      }
      ...
      if (jsonObj.get("vulnerabilityDetails") != null && !jsonObj.get("vulnerabilityDetails").isJsonNull()) {
        VulnerabilityDetails.validateJsonElement(jsonObj.get("vulnerabilityDetails"));
      }
  }
