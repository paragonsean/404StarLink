...
import org.openapitools.client.model.GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaBuilder;
import org.openapitools.client.model.GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaInvocation;
import org.openapitools.client.model.GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMaterial;
import org.openapitools.client.model.GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMetadata;
...
public class SlsaProvenanceZeroTwo {
  ...
  private List<GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMaterial> materials = new ArrayList<>();
  ...
  public SlsaProvenanceZeroTwo builder(GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaBuilder builder) {
  ...
  public void setBuilder(GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaBuilder builder) {
    this.builder = builder;
  }


  public SlsaProvenanceZeroTwo invocation(GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaInvocation invocation) {
  ...
  public void setInvocation(GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaInvocation invocation) {
    this.invocation = invocation;
  }


  public SlsaProvenanceZeroTwo materials(List<GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMaterial> materials) {
    this.materials = materials;
    return this;
  }

  public SlsaProvenanceZeroTwo addMaterialsItem(GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMaterial materialsItem) {
  ...
  public void setMaterials(List<GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMaterial> materials) {
    this.materials = materials;
  }


  public SlsaProvenanceZeroTwo metadata(GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMetadata metadata) {
  ...
  public void setMetadata(GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMetadata metadata) {
    this.metadata = metadata;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("builder") != null && !jsonObj.get("builder").isJsonNull()) {
        GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaBuilder.validateJsonElement(jsonObj.get("builder"));
      }
      // validate the optional field `invocation`
      if (jsonObj.get("invocation") != null && !jsonObj.get("invocation").isJsonNull()) {
        GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaInvocation.validateJsonElement(jsonObj.get("invocation"));
      }
      if (jsonObj.get("materials") != null && !jsonObj.get("materials").isJsonNull()) {
        ...
        if (jsonArraymaterials != null) {
          ...
          for (int i = 0; i < jsonArraymaterials.size(); i++) {
            GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMaterial.validateJsonElement(jsonArraymaterials.get(i));
          };
        }
      }
      // validate the optional field `metadata`
      if (jsonObj.get("metadata") != null && !jsonObj.get("metadata").isJsonNull()) {
        GoogleDevtoolsContaineranalysisV1alpha1SlsaProvenanceZeroTwoSlsaMetadata.validateJsonElement(jsonObj.get("metadata"));
      }
  }
