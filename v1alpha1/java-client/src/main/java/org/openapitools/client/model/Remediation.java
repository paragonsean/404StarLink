...
public class Remediation {
  ...
  public Remediation remediationUri(URI remediationUri) {
  ...
  public void setRemediationUri(URI remediationUri) {
    this.remediationUri = remediationUri;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("remediationUri") != null && !jsonObj.get("remediationUri").isJsonNull()) {
        URI.validateJsonElement(jsonObj.get("remediationUri"));
      }
  }
