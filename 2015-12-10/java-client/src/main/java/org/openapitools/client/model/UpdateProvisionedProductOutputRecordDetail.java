...
public class UpdateProvisionedProductOutputRecordDetail {
  ...
  public UpdateProvisionedProductOutputRecordDetail() {
  }

  public UpdateProvisionedProductOutputRecordDetail recordId(String recordId) {
  ...
  public UpdateProvisionedProductOutputRecordDetail provisionedProductName(String provisionedProductName) {
  ...
  public UpdateProvisionedProductOutputRecordDetail status(RecordStatus status) {
    this.status = status;
    return this;
  }
  ...
  public UpdateProvisionedProductOutputRecordDetail createdTime(OffsetDateTime createdTime) {
  ...
  public UpdateProvisionedProductOutputRecordDetail updatedTime(OffsetDateTime updatedTime) {
  ...
  public UpdateProvisionedProductOutputRecordDetail provisionedProductType(String provisionedProductType) {
  ...
  public UpdateProvisionedProductOutputRecordDetail recordType(String recordType) {
  ...
  public UpdateProvisionedProductOutputRecordDetail provisionedProductId(String provisionedProductId) {
  ...
  public UpdateProvisionedProductOutputRecordDetail productId(String productId) {
  ...
  public UpdateProvisionedProductOutputRecordDetail provisioningArtifactId(String provisioningArtifactId) {
  ...
  public UpdateProvisionedProductOutputRecordDetail pathId(String pathId) {
    this.pathId = pathId;
    return this;
  }
  ...
  public UpdateProvisionedProductOutputRecordDetail recordErrors(List recordErrors) {
  ...
  public UpdateProvisionedProductOutputRecordDetail recordTags(List recordTags) {
  ...
  public UpdateProvisionedProductOutputRecordDetail launchRoleArn(String launchRoleArn) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateProvisionedProductOutputRecordDetail updateProvisionedProductOutputRecordDetail = (UpdateProvisionedProductOutputRecordDetail) o;
    return Objects.equals(this.recordId, updateProvisionedProductOutputRecordDetail.recordId) &&
        Objects.equals(this.provisionedProductName, updateProvisionedProductOutputRecordDetail.provisionedProductName) &&
        Objects.equals(this.status, updateProvisionedProductOutputRecordDetail.status) &&
        Objects.equals(this.createdTime, updateProvisionedProductOutputRecordDetail.createdTime) &&
        Objects.equals(this.updatedTime, updateProvisionedProductOutputRecordDetail.updatedTime) &&
        Objects.equals(this.provisionedProductType, updateProvisionedProductOutputRecordDetail.provisionedProductType) &&
        Objects.equals(this.recordType, updateProvisionedProductOutputRecordDetail.recordType) &&
        Objects.equals(this.provisionedProductId, updateProvisionedProductOutputRecordDetail.provisionedProductId) &&
        Objects.equals(this.productId, updateProvisionedProductOutputRecordDetail.productId) &&
        Objects.equals(this.provisioningArtifactId, updateProvisionedProductOutputRecordDetail.provisioningArtifactId) &&
        Objects.equals(this.pathId, updateProvisionedProductOutputRecordDetail.pathId) &&
        Objects.equals(this.recordErrors, updateProvisionedProductOutputRecordDetail.recordErrors) &&
        Objects.equals(this.recordTags, updateProvisionedProductOutputRecordDetail.recordTags) &&
        Objects.equals(this.launchRoleArn, updateProvisionedProductOutputRecordDetail.launchRoleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateProvisionedProductOutputRecordDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateProvisionedProductOutputRecordDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateProvisionedProductOutputRecordDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateProvisionedProductOutputRecordDetail is not found in the empty JSON string", UpdateProvisionedProductOutputRecordDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateProvisionedProductOutputRecordDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateProvisionedProductOutputRecordDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateProvisionedProductOutputRecordDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateProvisionedProductOutputRecordDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateProvisionedProductOutputRecordDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateProvisionedProductOutputRecordDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateProvisionedProductOutputRecordDetail>() {
           @Override
           public void write(JsonWriter out, UpdateProvisionedProductOutputRecordDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateProvisionedProductOutputRecordDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateProvisionedProductOutputRecordDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateProvisionedProductOutputRecordDetail
   * @throws IOException if the JSON string is invalid with respect to UpdateProvisionedProductOutputRecordDetail
   */
  public static UpdateProvisionedProductOutputRecordDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateProvisionedProductOutputRecordDetail.class);
  }

  /**
   * Convert an instance of UpdateProvisionedProductOutputRecordDetail to an JSON string
   *
   * @return JSON string
   */
