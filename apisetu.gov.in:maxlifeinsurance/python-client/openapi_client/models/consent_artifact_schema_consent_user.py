...
class ConsentArtifactSchemaConsentUser(BaseModel):
    """
    ConsentArtifactSchemaConsentUser
    """ # noqa: E501
    email: Annotated[str, Field(min_length=1, strict=True)]
    id_number: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="idNumber")
    id_type: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="idType")
    mobile: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["email", "idNumber", "idType", "mobile"]
