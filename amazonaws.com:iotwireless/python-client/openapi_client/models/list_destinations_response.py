...
class ListDestinationsResponse(BaseModel):
    ...
    destination_list: Optional[Any] = Field(default=None, alias="DestinationList")
    __properties: ClassVar[List[str]] = ["NextToken", "DestinationList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DestinationList": obj.get("DestinationList")
        })
        return _obj
