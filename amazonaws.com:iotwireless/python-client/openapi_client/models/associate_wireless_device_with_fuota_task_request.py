...
class AssociateWirelessDeviceWithFuotaTaskRequest(BaseModel):
    ...
    """ # noqa: E501
    wireless_device_id: Annotated[str, Field(strict=True, max_length=256)] = Field(description="The ID of the wireless device.", alias="WirelessDeviceId")
    __properties: ClassVar[List[str]] = ["WirelessDeviceId"]
