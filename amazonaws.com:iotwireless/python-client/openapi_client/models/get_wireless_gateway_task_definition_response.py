...
class GetWirelessGatewayTaskDefinitionResponse(BaseModel):
    ...
    """ # noqa: E501
    auto_create_tasks: Optional[Any] = Field(default=None, alias="AutoCreateTasks")
    name: Optional[Any] = Field(default=None, alias="Name")
    update: Optional[GetWirelessGatewayTaskDefinitionResponseUpdate] = Field(default=None, alias="Update")
    arn: Optional[Any] = Field(default=None, alias="Arn")
    __properties: ClassVar[List[str]] = ["AutoCreateTasks", "Name", "Update", "Arn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Name": obj.get("Name"),
            "Update": GetWirelessGatewayTaskDefinitionResponseUpdate.from_dict(obj["Update"]) if obj.get("Update") is not None else None,
            "Arn": obj.get("Arn")
        })
        return _obj
