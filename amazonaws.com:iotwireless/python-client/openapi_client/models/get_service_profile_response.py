...
class GetServiceProfileResponse(BaseModel):
    ...
    lo_ra_wan: Optional[GetServiceProfileResponseLoRaWAN] = Field(default=None, alias="LoRaWAN")
    __properties: ClassVar[List[str]] = ["Arn", "Name", "Id", "LoRaWAN"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Name": obj.get("Name"),
            "Id": obj.get("Id"),
            "LoRaWAN": GetServiceProfileResponseLoRaWAN.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None
        })
        return _obj
