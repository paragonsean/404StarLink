...
class GetPositionConfigurationResponse(BaseModel):
    ...
    """ # noqa: E501
    solvers: Optional[GetPositionConfigurationResponseSolvers] = Field(default=None, alias="Solvers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Solvers": GetPositionConfigurationResponseSolvers.from_dict(obj["Solvers"]) if obj.get("Solvers") is not None else None,
