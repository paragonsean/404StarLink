...
class GetWirelessDeviceStatisticsResponseLoRaWAN(BaseModel):
    """
    GetWirelessDeviceStatisticsResponseLoRaWAN
    """ # noqa: E501
    dev_eui: Optional[Any] = Field(default=None, alias="DevEui")
    f_port: Optional[Any] = Field(default=None, alias="FPort")
    data_rate: Optional[Any] = Field(default=None, alias="DataRate")
    frequency: Optional[Any] = Field(default=None, alias="Frequency")
    timestamp: Optional[Any] = Field(default=None, alias="Timestamp")
    gateways: Optional[Any] = Field(default=None, alias="Gateways")
    __properties: ClassVar[List[str]] = ["DevEui", "FPort", "DataRate", "Frequency", "Timestamp", "Gateways"]
