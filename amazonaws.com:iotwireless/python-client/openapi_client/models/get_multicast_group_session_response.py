...
class GetMulticastGroupSessionResponse(BaseModel):
    ...
    """ # noqa: E501
    lo_ra_wan: Optional[LoRaWANMulticastSession] = Field(default=None, alias="LoRaWAN")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LoRaWAN": LoRaWANMulticastSession.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None
        })
        return _obj
