...
class ListWirelessGatewaysResponse(BaseModel):
    ...
    wireless_gateway_list: Optional[Any] = Field(default=None, alias="WirelessGatewayList")
    __properties: ClassVar[List[str]] = ["NextToken", "WirelessGatewayList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "WirelessGatewayList": obj.get("WirelessGatewayList")
        })
        return _obj
