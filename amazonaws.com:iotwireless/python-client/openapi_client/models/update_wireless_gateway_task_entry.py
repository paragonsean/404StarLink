...
class UpdateWirelessGatewayTaskEntry(BaseModel):
    ...
    lo_ra_wan: Optional[UpdateWirelessGatewayTaskEntryLoRaWAN] = Field(default=None, alias="LoRaWAN")
    arn: Optional[Any] = Field(default=None, alias="Arn")
    __properties: ClassVar[List[str]] = ["Id", "LoRaWAN", "Arn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Id": obj.get("Id"),
            "LoRaWAN": UpdateWirelessGatewayTaskEntryLoRaWAN.from_dict(obj["LoRaWAN"]) if obj.get("LoRaWAN") is not None else None,
            "Arn": obj.get("Arn")
        })
        return _obj
