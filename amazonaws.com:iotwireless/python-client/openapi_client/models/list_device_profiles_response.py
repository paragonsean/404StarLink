...
class ListDeviceProfilesResponse(BaseModel):
    ...
    device_profile_list: Optional[Any] = Field(default=None, alias="DeviceProfileList")
    __properties: ClassVar[List[str]] = ["NextToken", "DeviceProfileList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DeviceProfileList": obj.get("DeviceProfileList")
        })
        return _obj
