...
class ListServiceProfilesResponse(BaseModel):
    ...
    service_profile_list: Optional[Any] = Field(default=None, alias="ServiceProfileList")
    __properties: ClassVar[List[str]] = ["NextToken", "ServiceProfileList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ServiceProfileList": obj.get("ServiceProfileList")
        })
        return _obj
