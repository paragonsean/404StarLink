...
class WirelessDeviceLogOption(BaseModel):
    ...
    events: Optional[List[WirelessDeviceEventLogOption]] = Field(default=None, description="The list of wireless device event log options.", alias="Events")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Events": [WirelessDeviceEventLogOption.from_dict(_item) for _item in obj["Events"]] if obj.get("Events") is not None else None
        })
        return _obj
