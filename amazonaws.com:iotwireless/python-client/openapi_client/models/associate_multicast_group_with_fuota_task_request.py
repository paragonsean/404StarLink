...
class AssociateMulticastGroupWithFuotaTaskRequest(BaseModel):
    ...
    """ # noqa: E501
    multicast_group_id: Annotated[str, Field(strict=True, max_length=256)] = Field(description="The ID of the multicast group.", alias="MulticastGroupId")
    __properties: ClassVar[List[str]] = ["MulticastGroupId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "MulticastGroupId": obj.get("MulticastGroupId")
        })
        return _obj
