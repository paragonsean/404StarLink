...
class ListEventConfigurationsResponse(BaseModel):
    ...
    event_configurations_list: Optional[Any] = Field(default=None, alias="EventConfigurationsList")
    __properties: ClassVar[List[str]] = ["NextToken", "EventConfigurationsList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "EventConfigurationsList": obj.get("EventConfigurationsList")
        })
        return _obj
