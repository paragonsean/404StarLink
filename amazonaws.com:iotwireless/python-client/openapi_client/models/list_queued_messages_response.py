...
class ListQueuedMessagesResponse(BaseModel):
    ...
    downlink_queue_messages_list: Optional[Any] = Field(default=None, alias="DownlinkQueueMessagesList")
    __properties: ClassVar[List[str]] = ["NextToken", "DownlinkQueueMessagesList"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DownlinkQueueMessagesList": obj.get("DownlinkQueueMessagesList")
        })
        return _obj
