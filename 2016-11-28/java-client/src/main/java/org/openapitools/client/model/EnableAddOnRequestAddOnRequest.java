...
public class EnableAddOnRequestAddOnRequest {
  ...
  public EnableAddOnRequestAddOnRequest() {
  }

  public EnableAddOnRequestAddOnRequest addOnType(AddOnType addOnType) {
  ...
  public EnableAddOnRequestAddOnRequest autoSnapshotAddOnRequest(AddOnRequestAutoSnapshotAddOnRequest autoSnapshotAddOnRequest) {
  ...
  public EnableAddOnRequestAddOnRequest stopInstanceOnIdleRequest(AddOnRequestStopInstanceOnIdleRequest stopInstanceOnIdleRequest) {
  ...
  public boolean equals(Object o) {
    ...
    EnableAddOnRequestAddOnRequest enableAddOnRequestAddOnRequest = (EnableAddOnRequestAddOnRequest) o;
    return Objects.equals(this.addOnType, enableAddOnRequestAddOnRequest.addOnType) &&
        Objects.equals(this.autoSnapshotAddOnRequest, enableAddOnRequestAddOnRequest.autoSnapshotAddOnRequest) &&
        Objects.equals(this.stopInstanceOnIdleRequest, enableAddOnRequestAddOnRequest.stopInstanceOnIdleRequest);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnableAddOnRequestAddOnRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EnableAddOnRequestAddOnRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EnableAddOnRequestAddOnRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnableAddOnRequestAddOnRequest is not found in the empty JSON string", EnableAddOnRequestAddOnRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EnableAddOnRequestAddOnRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EnableAddOnRequestAddOnRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EnableAddOnRequestAddOnRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnableAddOnRequestAddOnRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnableAddOnRequestAddOnRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnableAddOnRequestAddOnRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnableAddOnRequestAddOnRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EnableAddOnRequestAddOnRequest>() {
           @Override
           public void write(JsonWriter out, EnableAddOnRequestAddOnRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EnableAddOnRequestAddOnRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EnableAddOnRequestAddOnRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EnableAddOnRequestAddOnRequest
   * @throws IOException if the JSON string is invalid with respect to EnableAddOnRequestAddOnRequest
   */
  public static EnableAddOnRequestAddOnRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnableAddOnRequestAddOnRequest.class);
  }

  /**
   * Convert an instance of EnableAddOnRequestAddOnRequest to an JSON string
   *
   * @return JSON string
   */
