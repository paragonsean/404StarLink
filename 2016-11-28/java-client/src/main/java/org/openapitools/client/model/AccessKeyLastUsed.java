...
public class AccessKeyLastUsed {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lastUsedDate, region, serviceName);
  }
  ...
  static {
    ...
    openapiFields.add("lastUsedDate");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `lastUsedDate`
      if (jsonObj.get("lastUsedDate") != null && !jsonObj.get("lastUsedDate").isJsonNull()) {
        OffsetDateTime.validateJsonElement(jsonObj.get("lastUsedDate"));
      }
