...
class HIPHIRequest(BaseModel):
    ...
    HIPHIRequest
    """ # noqa: E501
    hi_request: HIPHIRequestHiRequest = Field(alias="hiRequest")
    ...
    __properties: ClassVar[List[str]] = ["hiRequest", "requestId", "timestamp", "transactionId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hiRequest": HIPHIRequestHiRequest.from_dict(obj["hiRequest"]) if obj.get("hiRequest") is not None else None,
