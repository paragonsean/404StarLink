...
class ShareProfileRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["patient", "requestId", "timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patient": ShareProfileRequestPatient.from_dict(obj["patient"]) if obj.get("patient") is not None else None,
