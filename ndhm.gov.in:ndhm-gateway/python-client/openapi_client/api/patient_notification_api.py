...
class PatientNotificationApi:
    ...
    @validate_call
    def v05_patients_sms_notify_post_0(
        self,
        ...
        _param = self._v05_patients_sms_notify_post_0_serialize(
    ...
    @validate_call
    def v05_patients_sms_notify_post_0_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="Access token which was issued after successful login with gateway auth server.")],
        x_cm_id: Annotated[StrictStr, Field(description="Suffix of the consent manager to which the request was intended.")],
        patient_sms_notifcation_request: PatientSMSNotifcationRequest,
    ...
    @validate_call
    def v05_patients_sms_notify_post_0_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="Access token which was issued after successful login with gateway auth server.")],
        x_cm_id: Annotated[StrictStr, Field(description="Suffix of the consent manager to which the request was intended.")],
        patient_sms_notifcation_request: PatientSMSNotifcationRequest,
    ...
    def _v05_patients_sms_notify_post_0_serialize(
        self,
        authorization,
        x_cm_id,
    ...
    @validate_call
    def v05_patients_sms_on_notify_post_0(
        self,
        authorization: Annotated[StrictStr, Field(description="Access token which was issued after successful login with gateway auth server.")],
        ...
        _param = self._v05_patients_sms_on_notify_post_0_serialize(
            authorization=authorization,
            x_hip_id=x_hip_id,
    ...
    @validate_call
    def v05_patients_sms_on_notify_post_0_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="Access token which was issued after successful login with gateway auth server.")],
        x_hip_id: Annotated[StrictStr, Field(description="Identifier of the health information provider to which the request was intended.")],
        patient_sms_notifcation_response: PatientSMSNotifcationResponse,
    ...
    @validate_call
    def v05_patients_sms_on_notify_post_0_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="Access token which was issued after successful login with gateway auth server.")],
        x_hip_id: Annotated[StrictStr, Field(description="Identifier of the health information provider to which the request was intended.")],
        patient_sms_notifcation_response: PatientSMSNotifcationResponse,
    ...
    def _v05_patients_sms_on_notify_post_0_serialize(
        self,
        authorization,
        x_hip_id,
