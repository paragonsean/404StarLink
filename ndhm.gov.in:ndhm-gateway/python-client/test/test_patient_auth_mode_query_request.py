    ...
    def make_instance(self, include_optional) -> PatientAuthModeQueryRequest:
        ...
        if include_optional:
            return PatientAuthModeQueryRequest(
                query = openapi_client.models.patient_auth_mode_query_request_query.PatientAuthModeQueryRequest_query(
                    id = 'hinapatel79@ndhm', 
                    purpose = 'LINK', 
                    requester = openapi_client.models.patient_auth_mode_query_request_query_requester.PatientAuthModeQueryRequest_query_requester(
                        id = '100005', 
                        type = 'HIP', ), ),
