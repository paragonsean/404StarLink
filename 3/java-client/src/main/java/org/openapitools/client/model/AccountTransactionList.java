...
import org.openapitools.client.model.TransactionWrapper;
...
public class AccountTransactionList {
  ...
  public AccountTransactionList transactions(List<TransactionWrapper> transactions) {
    this.transactions = transactions;
    return this;
  }

  public AccountTransactionList addTransactionsItem(TransactionWrapper transactionsItem) {
      ...
      if (jsonObj.get("transactions") != null && !jsonObj.get("transactions").isJsonNull()) {
        ...
        if (jsonArraytransactions != null) {
          ...
          for (int i = 0; i < jsonArraytransactions.size(); i++) {
            TransactionWrapper.validateJsonElement(jsonArraytransactions.get(i));
          };
        }
      }
  }
