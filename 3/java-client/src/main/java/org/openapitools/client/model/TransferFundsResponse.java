...
public class TransferFundsResponse {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.merchantReference, transferFundsResponse.merchantReference) &&
        ...
        Objects.equals(this.submittedAsync, transferFundsResponse.submittedAsync);
  }

  @Override
  public int hashCode() {
    return Objects.hash(merchantReference, pspReference, resultCode, submittedAsync);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransferFundsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransferFundsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TransferFundsResponse is not found in the empty JSON string", TransferFundsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransferFundsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TransferFundsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransferFundsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransferFundsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransferFundsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransferFundsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TransferFundsResponse>() {
           @Override
           public void write(JsonWriter out, TransferFundsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransferFundsResponse read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to TransferFundsResponse
   */
  public static TransferFundsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransferFundsResponse.class);
  }
