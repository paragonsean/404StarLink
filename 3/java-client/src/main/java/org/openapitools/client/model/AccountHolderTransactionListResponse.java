...
import org.openapitools.client.model.AccountTransactionListWrapper;
...
public class AccountHolderTransactionListResponse {
  ...
  private List<AccountTransactionListWrapper> accountTransactionLists = new ArrayList<>();
  ...
  public AccountHolderTransactionListResponse accountTransactionLists(List<AccountTransactionListWrapper> accountTransactionLists) {
    this.accountTransactionLists = accountTransactionLists;
    return this;
  }

  public AccountHolderTransactionListResponse addAccountTransactionListsItem(AccountTransactionListWrapper accountTransactionListsItem) {
  ...
  public List<AccountTransactionListWrapper> getAccountTransactionLists() {
    return accountTransactionLists;
  }

  public void setAccountTransactionLists(List<AccountTransactionListWrapper> accountTransactionLists) {
    this.accountTransactionLists = accountTransactionLists;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountTransactionLists, accountHolderTransactionListResponse.accountTransactionLists) &&
        ...
        Objects.equals(this.submittedAsync, accountHolderTransactionListResponse.submittedAsync);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountTransactionLists, pspReference, resultCode, submittedAsync);
  }
      ...
      if (jsonObj.get("accountTransactionLists") != null && !jsonObj.get("accountTransactionLists").isJsonNull()) {
        ...
        if (jsonArrayaccountTransactionLists != null) {
          ...
          for (int i = 0; i < jsonArrayaccountTransactionLists.size(); i++) {
            AccountTransactionListWrapper.validateJsonElement(jsonArrayaccountTransactionLists.get(i));
          };
        }
      }
