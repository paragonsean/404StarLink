...
class TestCALocalAccountIdentification(unittest.TestCase):
    """CALocalAccountIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CALocalAccountIdentification:
        """Test CALocalAccountIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CALocalAccountIdentification`
        """
        model = CALocalAccountIdentification()
        if include_optional:
    ...
    def testCALocalAccountIdentification(self):
        """Test CALocalAccountIdentification"""
