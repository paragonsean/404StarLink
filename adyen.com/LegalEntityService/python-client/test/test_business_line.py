...
class TestBusinessLine(unittest.TestCase):
    """BusinessLine unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessLine:
        """Test BusinessLine
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessLine`
        """
        model = BusinessLine()
        if include_optional:
            return BusinessLine(
