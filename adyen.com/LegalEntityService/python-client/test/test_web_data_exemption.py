...
class TestWebDataExemption(unittest.TestCase):
    """WebDataExemption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebDataExemption:
        """Test WebDataExemption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebDataExemption`
        """
        model = WebDataExemption()
        if include_optional:
