...
class TestSupportingEntityCapability(unittest.TestCase):
    """SupportingEntityCapability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportingEntityCapability:
        """Test SupportingEntityCapability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupportingEntityCapability`
        """
        model = SupportingEntityCapability()
        if include_optional:
    ...
    def testSupportingEntityCapability(self):
        """Test SupportingEntityCapability"""
