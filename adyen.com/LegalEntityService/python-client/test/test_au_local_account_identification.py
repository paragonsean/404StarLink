...
class TestAULocalAccountIdentification(unittest.TestCase):
    """AULocalAccountIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AULocalAccountIdentification:
        """Test AULocalAccountIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AULocalAccountIdentification`
        """
        model = AULocalAccountIdentification()
        if include_optional:
    ...
    def testAULocalAccountIdentification(self):
        """Test AULocalAccountIdentification"""
