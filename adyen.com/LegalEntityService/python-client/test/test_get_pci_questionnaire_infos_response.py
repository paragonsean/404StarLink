...
class TestGetPciQuestionnaireInfosResponse(unittest.TestCase):
    """GetPciQuestionnaireInfosResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPciQuestionnaireInfosResponse:
        """Test GetPciQuestionnaireInfosResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPciQuestionnaireInfosResponse`
        """
        model = GetPciQuestionnaireInfosResponse()
        if include_optional:
            return GetPciQuestionnaireInfosResponse(
                data = [
                    openapi_client.models.pci_document_info.PciDocumentInfo(
    ...
    def testGetPciQuestionnaireInfosResponse(self):
        """Test GetPciQuestionnaireInfosResponse"""
