...
class TestCapabilityProblemEntity(unittest.TestCase):
    """CapabilityProblemEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CapabilityProblemEntity:
        """Test CapabilityProblemEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CapabilityProblemEntity`
        """
        model = CapabilityProblemEntity()
        if include_optional:
    ...
    def testCapabilityProblemEntity(self):
        """Test CapabilityProblemEntity"""
