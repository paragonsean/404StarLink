...
class TestNumberAndBicAccountIdentification(unittest.TestCase):
    """NumberAndBicAccountIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumberAndBicAccountIdentification:
        """Test NumberAndBicAccountIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumberAndBicAccountIdentification`
        """
        model = NumberAndBicAccountIdentification()
        if include_optional:
    ...
    def testNumberAndBicAccountIdentification(self):
        """Test NumberAndBicAccountIdentification"""
