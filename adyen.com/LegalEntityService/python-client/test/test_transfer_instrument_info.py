...
class TestTransferInstrumentInfo(unittest.TestCase):
    """TransferInstrumentInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferInstrumentInfo:
        """Test TransferInstrumentInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferInstrumentInfo`
        """
        model = TransferInstrumentInfo()
        if include_optional:
    ...
    def testTransferInstrumentInfo(self):
        """Test TransferInstrumentInfo"""
