...
class TestBusinessLineInfo(unittest.TestCase):
    """BusinessLineInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessLineInfo:
        """Test BusinessLineInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessLineInfo`
        """
        model = BusinessLineInfo()
        if include_optional:
