...
class TestOnboardingThemes(unittest.TestCase):
    """OnboardingThemes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnboardingThemes:
        """Test OnboardingThemes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnboardingThemes`
        """
        model = OnboardingThemes()
        if include_optional:
            return OnboardingThemes(
                next = '',
                previous = '',
                themes = [
                    openapi_client.models.onboarding_theme.OnboardingTheme(
