...
class TestCapabilityProblemEntityRecursive(unittest.TestCase):
    """CapabilityProblemEntityRecursive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CapabilityProblemEntityRecursive:
        """Test CapabilityProblemEntityRecursive
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CapabilityProblemEntityRecursive`
        """
        model = CapabilityProblemEntityRecursive()
        if include_optional:
    ...
    def testCapabilityProblemEntityRecursive(self):
        """Test CapabilityProblemEntityRecursive"""
