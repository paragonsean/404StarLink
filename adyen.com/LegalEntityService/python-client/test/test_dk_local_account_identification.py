...
class TestDKLocalAccountIdentification(unittest.TestCase):
    """DKLocalAccountIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DKLocalAccountIdentification:
        """Test DKLocalAccountIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DKLocalAccountIdentification`
        """
        model = DKLocalAccountIdentification()
        if include_optional:
    ...
    def testDKLocalAccountIdentification(self):
        """Test DKLocalAccountIdentification"""
