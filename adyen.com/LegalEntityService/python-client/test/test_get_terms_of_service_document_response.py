...
class TestGetTermsOfServiceDocumentResponse(unittest.TestCase):
    """GetTermsOfServiceDocumentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTermsOfServiceDocumentResponse:
        """Test GetTermsOfServiceDocumentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTermsOfServiceDocumentResponse`
        """
        model = GetTermsOfServiceDocumentResponse()
        if include_optional:
    ...
    def testGetTermsOfServiceDocumentResponse(self):
        """Test GetTermsOfServiceDocumentResponse"""
