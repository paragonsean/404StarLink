...
class TestUSLocalAccountIdentification(unittest.TestCase):
    """USLocalAccountIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> USLocalAccountIdentification:
        """Test USLocalAccountIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `USLocalAccountIdentification`
        """
        model = USLocalAccountIdentification()
        if include_optional:
    ...
    def testUSLocalAccountIdentification(self):
        """Test USLocalAccountIdentification"""
