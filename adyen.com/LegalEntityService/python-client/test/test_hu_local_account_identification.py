...
class TestHULocalAccountIdentification(unittest.TestCase):
    """HULocalAccountIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HULocalAccountIdentification:
        """Test HULocalAccountIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HULocalAccountIdentification`
        """
        model = HULocalAccountIdentification()
        if include_optional:
            return HULocalAccountIdentification(
                account_number = '01234567891011121314151617181920212223',
                type = 'huLocal'
            )
        else:
            return HULocalAccountIdentification(
    ...
    def testHULocalAccountIdentification(self):
        """Test HULocalAccountIdentification"""
