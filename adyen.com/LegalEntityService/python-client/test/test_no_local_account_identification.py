...
class TestNOLocalAccountIdentification(unittest.TestCase):
    """NOLocalAccountIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NOLocalAccountIdentification:
        """Test NOLocalAccountIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NOLocalAccountIdentification`
        """
        model = NOLocalAccountIdentification()
        if include_optional:
    ...
    def testNOLocalAccountIdentification(self):
        """Test NOLocalAccountIdentification"""
