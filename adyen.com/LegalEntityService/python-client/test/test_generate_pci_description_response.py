...
class TestGeneratePciDescriptionResponse(unittest.TestCase):
    """GeneratePciDescriptionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeneratePciDescriptionResponse:
        """Test GeneratePciDescriptionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeneratePciDescriptionResponse`
        """
        model = GeneratePciDescriptionResponse()
        if include_optional:
    ...
    def testGeneratePciDescriptionResponse(self):
        """Test GeneratePciDescriptionResponse"""
