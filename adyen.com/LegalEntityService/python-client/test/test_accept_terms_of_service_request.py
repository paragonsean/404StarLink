...
class TestAcceptTermsOfServiceRequest(unittest.TestCase):
    """AcceptTermsOfServiceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AcceptTermsOfServiceRequest:
        """Test AcceptTermsOfServiceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AcceptTermsOfServiceRequest`
        """
        model = AcceptTermsOfServiceRequest()
        if include_optional:
    ...
    def testAcceptTermsOfServiceRequest(self):
        """Test AcceptTermsOfServiceRequest"""
