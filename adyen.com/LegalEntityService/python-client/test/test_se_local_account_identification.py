...
class TestSELocalAccountIdentification(unittest.TestCase):
    """SELocalAccountIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SELocalAccountIdentification:
        """Test SELocalAccountIdentification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SELocalAccountIdentification`
        """
        model = SELocalAccountIdentification()
        if include_optional:
    ...
    def testSELocalAccountIdentification(self):
        """Test SELocalAccountIdentification"""
