...
class TestTaxInformation(unittest.TestCase):
    """TaxInformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxInformation:
        """Test TaxInformation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaxInformation`
        """
