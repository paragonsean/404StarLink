...
class TestCapabilityProblem(unittest.TestCase):
    """CapabilityProblem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CapabilityProblem:
        """Test CapabilityProblem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CapabilityProblem`
        """
        model = CapabilityProblem()
        if include_optional:
    ...
    def testCapabilityProblem(self):
        """Test CapabilityProblem"""
