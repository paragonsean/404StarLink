...
class TestGetTermsOfServiceDocumentRequest(unittest.TestCase):
    """GetTermsOfServiceDocumentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTermsOfServiceDocumentRequest:
        """Test GetTermsOfServiceDocumentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTermsOfServiceDocumentRequest`
        """
        model = GetTermsOfServiceDocumentRequest()
        if include_optional:
    ...
    def testGetTermsOfServiceDocumentRequest(self):
        """Test GetTermsOfServiceDocumentRequest"""
