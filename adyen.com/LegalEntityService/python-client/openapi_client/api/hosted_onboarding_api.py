...
class HostedOnboardingApi:
    ...
    def get_themes_id(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the theme")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_themes_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_themes_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the theme")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_themes_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the theme")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def post_legal_entities_id_onboarding_links(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the legal entity")],
        onboarding_link_info: Optional[OnboardingLinkInfo] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: str
        :param onboarding_link_info:
        :type onboarding_link_info: OnboardingLinkInfo
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_legal_entities_id_onboarding_links_serialize(
            id=id,
            onboarding_link_info=onboarding_link_info,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_legal_entities_id_onboarding_links_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the legal entity")],
        onboarding_link_info: Optional[OnboardingLinkInfo] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def post_legal_entities_id_onboarding_links_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the legal entity")],
        onboarding_link_info: Optional[OnboardingLinkInfo] = None,
        _request_timeout: Union[
    ...
    def _post_legal_entities_id_onboarding_links_serialize(
        self,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if onboarding_link_info is not None:
            _body_params = onboarding_link_info
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/legalEntities/{id}/onboardingLinks',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
