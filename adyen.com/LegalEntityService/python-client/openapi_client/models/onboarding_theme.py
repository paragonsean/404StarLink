...
class OnboardingTheme(BaseModel):
    ...
    OnboardingTheme
    """ # noqa: E501
    created_at: datetime = Field(description="The creation date of the theme.", alias="createdAt")
    description: Optional[StrictStr] = Field(default=None, description="The description of the theme.")
    id: StrictStr = Field(description="The unique identifier of the theme.")
    properties: Dict[str, StrictStr] = Field(description="The properties of the theme.")
    updated_at: Optional[datetime] = Field(default=None, description="The date when the theme was last updated.", alias="updatedAt")
    __properties: ClassVar[List[str]] = ["createdAt", "description", "id", "properties", "updatedAt"]
