...
class USLocalAccountIdentification(BaseModel):
    ...
    """ # noqa: E501
    account_number: Annotated[str, Field(min_length=2, strict=True, max_length=18)] = Field(description="The bank account number, without separators or whitespace.", alias="accountNumber")
    ...
    routing_number: Annotated[str, Field(min_length=9, strict=True, max_length=9)] = Field(description="The 9-digit [routing number](https://en.wikipedia.org/wiki/ABA_routing_transit_number), without separators or whitespace.", alias="routingNumber")
    type: StrictStr = Field(description="**usLocal**")
    __properties: ClassVar[List[str]] = ["accountNumber", "accountType", "routingNumber", "type"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['usLocal']):
            raise ValueError("must be one of enum values ('usLocal')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'usLocal'
        })
        return _obj
