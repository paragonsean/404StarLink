...
class PLLocalAccountIdentification(BaseModel):
    ...
    """ # noqa: E501
    account_number: Annotated[str, Field(min_length=26, strict=True, max_length=26)] = Field(description="The 26-digit bank account number ([Numer rachunku](https://pl.wikipedia.org/wiki/Numer_Rachunku_Bankowego)), without separators or whitespace.", alias="accountNumber")
    type: StrictStr = Field(description="**plLocal**")
    __properties: ClassVar[List[str]] = ["accountNumber", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['plLocal']):
            raise ValueError("must be one of enum values ('plLocal')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'plLocal'
        })
        return _obj
