...
class GetPciQuestionnaireInfosResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[PciDocumentInfo]] = Field(default=None, description="Information about the signed PCI questionnaires.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PciDocumentInfo.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
