...
class IbanAccountIdentification(BaseModel):
    ...
    """ # noqa: E501
    iban: StrictStr = Field(description="The international bank account number as defined in the [ISO-13616](https://www.iso.org/standard/81090.html) standard.")
    type: StrictStr = Field(description="**iban**")
    __properties: ClassVar[List[str]] = ["iban", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "iban": obj.get("iban"),
            "type": obj.get("type") if obj.get("type") is not None else 'iban'
        })
        return _obj
