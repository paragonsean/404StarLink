...
class DocumentReference(BaseModel):
    ...
    DocumentReference
    """ # noqa: E501
    active: Optional[StrictBool] = Field(default=None, description="Identifies whether the document is active and used for checks.")
    description: Optional[StrictStr] = Field(default=None, description="Your description for the document.")
    file_name: Optional[StrictStr] = Field(default=None, description="Document name.", alias="fileName")
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the resource.")
    ...
    type: Optional[StrictStr] = Field(default=None, description="Type of document, used when providing an ID number or uploading a document.")
    __properties: ClassVar[List[str]] = ["active", "description", "fileName", "id", "modificationDate", "type"]
