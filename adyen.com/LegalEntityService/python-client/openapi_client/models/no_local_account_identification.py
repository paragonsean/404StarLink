...
class NOLocalAccountIdentification(BaseModel):
    ...
    """ # noqa: E501
    account_number: Annotated[str, Field(min_length=11, strict=True, max_length=11)] = Field(description="The 11-digit bank account number, without separators or whitespace.", alias="accountNumber")
    type: StrictStr = Field(description="**noLocal**")
    __properties: ClassVar[List[str]] = ["accountNumber", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['noLocal']):
            raise ValueError("must be one of enum values ('noLocal')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type") if obj.get("type") is not None else 'noLocal'
        })
        return _obj
