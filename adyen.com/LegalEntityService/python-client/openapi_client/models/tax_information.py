...
class TaxInformation(BaseModel):
    ...
    TaxInformation
    """ # noqa: E501
    country: Optional[Annotated[str, Field(min_length=2, strict=True, max_length=2)]] = Field(default=None, description="The two-letter [ISO 3166-1 alpha-2](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) country code.")
    number: Optional[StrictStr] = Field(default=None, description="The tax ID number (TIN) of the organization or individual.")
    type: Optional[StrictStr] = Field(default=None, description="The TIN type depending on the country where it was issued. Provide only for countries that have multiple tax IDs, such as Sweden, the UK, or the US. For example, provide **SSN**, **EIN**, or **ITIN** for the US.")
    __properties: ClassVar[List[str]] = ["country", "number", "type"]
