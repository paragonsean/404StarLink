...
class LegalEntity(BaseModel):
    ...
    document_details: Optional[List[DocumentReference]] = Field(default=None, description="List of documents uploaded for the legal entity.", alias="documentDetails")
    documents: Optional[List[EntityReference]] = Field(default=None, description="List of documents uploaded for the legal entity.")
    ...
    id: StrictStr = Field(description="The unique identifier of the legal entity.")
    ...
    problems: Optional[List[CapabilityProblem]] = Field(default=None, description="List of the verification errors from capabilities for the legal entity.")
    ...
    transfer_instruments: Optional[List[TransferInstrumentReference]] = Field(default=None, description="List of transfer instruments that the legal entity owns.", alias="transferInstruments")
    ...
    __properties: ClassVar[List[str]] = ["capabilities", "documentDetails", "documents", "entityAssociations", "id", "individual", "organization", "problems", "reference", "soleProprietorship", "transferInstruments", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "documents": [EntityReference.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None,
            ...
            "transferInstruments": [TransferInstrumentReference.from_dict(_item) for _item in obj["transferInstruments"]] if obj.get("transferInstruments") is not None else None,
            "type": obj.get("type")
        })
        return _obj
