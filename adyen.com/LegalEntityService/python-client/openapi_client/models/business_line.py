...
class BusinessLine(BaseModel):
    ...
    id: StrictStr = Field(description="The unique identifier of the business line.")
    ...
    __properties: ClassVar[List[str]] = ["capability", "id", "industryCode", "legalEntityId", "problems", "salesChannels", "service", "sourceOfFunds", "webData", "webDataExemption"]
