...
class CapabilityProblemEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["documents", "id", "owner", "type"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['BankAccount', 'Document', 'LegalEntity']):
            raise ValueError("must be one of enum values ('BankAccount', 'Document', 'LegalEntity')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "owner": CapabilityProblemEntityRecursive.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            "type": obj.get("type")
        })
        return _obj
