...
class WebData(BaseModel):
    ...
    WebData
    """ # noqa: E501
    web_address: Optional[StrictStr] = Field(default=None, description="The URL of the website or the app store URL.", alias="webAddress")
    web_address_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the web address.", alias="webAddressId")
    __properties: ClassVar[List[str]] = ["webAddress", "webAddressId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "webAddressId": obj.get("webAddressId")
        })
        return _obj
