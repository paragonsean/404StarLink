...
class BusinessLines(BaseModel):
    ...
    BusinessLines
    """ # noqa: E501
    business_lines: List[BusinessLine] = Field(description="List of business lines.", alias="businessLines")
    __properties: ClassVar[List[str]] = ["businessLines"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in business_lines (list)
        _items = []
        if self.business_lines:
            for _item_business_lines in self.business_lines:
                if _item_business_lines:
                    _items.append(_item_business_lines.to_dict())
            _dict['businessLines'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "businessLines": [BusinessLine.from_dict(_item) for _item in obj["businessLines"]] if obj.get("businessLines") is not None else None
        })
        return _obj
