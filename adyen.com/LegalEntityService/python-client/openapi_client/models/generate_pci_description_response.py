...
class GeneratePciDescriptionResponse(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="The generated questionnaires in a base64 encoded format.")
    language: Optional[StrictStr] = Field(default=None, description="The two-letter [ISO-639-1](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) language code for the questionnaire. For example, **en**.")
    pci_template_references: Optional[List[StrictStr]] = Field(default=None, description="The array of Adyen-generated unique identifiers for the questionnaires.", alias="pciTemplateReferences")
    __properties: ClassVar[List[str]] = ["content", "language", "pciTemplateReferences"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pciTemplateReferences": obj.get("pciTemplateReferences")
        })
        return _obj
