...
import org.openapitools.client.model.BankAccountIdentificationValidationRequestAccountIdentification;
...
public class BankAccountIdentificationValidationRequest {
   ...
   * @throws IOException if the JSON Element is invalid with respect to BankAccountIdentificationValidationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BankAccountIdentificationValidationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BankAccountIdentificationValidationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BankAccountIdentificationValidationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      BankAccountIdentificationValidationRequestAccountIdentification.validateJsonElement(jsonObj.get("accountIdentification"));
  }
