...
public class Organization {
  ...
  private Address3 principalPlaceOfBusiness;
  ...
  private Address3 registeredAddress;
  ...
  public Organization phone(PhoneNumber2 phone) {
    this.phone = phone;
    return this;
  }
  ...
  public Organization principalPlaceOfBusiness(Address3 principalPlaceOfBusiness) {
   ...
   */
  @javax.annotation.Nullable
  public Address3 getPrincipalPlaceOfBusiness() {
    return principalPlaceOfBusiness;
  }

  public void setPrincipalPlaceOfBusiness(Address3 principalPlaceOfBusiness) {
    this.principalPlaceOfBusiness = principalPlaceOfBusiness;
  }


  public Organization registeredAddress(Address3 registeredAddress) {
   ...
   */
  @javax.annotation.Nonnull
  public Address3 getRegisteredAddress() {
    return registeredAddress;
  }

  public void setRegisteredAddress(Address3 registeredAddress) {
    this.registeredAddress = registeredAddress;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("principalPlaceOfBusiness") != null && !jsonObj.get("principalPlaceOfBusiness").isJsonNull()) {
        Address3.validateJsonElement(jsonObj.get("principalPlaceOfBusiness"));
      }
      // validate the required field `registeredAddress`
      Address3.validateJsonElement(jsonObj.get("registeredAddress"));
