...
public class ResourceDetailsAwsApiGatewayStage {
  ...
  public ResourceDetailsAwsApiGatewayStage() {
  }

  public ResourceDetailsAwsApiGatewayStage deploymentId(String deploymentId) {
  ...
  public ResourceDetailsAwsApiGatewayStage clientCertificateId(String clientCertificateId) {
  ...
  public ResourceDetailsAwsApiGatewayStage stageName(String stageName) {
  ...
  public ResourceDetailsAwsApiGatewayStage description(String description) {
  ...
  public ResourceDetailsAwsApiGatewayStage cacheClusterEnabled(Boolean cacheClusterEnabled) {
  ...
  public ResourceDetailsAwsApiGatewayStage cacheClusterSize(String cacheClusterSize) {
  ...
  public ResourceDetailsAwsApiGatewayStage cacheClusterStatus(String cacheClusterStatus) {
  ...
  public ResourceDetailsAwsApiGatewayStage methodSettings(List methodSettings) {
  ...
  public ResourceDetailsAwsApiGatewayStage variables(Map variables) {
  ...
  public ResourceDetailsAwsApiGatewayStage documentationVersion(String documentationVersion) {
  ...
  public ResourceDetailsAwsApiGatewayStage accessLogSettings(AwsApiGatewayStageDetailsAccessLogSettings accessLogSettings) {
  ...
  public ResourceDetailsAwsApiGatewayStage canarySettings(AwsApiGatewayStageDetailsCanarySettings canarySettings) {
  ...
  public ResourceDetailsAwsApiGatewayStage tracingEnabled(Boolean tracingEnabled) {
  ...
  public ResourceDetailsAwsApiGatewayStage createdDate(String createdDate) {
  ...
  public ResourceDetailsAwsApiGatewayStage lastUpdatedDate(String lastUpdatedDate) {
  ...
  public ResourceDetailsAwsApiGatewayStage webAclArn(String webAclArn) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceDetailsAwsApiGatewayStage resourceDetailsAwsApiGatewayStage = (ResourceDetailsAwsApiGatewayStage) o;
    return Objects.equals(this.deploymentId, resourceDetailsAwsApiGatewayStage.deploymentId) &&
        Objects.equals(this.clientCertificateId, resourceDetailsAwsApiGatewayStage.clientCertificateId) &&
        Objects.equals(this.stageName, resourceDetailsAwsApiGatewayStage.stageName) &&
        Objects.equals(this.description, resourceDetailsAwsApiGatewayStage.description) &&
        Objects.equals(this.cacheClusterEnabled, resourceDetailsAwsApiGatewayStage.cacheClusterEnabled) &&
        Objects.equals(this.cacheClusterSize, resourceDetailsAwsApiGatewayStage.cacheClusterSize) &&
        Objects.equals(this.cacheClusterStatus, resourceDetailsAwsApiGatewayStage.cacheClusterStatus) &&
        Objects.equals(this.methodSettings, resourceDetailsAwsApiGatewayStage.methodSettings) &&
        Objects.equals(this.variables, resourceDetailsAwsApiGatewayStage.variables) &&
        Objects.equals(this.documentationVersion, resourceDetailsAwsApiGatewayStage.documentationVersion) &&
        Objects.equals(this.accessLogSettings, resourceDetailsAwsApiGatewayStage.accessLogSettings) &&
        Objects.equals(this.canarySettings, resourceDetailsAwsApiGatewayStage.canarySettings) &&
        Objects.equals(this.tracingEnabled, resourceDetailsAwsApiGatewayStage.tracingEnabled) &&
        Objects.equals(this.createdDate, resourceDetailsAwsApiGatewayStage.createdDate) &&
        Objects.equals(this.lastUpdatedDate, resourceDetailsAwsApiGatewayStage.lastUpdatedDate) &&
        Objects.equals(this.webAclArn, resourceDetailsAwsApiGatewayStage.webAclArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceDetailsAwsApiGatewayStage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceDetailsAwsApiGatewayStage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceDetailsAwsApiGatewayStage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceDetailsAwsApiGatewayStage is not found in the empty JSON string", ResourceDetailsAwsApiGatewayStage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceDetailsAwsApiGatewayStage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceDetailsAwsApiGatewayStage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceDetailsAwsApiGatewayStage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceDetailsAwsApiGatewayStage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceDetailsAwsApiGatewayStage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceDetailsAwsApiGatewayStage.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceDetailsAwsApiGatewayStage>() {
           @Override
           public void write(JsonWriter out, ResourceDetailsAwsApiGatewayStage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceDetailsAwsApiGatewayStage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceDetailsAwsApiGatewayStage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceDetailsAwsApiGatewayStage
   * @throws IOException if the JSON string is invalid with respect to ResourceDetailsAwsApiGatewayStage
   */
  public static ResourceDetailsAwsApiGatewayStage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceDetailsAwsApiGatewayStage.class);
  }

  /**
   * Convert an instance of ResourceDetailsAwsApiGatewayStage to an JSON string
   *
   * @return JSON string
   */
