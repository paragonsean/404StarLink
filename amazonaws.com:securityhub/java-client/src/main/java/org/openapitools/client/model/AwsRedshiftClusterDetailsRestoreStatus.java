...
public class AwsRedshiftClusterDetailsRestoreStatus {
  ...
  public AwsRedshiftClusterDetailsRestoreStatus() {
  }

  public AwsRedshiftClusterDetailsRestoreStatus currentRestoreRateInMegaBytesPerSecond(Double currentRestoreRateInMegaBytesPerSecond) {
  ...
  public AwsRedshiftClusterDetailsRestoreStatus elapsedTimeInSeconds(Integer elapsedTimeInSeconds) {
  ...
  public AwsRedshiftClusterDetailsRestoreStatus estimatedTimeToCompletionInSeconds(Integer estimatedTimeToCompletionInSeconds) {
  ...
  public AwsRedshiftClusterDetailsRestoreStatus progressInMegaBytes(Integer progressInMegaBytes) {
  ...
  public AwsRedshiftClusterDetailsRestoreStatus snapshotSizeInMegaBytes(Integer snapshotSizeInMegaBytes) {
  ...
  public AwsRedshiftClusterDetailsRestoreStatus status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AwsRedshiftClusterDetailsRestoreStatus awsRedshiftClusterDetailsRestoreStatus = (AwsRedshiftClusterDetailsRestoreStatus) o;
    return Objects.equals(this.currentRestoreRateInMegaBytesPerSecond, awsRedshiftClusterDetailsRestoreStatus.currentRestoreRateInMegaBytesPerSecond) &&
        Objects.equals(this.elapsedTimeInSeconds, awsRedshiftClusterDetailsRestoreStatus.elapsedTimeInSeconds) &&
        Objects.equals(this.estimatedTimeToCompletionInSeconds, awsRedshiftClusterDetailsRestoreStatus.estimatedTimeToCompletionInSeconds) &&
        Objects.equals(this.progressInMegaBytes, awsRedshiftClusterDetailsRestoreStatus.progressInMegaBytes) &&
        Objects.equals(this.snapshotSizeInMegaBytes, awsRedshiftClusterDetailsRestoreStatus.snapshotSizeInMegaBytes) &&
        Objects.equals(this.status, awsRedshiftClusterDetailsRestoreStatus.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentRestoreRateInMegaBytesPerSecond, elapsedTimeInSeconds, estimatedTimeToCompletionInSeconds, progressInMegaBytes, snapshotSizeInMegaBytes, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AwsRedshiftClusterDetailsRestoreStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsRedshiftClusterDetailsRestoreStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsRedshiftClusterDetailsRestoreStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsRedshiftClusterDetailsRestoreStatus is not found in the empty JSON string", AwsRedshiftClusterDetailsRestoreStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsRedshiftClusterDetailsRestoreStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsRedshiftClusterDetailsRestoreStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsRedshiftClusterDetailsRestoreStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsRedshiftClusterDetailsRestoreStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsRedshiftClusterDetailsRestoreStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsRedshiftClusterDetailsRestoreStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsRedshiftClusterDetailsRestoreStatus>() {
           @Override
           public void write(JsonWriter out, AwsRedshiftClusterDetailsRestoreStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsRedshiftClusterDetailsRestoreStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsRedshiftClusterDetailsRestoreStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsRedshiftClusterDetailsRestoreStatus
   * @throws IOException if the JSON string is invalid with respect to AwsRedshiftClusterDetailsRestoreStatus
   */
  public static AwsRedshiftClusterDetailsRestoreStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsRedshiftClusterDetailsRestoreStatus.class);
  }

  /**
   * Convert an instance of AwsRedshiftClusterDetailsRestoreStatus to an JSON string
   *
   * @return JSON string
   */
