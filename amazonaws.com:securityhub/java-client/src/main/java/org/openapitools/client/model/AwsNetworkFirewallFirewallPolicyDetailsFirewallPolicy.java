...
public class AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy {
  ...
  public AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy() {
  }

  public AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy statefulRuleGroupReferences(List statefulRuleGroupReferences) {
  ...
  public AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy statelessCustomActions(List statelessCustomActions) {
  ...
  public AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy statelessDefaultActions(List statelessDefaultActions) {
  ...
  public AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy statelessFragmentDefaultActions(List statelessFragmentDefaultActions) {
  ...
  public AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy statelessRuleGroupReferences(List statelessRuleGroupReferences) {
  ...
  public boolean equals(Object o) {
    ...
    AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy awsNetworkFirewallFirewallPolicyDetailsFirewallPolicy = (AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy) o;
    return Objects.equals(this.statefulRuleGroupReferences, awsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.statefulRuleGroupReferences) &&
        Objects.equals(this.statelessCustomActions, awsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.statelessCustomActions) &&
        Objects.equals(this.statelessDefaultActions, awsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.statelessDefaultActions) &&
        Objects.equals(this.statelessFragmentDefaultActions, awsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.statelessFragmentDefaultActions) &&
        Objects.equals(this.statelessRuleGroupReferences, awsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.statelessRuleGroupReferences);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy is not found in the empty JSON string", AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy>() {
           @Override
           public void write(JsonWriter out, AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy
   * @throws IOException if the JSON string is invalid with respect to AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy
   */
  public static AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy.class);
  }

  /**
   * Convert an instance of AwsNetworkFirewallFirewallPolicyDetailsFirewallPolicy to an JSON string
   *
   * @return JSON string
   */
