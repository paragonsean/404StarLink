...
public class AwsSecurityFindingNetwork {
  ...
  public AwsSecurityFindingNetwork() {
  }

  public AwsSecurityFindingNetwork direction(NetworkDirection direction) {
  ...
  public AwsSecurityFindingNetwork protocol(String protocol) {
  ...
  public AwsSecurityFindingNetwork openPortRange(NetworkOpenPortRange openPortRange) {
  ...
  public AwsSecurityFindingNetwork sourceIpV4(String sourceIpV4) {
  ...
  public AwsSecurityFindingNetwork sourceIpV6(String sourceIpV6) {
  ...
  public AwsSecurityFindingNetwork sourcePort(Integer sourcePort) {
  ...
  public AwsSecurityFindingNetwork sourceDomain(String sourceDomain) {
  ...
  public AwsSecurityFindingNetwork sourceMac(String sourceMac) {
  ...
  public AwsSecurityFindingNetwork destinationIpV4(String destinationIpV4) {
  ...
  public AwsSecurityFindingNetwork destinationIpV6(String destinationIpV6) {
  ...
  public AwsSecurityFindingNetwork destinationPort(Integer destinationPort) {
  ...
  public AwsSecurityFindingNetwork destinationDomain(String destinationDomain) {
  ...
  public boolean equals(Object o) {
    ...
    AwsSecurityFindingNetwork awsSecurityFindingNetwork = (AwsSecurityFindingNetwork) o;
    return Objects.equals(this.direction, awsSecurityFindingNetwork.direction) &&
        Objects.equals(this.protocol, awsSecurityFindingNetwork.protocol) &&
        Objects.equals(this.openPortRange, awsSecurityFindingNetwork.openPortRange) &&
        Objects.equals(this.sourceIpV4, awsSecurityFindingNetwork.sourceIpV4) &&
        Objects.equals(this.sourceIpV6, awsSecurityFindingNetwork.sourceIpV6) &&
        Objects.equals(this.sourcePort, awsSecurityFindingNetwork.sourcePort) &&
        Objects.equals(this.sourceDomain, awsSecurityFindingNetwork.sourceDomain) &&
        Objects.equals(this.sourceMac, awsSecurityFindingNetwork.sourceMac) &&
        Objects.equals(this.destinationIpV4, awsSecurityFindingNetwork.destinationIpV4) &&
        Objects.equals(this.destinationIpV6, awsSecurityFindingNetwork.destinationIpV6) &&
        Objects.equals(this.destinationPort, awsSecurityFindingNetwork.destinationPort) &&
        Objects.equals(this.destinationDomain, awsSecurityFindingNetwork.destinationDomain);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsSecurityFindingNetwork {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsSecurityFindingNetwork
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsSecurityFindingNetwork.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsSecurityFindingNetwork is not found in the empty JSON string", AwsSecurityFindingNetwork.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsSecurityFindingNetwork.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsSecurityFindingNetwork` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsSecurityFindingNetwork.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsSecurityFindingNetwork' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsSecurityFindingNetwork> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsSecurityFindingNetwork.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsSecurityFindingNetwork>() {
           @Override
           public void write(JsonWriter out, AwsSecurityFindingNetwork value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsSecurityFindingNetwork read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsSecurityFindingNetwork given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsSecurityFindingNetwork
   * @throws IOException if the JSON string is invalid with respect to AwsSecurityFindingNetwork
   */
  public static AwsSecurityFindingNetwork fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsSecurityFindingNetwork.class);
  }

  /**
   * Convert an instance of AwsSecurityFindingNetwork to an JSON string
   *
   * @return JSON string
   */
