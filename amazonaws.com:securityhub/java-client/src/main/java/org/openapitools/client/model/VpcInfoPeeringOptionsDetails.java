...
public class VpcInfoPeeringOptionsDetails {
  ...
  public VpcInfoPeeringOptionsDetails allowDnsResolutionFromRemoteVpc(Boolean allowDnsResolutionFromRemoteVpc) {
  ...
  public VpcInfoPeeringOptionsDetails allowEgressFromLocalClassicLinkToRemoteVpc(Boolean allowEgressFromLocalClassicLinkToRemoteVpc) {
  ...
  public VpcInfoPeeringOptionsDetails allowEgressFromLocalVpcToRemoteClassicLink(Boolean allowEgressFromLocalVpcToRemoteClassicLink) {
  ...
  public boolean equals(Object o) {
    ...
    VpcInfoPeeringOptionsDetails vpcInfoPeeringOptionsDetails = (VpcInfoPeeringOptionsDetails) o;
    return Objects.equals(this.allowDnsResolutionFromRemoteVpc, vpcInfoPeeringOptionsDetails.allowDnsResolutionFromRemoteVpc) &&
        Objects.equals(this.allowEgressFromLocalClassicLinkToRemoteVpc, vpcInfoPeeringOptionsDetails.allowEgressFromLocalClassicLinkToRemoteVpc) &&
        Objects.equals(this.allowEgressFromLocalVpcToRemoteClassicLink, vpcInfoPeeringOptionsDetails.allowEgressFromLocalVpcToRemoteClassicLink);
  }
  ...
  public String toString() {
    ...
    sb.append("class VpcInfoPeeringOptionsDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VpcInfoPeeringOptionsDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VpcInfoPeeringOptionsDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcInfoPeeringOptionsDetails is not found in the empty JSON string", VpcInfoPeeringOptionsDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VpcInfoPeeringOptionsDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VpcInfoPeeringOptionsDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcInfoPeeringOptionsDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcInfoPeeringOptionsDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcInfoPeeringOptionsDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcInfoPeeringOptionsDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcInfoPeeringOptionsDetails>() {
           @Override
           public void write(JsonWriter out, VpcInfoPeeringOptionsDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VpcInfoPeeringOptionsDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VpcInfoPeeringOptionsDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VpcInfoPeeringOptionsDetails
   * @throws IOException if the JSON string is invalid with respect to VpcInfoPeeringOptionsDetails
   */
  public static VpcInfoPeeringOptionsDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcInfoPeeringOptionsDetails.class);
  }

  /**
   * Convert an instance of VpcInfoPeeringOptionsDetails to an JSON string
   *
   * @return JSON string
   */
