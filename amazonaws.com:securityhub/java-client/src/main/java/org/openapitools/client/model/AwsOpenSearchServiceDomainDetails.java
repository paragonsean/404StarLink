...
public class AwsOpenSearchServiceDomainDetails {
  ...
  public AwsOpenSearchServiceDomainDetails arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public AwsOpenSearchServiceDomainDetails accessPolicies(String accessPolicies) {
  ...
  public AwsOpenSearchServiceDomainDetails domainName(String domainName) {
  ...
  public AwsOpenSearchServiceDomainDetails id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AwsOpenSearchServiceDomainDetails domainEndpoint(String domainEndpoint) {
  ...
  public AwsOpenSearchServiceDomainDetails engineVersion(String engineVersion) {
  ...
  public AwsOpenSearchServiceDomainDetails encryptionAtRestOptions(AwsOpenSearchServiceDomainDetailsEncryptionAtRestOptions encryptionAtRestOptions) {
  ...
  public AwsOpenSearchServiceDomainDetails nodeToNodeEncryptionOptions(AwsOpenSearchServiceDomainDetailsNodeToNodeEncryptionOptions nodeToNodeEncryptionOptions) {
  ...
  public AwsOpenSearchServiceDomainDetails serviceSoftwareOptions(AwsOpenSearchServiceDomainDetailsServiceSoftwareOptions serviceSoftwareOptions) {
  ...
  public AwsOpenSearchServiceDomainDetails clusterConfig(AwsOpenSearchServiceDomainDetailsClusterConfig clusterConfig) {
  ...
  public AwsOpenSearchServiceDomainDetails domainEndpointOptions(AwsOpenSearchServiceDomainDetailsDomainEndpointOptions domainEndpointOptions) {
  ...
  public AwsOpenSearchServiceDomainDetails vpcOptions(AwsOpenSearchServiceDomainDetailsVpcOptions vpcOptions) {
  ...
  public AwsOpenSearchServiceDomainDetails logPublishingOptions(AwsOpenSearchServiceDomainDetailsLogPublishingOptions logPublishingOptions) {
  ...
  public AwsOpenSearchServiceDomainDetails domainEndpoints(Map domainEndpoints) {
  ...
  public AwsOpenSearchServiceDomainDetails advancedSecurityOptions(AwsOpenSearchServiceDomainDetailsAdvancedSecurityOptions advancedSecurityOptions) {
  ...
  public boolean equals(Object o) {
    ...
    AwsOpenSearchServiceDomainDetails awsOpenSearchServiceDomainDetails = (AwsOpenSearchServiceDomainDetails) o;
    return Objects.equals(this.arn, awsOpenSearchServiceDomainDetails.arn) &&
        Objects.equals(this.accessPolicies, awsOpenSearchServiceDomainDetails.accessPolicies) &&
        Objects.equals(this.domainName, awsOpenSearchServiceDomainDetails.domainName) &&
        Objects.equals(this.id, awsOpenSearchServiceDomainDetails.id) &&
        Objects.equals(this.domainEndpoint, awsOpenSearchServiceDomainDetails.domainEndpoint) &&
        Objects.equals(this.engineVersion, awsOpenSearchServiceDomainDetails.engineVersion) &&
        Objects.equals(this.encryptionAtRestOptions, awsOpenSearchServiceDomainDetails.encryptionAtRestOptions) &&
        Objects.equals(this.nodeToNodeEncryptionOptions, awsOpenSearchServiceDomainDetails.nodeToNodeEncryptionOptions) &&
        Objects.equals(this.serviceSoftwareOptions, awsOpenSearchServiceDomainDetails.serviceSoftwareOptions) &&
        Objects.equals(this.clusterConfig, awsOpenSearchServiceDomainDetails.clusterConfig) &&
        Objects.equals(this.domainEndpointOptions, awsOpenSearchServiceDomainDetails.domainEndpointOptions) &&
        Objects.equals(this.vpcOptions, awsOpenSearchServiceDomainDetails.vpcOptions) &&
        Objects.equals(this.logPublishingOptions, awsOpenSearchServiceDomainDetails.logPublishingOptions) &&
        Objects.equals(this.domainEndpoints, awsOpenSearchServiceDomainDetails.domainEndpoints) &&
        Objects.equals(this.advancedSecurityOptions, awsOpenSearchServiceDomainDetails.advancedSecurityOptions);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsOpenSearchServiceDomainDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsOpenSearchServiceDomainDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsOpenSearchServiceDomainDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsOpenSearchServiceDomainDetails is not found in the empty JSON string", AwsOpenSearchServiceDomainDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsOpenSearchServiceDomainDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsOpenSearchServiceDomainDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsOpenSearchServiceDomainDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsOpenSearchServiceDomainDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsOpenSearchServiceDomainDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsOpenSearchServiceDomainDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsOpenSearchServiceDomainDetails>() {
           @Override
           public void write(JsonWriter out, AwsOpenSearchServiceDomainDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsOpenSearchServiceDomainDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsOpenSearchServiceDomainDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsOpenSearchServiceDomainDetails
   * @throws IOException if the JSON string is invalid with respect to AwsOpenSearchServiceDomainDetails
   */
  public static AwsOpenSearchServiceDomainDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsOpenSearchServiceDomainDetails.class);
  }

  /**
   * Convert an instance of AwsOpenSearchServiceDomainDetails to an JSON string
   *
   * @return JSON string
   */
