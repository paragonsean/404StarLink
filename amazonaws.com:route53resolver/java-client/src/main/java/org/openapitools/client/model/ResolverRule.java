...
public class ResolverRule {
  ...
  public ResolverRule id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ResolverRule creatorRequestId(String creatorRequestId) {
  ...
  public ResolverRule arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public ResolverRule domainName(String domainName) {
  ...
  public ResolverRule status(ResolverRuleStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ResolverRule statusMessage(String statusMessage) {
  ...
  public ResolverRule ruleType(RuleTypeOption ruleType) {
  ...
  public ResolverRule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ResolverRule targetIps(List targetIps) {
  ...
  public ResolverRule resolverEndpointId(String resolverEndpointId) {
  ...
  public ResolverRule ownerId(String ownerId) {
  ...
  public ResolverRule shareStatus(ShareStatus shareStatus) {
  ...
  public ResolverRule creationTime(String creationTime) {
  ...
  public ResolverRule modificationTime(String modificationTime) {
  ...
  public boolean equals(Object o) {
    ...
    ResolverRule resolverRule = (ResolverRule) o;
    return Objects.equals(this.id, resolverRule.id) &&
        Objects.equals(this.creatorRequestId, resolverRule.creatorRequestId) &&
        Objects.equals(this.arn, resolverRule.arn) &&
        Objects.equals(this.domainName, resolverRule.domainName) &&
        Objects.equals(this.status, resolverRule.status) &&
        Objects.equals(this.statusMessage, resolverRule.statusMessage) &&
        Objects.equals(this.ruleType, resolverRule.ruleType) &&
        Objects.equals(this.name, resolverRule.name) &&
        Objects.equals(this.targetIps, resolverRule.targetIps) &&
        Objects.equals(this.resolverEndpointId, resolverRule.resolverEndpointId) &&
        Objects.equals(this.ownerId, resolverRule.ownerId) &&
        Objects.equals(this.shareStatus, resolverRule.shareStatus) &&
        Objects.equals(this.creationTime, resolverRule.creationTime) &&
        Objects.equals(this.modificationTime, resolverRule.modificationTime);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResolverRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResolverRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResolverRule is not found in the empty JSON string", ResolverRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResolverRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResolverRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResolverRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResolverRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResolverRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResolverRule.class));

       return (TypeAdapter<T>) new TypeAdapter<ResolverRule>() {
           @Override
           public void write(JsonWriter out, ResolverRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResolverRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResolverRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResolverRule
   * @throws IOException if the JSON string is invalid with respect to ResolverRule
   */
  public static ResolverRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResolverRule.class);
  }

  /**
   * Convert an instance of ResolverRule to an JSON string
   *
   * @return JSON string
   */
