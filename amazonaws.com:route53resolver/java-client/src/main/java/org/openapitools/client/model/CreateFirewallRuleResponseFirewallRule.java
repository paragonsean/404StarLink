...
public class CreateFirewallRuleResponseFirewallRule {
  ...
  public CreateFirewallRuleResponseFirewallRule() {
  }

  public CreateFirewallRuleResponseFirewallRule firewallRuleGroupId(String firewallRuleGroupId) {
  ...
  public CreateFirewallRuleResponseFirewallRule firewallDomainListId(String firewallDomainListId) {
  ...
  public CreateFirewallRuleResponseFirewallRule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateFirewallRuleResponseFirewallRule priority(Integer priority) {
  ...
  public CreateFirewallRuleResponseFirewallRule action(Action action) {
    this.action = action;
    return this;
  }
  ...
  public CreateFirewallRuleResponseFirewallRule blockResponse(BlockResponse blockResponse) {
  ...
  public CreateFirewallRuleResponseFirewallRule blockOverrideDomain(String blockOverrideDomain) {
  ...
  public CreateFirewallRuleResponseFirewallRule blockOverrideDnsType(BlockOverrideDnsType blockOverrideDnsType) {
  ...
  public CreateFirewallRuleResponseFirewallRule blockOverrideTtl(Integer blockOverrideTtl) {
  ...
  public CreateFirewallRuleResponseFirewallRule creatorRequestId(String creatorRequestId) {
  ...
  public CreateFirewallRuleResponseFirewallRule creationTime(String creationTime) {
  ...
  public CreateFirewallRuleResponseFirewallRule modificationTime(String modificationTime) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFirewallRuleResponseFirewallRule createFirewallRuleResponseFirewallRule = (CreateFirewallRuleResponseFirewallRule) o;
    return Objects.equals(this.firewallRuleGroupId, createFirewallRuleResponseFirewallRule.firewallRuleGroupId) &&
        Objects.equals(this.firewallDomainListId, createFirewallRuleResponseFirewallRule.firewallDomainListId) &&
        Objects.equals(this.name, createFirewallRuleResponseFirewallRule.name) &&
        Objects.equals(this.priority, createFirewallRuleResponseFirewallRule.priority) &&
        Objects.equals(this.action, createFirewallRuleResponseFirewallRule.action) &&
        Objects.equals(this.blockResponse, createFirewallRuleResponseFirewallRule.blockResponse) &&
        Objects.equals(this.blockOverrideDomain, createFirewallRuleResponseFirewallRule.blockOverrideDomain) &&
        Objects.equals(this.blockOverrideDnsType, createFirewallRuleResponseFirewallRule.blockOverrideDnsType) &&
        Objects.equals(this.blockOverrideTtl, createFirewallRuleResponseFirewallRule.blockOverrideTtl) &&
        Objects.equals(this.creatorRequestId, createFirewallRuleResponseFirewallRule.creatorRequestId) &&
        Objects.equals(this.creationTime, createFirewallRuleResponseFirewallRule.creationTime) &&
        Objects.equals(this.modificationTime, createFirewallRuleResponseFirewallRule.modificationTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFirewallRuleResponseFirewallRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateFirewallRuleResponseFirewallRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFirewallRuleResponseFirewallRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateFirewallRuleResponseFirewallRule is not found in the empty JSON string", CreateFirewallRuleResponseFirewallRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFirewallRuleResponseFirewallRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateFirewallRuleResponseFirewallRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateFirewallRuleResponseFirewallRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateFirewallRuleResponseFirewallRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateFirewallRuleResponseFirewallRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateFirewallRuleResponseFirewallRule.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateFirewallRuleResponseFirewallRule>() {
           @Override
           public void write(JsonWriter out, CreateFirewallRuleResponseFirewallRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateFirewallRuleResponseFirewallRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateFirewallRuleResponseFirewallRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateFirewallRuleResponseFirewallRule
   * @throws IOException if the JSON string is invalid with respect to CreateFirewallRuleResponseFirewallRule
   */
  public static CreateFirewallRuleResponseFirewallRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateFirewallRuleResponseFirewallRule.class);
  }

  /**
   * Convert an instance of CreateFirewallRuleResponseFirewallRule to an JSON string
   *
   * @return JSON string
   */
