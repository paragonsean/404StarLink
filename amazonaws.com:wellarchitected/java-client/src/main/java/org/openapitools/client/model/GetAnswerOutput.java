...
public class GetAnswerOutput {
  ...
  public GetAnswerOutput workloadId(String workloadId) {
  ...
  public GetAnswerOutput milestoneNumber(Integer milestoneNumber) {
  ...
  public GetAnswerOutput lensAlias(String lensAlias) {
  ...
  public GetAnswerOutput lensArn(String lensArn) {
  ...
  public GetAnswerOutput answer(Answer answer) {
    this.answer = answer;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetAnswerOutput getAnswerOutput = (GetAnswerOutput) o;
    return Objects.equals(this.workloadId, getAnswerOutput.workloadId) &&
        Objects.equals(this.milestoneNumber, getAnswerOutput.milestoneNumber) &&
        Objects.equals(this.lensAlias, getAnswerOutput.lensAlias) &&
        Objects.equals(this.lensArn, getAnswerOutput.lensArn) &&
        Objects.equals(this.answer, getAnswerOutput.answer);
  }

  @Override
  public int hashCode() {
    return Objects.hash(workloadId, milestoneNumber, lensAlias, lensArn, answer);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GetAnswerOutput {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetAnswerOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetAnswerOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetAnswerOutput is not found in the empty JSON string", GetAnswerOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetAnswerOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAnswerOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetAnswerOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetAnswerOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetAnswerOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetAnswerOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<GetAnswerOutput>() {
           @Override
           public void write(JsonWriter out, GetAnswerOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetAnswerOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetAnswerOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetAnswerOutput
   * @throws IOException if the JSON string is invalid with respect to GetAnswerOutput
   */
  public static GetAnswerOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetAnswerOutput.class);
  }

  /**
   * Convert an instance of GetAnswerOutput to an JSON string
   *
   * @return JSON string
   */
