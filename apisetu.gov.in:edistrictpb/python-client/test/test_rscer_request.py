...
class TestRscerRequest(unittest.TestCase):
    """RscerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RscerRequest:
        """Test RscerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RscerRequest`
        """
        model = RscerRequest()
        if include_optional:
            return RscerRequest(
                certificate_parameters = openapi_client.models.rscer_request_certificate_parameters.rscer_request_certificateParameters(
                    dob = '31-12-1980', 
                    dsnno = '2257331', 
