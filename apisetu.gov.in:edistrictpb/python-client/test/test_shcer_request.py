...
class TestShcerRequest(unittest.TestCase):
    """ShcerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShcerRequest:
        """Test ShcerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShcerRequest`
        """
        model = ShcerRequest()
        if include_optional:
            return ShcerRequest(
                certificate_parameters = openapi_client.models.shcer_request_certificate_parameters.shcer_request_certificateParameters(
                    dob = '31-12-1980', 
                    dsnno = '5592', 
