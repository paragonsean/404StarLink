...
class RscerRequestCertificateParameters(BaseModel):
    """
    RscerRequestCertificateParameters
    """ # noqa: E501
    dob: StrictStr = Field(description="Date of birth in DD-MM-YYYY format", alias="DOB")
    dsnno: StrictStr = Field(description="DSN Number", alias="DSNNo")
    father_name: StrictStr = Field(description="Father Name", alias="FatherName")
    full_name: StrictStr = Field(description="Full name", alias="FullName")
    uid: StrictStr = Field(description="Aadhaar number", alias="UID")
    __properties: ClassVar[List[str]] = ["DOB", "DSNNo", "FatherName", "FullName", "UID"]
