...
class TestBatchExecuteStatementInput(unittest.TestCase):
    """BatchExecuteStatementInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchExecuteStatementInput:
        """Test BatchExecuteStatementInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchExecuteStatementInput`
        """
        model = BatchExecuteStatementInput()
        if include_optional:
    ...
    def testBatchExecuteStatementInput(self):
        """Test BatchExecuteStatementInput"""
