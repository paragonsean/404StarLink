...
class TestDescribeStatementRequest(unittest.TestCase):
    """DescribeStatementRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DescribeStatementRequest:
        """Test DescribeStatementRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DescribeStatementRequest`
        """
        model = DescribeStatementRequest()
        if include_optional:
    ...
    def testDescribeStatementRequest(self):
        """Test DescribeStatementRequest"""
