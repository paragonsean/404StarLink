...
class ListStatementsRequest(BaseModel):
    ...
    role_level: Optional[Any] = Field(default=None, alias="RoleLevel")
    statement_name: Optional[Any] = Field(default=None, alias="StatementName")
    status: Optional[Any] = Field(default=None, alias="Status")
    __properties: ClassVar[List[str]] = ["MaxResults", "NextToken", "RoleLevel", "StatementName", "Status"]
