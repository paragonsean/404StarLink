...
class ExecuteStatementInput(BaseModel):
    ...
    """ # noqa: E501
    client_token: Optional[Any] = Field(default=None, alias="ClientToken")
    ...
    sql: Any = Field(alias="Sql")
    statement_name: Optional[Any] = Field(default=None, alias="StatementName")
    with_event: Optional[Any] = Field(default=None, alias="WithEvent")
    workgroup_name: Optional[Any] = Field(default=None, alias="WorkgroupName")
    __properties: ClassVar[List[str]] = ["ClientToken", "ClusterIdentifier", "Database", "DbUser", "Parameters", "SecretArn", "Sql", "StatementName", "WithEvent", "WorkgroupName"]
