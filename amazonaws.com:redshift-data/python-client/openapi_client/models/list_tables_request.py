...
class ListTablesRequest(BaseModel):
    ...
    schema_pattern: Optional[Any] = Field(default=None, alias="SchemaPattern")
    secret_arn: Optional[Any] = Field(default=None, alias="SecretArn")
    table_pattern: Optional[Any] = Field(default=None, alias="TablePattern")
    workgroup_name: Optional[Any] = Field(default=None, alias="WorkgroupName")
    __properties: ClassVar[List[str]] = ["ClusterIdentifier", "ConnectedDatabase", "Database", "DbUser", "MaxResults", "NextToken", "SchemaPattern", "SecretArn", "TablePattern", "WorkgroupName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "SchemaPattern": obj.get("SchemaPattern"),
            "SecretArn": obj.get("SecretArn"),
            "TablePattern": obj.get("TablePattern"),
