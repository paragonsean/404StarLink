...
public class GifImagesFixedWidthStill {
  ...
  public GifImagesFixedWidthStill() {
  }

  public GifImagesFixedWidthStill frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesFixedWidthStill height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesFixedWidthStill mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesFixedWidthStill mp4Size(String mp4Size) {
  ...
  public GifImagesFixedWidthStill size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesFixedWidthStill url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesFixedWidthStill webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesFixedWidthStill webpSize(String webpSize) {
  ...
  public GifImagesFixedWidthStill width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesFixedWidthStill gifImagesFixedWidthStill = (GifImagesFixedWidthStill) o;
    return Objects.equals(this.frames, gifImagesFixedWidthStill.frames) &&
        Objects.equals(this.height, gifImagesFixedWidthStill.height) &&
        Objects.equals(this.mp4, gifImagesFixedWidthStill.mp4) &&
        Objects.equals(this.mp4Size, gifImagesFixedWidthStill.mp4Size) &&
        Objects.equals(this.size, gifImagesFixedWidthStill.size) &&
        Objects.equals(this.url, gifImagesFixedWidthStill.url) &&
        Objects.equals(this.webp, gifImagesFixedWidthStill.webp) &&
        Objects.equals(this.webpSize, gifImagesFixedWidthStill.webpSize) &&
        Objects.equals(this.width, gifImagesFixedWidthStill.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesFixedWidthStill {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesFixedWidthStill
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesFixedWidthStill.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesFixedWidthStill is not found in the empty JSON string", GifImagesFixedWidthStill.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesFixedWidthStill.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesFixedWidthStill` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesFixedWidthStill.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesFixedWidthStill' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesFixedWidthStill> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesFixedWidthStill.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesFixedWidthStill>() {
           @Override
           public void write(JsonWriter out, GifImagesFixedWidthStill value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesFixedWidthStill read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesFixedWidthStill given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesFixedWidthStill
   * @throws IOException if the JSON string is invalid with respect to GifImagesFixedWidthStill
   */
  public static GifImagesFixedWidthStill fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesFixedWidthStill.class);
  }

  /**
   * Convert an instance of GifImagesFixedWidthStill to an JSON string
   *
   * @return JSON string
   */
