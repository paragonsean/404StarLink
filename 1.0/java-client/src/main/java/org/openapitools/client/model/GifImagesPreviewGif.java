...
public class GifImagesPreviewGif {
  ...
  public GifImagesPreviewGif() {
  }

  public GifImagesPreviewGif frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesPreviewGif height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesPreviewGif mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesPreviewGif mp4Size(String mp4Size) {
  ...
  public GifImagesPreviewGif size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesPreviewGif url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesPreviewGif webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesPreviewGif webpSize(String webpSize) {
  ...
  public GifImagesPreviewGif width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesPreviewGif gifImagesPreviewGif = (GifImagesPreviewGif) o;
    return Objects.equals(this.frames, gifImagesPreviewGif.frames) &&
        Objects.equals(this.height, gifImagesPreviewGif.height) &&
        Objects.equals(this.mp4, gifImagesPreviewGif.mp4) &&
        Objects.equals(this.mp4Size, gifImagesPreviewGif.mp4Size) &&
        Objects.equals(this.size, gifImagesPreviewGif.size) &&
        Objects.equals(this.url, gifImagesPreviewGif.url) &&
        Objects.equals(this.webp, gifImagesPreviewGif.webp) &&
        Objects.equals(this.webpSize, gifImagesPreviewGif.webpSize) &&
        Objects.equals(this.width, gifImagesPreviewGif.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesPreviewGif {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesPreviewGif
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesPreviewGif.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesPreviewGif is not found in the empty JSON string", GifImagesPreviewGif.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesPreviewGif.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesPreviewGif` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesPreviewGif.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesPreviewGif' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesPreviewGif> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesPreviewGif.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesPreviewGif>() {
           @Override
           public void write(JsonWriter out, GifImagesPreviewGif value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesPreviewGif read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesPreviewGif given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesPreviewGif
   * @throws IOException if the JSON string is invalid with respect to GifImagesPreviewGif
   */
  public static GifImagesPreviewGif fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesPreviewGif.class);
  }

  /**
   * Convert an instance of GifImagesPreviewGif to an JSON string
   *
   * @return JSON string
   */
