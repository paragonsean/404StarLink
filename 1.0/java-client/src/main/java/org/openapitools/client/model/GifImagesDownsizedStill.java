...
public class GifImagesDownsizedStill {
  ...
  public GifImagesDownsizedStill() {
  }

  public GifImagesDownsizedStill frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesDownsizedStill height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesDownsizedStill mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesDownsizedStill mp4Size(String mp4Size) {
  ...
  public GifImagesDownsizedStill size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesDownsizedStill url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesDownsizedStill webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesDownsizedStill webpSize(String webpSize) {
  ...
  public GifImagesDownsizedStill width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesDownsizedStill gifImagesDownsizedStill = (GifImagesDownsizedStill) o;
    return Objects.equals(this.frames, gifImagesDownsizedStill.frames) &&
        Objects.equals(this.height, gifImagesDownsizedStill.height) &&
        Objects.equals(this.mp4, gifImagesDownsizedStill.mp4) &&
        Objects.equals(this.mp4Size, gifImagesDownsizedStill.mp4Size) &&
        Objects.equals(this.size, gifImagesDownsizedStill.size) &&
        Objects.equals(this.url, gifImagesDownsizedStill.url) &&
        Objects.equals(this.webp, gifImagesDownsizedStill.webp) &&
        Objects.equals(this.webpSize, gifImagesDownsizedStill.webpSize) &&
        Objects.equals(this.width, gifImagesDownsizedStill.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesDownsizedStill {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesDownsizedStill
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesDownsizedStill.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesDownsizedStill is not found in the empty JSON string", GifImagesDownsizedStill.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesDownsizedStill.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesDownsizedStill` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesDownsizedStill.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesDownsizedStill' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesDownsizedStill> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesDownsizedStill.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesDownsizedStill>() {
           @Override
           public void write(JsonWriter out, GifImagesDownsizedStill value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesDownsizedStill read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesDownsizedStill given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesDownsizedStill
   * @throws IOException if the JSON string is invalid with respect to GifImagesDownsizedStill
   */
  public static GifImagesDownsizedStill fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesDownsizedStill.class);
  }

  /**
   * Convert an instance of GifImagesDownsizedStill to an JSON string
   *
   * @return JSON string
   */
