...
public class GifImagesFixedHeight {
  ...
  public GifImagesFixedHeight() {
  }

  public GifImagesFixedHeight frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesFixedHeight height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesFixedHeight mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesFixedHeight mp4Size(String mp4Size) {
  ...
  public GifImagesFixedHeight size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesFixedHeight url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesFixedHeight webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesFixedHeight webpSize(String webpSize) {
  ...
  public GifImagesFixedHeight width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesFixedHeight gifImagesFixedHeight = (GifImagesFixedHeight) o;
    return Objects.equals(this.frames, gifImagesFixedHeight.frames) &&
        Objects.equals(this.height, gifImagesFixedHeight.height) &&
        Objects.equals(this.mp4, gifImagesFixedHeight.mp4) &&
        Objects.equals(this.mp4Size, gifImagesFixedHeight.mp4Size) &&
        Objects.equals(this.size, gifImagesFixedHeight.size) &&
        Objects.equals(this.url, gifImagesFixedHeight.url) &&
        Objects.equals(this.webp, gifImagesFixedHeight.webp) &&
        Objects.equals(this.webpSize, gifImagesFixedHeight.webpSize) &&
        Objects.equals(this.width, gifImagesFixedHeight.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesFixedHeight {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesFixedHeight
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesFixedHeight.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesFixedHeight is not found in the empty JSON string", GifImagesFixedHeight.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesFixedHeight.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesFixedHeight` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesFixedHeight.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesFixedHeight' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesFixedHeight> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesFixedHeight.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesFixedHeight>() {
           @Override
           public void write(JsonWriter out, GifImagesFixedHeight value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesFixedHeight read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesFixedHeight given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesFixedHeight
   * @throws IOException if the JSON string is invalid with respect to GifImagesFixedHeight
   */
  public static GifImagesFixedHeight fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesFixedHeight.class);
  }

  /**
   * Convert an instance of GifImagesFixedHeight to an JSON string
   *
   * @return JSON string
   */
