...
class QuotaBucket(BaseModel):
    ...
    """ # noqa: E501
    admin_override: Optional[QuotaOverride] = Field(default=None, alias="adminOverride")
    consumer_override: Optional[QuotaOverride] = Field(default=None, alias="consumerOverride")
    ...
    producer_override: Optional[QuotaOverride] = Field(default=None, alias="producerOverride")
    __properties: ClassVar[List[str]] = ["adminOverride", "consumerOverride", "defaultLimit", "dimensions", "effectiveLimit", "producerOverride"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adminOverride": QuotaOverride.from_dict(obj["adminOverride"]) if obj.get("adminOverride") is not None else None,
            "consumerOverride": QuotaOverride.from_dict(obj["consumerOverride"]) if obj.get("consumerOverride") is not None else None,
            "defaultLimit": obj.get("defaultLimit"),
            "dimensions": obj.get("dimensions"),
            "effectiveLimit": obj.get("effectiveLimit"),
            "producerOverride": QuotaOverride.from_dict(obj["producerOverride"]) if obj.get("producerOverride") is not None else None
        })
        return _obj
