...
class ConsumerPolicy(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Output only. The resource name of the policy. For example, `projects/12345/consumerPolicy`, `folders/12345/consumerPolicy`, `organizations/12345/consumerPolicy`.")
