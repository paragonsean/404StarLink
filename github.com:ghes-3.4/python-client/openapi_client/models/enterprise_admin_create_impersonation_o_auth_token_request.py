...
class EnterpriseAdminCreateImpersonationOAuthTokenRequest(BaseModel):
    """
    EnterpriseAdminCreateImpersonationOAuthTokenRequest
    """ # noqa: E501
    scopes: List[StrictStr] = Field(description="A list of [scopes](https://docs.github.com/enterprise-server@3.4/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).")
