...
class PullRequestReview(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_links", "author_association", "body", "body_html", "body_text", "commit_id", "html_url", "id", "node_id", "pull_request_url", "state", "submitted_at", "user"]
