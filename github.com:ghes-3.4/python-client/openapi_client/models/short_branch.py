...
class ShortBranch(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["commit", "name", "protected", "protection", "protection_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "commit": CommitSearchResultItemCommitTree.from_dict(obj["commit"]) if obj.get("commit") is not None else None,
            "name": obj.get("name"),
