...
class Page(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["build_type", "cname", "custom_404", "html_url", "https_certificate", "https_enforced", "pending_domain_unverified_at", "protected_domain_state", "public", "source", "status", "url"]
