...
class Authorization(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["app", "created_at", "expires_at", "fingerprint", "hashed_token", "id", "installation", "note", "note_url", "scopes", "token", "token_last_eight", "updated_at", "url", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "app": ApplicationGrantApp.from_dict(obj["app"]) if obj.get("app") is not None else None,
