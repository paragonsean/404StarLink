...
class ReposUpdateWebhookRequestConfig(BaseModel):
    """
    ...
    secret: Optional[StrictStr] = Field(default=None, description="If provided, the `secret` will be used as the `key` to generate the HMAC hex digest value for [delivery signature headers](https://docs.github.com/enterprise-server@3.4/webhooks/event-payloads/#delivery-headers).")
    url: StrictStr = Field(description="The URL to which the payloads will be delivered.")
    __properties: ClassVar[List[str]] = ["address", "content_type", "insecure_ssl", "room", "secret", "url"]
