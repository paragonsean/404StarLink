...
class PreReceiveHookEnvironment(BaseModel):
    """
    PreReceiveHookEnvironment
    """ # noqa: E501
    created_at: Optional[StrictStr] = None
    default_environment: Optional[StrictBool] = None
    download: Optional[PreReceiveEnvironmentDownload] = None
    hooks_count: Optional[StrictInt] = None
    html_url: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    image_url: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["created_at", "default_environment", "download", "hooks_count", "html_url", "id", "image_url", "name", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "download": PreReceiveEnvironmentDownload.from_dict(obj["download"]) if obj.get("download") is not None else None,
            "hooks_count": obj.get("hooks_count"),
