...
class PullsCreateRequest(BaseModel):
    ...
    draft: Optional[StrictBool] = Field(default=None, description="Indicates whether the pull request is a draft. See \"[Draft Pull Requests](https://docs.github.com/enterprise-server@3.4/articles/about-pull-requests#draft-pull-requests)\" in the GitHub Help documentation to learn more.")
    ...
    __properties: ClassVar[List[str]] = ["base", "body", "draft", "head", "issue", "maintainer_can_modify", "title"]
