...
class RunnerGroupsOrg(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allows_public_repositories", "default", "id", "inherited", "inherited_allows_public_repositories", "name", "runners_url", "selected_repositories_url", "visibility"]
