...
class ReviewRequestRemovedIssueEvent(BaseModel):
    ...
    url: StrictStr
    __properties: ClassVar[List[str]] = ["actor", "commit_id", "commit_url", "created_at", "event", "id", "node_id", "performed_via_github_app", "requested_reviewer", "requested_team", "review_requester", "url"]
