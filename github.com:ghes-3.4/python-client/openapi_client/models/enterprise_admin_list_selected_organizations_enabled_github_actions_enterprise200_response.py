...
class EnterpriseAdminListSelectedOrganizationsEnabledGithubActionsEnterprise200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["organizations", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organizations": [OrganizationSimple.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None,
