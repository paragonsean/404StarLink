...
class IssueComment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["author_association", "body", "body_html", "body_text", "created_at", "html_url", "id", "issue_url", "node_id", "performed_via_github_app", "reactions", "updated_at", "url", "user"]
