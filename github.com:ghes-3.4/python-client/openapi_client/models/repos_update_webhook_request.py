...
class ReposUpdateWebhookRequest(BaseModel):
    ...
    config: Optional[ReposUpdateWebhookRequestConfig] = None
    events: Optional[List[StrictStr]] = Field(default=None, description="Determines what [events](https://docs.github.com/enterprise-server@3.4/webhooks/event-payloads) the hook is triggered for. This replaces the entire array of events.")
    ...
    __properties: ClassVar[List[str]] = ["active", "add_events", "config", "events", "remove_events"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": ReposUpdateWebhookRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
