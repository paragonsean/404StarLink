...
class BranchRestrictionPolicyAppsInnerOwner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["avatar_url", "description", "events_url", "followers_url", "following_url", "gists_url", "gravatar_id", "hooks_url", "html_url", "id", "issues_url", "login", "members_url", "node_id", "organizations_url", "public_members_url", "received_events_url", "repos_url", "site_admin", "starred_url", "subscriptions_url", "type", "url"]
