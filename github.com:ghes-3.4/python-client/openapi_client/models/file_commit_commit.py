...
class FileCommitCommit(BaseModel):
    ...
    parents: Optional[List[CommitSearchResultItemParentsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parents": [CommitSearchResultItemParentsInner.from_dict(_item) for _item in obj["parents"]] if obj.get("parents") is not None else None,
            "sha": obj.get("sha"),
