...
class EnterpriseSettings(BaseModel):
    ...
    EnterpriseSettings
    """ # noqa: E501
    enterprise: Optional[EnterpriseSettingsEnterprise] = None
    run_list: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["enterprise", "run_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "enterprise": EnterpriseSettingsEnterprise.from_dict(obj["enterprise"]) if obj.get("enterprise") is not None else None,
            "run_list": obj.get("run_list")
        })
        return _obj
