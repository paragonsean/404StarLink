...
class EnterpriseSettingsEnterpriseGithubOauth(BaseModel):
    """
    ...
    organization_team: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["client_id", "client_secret", "organization_name", "organization_team"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organization_team": obj.get("organization_team")
        })
        return _obj
