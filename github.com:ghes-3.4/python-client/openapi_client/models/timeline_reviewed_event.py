...
class TimelineReviewedEvent(BaseModel):
    ...
    """ # noqa: E501
    links: PullRequestReviewLinks = Field(alias="_links")
    ...
    user: SimpleUser
    __properties: ClassVar[List[str]] = ["_links", "author_association", "body", "body_html", "body_text", "commit_id", "event", "html_url", "id", "node_id", "pull_request_url", "state", "submitted_at", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_links": PullRequestReviewLinks.from_dict(obj["_links"]) if obj.get("_links") is not None else None,
