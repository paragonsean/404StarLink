...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    org = 'org_example' # str | The organization name. The name is not case sensitive.
    team_slug = 'team_slug_example' # str | The slug of the team name.
    teams_update_in_org_request = {"description":"new team description","name":"new team name","privacy":"closed"} # TeamsUpdateInOrgRequest |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.TeamsApi(api_client)
    team_id = 56 # int | The unique identifier of the team.
    teams_update_legacy_request = {"description":"new team description","name":"new team name","privacy":"closed"} # TeamsUpdateLegacyRequest | 
