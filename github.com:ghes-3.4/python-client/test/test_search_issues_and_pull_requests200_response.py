    ...
    def make_instance(self, include_optional) -> SearchIssuesAndPullRequests200Response:
        ...
        if include_optional:
            return SearchIssuesAndPullRequests200Response(
                ...
                items = [
                    openapi_client.models.issue_search_result_item.Issue Search Result Item(
                        active_lock_reason = '', 
                        ...
                        id = 56, 
                        labels = [
                            openapi_client.models.issue_search_result_item_labels_inner.issue_search_result_item_labels_inner(
                                color = '', 
                                default = True, 
                                description = '', 
                                id = 56, 
