...
public class ApiClient {
    ...
    private String basePath = "https://cal-test.adyen.com/cal/services/Fund/v6";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/6/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cal-test.adyen.com/cal/services/Fund/v6
