...
|------------- | ------------- | -------------|
| [**partnersGet**](PartnersApi.md#partnersGet) | **GET** /partners | List SureVoIP Partner accounts |
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.partnersGet();
    } catch (ApiException e) {
      System.err.println("Exception when calling PartnersApi#partnersGet");
