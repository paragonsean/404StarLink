...
class TestVehicleRegistrationSchemaCertificateDataVehicleRegistration(unittest.TestCase):
    """VehicleRegistrationSchemaCertificateDataVehicleRegistration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VehicleRegistrationSchemaCertificateDataVehicleRegistration:
        """Test VehicleRegistrationSchemaCertificateDataVehicleRegistration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VehicleRegistrationSchemaCertificateDataVehicleRegistration`
        """
        model = VehicleRegistrationSchemaCertificateDataVehicleRegistration()
        if include_optional:
    ...
    def testVehicleRegistrationSchemaCertificateDataVehicleRegistration(self):
        """Test VehicleRegistrationSchemaCertificateDataVehicleRegistration"""
