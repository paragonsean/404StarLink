...
class TestDrvlcRequest(unittest.TestCase):
    """DrvlcRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DrvlcRequest:
        """Test DrvlcRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DrvlcRequest`
        """
        model = DrvlcRequest()
        if include_optional:
            return DrvlcRequest(
                certificate_parameters = openapi_client.models.drvlc_request_certificate_parameters.drvlc_request_certificateParameters(
                    dob = '31-12-1980', 
