...
class TestVehicleRegistrationSchemaIssuedTo(unittest.TestCase):
    """VehicleRegistrationSchemaIssuedTo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VehicleRegistrationSchemaIssuedTo:
        """Test VehicleRegistrationSchemaIssuedTo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VehicleRegistrationSchemaIssuedTo`
        """
        model = VehicleRegistrationSchemaIssuedTo()
        if include_optional:
    ...
    def testVehicleRegistrationSchemaIssuedTo(self):
        """Test VehicleRegistrationSchemaIssuedTo"""
