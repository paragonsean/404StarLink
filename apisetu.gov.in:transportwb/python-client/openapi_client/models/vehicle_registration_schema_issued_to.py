...
class VehicleRegistrationSchemaIssuedTo(BaseModel):
    """
    VehicleRegistrationSchemaIssuedTo
    """ # noqa: E501
    person: VehicleRegistrationSchemaIssuedToPerson = Field(alias="Person")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Person": VehicleRegistrationSchemaIssuedToPerson.from_dict(obj["Person"]) if obj.get("Person") is not None else None
        })
        return _obj
