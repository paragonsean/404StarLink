...
class AcademicCertificateSchemaIssuedByOrganization(BaseModel):
    """
    AcademicCertificateSchemaIssuedByOrganization
    """ # noqa: E501
    address: AcademicCertificateSchemaIssuedByOrganizationAddress = Field(alias="Address")
    code: StrictStr
    name: Annotated[str, Field(min_length=1, strict=True)]
    tin: StrictStr
    type: Annotated[str, Field(min_length=1, strict=True)]
    uid: StrictStr
    __properties: ClassVar[List[str]] = ["Address", "code", "name", "tin", "type", "uid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Address": AcademicCertificateSchemaIssuedByOrganizationAddress.from_dict(obj["Address"]) if obj.get("Address") is not None else None,
            "code": obj.get("code"),
            "name": obj.get("name"),
            "tin": obj.get("tin"),
            "type": obj.get("type"),
