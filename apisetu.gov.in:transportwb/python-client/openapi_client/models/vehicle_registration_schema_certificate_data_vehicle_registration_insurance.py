...
class VehicleRegistrationSchemaCertificateDataVehicleRegistrationInsurance(BaseModel):
    """
    VehicleRegistrationSchemaCertificateDataVehicleRegistrationInsurance
    """ # noqa: E501
    company_name: Optional[StrictStr] = Field(default=None, alias="companyName")
    policy_no: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, alias="policyNo")
    valid_till: Optional[StrictStr] = Field(default=None, alias="validTill")
    __properties: ClassVar[List[str]] = ["companyName", "policyNo", "validTill"]
