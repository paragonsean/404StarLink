...
class ConsentArtifactSchemaConsentPermissionDateRange(BaseModel):
    """
    ConsentArtifactSchemaConsentPermissionDateRange
    """ # noqa: E501
    var_from: datetime = Field(description="Date time format in UTC, includes miliseconds YYYY-MM-DDThh:mm:ss.vZ", alias="from")
    to: datetime = Field(description="Date time format in UTC, includes miliseconds YYYY-MM-DDThh:mm:ss.vZ")
