...
class Drvlc404Response(BaseModel):
    """
    Drvlc404Response
    """ # noqa: E501
    ...
    def error_validate_enum(cls, value):
        ...
        if value not in set(['record_not_found', 'url_not_found']):
            raise ValueError("must be one of enum values ('record_not_found', 'url_not_found')")
        return value
    ...
    def error_description_validate_enum(cls, value):
        ...
        if value not in set(['No record found', 'Your API url or path is incorrect']):
            raise ValueError("must be one of enum values ('No record found', 'Your API url or path is incorrect')")
        return value
