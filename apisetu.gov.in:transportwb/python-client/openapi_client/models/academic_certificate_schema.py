...
class AcademicCertificateSchema(BaseModel):
    ...
    """ # noqa: E501
    certificate_data: AcademicCertificateSchemaCertificateData = Field(alias="CertificateData")
    issued_by: AcademicCertificateSchemaIssuedBy = Field(alias="IssuedBy")
    issued_to: AcademicCertificateSchemaIssuedTo = Field(alias="IssuedTo")
    ...
    __properties: ClassVar[List[str]] = ["CertificateData", "IssuedBy", "IssuedTo", "issueDate", "issuedAt", "language", "name", "number", "status", "type", "validFromDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CertificateData": AcademicCertificateSchemaCertificateData.from_dict(obj["CertificateData"]) if obj.get("CertificateData") is not None else None,
            "IssuedBy": AcademicCertificateSchemaIssuedBy.from_dict(obj["IssuedBy"]) if obj.get("IssuedBy") is not None else None,
            "IssuedTo": AcademicCertificateSchemaIssuedTo.from_dict(obj["IssuedTo"]) if obj.get("IssuedTo") is not None else None,
