...
public class TemplateDefinition {
  ...
  public TemplateDefinition pages(List<TemplateDefinitionPagesInner> pages) {
    this.pages = pages;
    return this;
  }

  public TemplateDefinition addPagesItem(TemplateDefinitionPagesInner pagesItem) {
    if (this.pages == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataSettings, templateDefinition.dataSettings) &&
        Objects.equals(this.editor, templateDefinition.editor) &&
        Objects.equals(this.id, templateDefinition.id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dataSettings, editor, id, isDraft, layout, name, pages, tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateDefinition
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinition.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinition` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `dataSettings`
      if (jsonObj.get("dataSettings") != null && !jsonObj.get("dataSettings").isJsonNull()) {
        TemplateDefinitionDataSettings.validateJsonElement(jsonObj.get("dataSettings"));
      }
      // validate the optional field `editor`
      if (jsonObj.get("editor") != null && !jsonObj.get("editor").isJsonNull()) {
        TemplateDefinitionEditor.validateJsonElement(jsonObj.get("editor"));
      }
      // validate the optional field `layout`
      if (jsonObj.get("layout") != null && !jsonObj.get("layout").isJsonNull()) {
        TemplateDefinitionLayout.validateJsonElement(jsonObj.get("layout"));
      }
