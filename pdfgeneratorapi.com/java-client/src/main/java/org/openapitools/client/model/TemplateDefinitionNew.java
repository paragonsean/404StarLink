...
import org.openapitools.client.model.TemplateDefinitionNewLayout;
...
public class TemplateDefinitionNew {
  ...
  private List<TemplateDefinitionPagesInner> pages = new ArrayList<>();

  public static final String SERIALIZED_NAME_TAGS = "tags";
  @SerializedName(SERIALIZED_NAME_TAGS)
  private List<String> tags = new ArrayList<>();

  public TemplateDefinitionNew() {
  }
  ...
  public TemplateDefinitionNew pages(List<TemplateDefinitionPagesInner> pages) {
    this.pages = pages;
    return this;
  }

  public TemplateDefinitionNew addPagesItem(TemplateDefinitionPagesInner pagesItem) {
    if (this.pages == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<TemplateDefinitionPagesInner> getPages() {
    return pages;
  }

  public void setPages(List<TemplateDefinitionPagesInner> pages) {
    this.pages = pages;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isDraft, templateDefinitionNew.isDraft) &&
        Objects.equals(this.layout, templateDefinitionNew.layout) &&
        Objects.equals(this.name, templateDefinitionNew.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(isDraft, layout, name, pages, tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateDefinitionNew
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateDefinitionNew.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateDefinitionNew is not found in the empty JSON string", TemplateDefinitionNew.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionNew.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionNew` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TemplateDefinitionNew.openapiRequiredFields) {
      ...
      if (jsonObj.get("layout") != null && !jsonObj.get("layout").isJsonNull()) {
        TemplateDefinitionNewLayout.validateJsonElement(jsonObj.get("layout"));
      }
      ...
      if (jsonObj.get("pages") != null && !jsonObj.get("pages").isJsonNull()) {
        ...
        if (jsonArraypages != null) {
          ...
          for (int i = 0; i < jsonArraypages.size(); i++) {
            TemplateDefinitionPagesInner.validateJsonElement(jsonArraypages.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateDefinitionNew.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateDefinitionNew' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateDefinitionNew> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateDefinitionNew.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateDefinitionNew>() {
           @Override
           public void write(JsonWriter out, TemplateDefinitionNew value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateDefinitionNew read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateDefinitionNew given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateDefinitionNew
   * @throws IOException if the JSON string is invalid with respect to TemplateDefinitionNew
   */
  public static TemplateDefinitionNew fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateDefinitionNew.class);
  }

  /**
   * Convert an instance of TemplateDefinitionNew to an JSON string
   *
   * @return JSON string
   */
