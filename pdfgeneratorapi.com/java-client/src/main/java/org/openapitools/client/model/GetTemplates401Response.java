...
public class GetTemplates401Response {
  /**
   * Error description
   */
  ...
  public GetTemplates401Response() {
  }

  public GetTemplates401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates401Response status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTemplates401Response getTemplates401Response = (GetTemplates401Response) o;
    return Objects.equals(this.error, getTemplates401Response.error) &&
        Objects.equals(this.status, getTemplates401Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTemplates401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTemplates401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTemplates401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTemplates401Response is not found in the empty JSON string", GetTemplates401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTemplates401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTemplates401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTemplates401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTemplates401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTemplates401Response>() {
           @Override
           public void write(JsonWriter out, GetTemplates401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTemplates401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTemplates401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTemplates401Response
   * @throws IOException if the JSON string is invalid with respect to GetTemplates401Response
   */
  public static GetTemplates401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTemplates401Response.class);
  }

  /**
   * Convert an instance of GetTemplates401Response to an JSON string
   *
   * @return JSON string
   */
