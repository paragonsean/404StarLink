...
public class DeleteTemplate200ResponseResponse {
  public static final String SERIALIZED_NAME_SUCCESS = "success";
  @SerializedName(SERIALIZED_NAME_SUCCESS)
  private Boolean success;

  public DeleteTemplate200ResponseResponse() {
  }

  public DeleteTemplate200ResponseResponse success(Boolean success) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteTemplate200ResponseResponse deleteTemplate200ResponseResponse = (DeleteTemplate200ResponseResponse) o;
    return Objects.equals(this.success, deleteTemplate200ResponseResponse.success);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteTemplate200ResponseResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTemplate200ResponseResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTemplate200ResponseResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTemplate200ResponseResponse is not found in the empty JSON string", DeleteTemplate200ResponseResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTemplate200ResponseResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTemplate200ResponseResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTemplate200ResponseResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTemplate200ResponseResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTemplate200ResponseResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTemplate200ResponseResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTemplate200ResponseResponse>() {
           @Override
           public void write(JsonWriter out, DeleteTemplate200ResponseResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTemplate200ResponseResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTemplate200ResponseResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTemplate200ResponseResponse
   * @throws IOException if the JSON string is invalid with respect to DeleteTemplate200ResponseResponse
   */
  public static DeleteTemplate200ResponseResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTemplate200ResponseResponse.class);
  }

  /**
   * Convert an instance of DeleteTemplate200ResponseResponse to an JSON string
   *
   * @return JSON string
   */
