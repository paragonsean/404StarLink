...
public class GetTemplates422Response {
  /**
   * Error description
   */
  ...
  public GetTemplates422Response() {
  }

  public GetTemplates422Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates422Response status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTemplates422Response getTemplates422Response = (GetTemplates422Response) o;
    return Objects.equals(this.error, getTemplates422Response.error) &&
        Objects.equals(this.status, getTemplates422Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTemplates422Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTemplates422Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTemplates422Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTemplates422Response is not found in the empty JSON string", GetTemplates422Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates422Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates422Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTemplates422Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTemplates422Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTemplates422Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTemplates422Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTemplates422Response>() {
           @Override
           public void write(JsonWriter out, GetTemplates422Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTemplates422Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTemplates422Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTemplates422Response
   * @throws IOException if the JSON string is invalid with respect to GetTemplates422Response
   */
  public static GetTemplates422Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTemplates422Response.class);
  }

  /**
   * Convert an instance of GetTemplates422Response to an JSON string
   *
   * @return JSON string
   */
