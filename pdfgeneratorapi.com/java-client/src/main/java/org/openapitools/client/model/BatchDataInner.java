...
public class BatchDataInner {
  ...
  public BatchDataInner() {
  }

  public BatchDataInner data(Data data) {
    this.data = data;
    return this;
  }
  ...
  public BatchDataInner template(Integer template) {
  ...
  public boolean equals(Object o) {
    ...
    BatchDataInner batchDataInner = (BatchDataInner) o;
    return Objects.equals(this.data, batchDataInner.data) &&
        Objects.equals(this.template, batchDataInner.template);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, template);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BatchDataInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to BatchDataInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!BatchDataInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchDataInner is not found in the empty JSON string", BatchDataInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!BatchDataInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BatchDataInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchDataInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchDataInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchDataInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchDataInner.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchDataInner>() {
           @Override
           public void write(JsonWriter out, BatchDataInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public BatchDataInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of BatchDataInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of BatchDataInner
   * @throws IOException if the JSON string is invalid with respect to BatchDataInner
   */
  public static BatchDataInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchDataInner.class);
  }

  /**
   * Convert an instance of BatchDataInner to an JSON string
   *
   * @return JSON string
   */
