...
import org.openapitools.client.model.DeleteTemplate200ResponseResponse;
...
public class DeleteTemplate200Response {
  public static final String SERIALIZED_NAME_RESPONSE = "response";
  @SerializedName(SERIALIZED_NAME_RESPONSE)
  private DeleteTemplate200ResponseResponse response;

  public DeleteTemplate200Response() {
  }

  public DeleteTemplate200Response response(DeleteTemplate200ResponseResponse response) {
  ...
  public DeleteTemplate200ResponseResponse getResponse() {
    return response;
  }

  public void setResponse(DeleteTemplate200ResponseResponse response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteTemplate200Response deleteTemplate200Response = (DeleteTemplate200Response) o;
    return Objects.equals(this.response, deleteTemplate200Response.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteTemplate200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteTemplate200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteTemplate200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteTemplate200Response is not found in the empty JSON string", DeleteTemplate200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteTemplate200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteTemplate200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `response`
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        DeleteTemplate200ResponseResponse.validateJsonElement(jsonObj.get("response"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteTemplate200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteTemplate200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteTemplate200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteTemplate200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteTemplate200Response>() {
           @Override
           public void write(JsonWriter out, DeleteTemplate200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteTemplate200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteTemplate200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteTemplate200Response
   * @throws IOException if the JSON string is invalid with respect to DeleteTemplate200Response
   */
  public static DeleteTemplate200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteTemplate200Response.class);
  }

  /**
   * Convert an instance of DeleteTemplate200Response to an JSON string
   *
   * @return JSON string
   */
