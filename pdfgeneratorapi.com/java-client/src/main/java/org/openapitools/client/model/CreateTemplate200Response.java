...
import org.openapitools.client.model.TemplateDefinition;
...
public class CreateTemplate200Response {
  ...
  private TemplateDefinition response;

  public CreateTemplate200Response() {
  }

  public CreateTemplate200Response response(TemplateDefinition response) {
  ...
  public TemplateDefinition getResponse() {
    return response;
  }

  public void setResponse(TemplateDefinition response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, createTemplate200Response.response);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTemplate200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateTemplate200Response is not found in the empty JSON string", CreateTemplate200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTemplate200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateTemplate200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `response`
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        TemplateDefinition.validateJsonElement(jsonObj.get("response"));
      }
  }
