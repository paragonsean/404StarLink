...
import org.openapitools.client.model.MergeTemplates200ResponseMeta;
...
public class MergeTemplates200Response {
  public static final String SERIALIZED_NAME_META = "meta";
  @SerializedName(SERIALIZED_NAME_META)
  private MergeTemplates200ResponseMeta meta;

  public static final String SERIALIZED_NAME_RESPONSE = "response";
  @SerializedName(SERIALIZED_NAME_RESPONSE)
  private String response;

  public MergeTemplates200Response() {
  }

  public MergeTemplates200Response meta(MergeTemplates200ResponseMeta meta) {
    this.meta = meta;
    return this;
  }
  ...
  public MergeTemplates200ResponseMeta getMeta() {
    return meta;
  }

  public void setMeta(MergeTemplates200ResponseMeta meta) {
    this.meta = meta;
  }


  public MergeTemplates200Response response(String response) {
  ...
  public boolean equals(Object o) {
    ...
    MergeTemplates200Response mergeTemplates200Response = (MergeTemplates200Response) o;
    return Objects.equals(this.meta, mergeTemplates200Response.meta) &&
        Objects.equals(this.response, mergeTemplates200Response.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class MergeTemplates200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MergeTemplates200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MergeTemplates200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeTemplates200Response is not found in the empty JSON string", MergeTemplates200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MergeTemplates200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MergeTemplates200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `meta`
      if (jsonObj.get("meta") != null && !jsonObj.get("meta").isJsonNull()) {
        MergeTemplates200ResponseMeta.validateJsonElement(jsonObj.get("meta"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeTemplates200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeTemplates200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeTemplates200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeTemplates200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeTemplates200Response>() {
           @Override
           public void write(JsonWriter out, MergeTemplates200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MergeTemplates200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MergeTemplates200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MergeTemplates200Response
   * @throws IOException if the JSON string is invalid with respect to MergeTemplates200Response
   */
  public static MergeTemplates200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeTemplates200Response.class);
  }

  /**
   * Convert an instance of MergeTemplates200Response to an JSON string
   *
   * @return JSON string
   */
