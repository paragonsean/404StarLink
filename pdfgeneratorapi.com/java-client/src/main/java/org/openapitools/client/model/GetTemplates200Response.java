...
public class GetTemplates200Response {
  ...
  private List<Template> response = new ArrayList<>();

  public GetTemplates200Response() {
  }

  public GetTemplates200Response response(List<Template> response) {
    this.response = response;
    return this;
  }

  public GetTemplates200Response addResponseItem(Template responseItem) {
  ...
  public List<Template> getResponse() {
    return response;
  }

  public void setResponse(List<Template> response) {
    this.response = response;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, getTemplates200Response.response);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("response") != null && !jsonObj.get("response").isJsonNull()) {
        ...
        if (jsonArrayresponse != null) {
          ...
          for (int i = 0; i < jsonArrayresponse.size(); i++) {
            Template.validateJsonElement(jsonArrayresponse.get(i));
          };
        }
      }
  }
