...
public class TemplateDefinitionEditor {
  ...
  public TemplateDefinitionEditor heightMultiplier(BigDecimal heightMultiplier) {
  ...
  public boolean equals(Object o) {
    ...
    TemplateDefinitionEditor templateDefinitionEditor = (TemplateDefinitionEditor) o;
    return Objects.equals(this.heightMultiplier, templateDefinitionEditor.heightMultiplier);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateDefinitionEditor
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateDefinitionEditor.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateDefinitionEditor is not found in the empty JSON string", TemplateDefinitionEditor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionEditor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionEditor` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateDefinitionEditor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateDefinitionEditor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateDefinitionEditor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateDefinitionEditor.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateDefinitionEditor>() {
           @Override
           public void write(JsonWriter out, TemplateDefinitionEditor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateDefinitionEditor read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateDefinitionEditor given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateDefinitionEditor
   * @throws IOException if the JSON string is invalid with respect to TemplateDefinitionEditor
   */
  public static TemplateDefinitionEditor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateDefinitionEditor.class);
  }

  /**
   * Convert an instance of TemplateDefinitionEditor to an JSON string
   *
   * @return JSON string
   */
