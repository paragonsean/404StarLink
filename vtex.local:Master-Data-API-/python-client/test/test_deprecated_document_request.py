...
class TestDEPRECATEDDocumentRequest(unittest.TestCase):
    """DEPRECATEDDocumentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DEPRECATEDDocumentRequest:
        """Test DEPRECATEDDocumentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DEPRECATEDDocumentRequest`
        """
        model = DEPRECATEDDocumentRequest()
        if include_optional:
            return DEPRECATEDDocumentRequest(
                var_field = ''
            )
        else:
            return DEPRECATEDDocumentRequest(
    ...
    def testDEPRECATEDDocumentRequest(self):
        """Test DEPRECATEDDocumentRequest"""
