...
class TestGetversion(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Getversion:
        """Test Getversion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Getversion`
        """
        model = Getversion()
        if include_optional:
            return Getversion(
                author = '',
                document = {"accountId":"my-account-id","accountName":"my-account","carttag":null,"checkouttag":null,"dataEntityId":"Client","departmentVisitedTag":{"DisplayValue":"Ar e Ventilação","Scores":{"Ar e Ventilação":[{"Date":"2016-10-18T16:53:31.0842607Z","Point":1,"Until":"2017-04-16T16:53:31.0842607Z"}]}},"email":"teste@mail.com","followers":[],"id":"my-id","rclastsession":"163054c0-954f-11e6-891e-4d2b1c3450a4","rclastsessiondate":"2016-10-18T16:53:00"},
                id = ''
            )
        else:
            return Getversion(
