...
class TestCreateUpdateAddressRequests(unittest.TestCase):
    """CreateUpdateAddressRequests unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateUpdateAddressRequests:
        """Test CreateUpdateAddressRequests
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateUpdateAddressRequests`
        """
        model = CreateUpdateAddressRequests()
        if include_optional:
    ...
    def testCreateUpdateAddressRequests(self):
        """Test CreateUpdateAddressRequests"""
