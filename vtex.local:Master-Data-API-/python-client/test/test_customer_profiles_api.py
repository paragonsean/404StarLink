...
class TestCustomerProfilesApi(unittest.TestCase):
    """CustomerProfilesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = CustomerProfilesApi()

    def tearDown(self) -> None:
        pass

    def test_create_new_customer_profilev2(self) -> None:
    ...
    def test_delete_customer_profile(self) -> None:
    ...
    def test_update_customer_profile(self) -> None:
