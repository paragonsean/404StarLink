    ...
    def make_instance(self, include_optional) -> Document:
        ...
        if include_optional:
            return Document(
                ...
                checkouttag = '',
                data_entity_id = '',
                department_visited_tag = {"DisplayValue":"Ar e Ventilação","Scores":{"Ar e Ventilação":[{"Date":"2016-10-18T16:53:31.0842607Z","Point":1,"Until":"2017-04-16T16:53:31.0842607Z"}]}},
                email = '',
                followers = [
                    ''
                    ],
