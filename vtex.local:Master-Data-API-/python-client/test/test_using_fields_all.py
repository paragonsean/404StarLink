...
class TestUsingFieldsAll(unittest.TestCase):
    """UsingFieldsAll unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsingFieldsAll:
        """Test UsingFieldsAll
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsingFieldsAll`
        """
        model = UsingFieldsAll()
        if include_optional:
