...
class TestPutindicesRequest(unittest.TestCase):
    """PutindicesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutindicesRequest:
        """Test PutindicesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutindicesRequest`
        """
        model = PutindicesRequest()
        if include_optional:
            return PutindicesRequest(
                fields = '',
                multiple = True,
                name = ''
            )
    ...
    def testPutindicesRequest(self):
        """Test PutindicesRequest"""
