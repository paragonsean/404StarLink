...
class AddressesApi:
    ...
    def create_new_customer_address(
        ...
        create_update_address_requests: CreateUpdateAddressRequests,
        ...
        :type accept: str
        :param create_update_address_requests: (required)
        :type create_update_address_requests: CreateUpdateAddressRequests
        ...
        _param = self._create_new_customer_address_serialize(
            content_type=content_type,
            accept=accept,
            create_update_address_requests=create_update_address_requests,
    ...
    @validate_call
    def create_new_customer_address_with_http_info(
        self,
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        create_update_address_requests: CreateUpdateAddressRequests,
    ...
    @validate_call
    def create_new_customer_address_without_preload_content(
        self,
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        create_update_address_requests: CreateUpdateAddressRequests,
    ...
    def _create_new_customer_address_serialize(
        self,
        content_type,
        accept,
        create_update_address_requests,
        var_schema,
        _request_auth,
        _content_type,
        _headers,
        ...
        if create_update_address_requests is not None:
            _body_params = create_update_address_requests
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/dataentities/Address/documents',
    ...
    def _delete_customer_address_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/dataentities/Address/documents/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_customer_address(
        ...
        _param = self._update_customer_address_serialize(
            content_type=content_type,
            accept=accept,
            id=id,
            create_update_address_requests=create_update_address_requests,
    ...
    @validate_call
    def update_customer_address_with_http_info(
        self,
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        id: Annotated[StrictStr, Field(description="ID of the Document.")],
    ...
    @validate_call
    def update_customer_address_without_preload_content(
        self,
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        id: Annotated[StrictStr, Field(description="ID of the Document.")],
    ...
    def _update_customer_address_serialize(
        self,
        content_type,
        accept,
        id,
