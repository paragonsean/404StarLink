...
class DocumentResponse(BaseModel):
    ...
    DocumentResponse
    """ # noqa: E501
    href: StrictStr = Field(description="Document reference URL.", alias="Href")
    id: StrictStr = Field(description="ID of the document that was created or updated.", alias="Id")
