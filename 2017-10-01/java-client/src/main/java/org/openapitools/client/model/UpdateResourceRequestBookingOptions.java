...
public class UpdateResourceRequestBookingOptions {
  ...
  public UpdateResourceRequestBookingOptions() {
  }

  public UpdateResourceRequestBookingOptions autoAcceptRequests(Boolean autoAcceptRequests) {
  ...
  public UpdateResourceRequestBookingOptions autoDeclineRecurringRequests(Boolean autoDeclineRecurringRequests) {
  ...
  public UpdateResourceRequestBookingOptions autoDeclineConflictingRequests(Boolean autoDeclineConflictingRequests) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateResourceRequestBookingOptions updateResourceRequestBookingOptions = (UpdateResourceRequestBookingOptions) o;
    return Objects.equals(this.autoAcceptRequests, updateResourceRequestBookingOptions.autoAcceptRequests) &&
        Objects.equals(this.autoDeclineRecurringRequests, updateResourceRequestBookingOptions.autoDeclineRecurringRequests) &&
        Objects.equals(this.autoDeclineConflictingRequests, updateResourceRequestBookingOptions.autoDeclineConflictingRequests);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateResourceRequestBookingOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateResourceRequestBookingOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateResourceRequestBookingOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateResourceRequestBookingOptions is not found in the empty JSON string", UpdateResourceRequestBookingOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateResourceRequestBookingOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateResourceRequestBookingOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateResourceRequestBookingOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateResourceRequestBookingOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateResourceRequestBookingOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateResourceRequestBookingOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateResourceRequestBookingOptions>() {
           @Override
           public void write(JsonWriter out, UpdateResourceRequestBookingOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateResourceRequestBookingOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateResourceRequestBookingOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateResourceRequestBookingOptions
   * @throws IOException if the JSON string is invalid with respect to UpdateResourceRequestBookingOptions
   */
  public static UpdateResourceRequestBookingOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateResourceRequestBookingOptions.class);
  }

  /**
   * Convert an instance of UpdateResourceRequestBookingOptions to an JSON string
   *
   * @return JSON string
   */
