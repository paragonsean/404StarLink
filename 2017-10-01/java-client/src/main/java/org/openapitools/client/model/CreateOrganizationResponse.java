...
public class CreateOrganizationResponse {
  ...
  public CreateOrganizationResponse organizationId(String organizationId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.organizationId, createOrganizationResponse.organizationId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateOrganizationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateOrganizationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateOrganizationResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateOrganizationResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
