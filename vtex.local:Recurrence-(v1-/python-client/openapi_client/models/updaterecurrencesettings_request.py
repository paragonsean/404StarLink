...
class UpdaterecurrencesettingsRequest(BaseModel):
    ...
    """ # noqa: E501
    default_sla: StrictStr = Field(alias="defaultSLA")
    sales_channel: StrictStr = Field(alias="salesChannel")
    __properties: ClassVar[List[str]] = ["defaultSLA", "salesChannel"]
