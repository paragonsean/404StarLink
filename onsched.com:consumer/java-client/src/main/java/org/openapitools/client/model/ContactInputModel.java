...
public class ContactInputModel {
  ...
  public ContactInputModel businessPhone(String businessPhone) {
  ...
  public ContactInputModel businessPhoneExt(String businessPhoneExt) {
  ...
  public ContactInputModel conferenceInfo(String conferenceInfo) {
  ...
  public ContactInputModel homePhone(String homePhone) {
  ...
  public ContactInputModel mobilePhone(String mobilePhone) {
  ...
  public ContactInputModel preferredPhoneType(String preferredPhoneType) {
  ...
  public ContactInputModel skypeUsername(String skypeUsername) {
  ...
  public boolean equals(Object o) {
    ...
    ContactInputModel contactInputModel = (ContactInputModel) o;
    return Objects.equals(this.businessPhone, contactInputModel.businessPhone) &&
        Objects.equals(this.businessPhoneExt, contactInputModel.businessPhoneExt) &&
        Objects.equals(this.conferenceInfo, contactInputModel.conferenceInfo) &&
        Objects.equals(this.homePhone, contactInputModel.homePhone) &&
        Objects.equals(this.mobilePhone, contactInputModel.mobilePhone) &&
        Objects.equals(this.preferredPhoneType, contactInputModel.preferredPhoneType) &&
        Objects.equals(this.skypeUsername, contactInputModel.skypeUsername);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContactInputModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContactInputModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ContactInputModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ContactInputModel is not found in the empty JSON string", ContactInputModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContactInputModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContactInputModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ContactInputModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ContactInputModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ContactInputModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ContactInputModel.class));

       return (TypeAdapter<T>) new TypeAdapter<ContactInputModel>() {
           @Override
           public void write(JsonWriter out, ContactInputModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ContactInputModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ContactInputModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ContactInputModel
   * @throws IOException if the JSON string is invalid with respect to ContactInputModel
   */
  public static ContactInputModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ContactInputModel.class);
  }

  /**
   * Convert an instance of ContactInputModel to an JSON string
   *
   * @return JSON string
   */
