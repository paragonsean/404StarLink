...
public class CreateCallRequestAnswerUrl {
   ...
   */
  @JsonAdapter(AnswerMethodEnum.Adapter.class)
  public enum AnswerMethodEnum {
    ...
    public static AnswerMethodEnum fromValue(String value) {
      for (AnswerMethodEnum b : AnswerMethodEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<AnswerMethodEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AnswerMethodEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AnswerMethodEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AnswerMethodEnum.fromValue(value);
      }
    }

    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      AnswerMethodEnum.fromValue(value);
    }
  }

  public static final String SERIALIZED_NAME_ANSWER_METHOD = "answer_method";
  @SerializedName(SERIALIZED_NAME_ANSWER_METHOD)
  private AnswerMethodEnum answerMethod = AnswerMethodEnum.GET;

  public static final String SERIALIZED_NAME_ANSWER_URL = "answer_url";
  @SerializedName(SERIALIZED_NAME_ANSWER_URL)
  private List<String> answerUrl = new ArrayList<>();

  public CreateCallRequestAnswerUrl() {
  }

  public CreateCallRequestAnswerUrl eventMethod(EventMethodEnum eventMethod) {
  ...
  public CreateCallRequestAnswerUrl eventUrl(List<URI> eventUrl) {
    this.eventUrl = eventUrl;
    return this;
  }

  public CreateCallRequestAnswerUrl addEventUrlItem(URI eventUrlItem) {
  ...
  public CreateCallRequestAnswerUrl from(EndpointPhoneFrom from) {
    this.from = from;
    return this;
  }
  ...
  public CreateCallRequestAnswerUrl lengthTimer(Integer lengthTimer) {
  ...
  public CreateCallRequestAnswerUrl machineDetection(MachineDetectionEnum machineDetection) {
  ...
  public CreateCallRequestAnswerUrl randomFromNumber(Boolean randomFromNumber) {
  ...
  public CreateCallRequestAnswerUrl ringingTimer(Integer ringingTimer) {
  ...
  public CreateCallRequestAnswerUrl to(List<CreateCallRequestBaseToInner> to) {
    this.to = to;
    return this;
  }

  public CreateCallRequestAnswerUrl addToItem(CreateCallRequestBaseToInner toItem) {
    if (this.to == null) {
  ...
  public CreateCallRequestAnswerUrl answerMethod(AnswerMethodEnum answerMethod) {
  ...
  public CreateCallRequestAnswerUrl answerUrl(List<String> answerUrl) {
    this.answerUrl = answerUrl;
    return this;
  }

  public CreateCallRequestAnswerUrl addAnswerUrlItem(String answerUrlItem) {
    if (this.answerUrl == null) {
      this.answerUrl = new ArrayList<>();
    }
    this.answerUrl.add(answerUrlItem);
    return this;
  }
  ...
  public void setAnswerUrl(List<String> answerUrl) {
    this.answerUrl = answerUrl;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateCallRequestAnswerUrl createCallRequestAnswerUrl = (CreateCallRequestAnswerUrl) o;
    return Objects.equals(this.eventMethod, createCallRequestAnswerUrl.eventMethod) &&
        Objects.equals(this.eventUrl, createCallRequestAnswerUrl.eventUrl) &&
        Objects.equals(this.from, createCallRequestAnswerUrl.from) &&
        Objects.equals(this.lengthTimer, createCallRequestAnswerUrl.lengthTimer) &&
        Objects.equals(this.machineDetection, createCallRequestAnswerUrl.machineDetection) &&
        Objects.equals(this.randomFromNumber, createCallRequestAnswerUrl.randomFromNumber) &&
        Objects.equals(this.ringingTimer, createCallRequestAnswerUrl.ringingTimer) &&
        Objects.equals(this.to, createCallRequestAnswerUrl.to) &&
        Objects.equals(this.answerMethod, createCallRequestAnswerUrl.answerMethod) &&
        Objects.equals(this.answerUrl, createCallRequestAnswerUrl.answerUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventMethod, eventUrl, from, lengthTimer, machineDetection, randomFromNumber, ringingTimer, to, answerMethod, answerUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateCallRequestAnswerUrl {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("answer_url");
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCallRequestAnswerUrl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCallRequestAnswerUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCallRequestAnswerUrl is not found in the empty JSON string", CreateCallRequestAnswerUrl.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCallRequestAnswerUrl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCallRequestAnswerUrl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCallRequestAnswerUrl.openapiRequiredFields) {
      ...
      // validate the optional field `answer_method`
      if (jsonObj.get("answer_method") != null && !jsonObj.get("answer_method").isJsonNull()) {
        AnswerMethodEnum.validateJsonElement(jsonObj.get("answer_method"));
      }
      // ensure the required json array is present
      if (jsonObj.get("answer_url") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("answer_url").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `answer_url` to be an array in the JSON string but got `%s`", jsonObj.get("answer_url").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCallRequestAnswerUrl.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCallRequestAnswerUrl' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCallRequestAnswerUrl> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCallRequestAnswerUrl.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCallRequestAnswerUrl>() {
           @Override
           public void write(JsonWriter out, CreateCallRequestAnswerUrl value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCallRequestAnswerUrl read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCallRequestAnswerUrl given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCallRequestAnswerUrl
   * @throws IOException if the JSON string is invalid with respect to CreateCallRequestAnswerUrl
   */
  public static CreateCallRequestAnswerUrl fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCallRequestAnswerUrl.class);
  }

  /**
   * Convert an instance of CreateCallRequestAnswerUrl to an JSON string
   *
   * @return JSON string
   */
