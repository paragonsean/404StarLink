...
public class CreateCallRequestNcco {
  ...
  public CreateCallRequestNcco() {
  }

  public CreateCallRequestNcco eventMethod(EventMethodEnum eventMethod) {
  ...
  public CreateCallRequestNcco eventUrl(List<URI> eventUrl) {
    this.eventUrl = eventUrl;
    return this;
  }

  public CreateCallRequestNcco addEventUrlItem(URI eventUrlItem) {
  ...
  public CreateCallRequestNcco from(EndpointPhoneFrom from) {
    this.from = from;
    return this;
  }
  ...
  public CreateCallRequestNcco lengthTimer(Integer lengthTimer) {
  ...
  public CreateCallRequestNcco machineDetection(MachineDetectionEnum machineDetection) {
  ...
  public CreateCallRequestNcco randomFromNumber(Boolean randomFromNumber) {
  ...
  public CreateCallRequestNcco ringingTimer(Integer ringingTimer) {
  ...
  public CreateCallRequestNcco to(List<CreateCallRequestBaseToInner> to) {
    this.to = to;
    return this;
  }

  public CreateCallRequestNcco addToItem(CreateCallRequestBaseToInner toItem) {
    if (this.to == null) {
  ...
  public CreateCallRequestNcco ncco(List<Object> ncco) {
    this.ncco = ncco;
    return this;
  }

  public CreateCallRequestNcco addNccoItem(Object nccoItem) {
    if (this.ncco == null) {
  ...
  public boolean equals(Object o) {
    ...
    CreateCallRequestNcco createCallRequestNcco = (CreateCallRequestNcco) o;
    return Objects.equals(this.eventMethod, createCallRequestNcco.eventMethod) &&
        Objects.equals(this.eventUrl, createCallRequestNcco.eventUrl) &&
        Objects.equals(this.from, createCallRequestNcco.from) &&
        Objects.equals(this.lengthTimer, createCallRequestNcco.lengthTimer) &&
        Objects.equals(this.machineDetection, createCallRequestNcco.machineDetection) &&
        Objects.equals(this.randomFromNumber, createCallRequestNcco.randomFromNumber) &&
        Objects.equals(this.ringingTimer, createCallRequestNcco.ringingTimer) &&
        Objects.equals(this.to, createCallRequestNcco.to) &&
        Objects.equals(this.ncco, createCallRequestNcco.ncco);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventMethod, eventUrl, from, lengthTimer, machineDetection, randomFromNumber, ringingTimer, to, ncco);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateCallRequestNcco {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateCallRequestNcco
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCallRequestNcco.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateCallRequestNcco is not found in the empty JSON string", CreateCallRequestNcco.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCallRequestNcco.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateCallRequestNcco` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateCallRequestNcco.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateCallRequestNcco.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateCallRequestNcco' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateCallRequestNcco> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateCallRequestNcco.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateCallRequestNcco>() {
           @Override
           public void write(JsonWriter out, CreateCallRequestNcco value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateCallRequestNcco read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateCallRequestNcco given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateCallRequestNcco
   * @throws IOException if the JSON string is invalid with respect to CreateCallRequestNcco
   */
  public static CreateCallRequestNcco fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateCallRequestNcco.class);
  }

  /**
   * Convert an instance of CreateCallRequestNcco to an JSON string
   *
   * @return JSON string
   */
