...
public class CreateConnectionRequestAuthParameters {
  ...
  public CreateConnectionRequestAuthParameters() {
  }

  public CreateConnectionRequestAuthParameters basicAuthParameters(CreateConnectionAuthRequestParametersBasicAuthParameters basicAuthParameters) {
  ...
  public CreateConnectionRequestAuthParameters oauthParameters(CreateConnectionAuthRequestParametersOAuthParameters oauthParameters) {
  ...
  public CreateConnectionRequestAuthParameters apiKeyAuthParameters(CreateConnectionAuthRequestParametersApiKeyAuthParameters apiKeyAuthParameters) {
  ...
  public CreateConnectionRequestAuthParameters invocationHttpParameters(CreateConnectionAuthRequestParametersInvocationHttpParameters invocationHttpParameters) {
  ...
  public boolean equals(Object o) {
    ...
    CreateConnectionRequestAuthParameters createConnectionRequestAuthParameters = (CreateConnectionRequestAuthParameters) o;
    return Objects.equals(this.basicAuthParameters, createConnectionRequestAuthParameters.basicAuthParameters) &&
        Objects.equals(this.oauthParameters, createConnectionRequestAuthParameters.oauthParameters) &&
        Objects.equals(this.apiKeyAuthParameters, createConnectionRequestAuthParameters.apiKeyAuthParameters) &&
        Objects.equals(this.invocationHttpParameters, createConnectionRequestAuthParameters.invocationHttpParameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateConnectionRequestAuthParameters {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateConnectionRequestAuthParameters
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateConnectionRequestAuthParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateConnectionRequestAuthParameters is not found in the empty JSON string", CreateConnectionRequestAuthParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateConnectionRequestAuthParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateConnectionRequestAuthParameters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateConnectionRequestAuthParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateConnectionRequestAuthParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateConnectionRequestAuthParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateConnectionRequestAuthParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateConnectionRequestAuthParameters>() {
           @Override
           public void write(JsonWriter out, CreateConnectionRequestAuthParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateConnectionRequestAuthParameters read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateConnectionRequestAuthParameters given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateConnectionRequestAuthParameters
   * @throws IOException if the JSON string is invalid with respect to CreateConnectionRequestAuthParameters
   */
  public static CreateConnectionRequestAuthParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateConnectionRequestAuthParameters.class);
  }

  /**
   * Convert an instance of CreateConnectionRequestAuthParameters to an JSON string
   *
   * @return JSON string
   */
