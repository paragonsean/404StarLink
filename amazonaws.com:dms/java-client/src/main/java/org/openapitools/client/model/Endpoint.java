...
public class Endpoint {
  ...
  public Endpoint endpointIdentifier(String endpointIdentifier) {
  ...
  public Endpoint endpointType(ReplicationEndpointTypeValue endpointType) {
  ...
  public Endpoint engineName(String engineName) {
  ...
  public Endpoint engineDisplayName(String engineDisplayName) {
  ...
  public Endpoint username(String username) {
  ...
  public Endpoint serverName(String serverName) {
  ...
  public Endpoint databaseName(String databaseName) {
  ...
  public Endpoint extraConnectionAttributes(String extraConnectionAttributes) {
  ...
  public Endpoint kmsKeyId(String kmsKeyId) {
  ...
  public Endpoint certificateArn(String certificateArn) {
  ...
  public Endpoint sslMode(DmsSslModeValue sslMode) {
  ...
  public Endpoint serviceAccessRoleArn(String serviceAccessRoleArn) {
  ...
  public Endpoint externalTableDefinition(String externalTableDefinition) {
  ...
  public Endpoint externalId(String externalId) {
  ...
  public Endpoint dynamoDbSettings(EndpointDynamoDbSettings dynamoDbSettings) {
  ...
  public Endpoint s3Settings(EndpointS3Settings s3Settings) {
  ...
  public Endpoint dmsTransferSettings(EndpointDmsTransferSettings dmsTransferSettings) {
  ...
  public Endpoint mongoDbSettings(EndpointMongoDbSettings mongoDbSettings) {
  ...
  public Endpoint kinesisSettings(EndpointKinesisSettings kinesisSettings) {
  ...
  public Endpoint kafkaSettings(EndpointKafkaSettings kafkaSettings) {
  ...
  public Endpoint elasticsearchSettings(EndpointElasticsearchSettings elasticsearchSettings) {
  ...
  public Endpoint neptuneSettings(EndpointNeptuneSettings neptuneSettings) {
  ...
  public Endpoint redshiftSettings(EndpointRedshiftSettings redshiftSettings) {
  ...
  public Endpoint postgreSQLSettings(EndpointPostgreSQLSettings postgreSQLSettings) {
  ...
  public Endpoint mySQLSettings(EndpointMySQLSettings mySQLSettings) {
  ...
  public Endpoint oracleSettings(EndpointOracleSettings oracleSettings) {
  ...
  public Endpoint sybaseSettings(EndpointSybaseSettings sybaseSettings) {
  ...
  public Endpoint microsoftSQLServerSettings(EndpointMicrosoftSQLServerSettings microsoftSQLServerSettings) {
  ...
  public Endpoint ibMDb2Settings(EndpointIBMDb2Settings ibMDb2Settings) {
  ...
  public Endpoint docDbSettings(DocDbSettings docDbSettings) {
  ...
  public Endpoint redisSettings(EndpointRedisSettings redisSettings) {
  ...
  public Endpoint gcpMySQLSettings(CreateEndpointMessageGcpMySQLSettings gcpMySQLSettings) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endpointIdentifier, endpoint.endpointIdentifier) &&
        Objects.equals(this.endpointType, endpoint.endpointType) &&
        Objects.equals(this.engineName, endpoint.engineName) &&
        Objects.equals(this.engineDisplayName, endpoint.engineDisplayName) &&
        Objects.equals(this.username, endpoint.username) &&
        Objects.equals(this.serverName, endpoint.serverName) &&
        Objects.equals(this.port, endpoint.port) &&
        Objects.equals(this.databaseName, endpoint.databaseName) &&
        Objects.equals(this.extraConnectionAttributes, endpoint.extraConnectionAttributes) &&
        Objects.equals(this.status, endpoint.status) &&
        Objects.equals(this.kmsKeyId, endpoint.kmsKeyId) &&
        Objects.equals(this.endpointArn, endpoint.endpointArn) &&
        Objects.equals(this.certificateArn, endpoint.certificateArn) &&
        Objects.equals(this.sslMode, endpoint.sslMode) &&
        Objects.equals(this.serviceAccessRoleArn, endpoint.serviceAccessRoleArn) &&
        Objects.equals(this.externalTableDefinition, endpoint.externalTableDefinition) &&
        Objects.equals(this.externalId, endpoint.externalId) &&
        Objects.equals(this.dynamoDbSettings, endpoint.dynamoDbSettings) &&
        Objects.equals(this.s3Settings, endpoint.s3Settings) &&
        Objects.equals(this.dmsTransferSettings, endpoint.dmsTransferSettings) &&
        Objects.equals(this.mongoDbSettings, endpoint.mongoDbSettings) &&
        Objects.equals(this.kinesisSettings, endpoint.kinesisSettings) &&
        Objects.equals(this.kafkaSettings, endpoint.kafkaSettings) &&
        Objects.equals(this.elasticsearchSettings, endpoint.elasticsearchSettings) &&
        Objects.equals(this.neptuneSettings, endpoint.neptuneSettings) &&
        Objects.equals(this.redshiftSettings, endpoint.redshiftSettings) &&
        Objects.equals(this.postgreSQLSettings, endpoint.postgreSQLSettings) &&
        Objects.equals(this.mySQLSettings, endpoint.mySQLSettings) &&
        Objects.equals(this.oracleSettings, endpoint.oracleSettings) &&
        Objects.equals(this.sybaseSettings, endpoint.sybaseSettings) &&
        Objects.equals(this.microsoftSQLServerSettings, endpoint.microsoftSQLServerSettings) &&
        Objects.equals(this.ibMDb2Settings, endpoint.ibMDb2Settings) &&
        Objects.equals(this.docDbSettings, endpoint.docDbSettings) &&
        Objects.equals(this.redisSettings, endpoint.redisSettings) &&
        Objects.equals(this.gcpMySQLSettings, endpoint.gcpMySQLSettings);
  }
