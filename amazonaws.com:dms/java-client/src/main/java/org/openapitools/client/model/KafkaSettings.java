...
public class KafkaSettings {
  ...
  public KafkaSettings broker(String broker) {
    this.broker = broker;
    return this;
  }
  ...
  public KafkaSettings topic(String topic) {
    this.topic = topic;
    return this;
  }
  ...
  public KafkaSettings messageFormat(MessageFormatValue messageFormat) {
  ...
  public KafkaSettings includeTransactionDetails(Boolean includeTransactionDetails) {
  ...
  public KafkaSettings includePartitionValue(Boolean includePartitionValue) {
  ...
  public KafkaSettings partitionIncludeSchemaTable(Boolean partitionIncludeSchemaTable) {
  ...
  public KafkaSettings includeTableAlterOperations(Boolean includeTableAlterOperations) {
  ...
  public KafkaSettings includeControlDetails(Boolean includeControlDetails) {
  ...
  public KafkaSettings messageMaxBytes(Integer messageMaxBytes) {
  ...
  public KafkaSettings includeNullAndEmpty(Boolean includeNullAndEmpty) {
  ...
  public KafkaSettings securityProtocol(KafkaSecurityProtocol securityProtocol) {
  ...
  public KafkaSettings sslClientCertificateArn(String sslClientCertificateArn) {
  ...
  public KafkaSettings sslClientKeyArn(String sslClientKeyArn) {
  ...
  public KafkaSettings sslClientKeyPassword(String sslClientKeyPassword) {
  ...
  public KafkaSettings sslCaCertificateArn(String sslCaCertificateArn) {
  ...
  public KafkaSettings saslUsername(String saslUsername) {
  ...
  public KafkaSettings saslPassword(String saslPassword) {
  ...
  public KafkaSettings noHexPrefix(Boolean noHexPrefix) {
  ...
  public KafkaSettings saslMechanism(KafkaSaslMechanism saslMechanism) {
  ...
  public boolean equals(Object o) {
    ...
    KafkaSettings kafkaSettings = (KafkaSettings) o;
    return Objects.equals(this.broker, kafkaSettings.broker) &&
        Objects.equals(this.topic, kafkaSettings.topic) &&
        Objects.equals(this.messageFormat, kafkaSettings.messageFormat) &&
        Objects.equals(this.includeTransactionDetails, kafkaSettings.includeTransactionDetails) &&
        Objects.equals(this.includePartitionValue, kafkaSettings.includePartitionValue) &&
        Objects.equals(this.partitionIncludeSchemaTable, kafkaSettings.partitionIncludeSchemaTable) &&
        Objects.equals(this.includeTableAlterOperations, kafkaSettings.includeTableAlterOperations) &&
        Objects.equals(this.includeControlDetails, kafkaSettings.includeControlDetails) &&
        Objects.equals(this.messageMaxBytes, kafkaSettings.messageMaxBytes) &&
        Objects.equals(this.includeNullAndEmpty, kafkaSettings.includeNullAndEmpty) &&
        Objects.equals(this.securityProtocol, kafkaSettings.securityProtocol) &&
        Objects.equals(this.sslClientCertificateArn, kafkaSettings.sslClientCertificateArn) &&
        Objects.equals(this.sslClientKeyArn, kafkaSettings.sslClientKeyArn) &&
        Objects.equals(this.sslClientKeyPassword, kafkaSettings.sslClientKeyPassword) &&
        Objects.equals(this.sslCaCertificateArn, kafkaSettings.sslCaCertificateArn) &&
        Objects.equals(this.saslUsername, kafkaSettings.saslUsername) &&
        Objects.equals(this.saslPassword, kafkaSettings.saslPassword) &&
        Objects.equals(this.noHexPrefix, kafkaSettings.noHexPrefix) &&
        Objects.equals(this.saslMechanism, kafkaSettings.saslMechanism);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to KafkaSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KafkaSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KafkaSettings is not found in the empty JSON string", KafkaSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KafkaSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `KafkaSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KafkaSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KafkaSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KafkaSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KafkaSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<KafkaSettings>() {
           @Override
           public void write(JsonWriter out, KafkaSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public KafkaSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of KafkaSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of KafkaSettings
   * @throws IOException if the JSON string is invalid with respect to KafkaSettings
   */
  public static KafkaSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KafkaSettings.class);
  }

  /**
   * Convert an instance of KafkaSettings to an JSON string
   *
   * @return JSON string
   */
