...
public class DeleteCertificateResponseCertificate {
  ...
  public DeleteCertificateResponseCertificate() {
  }

  public DeleteCertificateResponseCertificate certificateIdentifier(String certificateIdentifier) {
  ...
  public DeleteCertificateResponseCertificate certificateCreationDate(OffsetDateTime certificateCreationDate) {
  ...
  public DeleteCertificateResponseCertificate certificatePem(String certificatePem) {
  ...
  public DeleteCertificateResponseCertificate certificateWallet(String certificateWallet) {
  ...
  public DeleteCertificateResponseCertificate certificateArn(String certificateArn) {
  ...
  public DeleteCertificateResponseCertificate certificateOwner(String certificateOwner) {
  ...
  public DeleteCertificateResponseCertificate validFromDate(OffsetDateTime validFromDate) {
  ...
  public DeleteCertificateResponseCertificate validToDate(OffsetDateTime validToDate) {
  ...
  public DeleteCertificateResponseCertificate signingAlgorithm(String signingAlgorithm) {
  ...
  public DeleteCertificateResponseCertificate keyLength(Integer keyLength) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteCertificateResponseCertificate deleteCertificateResponseCertificate = (DeleteCertificateResponseCertificate) o;
    return Objects.equals(this.certificateIdentifier, deleteCertificateResponseCertificate.certificateIdentifier) &&
        Objects.equals(this.certificateCreationDate, deleteCertificateResponseCertificate.certificateCreationDate) &&
        Objects.equals(this.certificatePem, deleteCertificateResponseCertificate.certificatePem) &&
        Objects.equals(this.certificateWallet, deleteCertificateResponseCertificate.certificateWallet) &&
        Objects.equals(this.certificateArn, deleteCertificateResponseCertificate.certificateArn) &&
        Objects.equals(this.certificateOwner, deleteCertificateResponseCertificate.certificateOwner) &&
        Objects.equals(this.validFromDate, deleteCertificateResponseCertificate.validFromDate) &&
        Objects.equals(this.validToDate, deleteCertificateResponseCertificate.validToDate) &&
        Objects.equals(this.signingAlgorithm, deleteCertificateResponseCertificate.signingAlgorithm) &&
        Objects.equals(this.keyLength, deleteCertificateResponseCertificate.keyLength);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteCertificateResponseCertificate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteCertificateResponseCertificate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteCertificateResponseCertificate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteCertificateResponseCertificate is not found in the empty JSON string", DeleteCertificateResponseCertificate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteCertificateResponseCertificate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteCertificateResponseCertificate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteCertificateResponseCertificate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteCertificateResponseCertificate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteCertificateResponseCertificate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteCertificateResponseCertificate.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteCertificateResponseCertificate>() {
           @Override
           public void write(JsonWriter out, DeleteCertificateResponseCertificate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteCertificateResponseCertificate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteCertificateResponseCertificate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteCertificateResponseCertificate
   * @throws IOException if the JSON string is invalid with respect to DeleteCertificateResponseCertificate
   */
  public static DeleteCertificateResponseCertificate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteCertificateResponseCertificate.class);
  }

  /**
   * Convert an instance of DeleteCertificateResponseCertificate to an JSON string
   *
   * @return JSON string
   */
