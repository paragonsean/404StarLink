...
public class DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun() {
  }

  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun replicationTaskAssessmentRunArn(String replicationTaskAssessmentRunArn) {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun replicationTaskArn(String replicationTaskArn) {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun status(String status) {
    this.status = status;
    return this;
  }
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun replicationTaskAssessmentRunCreationDate(OffsetDateTime replicationTaskAssessmentRunCreationDate) {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun assessmentProgress(ReplicationTaskAssessmentRunAssessmentProgress assessmentProgress) {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun lastFailureMessage(String lastFailureMessage) {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun serviceAccessRoleArn(String serviceAccessRoleArn) {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun resultLocationBucket(String resultLocationBucket) {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun resultLocationFolder(String resultLocationFolder) {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun resultEncryptionMode(String resultEncryptionMode) {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun resultKmsKeyArn(String resultKmsKeyArn) {
  ...
  public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun assessmentRunName(String assessmentRunName) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun = (DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun) o;
    return Objects.equals(this.replicationTaskAssessmentRunArn, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.replicationTaskAssessmentRunArn) &&
        Objects.equals(this.replicationTaskArn, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.replicationTaskArn) &&
        Objects.equals(this.status, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.status) &&
        Objects.equals(this.replicationTaskAssessmentRunCreationDate, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.replicationTaskAssessmentRunCreationDate) &&
        Objects.equals(this.assessmentProgress, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.assessmentProgress) &&
        Objects.equals(this.lastFailureMessage, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.lastFailureMessage) &&
        Objects.equals(this.serviceAccessRoleArn, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.serviceAccessRoleArn) &&
        Objects.equals(this.resultLocationBucket, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.resultLocationBucket) &&
        Objects.equals(this.resultLocationFolder, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.resultLocationFolder) &&
        Objects.equals(this.resultEncryptionMode, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.resultEncryptionMode) &&
        Objects.equals(this.resultKmsKeyArn, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.resultKmsKeyArn) &&
        Objects.equals(this.assessmentRunName, deleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.assessmentRunName);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun is not found in the empty JSON string", DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun>() {
           @Override
           public void write(JsonWriter out, DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun
   * @throws IOException if the JSON string is invalid with respect to DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun
   */
  public static DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun.class);
  }

  /**
   * Convert an instance of DeleteReplicationTaskAssessmentRunResponseReplicationTaskAssessmentRun to an JSON string
   *
   * @return JSON string
   */
