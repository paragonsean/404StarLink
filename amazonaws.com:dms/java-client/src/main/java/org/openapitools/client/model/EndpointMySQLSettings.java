...
public class EndpointMySQLSettings {
  ...
  public EndpointMySQLSettings() {
  }

  public EndpointMySQLSettings afterConnectScript(String afterConnectScript) {
  ...
  public EndpointMySQLSettings cleanSourceMetadataOnMismatch(Boolean cleanSourceMetadataOnMismatch) {
  ...
  public EndpointMySQLSettings databaseName(String databaseName) {
  ...
  public EndpointMySQLSettings eventsPollInterval(Integer eventsPollInterval) {
  ...
  public EndpointMySQLSettings targetDbType(TargetDbType targetDbType) {
  ...
  public EndpointMySQLSettings maxFileSize(Integer maxFileSize) {
  ...
  public EndpointMySQLSettings parallelLoadThreads(Integer parallelLoadThreads) {
  ...
  public EndpointMySQLSettings password(String password) {
  ...
  public EndpointMySQLSettings port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public EndpointMySQLSettings serverName(String serverName) {
  ...
  public EndpointMySQLSettings serverTimezone(String serverTimezone) {
  ...
  public EndpointMySQLSettings username(String username) {
  ...
  public EndpointMySQLSettings secretsManagerAccessRoleArn(String secretsManagerAccessRoleArn) {
  ...
  public EndpointMySQLSettings secretsManagerSecretId(String secretsManagerSecretId) {
  ...
  public boolean equals(Object o) {
    ...
    EndpointMySQLSettings endpointMySQLSettings = (EndpointMySQLSettings) o;
    return Objects.equals(this.afterConnectScript, endpointMySQLSettings.afterConnectScript) &&
        Objects.equals(this.cleanSourceMetadataOnMismatch, endpointMySQLSettings.cleanSourceMetadataOnMismatch) &&
        Objects.equals(this.databaseName, endpointMySQLSettings.databaseName) &&
        Objects.equals(this.eventsPollInterval, endpointMySQLSettings.eventsPollInterval) &&
        Objects.equals(this.targetDbType, endpointMySQLSettings.targetDbType) &&
        Objects.equals(this.maxFileSize, endpointMySQLSettings.maxFileSize) &&
        Objects.equals(this.parallelLoadThreads, endpointMySQLSettings.parallelLoadThreads) &&
        Objects.equals(this.password, endpointMySQLSettings.password) &&
        Objects.equals(this.port, endpointMySQLSettings.port) &&
        Objects.equals(this.serverName, endpointMySQLSettings.serverName) &&
        Objects.equals(this.serverTimezone, endpointMySQLSettings.serverTimezone) &&
        Objects.equals(this.username, endpointMySQLSettings.username) &&
        Objects.equals(this.secretsManagerAccessRoleArn, endpointMySQLSettings.secretsManagerAccessRoleArn) &&
        Objects.equals(this.secretsManagerSecretId, endpointMySQLSettings.secretsManagerSecretId);
  }
  ...
  public String toString() {
    ...
    sb.append("class EndpointMySQLSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EndpointMySQLSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointMySQLSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointMySQLSettings is not found in the empty JSON string", EndpointMySQLSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EndpointMySQLSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointMySQLSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointMySQLSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointMySQLSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointMySQLSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointMySQLSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointMySQLSettings>() {
           @Override
           public void write(JsonWriter out, EndpointMySQLSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EndpointMySQLSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EndpointMySQLSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EndpointMySQLSettings
   * @throws IOException if the JSON string is invalid with respect to EndpointMySQLSettings
   */
  public static EndpointMySQLSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointMySQLSettings.class);
  }

  /**
   * Convert an instance of EndpointMySQLSettings to an JSON string
   *
   * @return JSON string
   */
