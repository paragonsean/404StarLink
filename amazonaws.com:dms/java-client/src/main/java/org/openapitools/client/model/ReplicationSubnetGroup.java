...
public class ReplicationSubnetGroup {
  ...
  public ReplicationSubnetGroup replicationSubnetGroupIdentifier(String replicationSubnetGroupIdentifier) {
  ...
  public ReplicationSubnetGroup replicationSubnetGroupDescription(String replicationSubnetGroupDescription) {
  ...
  public ReplicationSubnetGroup vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public ReplicationSubnetGroup subnetGroupStatus(String subnetGroupStatus) {
  ...
  public ReplicationSubnetGroup subnets(List subnets) {
  ...
  public ReplicationSubnetGroup supportedNetworkTypes(List supportedNetworkTypes) {
  ...
  public boolean equals(Object o) {
    ...
    ReplicationSubnetGroup replicationSubnetGroup = (ReplicationSubnetGroup) o;
    return Objects.equals(this.replicationSubnetGroupIdentifier, replicationSubnetGroup.replicationSubnetGroupIdentifier) &&
        Objects.equals(this.replicationSubnetGroupDescription, replicationSubnetGroup.replicationSubnetGroupDescription) &&
        Objects.equals(this.vpcId, replicationSubnetGroup.vpcId) &&
        Objects.equals(this.subnetGroupStatus, replicationSubnetGroup.subnetGroupStatus) &&
        Objects.equals(this.subnets, replicationSubnetGroup.subnets) &&
        Objects.equals(this.supportedNetworkTypes, replicationSubnetGroup.supportedNetworkTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReplicationSubnetGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplicationSubnetGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplicationSubnetGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplicationSubnetGroup is not found in the empty JSON string", ReplicationSubnetGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplicationSubnetGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplicationSubnetGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplicationSubnetGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplicationSubnetGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplicationSubnetGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplicationSubnetGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplicationSubnetGroup>() {
           @Override
           public void write(JsonWriter out, ReplicationSubnetGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplicationSubnetGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplicationSubnetGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplicationSubnetGroup
   * @throws IOException if the JSON string is invalid with respect to ReplicationSubnetGroup
   */
  public static ReplicationSubnetGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplicationSubnetGroup.class);
  }

  /**
   * Convert an instance of ReplicationSubnetGroup to an JSON string
   *
   * @return JSON string
   */
