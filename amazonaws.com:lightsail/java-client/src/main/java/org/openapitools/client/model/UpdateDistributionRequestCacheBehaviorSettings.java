...
public class UpdateDistributionRequestCacheBehaviorSettings {
  ...
  public UpdateDistributionRequestCacheBehaviorSettings() {
  }

  public UpdateDistributionRequestCacheBehaviorSettings defaultTTL(Integer defaultTTL) {
  ...
  public UpdateDistributionRequestCacheBehaviorSettings minimumTTL(Integer minimumTTL) {
  ...
  public UpdateDistributionRequestCacheBehaviorSettings maximumTTL(Integer maximumTTL) {
  ...
  public UpdateDistributionRequestCacheBehaviorSettings allowedHTTPMethods(String allowedHTTPMethods) {
  ...
  public UpdateDistributionRequestCacheBehaviorSettings cachedHTTPMethods(String cachedHTTPMethods) {
  ...
  public UpdateDistributionRequestCacheBehaviorSettings forwardedCookies(CacheSettingsForwardedCookies forwardedCookies) {
  ...
  public UpdateDistributionRequestCacheBehaviorSettings forwardedHeaders(CacheSettingsForwardedHeaders forwardedHeaders) {
  ...
  public UpdateDistributionRequestCacheBehaviorSettings forwardedQueryStrings(CacheSettingsForwardedQueryStrings forwardedQueryStrings) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateDistributionRequestCacheBehaviorSettings updateDistributionRequestCacheBehaviorSettings = (UpdateDistributionRequestCacheBehaviorSettings) o;
    return Objects.equals(this.defaultTTL, updateDistributionRequestCacheBehaviorSettings.defaultTTL) &&
        Objects.equals(this.minimumTTL, updateDistributionRequestCacheBehaviorSettings.minimumTTL) &&
        Objects.equals(this.maximumTTL, updateDistributionRequestCacheBehaviorSettings.maximumTTL) &&
        Objects.equals(this.allowedHTTPMethods, updateDistributionRequestCacheBehaviorSettings.allowedHTTPMethods) &&
        Objects.equals(this.cachedHTTPMethods, updateDistributionRequestCacheBehaviorSettings.cachedHTTPMethods) &&
        Objects.equals(this.forwardedCookies, updateDistributionRequestCacheBehaviorSettings.forwardedCookies) &&
        Objects.equals(this.forwardedHeaders, updateDistributionRequestCacheBehaviorSettings.forwardedHeaders) &&
        Objects.equals(this.forwardedQueryStrings, updateDistributionRequestCacheBehaviorSettings.forwardedQueryStrings);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateDistributionRequestCacheBehaviorSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDistributionRequestCacheBehaviorSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDistributionRequestCacheBehaviorSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateDistributionRequestCacheBehaviorSettings is not found in the empty JSON string", UpdateDistributionRequestCacheBehaviorSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDistributionRequestCacheBehaviorSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateDistributionRequestCacheBehaviorSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDistributionRequestCacheBehaviorSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDistributionRequestCacheBehaviorSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDistributionRequestCacheBehaviorSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDistributionRequestCacheBehaviorSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDistributionRequestCacheBehaviorSettings>() {
           @Override
           public void write(JsonWriter out, UpdateDistributionRequestCacheBehaviorSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDistributionRequestCacheBehaviorSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDistributionRequestCacheBehaviorSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDistributionRequestCacheBehaviorSettings
   * @throws IOException if the JSON string is invalid with respect to UpdateDistributionRequestCacheBehaviorSettings
   */
  public static UpdateDistributionRequestCacheBehaviorSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDistributionRequestCacheBehaviorSettings.class);
  }

  /**
   * Convert an instance of UpdateDistributionRequestCacheBehaviorSettings to an JSON string
   *
   * @return JSON string
   */
