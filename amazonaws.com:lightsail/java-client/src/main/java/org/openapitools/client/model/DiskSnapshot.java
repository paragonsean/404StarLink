...
public class DiskSnapshot {
  ...
  public DiskSnapshot arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public DiskSnapshot supportCode(String supportCode) {
  ...
  public DiskSnapshot createdAt(OffsetDateTime createdAt) {
  ...
  public DiskSnapshot location(DiskSnapshotLocation location) {
  ...
  public DiskSnapshot resourceType(ResourceType resourceType) {
  ...
  public DiskSnapshot tags(List tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DiskSnapshot sizeInGb(Integer sizeInGb) {
  ...
  public DiskSnapshot state(DiskSnapshotState state) {
    this.state = state;
    return this;
  }
  ...
  public DiskSnapshot progress(String progress) {
  ...
  public DiskSnapshot fromDiskName(String fromDiskName) {
  ...
  public DiskSnapshot fromDiskArn(String fromDiskArn) {
  ...
  public DiskSnapshot fromInstanceName(String fromInstanceName) {
  ...
  public DiskSnapshot fromInstanceArn(String fromInstanceArn) {
  ...
  public DiskSnapshot isFromAutoSnapshot(Boolean isFromAutoSnapshot) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, diskSnapshot.name) &&
        Objects.equals(this.arn, diskSnapshot.arn) &&
        Objects.equals(this.supportCode, diskSnapshot.supportCode) &&
        Objects.equals(this.createdAt, diskSnapshot.createdAt) &&
        Objects.equals(this.location, diskSnapshot.location) &&
        Objects.equals(this.resourceType, diskSnapshot.resourceType) &&
        Objects.equals(this.tags, diskSnapshot.tags) &&
        Objects.equals(this.sizeInGb, diskSnapshot.sizeInGb) &&
        Objects.equals(this.state, diskSnapshot.state) &&
        Objects.equals(this.progress, diskSnapshot.progress) &&
        Objects.equals(this.fromDiskName, diskSnapshot.fromDiskName) &&
        Objects.equals(this.fromDiskArn, diskSnapshot.fromDiskArn) &&
        Objects.equals(this.fromInstanceName, diskSnapshot.fromInstanceName) &&
        Objects.equals(this.fromInstanceArn, diskSnapshot.fromInstanceArn) &&
        Objects.equals(this.isFromAutoSnapshot, diskSnapshot.isFromAutoSnapshot);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DiskSnapshot
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DiskSnapshot.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiskSnapshot is not found in the empty JSON string", DiskSnapshot.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DiskSnapshot.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DiskSnapshot` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiskSnapshot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiskSnapshot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiskSnapshot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiskSnapshot.class));

       return (TypeAdapter<T>) new TypeAdapter<DiskSnapshot>() {
           @Override
           public void write(JsonWriter out, DiskSnapshot value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DiskSnapshot read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DiskSnapshot given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DiskSnapshot
   * @throws IOException if the JSON string is invalid with respect to DiskSnapshot
   */
  public static DiskSnapshot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiskSnapshot.class);
  }

  /**
   * Convert an instance of DiskSnapshot to an JSON string
   *
   * @return JSON string
   */
