...
class TestFormRecognitionResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FormRecognitionResult:
        """Test FormRecognitionResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FormRecognitionResult`
        """
        model = FormRecognitionResult()
        if include_optional:
            return FormRecognitionResult(
                best_match_form_setting_name = '',
                diagnostics = [
                    ''
                    ],
                field_value_extraction_result = [
                    openapi_client.models.field_result.FieldResult(
                        field_values = [
                ...
                successful = True,
                table_value_extraction_results = [
                    openapi_client.models.table_result.TableResult(
                        table_definition = openapi_client.models.form_table_definition.FormTableDefinition(
                            column_definitions = [
                        ...
                        table_rows_result = [
                            openapi_client.models.table_row_result.TableRowResult(
