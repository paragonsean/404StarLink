...
class OcrLineElement(BaseModel):
    ...
    """ # noqa: E501
    line_text: Optional[StrictStr] = Field(default=None, description="Text of the line", alias="LineText")
    words: Optional[List[OcrWordElement]] = Field(default=None, description="Word objects in the line", alias="Words")
    __properties: ClassVar[List[str]] = ["LineText", "Words"]
