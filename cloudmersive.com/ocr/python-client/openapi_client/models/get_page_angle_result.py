...
class GetPageAngleResult(BaseModel):
    ...
    """ # noqa: E501
    angle: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Angle of the page in radians; 0 represents perfectly horizontal", alias="Angle")
    ...
    __properties: ClassVar[List[str]] = ["Angle", "Successful"]
