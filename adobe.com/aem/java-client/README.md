...
- API version: 3.7.1-pre.0
  - Build date: 2024-10-11T02:16:19.674905-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:3.7.1-pre.0"
  }
```
...
* `target/openapi-java-client-3.7.1-pre.0.jar`
* `target/lib/*.jar`
