...
class TestVendorProjectPair(unittest.TestCase):
    """VendorProjectPair unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VendorProjectPair:
        """Test VendorProjectPair
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VendorProjectPair`
        """
        model = VendorProjectPair()
        if include_optional:
            return VendorProjectPair(
                currency = 'usd',
                is_proofreader = True,
    ...
    def testVendorProjectPair(self):
        """Test VendorProjectPair"""
