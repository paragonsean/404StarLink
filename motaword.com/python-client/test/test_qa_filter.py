...
class TestQaFilter(unittest.TestCase):
    """QaFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QaFilter:
        """Test QaFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QaFilter`
        """
        model = QaFilter()
        if include_optional:
            return QaFilter(
