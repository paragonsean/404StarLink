...
class TestCallbackResult(unittest.TestCase):
    """CallbackResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallbackResult:
        """Test CallbackResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallbackResult`
        """
        model = CallbackResult()
        if include_optional:
            return CallbackResult(
                data = openapi_client.models.project.Project(
                    average_scores = {
                        'key' : 1.337
                        }, 
                    budget_code = '', 
