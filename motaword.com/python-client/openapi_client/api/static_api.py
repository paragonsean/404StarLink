...
class StaticApi:
    ...
    def get_swagger_yaml(
        ...
        _param = self._get_swagger_yaml_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_swagger_yaml_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_swagger_yaml_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_swagger_yaml_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
