...
class ProjectWordCountAnalysis(BaseModel):
    """
    ProjectWordCountAnalysis
    """ # noqa: E501
    base: Optional[Union[StrictFloat, StrictInt]] = None
    duplicate: Optional[Union[StrictFloat, StrictInt]] = None
    exclusion: Optional[Union[StrictFloat, StrictInt]] = None
    final: Optional[Union[StrictFloat, StrictInt]] = None
    tm: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["base", "duplicate", "exclusion", "final", "tm"]
