...
class SendEmailConfirmation200Response(BaseModel):
    """
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['success', 'already_confirmed']):
            raise ValueError("must be one of enum values ('success', 'already_confirmed')")
        return value
