...
class ClientStrings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["meta", "strings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "strings": [ClientStringWithTranslations.from_dict(_item) for _item in obj["strings"]] if obj.get("strings") is not None else None
        })
        return _obj
