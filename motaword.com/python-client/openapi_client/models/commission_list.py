...
class CommissionList(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["commissions", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "commissions": [Commission.from_dict(_item) for _item in obj["commissions"]] if obj.get("commissions") is not None else None,
