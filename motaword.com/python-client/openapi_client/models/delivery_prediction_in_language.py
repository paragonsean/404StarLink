...
class DeliveryPredictionInLanguage(BaseModel):
    ...
    late: Optional[StrictBool] = Field(default=None, description="true for late, false for on-time delivery")
    probability: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["language", "late", "probability"]
