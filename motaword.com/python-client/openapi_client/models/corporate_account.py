...
class CorporateAccount(BaseModel):
    ...
    web_site: Optional[StrictStr] = Field(default=None, description="Deprecated, use `domain`.")
    __properties: ClassVar[List[str]] = ["billing", "domain", "email", "id", "logo", "name", "web_site"]
