...
class Stats(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["client", "vendor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "client": ClientStats.from_dict(obj["client"]) if obj.get("client") is not None else None,
            "vendor": VendorStats.from_dict(obj["vendor"]) if obj.get("vendor") is not None else None
        })
        return _obj
