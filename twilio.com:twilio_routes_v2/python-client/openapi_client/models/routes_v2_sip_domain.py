...
class RoutesV2SipDomain(BaseModel):
    ...
    RoutesV2SipDomain
    """ # noqa: E501
    account_sid: Optional[Annotated[str, Field(min_length=34, strict=True, max_length=34)]] = None
    date_created: Optional[datetime] = None
    date_updated: Optional[datetime] = None
    friendly_name: Optional[StrictStr] = None
    sid: Optional[Annotated[str, Field(min_length=34, strict=True, max_length=34)]] = None
    sip_domain: Optional[StrictStr] = None
    url: Optional[StrictStr] = None
    voice_region: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["account_sid", "date_created", "date_updated", "friendly_name", "sid", "sip_domain", "url", "voice_region"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sip_domain (nullable) is None
        # and model_fields_set contains the field
        if self.sip_domain is None and "sip_domain" in self.model_fields_set:
            _dict['sip_domain'] = None
