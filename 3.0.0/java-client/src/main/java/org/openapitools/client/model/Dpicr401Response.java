...
public class Dpicr401Response {
  ...
  public Dpicr401Response() {
  }

  public Dpicr401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Dpicr401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Dpicr401Response dpicr401Response = (Dpicr401Response) o;
    return Objects.equals(this.error, dpicr401Response.error) &&
        Objects.equals(this.errorDescription, dpicr401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Dpicr401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Dpicr401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Dpicr401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Dpicr401Response is not found in the empty JSON string", Dpicr401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Dpicr401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dpicr401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Dpicr401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Dpicr401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Dpicr401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Dpicr401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Dpicr401Response>() {
           @Override
           public void write(JsonWriter out, Dpicr401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Dpicr401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Dpicr401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Dpicr401Response
   * @throws IOException if the JSON string is invalid with respect to Dpicr401Response
   */
  public static Dpicr401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Dpicr401Response.class);
  }

  /**
   * Convert an instance of Dpicr401Response to an JSON string
   *
   * @return JSON string
   */
