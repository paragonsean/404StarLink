...
public class Hpcer504Response {
  ...
  public Hpcer504Response() {
  }

  public Hpcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hpcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hpcer504Response hpcer504Response = (Hpcer504Response) o;
    return Objects.equals(this.error, hpcer504Response.error) &&
        Objects.equals(this.errorDescription, hpcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hpcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hpcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hpcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hpcer504Response is not found in the empty JSON string", Hpcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hpcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hpcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hpcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hpcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hpcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hpcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hpcer504Response>() {
           @Override
           public void write(JsonWriter out, Hpcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hpcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hpcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hpcer504Response
   * @throws IOException if the JSON string is invalid with respect to Hpcer504Response
   */
  public static Hpcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hpcer504Response.class);
  }

  /**
   * Convert an instance of Hpcer504Response to an JSON string
   *
   * @return JSON string
   */
