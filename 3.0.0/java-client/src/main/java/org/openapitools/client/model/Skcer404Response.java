...
public class Skcer404Response {
  ...
  public Skcer404Response() {
  }

  public Skcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skcer404Response skcer404Response = (Skcer404Response) o;
    return Objects.equals(this.error, skcer404Response.error) &&
        Objects.equals(this.errorDescription, skcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skcer404Response is not found in the empty JSON string", Skcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skcer404Response>() {
           @Override
           public void write(JsonWriter out, Skcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skcer404Response
   * @throws IOException if the JSON string is invalid with respect to Skcer404Response
   */
  public static Skcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skcer404Response.class);
  }

  /**
   * Convert an instance of Skcer404Response to an JSON string
   *
   * @return JSON string
   */
