...
public class Skcer502Response {
  ...
  public Skcer502Response() {
  }

  public Skcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skcer502Response skcer502Response = (Skcer502Response) o;
    return Objects.equals(this.error, skcer502Response.error) &&
        Objects.equals(this.errorDescription, skcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skcer502Response is not found in the empty JSON string", Skcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skcer502Response>() {
           @Override
           public void write(JsonWriter out, Skcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skcer502Response
   * @throws IOException if the JSON string is invalid with respect to Skcer502Response
   */
  public static Skcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skcer502Response.class);
  }

  /**
   * Convert an instance of Skcer502Response to an JSON string
   *
   * @return JSON string
   */
