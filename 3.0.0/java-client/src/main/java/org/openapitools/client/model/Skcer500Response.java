...
public class Skcer500Response {
  ...
  public Skcer500Response() {
  }

  public Skcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skcer500Response skcer500Response = (Skcer500Response) o;
    return Objects.equals(this.error, skcer500Response.error) &&
        Objects.equals(this.errorDescription, skcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skcer500Response is not found in the empty JSON string", Skcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skcer500Response>() {
           @Override
           public void write(JsonWriter out, Skcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skcer500Response
   * @throws IOException if the JSON string is invalid with respect to Skcer500Response
   */
  public static Skcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skcer500Response.class);
  }

  /**
   * Convert an instance of Skcer500Response to an JSON string
   *
   * @return JSON string
   */
