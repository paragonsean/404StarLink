 ...
 * Skcer503Response
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-11T02:09:16.425338-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class Skcer503Response {
  /**
   * Gets or Sets error
   */
  ...
  public Skcer503Response() {
  }

  public Skcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Skcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Skcer503Response skcer503Response = (Skcer503Response) o;
    return Objects.equals(this.error, skcer503Response.error) &&
        Objects.equals(this.errorDescription, skcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Skcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Skcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Skcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Skcer503Response is not found in the empty JSON string", Skcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Skcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Skcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Skcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Skcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Skcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Skcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Skcer503Response>() {
           @Override
           public void write(JsonWriter out, Skcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Skcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Skcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Skcer503Response
   * @throws IOException if the JSON string is invalid with respect to Skcer503Response
   */
  public static Skcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Skcer503Response.class);
  }

  /**
   * Convert an instance of Skcer503Response to an JSON string
   *
   * @return JSON string
   */
