...
public class AlertPolicy {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alertStrategy, combiner, conditions, creationRecord, displayName, documentation, enabled, mutationRecord, name, notificationChannels, userLabels, validity);
  }
