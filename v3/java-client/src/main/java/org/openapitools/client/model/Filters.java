...
public class Filters {
  ...
  private String kind = "analytics#filters";
  ...
  public Filters items(List<Filter> items) {
    this.items = items;
    return this;
  }

  public Filters addItemsItem(Filter itemsItem) {
    if (this.items == null) {
  ...
  public Filters itemsPerPage(Integer itemsPerPage) {
  ...
  public Filters kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public Filters nextLink(String nextLink) {
  ...
  public Filters previousLink(String previousLink) {
  ...
  public Filters startIndex(Integer startIndex) {
  ...
  public Filters totalResults(Integer totalResults) {
  ...
  public Filters username(String username) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, filters.items) &&
        Objects.equals(this.itemsPerPage, filters.itemsPerPage) &&
        Objects.equals(this.kind, filters.kind) &&
        Objects.equals(this.nextLink, filters.nextLink) &&
        Objects.equals(this.previousLink, filters.previousLink) &&
        Objects.equals(this.startIndex, filters.startIndex) &&
        Objects.equals(this.totalResults, filters.totalResults) &&
        Objects.equals(this.username, filters.username);
  }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            Filter.validateJsonElement(jsonArrayitems.get(i));
          };
        }
      }
