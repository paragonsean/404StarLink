...
public class AccountRef {
  ...
  private String kind = "analytics#accountRef";
  ...
  public AccountRef kind(String kind) {
    this.kind = kind;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.href, accountRef.href) &&
        Objects.equals(this.id, accountRef.id) &&
        Objects.equals(this.kind, accountRef.kind) &&
        Objects.equals(this.name, accountRef.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(href, id, kind, name);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccountRef.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AccountRef` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
