...
public class UptimeCheckConfig {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(checkerType, contentMatchers, displayName, httpCheck, internalCheckers, isInternal, monitoredResource, name, period, resourceGroup, selectedRegions, tcpCheck, timeout, userLabels);
  }
