...
class EnvironmentProtectionRulesInnerAnyOf1ReviewersInner(BaseModel):
    """
    EnvironmentProtectionRulesInnerAnyOf1ReviewersInner
    """ # noqa: E501
    reviewer: Optional[EnvironmentProtectionRulesInnerAnyOf1ReviewersInnerReviewer] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reviewer": EnvironmentProtectionRulesInnerAnyOf1ReviewersInnerReviewer.from_dict(obj["reviewer"]) if obj.get("reviewer") is not None else None,
            "type": obj.get("type")
        })
        return _obj
