...
class ProtectedBranchPullRequestReviewDismissalRestrictions(BaseModel):
    ...
    """ # noqa: E501
    apps: Optional[List[Integration]] = Field(default=None, description="The list of apps with review dismissal access.")
    ...
    __properties: ClassVar[List[str]] = ["apps", "teams", "teams_url", "url", "users", "users_url"]
