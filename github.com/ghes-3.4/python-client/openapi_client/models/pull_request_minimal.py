...
class PullRequestMinimal(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "base": PullRequestMinimalBase.from_dict(obj["base"]) if obj.get("base") is not None else None,
            "head": PullRequestMinimalBase.from_dict(obj["head"]) if obj.get("head") is not None else None,
            "id": obj.get("id"),
