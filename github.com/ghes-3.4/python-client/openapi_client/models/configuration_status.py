...
class ConfigurationStatus(BaseModel):
    ...
    ConfigurationStatus
    """ # noqa: E501
    progress: Optional[List[ConfigurationStatusProgressInner]] = None
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["progress", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "progress": [ConfigurationStatusProgressInner.from_dict(_item) for _item in obj["progress"]] if obj.get("progress") is not None else None,
