...
class CodeScanningAlertInstance(BaseModel):
    ...
    ref: Optional[StrictStr] = Field(default=None, description="The full Git reference, formatted as `refs/heads/<branch name>`, `refs/pull/<number>/merge`, or `refs/pull/<number>/head`.")
    state: Optional[CodeScanningAlertState] = None
    __properties: ClassVar[List[str]] = ["analysis_key", "category", "classifications", "commit_sha", "environment", "html_url", "location", "message", "ref", "state"]
