...
class OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["client_secret", "note", "note_url", "scopes"]
