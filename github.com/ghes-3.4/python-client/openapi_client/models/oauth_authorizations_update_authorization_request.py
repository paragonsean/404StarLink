...
class OauthAuthorizationsUpdateAuthorizationRequest(BaseModel):
    """
    OauthAuthorizationsUpdateAuthorizationRequest
    """ # noqa: E501
    add_scopes: Optional[List[StrictStr]] = Field(default=None, description="A list of scopes to add to this authorization.")
    ...
    remove_scopes: Optional[List[StrictStr]] = Field(default=None, description="A list of scopes to remove from this authorization.")
    scopes: Optional[List[StrictStr]] = Field(default=None, description="A list of scopes that this authorization is in.")
    __properties: ClassVar[List[str]] = ["add_scopes", "fingerprint", "note", "note_url", "remove_scopes", "scopes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "add_scopes": obj.get("add_scopes"),
            "fingerprint": obj.get("fingerprint"),
            "note": obj.get("note"),
            "note_url": obj.get("note_url"),
            "remove_scopes": obj.get("remove_scopes"),
