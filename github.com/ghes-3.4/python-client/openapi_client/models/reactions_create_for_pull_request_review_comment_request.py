...
class ReactionsCreateForPullRequestReviewCommentRequest(BaseModel):
    ...
    """ # noqa: E501
    content: StrictStr = Field(description="The [reaction type](https://docs.github.com/enterprise-server@3.4/rest/reference/reactions#reaction-types) to add to the pull request review comment.")
