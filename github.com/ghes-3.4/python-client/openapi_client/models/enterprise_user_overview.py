...
class EnterpriseUserOverview(BaseModel):
    ...
    """ # noqa: E501
    admin_users: StrictInt
    suspended_users: StrictInt
    total_users: StrictInt
    __properties: ClassVar[List[str]] = ["admin_users", "suspended_users", "total_users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "suspended_users": obj.get("suspended_users"),
