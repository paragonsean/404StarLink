...
class IssuesCreateRequest(BaseModel):
    ...
    IssuesCreateRequest
    """ # noqa: E501
    assignee: Optional[StrictStr] = Field(default=None, description="Login for the user that this issue should be assigned to. _NOTE: Only users with push access can set the assignee for new issues. The assignee is silently dropped otherwise. **This field is deprecated.**_")
    ...
    __properties: ClassVar[List[str]] = ["assignee", "assignees", "body", "labels", "milestone", "title"]
