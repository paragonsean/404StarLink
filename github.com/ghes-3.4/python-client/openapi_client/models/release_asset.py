...
class ReleaseAsset(BaseModel):
    ...
    updated_at: datetime
    uploader: Optional[NullableSimpleUser]
    url: StrictStr
    ...
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['uploaded', 'open']):
            raise ValueError("must be one of enum values ('uploaded', 'open')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uploader": NullableSimpleUser.from_dict(obj["uploader"]) if obj.get("uploader") is not None else None,
            "url": obj.get("url")
        })
        return _obj
