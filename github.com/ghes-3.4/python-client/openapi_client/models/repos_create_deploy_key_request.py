...
class ReposCreateDeployKeyRequest(BaseModel):
    """
    ReposCreateDeployKeyRequest
    """ # noqa: E501
    key: StrictStr = Field(description="The contents of the key.")
    read_only: Optional[StrictBool] = Field(default=None, description="If `true`, the key will only be able to read repository contents. Otherwise, the key will be able to read and write.      Deploy keys with write access can perform the same actions as an organization member with admin access, or a collaborator on a personal repository. For more information, see \"[Repository permission levels for an organization](https://docs.github.com/enterprise-server@3.4/articles/repository-permission-levels-for-an-organization/)\" and \"[Permission levels for a user account repository](https://docs.github.com/enterprise-server@3.4/articles/permission-levels-for-a-user-account-repository/).\"")
    title: Optional[StrictStr] = Field(default=None, description="A name for the key.")
