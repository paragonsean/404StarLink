...
class TeamDiscussion(BaseModel):
    ...
    private: StrictBool = Field(description="Whether or not this discussion should be restricted to team members and organization administrators.")
    reactions: Optional[ReactionRollup] = None
    team_url: StrictStr
    title: StrictStr = Field(description="The title of the discussion.")
    updated_at: datetime
    url: StrictStr
    __properties: ClassVar[List[str]] = ["author", "body", "body_html", "body_version", "comments_count", "comments_url", "created_at", "html_url", "last_edited_at", "node_id", "number", "pinned", "private", "reactions", "team_url", "title", "updated_at", "url"]
