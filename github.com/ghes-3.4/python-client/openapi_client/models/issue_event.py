...
class IssueEvent(BaseModel):
    ...
    url: StrictStr
    __properties: ClassVar[List[str]] = ["actor", "assignee", "assigner", "author_association", "commit_id", "commit_url", "created_at", "dismissed_review", "event", "id", "issue", "label", "lock_reason", "milestone", "node_id", "performed_via_github_app", "project_card", "rename", "requested_reviewer", "requested_team", "review_requester", "url"]
