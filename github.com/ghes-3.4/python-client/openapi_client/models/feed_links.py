...
class FeedLinks(BaseModel):
    ...
    user: LinkWithType
    __properties: ClassVar[List[str]] = ["current_user", "current_user_actor", "current_user_organization", "current_user_organizations", "current_user_public", "repository_discussions", "repository_discussions_category", "security_advisories", "timeline", "user"]
