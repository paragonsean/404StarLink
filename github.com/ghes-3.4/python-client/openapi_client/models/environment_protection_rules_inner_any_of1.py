...
class EnvironmentProtectionRulesInnerAnyOf1(BaseModel):
    ...
    id: StrictInt
    node_id: StrictStr
    reviewers: Optional[List[EnvironmentProtectionRulesInnerAnyOf1ReviewersInner]] = Field(default=None, description="The people or teams that may approve jobs that reference the environment. You can list up to six users or teams as reviewers. The reviewers must have at least read access to the repository. Only one of the required reviewers needs to approve the job for it to proceed.")
    type: StrictStr
    __properties: ClassVar[List[str]] = ["id", "node_id", "reviewers", "type"]
