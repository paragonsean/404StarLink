...
class ProtectedBranch(BaseModel):
    ...
    """ # noqa: E501
    allow_deletions: Optional[ProtectedBranchAllowDeletions] = None
    allow_force_pushes: Optional[ProtectedBranchAllowDeletions] = None
    block_creations: Optional[ProtectedBranchAllowDeletions] = None
    ...
    required_linear_history: Optional[ProtectedBranchAllowDeletions] = None
    ...
    url: StrictStr
    __properties: ClassVar[List[str]] = ["allow_deletions", "allow_force_pushes", "block_creations", "enforce_admins", "required_conversation_resolution", "required_linear_history", "required_pull_request_reviews", "required_signatures", "required_status_checks", "restrictions", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "allow_deletions": ProtectedBranchAllowDeletions.from_dict(obj["allow_deletions"]) if obj.get("allow_deletions") is not None else None,
            "allow_force_pushes": ProtectedBranchAllowDeletions.from_dict(obj["allow_force_pushes"]) if obj.get("allow_force_pushes") is not None else None,
            "block_creations": ProtectedBranchAllowDeletions.from_dict(obj["block_creations"]) if obj.get("block_creations") is not None else None,
            ...
            "required_linear_history": ProtectedBranchAllowDeletions.from_dict(obj["required_linear_history"]) if obj.get("required_linear_history") is not None else None,
