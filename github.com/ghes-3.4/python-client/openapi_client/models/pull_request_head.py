...
class PullRequestHead(BaseModel):
    ...
    label: StrictStr
    ref: StrictStr
    repo: Optional[PullRequestHeadRepo]
    sha: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "label": obj.get("label"),
            "ref": obj.get("ref"),
            "repo": PullRequestHeadRepo.from_dict(obj["repo"]) if obj.get("repo") is not None else None,
            "sha": obj.get("sha"),
            "user": PullRequestBaseRepoOwner.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
