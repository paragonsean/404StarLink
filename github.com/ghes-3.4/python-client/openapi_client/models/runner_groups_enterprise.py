...
class RunnerGroupsEnterprise(BaseModel):
    ...
    selected_organizations_url: Optional[StrictStr] = None
    visibility: StrictStr
    __properties: ClassVar[List[str]] = ["allows_public_repositories", "default", "id", "name", "runners_url", "selected_organizations_url", "visibility"]
