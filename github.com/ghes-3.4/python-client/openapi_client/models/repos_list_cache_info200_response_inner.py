...
class ReposListCacheInfo200ResponseInner(BaseModel):
    """
    Status for a cache replica
    """ # noqa: E501
    git: ReposListCacheInfo200ResponseInnerGit
    host: StrictStr
    location: StrictStr
    __properties: ClassVar[List[str]] = ["git", "host", "location"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "git": ReposListCacheInfo200ResponseInnerGit.from_dict(obj["git"]) if obj.get("git") is not None else None,
            "host": obj.get("host"),
