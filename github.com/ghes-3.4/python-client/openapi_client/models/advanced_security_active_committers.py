...
class AdvancedSecurityActiveCommitters(BaseModel):
    ...
    total_advanced_security_committers: Optional[StrictInt] = None
    total_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["repositories", "total_advanced_security_committers", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "repositories": [AdvancedSecurityActiveCommittersRepository.from_dict(_item) for _item in obj["repositories"]] if obj.get("repositories") is not None else None,
            "total_advanced_security_committers": obj.get("total_advanced_security_committers"),
