...
class CodeScanningAnalysis(BaseModel):
    ...
    ref: StrictStr = Field(description="The full Git reference, formatted as `refs/heads/<branch name>`, `refs/pull/<number>/merge`, or `refs/pull/<number>/head`.")
    ...
    __properties: ClassVar[List[str]] = ["analysis_key", "category", "commit_sha", "created_at", "deletable", "environment", "error", "id", "ref", "results_count", "rules_count", "sarif_id", "tool", "url", "warning"]
