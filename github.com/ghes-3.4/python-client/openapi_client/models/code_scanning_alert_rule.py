...
class CodeScanningAlertRule(BaseModel):
    ...
    full_description: Optional[StrictStr] = Field(default=None, description="description of the rule used to detect the alert.")
    ...
    __properties: ClassVar[List[str]] = ["description", "full_description", "help", "help_uri", "id", "name", "security_severity_level", "severity", "tags"]
