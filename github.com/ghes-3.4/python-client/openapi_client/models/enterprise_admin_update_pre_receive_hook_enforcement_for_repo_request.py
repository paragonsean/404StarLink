...
class EnterpriseAdminUpdatePreReceiveHookEnforcementForRepoRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["enforcement"]
    ...
    def enforcement_validate_enum(cls, value):
        ...
        if value not in set(['enabled', 'disabled', 'testing']):
            raise ValueError("must be one of enum values ('enabled', 'disabled', 'testing')")
        return value
