...
class IssuesUpdateRequest(BaseModel):
    ...
    IssuesUpdateRequest
    """ # noqa: E501
    assignee: Optional[StrictStr] = Field(default=None, description="Username to assign to this issue. **This field is deprecated.**")
    ...
    __properties: ClassVar[List[str]] = ["assignee", "assignees", "body", "labels", "milestone", "state", "state_reason", "title"]
