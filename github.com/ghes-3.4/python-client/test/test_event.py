    ...
    def make_instance(self, include_optional) -> Event:
        ...
        if include_optional:
            return Event(
                ...
                id = '',
                org = openapi_client.models.actor.Actor(
                    avatar_url = '', 
                    display_login = '', 
                    gravatar_id = '', 
                    id = 56, 
                    login = '', 
                    url = '', ),
                payload = openapi_client.models.event_payload.event_payload(
                    action = '', 
                    comment = openapi_client.models.issue_comment.Issue Comment(
                    ...
                    issue = openapi_client.models.issue.Issue(
                        ...
                        user = , ), 
                    pages = [
                        openapi_client.models.event_payload_pages_inner.event_payload_pages_inner(
                            action = '', 
                            html_url = '', 
                            page_name = '', 
                            sha = '', 
                ...
                public = True,
                repo = openapi_client.models.event_repo.event_repo(
                    id = 56, 
                    name = '', 
                    url = '', ),
                type = ''
