...
class TestPullRequestSimpleBase(unittest.TestCase):
    """PullRequestSimpleBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequestSimpleBase:
        """Test PullRequestSimpleBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequestSimpleBase`
        """
        model = PullRequestSimpleBase()
        if include_optional:
    ...
    def testPullRequestSimpleBase(self):
        """Test PullRequestSimpleBase"""
