...
public class AutoScalingThresholds {
  ...
  public AutoScalingThresholds instanceCount(Integer instanceCount) {
  ...
  public AutoScalingThresholds thresholdsWaitTime(Integer thresholdsWaitTime) {
  ...
  public AutoScalingThresholds ignoreMetricsTime(Integer ignoreMetricsTime) {
  ...
  public AutoScalingThresholds cpuThreshold(Double cpuThreshold) {
  ...
  public AutoScalingThresholds memoryThreshold(Double memoryThreshold) {
  ...
  public AutoScalingThresholds loadThreshold(Double loadThreshold) {
  ...
  public AutoScalingThresholds alarms(List alarms) {
    this.alarms = alarms;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AutoScalingThresholds autoScalingThresholds = (AutoScalingThresholds) o;
    return Objects.equals(this.instanceCount, autoScalingThresholds.instanceCount) &&
        Objects.equals(this.thresholdsWaitTime, autoScalingThresholds.thresholdsWaitTime) &&
        Objects.equals(this.ignoreMetricsTime, autoScalingThresholds.ignoreMetricsTime) &&
        Objects.equals(this.cpuThreshold, autoScalingThresholds.cpuThreshold) &&
        Objects.equals(this.memoryThreshold, autoScalingThresholds.memoryThreshold) &&
        Objects.equals(this.loadThreshold, autoScalingThresholds.loadThreshold) &&
        Objects.equals(this.alarms, autoScalingThresholds.alarms);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutoScalingThresholds {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AutoScalingThresholds
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AutoScalingThresholds.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutoScalingThresholds is not found in the empty JSON string", AutoScalingThresholds.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AutoScalingThresholds.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AutoScalingThresholds` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutoScalingThresholds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutoScalingThresholds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutoScalingThresholds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutoScalingThresholds.class));

       return (TypeAdapter<T>) new TypeAdapter<AutoScalingThresholds>() {
           @Override
           public void write(JsonWriter out, AutoScalingThresholds value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AutoScalingThresholds read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AutoScalingThresholds given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AutoScalingThresholds
   * @throws IOException if the JSON string is invalid with respect to AutoScalingThresholds
   */
  public static AutoScalingThresholds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutoScalingThresholds.class);
  }

  /**
   * Convert an instance of AutoScalingThresholds to an JSON string
   *
   * @return JSON string
   */
