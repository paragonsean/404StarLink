...
class PaginationLinks(BaseModel):
    ...
    PaginationLinks
    """ # noqa: E501
    first: Optional[PaginationLinksFirst] = None
    last: Optional[PaginationLinksFirst] = None
    next: PaginationLinksFirst
    prev: Optional[PaginationLinksFirst] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "first": PaginationLinksFirst.from_dict(obj["first"]) if obj.get("first") is not None else None,
            "last": PaginationLinksFirst.from_dict(obj["last"]) if obj.get("last") is not None else None,
            "next": PaginationLinksFirst.from_dict(obj["next"]) if obj.get("next") is not None else None,
            "prev": PaginationLinksFirst.from_dict(obj["prev"]) if obj.get("prev") is not None else None
        })
        return _obj
