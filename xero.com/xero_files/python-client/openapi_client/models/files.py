...
class Files(BaseModel):
    ...
    Files
    """ # noqa: E501
    items: Optional[List[FileObject]] = Field(default=None, alias="Items")
    ...
    __properties: ClassVar[List[str]] = ["Items", "Page", "PerPage", "TotalCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Items": [FileObject.from_dict(_item) for _item in obj["Items"]] if obj.get("Items") is not None else None,
            "Page": obj.get("Page"),
