...
class Get200Response(BaseModel):
    ...
    palette_title: Optional[StrictStr] = Field(default=None, alias="paletteTitle")
    __properties: ClassVar[List[str]] = ["colors", "paletteTitle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "colors": [Color.from_dict(_item) for _item in obj["colors"]] if obj.get("colors") is not None else None,
            "paletteTitle": obj.get("paletteTitle")
        })
        return _obj
