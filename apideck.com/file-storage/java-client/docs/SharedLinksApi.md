...
# **sharedLinksAll**
> GetSharedLinksResponse sharedLinksAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetSharedLinksResponse result = apiInstance.sharedLinksAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, fields);
      System.out.println(result);
    } catch (ApiException e) {
