...
CUSTOMFIELDVALUE_ANY_OF_SCHEMAS = ["List[str]", "bool", "float", "str"]
...
class CustomFieldValue(BaseModel):
    ...
    any_of_schemas: Set[str] = { "List[str]", "bool", "float", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in CustomFieldValue with anyOf schemas: List[str], bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CustomFieldValue with anyOf schemas: List[str], bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return instance
