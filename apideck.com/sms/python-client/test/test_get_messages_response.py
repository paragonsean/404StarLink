            ...
            return GetMessagesResponse(
                data = [
                    openapi_client.models.message.Message(
                        ...
                        error = {"code":"X1","message":"Something went wrong"}, 
                        from = '+15017122661', 
                        id = '12345', 
                        messaging_service_id = '123456', 
                        number_of_media_files = 1, 
                        number_of_units = 1, 
                        price = {"currency":"USD","per_unit":"0.01","total_amount":"0.01"}, 
                        reference = 'CUST001', 
                        scheduled_at = '2020-09-30T07:43:32Z', 
                        sent_at = '2020-09-30T07:43:32Z', 
                        status = 'sent', 
                        subject = 'Picture', 
                        to = '+15017122662', 
                        type = 'sms', 
