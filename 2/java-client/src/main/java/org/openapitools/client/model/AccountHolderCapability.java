...
public class AccountHolderCapability {
  ...
  private List<Object> problems = new ArrayList<>();
  ...
  public AccountHolderCapability(
     ...
     JSONObject allowedSettings, 
     JSONObject requestedSettings, 
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("allowedSettings") != null && !jsonObj.get("allowedSettings").isJsonNull()) {
        JSONObject.validateJsonElement(jsonObj.get("allowedSettings"));
      }
      ...
      if (jsonObj.get("requestedSettings") != null && !jsonObj.get("requestedSettings").isJsonNull()) {
        JSONObject.validateJsonElement(jsonObj.get("requestedSettings"));
      }
