...
public class CardConfiguration {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CardConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CardConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CardConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CardConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bulkAddress") != null && !jsonObj.get("bulkAddress").isJsonNull()) {
        BulkAddress.validateJsonElement(jsonObj.get("bulkAddress"));
      }
      if ((jsonObj.get("cardImageId") != null && !jsonObj.get("cardImageId").isJsonNull()) && !jsonObj.get("cardImageId").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("carrierImageId") != null && !jsonObj.get("carrierImageId").isJsonNull()) && !jsonObj.get("carrierImageId").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("insert") != null && !jsonObj.get("insert").isJsonNull()) && !jsonObj.get("insert").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("logoImageId") != null && !jsonObj.get("logoImageId").isJsonNull()) && !jsonObj.get("logoImageId").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("pinMailer") != null && !jsonObj.get("pinMailer").isJsonNull()) && !jsonObj.get("pinMailer").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("shipmentMethod") != null && !jsonObj.get("shipmentMethod").isJsonNull()) && !jsonObj.get("shipmentMethod").isJsonPrimitive()) {
