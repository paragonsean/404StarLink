...
public class ApiClient {
    ...
    private String basePath = "https://balanceplatform-api-test.adyen.com/bcl/v2";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://balanceplatform-api-test.adyen.com/bcl/v2
