...
public class SweepConfigurationV2Schedule extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<SweepConfigurationV2Schedule>() {
                ...
                public SweepConfigurationV2Schedule read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for SweepConfigurationV2Schedule: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SweepConfigurationV2Schedule(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to SweepConfigurationV2Schedule
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format("The JSON string is invalid for SweepConfigurationV2Schedule with oneOf schemas: CronSweepSchedule, SweepSchedule. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }
