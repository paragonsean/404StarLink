...
import org.openapitools.client.model.RepaymentTerm;
import org.openapitools.client.model.ThresholdRepayment;
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Repayment.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Repayment` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("term") != null && !jsonObj.get("term").isJsonNull()) {
        RepaymentTerm.validateJsonElement(jsonObj.get("term"));
      }
      // validate the optional field `threshold`
      if (jsonObj.get("threshold") != null && !jsonObj.get("threshold").isJsonNull()) {
        ThresholdRepayment.validateJsonElement(jsonObj.get("threshold"));
      }
  }
