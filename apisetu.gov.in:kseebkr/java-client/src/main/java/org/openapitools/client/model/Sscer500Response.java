...
public class Sscer500Response {
  ...
  public Sscer500Response() {
  }

  public Sscer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Sscer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Sscer500Response sscer500Response = (Sscer500Response) o;
    return Objects.equals(this.error, sscer500Response.error) &&
        Objects.equals(this.errorDescription, sscer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Sscer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Sscer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Sscer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Sscer500Response is not found in the empty JSON string", Sscer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Sscer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Sscer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Sscer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Sscer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Sscer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Sscer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Sscer500Response>() {
           @Override
           public void write(JsonWriter out, Sscer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Sscer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Sscer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Sscer500Response
   * @throws IOException if the JSON string is invalid with respect to Sscer500Response
   */
  public static Sscer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Sscer500Response.class);
  }

  /**
   * Convert an instance of Sscer500Response to an JSON string
   *
   * @return JSON string
   */
