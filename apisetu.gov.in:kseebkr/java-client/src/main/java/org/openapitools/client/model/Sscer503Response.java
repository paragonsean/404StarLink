...
public class Sscer503Response {
  ...
  public Sscer503Response() {
  }

  public Sscer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Sscer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Sscer503Response sscer503Response = (Sscer503Response) o;
    return Objects.equals(this.error, sscer503Response.error) &&
        Objects.equals(this.errorDescription, sscer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Sscer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Sscer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Sscer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Sscer503Response is not found in the empty JSON string", Sscer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Sscer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Sscer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Sscer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Sscer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Sscer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Sscer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Sscer503Response>() {
           @Override
           public void write(JsonWriter out, Sscer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Sscer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Sscer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Sscer503Response
   * @throws IOException if the JSON string is invalid with respect to Sscer503Response
   */
  public static Sscer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Sscer503Response.class);
  }

  /**
   * Convert an instance of Sscer503Response to an JSON string
   *
   * @return JSON string
   */
