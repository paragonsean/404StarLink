...
public class Sscer404Response {
  ...
  public Sscer404Response() {
  }

  public Sscer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Sscer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Sscer404Response sscer404Response = (Sscer404Response) o;
    return Objects.equals(this.error, sscer404Response.error) &&
        Objects.equals(this.errorDescription, sscer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Sscer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Sscer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Sscer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Sscer404Response is not found in the empty JSON string", Sscer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Sscer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Sscer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Sscer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Sscer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Sscer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Sscer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Sscer404Response>() {
           @Override
           public void write(JsonWriter out, Sscer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Sscer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Sscer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Sscer404Response
   * @throws IOException if the JSON string is invalid with respect to Sscer404Response
   */
  public static Sscer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Sscer404Response.class);
  }

  /**
   * Convert an instance of Sscer404Response to an JSON string
   *
   * @return JSON string
   */
