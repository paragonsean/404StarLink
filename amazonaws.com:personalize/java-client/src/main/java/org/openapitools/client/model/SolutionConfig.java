...
public class SolutionConfig {
  ...
  public SolutionConfig eventValueThreshold(String eventValueThreshold) {
  ...
  public SolutionConfig hpoConfig(SolutionConfigHpoConfig hpoConfig) {
  ...
  public SolutionConfig algorithmHyperParameters(Map algorithmHyperParameters) {
  ...
  public SolutionConfig featureTransformationParameters(Map featureTransformationParameters) {
  ...
  public SolutionConfig autoMLConfig(SolutionConfigAutoMLConfig autoMLConfig) {
  ...
  public SolutionConfig optimizationObjective(SolutionConfigOptimizationObjective optimizationObjective) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventValueThreshold, solutionConfig.eventValueThreshold) &&
        Objects.equals(this.hpoConfig, solutionConfig.hpoConfig) &&
        Objects.equals(this.algorithmHyperParameters, solutionConfig.algorithmHyperParameters) &&
        Objects.equals(this.featureTransformationParameters, solutionConfig.featureTransformationParameters) &&
        Objects.equals(this.autoMLConfig, solutionConfig.autoMLConfig) &&
        Objects.equals(this.optimizationObjective, solutionConfig.optimizationObjective);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SolutionConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SolutionConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SolutionConfig is not found in the empty JSON string", SolutionConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SolutionConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SolutionConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SolutionConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SolutionConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SolutionConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SolutionConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<SolutionConfig>() {
           @Override
           public void write(JsonWriter out, SolutionConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SolutionConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SolutionConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SolutionConfig
   * @throws IOException if the JSON string is invalid with respect to SolutionConfig
   */
  public static SolutionConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SolutionConfig.class);
  }

  /**
   * Convert an instance of SolutionConfig to an JSON string
   *
   * @return JSON string
   */
