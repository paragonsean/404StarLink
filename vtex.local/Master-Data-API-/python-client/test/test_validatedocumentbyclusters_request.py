...
class TestValidatedocumentbyclustersRequest(unittest.TestCase):
    """ValidatedocumentbyclustersRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidatedocumentbyclustersRequest:
        """Test ValidatedocumentbyclustersRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidatedocumentbyclustersRequest`
        """
        model = ValidatedocumentbyclustersRequest()
        if include_optional:
    ...
    def testValidatedocumentbyclustersRequest(self):
        """Test ValidatedocumentbyclustersRequest"""
