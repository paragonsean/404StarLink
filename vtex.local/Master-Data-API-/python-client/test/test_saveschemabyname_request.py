...
class TestSaveschemabynameRequest(unittest.TestCase):
    """SaveschemabynameRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SaveschemabynameRequest:
        """Test SaveschemabynameRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SaveschemabynameRequest`
        """
        model = SaveschemabynameRequest()
        if include_optional:
            return SaveschemabynameRequest(
    ...
    def testSaveschemabynameRequest(self):
        """Test SaveschemabynameRequest"""
