...
class TestArEVentilaO(unittest.TestCase):
    """ArEVentilaO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArEVentilaO:
        """Test ArEVentilaO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArEVentilaO`
        """
        model = ArEVentilaO()
        if include_optional:
            return ArEVentilaO(
