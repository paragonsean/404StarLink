...
class TestCreateUpdateProfileRequests(unittest.TestCase):
    """CreateUpdateProfileRequests unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateUpdateProfileRequests:
        """Test CreateUpdateProfileRequests
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateUpdateProfileRequests`
        """
        model = CreateUpdateProfileRequests()
        if include_optional:
    ...
    def testCreateUpdateProfileRequests(self):
        """Test CreateUpdateProfileRequests"""
