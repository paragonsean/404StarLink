...
class CustomerProfilesApi:
    ...
    def create_new_customer_profilev2(
        ...
        create_update_profile_requests: CreateUpdateProfileRequests,
        ...
        :type accept: str
        :param create_update_profile_requests: (required)
        :type create_update_profile_requests: CreateUpdateProfileRequests
        ...
        _param = self._create_new_customer_profilev2_serialize(
            content_type=content_type,
            accept=accept,
            create_update_profile_requests=create_update_profile_requests,
    ...
    @validate_call
    def create_new_customer_profilev2_with_http_info(
        self,
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        create_update_profile_requests: CreateUpdateProfileRequests,
    ...
    @validate_call
    def create_new_customer_profilev2_without_preload_content(
        self,
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        create_update_profile_requests: CreateUpdateProfileRequests,
    ...
    def _create_new_customer_profilev2_serialize(
        self,
        content_type,
        accept,
        create_update_profile_requests,
        var_schema,
        _request_auth,
        _content_type,
        _headers,
        ...
        if create_update_profile_requests is not None:
            _body_params = create_update_profile_requests
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/dataentities/Client/documents',
    ...
    def delete_customer_profile(
        ...
        _param = self._delete_customer_profile_serialize(
            content_type=content_type,
            accept=accept,
            id=id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def delete_customer_profile_with_http_info(
        self,
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        id: Annotated[StrictStr, Field(description="ID of the Document.")],
    ...
    @validate_call
    def delete_customer_profile_without_preload_content(
        self,
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        id: Annotated[StrictStr, Field(description="ID of the Document.")],
    ...
    def _delete_customer_profile_serialize(
        self,
        content_type,
        accept,
        id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/dataentities/Client/documents/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_customer_profile(
        ...
        _param = self._update_customer_profile_serialize(
            content_type=content_type,
            accept=accept,
            id=id,
            create_update_profile_requests=create_update_profile_requests,
    ...
    @validate_call
    def update_customer_profile_with_http_info(
        self,
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        id: Annotated[StrictStr, Field(description="ID of the Document.")],
    ...
    @validate_call
    def update_customer_profile_without_preload_content(
        self,
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        id: Annotated[StrictStr, Field(description="ID of the Document.")],
    ...
    def _update_customer_profile_serialize(
        self,
        content_type,
        accept,
        id,
