...
class VersionsApi:
    ...
    def getversion(
        ...
        version_id: Annotated[StrictStr, Field(description="ID of the version to update.")],
        ...
        :type id: str
        :param version_id: ID of the version to update. (required)
        :type version_id: str
        ...
        _param = self._getversion_serialize(
    ...
    @validate_call
    def getversion_without_preload_content(
        self,
        data_entity_name: Annotated[StrictStr, Field(description="Name of the data entity. Defined by the api. Examples of native data entities you can use are `CL` for client profiles and `AD` for client addresses.")],
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
    ...
    def _getversion_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/dataentities/{dataEntityName}/documents/{id}/versions/{versionId}',
    ...
    def listversions(
        ...
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
        id: Annotated[StrictStr, Field(description="ID of the Document.")],
        load: Annotated[Optional[StrictBool], Field(description="If true, return all the fields in each version of the document")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="If `load` is true, the response will return only these specific fields")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._listversions_serialize(
            data_entity_name=data_entity_name,
            content_type=content_type,
            accept=accept,
            id=id,
    ...
    @validate_call
    def listversions_with_http_info(
        self,
        data_entity_name: Annotated[StrictStr, Field(description="Name of the data entity. Defined by the api. Examples of native data entities you can use are `CL` for client profiles and `AD` for client addresses.")],
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
    ...
    @validate_call
    def listversions_without_preload_content(
        self,
        data_entity_name: Annotated[StrictStr, Field(description="Name of the data entity. Defined by the api. Examples of native data entities you can use are `CL` for client profiles and `AD` for client addresses.")],
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
    ...
    def _listversions_serialize(
        ...
        if load is not None:
            ...
            _query_params.append(('load', load))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/dataentities/{dataEntityName}/documents/{id}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def putversion(
        ...
        _param = self._putversion_serialize(
            data_entity_name=data_entity_name,
            content_type=content_type,
            accept=accept,
            id=id,
    ...
    @validate_call
    def putversion_without_preload_content(
        self,
        data_entity_name: Annotated[StrictStr, Field(description="Name of the data entity. Defined by the api. Examples of native data entities you can use are `CL` for client profiles and `AD` for client addresses.")],
        content_type: Annotated[StrictStr, Field(description="Type of the content being sent.")],
        accept: Annotated[StrictStr, Field(description="HTTP Client Negotiation _Accept_ Header. Indicates the types of responses the client can understand.")],
