...
class DepartmentVisitedTag(BaseModel):
    ...
    scores: Scores = Field(alias="Scores")
    __properties: ClassVar[List[str]] = ["DisplayValue", "Scores"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Scores": Scores.from_dict(obj["Scores"]) if obj.get("Scores") is not None else None
        })
        return _obj
