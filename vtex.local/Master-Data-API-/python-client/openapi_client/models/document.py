...
class Document(BaseModel):
    ...
    carttag: Optional[StrictStr]
    checkouttag: Optional[StrictStr]
    data_entity_id: StrictStr = Field(alias="dataEntityId")
    department_visited_tag: DepartmentVisitedTag = Field(alias="departmentVisitedTag")
    email: StrictStr
    followers: List[StrictStr]
    id: StrictStr
    rclastsession: StrictStr
    rclastsessiondate: StrictStr
    __properties: ClassVar[List[str]] = ["accountId", "accountName", "carttag", "checkouttag", "dataEntityId", "departmentVisitedTag", "email", "followers", "id", "rclastsession", "rclastsessiondate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of department_visited_tag
        if self.department_visited_tag:
            _dict['departmentVisitedTag'] = self.department_visited_tag.to_dict()
        # set to None if carttag (nullable) is None
        # and model_fields_set contains the field
        if self.carttag is None and "carttag" in self.model_fields_set:
            _dict['carttag'] = None

        # set to None if checkouttag (nullable) is None
        # and model_fields_set contains the field
        if self.checkouttag is None and "checkouttag" in self.model_fields_set:
            _dict['checkouttag'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "carttag": obj.get("carttag"),
            "checkouttag": obj.get("checkouttag"),
            "dataEntityId": obj.get("dataEntityId"),
            "departmentVisitedTag": DepartmentVisitedTag.from_dict(obj["departmentVisitedTag"]) if obj.get("departmentVisitedTag") is not None else None,
            "email": obj.get("email"),
            "followers": obj.get("followers"),
            "id": obj.get("id"),
            "rclastsession": obj.get("rclastsession"),
            "rclastsessiondate": obj.get("rclastsessiondate")
        })
        return _obj
