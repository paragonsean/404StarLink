...
class PutindicesRequest(BaseModel):
    ...
    PutindicesRequest
    """ # noqa: E501
    fields: StrictStr = Field(description="Comma-separted fields of the index")
    multiple: StrictBool = Field(description="Determines whether the values need to be unique. If false, values must be unique.")
    name: StrictStr = Field(description="Name to identify the index")
    __properties: ClassVar[List[str]] = ["fields", "multiple", "name"]
