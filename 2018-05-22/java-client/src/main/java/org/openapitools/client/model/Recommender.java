...
public class Recommender {
  ...
  public Recommender recommenderArn(String recommenderArn) {
  ...
  public Recommender datasetGroupArn(String datasetGroupArn) {
  ...
  public Recommender name(String name) {
    this.name = name;
    return this;
  }
  ...
  public Recommender recipeArn(String recipeArn) {
  ...
  public Recommender recommenderConfig(CreateRecommenderRequestRecommenderConfig recommenderConfig) {
  ...
  public Recommender creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public Recommender lastUpdatedDateTime(OffsetDateTime lastUpdatedDateTime) {
  ...
  public Recommender status(String status) {
    this.status = status;
    return this;
  }
  ...
  public Recommender failureReason(String failureReason) {
  ...
  public Recommender latestRecommenderUpdate(RecommenderLatestRecommenderUpdate latestRecommenderUpdate) {
  ...
  public Recommender modelMetrics(Map modelMetrics) {
  ...
  public boolean equals(Object o) {
    ...
    Recommender recommender = (Recommender) o;
    return Objects.equals(this.recommenderArn, recommender.recommenderArn) &&
        Objects.equals(this.datasetGroupArn, recommender.datasetGroupArn) &&
        Objects.equals(this.name, recommender.name) &&
        Objects.equals(this.recipeArn, recommender.recipeArn) &&
        Objects.equals(this.recommenderConfig, recommender.recommenderConfig) &&
        Objects.equals(this.creationDateTime, recommender.creationDateTime) &&
        Objects.equals(this.lastUpdatedDateTime, recommender.lastUpdatedDateTime) &&
        Objects.equals(this.status, recommender.status) &&
        Objects.equals(this.failureReason, recommender.failureReason) &&
        Objects.equals(this.latestRecommenderUpdate, recommender.latestRecommenderUpdate) &&
        Objects.equals(this.modelMetrics, recommender.modelMetrics);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Recommender
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Recommender.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Recommender is not found in the empty JSON string", Recommender.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Recommender.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Recommender` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Recommender.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Recommender' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Recommender> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Recommender.class));

       return (TypeAdapter<T>) new TypeAdapter<Recommender>() {
           @Override
           public void write(JsonWriter out, Recommender value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Recommender read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Recommender given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Recommender
   * @throws IOException if the JSON string is invalid with respect to Recommender
   */
  public static Recommender fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Recommender.class);
  }

  /**
   * Convert an instance of Recommender to an JSON string
   *
   * @return JSON string
   */
