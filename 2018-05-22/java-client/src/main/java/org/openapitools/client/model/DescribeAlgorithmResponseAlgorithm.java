...
public class DescribeAlgorithmResponseAlgorithm {
  ...
  public DescribeAlgorithmResponseAlgorithm() {
  }

  public DescribeAlgorithmResponseAlgorithm name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DescribeAlgorithmResponseAlgorithm algorithmArn(String algorithmArn) {
  ...
  public DescribeAlgorithmResponseAlgorithm algorithmImage(AlgorithmAlgorithmImage algorithmImage) {
  ...
  public DescribeAlgorithmResponseAlgorithm defaultHyperParameters(Map defaultHyperParameters) {
  ...
  public DescribeAlgorithmResponseAlgorithm defaultHyperParameterRanges(AlgorithmDefaultHyperParameterRanges defaultHyperParameterRanges) {
  ...
  public DescribeAlgorithmResponseAlgorithm defaultResourceConfig(Map defaultResourceConfig) {
  ...
  public DescribeAlgorithmResponseAlgorithm trainingInputMode(String trainingInputMode) {
  ...
  public DescribeAlgorithmResponseAlgorithm roleArn(String roleArn) {
  ...
  public DescribeAlgorithmResponseAlgorithm creationDateTime(OffsetDateTime creationDateTime) {
  ...
  public DescribeAlgorithmResponseAlgorithm lastUpdatedDateTime(OffsetDateTime lastUpdatedDateTime) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeAlgorithmResponseAlgorithm describeAlgorithmResponseAlgorithm = (DescribeAlgorithmResponseAlgorithm) o;
    return Objects.equals(this.name, describeAlgorithmResponseAlgorithm.name) &&
        Objects.equals(this.algorithmArn, describeAlgorithmResponseAlgorithm.algorithmArn) &&
        Objects.equals(this.algorithmImage, describeAlgorithmResponseAlgorithm.algorithmImage) &&
        Objects.equals(this.defaultHyperParameters, describeAlgorithmResponseAlgorithm.defaultHyperParameters) &&
        Objects.equals(this.defaultHyperParameterRanges, describeAlgorithmResponseAlgorithm.defaultHyperParameterRanges) &&
        Objects.equals(this.defaultResourceConfig, describeAlgorithmResponseAlgorithm.defaultResourceConfig) &&
        Objects.equals(this.trainingInputMode, describeAlgorithmResponseAlgorithm.trainingInputMode) &&
        Objects.equals(this.roleArn, describeAlgorithmResponseAlgorithm.roleArn) &&
        Objects.equals(this.creationDateTime, describeAlgorithmResponseAlgorithm.creationDateTime) &&
        Objects.equals(this.lastUpdatedDateTime, describeAlgorithmResponseAlgorithm.lastUpdatedDateTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class DescribeAlgorithmResponseAlgorithm {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeAlgorithmResponseAlgorithm
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeAlgorithmResponseAlgorithm.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeAlgorithmResponseAlgorithm is not found in the empty JSON string", DescribeAlgorithmResponseAlgorithm.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeAlgorithmResponseAlgorithm.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeAlgorithmResponseAlgorithm` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeAlgorithmResponseAlgorithm.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeAlgorithmResponseAlgorithm' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeAlgorithmResponseAlgorithm> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeAlgorithmResponseAlgorithm.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeAlgorithmResponseAlgorithm>() {
           @Override
           public void write(JsonWriter out, DescribeAlgorithmResponseAlgorithm value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeAlgorithmResponseAlgorithm read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeAlgorithmResponseAlgorithm given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeAlgorithmResponseAlgorithm
   * @throws IOException if the JSON string is invalid with respect to DescribeAlgorithmResponseAlgorithm
   */
  public static DescribeAlgorithmResponseAlgorithm fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeAlgorithmResponseAlgorithm.class);
  }

  /**
   * Convert an instance of DescribeAlgorithmResponseAlgorithm to an JSON string
   *
   * @return JSON string
   */
