...
public class GenerateOptions {
  ...
  @Deprecated
  public GenerateOptions model(ModelEnum model) {
    this.model = model;
    return this;
  }
  ...
  public GenerateOptions variant(VariantEnum variant) {
  ...
  public GenerateOptions visibility(VisibilityEnum visibility) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateOptions generateOptions = (GenerateOptions) o;
    return Objects.equals(this.model, generateOptions.model) &&
        Objects.equals(this.name, generateOptions.name) &&
        Objects.equals(this.variant, generateOptions.variant) &&
        Objects.equals(this.visibility, generateOptions.visibility);
  }

  @Override
  public int hashCode() {
    return Objects.hash(model, name, variant, visibility);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenerateOptions {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateOptions is not found in the empty JSON string", GenerateOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GenerateOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateOptions>() {
           @Override
           public void write(JsonWriter out, GenerateOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateOptions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateOptions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateOptions
   * @throws IOException if the JSON string is invalid with respect to GenerateOptions
   */
  public static GenerateOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateOptions.class);
  }

  /**
   * Convert an instance of GenerateOptions to an JSON string
   *
   * @return JSON string
   */
