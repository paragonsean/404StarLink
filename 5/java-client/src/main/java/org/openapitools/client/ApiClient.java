...
public class ApiClient {
    ...
    private String basePath = "https://cal-test.adyen.com/cal/services/Fund/v5";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://cal-test.adyen.com/cal/services/Fund/v5
