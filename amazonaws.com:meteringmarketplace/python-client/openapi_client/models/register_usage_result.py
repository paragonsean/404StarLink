...
class RegisterUsageResult(BaseModel):
    ...
    RegisterUsageResult
    """ # noqa: E501
    public_key_rotation_timestamp: Optional[Any] = Field(default=None, alias="PublicKeyRotationTimestamp")
    signature: Optional[Any] = Field(default=None, alias="Signature")
    __properties: ClassVar[List[str]] = ["PublicKeyRotationTimestamp", "Signature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "PublicKeyRotationTimestamp": obj.get("PublicKeyRotationTimestamp"),
