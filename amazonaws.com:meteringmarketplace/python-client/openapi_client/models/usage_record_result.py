...
class UsageRecordResult(BaseModel):
    ...
    """ # noqa: E501
    usage_record: Optional[UsageRecordResultUsageRecord] = Field(default=None, alias="UsageRecord")
    metering_record_id: Optional[Any] = Field(default=None, alias="MeteringRecordId")
    status: Optional[Any] = Field(default=None, alias="Status")
    __properties: ClassVar[List[str]] = ["UsageRecord", "MeteringRecordId", "Status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "UsageRecord": UsageRecordResultUsageRecord.from_dict(obj["UsageRecord"]) if obj.get("UsageRecord") is not None else None,
            "MeteringRecordId": obj.get("MeteringRecordId"),
            "Status": UsageRecordResultStatus.from_dict(obj["Status"]) if obj.get("Status") is not None else None
        })
        return _obj
