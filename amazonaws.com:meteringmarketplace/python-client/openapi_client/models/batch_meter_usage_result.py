...
class BatchMeterUsageResult(BaseModel):
    ...
    unprocessed_records: Optional[Any] = Field(default=None, alias="UnprocessedRecords")
    __properties: ClassVar[List[str]] = ["Results", "UnprocessedRecords"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "UnprocessedRecords": obj.get("UnprocessedRecords")
        })
        return _obj
