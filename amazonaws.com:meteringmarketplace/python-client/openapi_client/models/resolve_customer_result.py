...
class ResolveCustomerResult(BaseModel):
    ...
    """ # noqa: E501
    customer_identifier: Optional[Any] = Field(default=None, alias="CustomerIdentifier")
    product_code: Optional[Any] = Field(default=None, alias="ProductCode")
    customer_aws_account_id: Optional[Any] = Field(default=None, alias="CustomerAWSAccountId")
    __properties: ClassVar[List[str]] = ["CustomerIdentifier", "ProductCode", "CustomerAWSAccountId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "CustomerAWSAccountId": obj.get("CustomerAWSAccountId")
        })
        return _obj
