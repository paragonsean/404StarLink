...
class TestRegisterUsageRequest(unittest.TestCase):
    """RegisterUsageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegisterUsageRequest:
        """Test RegisterUsageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegisterUsageRequest`
        """
        model = RegisterUsageRequest()
        if include_optional:
    ...
    def testRegisterUsageRequest(self):
        """Test RegisterUsageRequest"""
