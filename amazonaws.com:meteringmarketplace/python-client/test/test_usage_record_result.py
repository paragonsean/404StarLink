...
class TestUsageRecordResult(unittest.TestCase):
    """UsageRecordResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageRecordResult:
        """Test UsageRecordResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageRecordResult`
        """
        model = UsageRecordResult()
        if include_optional:
    ...
    def testUsageRecordResult(self):
        """Test UsageRecordResult"""
