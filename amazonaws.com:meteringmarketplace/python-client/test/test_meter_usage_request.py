...
class TestMeterUsageRequest(unittest.TestCase):
    """MeterUsageRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MeterUsageRequest:
        """Test MeterUsageRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MeterUsageRequest`
        """
        model = MeterUsageRequest()
        if include_optional:
            return MeterUsageRequest(
                product_code = None,
                timestamp = None,
                usage_dimension = None,
                usage_quantity = None,
                dry_run = None,
    ...
    def testMeterUsageRequest(self):
        """Test MeterUsageRequest"""
