...
class Sms200ResponseMessagesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["encoding", "error", "error_text", "id", "messages", "parts", "price", "recipient", "sender", "success", "text"]
