...
class Roaming(BaseModel):
    ...
    Roaming
    """ # noqa: E501
    roaming_country_code: Optional[StrictStr] = None
    roaming_network_code: Optional[StrictStr] = None
    roaming_network_name: Optional[StrictStr] = None
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['unknown', 'roaming', 'not_roaming']):
            raise ValueError("must be one of enum values ('unknown', 'roaming', 'not_roaming')")
        return value
