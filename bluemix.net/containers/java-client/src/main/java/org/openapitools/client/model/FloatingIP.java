...
public class FloatingIP {
  ...
  public FloatingIP bindings(Binding bindings) {
  ...
  public FloatingIP ipAddress(String ipAddress) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bindings, floatingIP.bindings) &&
        Objects.equals(this.ipAddress, floatingIP.ipAddress);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bindings, ipAddress);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Bindings") != null && !jsonObj.get("Bindings").isJsonNull()) {
        Binding.validateJsonElement(jsonObj.get("Bindings"));
      }
