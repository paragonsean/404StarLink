...
public class Volume {
  public static final String SERIALIZED_NAME_FS_I_D = "fsID";
  @SerializedName(SERIALIZED_NAME_FS_I_D)
  private String fsID;
  ...
  public static final String SERIALIZED_NAME_OTHER_SPACE_VISIBILITY = "otherSpaceVisibility";
  @SerializedName(SERIALIZED_NAME_OTHER_SPACE_VISIBILITY)
  private List<String> otherSpaceVisibility = new ArrayList<>();

  public static final String SERIALIZED_NAME_SPACE_GUID = "spaceGuid";
  @SerializedName(SERIALIZED_NAME_SPACE_GUID)
  private String spaceGuid;

  public static final String SERIALIZED_NAME_VOL_NAME = "volName";
  @SerializedName(SERIALIZED_NAME_VOL_NAME)
  private String volName;

  public Volume() {
  }

  public Volume fsID(String fsID) {
    this.fsID = fsID;
    return this;
  }
  ...
  public Volume hostPath(String hostPath) {
  ...
  public Volume otherSpaceVisibility(List<String> otherSpaceVisibility) {
    this.otherSpaceVisibility = otherSpaceVisibility;
    return this;
  }

  public Volume addOtherSpaceVisibilityItem(String otherSpaceVisibilityItem) {
    if (this.otherSpaceVisibility == null) {
      this.otherSpaceVisibility = new ArrayList<>();
    }
    this.otherSpaceVisibility.add(otherSpaceVisibilityItem);
    return this;
  }

  /**
   * List of space IDs in which the volume is visible and can be used by all the single containers and container groups. 
   * @return otherSpaceVisibility
   */
  @javax.annotation.Nullable
  public List<String> getOtherSpaceVisibility() {
    return otherSpaceVisibility;
  }

  public void setOtherSpaceVisibility(List<String> otherSpaceVisibility) {
    this.otherSpaceVisibility = otherSpaceVisibility;
  }


  public Volume spaceGuid(String spaceGuid) {
  ...
  public Volume volName(String volName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fsID, volume.fsID) &&
        Objects.equals(this.hostPath, volume.hostPath) &&
        Objects.equals(this.otherSpaceVisibility, volume.otherSpaceVisibility) &&
        Objects.equals(this.spaceGuid, volume.spaceGuid) &&
        Objects.equals(this.volName, volume.volName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fsID, hostPath, otherSpaceVisibility, spaceGuid, volName);
  }
  ...
  public String toString() {
    ...
    sb.append("    otherSpaceVisibility: ").append(toIndentedString(otherSpaceVisibility)).append("\n");
    sb.append("    spaceGuid: ").append(toIndentedString(spaceGuid)).append("\n");
    sb.append("    volName: ").append(toIndentedString(volName)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("fsID");
    openapiFields.add("hostPath");
    openapiFields.add("otherSpaceVisibility");
    openapiFields.add("spaceGuid");
    openapiFields.add("volName");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("fsID") != null && !jsonObj.get("fsID").isJsonNull()) && !jsonObj.get("fsID").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `fsID` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fsID").toString()));
      }
      ...
      if (jsonObj.get("otherSpaceVisibility") != null && !jsonObj.get("otherSpaceVisibility").isJsonNull() && !jsonObj.get("otherSpaceVisibility").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `otherSpaceVisibility` to be an array in the JSON string but got `%s`", jsonObj.get("otherSpaceVisibility").toString()));
      }
      ...
      if ((jsonObj.get("volName") != null && !jsonObj.get("volName").isJsonNull()) && !jsonObj.get("volName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `volName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("volName").toString()));
      }
  }
