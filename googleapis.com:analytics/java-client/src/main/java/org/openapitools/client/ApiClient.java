...
public class ApiClient {
    ...
    private String basePath = "https://www.googleapis.com/analytics/v2.4";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v2.4/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.googleapis.com/analytics/v2.4
