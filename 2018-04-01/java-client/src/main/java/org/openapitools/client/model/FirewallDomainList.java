...
public class FirewallDomainList {
  ...
  public FirewallDomainList id(String id) {
    this.id = id;
    return this;
  }
  ...
  public FirewallDomainList arn(String arn) {
    this.arn = arn;
    return this;
  }
  ...
  public FirewallDomainList name(String name) {
    this.name = name;
    return this;
  }
  ...
  public FirewallDomainList domainCount(Integer domainCount) {
  ...
  public FirewallDomainList status(FirewallDomainListStatus status) {
    this.status = status;
    return this;
  }
  ...
  public FirewallDomainList statusMessage(String statusMessage) {
  ...
  public FirewallDomainList managedOwnerName(String managedOwnerName) {
  ...
  public FirewallDomainList creatorRequestId(String creatorRequestId) {
  ...
  public FirewallDomainList creationTime(String creationTime) {
  ...
  public FirewallDomainList modificationTime(String modificationTime) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallDomainList firewallDomainList = (FirewallDomainList) o;
    return Objects.equals(this.id, firewallDomainList.id) &&
        Objects.equals(this.arn, firewallDomainList.arn) &&
        Objects.equals(this.name, firewallDomainList.name) &&
        Objects.equals(this.domainCount, firewallDomainList.domainCount) &&
        Objects.equals(this.status, firewallDomainList.status) &&
        Objects.equals(this.statusMessage, firewallDomainList.statusMessage) &&
        Objects.equals(this.managedOwnerName, firewallDomainList.managedOwnerName) &&
        Objects.equals(this.creatorRequestId, firewallDomainList.creatorRequestId) &&
        Objects.equals(this.creationTime, firewallDomainList.creationTime) &&
        Objects.equals(this.modificationTime, firewallDomainList.modificationTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallDomainList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to FirewallDomainList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FirewallDomainList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallDomainList is not found in the empty JSON string", FirewallDomainList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FirewallDomainList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FirewallDomainList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallDomainList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallDomainList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallDomainList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallDomainList.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallDomainList>() {
           @Override
           public void write(JsonWriter out, FirewallDomainList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FirewallDomainList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of FirewallDomainList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of FirewallDomainList
   * @throws IOException if the JSON string is invalid with respect to FirewallDomainList
   */
  public static FirewallDomainList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallDomainList.class);
  }

  /**
   * Convert an instance of FirewallDomainList to an JSON string
   *
   * @return JSON string
   */
