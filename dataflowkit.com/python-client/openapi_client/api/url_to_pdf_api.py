...
class UrlToPdfApi:
    ...
    def url_to_pdf(
        ...
        :type url2pdfrequest: Url2pdfrequest
        ...
        _param = self._url_to_pdf_serialize(
            url2pdfrequest=url2pdfrequest,
    ...
    @validate_call
    def url_to_pdf_without_preload_content(
        self,
        url2pdfrequest: Url2pdfrequest,
        _request_timeout: Union[
            None,
    ...
    def _url_to_pdf_serialize(
        ...
        if url2pdfrequest is not None:
            _body_params = url2pdfrequest
