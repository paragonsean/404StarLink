...
class Getcontent(BaseModel):
    ...
    """ # noqa: E501
    skip_last_iteration: Optional[StrictBool] = Field(default=None, description="It is only used for loop actions only. Skips the last iteration.", alias="skipLastIteration")
    __properties: ClassVar[List[str]] = ["skipLastIteration"]
