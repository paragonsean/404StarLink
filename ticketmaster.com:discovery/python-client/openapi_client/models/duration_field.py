...
class DurationField(BaseModel):
    ...
    precise: Optional[StrictBool] = False
    supported: Optional[StrictBool] = False
    type: Optional[DurationFieldType] = None
    unit_millis: Optional[StrictInt] = Field(default=None, alias="unitMillis")
    __properties: ClassVar[List[str]] = ["name", "precise", "supported", "type", "unitMillis"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "precise": obj.get("precise") if obj.get("precise") is not None else False,
            "supported": obj.get("supported") if obj.get("supported") is not None else False,
            "type": DurationFieldType.from_dict(obj["type"]) if obj.get("type") is not None else None,
            "unitMillis": obj.get("unitMillis")
        })
        return _obj
