 ...
 * Player
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-11T01:57:40.021521-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class Player {
  ...
  public static final String SERIALIZED_NAME_CATCHES = "Catches";
  @SerializedName(SERIALIZED_NAME_CATCHES)
  private String catches;

  public static final String SERIALIZED_NAME_DEPTH_CHART_ORDER = "DepthChartOrder";
  @SerializedName(SERIALIZED_NAME_DEPTH_CHART_ORDER)
  private Integer depthChartOrder;

  public static final String SERIALIZED_NAME_DEPTH_CHART_POSITION = "DepthChartPosition";
  @SerializedName(SERIALIZED_NAME_DEPTH_CHART_POSITION)
  ...
  public Player catches(String catches) {
  ...
  public Player depthChartOrder(Integer depthChartOrder) {
  ...
  public Player depthChartPosition(String depthChartPosition) {
    this.depthChartPosition = depthChartPosition;
    return this;
  }

  /**
   * Get depthChartPosition
  ...
  public Player shoots(String shoots) {
    this.shoots = shoots;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.birthCity, player.birthCity) &&
        ...
        Objects.equals(this.catches, player.catches) &&
        Objects.equals(this.depthChartOrder, player.depthChartOrder) &&
        Objects.equals(this.depthChartPosition, player.depthChartPosition) &&
        ...
        Objects.equals(this.shoots, player.shoots) &&
  ...
  public String toString() {
    ...
    sb.append("    catches: ").append(toIndentedString(catches)).append("\n");
    sb.append("    depthChartOrder: ").append(toIndentedString(depthChartOrder)).append("\n");
    sb.append("    depthChartPosition: ").append(toIndentedString(depthChartPosition)).append("\n");
  ...
  static {
    ...
    openapiFields.add("Catches");
    openapiFields.add("DepthChartOrder");
    openapiFields.add("DepthChartPosition");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("Catches") != null && !jsonObj.get("Catches").isJsonNull()) && !jsonObj.get("Catches").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `Catches` to be a primitive type in the JSON string but got `%s`", jsonObj.get("Catches").toString()));
      }
      if ((jsonObj.get("DepthChartPosition") != null && !jsonObj.get("DepthChartPosition").isJsonNull()) && !jsonObj.get("DepthChartPosition").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `DepthChartPosition` to be a primitive type in the JSON string but got `%s`", jsonObj.get("DepthChartPosition").toString()));
      }
