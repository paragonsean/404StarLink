...
public class Message {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(body, createdAt, createdBy, direction, error, from, id, messagingServiceId, numberOfMediaFiles, numberOfUnits, price, reference, scheduledAt, sentAt, status, subject, to, type, updatedAt, updatedBy, webhookUrl);
  }
