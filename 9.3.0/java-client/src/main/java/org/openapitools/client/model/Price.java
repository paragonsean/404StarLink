...
public class Price {
  ...
  public static final String SERIALIZED_NAME_PER_UNIT = "per_unit";
  @SerializedName(SERIALIZED_NAME_PER_UNIT)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currency, price.currency) &&
        Objects.equals(this.perUnit, price.perUnit) &&
        Objects.equals(this.totalAmount, price.totalAmount);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currency, perUnit, totalAmount);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("per_unit") != null && !jsonObj.get("per_unit").isJsonNull()) && !jsonObj.get("per_unit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `per_unit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("per_unit").toString()));
      }
