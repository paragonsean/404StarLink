...
public class DeleteFolderResponse {
  ...
  public DeleteFolderResponse data(UnifiedId data) {
    this.data = data;
    return this;
  }
  ...
  public DeleteFolderResponse operation(String operation) {
  ...
  public DeleteFolderResponse resource(String resource) {
  ...
  public DeleteFolderResponse service(String service) {
  ...
  public DeleteFolderResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  public DeleteFolderResponse statusCode(Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, deleteFolderResponse.data) &&
        Objects.equals(this.operation, deleteFolderResponse.operation) &&
        Objects.equals(this.resource, deleteFolderResponse.resource) &&
        Objects.equals(this.service, deleteFolderResponse.service) &&
        Objects.equals(this.status, deleteFolderResponse.status) &&
        Objects.equals(this.statusCode, deleteFolderResponse.statusCode);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFolderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFolderResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteFolderResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DeleteFolderResponse.openapiRequiredFields) {
