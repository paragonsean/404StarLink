...
public class UnifiedFile {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, createdBy, description, downloadable, downstreamId, id, mimeType, name, owner, parentFolders, parentFoldersComplete, path, size, type, updatedAt, updatedBy);
  }
