...
public class PhotoUrls {
  ...
  public PhotoUrls url(List<URL> url) {
    this.url = url;
    return this;
  }

  public PhotoUrls addUrlItem(URL urlItem) {
    if (this.url == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, photoUrls.url);
  }
      ...
      if (jsonObj.get("url") != null && !jsonObj.get("url").isJsonNull()) {
        ...
        if (jsonArrayurl != null) {
          ...
          for (int i = 0; i < jsonArrayurl.size(); i++) {
            URL.validateJsonElement(jsonArrayurl.get(i));
          };
        }
      }
  }
