...
class CreateDeliveryStreamInputKinesisStreamSourceConfiguration(BaseModel):
    """
    CreateDeliveryStreamInputKinesisStreamSourceConfiguration
    """ # noqa: E501
    kinesis_stream_arn: Any = Field(alias="KinesisStreamARN")
    role_arn: Any = Field(alias="RoleARN")
    __properties: ClassVar[List[str]] = ["KinesisStreamARN", "RoleARN"]
