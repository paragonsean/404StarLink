...
class EncryptionConfigurationKMSEncryptionConfig(BaseModel):
    """
    EncryptionConfigurationKMSEncryptionConfig
    """ # noqa: E501
    awskms_key_arn: Any = Field(alias="AWSKMSKeyARN")
    __properties: ClassVar[List[str]] = ["AWSKMSKeyARN"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "AWSKMSKeyARN": obj.get("AWSKMSKeyARN")
        })
        return _obj
