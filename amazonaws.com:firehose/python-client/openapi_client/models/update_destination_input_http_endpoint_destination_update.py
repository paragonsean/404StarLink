...
class UpdateDestinationInputHttpEndpointDestinationUpdate(BaseModel):
    """
    UpdateDestinationInputHttpEndpointDestinationUpdate
    """ # noqa: E501
    endpoint_configuration: Optional[HttpEndpointDestinationUpdateEndpointConfiguration] = Field(default=None, alias="EndpointConfiguration")
    ...
    request_configuration: Optional[HttpEndpointDestinationUpdateRequestConfiguration] = Field(default=None, alias="RequestConfiguration")
    ...
    __properties: ClassVar[List[str]] = ["EndpointConfiguration", "BufferingHints", "CloudWatchLoggingOptions", "RequestConfiguration", "ProcessingConfiguration", "RoleARN", "RetryOptions", "S3BackupMode", "S3Update"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "EndpointConfiguration": HttpEndpointDestinationUpdateEndpointConfiguration.from_dict(obj["EndpointConfiguration"]) if obj.get("EndpointConfiguration") is not None else None,
            ...
            "RequestConfiguration": HttpEndpointDestinationUpdateRequestConfiguration.from_dict(obj["RequestConfiguration"]) if obj.get("RequestConfiguration") is not None else None,
