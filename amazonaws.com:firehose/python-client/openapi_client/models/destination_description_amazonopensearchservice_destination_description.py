...
class DestinationDescriptionAmazonopensearchserviceDestinationDescription(BaseModel):
    """
    ...
    buffering_hints: Optional[AmazonopensearchserviceDestinationDescriptionBufferingHints] = Field(default=None, alias="BufferingHints")
    retry_options: Optional[AmazonopensearchserviceDestinationDescriptionRetryOptions] = Field(default=None, alias="RetryOptions")
    ...
    vpc_configuration_description: Optional[VpcConfigurationDescription] = Field(default=None, alias="VpcConfigurationDescription")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "IndexRotationPeriod": AmazonopensearchserviceIndexRotationPeriod.from_dict(obj["IndexRotationPeriod"]) if obj.get("IndexRotationPeriod") is not None else None,
            "BufferingHints": AmazonopensearchserviceDestinationDescriptionBufferingHints.from_dict(obj["BufferingHints"]) if obj.get("BufferingHints") is not None else None,
            "RetryOptions": AmazonopensearchserviceDestinationDescriptionRetryOptions.from_dict(obj["RetryOptions"]) if obj.get("RetryOptions") is not None else None,
            "S3BackupMode": AmazonopensearchserviceS3BackupMode.from_dict(obj["S3BackupMode"]) if obj.get("S3BackupMode") is not None else None,
            ...
            "VpcConfigurationDescription": VpcConfigurationDescription.from_dict(obj["VpcConfigurationDescription"]) if obj.get("VpcConfigurationDescription") is not None else None
        })
        return _obj
