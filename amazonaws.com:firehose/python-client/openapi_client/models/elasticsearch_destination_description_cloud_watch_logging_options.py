...
class ElasticsearchDestinationDescriptionCloudWatchLoggingOptions(BaseModel):
    """
    ElasticsearchDestinationDescriptionCloudWatchLoggingOptions
    """ # noqa: E501
    enabled: Optional[Any] = Field(default=None, alias="Enabled")
    log_group_name: Optional[Any] = Field(default=None, alias="LogGroupName")
    log_stream_name: Optional[Any] = Field(default=None, alias="LogStreamName")
    __properties: ClassVar[List[str]] = ["Enabled", "LogGroupName", "LogStreamName"]
