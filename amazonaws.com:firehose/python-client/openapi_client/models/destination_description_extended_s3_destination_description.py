...
class DestinationDescriptionExtendedS3DestinationDescription(BaseModel):
    """
    ...
    buffering_hints: ExtendedS3DestinationConfigurationBufferingHints = Field(alias="BufferingHints")
    ...
    __properties: ClassVar[List[str]] = ["RoleARN", "BucketARN", "Prefix", "ErrorOutputPrefix", "BufferingHints", "CompressionFormat", "EncryptionConfiguration", "CloudWatchLoggingOptions", "ProcessingConfiguration", "S3BackupMode", "S3BackupDescription", "DataFormatConversionConfiguration", "DynamicPartitioningConfiguration"]
