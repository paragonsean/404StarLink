...
class PutRecordInput(BaseModel):
    ...
    record: PutRecordInputRecord = Field(alias="Record")
    __properties: ClassVar[List[str]] = ["DeliveryStreamName", "Record"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Record": PutRecordInputRecord.from_dict(obj["Record"]) if obj.get("Record") is not None else None
        })
        return _obj
