...
class AmazonOpenSearchServerlessDestinationConfigurationBufferingHints(BaseModel):
    """
    AmazonOpenSearchServerlessDestinationConfigurationBufferingHints
    """ # noqa: E501
    interval_in_seconds: Optional[Any] = Field(default=None, alias="IntervalInSeconds")
    size_in_mbs: Optional[Any] = Field(default=None, alias="SizeInMBs")
    __properties: ClassVar[List[str]] = ["IntervalInSeconds", "SizeInMBs"]
