...
class DeliveryStreamEncryptionConfigurationFailureDescription(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Type": DeliveryStreamFailureType.from_dict(obj["Type"]) if obj.get("Type") is not None else None,
