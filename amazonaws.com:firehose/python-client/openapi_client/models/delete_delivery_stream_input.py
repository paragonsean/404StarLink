...
class DeleteDeliveryStreamInput(BaseModel):
    ...
    allow_force_delete: Optional[Any] = Field(default=None, alias="AllowForceDelete")
    __properties: ClassVar[List[str]] = ["DeliveryStreamName", "AllowForceDelete"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AllowForceDelete": obj.get("AllowForceDelete")
        })
        return _obj
