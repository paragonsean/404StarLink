...
class ExtendedS3DestinationConfigurationProcessingConfiguration(BaseModel):
    """
    ExtendedS3DestinationConfigurationProcessingConfiguration
    """ # noqa: E501
    enabled: Optional[Any] = Field(default=None, alias="Enabled")
    processors: Optional[Any] = Field(default=None, alias="Processors")
    __properties: ClassVar[List[str]] = ["Enabled", "Processors"]
