...
class PlayerDetail(BaseModel):
    ...
    latest_news: Optional[List[News]] = Field(default=None, alias="LatestNews")
    ...
    player_season: Optional[PlayerSeason] = Field(default=None, alias="PlayerSeason")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in latest_news (list)
        _items = []
        if self.latest_news:
            for _item_latest_news in self.latest_news:
                if _item_latest_news:
                    _items.append(_item_latest_news.to_dict())
            _dict['LatestNews'] = _items
        # override the default output from pydantic by calling `to_dict()` of player_season
        if self.player_season:
            _dict['PlayerSeason'] = self.player_season.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LatestNews": [News.from_dict(_item) for _item in obj["LatestNews"]] if obj.get("LatestNews") is not None else None,
            "Name": obj.get("Name"),
            "Number": obj.get("Number"),
            "PhotoUrl": obj.get("PhotoUrl"),
            "PlayerID": obj.get("PlayerID"),
            "PlayerSeason": PlayerSeason.from_dict(obj["PlayerSeason"]) if obj.get("PlayerSeason") is not None else None,
