...
class Booking(BaseModel):
    ...
    Booking
    """ # noqa: E501
    booking_id: Optional[StrictInt] = Field(default=None, alias="BookingId")
    ...
    __properties: ClassVar[List[str]] = ["BookingId", "GameId", "GameMinute", "GameMinuteExtra", "Name", "PlayerId", "TeamId", "Type"]
