...
class TeamSeason(BaseModel):
    ...
    opponent_stat: Optional[OpponentSeason] = Field(default=None, alias="OpponentStat")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of opponent_stat
        if self.opponent_stat:
            _dict['OpponentStat'] = self.opponent_stat.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "OpponentStat": OpponentSeason.from_dict(obj["OpponentStat"]) if obj.get("OpponentStat") is not None else None,
