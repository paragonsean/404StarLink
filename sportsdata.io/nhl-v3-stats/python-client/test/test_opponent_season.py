...
class TestOpponentSeason(unittest.TestCase):
    """OpponentSeason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpponentSeason:
        """Test OpponentSeason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpponentSeason`
        """
        model = OpponentSeason()
        if include_optional:
