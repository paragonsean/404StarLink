...
public class MoveReplicationTaskResponseReplicationTask {
  ...
  public MoveReplicationTaskResponseReplicationTask() {
  }

  public MoveReplicationTaskResponseReplicationTask replicationTaskIdentifier(String replicationTaskIdentifier) {
  ...
  public MoveReplicationTaskResponseReplicationTask sourceEndpointArn(String sourceEndpointArn) {
  ...
  public MoveReplicationTaskResponseReplicationTask targetEndpointArn(String targetEndpointArn) {
  ...
  public MoveReplicationTaskResponseReplicationTask replicationInstanceArn(String replicationInstanceArn) {
  ...
  public MoveReplicationTaskResponseReplicationTask migrationType(MigrationTypeValue migrationType) {
  ...
  public MoveReplicationTaskResponseReplicationTask tableMappings(String tableMappings) {
  ...
  public MoveReplicationTaskResponseReplicationTask replicationTaskSettings(String replicationTaskSettings) {
  ...
  public MoveReplicationTaskResponseReplicationTask status(String status) {
    this.status = status;
    return this;
  }
  ...
  public MoveReplicationTaskResponseReplicationTask lastFailureMessage(String lastFailureMessage) {
  ...
  public MoveReplicationTaskResponseReplicationTask stopReason(String stopReason) {
  ...
  public MoveReplicationTaskResponseReplicationTask replicationTaskCreationDate(OffsetDateTime replicationTaskCreationDate) {
  ...
  public MoveReplicationTaskResponseReplicationTask replicationTaskStartDate(OffsetDateTime replicationTaskStartDate) {
  ...
  public MoveReplicationTaskResponseReplicationTask cdcStartPosition(String cdcStartPosition) {
  ...
  public MoveReplicationTaskResponseReplicationTask cdcStopPosition(String cdcStopPosition) {
  ...
  public MoveReplicationTaskResponseReplicationTask recoveryCheckpoint(String recoveryCheckpoint) {
  ...
  public MoveReplicationTaskResponseReplicationTask replicationTaskArn(String replicationTaskArn) {
  ...
  public MoveReplicationTaskResponseReplicationTask replicationTaskStats(ReplicationTaskReplicationTaskStats replicationTaskStats) {
  ...
  public MoveReplicationTaskResponseReplicationTask taskData(String taskData) {
  ...
  public MoveReplicationTaskResponseReplicationTask targetReplicationInstanceArn(String targetReplicationInstanceArn) {
  ...
  public boolean equals(Object o) {
    ...
    MoveReplicationTaskResponseReplicationTask moveReplicationTaskResponseReplicationTask = (MoveReplicationTaskResponseReplicationTask) o;
    return Objects.equals(this.replicationTaskIdentifier, moveReplicationTaskResponseReplicationTask.replicationTaskIdentifier) &&
        Objects.equals(this.sourceEndpointArn, moveReplicationTaskResponseReplicationTask.sourceEndpointArn) &&
        Objects.equals(this.targetEndpointArn, moveReplicationTaskResponseReplicationTask.targetEndpointArn) &&
        Objects.equals(this.replicationInstanceArn, moveReplicationTaskResponseReplicationTask.replicationInstanceArn) &&
        Objects.equals(this.migrationType, moveReplicationTaskResponseReplicationTask.migrationType) &&
        Objects.equals(this.tableMappings, moveReplicationTaskResponseReplicationTask.tableMappings) &&
        Objects.equals(this.replicationTaskSettings, moveReplicationTaskResponseReplicationTask.replicationTaskSettings) &&
        Objects.equals(this.status, moveReplicationTaskResponseReplicationTask.status) &&
        Objects.equals(this.lastFailureMessage, moveReplicationTaskResponseReplicationTask.lastFailureMessage) &&
        Objects.equals(this.stopReason, moveReplicationTaskResponseReplicationTask.stopReason) &&
        Objects.equals(this.replicationTaskCreationDate, moveReplicationTaskResponseReplicationTask.replicationTaskCreationDate) &&
        Objects.equals(this.replicationTaskStartDate, moveReplicationTaskResponseReplicationTask.replicationTaskStartDate) &&
        Objects.equals(this.cdcStartPosition, moveReplicationTaskResponseReplicationTask.cdcStartPosition) &&
        Objects.equals(this.cdcStopPosition, moveReplicationTaskResponseReplicationTask.cdcStopPosition) &&
        Objects.equals(this.recoveryCheckpoint, moveReplicationTaskResponseReplicationTask.recoveryCheckpoint) &&
        Objects.equals(this.replicationTaskArn, moveReplicationTaskResponseReplicationTask.replicationTaskArn) &&
        Objects.equals(this.replicationTaskStats, moveReplicationTaskResponseReplicationTask.replicationTaskStats) &&
        Objects.equals(this.taskData, moveReplicationTaskResponseReplicationTask.taskData) &&
        Objects.equals(this.targetReplicationInstanceArn, moveReplicationTaskResponseReplicationTask.targetReplicationInstanceArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class MoveReplicationTaskResponseReplicationTask {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MoveReplicationTaskResponseReplicationTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MoveReplicationTaskResponseReplicationTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MoveReplicationTaskResponseReplicationTask is not found in the empty JSON string", MoveReplicationTaskResponseReplicationTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MoveReplicationTaskResponseReplicationTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MoveReplicationTaskResponseReplicationTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MoveReplicationTaskResponseReplicationTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MoveReplicationTaskResponseReplicationTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MoveReplicationTaskResponseReplicationTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MoveReplicationTaskResponseReplicationTask.class));

       return (TypeAdapter<T>) new TypeAdapter<MoveReplicationTaskResponseReplicationTask>() {
           @Override
           public void write(JsonWriter out, MoveReplicationTaskResponseReplicationTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MoveReplicationTaskResponseReplicationTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MoveReplicationTaskResponseReplicationTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MoveReplicationTaskResponseReplicationTask
   * @throws IOException if the JSON string is invalid with respect to MoveReplicationTaskResponseReplicationTask
   */
  public static MoveReplicationTaskResponseReplicationTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MoveReplicationTaskResponseReplicationTask.class);
  }

  /**
   * Convert an instance of MoveReplicationTaskResponseReplicationTask to an JSON string
   *
   * @return JSON string
   */
