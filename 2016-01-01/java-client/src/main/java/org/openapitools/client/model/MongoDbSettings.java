...
public class MongoDbSettings {
  ...
  public MongoDbSettings username(String username) {
  ...
  public MongoDbSettings password(String password) {
  ...
  public MongoDbSettings serverName(String serverName) {
  ...
  public MongoDbSettings port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public MongoDbSettings databaseName(String databaseName) {
  ...
  public MongoDbSettings authType(AuthTypeValue authType) {
  ...
  public MongoDbSettings authMechanism(AuthMechanismValue authMechanism) {
  ...
  public MongoDbSettings nestingLevel(NestingLevelValue nestingLevel) {
  ...
  public MongoDbSettings extractDocId(String extractDocId) {
  ...
  public MongoDbSettings docsToInvestigate(String docsToInvestigate) {
  ...
  public MongoDbSettings authSource(String authSource) {
  ...
  public MongoDbSettings kmsKeyId(String kmsKeyId) {
  ...
  public MongoDbSettings secretsManagerAccessRoleArn(String secretsManagerAccessRoleArn) {
  ...
  public MongoDbSettings secretsManagerSecretId(String secretsManagerSecretId) {
  ...
  public boolean equals(Object o) {
    ...
    MongoDbSettings mongoDbSettings = (MongoDbSettings) o;
    return Objects.equals(this.username, mongoDbSettings.username) &&
        Objects.equals(this.password, mongoDbSettings.password) &&
        Objects.equals(this.serverName, mongoDbSettings.serverName) &&
        Objects.equals(this.port, mongoDbSettings.port) &&
        Objects.equals(this.databaseName, mongoDbSettings.databaseName) &&
        Objects.equals(this.authType, mongoDbSettings.authType) &&
        Objects.equals(this.authMechanism, mongoDbSettings.authMechanism) &&
        Objects.equals(this.nestingLevel, mongoDbSettings.nestingLevel) &&
        Objects.equals(this.extractDocId, mongoDbSettings.extractDocId) &&
        Objects.equals(this.docsToInvestigate, mongoDbSettings.docsToInvestigate) &&
        Objects.equals(this.authSource, mongoDbSettings.authSource) &&
        Objects.equals(this.kmsKeyId, mongoDbSettings.kmsKeyId) &&
        Objects.equals(this.secretsManagerAccessRoleArn, mongoDbSettings.secretsManagerAccessRoleArn) &&
        Objects.equals(this.secretsManagerSecretId, mongoDbSettings.secretsManagerSecretId);
  }
  ...
  public String toString() {
    ...
    sb.append("class MongoDbSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MongoDbSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MongoDbSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MongoDbSettings is not found in the empty JSON string", MongoDbSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MongoDbSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MongoDbSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MongoDbSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MongoDbSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MongoDbSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MongoDbSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<MongoDbSettings>() {
           @Override
           public void write(JsonWriter out, MongoDbSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MongoDbSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MongoDbSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MongoDbSettings
   * @throws IOException if the JSON string is invalid with respect to MongoDbSettings
   */
  public static MongoDbSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MongoDbSettings.class);
  }

  /**
   * Convert an instance of MongoDbSettings to an JSON string
   *
   * @return JSON string
   */
