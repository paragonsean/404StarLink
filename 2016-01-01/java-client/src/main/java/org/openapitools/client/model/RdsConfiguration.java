...
public class RdsConfiguration {
  ...
  public RdsConfiguration engineEdition(String engineEdition) {
  ...
  public RdsConfiguration instanceType(String instanceType) {
  ...
  public RdsConfiguration instanceVcpu(Double instanceVcpu) {
  ...
  public RdsConfiguration instanceMemory(Double instanceMemory) {
  ...
  public RdsConfiguration storageType(String storageType) {
  ...
  public RdsConfiguration storageSize(Integer storageSize) {
  ...
  public RdsConfiguration storageIops(Integer storageIops) {
  ...
  public RdsConfiguration deploymentOption(String deploymentOption) {
  ...
  public boolean equals(Object o) {
    ...
    RdsConfiguration rdsConfiguration = (RdsConfiguration) o;
    return Objects.equals(this.engineEdition, rdsConfiguration.engineEdition) &&
        Objects.equals(this.instanceType, rdsConfiguration.instanceType) &&
        Objects.equals(this.instanceVcpu, rdsConfiguration.instanceVcpu) &&
        Objects.equals(this.instanceMemory, rdsConfiguration.instanceMemory) &&
        Objects.equals(this.storageType, rdsConfiguration.storageType) &&
        Objects.equals(this.storageSize, rdsConfiguration.storageSize) &&
        Objects.equals(this.storageIops, rdsConfiguration.storageIops) &&
        Objects.equals(this.deploymentOption, rdsConfiguration.deploymentOption);
  }
  ...
  public String toString() {
    ...
    sb.append("class RdsConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RdsConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RdsConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RdsConfiguration is not found in the empty JSON string", RdsConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RdsConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RdsConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RdsConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RdsConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RdsConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RdsConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<RdsConfiguration>() {
           @Override
           public void write(JsonWriter out, RdsConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RdsConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RdsConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RdsConfiguration
   * @throws IOException if the JSON string is invalid with respect to RdsConfiguration
   */
  public static RdsConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RdsConfiguration.class);
  }

  /**
   * Convert an instance of RdsConfiguration to an JSON string
   *
   * @return JSON string
   */
