...
public class RedshiftSettings {
  ...
  public RedshiftSettings acceptAnyDate(Boolean acceptAnyDate) {
  ...
  public RedshiftSettings afterConnectScript(String afterConnectScript) {
  ...
  public RedshiftSettings bucketFolder(String bucketFolder) {
  ...
  public RedshiftSettings bucketName(String bucketName) {
  ...
  public RedshiftSettings caseSensitiveNames(Boolean caseSensitiveNames) {
  ...
  public RedshiftSettings compUpdate(Boolean compUpdate) {
  ...
  public RedshiftSettings connectionTimeout(Integer connectionTimeout) {
  ...
  public RedshiftSettings databaseName(String databaseName) {
  ...
  public RedshiftSettings dateFormat(String dateFormat) {
  ...
  public RedshiftSettings emptyAsNull(Boolean emptyAsNull) {
  ...
  public RedshiftSettings encryptionMode(EncryptionModeValue encryptionMode) {
  ...
  public RedshiftSettings explicitIds(Boolean explicitIds) {
  ...
  public RedshiftSettings fileTransferUploadStreams(Integer fileTransferUploadStreams) {
  ...
  public RedshiftSettings loadTimeout(Integer loadTimeout) {
  ...
  public RedshiftSettings maxFileSize(Integer maxFileSize) {
  ...
  public RedshiftSettings password(String password) {
  ...
  public RedshiftSettings port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public RedshiftSettings removeQuotes(Boolean removeQuotes) {
  ...
  public RedshiftSettings replaceInvalidChars(String replaceInvalidChars) {
  ...
  public RedshiftSettings replaceChars(String replaceChars) {
  ...
  public RedshiftSettings serverName(String serverName) {
  ...
  public RedshiftSettings serviceAccessRoleArn(String serviceAccessRoleArn) {
  ...
  public RedshiftSettings serverSideEncryptionKmsKeyId(String serverSideEncryptionKmsKeyId) {
  ...
  public RedshiftSettings timeFormat(String timeFormat) {
  ...
  public RedshiftSettings trimBlanks(Boolean trimBlanks) {
  ...
  public RedshiftSettings truncateColumns(Boolean truncateColumns) {
  ...
  public RedshiftSettings username(String username) {
  ...
  public RedshiftSettings writeBufferSize(Integer writeBufferSize) {
  ...
  public RedshiftSettings secretsManagerAccessRoleArn(String secretsManagerAccessRoleArn) {
  ...
  public RedshiftSettings secretsManagerSecretId(String secretsManagerSecretId) {
  ...
  public RedshiftSettings mapBooleanAsBoolean(Boolean mapBooleanAsBoolean) {
  ...
  public boolean equals(Object o) {
    ...
    RedshiftSettings redshiftSettings = (RedshiftSettings) o;
    return Objects.equals(this.acceptAnyDate, redshiftSettings.acceptAnyDate) &&
        Objects.equals(this.afterConnectScript, redshiftSettings.afterConnectScript) &&
        Objects.equals(this.bucketFolder, redshiftSettings.bucketFolder) &&
        Objects.equals(this.bucketName, redshiftSettings.bucketName) &&
        Objects.equals(this.caseSensitiveNames, redshiftSettings.caseSensitiveNames) &&
        Objects.equals(this.compUpdate, redshiftSettings.compUpdate) &&
        Objects.equals(this.connectionTimeout, redshiftSettings.connectionTimeout) &&
        Objects.equals(this.databaseName, redshiftSettings.databaseName) &&
        Objects.equals(this.dateFormat, redshiftSettings.dateFormat) &&
        Objects.equals(this.emptyAsNull, redshiftSettings.emptyAsNull) &&
        Objects.equals(this.encryptionMode, redshiftSettings.encryptionMode) &&
        Objects.equals(this.explicitIds, redshiftSettings.explicitIds) &&
        Objects.equals(this.fileTransferUploadStreams, redshiftSettings.fileTransferUploadStreams) &&
        Objects.equals(this.loadTimeout, redshiftSettings.loadTimeout) &&
        Objects.equals(this.maxFileSize, redshiftSettings.maxFileSize) &&
        Objects.equals(this.password, redshiftSettings.password) &&
        Objects.equals(this.port, redshiftSettings.port) &&
        Objects.equals(this.removeQuotes, redshiftSettings.removeQuotes) &&
        Objects.equals(this.replaceInvalidChars, redshiftSettings.replaceInvalidChars) &&
        Objects.equals(this.replaceChars, redshiftSettings.replaceChars) &&
        Objects.equals(this.serverName, redshiftSettings.serverName) &&
        Objects.equals(this.serviceAccessRoleArn, redshiftSettings.serviceAccessRoleArn) &&
        Objects.equals(this.serverSideEncryptionKmsKeyId, redshiftSettings.serverSideEncryptionKmsKeyId) &&
        Objects.equals(this.timeFormat, redshiftSettings.timeFormat) &&
        Objects.equals(this.trimBlanks, redshiftSettings.trimBlanks) &&
        Objects.equals(this.truncateColumns, redshiftSettings.truncateColumns) &&
        Objects.equals(this.username, redshiftSettings.username) &&
        Objects.equals(this.writeBufferSize, redshiftSettings.writeBufferSize) &&
        Objects.equals(this.secretsManagerAccessRoleArn, redshiftSettings.secretsManagerAccessRoleArn) &&
        Objects.equals(this.secretsManagerSecretId, redshiftSettings.secretsManagerSecretId) &&
        Objects.equals(this.mapBooleanAsBoolean, redshiftSettings.mapBooleanAsBoolean);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedshiftSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RedshiftSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RedshiftSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedshiftSettings is not found in the empty JSON string", RedshiftSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RedshiftSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RedshiftSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedshiftSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedshiftSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedshiftSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedshiftSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<RedshiftSettings>() {
           @Override
           public void write(JsonWriter out, RedshiftSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RedshiftSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RedshiftSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RedshiftSettings
   * @throws IOException if the JSON string is invalid with respect to RedshiftSettings
   */
  public static RedshiftSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedshiftSettings.class);
  }

  /**
   * Convert an instance of RedshiftSettings to an JSON string
   *
   * @return JSON string
   */
