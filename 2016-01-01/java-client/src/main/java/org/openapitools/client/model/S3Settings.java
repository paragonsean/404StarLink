...
public class S3Settings {
  ...
  public S3Settings serviceAccessRoleArn(String serviceAccessRoleArn) {
  ...
  public S3Settings externalTableDefinition(String externalTableDefinition) {
  ...
  public S3Settings csvRowDelimiter(String csvRowDelimiter) {
  ...
  public S3Settings csvDelimiter(String csvDelimiter) {
  ...
  public S3Settings bucketFolder(String bucketFolder) {
  ...
  public S3Settings bucketName(String bucketName) {
  ...
  public S3Settings compressionType(CompressionTypeValue compressionType) {
  ...
  public S3Settings encryptionMode(EncryptionModeValue encryptionMode) {
  ...
  public S3Settings serverSideEncryptionKmsKeyId(String serverSideEncryptionKmsKeyId) {
  ...
  public S3Settings dataFormat(DataFormatValue dataFormat) {
  ...
  public S3Settings encodingType(EncodingTypeValue encodingType) {
  ...
  public S3Settings dictPageSizeLimit(Integer dictPageSizeLimit) {
  ...
  public S3Settings rowGroupLength(Integer rowGroupLength) {
  ...
  public S3Settings dataPageSize(Integer dataPageSize) {
  ...
  public S3Settings parquetVersion(ParquetVersionValue parquetVersion) {
  ...
  public S3Settings enableStatistics(Boolean enableStatistics) {
  ...
  public S3Settings includeOpForFullLoad(Boolean includeOpForFullLoad) {
  ...
  public S3Settings cdcInsertsOnly(Boolean cdcInsertsOnly) {
  ...
  public S3Settings timestampColumnName(String timestampColumnName) {
  ...
  public S3Settings parquetTimestampInMillisecond(Boolean parquetTimestampInMillisecond) {
  ...
  public S3Settings cdcInsertsAndUpdates(Boolean cdcInsertsAndUpdates) {
  ...
  public S3Settings datePartitionEnabled(Boolean datePartitionEnabled) {
  ...
  public S3Settings datePartitionSequence(DatePartitionSequenceValue datePartitionSequence) {
  ...
  public S3Settings datePartitionDelimiter(DatePartitionDelimiterValue datePartitionDelimiter) {
  ...
  public S3Settings useCsvNoSupValue(Boolean useCsvNoSupValue) {
  ...
  public S3Settings csvNoSupValue(String csvNoSupValue) {
  ...
  public S3Settings preserveTransactions(Boolean preserveTransactions) {
  ...
  public S3Settings cdcPath(String cdcPath) {
  ...
  public S3Settings useTaskStartTimeForFullLoadTimestamp(Boolean useTaskStartTimeForFullLoadTimestamp) {
  ...
  public S3Settings cannedAclForObjects(CannedAclForObjectsValue cannedAclForObjects) {
  ...
  public S3Settings addColumnName(Boolean addColumnName) {
  ...
  public S3Settings cdcMaxBatchInterval(Integer cdcMaxBatchInterval) {
  ...
  public S3Settings cdcMinFileSize(Integer cdcMinFileSize) {
  ...
  public S3Settings csvNullValue(String csvNullValue) {
  ...
  public S3Settings ignoreHeaderRows(Integer ignoreHeaderRows) {
  ...
  public S3Settings maxFileSize(Integer maxFileSize) {
  ...
  public S3Settings rfc4180(Boolean rfc4180) {
  ...
  public S3Settings datePartitionTimezone(String datePartitionTimezone) {
  ...
  public S3Settings addTrailingPaddingCharacter(Boolean addTrailingPaddingCharacter) {
  ...
  public S3Settings expectedBucketOwner(String expectedBucketOwner) {
  ...
  public S3Settings glueCatalogGeneration(Boolean glueCatalogGeneration) {
  ...
  public boolean equals(Object o) {
    ...
    S3Settings s3Settings = (S3Settings) o;
    return Objects.equals(this.serviceAccessRoleArn, s3Settings.serviceAccessRoleArn) &&
        Objects.equals(this.externalTableDefinition, s3Settings.externalTableDefinition) &&
        Objects.equals(this.csvRowDelimiter, s3Settings.csvRowDelimiter) &&
        Objects.equals(this.csvDelimiter, s3Settings.csvDelimiter) &&
        Objects.equals(this.bucketFolder, s3Settings.bucketFolder) &&
        Objects.equals(this.bucketName, s3Settings.bucketName) &&
        Objects.equals(this.compressionType, s3Settings.compressionType) &&
        Objects.equals(this.encryptionMode, s3Settings.encryptionMode) &&
        Objects.equals(this.serverSideEncryptionKmsKeyId, s3Settings.serverSideEncryptionKmsKeyId) &&
        Objects.equals(this.dataFormat, s3Settings.dataFormat) &&
        Objects.equals(this.encodingType, s3Settings.encodingType) &&
        Objects.equals(this.dictPageSizeLimit, s3Settings.dictPageSizeLimit) &&
        Objects.equals(this.rowGroupLength, s3Settings.rowGroupLength) &&
        Objects.equals(this.dataPageSize, s3Settings.dataPageSize) &&
        Objects.equals(this.parquetVersion, s3Settings.parquetVersion) &&
        Objects.equals(this.enableStatistics, s3Settings.enableStatistics) &&
        Objects.equals(this.includeOpForFullLoad, s3Settings.includeOpForFullLoad) &&
        Objects.equals(this.cdcInsertsOnly, s3Settings.cdcInsertsOnly) &&
        Objects.equals(this.timestampColumnName, s3Settings.timestampColumnName) &&
        Objects.equals(this.parquetTimestampInMillisecond, s3Settings.parquetTimestampInMillisecond) &&
        Objects.equals(this.cdcInsertsAndUpdates, s3Settings.cdcInsertsAndUpdates) &&
        Objects.equals(this.datePartitionEnabled, s3Settings.datePartitionEnabled) &&
        Objects.equals(this.datePartitionSequence, s3Settings.datePartitionSequence) &&
        Objects.equals(this.datePartitionDelimiter, s3Settings.datePartitionDelimiter) &&
        Objects.equals(this.useCsvNoSupValue, s3Settings.useCsvNoSupValue) &&
        Objects.equals(this.csvNoSupValue, s3Settings.csvNoSupValue) &&
        Objects.equals(this.preserveTransactions, s3Settings.preserveTransactions) &&
        Objects.equals(this.cdcPath, s3Settings.cdcPath) &&
        Objects.equals(this.useTaskStartTimeForFullLoadTimestamp, s3Settings.useTaskStartTimeForFullLoadTimestamp) &&
        Objects.equals(this.cannedAclForObjects, s3Settings.cannedAclForObjects) &&
        Objects.equals(this.addColumnName, s3Settings.addColumnName) &&
        Objects.equals(this.cdcMaxBatchInterval, s3Settings.cdcMaxBatchInterval) &&
        Objects.equals(this.cdcMinFileSize, s3Settings.cdcMinFileSize) &&
        Objects.equals(this.csvNullValue, s3Settings.csvNullValue) &&
        Objects.equals(this.ignoreHeaderRows, s3Settings.ignoreHeaderRows) &&
        Objects.equals(this.maxFileSize, s3Settings.maxFileSize) &&
        Objects.equals(this.rfc4180, s3Settings.rfc4180) &&
        Objects.equals(this.datePartitionTimezone, s3Settings.datePartitionTimezone) &&
        Objects.equals(this.addTrailingPaddingCharacter, s3Settings.addTrailingPaddingCharacter) &&
        Objects.equals(this.expectedBucketOwner, s3Settings.expectedBucketOwner) &&
        Objects.equals(this.glueCatalogGeneration, s3Settings.glueCatalogGeneration);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to S3Settings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!S3Settings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in S3Settings is not found in the empty JSON string", S3Settings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!S3Settings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `S3Settings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!S3Settings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'S3Settings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<S3Settings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(S3Settings.class));

       return (TypeAdapter<T>) new TypeAdapter<S3Settings>() {
           @Override
           public void write(JsonWriter out, S3Settings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public S3Settings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of S3Settings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of S3Settings
   * @throws IOException if the JSON string is invalid with respect to S3Settings
   */
  public static S3Settings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, S3Settings.class);
  }

  /**
   * Convert an instance of S3Settings to an JSON string
   *
   * @return JSON string
   */
