...
public class DeleteReplicationTaskResponseReplicationTask {
  ...
  public DeleteReplicationTaskResponseReplicationTask() {
  }

  public DeleteReplicationTaskResponseReplicationTask replicationTaskIdentifier(String replicationTaskIdentifier) {
  ...
  public DeleteReplicationTaskResponseReplicationTask sourceEndpointArn(String sourceEndpointArn) {
  ...
  public DeleteReplicationTaskResponseReplicationTask targetEndpointArn(String targetEndpointArn) {
  ...
  public DeleteReplicationTaskResponseReplicationTask replicationInstanceArn(String replicationInstanceArn) {
  ...
  public DeleteReplicationTaskResponseReplicationTask migrationType(MigrationTypeValue migrationType) {
  ...
  public DeleteReplicationTaskResponseReplicationTask tableMappings(String tableMappings) {
  ...
  public DeleteReplicationTaskResponseReplicationTask replicationTaskSettings(String replicationTaskSettings) {
  ...
  public DeleteReplicationTaskResponseReplicationTask status(String status) {
    this.status = status;
    return this;
  }
  ...
  public DeleteReplicationTaskResponseReplicationTask lastFailureMessage(String lastFailureMessage) {
  ...
  public DeleteReplicationTaskResponseReplicationTask stopReason(String stopReason) {
  ...
  public DeleteReplicationTaskResponseReplicationTask replicationTaskCreationDate(OffsetDateTime replicationTaskCreationDate) {
  ...
  public DeleteReplicationTaskResponseReplicationTask replicationTaskStartDate(OffsetDateTime replicationTaskStartDate) {
  ...
  public DeleteReplicationTaskResponseReplicationTask cdcStartPosition(String cdcStartPosition) {
  ...
  public DeleteReplicationTaskResponseReplicationTask cdcStopPosition(String cdcStopPosition) {
  ...
  public DeleteReplicationTaskResponseReplicationTask recoveryCheckpoint(String recoveryCheckpoint) {
  ...
  public DeleteReplicationTaskResponseReplicationTask replicationTaskArn(String replicationTaskArn) {
  ...
  public DeleteReplicationTaskResponseReplicationTask replicationTaskStats(ReplicationTaskReplicationTaskStats replicationTaskStats) {
  ...
  public DeleteReplicationTaskResponseReplicationTask taskData(String taskData) {
  ...
  public DeleteReplicationTaskResponseReplicationTask targetReplicationInstanceArn(String targetReplicationInstanceArn) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteReplicationTaskResponseReplicationTask deleteReplicationTaskResponseReplicationTask = (DeleteReplicationTaskResponseReplicationTask) o;
    return Objects.equals(this.replicationTaskIdentifier, deleteReplicationTaskResponseReplicationTask.replicationTaskIdentifier) &&
        Objects.equals(this.sourceEndpointArn, deleteReplicationTaskResponseReplicationTask.sourceEndpointArn) &&
        Objects.equals(this.targetEndpointArn, deleteReplicationTaskResponseReplicationTask.targetEndpointArn) &&
        Objects.equals(this.replicationInstanceArn, deleteReplicationTaskResponseReplicationTask.replicationInstanceArn) &&
        Objects.equals(this.migrationType, deleteReplicationTaskResponseReplicationTask.migrationType) &&
        Objects.equals(this.tableMappings, deleteReplicationTaskResponseReplicationTask.tableMappings) &&
        Objects.equals(this.replicationTaskSettings, deleteReplicationTaskResponseReplicationTask.replicationTaskSettings) &&
        Objects.equals(this.status, deleteReplicationTaskResponseReplicationTask.status) &&
        Objects.equals(this.lastFailureMessage, deleteReplicationTaskResponseReplicationTask.lastFailureMessage) &&
        Objects.equals(this.stopReason, deleteReplicationTaskResponseReplicationTask.stopReason) &&
        Objects.equals(this.replicationTaskCreationDate, deleteReplicationTaskResponseReplicationTask.replicationTaskCreationDate) &&
        Objects.equals(this.replicationTaskStartDate, deleteReplicationTaskResponseReplicationTask.replicationTaskStartDate) &&
        Objects.equals(this.cdcStartPosition, deleteReplicationTaskResponseReplicationTask.cdcStartPosition) &&
        Objects.equals(this.cdcStopPosition, deleteReplicationTaskResponseReplicationTask.cdcStopPosition) &&
        Objects.equals(this.recoveryCheckpoint, deleteReplicationTaskResponseReplicationTask.recoveryCheckpoint) &&
        Objects.equals(this.replicationTaskArn, deleteReplicationTaskResponseReplicationTask.replicationTaskArn) &&
        Objects.equals(this.replicationTaskStats, deleteReplicationTaskResponseReplicationTask.replicationTaskStats) &&
        Objects.equals(this.taskData, deleteReplicationTaskResponseReplicationTask.taskData) &&
        Objects.equals(this.targetReplicationInstanceArn, deleteReplicationTaskResponseReplicationTask.targetReplicationInstanceArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteReplicationTaskResponseReplicationTask {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteReplicationTaskResponseReplicationTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteReplicationTaskResponseReplicationTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteReplicationTaskResponseReplicationTask is not found in the empty JSON string", DeleteReplicationTaskResponseReplicationTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteReplicationTaskResponseReplicationTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeleteReplicationTaskResponseReplicationTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteReplicationTaskResponseReplicationTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteReplicationTaskResponseReplicationTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteReplicationTaskResponseReplicationTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteReplicationTaskResponseReplicationTask.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteReplicationTaskResponseReplicationTask>() {
           @Override
           public void write(JsonWriter out, DeleteReplicationTaskResponseReplicationTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteReplicationTaskResponseReplicationTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteReplicationTaskResponseReplicationTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteReplicationTaskResponseReplicationTask
   * @throws IOException if the JSON string is invalid with respect to DeleteReplicationTaskResponseReplicationTask
   */
  public static DeleteReplicationTaskResponseReplicationTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteReplicationTaskResponseReplicationTask.class);
  }

  /**
   * Convert an instance of DeleteReplicationTaskResponseReplicationTask to an JSON string
   *
   * @return JSON string
   */
