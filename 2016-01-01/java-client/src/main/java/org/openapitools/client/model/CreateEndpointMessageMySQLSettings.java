...
public class CreateEndpointMessageMySQLSettings {
  ...
  public CreateEndpointMessageMySQLSettings() {
  }

  public CreateEndpointMessageMySQLSettings afterConnectScript(String afterConnectScript) {
  ...
  public CreateEndpointMessageMySQLSettings cleanSourceMetadataOnMismatch(Boolean cleanSourceMetadataOnMismatch) {
  ...
  public CreateEndpointMessageMySQLSettings databaseName(String databaseName) {
  ...
  public CreateEndpointMessageMySQLSettings eventsPollInterval(Integer eventsPollInterval) {
  ...
  public CreateEndpointMessageMySQLSettings targetDbType(TargetDbType targetDbType) {
  ...
  public CreateEndpointMessageMySQLSettings maxFileSize(Integer maxFileSize) {
  ...
  public CreateEndpointMessageMySQLSettings parallelLoadThreads(Integer parallelLoadThreads) {
  ...
  public CreateEndpointMessageMySQLSettings password(String password) {
  ...
  public CreateEndpointMessageMySQLSettings port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public CreateEndpointMessageMySQLSettings serverName(String serverName) {
  ...
  public CreateEndpointMessageMySQLSettings serverTimezone(String serverTimezone) {
  ...
  public CreateEndpointMessageMySQLSettings username(String username) {
  ...
  public CreateEndpointMessageMySQLSettings secretsManagerAccessRoleArn(String secretsManagerAccessRoleArn) {
  ...
  public CreateEndpointMessageMySQLSettings secretsManagerSecretId(String secretsManagerSecretId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateEndpointMessageMySQLSettings createEndpointMessageMySQLSettings = (CreateEndpointMessageMySQLSettings) o;
    return Objects.equals(this.afterConnectScript, createEndpointMessageMySQLSettings.afterConnectScript) &&
        Objects.equals(this.cleanSourceMetadataOnMismatch, createEndpointMessageMySQLSettings.cleanSourceMetadataOnMismatch) &&
        Objects.equals(this.databaseName, createEndpointMessageMySQLSettings.databaseName) &&
        Objects.equals(this.eventsPollInterval, createEndpointMessageMySQLSettings.eventsPollInterval) &&
        Objects.equals(this.targetDbType, createEndpointMessageMySQLSettings.targetDbType) &&
        Objects.equals(this.maxFileSize, createEndpointMessageMySQLSettings.maxFileSize) &&
        Objects.equals(this.parallelLoadThreads, createEndpointMessageMySQLSettings.parallelLoadThreads) &&
        Objects.equals(this.password, createEndpointMessageMySQLSettings.password) &&
        Objects.equals(this.port, createEndpointMessageMySQLSettings.port) &&
        Objects.equals(this.serverName, createEndpointMessageMySQLSettings.serverName) &&
        Objects.equals(this.serverTimezone, createEndpointMessageMySQLSettings.serverTimezone) &&
        Objects.equals(this.username, createEndpointMessageMySQLSettings.username) &&
        Objects.equals(this.secretsManagerAccessRoleArn, createEndpointMessageMySQLSettings.secretsManagerAccessRoleArn) &&
        Objects.equals(this.secretsManagerSecretId, createEndpointMessageMySQLSettings.secretsManagerSecretId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEndpointMessageMySQLSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateEndpointMessageMySQLSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEndpointMessageMySQLSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEndpointMessageMySQLSettings is not found in the empty JSON string", CreateEndpointMessageMySQLSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEndpointMessageMySQLSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateEndpointMessageMySQLSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEndpointMessageMySQLSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEndpointMessageMySQLSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEndpointMessageMySQLSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEndpointMessageMySQLSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEndpointMessageMySQLSettings>() {
           @Override
           public void write(JsonWriter out, CreateEndpointMessageMySQLSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateEndpointMessageMySQLSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateEndpointMessageMySQLSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateEndpointMessageMySQLSettings
   * @throws IOException if the JSON string is invalid with respect to CreateEndpointMessageMySQLSettings
   */
  public static CreateEndpointMessageMySQLSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEndpointMessageMySQLSettings.class);
  }

  /**
   * Convert an instance of CreateEndpointMessageMySQLSettings to an JSON string
   *
   * @return JSON string
   */
