...
public class ModifyReplicationTaskResponseReplicationTask {
  ...
  public ModifyReplicationTaskResponseReplicationTask() {
  }

  public ModifyReplicationTaskResponseReplicationTask replicationTaskIdentifier(String replicationTaskIdentifier) {
  ...
  public ModifyReplicationTaskResponseReplicationTask sourceEndpointArn(String sourceEndpointArn) {
  ...
  public ModifyReplicationTaskResponseReplicationTask targetEndpointArn(String targetEndpointArn) {
  ...
  public ModifyReplicationTaskResponseReplicationTask replicationInstanceArn(String replicationInstanceArn) {
  ...
  public ModifyReplicationTaskResponseReplicationTask migrationType(MigrationTypeValue migrationType) {
  ...
  public ModifyReplicationTaskResponseReplicationTask tableMappings(String tableMappings) {
  ...
  public ModifyReplicationTaskResponseReplicationTask replicationTaskSettings(String replicationTaskSettings) {
  ...
  public ModifyReplicationTaskResponseReplicationTask status(String status) {
    this.status = status;
    return this;
  }
  ...
  public ModifyReplicationTaskResponseReplicationTask lastFailureMessage(String lastFailureMessage) {
  ...
  public ModifyReplicationTaskResponseReplicationTask stopReason(String stopReason) {
  ...
  public ModifyReplicationTaskResponseReplicationTask replicationTaskCreationDate(OffsetDateTime replicationTaskCreationDate) {
  ...
  public ModifyReplicationTaskResponseReplicationTask replicationTaskStartDate(OffsetDateTime replicationTaskStartDate) {
  ...
  public ModifyReplicationTaskResponseReplicationTask cdcStartPosition(String cdcStartPosition) {
  ...
  public ModifyReplicationTaskResponseReplicationTask cdcStopPosition(String cdcStopPosition) {
  ...
  public ModifyReplicationTaskResponseReplicationTask recoveryCheckpoint(String recoveryCheckpoint) {
  ...
  public ModifyReplicationTaskResponseReplicationTask replicationTaskArn(String replicationTaskArn) {
  ...
  public ModifyReplicationTaskResponseReplicationTask replicationTaskStats(ReplicationTaskReplicationTaskStats replicationTaskStats) {
  ...
  public ModifyReplicationTaskResponseReplicationTask taskData(String taskData) {
  ...
  public ModifyReplicationTaskResponseReplicationTask targetReplicationInstanceArn(String targetReplicationInstanceArn) {
  ...
  public boolean equals(Object o) {
    ...
    ModifyReplicationTaskResponseReplicationTask modifyReplicationTaskResponseReplicationTask = (ModifyReplicationTaskResponseReplicationTask) o;
    return Objects.equals(this.replicationTaskIdentifier, modifyReplicationTaskResponseReplicationTask.replicationTaskIdentifier) &&
        Objects.equals(this.sourceEndpointArn, modifyReplicationTaskResponseReplicationTask.sourceEndpointArn) &&
        Objects.equals(this.targetEndpointArn, modifyReplicationTaskResponseReplicationTask.targetEndpointArn) &&
        Objects.equals(this.replicationInstanceArn, modifyReplicationTaskResponseReplicationTask.replicationInstanceArn) &&
        Objects.equals(this.migrationType, modifyReplicationTaskResponseReplicationTask.migrationType) &&
        Objects.equals(this.tableMappings, modifyReplicationTaskResponseReplicationTask.tableMappings) &&
        Objects.equals(this.replicationTaskSettings, modifyReplicationTaskResponseReplicationTask.replicationTaskSettings) &&
        Objects.equals(this.status, modifyReplicationTaskResponseReplicationTask.status) &&
        Objects.equals(this.lastFailureMessage, modifyReplicationTaskResponseReplicationTask.lastFailureMessage) &&
        Objects.equals(this.stopReason, modifyReplicationTaskResponseReplicationTask.stopReason) &&
        Objects.equals(this.replicationTaskCreationDate, modifyReplicationTaskResponseReplicationTask.replicationTaskCreationDate) &&
        Objects.equals(this.replicationTaskStartDate, modifyReplicationTaskResponseReplicationTask.replicationTaskStartDate) &&
        Objects.equals(this.cdcStartPosition, modifyReplicationTaskResponseReplicationTask.cdcStartPosition) &&
        Objects.equals(this.cdcStopPosition, modifyReplicationTaskResponseReplicationTask.cdcStopPosition) &&
        Objects.equals(this.recoveryCheckpoint, modifyReplicationTaskResponseReplicationTask.recoveryCheckpoint) &&
        Objects.equals(this.replicationTaskArn, modifyReplicationTaskResponseReplicationTask.replicationTaskArn) &&
        Objects.equals(this.replicationTaskStats, modifyReplicationTaskResponseReplicationTask.replicationTaskStats) &&
        Objects.equals(this.taskData, modifyReplicationTaskResponseReplicationTask.taskData) &&
        Objects.equals(this.targetReplicationInstanceArn, modifyReplicationTaskResponseReplicationTask.targetReplicationInstanceArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModifyReplicationTaskResponseReplicationTask {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModifyReplicationTaskResponseReplicationTask
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModifyReplicationTaskResponseReplicationTask.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ModifyReplicationTaskResponseReplicationTask is not found in the empty JSON string", ModifyReplicationTaskResponseReplicationTask.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModifyReplicationTaskResponseReplicationTask.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ModifyReplicationTaskResponseReplicationTask` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModifyReplicationTaskResponseReplicationTask.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModifyReplicationTaskResponseReplicationTask' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModifyReplicationTaskResponseReplicationTask> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModifyReplicationTaskResponseReplicationTask.class));

       return (TypeAdapter<T>) new TypeAdapter<ModifyReplicationTaskResponseReplicationTask>() {
           @Override
           public void write(JsonWriter out, ModifyReplicationTaskResponseReplicationTask value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModifyReplicationTaskResponseReplicationTask read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModifyReplicationTaskResponseReplicationTask given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModifyReplicationTaskResponseReplicationTask
   * @throws IOException if the JSON string is invalid with respect to ModifyReplicationTaskResponseReplicationTask
   */
  public static ModifyReplicationTaskResponseReplicationTask fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModifyReplicationTaskResponseReplicationTask.class);
  }

  /**
   * Convert an instance of ModifyReplicationTaskResponseReplicationTask to an JSON string
   *
   * @return JSON string
   */
