...
public class EndpointElasticsearchSettings {
  ...
  public EndpointElasticsearchSettings serviceAccessRoleArn(String serviceAccessRoleArn) {
  ...
  public EndpointElasticsearchSettings endpointUri(String endpointUri) {
  ...
  public EndpointElasticsearchSettings fullLoadErrorPercentage(Integer fullLoadErrorPercentage) {
  ...
  public EndpointElasticsearchSettings errorRetryDuration(Integer errorRetryDuration) {
  ...
  public EndpointElasticsearchSettings useNewMappingType(Boolean useNewMappingType) {
  ...
  public boolean equals(Object o) {
    ...
    EndpointElasticsearchSettings endpointElasticsearchSettings = (EndpointElasticsearchSettings) o;
    return Objects.equals(this.serviceAccessRoleArn, endpointElasticsearchSettings.serviceAccessRoleArn) &&
        Objects.equals(this.endpointUri, endpointElasticsearchSettings.endpointUri) &&
        Objects.equals(this.fullLoadErrorPercentage, endpointElasticsearchSettings.fullLoadErrorPercentage) &&
        Objects.equals(this.errorRetryDuration, endpointElasticsearchSettings.errorRetryDuration) &&
        Objects.equals(this.useNewMappingType, endpointElasticsearchSettings.useNewMappingType);
  }
  ...
  public String toString() {
    ...
    sb.append("class EndpointElasticsearchSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EndpointElasticsearchSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointElasticsearchSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointElasticsearchSettings is not found in the empty JSON string", EndpointElasticsearchSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EndpointElasticsearchSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointElasticsearchSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EndpointElasticsearchSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointElasticsearchSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointElasticsearchSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointElasticsearchSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointElasticsearchSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointElasticsearchSettings>() {
           @Override
           public void write(JsonWriter out, EndpointElasticsearchSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EndpointElasticsearchSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EndpointElasticsearchSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EndpointElasticsearchSettings
   * @throws IOException if the JSON string is invalid with respect to EndpointElasticsearchSettings
   */
  public static EndpointElasticsearchSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointElasticsearchSettings.class);
  }

  /**
   * Convert an instance of EndpointElasticsearchSettings to an JSON string
   *
   * @return JSON string
   */
