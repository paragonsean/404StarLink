...
import org.openapitools.client.model.TestConnectionResponseConnection;
...
public class TestConnectionResponse {
  ...
  private TestConnectionResponseConnection connection;

  public TestConnectionResponse() {
  }

  public TestConnectionResponse connection(TestConnectionResponseConnection connection) {
  ...
  public TestConnectionResponseConnection getConnection() {
    return connection;
  }

  public void setConnection(TestConnectionResponseConnection connection) {
    this.connection = connection;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connection, testConnectionResponse.connection);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Connection") != null && !jsonObj.get("Connection").isJsonNull()) {
        TestConnectionResponseConnection.validateJsonElement(jsonObj.get("Connection"));
      }
  }
