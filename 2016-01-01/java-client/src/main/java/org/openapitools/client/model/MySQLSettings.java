...
public class MySQLSettings {
  ...
  public MySQLSettings afterConnectScript(String afterConnectScript) {
  ...
  public MySQLSettings cleanSourceMetadataOnMismatch(Boolean cleanSourceMetadataOnMismatch) {
  ...
  public MySQLSettings databaseName(String databaseName) {
  ...
  public MySQLSettings eventsPollInterval(Integer eventsPollInterval) {
  ...
  public MySQLSettings targetDbType(TargetDbType targetDbType) {
  ...
  public MySQLSettings maxFileSize(Integer maxFileSize) {
  ...
  public MySQLSettings parallelLoadThreads(Integer parallelLoadThreads) {
  ...
  public MySQLSettings password(String password) {
  ...
  public MySQLSettings port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public MySQLSettings serverName(String serverName) {
  ...
  public MySQLSettings serverTimezone(String serverTimezone) {
  ...
  public MySQLSettings username(String username) {
  ...
  public MySQLSettings secretsManagerAccessRoleArn(String secretsManagerAccessRoleArn) {
  ...
  public MySQLSettings secretsManagerSecretId(String secretsManagerSecretId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.afterConnectScript, mySQLSettings.afterConnectScript) &&
        Objects.equals(this.cleanSourceMetadataOnMismatch, mySQLSettings.cleanSourceMetadataOnMismatch) &&
        Objects.equals(this.databaseName, mySQLSettings.databaseName) &&
        Objects.equals(this.eventsPollInterval, mySQLSettings.eventsPollInterval) &&
        Objects.equals(this.targetDbType, mySQLSettings.targetDbType) &&
        Objects.equals(this.maxFileSize, mySQLSettings.maxFileSize) &&
        Objects.equals(this.parallelLoadThreads, mySQLSettings.parallelLoadThreads) &&
        Objects.equals(this.password, mySQLSettings.password) &&
        Objects.equals(this.port, mySQLSettings.port) &&
        Objects.equals(this.serverName, mySQLSettings.serverName) &&
        Objects.equals(this.serverTimezone, mySQLSettings.serverTimezone) &&
        Objects.equals(this.username, mySQLSettings.username) &&
        Objects.equals(this.secretsManagerAccessRoleArn, mySQLSettings.secretsManagerAccessRoleArn) &&
        Objects.equals(this.secretsManagerSecretId, mySQLSettings.secretsManagerSecretId);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MySQLSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MySQLSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MySQLSettings is not found in the empty JSON string", MySQLSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MySQLSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MySQLSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MySQLSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MySQLSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MySQLSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MySQLSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<MySQLSettings>() {
           @Override
           public void write(JsonWriter out, MySQLSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MySQLSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MySQLSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MySQLSettings
   * @throws IOException if the JSON string is invalid with respect to MySQLSettings
   */
  public static MySQLSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MySQLSettings.class);
  }

  /**
   * Convert an instance of MySQLSettings to an JSON string
   *
   * @return JSON string
   */
