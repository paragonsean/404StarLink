...
public class CreateEndpointMessageKinesisSettings {
  ...
  public CreateEndpointMessageKinesisSettings() {
  }

  public CreateEndpointMessageKinesisSettings streamArn(String streamArn) {
  ...
  public CreateEndpointMessageKinesisSettings messageFormat(MessageFormatValue messageFormat) {
  ...
  public CreateEndpointMessageKinesisSettings serviceAccessRoleArn(String serviceAccessRoleArn) {
  ...
  public CreateEndpointMessageKinesisSettings includeTransactionDetails(Boolean includeTransactionDetails) {
  ...
  public CreateEndpointMessageKinesisSettings includePartitionValue(Boolean includePartitionValue) {
  ...
  public CreateEndpointMessageKinesisSettings partitionIncludeSchemaTable(Boolean partitionIncludeSchemaTable) {
  ...
  public CreateEndpointMessageKinesisSettings includeTableAlterOperations(Boolean includeTableAlterOperations) {
  ...
  public CreateEndpointMessageKinesisSettings includeControlDetails(Boolean includeControlDetails) {
  ...
  public CreateEndpointMessageKinesisSettings includeNullAndEmpty(Boolean includeNullAndEmpty) {
  ...
  public CreateEndpointMessageKinesisSettings noHexPrefix(Boolean noHexPrefix) {
  ...
  public boolean equals(Object o) {
    ...
    CreateEndpointMessageKinesisSettings createEndpointMessageKinesisSettings = (CreateEndpointMessageKinesisSettings) o;
    return Objects.equals(this.streamArn, createEndpointMessageKinesisSettings.streamArn) &&
        Objects.equals(this.messageFormat, createEndpointMessageKinesisSettings.messageFormat) &&
        Objects.equals(this.serviceAccessRoleArn, createEndpointMessageKinesisSettings.serviceAccessRoleArn) &&
        Objects.equals(this.includeTransactionDetails, createEndpointMessageKinesisSettings.includeTransactionDetails) &&
        Objects.equals(this.includePartitionValue, createEndpointMessageKinesisSettings.includePartitionValue) &&
        Objects.equals(this.partitionIncludeSchemaTable, createEndpointMessageKinesisSettings.partitionIncludeSchemaTable) &&
        Objects.equals(this.includeTableAlterOperations, createEndpointMessageKinesisSettings.includeTableAlterOperations) &&
        Objects.equals(this.includeControlDetails, createEndpointMessageKinesisSettings.includeControlDetails) &&
        Objects.equals(this.includeNullAndEmpty, createEndpointMessageKinesisSettings.includeNullAndEmpty) &&
        Objects.equals(this.noHexPrefix, createEndpointMessageKinesisSettings.noHexPrefix);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateEndpointMessageKinesisSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateEndpointMessageKinesisSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEndpointMessageKinesisSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateEndpointMessageKinesisSettings is not found in the empty JSON string", CreateEndpointMessageKinesisSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEndpointMessageKinesisSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateEndpointMessageKinesisSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateEndpointMessageKinesisSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateEndpointMessageKinesisSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateEndpointMessageKinesisSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateEndpointMessageKinesisSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateEndpointMessageKinesisSettings>() {
           @Override
           public void write(JsonWriter out, CreateEndpointMessageKinesisSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateEndpointMessageKinesisSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateEndpointMessageKinesisSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateEndpointMessageKinesisSettings
   * @throws IOException if the JSON string is invalid with respect to CreateEndpointMessageKinesisSettings
   */
  public static CreateEndpointMessageKinesisSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateEndpointMessageKinesisSettings.class);
  }

  /**
   * Convert an instance of CreateEndpointMessageKinesisSettings to an JSON string
   *
   * @return JSON string
   */
