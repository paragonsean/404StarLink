...
public class ReplicationInstance {
  ...
  public ReplicationInstance replicationInstanceIdentifier(String replicationInstanceIdentifier) {
  ...
  public ReplicationInstance replicationInstanceClass(String replicationInstanceClass) {
  ...
  public ReplicationInstance replicationInstanceStatus(String replicationInstanceStatus) {
  ...
  public ReplicationInstance allocatedStorage(Integer allocatedStorage) {
  ...
  public ReplicationInstance instanceCreateTime(OffsetDateTime instanceCreateTime) {
  ...
  public ReplicationInstance vpcSecurityGroups(List vpcSecurityGroups) {
  ...
  public ReplicationInstance availabilityZone(String availabilityZone) {
  ...
  public ReplicationInstance replicationSubnetGroup(ReplicationInstanceReplicationSubnetGroup replicationSubnetGroup) {
  ...
  public ReplicationInstance preferredMaintenanceWindow(String preferredMaintenanceWindow) {
  ...
  public ReplicationInstance pendingModifiedValues(ReplicationInstancePendingModifiedValues pendingModifiedValues) {
  ...
  public ReplicationInstance multiAZ(Boolean multiAZ) {
  ...
  public ReplicationInstance engineVersion(String engineVersion) {
  ...
  public ReplicationInstance autoMinorVersionUpgrade(Boolean autoMinorVersionUpgrade) {
  ...
  public ReplicationInstance kmsKeyId(String kmsKeyId) {
  ...
  public ReplicationInstance replicationInstanceArn(String replicationInstanceArn) {
  ...
  public ReplicationInstance replicationInstancePublicIpAddress(String replicationInstancePublicIpAddress) {
  ...
  public ReplicationInstance replicationInstancePrivateIpAddress(String replicationInstancePrivateIpAddress) {
  ...
  public ReplicationInstance replicationInstancePublicIpAddresses(List replicationInstancePublicIpAddresses) {
  ...
  public ReplicationInstance replicationInstancePrivateIpAddresses(List replicationInstancePrivateIpAddresses) {
  ...
  public ReplicationInstance replicationInstanceIpv6Addresses(List replicationInstanceIpv6Addresses) {
  ...
  public ReplicationInstance publiclyAccessible(Boolean publiclyAccessible) {
  ...
  public ReplicationInstance secondaryAvailabilityZone(String secondaryAvailabilityZone) {
  ...
  public ReplicationInstance freeUntil(OffsetDateTime freeUntil) {
  ...
  public ReplicationInstance dnsNameServers(String dnsNameServers) {
  ...
  public ReplicationInstance networkType(String networkType) {
  ...
  public boolean equals(Object o) {
    ...
    ReplicationInstance replicationInstance = (ReplicationInstance) o;
    return Objects.equals(this.replicationInstanceIdentifier, replicationInstance.replicationInstanceIdentifier) &&
        Objects.equals(this.replicationInstanceClass, replicationInstance.replicationInstanceClass) &&
        Objects.equals(this.replicationInstanceStatus, replicationInstance.replicationInstanceStatus) &&
        Objects.equals(this.allocatedStorage, replicationInstance.allocatedStorage) &&
        Objects.equals(this.instanceCreateTime, replicationInstance.instanceCreateTime) &&
        Objects.equals(this.vpcSecurityGroups, replicationInstance.vpcSecurityGroups) &&
        Objects.equals(this.availabilityZone, replicationInstance.availabilityZone) &&
        Objects.equals(this.replicationSubnetGroup, replicationInstance.replicationSubnetGroup) &&
        Objects.equals(this.preferredMaintenanceWindow, replicationInstance.preferredMaintenanceWindow) &&
        Objects.equals(this.pendingModifiedValues, replicationInstance.pendingModifiedValues) &&
        Objects.equals(this.multiAZ, replicationInstance.multiAZ) &&
        Objects.equals(this.engineVersion, replicationInstance.engineVersion) &&
        Objects.equals(this.autoMinorVersionUpgrade, replicationInstance.autoMinorVersionUpgrade) &&
        Objects.equals(this.kmsKeyId, replicationInstance.kmsKeyId) &&
        Objects.equals(this.replicationInstanceArn, replicationInstance.replicationInstanceArn) &&
        Objects.equals(this.replicationInstancePublicIpAddress, replicationInstance.replicationInstancePublicIpAddress) &&
        Objects.equals(this.replicationInstancePrivateIpAddress, replicationInstance.replicationInstancePrivateIpAddress) &&
        Objects.equals(this.replicationInstancePublicIpAddresses, replicationInstance.replicationInstancePublicIpAddresses) &&
        Objects.equals(this.replicationInstancePrivateIpAddresses, replicationInstance.replicationInstancePrivateIpAddresses) &&
        Objects.equals(this.replicationInstanceIpv6Addresses, replicationInstance.replicationInstanceIpv6Addresses) &&
        Objects.equals(this.publiclyAccessible, replicationInstance.publiclyAccessible) &&
        Objects.equals(this.secondaryAvailabilityZone, replicationInstance.secondaryAvailabilityZone) &&
        Objects.equals(this.freeUntil, replicationInstance.freeUntil) &&
        Objects.equals(this.dnsNameServers, replicationInstance.dnsNameServers) &&
        Objects.equals(this.networkType, replicationInstance.networkType);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReplicationInstance {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReplicationInstance
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReplicationInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplicationInstance is not found in the empty JSON string", ReplicationInstance.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReplicationInstance.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReplicationInstance` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplicationInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplicationInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplicationInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplicationInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplicationInstance>() {
           @Override
           public void write(JsonWriter out, ReplicationInstance value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReplicationInstance read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReplicationInstance given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReplicationInstance
   * @throws IOException if the JSON string is invalid with respect to ReplicationInstance
   */
  public static ReplicationInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplicationInstance.class);
  }

  /**
   * Convert an instance of ReplicationInstance to an JSON string
   *
   * @return JSON string
   */
