...
public class EndpointMicrosoftSQLServerSettings {
  ...
  public EndpointMicrosoftSQLServerSettings() {
  }

  public EndpointMicrosoftSQLServerSettings port(Integer port) {
    this.port = port;
    return this;
  }
  ...
  public EndpointMicrosoftSQLServerSettings bcpPacketSize(Integer bcpPacketSize) {
  ...
  public EndpointMicrosoftSQLServerSettings databaseName(String databaseName) {
  ...
  public EndpointMicrosoftSQLServerSettings controlTablesFileGroup(String controlTablesFileGroup) {
  ...
  public EndpointMicrosoftSQLServerSettings password(String password) {
  ...
  public EndpointMicrosoftSQLServerSettings querySingleAlwaysOnNode(Boolean querySingleAlwaysOnNode) {
  ...
  public EndpointMicrosoftSQLServerSettings readBackupOnly(Boolean readBackupOnly) {
  ...
  public EndpointMicrosoftSQLServerSettings safeguardPolicy(SafeguardPolicy safeguardPolicy) {
  ...
  public EndpointMicrosoftSQLServerSettings serverName(String serverName) {
  ...
  public EndpointMicrosoftSQLServerSettings username(String username) {
  ...
  public EndpointMicrosoftSQLServerSettings useBcpFullLoad(Boolean useBcpFullLoad) {
  ...
  public EndpointMicrosoftSQLServerSettings useThirdPartyBackupDevice(Boolean useThirdPartyBackupDevice) {
  ...
  public EndpointMicrosoftSQLServerSettings secretsManagerAccessRoleArn(String secretsManagerAccessRoleArn) {
  ...
  public EndpointMicrosoftSQLServerSettings secretsManagerSecretId(String secretsManagerSecretId) {
  ...
  public EndpointMicrosoftSQLServerSettings trimSpaceInChar(Boolean trimSpaceInChar) {
  ...
  public EndpointMicrosoftSQLServerSettings tlogAccessMode(TlogAccessMode tlogAccessMode) {
  ...
  public EndpointMicrosoftSQLServerSettings forceLobLookup(Boolean forceLobLookup) {
  ...
  public boolean equals(Object o) {
    ...
    EndpointMicrosoftSQLServerSettings endpointMicrosoftSQLServerSettings = (EndpointMicrosoftSQLServerSettings) o;
    return Objects.equals(this.port, endpointMicrosoftSQLServerSettings.port) &&
        Objects.equals(this.bcpPacketSize, endpointMicrosoftSQLServerSettings.bcpPacketSize) &&
        Objects.equals(this.databaseName, endpointMicrosoftSQLServerSettings.databaseName) &&
        Objects.equals(this.controlTablesFileGroup, endpointMicrosoftSQLServerSettings.controlTablesFileGroup) &&
        Objects.equals(this.password, endpointMicrosoftSQLServerSettings.password) &&
        Objects.equals(this.querySingleAlwaysOnNode, endpointMicrosoftSQLServerSettings.querySingleAlwaysOnNode) &&
        Objects.equals(this.readBackupOnly, endpointMicrosoftSQLServerSettings.readBackupOnly) &&
        Objects.equals(this.safeguardPolicy, endpointMicrosoftSQLServerSettings.safeguardPolicy) &&
        Objects.equals(this.serverName, endpointMicrosoftSQLServerSettings.serverName) &&
        Objects.equals(this.username, endpointMicrosoftSQLServerSettings.username) &&
        Objects.equals(this.useBcpFullLoad, endpointMicrosoftSQLServerSettings.useBcpFullLoad) &&
        Objects.equals(this.useThirdPartyBackupDevice, endpointMicrosoftSQLServerSettings.useThirdPartyBackupDevice) &&
        Objects.equals(this.secretsManagerAccessRoleArn, endpointMicrosoftSQLServerSettings.secretsManagerAccessRoleArn) &&
        Objects.equals(this.secretsManagerSecretId, endpointMicrosoftSQLServerSettings.secretsManagerSecretId) &&
        Objects.equals(this.trimSpaceInChar, endpointMicrosoftSQLServerSettings.trimSpaceInChar) &&
        Objects.equals(this.tlogAccessMode, endpointMicrosoftSQLServerSettings.tlogAccessMode) &&
        Objects.equals(this.forceLobLookup, endpointMicrosoftSQLServerSettings.forceLobLookup);
  }
  ...
  public String toString() {
    ...
    sb.append("class EndpointMicrosoftSQLServerSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EndpointMicrosoftSQLServerSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EndpointMicrosoftSQLServerSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EndpointMicrosoftSQLServerSettings is not found in the empty JSON string", EndpointMicrosoftSQLServerSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EndpointMicrosoftSQLServerSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EndpointMicrosoftSQLServerSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EndpointMicrosoftSQLServerSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EndpointMicrosoftSQLServerSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EndpointMicrosoftSQLServerSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EndpointMicrosoftSQLServerSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<EndpointMicrosoftSQLServerSettings>() {
           @Override
           public void write(JsonWriter out, EndpointMicrosoftSQLServerSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EndpointMicrosoftSQLServerSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EndpointMicrosoftSQLServerSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EndpointMicrosoftSQLServerSettings
   * @throws IOException if the JSON string is invalid with respect to EndpointMicrosoftSQLServerSettings
   */
  public static EndpointMicrosoftSQLServerSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EndpointMicrosoftSQLServerSettings.class);
  }

  /**
   * Convert an instance of EndpointMicrosoftSQLServerSettings to an JSON string
   *
   * @return JSON string
   */
