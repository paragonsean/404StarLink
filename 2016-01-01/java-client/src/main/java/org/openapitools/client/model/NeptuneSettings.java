...
public class NeptuneSettings {
  ...
  public NeptuneSettings() {
  }

  public NeptuneSettings serviceAccessRoleArn(String serviceAccessRoleArn) {
  ...
  public NeptuneSettings s3BucketName(String s3BucketName) {
  ...
  public NeptuneSettings s3BucketFolder(String s3BucketFolder) {
  ...
  public NeptuneSettings errorRetryDuration(Integer errorRetryDuration) {
  ...
  public NeptuneSettings maxFileSize(Integer maxFileSize) {
  ...
  public NeptuneSettings maxRetryCount(Integer maxRetryCount) {
  ...
  public NeptuneSettings iamAuthEnabled(Boolean iamAuthEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    NeptuneSettings neptuneSettings = (NeptuneSettings) o;
    return Objects.equals(this.serviceAccessRoleArn, neptuneSettings.serviceAccessRoleArn) &&
        Objects.equals(this.s3BucketName, neptuneSettings.s3BucketName) &&
        Objects.equals(this.s3BucketFolder, neptuneSettings.s3BucketFolder) &&
        Objects.equals(this.errorRetryDuration, neptuneSettings.errorRetryDuration) &&
        Objects.equals(this.maxFileSize, neptuneSettings.maxFileSize) &&
        Objects.equals(this.maxRetryCount, neptuneSettings.maxRetryCount) &&
        Objects.equals(this.iamAuthEnabled, neptuneSettings.iamAuthEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class NeptuneSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NeptuneSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NeptuneSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NeptuneSettings is not found in the empty JSON string", NeptuneSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NeptuneSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NeptuneSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NeptuneSettings.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NeptuneSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NeptuneSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NeptuneSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NeptuneSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<NeptuneSettings>() {
           @Override
           public void write(JsonWriter out, NeptuneSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NeptuneSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NeptuneSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NeptuneSettings
   * @throws IOException if the JSON string is invalid with respect to NeptuneSettings
   */
  public static NeptuneSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NeptuneSettings.class);
  }

  /**
   * Convert an instance of NeptuneSettings to an JSON string
   *
   * @return JSON string
   */
