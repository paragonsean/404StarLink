...
public class AwsIamUserDetails {
  ...
  public AwsIamUserDetails attachedManagedPolicies(List attachedManagedPolicies) {
  ...
  public AwsIamUserDetails createDate(String createDate) {
  ...
  public AwsIamUserDetails groupList(List groupList) {
  ...
  public AwsIamUserDetails path(String path) {
    this.path = path;
    return this;
  }
  ...
  public AwsIamUserDetails permissionsBoundary(AwsIamUserDetailsPermissionsBoundary permissionsBoundary) {
  ...
  public AwsIamUserDetails userId(String userId) {
    this.userId = userId;
    return this;
  }
  ...
  public AwsIamUserDetails userName(String userName) {
  ...
  public AwsIamUserDetails userPolicyList(List userPolicyList) {
  ...
  public boolean equals(Object o) {
    ...
    AwsIamUserDetails awsIamUserDetails = (AwsIamUserDetails) o;
    return Objects.equals(this.attachedManagedPolicies, awsIamUserDetails.attachedManagedPolicies) &&
        Objects.equals(this.createDate, awsIamUserDetails.createDate) &&
        Objects.equals(this.groupList, awsIamUserDetails.groupList) &&
        Objects.equals(this.path, awsIamUserDetails.path) &&
        Objects.equals(this.permissionsBoundary, awsIamUserDetails.permissionsBoundary) &&
        Objects.equals(this.userId, awsIamUserDetails.userId) &&
        Objects.equals(this.userName, awsIamUserDetails.userName) &&
        Objects.equals(this.userPolicyList, awsIamUserDetails.userPolicyList);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsIamUserDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsIamUserDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsIamUserDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsIamUserDetails is not found in the empty JSON string", AwsIamUserDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsIamUserDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsIamUserDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsIamUserDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsIamUserDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsIamUserDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsIamUserDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsIamUserDetails>() {
           @Override
           public void write(JsonWriter out, AwsIamUserDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsIamUserDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsIamUserDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsIamUserDetails
   * @throws IOException if the JSON string is invalid with respect to AwsIamUserDetails
   */
  public static AwsIamUserDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsIamUserDetails.class);
  }

  /**
   * Convert an instance of AwsIamUserDetails to an JSON string
   *
   * @return JSON string
   */
