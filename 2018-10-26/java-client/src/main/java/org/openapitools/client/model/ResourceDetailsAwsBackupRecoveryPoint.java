...
public class ResourceDetailsAwsBackupRecoveryPoint {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint() {
  }

  public ResourceDetailsAwsBackupRecoveryPoint backupSizeInBytes(Integer backupSizeInBytes) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint backupVaultArn(String backupVaultArn) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint backupVaultName(String backupVaultName) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint calculatedLifecycle(AwsBackupRecoveryPointDetailsCalculatedLifecycle calculatedLifecycle) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint completionDate(String completionDate) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint createdBy(AwsBackupRecoveryPointDetailsCreatedBy createdBy) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint creationDate(String creationDate) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint encryptionKeyArn(String encryptionKeyArn) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint iamRoleArn(String iamRoleArn) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint isEncrypted(Boolean isEncrypted) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint lastRestoreTime(String lastRestoreTime) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint lifecycle(AwsBackupRecoveryPointDetailsLifecycle lifecycle) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint recoveryPointArn(String recoveryPointArn) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint resourceArn(String resourceArn) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint resourceType(String resourceType) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint sourceBackupVaultArn(String sourceBackupVaultArn) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint status(String status) {
    this.status = status;
    return this;
  }
  ...
  public ResourceDetailsAwsBackupRecoveryPoint statusMessage(String statusMessage) {
  ...
  public ResourceDetailsAwsBackupRecoveryPoint storageClass(String storageClass) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceDetailsAwsBackupRecoveryPoint resourceDetailsAwsBackupRecoveryPoint = (ResourceDetailsAwsBackupRecoveryPoint) o;
    return Objects.equals(this.backupSizeInBytes, resourceDetailsAwsBackupRecoveryPoint.backupSizeInBytes) &&
        Objects.equals(this.backupVaultArn, resourceDetailsAwsBackupRecoveryPoint.backupVaultArn) &&
        Objects.equals(this.backupVaultName, resourceDetailsAwsBackupRecoveryPoint.backupVaultName) &&
        Objects.equals(this.calculatedLifecycle, resourceDetailsAwsBackupRecoveryPoint.calculatedLifecycle) &&
        Objects.equals(this.completionDate, resourceDetailsAwsBackupRecoveryPoint.completionDate) &&
        Objects.equals(this.createdBy, resourceDetailsAwsBackupRecoveryPoint.createdBy) &&
        Objects.equals(this.creationDate, resourceDetailsAwsBackupRecoveryPoint.creationDate) &&
        Objects.equals(this.encryptionKeyArn, resourceDetailsAwsBackupRecoveryPoint.encryptionKeyArn) &&
        Objects.equals(this.iamRoleArn, resourceDetailsAwsBackupRecoveryPoint.iamRoleArn) &&
        Objects.equals(this.isEncrypted, resourceDetailsAwsBackupRecoveryPoint.isEncrypted) &&
        Objects.equals(this.lastRestoreTime, resourceDetailsAwsBackupRecoveryPoint.lastRestoreTime) &&
        Objects.equals(this.lifecycle, resourceDetailsAwsBackupRecoveryPoint.lifecycle) &&
        Objects.equals(this.recoveryPointArn, resourceDetailsAwsBackupRecoveryPoint.recoveryPointArn) &&
        Objects.equals(this.resourceArn, resourceDetailsAwsBackupRecoveryPoint.resourceArn) &&
        Objects.equals(this.resourceType, resourceDetailsAwsBackupRecoveryPoint.resourceType) &&
        Objects.equals(this.sourceBackupVaultArn, resourceDetailsAwsBackupRecoveryPoint.sourceBackupVaultArn) &&
        Objects.equals(this.status, resourceDetailsAwsBackupRecoveryPoint.status) &&
        Objects.equals(this.statusMessage, resourceDetailsAwsBackupRecoveryPoint.statusMessage) &&
        Objects.equals(this.storageClass, resourceDetailsAwsBackupRecoveryPoint.storageClass);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceDetailsAwsBackupRecoveryPoint {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceDetailsAwsBackupRecoveryPoint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceDetailsAwsBackupRecoveryPoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceDetailsAwsBackupRecoveryPoint is not found in the empty JSON string", ResourceDetailsAwsBackupRecoveryPoint.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceDetailsAwsBackupRecoveryPoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceDetailsAwsBackupRecoveryPoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceDetailsAwsBackupRecoveryPoint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceDetailsAwsBackupRecoveryPoint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceDetailsAwsBackupRecoveryPoint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceDetailsAwsBackupRecoveryPoint.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceDetailsAwsBackupRecoveryPoint>() {
           @Override
           public void write(JsonWriter out, ResourceDetailsAwsBackupRecoveryPoint value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceDetailsAwsBackupRecoveryPoint read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceDetailsAwsBackupRecoveryPoint given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceDetailsAwsBackupRecoveryPoint
   * @throws IOException if the JSON string is invalid with respect to ResourceDetailsAwsBackupRecoveryPoint
   */
  public static ResourceDetailsAwsBackupRecoveryPoint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceDetailsAwsBackupRecoveryPoint.class);
  }

  /**
   * Convert an instance of ResourceDetailsAwsBackupRecoveryPoint to an JSON string
   *
   * @return JSON string
   */
