...
public class ResourceDetailsAwsNetworkFirewallFirewall {
  ...
  public ResourceDetailsAwsNetworkFirewallFirewall() {
  }

  public ResourceDetailsAwsNetworkFirewallFirewall deleteProtection(Boolean deleteProtection) {
  ...
  public ResourceDetailsAwsNetworkFirewallFirewall description(String description) {
  ...
  public ResourceDetailsAwsNetworkFirewallFirewall firewallArn(String firewallArn) {
  ...
  public ResourceDetailsAwsNetworkFirewallFirewall firewallId(String firewallId) {
  ...
  public ResourceDetailsAwsNetworkFirewallFirewall firewallName(String firewallName) {
  ...
  public ResourceDetailsAwsNetworkFirewallFirewall firewallPolicyArn(String firewallPolicyArn) {
  ...
  public ResourceDetailsAwsNetworkFirewallFirewall firewallPolicyChangeProtection(Boolean firewallPolicyChangeProtection) {
  ...
  public ResourceDetailsAwsNetworkFirewallFirewall subnetChangeProtection(Boolean subnetChangeProtection) {
  ...
  public ResourceDetailsAwsNetworkFirewallFirewall subnetMappings(List subnetMappings) {
  ...
  public ResourceDetailsAwsNetworkFirewallFirewall vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceDetailsAwsNetworkFirewallFirewall resourceDetailsAwsNetworkFirewallFirewall = (ResourceDetailsAwsNetworkFirewallFirewall) o;
    return Objects.equals(this.deleteProtection, resourceDetailsAwsNetworkFirewallFirewall.deleteProtection) &&
        Objects.equals(this.description, resourceDetailsAwsNetworkFirewallFirewall.description) &&
        Objects.equals(this.firewallArn, resourceDetailsAwsNetworkFirewallFirewall.firewallArn) &&
        Objects.equals(this.firewallId, resourceDetailsAwsNetworkFirewallFirewall.firewallId) &&
        Objects.equals(this.firewallName, resourceDetailsAwsNetworkFirewallFirewall.firewallName) &&
        Objects.equals(this.firewallPolicyArn, resourceDetailsAwsNetworkFirewallFirewall.firewallPolicyArn) &&
        Objects.equals(this.firewallPolicyChangeProtection, resourceDetailsAwsNetworkFirewallFirewall.firewallPolicyChangeProtection) &&
        Objects.equals(this.subnetChangeProtection, resourceDetailsAwsNetworkFirewallFirewall.subnetChangeProtection) &&
        Objects.equals(this.subnetMappings, resourceDetailsAwsNetworkFirewallFirewall.subnetMappings) &&
        Objects.equals(this.vpcId, resourceDetailsAwsNetworkFirewallFirewall.vpcId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceDetailsAwsNetworkFirewallFirewall {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceDetailsAwsNetworkFirewallFirewall
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceDetailsAwsNetworkFirewallFirewall.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceDetailsAwsNetworkFirewallFirewall is not found in the empty JSON string", ResourceDetailsAwsNetworkFirewallFirewall.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceDetailsAwsNetworkFirewallFirewall.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceDetailsAwsNetworkFirewallFirewall` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceDetailsAwsNetworkFirewallFirewall.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceDetailsAwsNetworkFirewallFirewall' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceDetailsAwsNetworkFirewallFirewall> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceDetailsAwsNetworkFirewallFirewall.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceDetailsAwsNetworkFirewallFirewall>() {
           @Override
           public void write(JsonWriter out, ResourceDetailsAwsNetworkFirewallFirewall value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceDetailsAwsNetworkFirewallFirewall read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceDetailsAwsNetworkFirewallFirewall given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceDetailsAwsNetworkFirewallFirewall
   * @throws IOException if the JSON string is invalid with respect to ResourceDetailsAwsNetworkFirewallFirewall
   */
  public static ResourceDetailsAwsNetworkFirewallFirewall fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceDetailsAwsNetworkFirewallFirewall.class);
  }

  /**
   * Convert an instance of ResourceDetailsAwsNetworkFirewallFirewall to an JSON string
   *
   * @return JSON string
   */
