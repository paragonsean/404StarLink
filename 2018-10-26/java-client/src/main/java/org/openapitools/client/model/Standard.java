...
import org.openapitools.client.model.StandardStandardsManagedBy;
...
public class Standard {
  ...
  public static final String SERIALIZED_NAME_STANDARDS_MANAGED_BY = "StandardsManagedBy";
  @SerializedName(SERIALIZED_NAME_STANDARDS_MANAGED_BY)
  private StandardStandardsManagedBy standardsManagedBy;

  public Standard() {
  }

  public Standard standardsArn(String standardsArn) {
  ...
  public Standard description(String description) {
  ...
  public Standard enabledByDefault(Boolean enabledByDefault) {
  ...
  public Standard standardsManagedBy(StandardStandardsManagedBy standardsManagedBy) {
    this.standardsManagedBy = standardsManagedBy;
    return this;
  }

  /**
   * Get standardsManagedBy
   * @return standardsManagedBy
   */
  @javax.annotation.Nullable
  public StandardStandardsManagedBy getStandardsManagedBy() {
    return standardsManagedBy;
  }

  public void setStandardsManagedBy(StandardStandardsManagedBy standardsManagedBy) {
    this.standardsManagedBy = standardsManagedBy;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.standardsArn, standard.standardsArn) &&
        Objects.equals(this.name, standard.name) &&
        Objects.equals(this.description, standard.description) &&
        Objects.equals(this.enabledByDefault, standard.enabledByDefault) &&
        Objects.equals(this.standardsManagedBy, standard.standardsManagedBy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(standardsArn, name, description, enabledByDefault, standardsManagedBy);
  }
  ...
  public String toString() {
    ...
    sb.append("    standardsManagedBy: ").append(toIndentedString(standardsManagedBy)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("StandardsManagedBy");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `StandardsArn`
      if (jsonObj.get("StandardsArn") != null && !jsonObj.get("StandardsArn").isJsonNull()) {
      ...
      // validate the optional field `EnabledByDefault`
      if (jsonObj.get("EnabledByDefault") != null && !jsonObj.get("EnabledByDefault").isJsonNull()) {
        Boolean.validateJsonElement(jsonObj.get("EnabledByDefault"));
      }
      // validate the optional field `StandardsManagedBy`
      if (jsonObj.get("StandardsManagedBy") != null && !jsonObj.get("StandardsManagedBy").isJsonNull()) {
        StandardStandardsManagedBy.validateJsonElement(jsonObj.get("StandardsManagedBy"));
      }
  }
