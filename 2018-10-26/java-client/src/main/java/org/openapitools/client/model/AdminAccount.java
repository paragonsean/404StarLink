...
import org.openapitools.client.model.AdminStatus;
...
public class AdminAccount {
  ...
  public AdminAccount accountId(String accountId) {
  ...
  public AdminAccount status(AdminStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, adminAccount.accountId) &&
        Objects.equals(this.status, adminAccount.status);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("Status") != null && !jsonObj.get("Status").isJsonNull()) {
        AdminStatus.validateJsonElement(jsonObj.get("Status"));
      }
  }
