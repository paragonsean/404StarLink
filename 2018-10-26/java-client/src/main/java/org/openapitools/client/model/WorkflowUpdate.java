...
public class WorkflowUpdate {
  ...
  public WorkflowUpdate status(WorkflowStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, workflowUpdate.status);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WorkflowUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
