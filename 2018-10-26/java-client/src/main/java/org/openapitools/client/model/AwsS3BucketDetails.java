...
public class AwsS3BucketDetails {
  ...
  public AwsS3BucketDetails ownerId(String ownerId) {
  ...
  public AwsS3BucketDetails ownerName(String ownerName) {
  ...
  public AwsS3BucketDetails ownerAccountId(String ownerAccountId) {
  ...
  public AwsS3BucketDetails createdAt(String createdAt) {
  ...
  public AwsS3BucketDetails serverSideEncryptionConfiguration(AwsS3BucketDetailsServerSideEncryptionConfiguration serverSideEncryptionConfiguration) {
  ...
  public AwsS3BucketDetails bucketLifecycleConfiguration(AwsS3BucketDetailsBucketLifecycleConfiguration bucketLifecycleConfiguration) {
  ...
  public AwsS3BucketDetails publicAccessBlockConfiguration(AwsS3BucketDetailsPublicAccessBlockConfiguration publicAccessBlockConfiguration) {
  ...
  public AwsS3BucketDetails accessControlList(String accessControlList) {
  ...
  public AwsS3BucketDetails bucketLoggingConfiguration(AwsS3BucketDetailsBucketLoggingConfiguration bucketLoggingConfiguration) {
  ...
  public AwsS3BucketDetails bucketWebsiteConfiguration(AwsS3BucketDetailsBucketWebsiteConfiguration bucketWebsiteConfiguration) {
  ...
  public AwsS3BucketDetails bucketNotificationConfiguration(AwsS3BucketDetailsBucketNotificationConfiguration bucketNotificationConfiguration) {
  ...
  public AwsS3BucketDetails bucketVersioningConfiguration(AwsS3BucketDetailsBucketVersioningConfiguration bucketVersioningConfiguration) {
  ...
  public AwsS3BucketDetails objectLockConfiguration(AwsS3BucketDetailsObjectLockConfiguration objectLockConfiguration) {
  ...
  public boolean equals(Object o) {
    ...
    AwsS3BucketDetails awsS3BucketDetails = (AwsS3BucketDetails) o;
    return Objects.equals(this.ownerId, awsS3BucketDetails.ownerId) &&
        Objects.equals(this.ownerName, awsS3BucketDetails.ownerName) &&
        Objects.equals(this.ownerAccountId, awsS3BucketDetails.ownerAccountId) &&
        Objects.equals(this.createdAt, awsS3BucketDetails.createdAt) &&
        Objects.equals(this.serverSideEncryptionConfiguration, awsS3BucketDetails.serverSideEncryptionConfiguration) &&
        Objects.equals(this.bucketLifecycleConfiguration, awsS3BucketDetails.bucketLifecycleConfiguration) &&
        Objects.equals(this.publicAccessBlockConfiguration, awsS3BucketDetails.publicAccessBlockConfiguration) &&
        Objects.equals(this.accessControlList, awsS3BucketDetails.accessControlList) &&
        Objects.equals(this.bucketLoggingConfiguration, awsS3BucketDetails.bucketLoggingConfiguration) &&
        Objects.equals(this.bucketWebsiteConfiguration, awsS3BucketDetails.bucketWebsiteConfiguration) &&
        Objects.equals(this.bucketNotificationConfiguration, awsS3BucketDetails.bucketNotificationConfiguration) &&
        Objects.equals(this.bucketVersioningConfiguration, awsS3BucketDetails.bucketVersioningConfiguration) &&
        Objects.equals(this.objectLockConfiguration, awsS3BucketDetails.objectLockConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsS3BucketDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsS3BucketDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsS3BucketDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsS3BucketDetails is not found in the empty JSON string", AwsS3BucketDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsS3BucketDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsS3BucketDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsS3BucketDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsS3BucketDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsS3BucketDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsS3BucketDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsS3BucketDetails>() {
           @Override
           public void write(JsonWriter out, AwsS3BucketDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsS3BucketDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsS3BucketDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsS3BucketDetails
   * @throws IOException if the JSON string is invalid with respect to AwsS3BucketDetails
   */
  public static AwsS3BucketDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsS3BucketDetails.class);
  }

  /**
   * Convert an instance of AwsS3BucketDetails to an JSON string
   *
   * @return JSON string
   */
