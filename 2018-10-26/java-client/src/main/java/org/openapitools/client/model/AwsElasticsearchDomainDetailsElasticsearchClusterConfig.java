...
public class AwsElasticsearchDomainDetailsElasticsearchClusterConfig {
  ...
  public AwsElasticsearchDomainDetailsElasticsearchClusterConfig() {
  }

  public AwsElasticsearchDomainDetailsElasticsearchClusterConfig dedicatedMasterCount(Integer dedicatedMasterCount) {
  ...
  public AwsElasticsearchDomainDetailsElasticsearchClusterConfig dedicatedMasterEnabled(Boolean dedicatedMasterEnabled) {
  ...
  public AwsElasticsearchDomainDetailsElasticsearchClusterConfig dedicatedMasterType(String dedicatedMasterType) {
  ...
  public AwsElasticsearchDomainDetailsElasticsearchClusterConfig instanceCount(Integer instanceCount) {
  ...
  public AwsElasticsearchDomainDetailsElasticsearchClusterConfig instanceType(String instanceType) {
  ...
  public AwsElasticsearchDomainDetailsElasticsearchClusterConfig zoneAwarenessConfig(AwsElasticsearchDomainElasticsearchClusterConfigDetailsZoneAwarenessConfig zoneAwarenessConfig) {
  ...
  public AwsElasticsearchDomainDetailsElasticsearchClusterConfig zoneAwarenessEnabled(Boolean zoneAwarenessEnabled) {
  ...
  public boolean equals(Object o) {
    ...
    AwsElasticsearchDomainDetailsElasticsearchClusterConfig awsElasticsearchDomainDetailsElasticsearchClusterConfig = (AwsElasticsearchDomainDetailsElasticsearchClusterConfig) o;
    return Objects.equals(this.dedicatedMasterCount, awsElasticsearchDomainDetailsElasticsearchClusterConfig.dedicatedMasterCount) &&
        Objects.equals(this.dedicatedMasterEnabled, awsElasticsearchDomainDetailsElasticsearchClusterConfig.dedicatedMasterEnabled) &&
        Objects.equals(this.dedicatedMasterType, awsElasticsearchDomainDetailsElasticsearchClusterConfig.dedicatedMasterType) &&
        Objects.equals(this.instanceCount, awsElasticsearchDomainDetailsElasticsearchClusterConfig.instanceCount) &&
        Objects.equals(this.instanceType, awsElasticsearchDomainDetailsElasticsearchClusterConfig.instanceType) &&
        Objects.equals(this.zoneAwarenessConfig, awsElasticsearchDomainDetailsElasticsearchClusterConfig.zoneAwarenessConfig) &&
        Objects.equals(this.zoneAwarenessEnabled, awsElasticsearchDomainDetailsElasticsearchClusterConfig.zoneAwarenessEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsElasticsearchDomainDetailsElasticsearchClusterConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsElasticsearchDomainDetailsElasticsearchClusterConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsElasticsearchDomainDetailsElasticsearchClusterConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsElasticsearchDomainDetailsElasticsearchClusterConfig is not found in the empty JSON string", AwsElasticsearchDomainDetailsElasticsearchClusterConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsElasticsearchDomainDetailsElasticsearchClusterConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsElasticsearchDomainDetailsElasticsearchClusterConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsElasticsearchDomainDetailsElasticsearchClusterConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsElasticsearchDomainDetailsElasticsearchClusterConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsElasticsearchDomainDetailsElasticsearchClusterConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsElasticsearchDomainDetailsElasticsearchClusterConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsElasticsearchDomainDetailsElasticsearchClusterConfig>() {
           @Override
           public void write(JsonWriter out, AwsElasticsearchDomainDetailsElasticsearchClusterConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsElasticsearchDomainDetailsElasticsearchClusterConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsElasticsearchDomainDetailsElasticsearchClusterConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsElasticsearchDomainDetailsElasticsearchClusterConfig
   * @throws IOException if the JSON string is invalid with respect to AwsElasticsearchDomainDetailsElasticsearchClusterConfig
   */
  public static AwsElasticsearchDomainDetailsElasticsearchClusterConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsElasticsearchDomainDetailsElasticsearchClusterConfig.class);
  }

  /**
   * Convert an instance of AwsElasticsearchDomainDetailsElasticsearchClusterConfig to an JSON string
   *
   * @return JSON string
   */
