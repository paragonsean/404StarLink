...
public class ResourceDetailsAwsSnsTopic {
  ...
  public ResourceDetailsAwsSnsTopic() {
  }

  public ResourceDetailsAwsSnsTopic kmsMasterKeyId(String kmsMasterKeyId) {
  ...
  public ResourceDetailsAwsSnsTopic subscription(List subscription) {
  ...
  public ResourceDetailsAwsSnsTopic topicName(String topicName) {
  ...
  public ResourceDetailsAwsSnsTopic owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ResourceDetailsAwsSnsTopic sqsSuccessFeedbackRoleArn(String sqsSuccessFeedbackRoleArn) {
  ...
  public ResourceDetailsAwsSnsTopic sqsFailureFeedbackRoleArn(String sqsFailureFeedbackRoleArn) {
  ...
  public ResourceDetailsAwsSnsTopic applicationSuccessFeedbackRoleArn(String applicationSuccessFeedbackRoleArn) {
  ...
  public ResourceDetailsAwsSnsTopic firehoseSuccessFeedbackRoleArn(String firehoseSuccessFeedbackRoleArn) {
  ...
  public ResourceDetailsAwsSnsTopic firehoseFailureFeedbackRoleArn(String firehoseFailureFeedbackRoleArn) {
  ...
  public ResourceDetailsAwsSnsTopic httpSuccessFeedbackRoleArn(String httpSuccessFeedbackRoleArn) {
  ...
  public ResourceDetailsAwsSnsTopic httpFailureFeedbackRoleArn(String httpFailureFeedbackRoleArn) {
  ...
  public boolean equals(Object o) {
    ...
    ResourceDetailsAwsSnsTopic resourceDetailsAwsSnsTopic = (ResourceDetailsAwsSnsTopic) o;
    return Objects.equals(this.kmsMasterKeyId, resourceDetailsAwsSnsTopic.kmsMasterKeyId) &&
        Objects.equals(this.subscription, resourceDetailsAwsSnsTopic.subscription) &&
        Objects.equals(this.topicName, resourceDetailsAwsSnsTopic.topicName) &&
        Objects.equals(this.owner, resourceDetailsAwsSnsTopic.owner) &&
        Objects.equals(this.sqsSuccessFeedbackRoleArn, resourceDetailsAwsSnsTopic.sqsSuccessFeedbackRoleArn) &&
        Objects.equals(this.sqsFailureFeedbackRoleArn, resourceDetailsAwsSnsTopic.sqsFailureFeedbackRoleArn) &&
        Objects.equals(this.applicationSuccessFeedbackRoleArn, resourceDetailsAwsSnsTopic.applicationSuccessFeedbackRoleArn) &&
        Objects.equals(this.firehoseSuccessFeedbackRoleArn, resourceDetailsAwsSnsTopic.firehoseSuccessFeedbackRoleArn) &&
        Objects.equals(this.firehoseFailureFeedbackRoleArn, resourceDetailsAwsSnsTopic.firehoseFailureFeedbackRoleArn) &&
        Objects.equals(this.httpSuccessFeedbackRoleArn, resourceDetailsAwsSnsTopic.httpSuccessFeedbackRoleArn) &&
        Objects.equals(this.httpFailureFeedbackRoleArn, resourceDetailsAwsSnsTopic.httpFailureFeedbackRoleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceDetailsAwsSnsTopic {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceDetailsAwsSnsTopic
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceDetailsAwsSnsTopic.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceDetailsAwsSnsTopic is not found in the empty JSON string", ResourceDetailsAwsSnsTopic.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceDetailsAwsSnsTopic.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceDetailsAwsSnsTopic` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceDetailsAwsSnsTopic.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceDetailsAwsSnsTopic' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceDetailsAwsSnsTopic> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceDetailsAwsSnsTopic.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceDetailsAwsSnsTopic>() {
           @Override
           public void write(JsonWriter out, ResourceDetailsAwsSnsTopic value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceDetailsAwsSnsTopic read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceDetailsAwsSnsTopic given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceDetailsAwsSnsTopic
   * @throws IOException if the JSON string is invalid with respect to ResourceDetailsAwsSnsTopic
   */
  public static ResourceDetailsAwsSnsTopic fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceDetailsAwsSnsTopic.class);
  }

  /**
   * Convert an instance of ResourceDetailsAwsSnsTopic to an JSON string
   *
   * @return JSON string
   */
