...
public class AwsCorsConfiguration {
  ...
  public AwsCorsConfiguration allowOrigins(List allowOrigins) {
  ...
  public AwsCorsConfiguration allowCredentials(Boolean allowCredentials) {
  ...
  public AwsCorsConfiguration exposeHeaders(List exposeHeaders) {
  ...
  public AwsCorsConfiguration maxAge(Integer maxAge) {
    this.maxAge = maxAge;
    return this;
  }
  ...
  public AwsCorsConfiguration allowMethods(List allowMethods) {
  ...
  public AwsCorsConfiguration allowHeaders(List allowHeaders) {
  ...
  public boolean equals(Object o) {
    ...
    AwsCorsConfiguration awsCorsConfiguration = (AwsCorsConfiguration) o;
    return Objects.equals(this.allowOrigins, awsCorsConfiguration.allowOrigins) &&
        Objects.equals(this.allowCredentials, awsCorsConfiguration.allowCredentials) &&
        Objects.equals(this.exposeHeaders, awsCorsConfiguration.exposeHeaders) &&
        Objects.equals(this.maxAge, awsCorsConfiguration.maxAge) &&
        Objects.equals(this.allowMethods, awsCorsConfiguration.allowMethods) &&
        Objects.equals(this.allowHeaders, awsCorsConfiguration.allowHeaders);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsCorsConfiguration {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsCorsConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsCorsConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsCorsConfiguration is not found in the empty JSON string", AwsCorsConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsCorsConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsCorsConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsCorsConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsCorsConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsCorsConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsCorsConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsCorsConfiguration>() {
           @Override
           public void write(JsonWriter out, AwsCorsConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsCorsConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsCorsConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsCorsConfiguration
   * @throws IOException if the JSON string is invalid with respect to AwsCorsConfiguration
   */
  public static AwsCorsConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsCorsConfiguration.class);
  }

  /**
   * Convert an instance of AwsCorsConfiguration to an JSON string
   *
   * @return JSON string
   */
