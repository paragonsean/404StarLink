...
public class AwsRedshiftClusterRestoreStatus {
  ...
  public AwsRedshiftClusterRestoreStatus currentRestoreRateInMegaBytesPerSecond(Double currentRestoreRateInMegaBytesPerSecond) {
  ...
  public AwsRedshiftClusterRestoreStatus elapsedTimeInSeconds(Integer elapsedTimeInSeconds) {
  ...
  public AwsRedshiftClusterRestoreStatus estimatedTimeToCompletionInSeconds(Integer estimatedTimeToCompletionInSeconds) {
  ...
  public AwsRedshiftClusterRestoreStatus progressInMegaBytes(Integer progressInMegaBytes) {
  ...
  public AwsRedshiftClusterRestoreStatus snapshotSizeInMegaBytes(Integer snapshotSizeInMegaBytes) {
  ...
  public AwsRedshiftClusterRestoreStatus status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AwsRedshiftClusterRestoreStatus awsRedshiftClusterRestoreStatus = (AwsRedshiftClusterRestoreStatus) o;
    return Objects.equals(this.currentRestoreRateInMegaBytesPerSecond, awsRedshiftClusterRestoreStatus.currentRestoreRateInMegaBytesPerSecond) &&
        Objects.equals(this.elapsedTimeInSeconds, awsRedshiftClusterRestoreStatus.elapsedTimeInSeconds) &&
        Objects.equals(this.estimatedTimeToCompletionInSeconds, awsRedshiftClusterRestoreStatus.estimatedTimeToCompletionInSeconds) &&
        Objects.equals(this.progressInMegaBytes, awsRedshiftClusterRestoreStatus.progressInMegaBytes) &&
        Objects.equals(this.snapshotSizeInMegaBytes, awsRedshiftClusterRestoreStatus.snapshotSizeInMegaBytes) &&
        Objects.equals(this.status, awsRedshiftClusterRestoreStatus.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsRedshiftClusterRestoreStatus {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsRedshiftClusterRestoreStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsRedshiftClusterRestoreStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsRedshiftClusterRestoreStatus is not found in the empty JSON string", AwsRedshiftClusterRestoreStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsRedshiftClusterRestoreStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsRedshiftClusterRestoreStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsRedshiftClusterRestoreStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsRedshiftClusterRestoreStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsRedshiftClusterRestoreStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsRedshiftClusterRestoreStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsRedshiftClusterRestoreStatus>() {
           @Override
           public void write(JsonWriter out, AwsRedshiftClusterRestoreStatus value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsRedshiftClusterRestoreStatus read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsRedshiftClusterRestoreStatus given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsRedshiftClusterRestoreStatus
   * @throws IOException if the JSON string is invalid with respect to AwsRedshiftClusterRestoreStatus
   */
  public static AwsRedshiftClusterRestoreStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsRedshiftClusterRestoreStatus.class);
  }

  /**
   * Convert an instance of AwsRedshiftClusterRestoreStatus to an JSON string
   *
   * @return JSON string
   */
