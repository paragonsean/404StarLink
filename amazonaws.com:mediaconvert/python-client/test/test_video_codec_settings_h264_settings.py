...
class TestVideoCodecSettingsH264Settings(unittest.TestCase):
    """VideoCodecSettingsH264Settings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VideoCodecSettingsH264Settings:
        """Test VideoCodecSettingsH264Settings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VideoCodecSettingsH264Settings`
        """
        model = VideoCodecSettingsH264Settings()
        if include_optional:
            return VideoCodecSettingsH264Settings(
    ...
    def testVideoCodecSettingsH264Settings(self):
        """Test VideoCodecSettingsH264Settings"""
