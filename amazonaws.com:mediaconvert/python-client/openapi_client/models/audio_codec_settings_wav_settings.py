...
class AudioCodecSettingsWavSettings(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["BitDepth", "Channels", "Format", "SampleRate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Format": WavFormat.from_dict(obj["Format"]) if obj.get("Format") is not None else None,
