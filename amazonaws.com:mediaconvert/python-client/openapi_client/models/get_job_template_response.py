...
class GetJobTemplateResponse(BaseModel):
    ...
    """ # noqa: E501
    job_template: Optional[CreateJobTemplateResponseJobTemplate] = Field(default=None, alias="JobTemplate")
    __properties: ClassVar[List[str]] = ["JobTemplate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JobTemplate": CreateJobTemplateResponseJobTemplate.from_dict(obj["JobTemplate"]) if obj.get("JobTemplate") is not None else None
        })
        return _obj
