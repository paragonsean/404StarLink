...
class VideoPreprocessorTimecodeBurnin(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["FontSize", "Position", "Prefix"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Position": TimecodeBurninPosition.from_dict(obj["Position"]) if obj.get("Position") is not None else None,
