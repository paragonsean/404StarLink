...
class CreatePresetResponsePreset(BaseModel):
    """
    ...
    settings: CreatePresetRequestSettings = Field(alias="Settings")
    type: Optional[Any] = Field(default=None, alias="Type")
    __properties: ClassVar[List[str]] = ["Arn", "Category", "CreatedAt", "Description", "LastUpdated", "Name", "Settings", "Type"]
