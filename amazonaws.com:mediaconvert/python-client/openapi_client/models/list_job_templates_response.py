...
class ListJobTemplatesResponse(BaseModel):
    ...
    """ # noqa: E501
    job_templates: Optional[Any] = Field(default=None, alias="JobTemplates")
    next_token: Optional[Any] = Field(default=None, alias="NextToken")
    __properties: ClassVar[List[str]] = ["JobTemplates", "NextToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "JobTemplates": obj.get("JobTemplates"),
