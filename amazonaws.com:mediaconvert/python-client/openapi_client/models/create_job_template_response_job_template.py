...
class CreateJobTemplateResponseJobTemplate(BaseModel):
    """
    ...
    settings: CreateJobTemplateRequestSettings = Field(alias="Settings")
    ...
    __properties: ClassVar[List[str]] = ["AccelerationSettings", "Arn", "Category", "CreatedAt", "Description", "HopDestinations", "LastUpdated", "Name", "Priority", "Queue", "Settings", "StatusUpdateInterval", "Type"]
