...
class InputClipping(BaseModel):
    ...
    """ # noqa: E501
    end_timecode: Optional[Any] = Field(default=None, alias="EndTimecode")
    start_timecode: Optional[Any] = Field(default=None, alias="StartTimecode")
    __properties: ClassVar[List[str]] = ["EndTimecode", "StartTimecode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "EndTimecode": obj.get("EndTimecode"),
            "StartTimecode": obj.get("StartTimecode")
        })
        return _obj
