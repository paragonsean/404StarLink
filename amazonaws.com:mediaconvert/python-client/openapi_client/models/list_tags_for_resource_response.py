...
class ListTagsForResourceResponse(BaseModel):
    ...
    """ # noqa: E501
    resource_tags: Optional[ListTagsForResourceResponseResourceTags] = Field(default=None, alias="ResourceTags")
    __properties: ClassVar[List[str]] = ["ResourceTags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ResourceTags": ListTagsForResourceResponseResourceTags.from_dict(obj["ResourceTags"]) if obj.get("ResourceTags") is not None else None
        })
        return _obj
