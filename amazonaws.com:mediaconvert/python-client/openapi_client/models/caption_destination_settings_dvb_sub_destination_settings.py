...
class CaptionDestinationSettingsDvbSubDestinationSettings(BaseModel):
    """
    ...
    dds_handling: Optional[Any] = Field(default=None, alias="DdsHandling")
    dds_x_coordinate: Optional[Any] = Field(default=None, alias="DdsXCoordinate")
    dds_y_coordinate: Optional[Any] = Field(default=None, alias="DdsYCoordinate")
    ...
    subtitling_type: Optional[Any] = Field(default=None, alias="SubtitlingType")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dds_handling
        if self.dds_handling:
            _dict['DdsHandling'] = self.dds_handling.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of subtitling_type
        if self.subtitling_type:
            _dict['SubtitlingType'] = self.subtitling_type.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Alignment": DvbSubtitleAlignment.from_dict(obj["Alignment"]) if obj.get("Alignment") is not None else None,
            "ApplyFontColor": DvbSubtitleApplyFontColor.from_dict(obj["ApplyFontColor"]) if obj.get("ApplyFontColor") is not None else None,
            "BackgroundColor": DvbSubtitleBackgroundColor.from_dict(obj["BackgroundColor"]) if obj.get("BackgroundColor") is not None else None,
            "BackgroundOpacity": obj.get("BackgroundOpacity"),
            "DdsHandling": DvbddsHandling.from_dict(obj["DdsHandling"]) if obj.get("DdsHandling") is not None else None,
            "DdsXCoordinate": obj.get("DdsXCoordinate"),
            "DdsYCoordinate": obj.get("DdsYCoordinate"),
            "FallbackFont": DvbSubSubtitleFallbackFont.from_dict(obj["FallbackFont"]) if obj.get("FallbackFont") is not None else None,
            "FontColor": DvbSubtitleFontColor.from_dict(obj["FontColor"]) if obj.get("FontColor") is not None else None,
            ...
            "OutlineColor": DvbSubtitleOutlineColor.from_dict(obj["OutlineColor"]) if obj.get("OutlineColor") is not None else None,
            "OutlineSize": obj.get("OutlineSize"),
            "ShadowColor": DvbSubtitleShadowColor.from_dict(obj["ShadowColor"]) if obj.get("ShadowColor") is not None else None,
            "ShadowOpacity": obj.get("ShadowOpacity"),
            "ShadowXOffset": obj.get("ShadowXOffset"),
            "ShadowYOffset": obj.get("ShadowYOffset"),
            "StylePassthrough": DvbSubtitleStylePassthrough.from_dict(obj["StylePassthrough"]) if obj.get("StylePassthrough") is not None else None,
            "SubtitlingType": DvbSubtitlingType.from_dict(obj["SubtitlingType"]) if obj.get("SubtitlingType") is not None else None,
            "TeletextSpacing": DvbSubtitleTeletextSpacing.from_dict(obj["TeletextSpacing"]) if obj.get("TeletextSpacing") is not None else None,
            "Width": obj.get("Width"),
