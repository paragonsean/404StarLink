...
class HlsCaptionLanguageMapping(BaseModel):
    ...
    """ # noqa: E501
    caption_channel: Optional[Any] = Field(default=None, alias="CaptionChannel")
    ...
    __properties: ClassVar[List[str]] = ["CaptionChannel", "CustomLanguageCode", "LanguageCode", "LanguageDescription"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CaptionChannel": obj.get("CaptionChannel"),
