...
class Type(BaseModel):
    ...
    def code_validate_enum(cls, value):
        ...
        if value not in set(['TYPE_CODE_UNSPECIFIED', 'BOOL', 'INT64', 'FLOAT64', 'TIMESTAMP', 'DATE', 'STRING', 'BYTES', 'ARRAY', 'STRUCT', 'NUMERIC', 'JSON', 'PROTO', 'ENUM']):
            raise ValueError("must be one of enum values ('TYPE_CODE_UNSPECIFIED', 'BOOL', 'INT64', 'FLOAT64', 'TIMESTAMP', 'DATE', 'STRING', 'BYTES', 'ARRAY', 'STRUCT', 'NUMERIC', 'JSON', 'PROTO', 'ENUM')")
        return value
