...
class InstanceConfig(BaseModel):
    ...
    state: Optional[StrictStr] = Field(default=None, description="Output only. The current instance config state.")
    __properties: ClassVar[List[str]] = ["baseConfig", "configType", "displayName", "etag", "freeInstanceAvailability", "labels", "leaderOptions", "name", "optionalReplicas", "reconciling", "replicas", "state"]
