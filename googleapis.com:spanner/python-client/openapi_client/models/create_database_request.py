...
class CreateDatabaseRequest(BaseModel):
    ...
    """ # noqa: E501
    create_statement: Optional[StrictStr] = Field(default=None, description="Required. A `CREATE DATABASE` statement, which specifies the ID of the new database. The database ID must conform to the regular expression `a-z*[a-z0-9]` and be between 2 and 30 characters in length. If the database ID is a reserved word or if it contains a hyphen, the database ID must be enclosed in backticks (`` ` ``).", alias="createStatement")
    database_dialect: Optional[StrictStr] = Field(default=None, description="Optional. The dialect of the Cloud Spanner Database.", alias="databaseDialect")
    encryption_config: Optional[EncryptionConfig] = Field(default=None, alias="encryptionConfig")
    extra_statements: Optional[List[StrictStr]] = Field(default=None, description="Optional. A list of DDL statements to run inside the newly created database. Statements can create tables, indexes, etc. These statements execute atomically with the creation of the database: if there is an error in any statement, the database is not created.", alias="extraStatements")
    ...
    __properties: ClassVar[List[str]] = ["createStatement", "databaseDialect", "encryptionConfig", "extraStatements", "protoDescriptors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "createStatement": obj.get("createStatement"),
            ...
            "extraStatements": obj.get("extraStatements"),
