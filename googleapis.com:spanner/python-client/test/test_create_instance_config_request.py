...
class TestCreateInstanceConfigRequest(unittest.TestCase):
    """CreateInstanceConfigRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateInstanceConfigRequest:
        """Test CreateInstanceConfigRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateInstanceConfigRequest`
        """
        model = CreateInstanceConfigRequest()
        if include_optional:
    ...
    def testCreateInstanceConfigRequest(self):
        """Test CreateInstanceConfigRequest"""
