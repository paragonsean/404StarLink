...
- API version: 3.0.0
  - Build date: 2024-10-11T02:16:41.374815-04:00[America/New_York]
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setBasePath("https://apisetu.gov.in/mpmsu/v3");
    ...
    MicerRequest micerRequest = new MicerRequest(); // MicerRequest | Request format
    try {
      apiInstance.micer(micerRequest);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApisApi#micer");
...
*ApisApi* | [**pvcer**](docs/ApisApi.md#pvcer) | **POST** /pvcer/certificate | Provisional Certificate
...
## Documentation for Models
 ...
 - [Micer400Response](docs/Micer400Response.md)
 - [Micer401Response](docs/Micer401Response.md)
 - [Micer404Response](docs/Micer404Response.md)
 - [Micer500Response](docs/Micer500Response.md)
 - [Micer502Response](docs/Micer502Response.md)
 - [Micer503Response](docs/Micer503Response.md)
 - [Micer504Response](docs/Micer504Response.md)
 - [MicerRequest](docs/MicerRequest.md)
 - [MicerRequestCertificateParameters](docs/MicerRequestCertificateParameters.md)
