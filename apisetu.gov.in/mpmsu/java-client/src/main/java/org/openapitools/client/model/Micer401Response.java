...
public class Micer401Response {
  ...
  public Micer401Response() {
  }

  public Micer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Micer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Micer401Response micer401Response = (Micer401Response) o;
    return Objects.equals(this.error, micer401Response.error) &&
        Objects.equals(this.errorDescription, micer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Micer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Micer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Micer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Micer401Response is not found in the empty JSON string", Micer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Micer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Micer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Micer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Micer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Micer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Micer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Micer401Response>() {
           @Override
           public void write(JsonWriter out, Micer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Micer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Micer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Micer401Response
   * @throws IOException if the JSON string is invalid with respect to Micer401Response
   */
  public static Micer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Micer401Response.class);
  }

  /**
   * Convert an instance of Micer401Response to an JSON string
   *
   * @return JSON string
   */
