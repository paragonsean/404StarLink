...
public class Sscer504Response {
  ...
  public Sscer504Response() {
  }

  public Sscer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Sscer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Sscer504Response sscer504Response = (Sscer504Response) o;
    return Objects.equals(this.error, sscer504Response.error) &&
        Objects.equals(this.errorDescription, sscer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Sscer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Sscer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Sscer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Sscer504Response is not found in the empty JSON string", Sscer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Sscer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Sscer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Sscer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Sscer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Sscer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Sscer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Sscer504Response>() {
           @Override
           public void write(JsonWriter out, Sscer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Sscer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Sscer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Sscer504Response
   * @throws IOException if the JSON string is invalid with respect to Sscer504Response
   */
  public static Sscer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Sscer504Response.class);
  }

  /**
   * Convert an instance of Sscer504Response to an JSON string
   *
   * @return JSON string
   */
