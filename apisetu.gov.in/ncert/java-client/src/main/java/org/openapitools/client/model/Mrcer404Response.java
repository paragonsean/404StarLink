...
public class Mrcer404Response {
  ...
  public Mrcer404Response() {
  }

  public Mrcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Mrcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Mrcer404Response mrcer404Response = (Mrcer404Response) o;
    return Objects.equals(this.error, mrcer404Response.error) &&
        Objects.equals(this.errorDescription, mrcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Mrcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Mrcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Mrcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Mrcer404Response is not found in the empty JSON string", Mrcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Mrcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Mrcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Mrcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Mrcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Mrcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Mrcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Mrcer404Response>() {
           @Override
           public void write(JsonWriter out, Mrcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Mrcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Mrcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Mrcer404Response
   * @throws IOException if the JSON string is invalid with respect to Mrcer404Response
   */
  public static Mrcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Mrcer404Response.class);
  }

  /**
   * Convert an instance of Mrcer404Response to an JSON string
   *
   * @return JSON string
   */
