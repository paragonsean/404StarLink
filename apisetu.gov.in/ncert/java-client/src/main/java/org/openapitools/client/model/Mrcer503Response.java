...
public class Mrcer503Response {
  ...
  public Mrcer503Response() {
  }

  public Mrcer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Mrcer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Mrcer503Response mrcer503Response = (Mrcer503Response) o;
    return Objects.equals(this.error, mrcer503Response.error) &&
        Objects.equals(this.errorDescription, mrcer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Mrcer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Mrcer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Mrcer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Mrcer503Response is not found in the empty JSON string", Mrcer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Mrcer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Mrcer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Mrcer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Mrcer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Mrcer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Mrcer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Mrcer503Response>() {
           @Override
           public void write(JsonWriter out, Mrcer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Mrcer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Mrcer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Mrcer503Response
   * @throws IOException if the JSON string is invalid with respect to Mrcer503Response
   */
  public static Mrcer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Mrcer503Response.class);
  }

  /**
   * Convert an instance of Mrcer503Response to an JSON string
   *
   * @return JSON string
   */
