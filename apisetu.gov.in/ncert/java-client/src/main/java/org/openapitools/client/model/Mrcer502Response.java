...
public class Mrcer502Response {
  ...
  public Mrcer502Response() {
  }

  public Mrcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Mrcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Mrcer502Response mrcer502Response = (Mrcer502Response) o;
    return Objects.equals(this.error, mrcer502Response.error) &&
        Objects.equals(this.errorDescription, mrcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Mrcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Mrcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Mrcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Mrcer502Response is not found in the empty JSON string", Mrcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Mrcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Mrcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Mrcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Mrcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Mrcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Mrcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Mrcer502Response>() {
           @Override
           public void write(JsonWriter out, Mrcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Mrcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Mrcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Mrcer502Response
   * @throws IOException if the JSON string is invalid with respect to Mrcer502Response
   */
  public static Mrcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Mrcer502Response.class);
  }

  /**
   * Convert an instance of Mrcer502Response to an JSON string
   *
   * @return JSON string
   */
