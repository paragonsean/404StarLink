...
public class Mrcer400Response {
  ...
  public Mrcer400Response() {
  }

  public Mrcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Mrcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Mrcer400Response mrcer400Response = (Mrcer400Response) o;
    return Objects.equals(this.error, mrcer400Response.error) &&
        Objects.equals(this.errorDescription, mrcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Mrcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Mrcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Mrcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Mrcer400Response is not found in the empty JSON string", Mrcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Mrcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Mrcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Mrcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Mrcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Mrcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Mrcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Mrcer400Response>() {
           @Override
           public void write(JsonWriter out, Mrcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Mrcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Mrcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Mrcer400Response
   * @throws IOException if the JSON string is invalid with respect to Mrcer400Response
   */
  public static Mrcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Mrcer400Response.class);
  }

  /**
   * Convert an instance of Mrcer400Response to an JSON string
   *
   * @return JSON string
   */
