...
class AcademicCertificateSchemaIssuedBy(BaseModel):
    """
    AcademicCertificateSchemaIssuedBy
    """ # noqa: E501
    organization: AcademicCertificateSchemaIssuedByOrganization = Field(alias="Organization")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Organization": AcademicCertificateSchemaIssuedByOrganization.from_dict(obj["Organization"]) if obj.get("Organization") is not None else None
        })
        return _obj
