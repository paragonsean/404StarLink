...
class BtcerRequest(BaseModel):
    """
    BtcerRequest
    """ # noqa: E501
    certificate_parameters: Optional[BtcerRequestCertificateParameters] = Field(default=None, alias="certificateParameters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "certificateParameters": BtcerRequestCertificateParameters.from_dict(obj["certificateParameters"]) if obj.get("certificateParameters") is not None else None,
