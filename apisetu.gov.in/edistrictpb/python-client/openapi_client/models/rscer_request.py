...
class RscerRequest(BaseModel):
    """
    RscerRequest
    """ # noqa: E501
    certificate_parameters: Optional[RscerRequestCertificateParameters] = Field(default=None, alias="certificateParameters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "certificateParameters": RscerRequestCertificateParameters.from_dict(obj["certificateParameters"]) if obj.get("certificateParameters") is not None else None,
