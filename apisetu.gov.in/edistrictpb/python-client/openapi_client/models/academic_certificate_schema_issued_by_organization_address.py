...
class AcademicCertificateSchemaIssuedByOrganizationAddress(BaseModel):
    """
    ...
    type: StrictStr
    vtc: StrictStr
    __properties: ClassVar[List[str]] = ["country", "district", "house", "landmark", "line1", "line2", "locality", "pin", "state", "type", "vtc"]
