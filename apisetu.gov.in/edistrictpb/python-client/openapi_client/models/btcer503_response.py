...
class Btcer503Response(BaseModel):
    """
    Btcer503Response
    """ # noqa: E501
    ...
    def error_validate_enum(cls, value):
        ...
        if value not in set(['service_unavailable']):
            raise ValueError("must be one of enum values ('service_unavailable')")
        return value
    ...
    def error_description_validate_enum(cls, value):
        ...
        if value not in set(['Publisher service is temporarily unavailable']):
            raise ValueError("must be one of enum values ('Publisher service is temporarily unavailable')")
        return value
