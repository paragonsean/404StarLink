...
class TestObcerRequest(unittest.TestCase):
    """ObcerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObcerRequest:
        """Test ObcerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObcerRequest`
        """
        model = ObcerRequest()
        if include_optional:
            return ObcerRequest(
                certificate_parameters = openapi_client.models.obcer_request_certificate_parameters.obcer_request_certificateParameters(
                    dob = '31-12-1980', 
                    dsnno = '7887', 
