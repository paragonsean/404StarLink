...
class TestBtcerRequest(unittest.TestCase):
    """BtcerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BtcerRequest:
        """Test BtcerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BtcerRequest`
        """
        model = BtcerRequest()
        if include_optional:
            return BtcerRequest(
                certificate_parameters = openapi_client.models.btcer_request_certificate_parameters.btcer_request_certificateParameters(
                    dob = '31-12-1980', 
