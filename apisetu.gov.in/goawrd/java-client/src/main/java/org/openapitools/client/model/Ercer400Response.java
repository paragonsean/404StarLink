...
public class Ercer400Response {
  ...
  public Ercer400Response() {
  }

  public Ercer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ercer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ercer400Response ercer400Response = (Ercer400Response) o;
    return Objects.equals(this.error, ercer400Response.error) &&
        Objects.equals(this.errorDescription, ercer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ercer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ercer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ercer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ercer400Response is not found in the empty JSON string", Ercer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ercer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ercer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ercer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ercer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ercer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ercer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ercer400Response>() {
           @Override
           public void write(JsonWriter out, Ercer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ercer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ercer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ercer400Response
   * @throws IOException if the JSON string is invalid with respect to Ercer400Response
   */
  public static Ercer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ercer400Response.class);
  }

  /**
   * Convert an instance of Ercer400Response to an JSON string
   *
   * @return JSON string
   */
