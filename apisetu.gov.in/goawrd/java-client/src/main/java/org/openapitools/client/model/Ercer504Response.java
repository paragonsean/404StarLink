...
public class Ercer504Response {
  ...
  public Ercer504Response() {
  }

  public Ercer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ercer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ercer504Response ercer504Response = (Ercer504Response) o;
    return Objects.equals(this.error, ercer504Response.error) &&
        Objects.equals(this.errorDescription, ercer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ercer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ercer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ercer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ercer504Response is not found in the empty JSON string", Ercer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ercer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ercer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ercer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ercer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ercer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ercer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ercer504Response>() {
           @Override
           public void write(JsonWriter out, Ercer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ercer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ercer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ercer504Response
   * @throws IOException if the JSON string is invalid with respect to Ercer504Response
   */
  public static Ercer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ercer504Response.class);
  }

  /**
   * Convert an instance of Ercer504Response to an JSON string
   *
   * @return JSON string
   */
