...
public class Ercer401Response {
  ...
  public Ercer401Response() {
  }

  public Ercer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ercer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ercer401Response ercer401Response = (Ercer401Response) o;
    return Objects.equals(this.error, ercer401Response.error) &&
        Objects.equals(this.errorDescription, ercer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ercer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ercer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ercer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ercer401Response is not found in the empty JSON string", Ercer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ercer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ercer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ercer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ercer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ercer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ercer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ercer401Response>() {
           @Override
           public void write(JsonWriter out, Ercer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ercer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ercer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ercer401Response
   * @throws IOException if the JSON string is invalid with respect to Ercer401Response
   */
  public static Ercer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ercer401Response.class);
  }

  /**
   * Convert an instance of Ercer401Response to an JSON string
   *
   * @return JSON string
   */
