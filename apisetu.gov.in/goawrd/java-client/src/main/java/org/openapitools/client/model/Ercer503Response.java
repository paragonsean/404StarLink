...
public class Ercer503Response {
  ...
  public Ercer503Response() {
  }

  public Ercer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ercer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ercer503Response ercer503Response = (Ercer503Response) o;
    return Objects.equals(this.error, ercer503Response.error) &&
        Objects.equals(this.errorDescription, ercer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ercer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ercer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ercer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ercer503Response is not found in the empty JSON string", Ercer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ercer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ercer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ercer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ercer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ercer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ercer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ercer503Response>() {
           @Override
           public void write(JsonWriter out, Ercer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ercer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ercer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ercer503Response
   * @throws IOException if the JSON string is invalid with respect to Ercer503Response
   */
  public static Ercer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ercer503Response.class);
  }

  /**
   * Convert an instance of Ercer503Response to an JSON string
   *
   * @return JSON string
   */
