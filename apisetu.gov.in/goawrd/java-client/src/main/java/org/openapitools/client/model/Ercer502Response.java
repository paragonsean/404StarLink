...
public class Ercer502Response {
  ...
  public Ercer502Response() {
  }

  public Ercer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Ercer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Ercer502Response ercer502Response = (Ercer502Response) o;
    return Objects.equals(this.error, ercer502Response.error) &&
        Objects.equals(this.errorDescription, ercer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Ercer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Ercer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Ercer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ercer502Response is not found in the empty JSON string", Ercer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Ercer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Ercer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ercer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ercer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ercer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ercer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Ercer502Response>() {
           @Override
           public void write(JsonWriter out, Ercer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Ercer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Ercer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Ercer502Response
   * @throws IOException if the JSON string is invalid with respect to Ercer502Response
   */
  public static Ercer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ercer502Response.class);
  }

  /**
   * Convert an instance of Ercer502Response to an JSON string
   *
   * @return JSON string
   */
