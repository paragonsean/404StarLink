...
public class Licer503Response {
  ...
  public Licer503Response() {
  }

  public Licer503Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Licer503Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Licer503Response licer503Response = (Licer503Response) o;
    return Objects.equals(this.error, licer503Response.error) &&
        Objects.equals(this.errorDescription, licer503Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Licer503Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Licer503Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Licer503Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Licer503Response is not found in the empty JSON string", Licer503Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Licer503Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Licer503Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Licer503Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Licer503Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Licer503Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Licer503Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Licer503Response>() {
           @Override
           public void write(JsonWriter out, Licer503Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Licer503Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Licer503Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Licer503Response
   * @throws IOException if the JSON string is invalid with respect to Licer503Response
   */
  public static Licer503Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Licer503Response.class);
  }

  /**
   * Convert an instance of Licer503Response to an JSON string
   *
   * @return JSON string
   */
