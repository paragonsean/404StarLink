...
public class Licer504Response {
  ...
  public Licer504Response() {
  }

  public Licer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Licer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Licer504Response licer504Response = (Licer504Response) o;
    return Objects.equals(this.error, licer504Response.error) &&
        Objects.equals(this.errorDescription, licer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Licer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Licer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Licer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Licer504Response is not found in the empty JSON string", Licer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Licer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Licer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Licer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Licer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Licer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Licer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Licer504Response>() {
           @Override
           public void write(JsonWriter out, Licer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Licer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Licer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Licer504Response
   * @throws IOException if the JSON string is invalid with respect to Licer504Response
   */
  public static Licer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Licer504Response.class);
  }

  /**
   * Convert an instance of Licer504Response to an JSON string
   *
   * @return JSON string
   */
