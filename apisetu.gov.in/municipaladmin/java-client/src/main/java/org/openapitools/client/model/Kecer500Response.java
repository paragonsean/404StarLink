...
public class Kecer500Response {
  ...
  public Kecer500Response() {
  }

  public Kecer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Kecer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Kecer500Response kecer500Response = (Kecer500Response) o;
    return Objects.equals(this.error, kecer500Response.error) &&
        Objects.equals(this.errorDescription, kecer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Kecer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Kecer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Kecer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Kecer500Response is not found in the empty JSON string", Kecer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Kecer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Kecer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Kecer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Kecer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Kecer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Kecer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Kecer500Response>() {
           @Override
           public void write(JsonWriter out, Kecer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Kecer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Kecer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Kecer500Response
   * @throws IOException if the JSON string is invalid with respect to Kecer500Response
   */
  public static Kecer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Kecer500Response.class);
  }

  /**
   * Convert an instance of Kecer500Response to an JSON string
   *
   * @return JSON string
   */
