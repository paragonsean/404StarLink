...
public class Kecer404Response {
  ...
  public Kecer404Response() {
  }

  public Kecer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Kecer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Kecer404Response kecer404Response = (Kecer404Response) o;
    return Objects.equals(this.error, kecer404Response.error) &&
        Objects.equals(this.errorDescription, kecer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Kecer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Kecer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Kecer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Kecer404Response is not found in the empty JSON string", Kecer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Kecer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Kecer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Kecer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Kecer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Kecer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Kecer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Kecer404Response>() {
           @Override
           public void write(JsonWriter out, Kecer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Kecer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Kecer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Kecer404Response
   * @throws IOException if the JSON string is invalid with respect to Kecer404Response
   */
  public static Kecer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Kecer404Response.class);
  }

  /**
   * Convert an instance of Kecer404Response to an JSON string
   *
   * @return JSON string
   */
