...
public class Kecer502Response {
  ...
  public Kecer502Response() {
  }

  public Kecer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Kecer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Kecer502Response kecer502Response = (Kecer502Response) o;
    return Objects.equals(this.error, kecer502Response.error) &&
        Objects.equals(this.errorDescription, kecer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Kecer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Kecer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Kecer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Kecer502Response is not found in the empty JSON string", Kecer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Kecer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Kecer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Kecer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Kecer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Kecer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Kecer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Kecer502Response>() {
           @Override
           public void write(JsonWriter out, Kecer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Kecer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Kecer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Kecer502Response
   * @throws IOException if the JSON string is invalid with respect to Kecer502Response
   */
  public static Kecer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Kecer502Response.class);
  }

  /**
   * Convert an instance of Kecer502Response to an JSON string
   *
   * @return JSON string
   */
