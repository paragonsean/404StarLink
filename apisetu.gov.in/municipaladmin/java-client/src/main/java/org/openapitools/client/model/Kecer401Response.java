...
public class Kecer401Response {
  ...
  public Kecer401Response() {
  }

  public Kecer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Kecer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Kecer401Response kecer401Response = (Kecer401Response) o;
    return Objects.equals(this.error, kecer401Response.error) &&
        Objects.equals(this.errorDescription, kecer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Kecer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Kecer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Kecer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Kecer401Response is not found in the empty JSON string", Kecer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Kecer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Kecer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Kecer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Kecer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Kecer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Kecer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Kecer401Response>() {
           @Override
           public void write(JsonWriter out, Kecer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Kecer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Kecer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Kecer401Response
   * @throws IOException if the JSON string is invalid with respect to Kecer401Response
   */
  public static Kecer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Kecer401Response.class);
  }

  /**
   * Convert an instance of Kecer401Response to an JSON string
   *
   * @return JSON string
   */
