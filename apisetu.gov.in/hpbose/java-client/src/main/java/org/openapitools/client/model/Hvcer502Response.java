...
public class Hvcer502Response {
  ...
  public Hvcer502Response() {
  }

  public Hvcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hvcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hvcer502Response hvcer502Response = (Hvcer502Response) o;
    return Objects.equals(this.error, hvcer502Response.error) &&
        Objects.equals(this.errorDescription, hvcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hvcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hvcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hvcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hvcer502Response is not found in the empty JSON string", Hvcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hvcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hvcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hvcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hvcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hvcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hvcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hvcer502Response>() {
           @Override
           public void write(JsonWriter out, Hvcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hvcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hvcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hvcer502Response
   * @throws IOException if the JSON string is invalid with respect to Hvcer502Response
   */
  public static Hvcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hvcer502Response.class);
  }

  /**
   * Convert an instance of Hvcer502Response to an JSON string
   *
   * @return JSON string
   */
