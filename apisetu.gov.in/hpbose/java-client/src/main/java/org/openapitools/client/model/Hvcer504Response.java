...
public class Hvcer504Response {
  ...
  public Hvcer504Response() {
  }

  public Hvcer504Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hvcer504Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hvcer504Response hvcer504Response = (Hvcer504Response) o;
    return Objects.equals(this.error, hvcer504Response.error) &&
        Objects.equals(this.errorDescription, hvcer504Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hvcer504Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hvcer504Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hvcer504Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hvcer504Response is not found in the empty JSON string", Hvcer504Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hvcer504Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hvcer504Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hvcer504Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hvcer504Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hvcer504Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hvcer504Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hvcer504Response>() {
           @Override
           public void write(JsonWriter out, Hvcer504Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hvcer504Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hvcer504Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hvcer504Response
   * @throws IOException if the JSON string is invalid with respect to Hvcer504Response
   */
  public static Hvcer504Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hvcer504Response.class);
  }

  /**
   * Convert an instance of Hvcer504Response to an JSON string
   *
   * @return JSON string
   */
