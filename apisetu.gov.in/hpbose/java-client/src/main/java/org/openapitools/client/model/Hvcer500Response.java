...
public class Hvcer500Response {
  ...
  public Hvcer500Response() {
  }

  public Hvcer500Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hvcer500Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hvcer500Response hvcer500Response = (Hvcer500Response) o;
    return Objects.equals(this.error, hvcer500Response.error) &&
        Objects.equals(this.errorDescription, hvcer500Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hvcer500Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hvcer500Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hvcer500Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hvcer500Response is not found in the empty JSON string", Hvcer500Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hvcer500Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hvcer500Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hvcer500Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hvcer500Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hvcer500Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hvcer500Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hvcer500Response>() {
           @Override
           public void write(JsonWriter out, Hvcer500Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hvcer500Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hvcer500Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hvcer500Response
   * @throws IOException if the JSON string is invalid with respect to Hvcer500Response
   */
  public static Hvcer500Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hvcer500Response.class);
  }

  /**
   * Convert an instance of Hvcer500Response to an JSON string
   *
   * @return JSON string
   */
