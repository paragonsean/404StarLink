...
public class Hvcer400Response {
  ...
  public Hvcer400Response() {
  }

  public Hvcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Hvcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Hvcer400Response hvcer400Response = (Hvcer400Response) o;
    return Objects.equals(this.error, hvcer400Response.error) &&
        Objects.equals(this.errorDescription, hvcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Hvcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Hvcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hvcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Hvcer400Response is not found in the empty JSON string", Hvcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hvcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Hvcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Hvcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Hvcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Hvcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Hvcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Hvcer400Response>() {
           @Override
           public void write(JsonWriter out, Hvcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Hvcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Hvcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Hvcer400Response
   * @throws IOException if the JSON string is invalid with respect to Hvcer400Response
   */
  public static Hvcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Hvcer400Response.class);
  }

  /**
   * Convert an instance of Hvcer400Response to an JSON string
   *
   * @return JSON string
   */
