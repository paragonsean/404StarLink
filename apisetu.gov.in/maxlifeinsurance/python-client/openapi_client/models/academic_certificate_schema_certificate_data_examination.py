...
class AcademicCertificateSchemaCertificateDataExamination(BaseModel):
    """
    AcademicCertificateSchemaCertificateDataExamination
    """ # noqa: E501
    month: Annotated[str, Field(min_length=1, strict=True)]
    name: Annotated[str, Field(min_length=1, strict=True)]
    year: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["month", "name", "year"]
