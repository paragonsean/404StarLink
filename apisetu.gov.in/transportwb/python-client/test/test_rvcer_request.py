...
class TestRvcerRequest(unittest.TestCase):
    """RvcerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RvcerRequest:
        """Test RvcerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RvcerRequest`
        """
        model = RvcerRequest()
        if include_optional:
            return RvcerRequest(
                certificate_parameters = openapi_client.models.rvcer_request_certificate_parameters.rvcer_request_certificateParameters(
