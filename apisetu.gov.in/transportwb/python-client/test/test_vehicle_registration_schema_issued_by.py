...
class TestVehicleRegistrationSchemaIssuedBy(unittest.TestCase):
    """VehicleRegistrationSchemaIssuedBy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VehicleRegistrationSchemaIssuedBy:
        """Test VehicleRegistrationSchemaIssuedBy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VehicleRegistrationSchemaIssuedBy`
        """
        model = VehicleRegistrationSchemaIssuedBy()
        if include_optional:
    ...
    def testVehicleRegistrationSchemaIssuedBy(self):
        """Test VehicleRegistrationSchemaIssuedBy"""
