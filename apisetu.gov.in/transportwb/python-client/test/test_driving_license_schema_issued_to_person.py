...
class TestDrivingLicenseSchemaIssuedToPerson(unittest.TestCase):
    """DrivingLicenseSchemaIssuedToPerson unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DrivingLicenseSchemaIssuedToPerson:
        """Test DrivingLicenseSchemaIssuedToPerson
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DrivingLicenseSchemaIssuedToPerson`
        """
        model = DrivingLicenseSchemaIssuedToPerson()
        if include_optional:
    ...
    def testDrivingLicenseSchemaIssuedToPerson(self):
        """Test DrivingLicenseSchemaIssuedToPerson"""
