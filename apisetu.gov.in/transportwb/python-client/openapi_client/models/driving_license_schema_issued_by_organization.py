...
class DrivingLicenseSchemaIssuedByOrganization(BaseModel):
    """
    DrivingLicenseSchemaIssuedByOrganization
    """ # noqa: E501
    address: DrivingLicenseSchemaIssuedByOrganizationAddress = Field(alias="Address")
    code: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Address": DrivingLicenseSchemaIssuedByOrganizationAddress.from_dict(obj["Address"]) if obj.get("Address") is not None else None,
            "code": obj.get("code"),
            "name": obj.get("name"),
            "tin": obj.get("tin"),
            "type": obj.get("type"),
