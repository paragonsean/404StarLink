...
class Drvlc502Response(BaseModel):
    """
    Drvlc502Response
    """ # noqa: E501
    ...
    def error_validate_enum(cls, value):
        ...
        if value not in set(['bad_gatewy']):
            raise ValueError("must be one of enum values ('bad_gatewy')")
        return value
    ...
    def error_description_validate_enum(cls, value):
        ...
        if value not in set(['Publisher service returned an invalid response']):
            raise ValueError("must be one of enum values ('Publisher service returned an invalid response')")
        return value
