...
class VehicleRegistrationSchemaIssuedToPerson(BaseModel):
    """
    ...
    title: StrictStr
    uid: StrictStr
    __properties: ClassVar[List[str]] = ["Address", "Photo", "dob", "email", "gender", "maritalStatus", "name", "phone", "religion", "swd", "swdIndicator", "title", "uid"]
