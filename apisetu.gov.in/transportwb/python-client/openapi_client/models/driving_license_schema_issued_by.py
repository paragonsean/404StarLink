...
class DrivingLicenseSchemaIssuedBy(BaseModel):
    """
    DrivingLicenseSchemaIssuedBy
    """ # noqa: E501
    organization: DrivingLicenseSchemaIssuedByOrganization = Field(alias="Organization")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Organization": DrivingLicenseSchemaIssuedByOrganization.from_dict(obj["Organization"]) if obj.get("Organization") is not None else None
        })
        return _obj
