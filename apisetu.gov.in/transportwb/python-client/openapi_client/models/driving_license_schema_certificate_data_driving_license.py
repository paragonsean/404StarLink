...
class DrivingLicenseSchemaCertificateDataDrivingLicense(BaseModel):
    """
    ...
    endorse_date: StrictStr = Field(alias="endorseDate")
    issue_date: StrictStr = Field(alias="issueDate")
    __properties: ClassVar[List[str]] = ["abbreviation", "code", "description", "endorseDate", "issueDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "endorseDate": obj.get("endorseDate"),
