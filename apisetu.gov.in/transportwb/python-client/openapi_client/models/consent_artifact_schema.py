...
class ConsentArtifactSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["consent", "signature"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consent": ConsentArtifactSchemaConsent.from_dict(obj["consent"]) if obj.get("consent") is not None else None,
            "signature": ConsentArtifactSchemaSignature.from_dict(obj["signature"]) if obj.get("signature") is not None else None
        })
        return _obj
