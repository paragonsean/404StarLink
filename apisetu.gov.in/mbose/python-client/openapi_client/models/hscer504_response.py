...
class Hscer504Response(BaseModel):
    """
    Hscer504Response
    """ # noqa: E501
    ...
    def error_validate_enum(cls, value):
        ...
        if value not in set(['gateway_timeout']):
            raise ValueError("must be one of enum values ('gateway_timeout')")
        return value
    ...
    def error_description_validate_enum(cls, value):
        ...
        if value not in set(['Publisher service did not respond in time']):
            raise ValueError("must be one of enum values ('Publisher service did not respond in time')")
        return value
