...
class AcademicCertificateSchemaIssuedTo(BaseModel):
    """
    AcademicCertificateSchemaIssuedTo
    """ # noqa: E501
    person: AcademicCertificateSchemaIssuedToPerson = Field(alias="Person")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Person": AcademicCertificateSchemaIssuedToPerson.from_dict(obj["Person"]) if obj.get("Person") is not None else None
        })
        return _obj
