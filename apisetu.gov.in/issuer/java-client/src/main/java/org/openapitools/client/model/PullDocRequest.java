...
import org.openapitools.client.model.PullDocRequestDocDetails;
 ...
 * PullDocRequest
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-11T02:14:24.237820-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class PullDocRequest {
  ...
  private PullDocRequestDocDetails docDetails;
  ...
  public PullDocRequest() {
  }

  public PullDocRequest docDetails(PullDocRequestDocDetails docDetails) {
  ...
  public PullDocRequestDocDetails getDocDetails() {
    return docDetails;
  }

  public void setDocDetails(PullDocRequestDocDetails docDetails) {
    this.docDetails = docDetails;
  }


  public PullDocRequest format(String format) {
    this.format = format;
    return this;
  }
  ...
  public PullDocRequest orgId(String orgId) {
    this.orgId = orgId;
    return this;
  }
  ...
  public PullDocRequest ts(String ts) {
    this.ts = ts;
    return this;
  }
  ...
  public PullDocRequest txn(String txn) {
    this.txn = txn;
    return this;
  }
  ...
  public PullDocRequest ver(String ver) {
    this.ver = ver;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PullDocRequest pullDocRequest = (PullDocRequest) o;
    return Objects.equals(this.docDetails, pullDocRequest.docDetails) &&
        Objects.equals(this.format, pullDocRequest.format) &&
        Objects.equals(this.orgId, pullDocRequest.orgId) &&
        Objects.equals(this.ts, pullDocRequest.ts) &&
        Objects.equals(this.txn, pullDocRequest.txn) &&
        Objects.equals(this.ver, pullDocRequest.ver);
  }
  ...
  public String toString() {
    ...
    sb.append("class PullDocRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PullDocRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PullDocRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PullDocRequest is not found in the empty JSON string", PullDocRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PullDocRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PullDocRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PullDocRequest.openapiRequiredFields) {
      ...
      PullDocRequestDocDetails.validateJsonElement(jsonObj.get("DocDetails"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PullDocRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PullDocRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PullDocRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PullDocRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<PullDocRequest>() {
           @Override
           public void write(JsonWriter out, PullDocRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PullDocRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of PullDocRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PullDocRequest
   * @throws IOException if the JSON string is invalid with respect to PullDocRequest
   */
  public static PullDocRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PullDocRequest.class);
  }

  /**
   * Convert an instance of PullDocRequest to an JSON string
   *
   * @return JSON string
   */
