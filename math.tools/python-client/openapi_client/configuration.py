...
conf = openapi_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.math.tools" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'X-Mathtools-Api-Secret' in self.api_key:
            auth['X-Mathtools-Api-Secret'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Mathtools-Api-Secret',
