...
class GeolocationVenueExtensions(BaseModel):
    ...
    """ # noqa: E501
    geocode: Optional[GeocodeExtension] = None
    __properties: ClassVar[List[str]] = ["geocode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "geocode": GeocodeExtension.from_dict(obj["geocode"]) if obj.get("geocode") is not None else None
        })
        return _obj
