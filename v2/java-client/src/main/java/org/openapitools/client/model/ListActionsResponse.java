...
public class ListActionsResponse {
  ...
  public ListActionsResponse actions(List<Action> actions) {
  ...
  public ListActionsResponse unsupportedActionNames(List<String> unsupportedActionNames) {
  ...
  public void setUnsupportedActionNames(List<String> unsupportedActionNames) {
    this.unsupportedActionNames = unsupportedActionNames;
  }
  ...
  static {
    ...
    openapiFields.add("unsupportedActionNames");
