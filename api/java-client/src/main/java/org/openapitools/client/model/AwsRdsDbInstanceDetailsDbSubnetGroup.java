...
public class AwsRdsDbInstanceDetailsDbSubnetGroup {
  ...
  public AwsRdsDbInstanceDetailsDbSubnetGroup() {
  }

  public AwsRdsDbInstanceDetailsDbSubnetGroup dbSubnetGroupName(String dbSubnetGroupName) {
  ...
  public AwsRdsDbInstanceDetailsDbSubnetGroup dbSubnetGroupDescription(String dbSubnetGroupDescription) {
  ...
  public AwsRdsDbInstanceDetailsDbSubnetGroup vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public AwsRdsDbInstanceDetailsDbSubnetGroup subnetGroupStatus(String subnetGroupStatus) {
  ...
  public AwsRdsDbInstanceDetailsDbSubnetGroup subnets(List subnets) {
  ...
  public AwsRdsDbInstanceDetailsDbSubnetGroup dbSubnetGroupArn(String dbSubnetGroupArn) {
  ...
  public boolean equals(Object o) {
    ...
    AwsRdsDbInstanceDetailsDbSubnetGroup awsRdsDbInstanceDetailsDbSubnetGroup = (AwsRdsDbInstanceDetailsDbSubnetGroup) o;
    return Objects.equals(this.dbSubnetGroupName, awsRdsDbInstanceDetailsDbSubnetGroup.dbSubnetGroupName) &&
        Objects.equals(this.dbSubnetGroupDescription, awsRdsDbInstanceDetailsDbSubnetGroup.dbSubnetGroupDescription) &&
        Objects.equals(this.vpcId, awsRdsDbInstanceDetailsDbSubnetGroup.vpcId) &&
        Objects.equals(this.subnetGroupStatus, awsRdsDbInstanceDetailsDbSubnetGroup.subnetGroupStatus) &&
        Objects.equals(this.subnets, awsRdsDbInstanceDetailsDbSubnetGroup.subnets) &&
        Objects.equals(this.dbSubnetGroupArn, awsRdsDbInstanceDetailsDbSubnetGroup.dbSubnetGroupArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsRdsDbInstanceDetailsDbSubnetGroup {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsRdsDbInstanceDetailsDbSubnetGroup
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsRdsDbInstanceDetailsDbSubnetGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsRdsDbInstanceDetailsDbSubnetGroup is not found in the empty JSON string", AwsRdsDbInstanceDetailsDbSubnetGroup.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsRdsDbInstanceDetailsDbSubnetGroup.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsRdsDbInstanceDetailsDbSubnetGroup` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsRdsDbInstanceDetailsDbSubnetGroup.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsRdsDbInstanceDetailsDbSubnetGroup' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsRdsDbInstanceDetailsDbSubnetGroup> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsRdsDbInstanceDetailsDbSubnetGroup.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsRdsDbInstanceDetailsDbSubnetGroup>() {
           @Override
           public void write(JsonWriter out, AwsRdsDbInstanceDetailsDbSubnetGroup value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsRdsDbInstanceDetailsDbSubnetGroup read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsRdsDbInstanceDetailsDbSubnetGroup given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsRdsDbInstanceDetailsDbSubnetGroup
   * @throws IOException if the JSON string is invalid with respect to AwsRdsDbInstanceDetailsDbSubnetGroup
   */
  public static AwsRdsDbInstanceDetailsDbSubnetGroup fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsRdsDbInstanceDetailsDbSubnetGroup.class);
  }

  /**
   * Convert an instance of AwsRdsDbInstanceDetailsDbSubnetGroup to an JSON string
   *
   * @return JSON string
   */
