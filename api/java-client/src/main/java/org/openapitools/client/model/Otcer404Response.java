...
public class Otcer404Response {
  ...
  public Otcer404Response() {
  }

  public Otcer404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Otcer404Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Otcer404Response otcer404Response = (Otcer404Response) o;
    return Objects.equals(this.error, otcer404Response.error) &&
        Objects.equals(this.errorDescription, otcer404Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Otcer404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Otcer404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Otcer404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Otcer404Response is not found in the empty JSON string", Otcer404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Otcer404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Otcer404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Otcer404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Otcer404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Otcer404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Otcer404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Otcer404Response>() {
           @Override
           public void write(JsonWriter out, Otcer404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Otcer404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Otcer404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Otcer404Response
   * @throws IOException if the JSON string is invalid with respect to Otcer404Response
   */
  public static Otcer404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Otcer404Response.class);
  }

  /**
   * Convert an instance of Otcer404Response to an JSON string
   *
   * @return JSON string
   */
