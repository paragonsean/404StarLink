...
public class Otcer502Response {
  ...
  public Otcer502Response() {
  }

  public Otcer502Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Otcer502Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Otcer502Response otcer502Response = (Otcer502Response) o;
    return Objects.equals(this.error, otcer502Response.error) &&
        Objects.equals(this.errorDescription, otcer502Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Otcer502Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Otcer502Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Otcer502Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Otcer502Response is not found in the empty JSON string", Otcer502Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Otcer502Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Otcer502Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Otcer502Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Otcer502Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Otcer502Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Otcer502Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Otcer502Response>() {
           @Override
           public void write(JsonWriter out, Otcer502Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Otcer502Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Otcer502Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Otcer502Response
   * @throws IOException if the JSON string is invalid with respect to Otcer502Response
   */
  public static Otcer502Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Otcer502Response.class);
  }

  /**
   * Convert an instance of Otcer502Response to an JSON string
   *
   * @return JSON string
   */
