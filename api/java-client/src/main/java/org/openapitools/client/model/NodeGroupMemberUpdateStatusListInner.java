...
public class NodeGroupMemberUpdateStatusListInner {
  ...
  public NodeGroupMemberUpdateStatusListInner() {
  }

  public NodeGroupMemberUpdateStatusListInner cacheClusterId(String cacheClusterId) {
  ...
  public NodeGroupMemberUpdateStatusListInner cacheNodeId(String cacheNodeId) {
  ...
  public NodeGroupMemberUpdateStatusListInner nodeUpdateStatus(NodeUpdateStatus nodeUpdateStatus) {
  ...
  public NodeGroupMemberUpdateStatusListInner nodeDeletionDate(OffsetDateTime nodeDeletionDate) {
  ...
  public NodeGroupMemberUpdateStatusListInner nodeUpdateStartDate(OffsetDateTime nodeUpdateStartDate) {
  ...
  public NodeGroupMemberUpdateStatusListInner nodeUpdateEndDate(OffsetDateTime nodeUpdateEndDate) {
  ...
  public NodeGroupMemberUpdateStatusListInner nodeUpdateInitiatedBy(NodeUpdateInitiatedBy nodeUpdateInitiatedBy) {
  ...
  public NodeGroupMemberUpdateStatusListInner nodeUpdateInitiatedDate(OffsetDateTime nodeUpdateInitiatedDate) {
  ...
  public NodeGroupMemberUpdateStatusListInner nodeUpdateStatusModifiedDate(OffsetDateTime nodeUpdateStatusModifiedDate) {
  ...
  public boolean equals(Object o) {
    ...
    NodeGroupMemberUpdateStatusListInner nodeGroupMemberUpdateStatusListInner = (NodeGroupMemberUpdateStatusListInner) o;
    return Objects.equals(this.cacheClusterId, nodeGroupMemberUpdateStatusListInner.cacheClusterId) &&
        Objects.equals(this.cacheNodeId, nodeGroupMemberUpdateStatusListInner.cacheNodeId) &&
        Objects.equals(this.nodeUpdateStatus, nodeGroupMemberUpdateStatusListInner.nodeUpdateStatus) &&
        Objects.equals(this.nodeDeletionDate, nodeGroupMemberUpdateStatusListInner.nodeDeletionDate) &&
        Objects.equals(this.nodeUpdateStartDate, nodeGroupMemberUpdateStatusListInner.nodeUpdateStartDate) &&
        Objects.equals(this.nodeUpdateEndDate, nodeGroupMemberUpdateStatusListInner.nodeUpdateEndDate) &&
        Objects.equals(this.nodeUpdateInitiatedBy, nodeGroupMemberUpdateStatusListInner.nodeUpdateInitiatedBy) &&
        Objects.equals(this.nodeUpdateInitiatedDate, nodeGroupMemberUpdateStatusListInner.nodeUpdateInitiatedDate) &&
        Objects.equals(this.nodeUpdateStatusModifiedDate, nodeGroupMemberUpdateStatusListInner.nodeUpdateStatusModifiedDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cacheClusterId, cacheNodeId, nodeUpdateStatus, nodeDeletionDate, nodeUpdateStartDate, nodeUpdateEndDate, nodeUpdateInitiatedBy, nodeUpdateInitiatedDate, nodeUpdateStatusModifiedDate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NodeGroupMemberUpdateStatusListInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to NodeGroupMemberUpdateStatusListInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NodeGroupMemberUpdateStatusListInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeGroupMemberUpdateStatusListInner is not found in the empty JSON string", NodeGroupMemberUpdateStatusListInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NodeGroupMemberUpdateStatusListInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NodeGroupMemberUpdateStatusListInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeGroupMemberUpdateStatusListInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeGroupMemberUpdateStatusListInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeGroupMemberUpdateStatusListInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeGroupMemberUpdateStatusListInner.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeGroupMemberUpdateStatusListInner>() {
           @Override
           public void write(JsonWriter out, NodeGroupMemberUpdateStatusListInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public NodeGroupMemberUpdateStatusListInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of NodeGroupMemberUpdateStatusListInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of NodeGroupMemberUpdateStatusListInner
   * @throws IOException if the JSON string is invalid with respect to NodeGroupMemberUpdateStatusListInner
   */
  public static NodeGroupMemberUpdateStatusListInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeGroupMemberUpdateStatusListInner.class);
  }

  /**
   * Convert an instance of NodeGroupMemberUpdateStatusListInner to an JSON string
   *
   * @return JSON string
   */
