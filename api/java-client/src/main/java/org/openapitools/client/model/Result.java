...
public class Result {
  ...
  public Result accountId(String accountId) {
  ...
  public Result processingResult(String processingResult) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, result.accountId) &&
        Objects.equals(this.processingResult, result.processingResult);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, processingResult);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `ProcessingResult`
      if (jsonObj.get("ProcessingResult") != null && !jsonObj.get("ProcessingResult").isJsonNull()) {
        String.validateJsonElement(jsonObj.get("ProcessingResult"));
      }
  }
