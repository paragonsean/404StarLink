...
public class AwsCloudTrailTrailDetails {
  ...
  public AwsCloudTrailTrailDetails cloudWatchLogsLogGroupArn(String cloudWatchLogsLogGroupArn) {
  ...
  public AwsCloudTrailTrailDetails cloudWatchLogsRoleArn(String cloudWatchLogsRoleArn) {
  ...
  public AwsCloudTrailTrailDetails hasCustomEventSelectors(Boolean hasCustomEventSelectors) {
  ...
  public AwsCloudTrailTrailDetails homeRegion(String homeRegion) {
  ...
  public AwsCloudTrailTrailDetails includeGlobalServiceEvents(Boolean includeGlobalServiceEvents) {
  ...
  public AwsCloudTrailTrailDetails isMultiRegionTrail(Boolean isMultiRegionTrail) {
  ...
  public AwsCloudTrailTrailDetails isOrganizationTrail(Boolean isOrganizationTrail) {
  ...
  public AwsCloudTrailTrailDetails kmsKeyId(String kmsKeyId) {
  ...
  public AwsCloudTrailTrailDetails logFileValidationEnabled(Boolean logFileValidationEnabled) {
  ...
  public AwsCloudTrailTrailDetails name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AwsCloudTrailTrailDetails s3BucketName(String s3BucketName) {
  ...
  public AwsCloudTrailTrailDetails s3KeyPrefix(String s3KeyPrefix) {
  ...
  public AwsCloudTrailTrailDetails snsTopicArn(String snsTopicArn) {
  ...
  public AwsCloudTrailTrailDetails snsTopicName(String snsTopicName) {
  ...
  public AwsCloudTrailTrailDetails trailArn(String trailArn) {
  ...
  public boolean equals(Object o) {
    ...
    AwsCloudTrailTrailDetails awsCloudTrailTrailDetails = (AwsCloudTrailTrailDetails) o;
    return Objects.equals(this.cloudWatchLogsLogGroupArn, awsCloudTrailTrailDetails.cloudWatchLogsLogGroupArn) &&
        Objects.equals(this.cloudWatchLogsRoleArn, awsCloudTrailTrailDetails.cloudWatchLogsRoleArn) &&
        Objects.equals(this.hasCustomEventSelectors, awsCloudTrailTrailDetails.hasCustomEventSelectors) &&
        Objects.equals(this.homeRegion, awsCloudTrailTrailDetails.homeRegion) &&
        Objects.equals(this.includeGlobalServiceEvents, awsCloudTrailTrailDetails.includeGlobalServiceEvents) &&
        Objects.equals(this.isMultiRegionTrail, awsCloudTrailTrailDetails.isMultiRegionTrail) &&
        Objects.equals(this.isOrganizationTrail, awsCloudTrailTrailDetails.isOrganizationTrail) &&
        Objects.equals(this.kmsKeyId, awsCloudTrailTrailDetails.kmsKeyId) &&
        Objects.equals(this.logFileValidationEnabled, awsCloudTrailTrailDetails.logFileValidationEnabled) &&
        Objects.equals(this.name, awsCloudTrailTrailDetails.name) &&
        Objects.equals(this.s3BucketName, awsCloudTrailTrailDetails.s3BucketName) &&
        Objects.equals(this.s3KeyPrefix, awsCloudTrailTrailDetails.s3KeyPrefix) &&
        Objects.equals(this.snsTopicArn, awsCloudTrailTrailDetails.snsTopicArn) &&
        Objects.equals(this.snsTopicName, awsCloudTrailTrailDetails.snsTopicName) &&
        Objects.equals(this.trailArn, awsCloudTrailTrailDetails.trailArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsCloudTrailTrailDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsCloudTrailTrailDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsCloudTrailTrailDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsCloudTrailTrailDetails is not found in the empty JSON string", AwsCloudTrailTrailDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsCloudTrailTrailDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsCloudTrailTrailDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsCloudTrailTrailDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsCloudTrailTrailDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsCloudTrailTrailDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsCloudTrailTrailDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsCloudTrailTrailDetails>() {
           @Override
           public void write(JsonWriter out, AwsCloudTrailTrailDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsCloudTrailTrailDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsCloudTrailTrailDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsCloudTrailTrailDetails
   * @throws IOException if the JSON string is invalid with respect to AwsCloudTrailTrailDetails
   */
  public static AwsCloudTrailTrailDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsCloudTrailTrailDetails.class);
  }

  /**
   * Convert an instance of AwsCloudTrailTrailDetails to an JSON string
   *
   * @return JSON string
   */
