...
public class SetLoadBasedAutoScalingRequestUpScaling {
  ...
  public SetLoadBasedAutoScalingRequestUpScaling() {
  }

  public SetLoadBasedAutoScalingRequestUpScaling instanceCount(Integer instanceCount) {
  ...
  public SetLoadBasedAutoScalingRequestUpScaling thresholdsWaitTime(Integer thresholdsWaitTime) {
  ...
  public SetLoadBasedAutoScalingRequestUpScaling ignoreMetricsTime(Integer ignoreMetricsTime) {
  ...
  public SetLoadBasedAutoScalingRequestUpScaling cpuThreshold(Double cpuThreshold) {
  ...
  public SetLoadBasedAutoScalingRequestUpScaling memoryThreshold(Double memoryThreshold) {
  ...
  public SetLoadBasedAutoScalingRequestUpScaling loadThreshold(Double loadThreshold) {
  ...
  public SetLoadBasedAutoScalingRequestUpScaling alarms(List alarms) {
    this.alarms = alarms;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SetLoadBasedAutoScalingRequestUpScaling setLoadBasedAutoScalingRequestUpScaling = (SetLoadBasedAutoScalingRequestUpScaling) o;
    return Objects.equals(this.instanceCount, setLoadBasedAutoScalingRequestUpScaling.instanceCount) &&
        Objects.equals(this.thresholdsWaitTime, setLoadBasedAutoScalingRequestUpScaling.thresholdsWaitTime) &&
        Objects.equals(this.ignoreMetricsTime, setLoadBasedAutoScalingRequestUpScaling.ignoreMetricsTime) &&
        Objects.equals(this.cpuThreshold, setLoadBasedAutoScalingRequestUpScaling.cpuThreshold) &&
        Objects.equals(this.memoryThreshold, setLoadBasedAutoScalingRequestUpScaling.memoryThreshold) &&
        Objects.equals(this.loadThreshold, setLoadBasedAutoScalingRequestUpScaling.loadThreshold) &&
        Objects.equals(this.alarms, setLoadBasedAutoScalingRequestUpScaling.alarms);
  }
  ...
  public String toString() {
    ...
    sb.append("class SetLoadBasedAutoScalingRequestUpScaling {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetLoadBasedAutoScalingRequestUpScaling
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetLoadBasedAutoScalingRequestUpScaling.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetLoadBasedAutoScalingRequestUpScaling is not found in the empty JSON string", SetLoadBasedAutoScalingRequestUpScaling.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetLoadBasedAutoScalingRequestUpScaling.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SetLoadBasedAutoScalingRequestUpScaling` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetLoadBasedAutoScalingRequestUpScaling.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetLoadBasedAutoScalingRequestUpScaling' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetLoadBasedAutoScalingRequestUpScaling> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetLoadBasedAutoScalingRequestUpScaling.class));

       return (TypeAdapter<T>) new TypeAdapter<SetLoadBasedAutoScalingRequestUpScaling>() {
           @Override
           public void write(JsonWriter out, SetLoadBasedAutoScalingRequestUpScaling value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetLoadBasedAutoScalingRequestUpScaling read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetLoadBasedAutoScalingRequestUpScaling given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetLoadBasedAutoScalingRequestUpScaling
   * @throws IOException if the JSON string is invalid with respect to SetLoadBasedAutoScalingRequestUpScaling
   */
  public static SetLoadBasedAutoScalingRequestUpScaling fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetLoadBasedAutoScalingRequestUpScaling.class);
  }

  /**
   * Convert an instance of SetLoadBasedAutoScalingRequestUpScaling to an JSON string
   *
   * @return JSON string
   */
