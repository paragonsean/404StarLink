...
public class ResourceDetailsAwsEcsCluster {
  ...
  public ResourceDetailsAwsEcsCluster() {
  }

  public ResourceDetailsAwsEcsCluster clusterArn(String clusterArn) {
  ...
  public ResourceDetailsAwsEcsCluster activeServicesCount(Integer activeServicesCount) {
  ...
  public ResourceDetailsAwsEcsCluster capacityProviders(List capacityProviders) {
  ...
  public ResourceDetailsAwsEcsCluster clusterSettings(List clusterSettings) {
  ...
  public ResourceDetailsAwsEcsCluster _configuration(AwsEcsClusterDetailsConfiguration _configuration) {
  ...
  public ResourceDetailsAwsEcsCluster defaultCapacityProviderStrategy(List defaultCapacityProviderStrategy) {
  ...
  public ResourceDetailsAwsEcsCluster clusterName(String clusterName) {
  ...
  public ResourceDetailsAwsEcsCluster registeredContainerInstancesCount(Integer registeredContainerInstancesCount) {
  ...
  public ResourceDetailsAwsEcsCluster runningTasksCount(Integer runningTasksCount) {
  ...
  public ResourceDetailsAwsEcsCluster status(String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceDetailsAwsEcsCluster resourceDetailsAwsEcsCluster = (ResourceDetailsAwsEcsCluster) o;
    return Objects.equals(this.clusterArn, resourceDetailsAwsEcsCluster.clusterArn) &&
        Objects.equals(this.activeServicesCount, resourceDetailsAwsEcsCluster.activeServicesCount) &&
        Objects.equals(this.capacityProviders, resourceDetailsAwsEcsCluster.capacityProviders) &&
        Objects.equals(this.clusterSettings, resourceDetailsAwsEcsCluster.clusterSettings) &&
        Objects.equals(this._configuration, resourceDetailsAwsEcsCluster._configuration) &&
        Objects.equals(this.defaultCapacityProviderStrategy, resourceDetailsAwsEcsCluster.defaultCapacityProviderStrategy) &&
        Objects.equals(this.clusterName, resourceDetailsAwsEcsCluster.clusterName) &&
        Objects.equals(this.registeredContainerInstancesCount, resourceDetailsAwsEcsCluster.registeredContainerInstancesCount) &&
        Objects.equals(this.runningTasksCount, resourceDetailsAwsEcsCluster.runningTasksCount) &&
        Objects.equals(this.status, resourceDetailsAwsEcsCluster.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceDetailsAwsEcsCluster {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceDetailsAwsEcsCluster
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceDetailsAwsEcsCluster.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceDetailsAwsEcsCluster is not found in the empty JSON string", ResourceDetailsAwsEcsCluster.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceDetailsAwsEcsCluster.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceDetailsAwsEcsCluster` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceDetailsAwsEcsCluster.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceDetailsAwsEcsCluster' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceDetailsAwsEcsCluster> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceDetailsAwsEcsCluster.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceDetailsAwsEcsCluster>() {
           @Override
           public void write(JsonWriter out, ResourceDetailsAwsEcsCluster value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceDetailsAwsEcsCluster read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceDetailsAwsEcsCluster given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceDetailsAwsEcsCluster
   * @throws IOException if the JSON string is invalid with respect to ResourceDetailsAwsEcsCluster
   */
  public static ResourceDetailsAwsEcsCluster fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceDetailsAwsEcsCluster.class);
  }

  /**
   * Convert an instance of ResourceDetailsAwsEcsCluster to an JSON string
   *
   * @return JSON string
   */
