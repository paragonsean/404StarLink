...
public class ReservedCacheNodesOfferingListInner {
  ...
  public ReservedCacheNodesOfferingListInner() {
  }

  public ReservedCacheNodesOfferingListInner reservedCacheNodesOfferingId(String reservedCacheNodesOfferingId) {
  ...
  public ReservedCacheNodesOfferingListInner cacheNodeType(String cacheNodeType) {
  ...
  public ReservedCacheNodesOfferingListInner duration(Integer duration) {
  ...
  public ReservedCacheNodesOfferingListInner fixedPrice(Double fixedPrice) {
  ...
  public ReservedCacheNodesOfferingListInner usagePrice(Double usagePrice) {
  ...
  public ReservedCacheNodesOfferingListInner productDescription(String productDescription) {
  ...
  public ReservedCacheNodesOfferingListInner offeringType(String offeringType) {
  ...
  public ReservedCacheNodesOfferingListInner recurringCharges(List recurringCharges) {
  ...
  public boolean equals(Object o) {
    ...
    ReservedCacheNodesOfferingListInner reservedCacheNodesOfferingListInner = (ReservedCacheNodesOfferingListInner) o;
    return Objects.equals(this.reservedCacheNodesOfferingId, reservedCacheNodesOfferingListInner.reservedCacheNodesOfferingId) &&
        Objects.equals(this.cacheNodeType, reservedCacheNodesOfferingListInner.cacheNodeType) &&
        Objects.equals(this.duration, reservedCacheNodesOfferingListInner.duration) &&
        Objects.equals(this.fixedPrice, reservedCacheNodesOfferingListInner.fixedPrice) &&
        Objects.equals(this.usagePrice, reservedCacheNodesOfferingListInner.usagePrice) &&
        Objects.equals(this.productDescription, reservedCacheNodesOfferingListInner.productDescription) &&
        Objects.equals(this.offeringType, reservedCacheNodesOfferingListInner.offeringType) &&
        Objects.equals(this.recurringCharges, reservedCacheNodesOfferingListInner.recurringCharges);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReservedCacheNodesOfferingListInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservedCacheNodesOfferingListInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservedCacheNodesOfferingListInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedCacheNodesOfferingListInner is not found in the empty JSON string", ReservedCacheNodesOfferingListInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservedCacheNodesOfferingListInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservedCacheNodesOfferingListInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservedCacheNodesOfferingListInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservedCacheNodesOfferingListInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservedCacheNodesOfferingListInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservedCacheNodesOfferingListInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservedCacheNodesOfferingListInner>() {
           @Override
           public void write(JsonWriter out, ReservedCacheNodesOfferingListInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservedCacheNodesOfferingListInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservedCacheNodesOfferingListInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservedCacheNodesOfferingListInner
   * @throws IOException if the JSON string is invalid with respect to ReservedCacheNodesOfferingListInner
   */
  public static ReservedCacheNodesOfferingListInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedCacheNodesOfferingListInner.class);
  }

  /**
   * Convert an instance of ReservedCacheNodesOfferingListInner to an JSON string
   *
   * @return JSON string
   */
