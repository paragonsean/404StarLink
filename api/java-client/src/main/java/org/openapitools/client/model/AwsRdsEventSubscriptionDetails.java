...
public class AwsRdsEventSubscriptionDetails {
  ...
  public AwsRdsEventSubscriptionDetails() {
  }

  public AwsRdsEventSubscriptionDetails custSubscriptionId(String custSubscriptionId) {
  ...
  public AwsRdsEventSubscriptionDetails customerAwsId(String customerAwsId) {
  ...
  public AwsRdsEventSubscriptionDetails enabled(Boolean enabled) {
  ...
  public AwsRdsEventSubscriptionDetails eventCategoriesList(List eventCategoriesList) {
  ...
  public AwsRdsEventSubscriptionDetails eventSubscriptionArn(String eventSubscriptionArn) {
  ...
  public AwsRdsEventSubscriptionDetails snsTopicArn(String snsTopicArn) {
  ...
  public AwsRdsEventSubscriptionDetails sourceIdsList(List sourceIdsList) {
  ...
  public AwsRdsEventSubscriptionDetails sourceType(String sourceType) {
  ...
  public AwsRdsEventSubscriptionDetails status(String status) {
    this.status = status;
    return this;
  }
  ...
  public AwsRdsEventSubscriptionDetails subscriptionCreationTime(String subscriptionCreationTime) {
  ...
  public boolean equals(Object o) {
    ...
    AwsRdsEventSubscriptionDetails awsRdsEventSubscriptionDetails = (AwsRdsEventSubscriptionDetails) o;
    return Objects.equals(this.custSubscriptionId, awsRdsEventSubscriptionDetails.custSubscriptionId) &&
        Objects.equals(this.customerAwsId, awsRdsEventSubscriptionDetails.customerAwsId) &&
        Objects.equals(this.enabled, awsRdsEventSubscriptionDetails.enabled) &&
        Objects.equals(this.eventCategoriesList, awsRdsEventSubscriptionDetails.eventCategoriesList) &&
        Objects.equals(this.eventSubscriptionArn, awsRdsEventSubscriptionDetails.eventSubscriptionArn) &&
        Objects.equals(this.snsTopicArn, awsRdsEventSubscriptionDetails.snsTopicArn) &&
        Objects.equals(this.sourceIdsList, awsRdsEventSubscriptionDetails.sourceIdsList) &&
        Objects.equals(this.sourceType, awsRdsEventSubscriptionDetails.sourceType) &&
        Objects.equals(this.status, awsRdsEventSubscriptionDetails.status) &&
        Objects.equals(this.subscriptionCreationTime, awsRdsEventSubscriptionDetails.subscriptionCreationTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsRdsEventSubscriptionDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsRdsEventSubscriptionDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsRdsEventSubscriptionDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsRdsEventSubscriptionDetails is not found in the empty JSON string", AwsRdsEventSubscriptionDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsRdsEventSubscriptionDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsRdsEventSubscriptionDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsRdsEventSubscriptionDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsRdsEventSubscriptionDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsRdsEventSubscriptionDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsRdsEventSubscriptionDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsRdsEventSubscriptionDetails>() {
           @Override
           public void write(JsonWriter out, AwsRdsEventSubscriptionDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsRdsEventSubscriptionDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsRdsEventSubscriptionDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsRdsEventSubscriptionDetails
   * @throws IOException if the JSON string is invalid with respect to AwsRdsEventSubscriptionDetails
   */
  public static AwsRdsEventSubscriptionDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsRdsEventSubscriptionDetails.class);
  }

  /**
   * Convert an instance of AwsRdsEventSubscriptionDetails to an JSON string
   *
   * @return JSON string
   */
