...
public class ApiClient {
    ...
    private String basePath = "http://qldb.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://qldb.{region}.amazonaws.com",
      "The QLDB multi-region endpoint",
    ...
    new ServerConfiguration(
      "https://qldb.{region}.amazonaws.com",
      "The QLDB multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://qldb.{region}.amazonaws.com.cn",
      "The QLDB endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
          "cn-north-1",
    ...
    new ServerConfiguration(
      "https://qldb.{region}.amazonaws.com.cn",
      "The QLDB endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2019-01-02/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://qldb.us-east-1.amazonaws.com
