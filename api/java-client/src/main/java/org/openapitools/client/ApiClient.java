...
public class ApiClient {
    ...
    private String basePath = "https://api.surevoip.co.uk";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/9dcb0dc8/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.surevoip.co.uk
