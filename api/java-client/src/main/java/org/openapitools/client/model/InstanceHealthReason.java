...
/**
 * Gets or Sets InstanceHealthReason
 */
@JsonAdapter(InstanceHealthReason.Adapter.class)
public enum InstanceHealthReason {
  ...
  InstanceHealthReason(String value) {
    this.value = value;
  }
  ...
  public static InstanceHealthReason fromValue(String value) {
    for (InstanceHealthReason b : InstanceHealthReason.values()) {
  ...
  public static class Adapter extends TypeAdapter<InstanceHealthReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final InstanceHealthReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public InstanceHealthReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return InstanceHealthReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    InstanceHealthReason.fromValue(value);
  }
}
