...
/**
 * Gets or Sets LoadBalancerMetricName
 */
@JsonAdapter(LoadBalancerMetricName.Adapter.class)
public enum LoadBalancerMetricName {
  ...
  LoadBalancerMetricName(String value) {
    this.value = value;
  }
  ...
  public static LoadBalancerMetricName fromValue(String value) {
    for (LoadBalancerMetricName b : LoadBalancerMetricName.values()) {
  ...
  public static class Adapter extends TypeAdapter<LoadBalancerMetricName> {
    @Override
    public void write(final JsonWriter jsonWriter, final LoadBalancerMetricName enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LoadBalancerMetricName read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LoadBalancerMetricName.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LoadBalancerMetricName.fromValue(value);
  }
}
