...
public class ReservedCacheNodeListInner {
  ...
  public ReservedCacheNodeListInner() {
  }

  public ReservedCacheNodeListInner reservedCacheNodeId(String reservedCacheNodeId) {
  ...
  public ReservedCacheNodeListInner reservedCacheNodesOfferingId(String reservedCacheNodesOfferingId) {
  ...
  public ReservedCacheNodeListInner cacheNodeType(String cacheNodeType) {
  ...
  public ReservedCacheNodeListInner startTime(OffsetDateTime startTime) {
  ...
  public ReservedCacheNodeListInner duration(Integer duration) {
  ...
  public ReservedCacheNodeListInner fixedPrice(Double fixedPrice) {
  ...
  public ReservedCacheNodeListInner usagePrice(Double usagePrice) {
  ...
  public ReservedCacheNodeListInner cacheNodeCount(Integer cacheNodeCount) {
  ...
  public ReservedCacheNodeListInner productDescription(String productDescription) {
  ...
  public ReservedCacheNodeListInner offeringType(String offeringType) {
  ...
  public ReservedCacheNodeListInner state(String state) {
    this.state = state;
    return this;
  }
  ...
  public ReservedCacheNodeListInner recurringCharges(List recurringCharges) {
  ...
  public ReservedCacheNodeListInner reservationARN(String reservationARN) {
  ...
  public boolean equals(Object o) {
    ...
    ReservedCacheNodeListInner reservedCacheNodeListInner = (ReservedCacheNodeListInner) o;
    return Objects.equals(this.reservedCacheNodeId, reservedCacheNodeListInner.reservedCacheNodeId) &&
        Objects.equals(this.reservedCacheNodesOfferingId, reservedCacheNodeListInner.reservedCacheNodesOfferingId) &&
        Objects.equals(this.cacheNodeType, reservedCacheNodeListInner.cacheNodeType) &&
        Objects.equals(this.startTime, reservedCacheNodeListInner.startTime) &&
        Objects.equals(this.duration, reservedCacheNodeListInner.duration) &&
        Objects.equals(this.fixedPrice, reservedCacheNodeListInner.fixedPrice) &&
        Objects.equals(this.usagePrice, reservedCacheNodeListInner.usagePrice) &&
        Objects.equals(this.cacheNodeCount, reservedCacheNodeListInner.cacheNodeCount) &&
        Objects.equals(this.productDescription, reservedCacheNodeListInner.productDescription) &&
        Objects.equals(this.offeringType, reservedCacheNodeListInner.offeringType) &&
        Objects.equals(this.state, reservedCacheNodeListInner.state) &&
        Objects.equals(this.recurringCharges, reservedCacheNodeListInner.recurringCharges) &&
        Objects.equals(this.reservationARN, reservedCacheNodeListInner.reservationARN);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReservedCacheNodeListInner {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ReservedCacheNodeListInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ReservedCacheNodeListInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedCacheNodeListInner is not found in the empty JSON string", ReservedCacheNodeListInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ReservedCacheNodeListInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReservedCacheNodeListInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservedCacheNodeListInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservedCacheNodeListInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservedCacheNodeListInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservedCacheNodeListInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservedCacheNodeListInner>() {
           @Override
           public void write(JsonWriter out, ReservedCacheNodeListInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReservedCacheNodeListInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ReservedCacheNodeListInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ReservedCacheNodeListInner
   * @throws IOException if the JSON string is invalid with respect to ReservedCacheNodeListInner
   */
  public static ReservedCacheNodeListInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedCacheNodeListInner.class);
  }

  /**
   * Convert an instance of ReservedCacheNodeListInner to an JSON string
   *
   * @return JSON string
   */
