...
public class AwsEc2LaunchTemplateDataInstanceRequirementsDetails {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails acceleratorCount(AwsEc2LaunchTemplateDataInstanceRequirementsDetailsAcceleratorCount acceleratorCount) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails acceleratorManufacturers(List acceleratorManufacturers) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails acceleratorNames(List acceleratorNames) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails acceleratorTotalMemoryMiB(AwsEc2LaunchTemplateDataInstanceRequirementsDetailsAcceleratorTotalMemoryMiB acceleratorTotalMemoryMiB) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails acceleratorTypes(List acceleratorTypes) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails bareMetal(String bareMetal) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails baselineEbsBandwidthMbps(AwsEc2LaunchTemplateDataInstanceRequirementsDetailsBaselineEbsBandwidthMbps baselineEbsBandwidthMbps) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails burstablePerformance(String burstablePerformance) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails cpuManufacturers(List cpuManufacturers) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails excludedInstanceTypes(List excludedInstanceTypes) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails instanceGenerations(List instanceGenerations) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails localStorage(String localStorage) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails localStorageTypes(List localStorageTypes) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails memoryGiBPerVCpu(AwsEc2LaunchTemplateDataInstanceRequirementsDetailsMemoryGiBPerVCpu memoryGiBPerVCpu) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails memoryMiB(AwsEc2LaunchTemplateDataInstanceRequirementsDetailsMemoryMiB memoryMiB) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails networkInterfaceCount(AwsEc2LaunchTemplateDataInstanceRequirementsDetailsNetworkInterfaceCount networkInterfaceCount) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails onDemandMaxPricePercentageOverLowestPrice(Integer onDemandMaxPricePercentageOverLowestPrice) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails requireHibernateSupport(Boolean requireHibernateSupport) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails spotMaxPricePercentageOverLowestPrice(Integer spotMaxPricePercentageOverLowestPrice) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails totalLocalStorageGB(AwsEc2LaunchTemplateDataInstanceRequirementsDetailsTotalLocalStorageGB totalLocalStorageGB) {
  ...
  public AwsEc2LaunchTemplateDataInstanceRequirementsDetails vcpuCount(AwsEc2LaunchTemplateDataInstanceRequirementsDetailsVCpuCount vcpuCount) {
  ...
  public boolean equals(Object o) {
    ...
    AwsEc2LaunchTemplateDataInstanceRequirementsDetails awsEc2LaunchTemplateDataInstanceRequirementsDetails = (AwsEc2LaunchTemplateDataInstanceRequirementsDetails) o;
    return Objects.equals(this.acceleratorCount, awsEc2LaunchTemplateDataInstanceRequirementsDetails.acceleratorCount) &&
        Objects.equals(this.acceleratorManufacturers, awsEc2LaunchTemplateDataInstanceRequirementsDetails.acceleratorManufacturers) &&
        Objects.equals(this.acceleratorNames, awsEc2LaunchTemplateDataInstanceRequirementsDetails.acceleratorNames) &&
        Objects.equals(this.acceleratorTotalMemoryMiB, awsEc2LaunchTemplateDataInstanceRequirementsDetails.acceleratorTotalMemoryMiB) &&
        Objects.equals(this.acceleratorTypes, awsEc2LaunchTemplateDataInstanceRequirementsDetails.acceleratorTypes) &&
        Objects.equals(this.bareMetal, awsEc2LaunchTemplateDataInstanceRequirementsDetails.bareMetal) &&
        Objects.equals(this.baselineEbsBandwidthMbps, awsEc2LaunchTemplateDataInstanceRequirementsDetails.baselineEbsBandwidthMbps) &&
        Objects.equals(this.burstablePerformance, awsEc2LaunchTemplateDataInstanceRequirementsDetails.burstablePerformance) &&
        Objects.equals(this.cpuManufacturers, awsEc2LaunchTemplateDataInstanceRequirementsDetails.cpuManufacturers) &&
        Objects.equals(this.excludedInstanceTypes, awsEc2LaunchTemplateDataInstanceRequirementsDetails.excludedInstanceTypes) &&
        Objects.equals(this.instanceGenerations, awsEc2LaunchTemplateDataInstanceRequirementsDetails.instanceGenerations) &&
        Objects.equals(this.localStorage, awsEc2LaunchTemplateDataInstanceRequirementsDetails.localStorage) &&
        Objects.equals(this.localStorageTypes, awsEc2LaunchTemplateDataInstanceRequirementsDetails.localStorageTypes) &&
        Objects.equals(this.memoryGiBPerVCpu, awsEc2LaunchTemplateDataInstanceRequirementsDetails.memoryGiBPerVCpu) &&
        Objects.equals(this.memoryMiB, awsEc2LaunchTemplateDataInstanceRequirementsDetails.memoryMiB) &&
        Objects.equals(this.networkInterfaceCount, awsEc2LaunchTemplateDataInstanceRequirementsDetails.networkInterfaceCount) &&
        Objects.equals(this.onDemandMaxPricePercentageOverLowestPrice, awsEc2LaunchTemplateDataInstanceRequirementsDetails.onDemandMaxPricePercentageOverLowestPrice) &&
        Objects.equals(this.requireHibernateSupport, awsEc2LaunchTemplateDataInstanceRequirementsDetails.requireHibernateSupport) &&
        Objects.equals(this.spotMaxPricePercentageOverLowestPrice, awsEc2LaunchTemplateDataInstanceRequirementsDetails.spotMaxPricePercentageOverLowestPrice) &&
        Objects.equals(this.totalLocalStorageGB, awsEc2LaunchTemplateDataInstanceRequirementsDetails.totalLocalStorageGB) &&
        Objects.equals(this.vcpuCount, awsEc2LaunchTemplateDataInstanceRequirementsDetails.vcpuCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsEc2LaunchTemplateDataInstanceRequirementsDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsEc2LaunchTemplateDataInstanceRequirementsDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsEc2LaunchTemplateDataInstanceRequirementsDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsEc2LaunchTemplateDataInstanceRequirementsDetails is not found in the empty JSON string", AwsEc2LaunchTemplateDataInstanceRequirementsDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsEc2LaunchTemplateDataInstanceRequirementsDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsEc2LaunchTemplateDataInstanceRequirementsDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsEc2LaunchTemplateDataInstanceRequirementsDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsEc2LaunchTemplateDataInstanceRequirementsDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsEc2LaunchTemplateDataInstanceRequirementsDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsEc2LaunchTemplateDataInstanceRequirementsDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsEc2LaunchTemplateDataInstanceRequirementsDetails>() {
           @Override
           public void write(JsonWriter out, AwsEc2LaunchTemplateDataInstanceRequirementsDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsEc2LaunchTemplateDataInstanceRequirementsDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsEc2LaunchTemplateDataInstanceRequirementsDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsEc2LaunchTemplateDataInstanceRequirementsDetails
   * @throws IOException if the JSON string is invalid with respect to AwsEc2LaunchTemplateDataInstanceRequirementsDetails
   */
  public static AwsEc2LaunchTemplateDataInstanceRequirementsDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsEc2LaunchTemplateDataInstanceRequirementsDetails.class);
  }

  /**
   * Convert an instance of AwsEc2LaunchTemplateDataInstanceRequirementsDetails to an JSON string
   *
   * @return JSON string
   */
