...
public class AwsApiGatewayV2StageDetailsRouteSettings {
  ...
  public AwsApiGatewayV2StageDetailsRouteSettings() {
  }

  public AwsApiGatewayV2StageDetailsRouteSettings detailedMetricsEnabled(Boolean detailedMetricsEnabled) {
  ...
  public AwsApiGatewayV2StageDetailsRouteSettings loggingLevel(String loggingLevel) {
  ...
  public AwsApiGatewayV2StageDetailsRouteSettings dataTraceEnabled(Boolean dataTraceEnabled) {
  ...
  public AwsApiGatewayV2StageDetailsRouteSettings throttlingBurstLimit(Integer throttlingBurstLimit) {
  ...
  public AwsApiGatewayV2StageDetailsRouteSettings throttlingRateLimit(Double throttlingRateLimit) {
  ...
  public boolean equals(Object o) {
    ...
    AwsApiGatewayV2StageDetailsRouteSettings awsApiGatewayV2StageDetailsRouteSettings = (AwsApiGatewayV2StageDetailsRouteSettings) o;
    return Objects.equals(this.detailedMetricsEnabled, awsApiGatewayV2StageDetailsRouteSettings.detailedMetricsEnabled) &&
        Objects.equals(this.loggingLevel, awsApiGatewayV2StageDetailsRouteSettings.loggingLevel) &&
        Objects.equals(this.dataTraceEnabled, awsApiGatewayV2StageDetailsRouteSettings.dataTraceEnabled) &&
        Objects.equals(this.throttlingBurstLimit, awsApiGatewayV2StageDetailsRouteSettings.throttlingBurstLimit) &&
        Objects.equals(this.throttlingRateLimit, awsApiGatewayV2StageDetailsRouteSettings.throttlingRateLimit);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsApiGatewayV2StageDetailsRouteSettings {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsApiGatewayV2StageDetailsRouteSettings
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsApiGatewayV2StageDetailsRouteSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsApiGatewayV2StageDetailsRouteSettings is not found in the empty JSON string", AwsApiGatewayV2StageDetailsRouteSettings.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsApiGatewayV2StageDetailsRouteSettings.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsApiGatewayV2StageDetailsRouteSettings` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsApiGatewayV2StageDetailsRouteSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsApiGatewayV2StageDetailsRouteSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsApiGatewayV2StageDetailsRouteSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsApiGatewayV2StageDetailsRouteSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsApiGatewayV2StageDetailsRouteSettings>() {
           @Override
           public void write(JsonWriter out, AwsApiGatewayV2StageDetailsRouteSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsApiGatewayV2StageDetailsRouteSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsApiGatewayV2StageDetailsRouteSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsApiGatewayV2StageDetailsRouteSettings
   * @throws IOException if the JSON string is invalid with respect to AwsApiGatewayV2StageDetailsRouteSettings
   */
  public static AwsApiGatewayV2StageDetailsRouteSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsApiGatewayV2StageDetailsRouteSettings.class);
  }

  /**
   * Convert an instance of AwsApiGatewayV2StageDetailsRouteSettings to an JSON string
   *
   * @return JSON string
   */
