...
public class AwsRedshiftClusterPendingModifiedValues {
  ...
  public AwsRedshiftClusterPendingModifiedValues automatedSnapshotRetentionPeriod(Integer automatedSnapshotRetentionPeriod) {
  ...
  public AwsRedshiftClusterPendingModifiedValues clusterIdentifier(String clusterIdentifier) {
  ...
  public AwsRedshiftClusterPendingModifiedValues clusterType(String clusterType) {
  ...
  public AwsRedshiftClusterPendingModifiedValues clusterVersion(String clusterVersion) {
  ...
  public AwsRedshiftClusterPendingModifiedValues encryptionType(String encryptionType) {
  ...
  public AwsRedshiftClusterPendingModifiedValues enhancedVpcRouting(Boolean enhancedVpcRouting) {
  ...
  public AwsRedshiftClusterPendingModifiedValues maintenanceTrackName(String maintenanceTrackName) {
  ...
  public AwsRedshiftClusterPendingModifiedValues masterUserPassword(String masterUserPassword) {
  ...
  public AwsRedshiftClusterPendingModifiedValues nodeType(String nodeType) {
  ...
  public AwsRedshiftClusterPendingModifiedValues numberOfNodes(Integer numberOfNodes) {
  ...
  public AwsRedshiftClusterPendingModifiedValues publiclyAccessible(Boolean publiclyAccessible) {
  ...
  public boolean equals(Object o) {
    ...
    AwsRedshiftClusterPendingModifiedValues awsRedshiftClusterPendingModifiedValues = (AwsRedshiftClusterPendingModifiedValues) o;
    return Objects.equals(this.automatedSnapshotRetentionPeriod, awsRedshiftClusterPendingModifiedValues.automatedSnapshotRetentionPeriod) &&
        Objects.equals(this.clusterIdentifier, awsRedshiftClusterPendingModifiedValues.clusterIdentifier) &&
        Objects.equals(this.clusterType, awsRedshiftClusterPendingModifiedValues.clusterType) &&
        Objects.equals(this.clusterVersion, awsRedshiftClusterPendingModifiedValues.clusterVersion) &&
        Objects.equals(this.encryptionType, awsRedshiftClusterPendingModifiedValues.encryptionType) &&
        Objects.equals(this.enhancedVpcRouting, awsRedshiftClusterPendingModifiedValues.enhancedVpcRouting) &&
        Objects.equals(this.maintenanceTrackName, awsRedshiftClusterPendingModifiedValues.maintenanceTrackName) &&
        Objects.equals(this.masterUserPassword, awsRedshiftClusterPendingModifiedValues.masterUserPassword) &&
        Objects.equals(this.nodeType, awsRedshiftClusterPendingModifiedValues.nodeType) &&
        Objects.equals(this.numberOfNodes, awsRedshiftClusterPendingModifiedValues.numberOfNodes) &&
        Objects.equals(this.publiclyAccessible, awsRedshiftClusterPendingModifiedValues.publiclyAccessible);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsRedshiftClusterPendingModifiedValues {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsRedshiftClusterPendingModifiedValues
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsRedshiftClusterPendingModifiedValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsRedshiftClusterPendingModifiedValues is not found in the empty JSON string", AwsRedshiftClusterPendingModifiedValues.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsRedshiftClusterPendingModifiedValues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsRedshiftClusterPendingModifiedValues` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsRedshiftClusterPendingModifiedValues.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsRedshiftClusterPendingModifiedValues' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsRedshiftClusterPendingModifiedValues> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsRedshiftClusterPendingModifiedValues.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsRedshiftClusterPendingModifiedValues>() {
           @Override
           public void write(JsonWriter out, AwsRedshiftClusterPendingModifiedValues value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsRedshiftClusterPendingModifiedValues read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsRedshiftClusterPendingModifiedValues given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsRedshiftClusterPendingModifiedValues
   * @throws IOException if the JSON string is invalid with respect to AwsRedshiftClusterPendingModifiedValues
   */
  public static AwsRedshiftClusterPendingModifiedValues fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsRedshiftClusterPendingModifiedValues.class);
  }

  /**
   * Convert an instance of AwsRedshiftClusterPendingModifiedValues to an JSON string
   *
   * @return JSON string
   */
