...
public class CustomFieldValue extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CustomFieldValue>() {
                ...
                public void write(JsonWriter out, CustomFieldValue value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: BigDecimal, Boolean, List<String>, String");
                }
     ...
     * BigDecimal, Boolean, List<String>, String
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be BigDecimal, Boolean, List<String>, String");
    }
     ...
     * BigDecimal, Boolean, List<String>, String
     *
     * @return The actual instance (BigDecimal, Boolean, List<String>, String)
     */
    @SuppressWarnings("unchecked")
    @Override
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format("The JSON string is invalid for CustomFieldValue with anyOf schemas: BigDecimal, Boolean, List<String>, String. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
