...
public class ListCredentialResponseMeta {
  ...
  public ListCredentialResponseMeta() {
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.firstPageUrl, listCredentialResponseMeta.firstPageUrl) &&
        ...
        Objects.equals(this.nextPageUrl, listCredentialResponseMeta.nextPageUrl) &&
        Objects.equals(this.page, listCredentialResponseMeta.page) &&
        Objects.equals(this.pageSize, listCredentialResponseMeta.pageSize) &&
        Objects.equals(this.previousPageUrl, listCredentialResponseMeta.previousPageUrl) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListCredentialResponseMeta
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListCredentialResponseMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListCredentialResponseMeta is not found in the empty JSON string", ListCredentialResponseMeta.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListCredentialResponseMeta.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListCredentialResponseMeta` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListCredentialResponseMeta.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListCredentialResponseMeta' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListCredentialResponseMeta> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListCredentialResponseMeta.class));

       return (TypeAdapter<T>) new TypeAdapter<ListCredentialResponseMeta>() {
           @Override
           public void write(JsonWriter out, ListCredentialResponseMeta value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListCredentialResponseMeta read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListCredentialResponseMeta given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListCredentialResponseMeta
   * @throws IOException if the JSON string is invalid with respect to ListCredentialResponseMeta
   */
  public static ListCredentialResponseMeta fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCredentialResponseMeta.class);
  }

  /**
   * Convert an instance of ListCredentialResponseMeta to an JSON string
   *
   * @return JSON string
   */
