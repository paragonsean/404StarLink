...
public class Workspace {
  ...
  public static final String SERIALIZED_NAME_IS_MASTER_WORKSPACE = "is_master_workspace";
  @SerializedName(SERIALIZED_NAME_IS_MASTER_WORKSPACE)
  private Boolean isMasterWorkspace;
  ...
  public Workspace id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Workspace isMasterWorkspace(Boolean isMasterWorkspace) {
   ...
   * @return isMasterWorkspace
   */
  @javax.annotation.Nullable
  public Boolean getIsMasterWorkspace() {
    return isMasterWorkspace;
  }

  public void setIsMasterWorkspace(Boolean isMasterWorkspace) {
    this.isMasterWorkspace = isMasterWorkspace;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, workspace.createdAt) &&
        ...
        Objects.equals(this.identifier, workspace.identifier) &&
        Objects.equals(this.isMasterWorkspace, workspace.isMasterWorkspace);
  }

  @Override
  public int hashCode() {
    return Objects.hash(createdAt, id, identifier, isMasterWorkspace);
  }
  ...
  public String toString() {
    ...
    sb.append("    isMasterWorkspace: ").append(toIndentedString(isMasterWorkspace)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("is_master_workspace");
