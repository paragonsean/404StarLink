...
public class TemplateDefinitionLayoutRepeatLayout {
  ...
  public TemplateDefinitionLayoutRepeatLayout format(FormatEnum format) {
    this.format = format;
    return this;
  }
  ...
  public TemplateDefinitionLayoutRepeatLayout height(BigDecimal height) {
    this.height = height;
    return this;
  }
  ...
  public TemplateDefinitionLayoutRepeatLayout width(BigDecimal width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TemplateDefinitionLayoutRepeatLayout templateDefinitionLayoutRepeatLayout = (TemplateDefinitionLayoutRepeatLayout) o;
    return Objects.equals(this.format, templateDefinitionLayoutRepeatLayout.format) &&
        Objects.equals(this.height, templateDefinitionLayoutRepeatLayout.height) &&
        Objects.equals(this.width, templateDefinitionLayoutRepeatLayout.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateDefinitionLayoutRepeatLayout {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateDefinitionLayoutRepeatLayout
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateDefinitionLayoutRepeatLayout.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateDefinitionLayoutRepeatLayout is not found in the empty JSON string", TemplateDefinitionLayoutRepeatLayout.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionLayoutRepeatLayout.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionLayoutRepeatLayout` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateDefinitionLayoutRepeatLayout.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateDefinitionLayoutRepeatLayout' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateDefinitionLayoutRepeatLayout> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateDefinitionLayoutRepeatLayout.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateDefinitionLayoutRepeatLayout>() {
           @Override
           public void write(JsonWriter out, TemplateDefinitionLayoutRepeatLayout value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateDefinitionLayoutRepeatLayout read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateDefinitionLayoutRepeatLayout given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateDefinitionLayoutRepeatLayout
   * @throws IOException if the JSON string is invalid with respect to TemplateDefinitionLayoutRepeatLayout
   */
  public static TemplateDefinitionLayoutRepeatLayout fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateDefinitionLayoutRepeatLayout.class);
  }

  /**
   * Convert an instance of TemplateDefinitionLayoutRepeatLayout to an JSON string
   *
   * @return JSON string
   */
