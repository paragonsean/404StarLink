...
public class GetTemplates404Response {
  /**
   * Error description
   */
  ...
  public GetTemplates404Response() {
  }

  public GetTemplates404Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public GetTemplates404Response status(Integer status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTemplates404Response getTemplates404Response = (GetTemplates404Response) o;
    return Objects.equals(this.error, getTemplates404Response.error) &&
        Objects.equals(this.status, getTemplates404Response.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetTemplates404Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetTemplates404Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetTemplates404Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetTemplates404Response is not found in the empty JSON string", GetTemplates404Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTemplates404Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTemplates404Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTemplates404Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTemplates404Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTemplates404Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTemplates404Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTemplates404Response>() {
           @Override
           public void write(JsonWriter out, GetTemplates404Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetTemplates404Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetTemplates404Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetTemplates404Response
   * @throws IOException if the JSON string is invalid with respect to GetTemplates404Response
   */
  public static GetTemplates404Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetTemplates404Response.class);
  }

  /**
   * Convert an instance of GetTemplates404Response to an JSON string
   *
   * @return JSON string
   */
