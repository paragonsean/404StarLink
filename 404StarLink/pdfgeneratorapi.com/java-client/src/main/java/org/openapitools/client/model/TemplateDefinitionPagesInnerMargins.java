...
public class TemplateDefinitionPagesInnerMargins {
  ...
  public TemplateDefinitionPagesInnerMargins() {
  }

  public TemplateDefinitionPagesInnerMargins bottom(BigDecimal bottom) {
    this.bottom = bottom;
    return this;
  }
  ...
  public TemplateDefinitionPagesInnerMargins right(BigDecimal right) {
    this.right = right;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TemplateDefinitionPagesInnerMargins templateDefinitionPagesInnerMargins = (TemplateDefinitionPagesInnerMargins) o;
    return Objects.equals(this.bottom, templateDefinitionPagesInnerMargins.bottom) &&
        Objects.equals(this.right, templateDefinitionPagesInnerMargins.right);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bottom, right);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TemplateDefinitionPagesInnerMargins {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateDefinitionPagesInnerMargins
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateDefinitionPagesInnerMargins.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateDefinitionPagesInnerMargins is not found in the empty JSON string", TemplateDefinitionPagesInnerMargins.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionPagesInnerMargins.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionPagesInnerMargins` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateDefinitionPagesInnerMargins.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateDefinitionPagesInnerMargins' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateDefinitionPagesInnerMargins> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateDefinitionPagesInnerMargins.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateDefinitionPagesInnerMargins>() {
           @Override
           public void write(JsonWriter out, TemplateDefinitionPagesInnerMargins value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateDefinitionPagesInnerMargins read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateDefinitionPagesInnerMargins given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateDefinitionPagesInnerMargins
   * @throws IOException if the JSON string is invalid with respect to TemplateDefinitionPagesInnerMargins
   */
  public static TemplateDefinitionPagesInnerMargins fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateDefinitionPagesInnerMargins.class);
  }

  /**
   * Convert an instance of TemplateDefinitionPagesInnerMargins to an JSON string
   *
   * @return JSON string
   */
