...
public class GetEditorUrl200Response {
  public static final String SERIALIZED_NAME_RESPONSE = "response";
  @SerializedName(SERIALIZED_NAME_RESPONSE)
  private String response;

  public GetEditorUrl200Response() {
  }

  public GetEditorUrl200Response response(String response) {
  ...
  public boolean equals(Object o) {
    ...
    GetEditorUrl200Response getEditorUrl200Response = (GetEditorUrl200Response) o;
    return Objects.equals(this.response, getEditorUrl200Response.response);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetEditorUrl200Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetEditorUrl200Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetEditorUrl200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetEditorUrl200Response is not found in the empty JSON string", GetEditorUrl200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetEditorUrl200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetEditorUrl200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetEditorUrl200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetEditorUrl200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetEditorUrl200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetEditorUrl200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetEditorUrl200Response>() {
           @Override
           public void write(JsonWriter out, GetEditorUrl200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetEditorUrl200Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetEditorUrl200Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetEditorUrl200Response
   * @throws IOException if the JSON string is invalid with respect to GetEditorUrl200Response
   */
  public static GetEditorUrl200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetEditorUrl200Response.class);
  }

  /**
   * Convert an instance of GetEditorUrl200Response to an JSON string
   *
   * @return JSON string
   */
