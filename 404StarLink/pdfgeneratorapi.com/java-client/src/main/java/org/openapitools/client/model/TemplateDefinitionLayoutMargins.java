...
public class TemplateDefinitionLayoutMargins {
  ...
  public TemplateDefinitionLayoutMargins bottom(BigDecimal bottom) {
    this.bottom = bottom;
    return this;
  }
  ...
  public TemplateDefinitionLayoutMargins left(BigDecimal left) {
    this.left = left;
    return this;
  }
  ...
  public TemplateDefinitionLayoutMargins right(BigDecimal right) {
    this.right = right;
    return this;
  }
  ...
  public TemplateDefinitionLayoutMargins top(BigDecimal top) {
    this.top = top;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    TemplateDefinitionLayoutMargins templateDefinitionLayoutMargins = (TemplateDefinitionLayoutMargins) o;
    return Objects.equals(this.bottom, templateDefinitionLayoutMargins.bottom) &&
        Objects.equals(this.left, templateDefinitionLayoutMargins.left) &&
        Objects.equals(this.right, templateDefinitionLayoutMargins.right) &&
        Objects.equals(this.top, templateDefinitionLayoutMargins.top);
  }
  ...
  public String toString() {
    ...
    sb.append("class TemplateDefinitionLayoutMargins {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateDefinitionLayoutMargins
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateDefinitionLayoutMargins.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateDefinitionLayoutMargins is not found in the empty JSON string", TemplateDefinitionLayoutMargins.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateDefinitionLayoutMargins.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateDefinitionLayoutMargins` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateDefinitionLayoutMargins.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateDefinitionLayoutMargins' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateDefinitionLayoutMargins> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateDefinitionLayoutMargins.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateDefinitionLayoutMargins>() {
           @Override
           public void write(JsonWriter out, TemplateDefinitionLayoutMargins value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TemplateDefinitionLayoutMargins read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TemplateDefinitionLayoutMargins given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TemplateDefinitionLayoutMargins
   * @throws IOException if the JSON string is invalid with respect to TemplateDefinitionLayoutMargins
   */
  public static TemplateDefinitionLayoutMargins fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateDefinitionLayoutMargins.class);
  }

  /**
   * Convert an instance of TemplateDefinitionLayoutMargins to an JSON string
   *
   * @return JSON string
   */
