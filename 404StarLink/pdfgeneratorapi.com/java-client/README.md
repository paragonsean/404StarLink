...
PDF Generator API
- API version: 3.1.1
  - Build date: 2024-10-11T02:12:02.698490-04:00[America/New_York]
...
```groovy
  ...
  dependencies {
     implementation "org.openapitools:openapi-java-client:3.1.1"
  }
```
...
* `target/openapi-java-client-3.1.1.jar`
* `target/lib/*.jar`
