...
public class GifImagesFixedHeightSmall {
  ...
  public GifImagesFixedHeightSmall() {
  }

  public GifImagesFixedHeightSmall frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesFixedHeightSmall height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesFixedHeightSmall mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesFixedHeightSmall mp4Size(String mp4Size) {
  ...
  public GifImagesFixedHeightSmall size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesFixedHeightSmall url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesFixedHeightSmall webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesFixedHeightSmall webpSize(String webpSize) {
  ...
  public GifImagesFixedHeightSmall width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesFixedHeightSmall gifImagesFixedHeightSmall = (GifImagesFixedHeightSmall) o;
    return Objects.equals(this.frames, gifImagesFixedHeightSmall.frames) &&
        Objects.equals(this.height, gifImagesFixedHeightSmall.height) &&
        Objects.equals(this.mp4, gifImagesFixedHeightSmall.mp4) &&
        Objects.equals(this.mp4Size, gifImagesFixedHeightSmall.mp4Size) &&
        Objects.equals(this.size, gifImagesFixedHeightSmall.size) &&
        Objects.equals(this.url, gifImagesFixedHeightSmall.url) &&
        Objects.equals(this.webp, gifImagesFixedHeightSmall.webp) &&
        Objects.equals(this.webpSize, gifImagesFixedHeightSmall.webpSize) &&
        Objects.equals(this.width, gifImagesFixedHeightSmall.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesFixedHeightSmall {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesFixedHeightSmall
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesFixedHeightSmall.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesFixedHeightSmall is not found in the empty JSON string", GifImagesFixedHeightSmall.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesFixedHeightSmall.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesFixedHeightSmall` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesFixedHeightSmall.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesFixedHeightSmall' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesFixedHeightSmall> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesFixedHeightSmall.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesFixedHeightSmall>() {
           @Override
           public void write(JsonWriter out, GifImagesFixedHeightSmall value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesFixedHeightSmall read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesFixedHeightSmall given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesFixedHeightSmall
   * @throws IOException if the JSON string is invalid with respect to GifImagesFixedHeightSmall
   */
  public static GifImagesFixedHeightSmall fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesFixedHeightSmall.class);
  }

  /**
   * Convert an instance of GifImagesFixedHeightSmall to an JSON string
   *
   * @return JSON string
   */
