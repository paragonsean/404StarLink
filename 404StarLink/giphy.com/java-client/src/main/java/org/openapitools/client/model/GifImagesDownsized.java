...
public class GifImagesDownsized {
  ...
  public GifImagesDownsized() {
  }

  public GifImagesDownsized frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesDownsized height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesDownsized mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesDownsized mp4Size(String mp4Size) {
  ...
  public GifImagesDownsized size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesDownsized url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesDownsized webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesDownsized webpSize(String webpSize) {
  ...
  public GifImagesDownsized width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesDownsized gifImagesDownsized = (GifImagesDownsized) o;
    return Objects.equals(this.frames, gifImagesDownsized.frames) &&
        Objects.equals(this.height, gifImagesDownsized.height) &&
        Objects.equals(this.mp4, gifImagesDownsized.mp4) &&
        Objects.equals(this.mp4Size, gifImagesDownsized.mp4Size) &&
        Objects.equals(this.size, gifImagesDownsized.size) &&
        Objects.equals(this.url, gifImagesDownsized.url) &&
        Objects.equals(this.webp, gifImagesDownsized.webp) &&
        Objects.equals(this.webpSize, gifImagesDownsized.webpSize) &&
        Objects.equals(this.width, gifImagesDownsized.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesDownsized {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesDownsized
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesDownsized.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesDownsized is not found in the empty JSON string", GifImagesDownsized.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesDownsized.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesDownsized` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesDownsized.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesDownsized' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesDownsized> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesDownsized.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesDownsized>() {
           @Override
           public void write(JsonWriter out, GifImagesDownsized value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesDownsized read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesDownsized given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesDownsized
   * @throws IOException if the JSON string is invalid with respect to GifImagesDownsized
   */
  public static GifImagesDownsized fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesDownsized.class);
  }

  /**
   * Convert an instance of GifImagesDownsized to an JSON string
   *
   * @return JSON string
   */
