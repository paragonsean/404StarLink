...
public class GifImagesPreview {
  ...
  public GifImagesPreview() {
  }

  public GifImagesPreview frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesPreview height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesPreview mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesPreview mp4Size(String mp4Size) {
  ...
  public GifImagesPreview size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesPreview url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesPreview webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesPreview webpSize(String webpSize) {
  ...
  public GifImagesPreview width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesPreview gifImagesPreview = (GifImagesPreview) o;
    return Objects.equals(this.frames, gifImagesPreview.frames) &&
        Objects.equals(this.height, gifImagesPreview.height) &&
        Objects.equals(this.mp4, gifImagesPreview.mp4) &&
        Objects.equals(this.mp4Size, gifImagesPreview.mp4Size) &&
        Objects.equals(this.size, gifImagesPreview.size) &&
        Objects.equals(this.url, gifImagesPreview.url) &&
        Objects.equals(this.webp, gifImagesPreview.webp) &&
        Objects.equals(this.webpSize, gifImagesPreview.webpSize) &&
        Objects.equals(this.width, gifImagesPreview.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesPreview {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesPreview
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesPreview.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesPreview is not found in the empty JSON string", GifImagesPreview.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesPreview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesPreview` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesPreview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesPreview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesPreview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesPreview.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesPreview>() {
           @Override
           public void write(JsonWriter out, GifImagesPreview value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesPreview read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesPreview given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesPreview
   * @throws IOException if the JSON string is invalid with respect to GifImagesPreview
   */
  public static GifImagesPreview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesPreview.class);
  }

  /**
   * Convert an instance of GifImagesPreview to an JSON string
   *
   * @return JSON string
   */
