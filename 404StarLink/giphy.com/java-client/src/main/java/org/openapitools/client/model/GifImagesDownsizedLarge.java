...
public class GifImagesDownsizedLarge {
  ...
  public GifImagesDownsizedLarge() {
  }

  public GifImagesDownsizedLarge frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesDownsizedLarge height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesDownsizedLarge mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesDownsizedLarge mp4Size(String mp4Size) {
  ...
  public GifImagesDownsizedLarge size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesDownsizedLarge url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesDownsizedLarge webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesDownsizedLarge webpSize(String webpSize) {
  ...
  public GifImagesDownsizedLarge width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesDownsizedLarge gifImagesDownsizedLarge = (GifImagesDownsizedLarge) o;
    return Objects.equals(this.frames, gifImagesDownsizedLarge.frames) &&
        Objects.equals(this.height, gifImagesDownsizedLarge.height) &&
        Objects.equals(this.mp4, gifImagesDownsizedLarge.mp4) &&
        Objects.equals(this.mp4Size, gifImagesDownsizedLarge.mp4Size) &&
        Objects.equals(this.size, gifImagesDownsizedLarge.size) &&
        Objects.equals(this.url, gifImagesDownsizedLarge.url) &&
        Objects.equals(this.webp, gifImagesDownsizedLarge.webp) &&
        Objects.equals(this.webpSize, gifImagesDownsizedLarge.webpSize) &&
        Objects.equals(this.width, gifImagesDownsizedLarge.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesDownsizedLarge {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesDownsizedLarge
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesDownsizedLarge.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesDownsizedLarge is not found in the empty JSON string", GifImagesDownsizedLarge.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesDownsizedLarge.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesDownsizedLarge` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesDownsizedLarge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesDownsizedLarge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesDownsizedLarge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesDownsizedLarge.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesDownsizedLarge>() {
           @Override
           public void write(JsonWriter out, GifImagesDownsizedLarge value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesDownsizedLarge read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesDownsizedLarge given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesDownsizedLarge
   * @throws IOException if the JSON string is invalid with respect to GifImagesDownsizedLarge
   */
  public static GifImagesDownsizedLarge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesDownsizedLarge.class);
  }

  /**
   * Convert an instance of GifImagesDownsizedLarge to an JSON string
   *
   * @return JSON string
   */
