...
public class Error {
  ...
  public static final String SERIALIZED_NAME_ERROR_NAME = "error-name";
  ...
  public static final String SERIALIZED_NAME_FORMAT_STRING = "format-string";
  ...
  public static final String SERIALIZED_NAME_XQUERY_VERSION = "xquery-version";
  @SerializedName(SERIALIZED_NAME_XQUERY_VERSION)
  private XqueryVersion xqueryVersion;
  ...
  public Error formatString(String formatString) {
  ...
  public Error xqueryVersion(XqueryVersion xqueryVersion) {
  ...
  public void setXqueryVersion(XqueryVersion xqueryVersion) {
    this.xqueryVersion = xqueryVersion;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, error.code) &&
        ...
        Objects.equals(this.expr, error.expr) &&
        Objects.equals(this.formatString, error.formatString) &&
        Objects.equals(this.message, error.message) &&
        Objects.equals(this.retryable, error.retryable) &&
        Objects.equals(this.xqueryVersion, error.xqueryVersion);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, data, errorName, expr, formatString, message, retryable, xqueryVersion);
  }
  ...
  public String toString() {
    ...
    sb.append("    xqueryVersion: ").append(toIndentedString(xqueryVersion)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("error-name");
    openapiFields.add("expr");
    openapiFields.add("format-string");
    openapiFields.add("message");
    openapiFields.add("retryable");
    openapiFields.add("xquery-version");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("code");
    openapiRequiredFields.add("data");
    openapiRequiredFields.add("error-name");
    openapiRequiredFields.add("expr");
    openapiRequiredFields.add("format-string");
    openapiRequiredFields.add("message");
    openapiRequiredFields.add("retryable");
    openapiRequiredFields.add("xquery-version");
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("error-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `error-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("error-name").toString()));
      }
      ...
      if (!jsonObj.get("format-string").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `format-string` to be a primitive type in the JSON string but got `%s`", jsonObj.get("format-string").toString()));
      }
      if (!jsonObj.get("message").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `message` to be a primitive type in the JSON string but got `%s`", jsonObj.get("message").toString()));
      }
      // validate the required field `xquery-version`
      XqueryVersion.validateJsonElement(jsonObj.get("xquery-version"));
  }
