...
class TestProjectInSearch(unittest.TestCase):
    """ProjectInSearch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectInSearch:
        """Test ProjectInSearch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectInSearch`
        """
        model = ProjectInSearch()
        if include_optional:
