...
class ProjectPrice(BaseModel):
    ...
    base_amount: Optional[Union[StrictFloat, StrictInt]] = None
    base_currency: Optional[StrictStr] = 'usd'
    currency: Optional[StrictStr] = 'usd'
    usd_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="USD is our base pricing currency. If `currency` is different, this will help.")
    __properties: ClassVar[List[str]] = ["amount", "base_amount", "base_currency", "currency", "usd_amount"]
