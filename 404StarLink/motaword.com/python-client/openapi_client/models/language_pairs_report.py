...
class LanguagePairsReport(BaseModel):
    ...
    report: Optional[List[LanguagePairsReportReportInner]] = None
    __properties: ClassVar[List[str]] = ["meta", "report"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "report": [LanguagePairsReportReportInner.from_dict(_item) for _item in obj["report"]] if obj.get("report") is not None else None
        })
        return _obj
