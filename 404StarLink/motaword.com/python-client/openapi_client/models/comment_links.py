...
class CommentLinks(BaseModel):
    ...
    activity: Optional[Href] = None
    project: Optional[Href] = None
    __properties: ClassVar[List[str]] = ["self", "activity", "project"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activity": Href.from_dict(obj["activity"]) if obj.get("activity") is not None else None,
