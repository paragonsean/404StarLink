...
class ClientProfileNps(BaseModel):
    """
    net promoter score info for this client
    """ # noqa: E501
    average: Optional[ClientProfileNpsAverage] = None
    last: Optional[ClientProfileNpsLast] = None
    __properties: ClassVar[List[str]] = ["average", "last"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "average": ClientProfileNpsAverage.from_dict(obj["average"]) if obj.get("average") is not None else None,
            "last": ClientProfileNpsLast.from_dict(obj["last"]) if obj.get("last") is not None else None
        })
        return _obj
