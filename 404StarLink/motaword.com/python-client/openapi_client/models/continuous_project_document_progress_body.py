...
class ContinuousProjectDocumentProgressBody(BaseModel):
    ...
    filter_by_language: Optional[StrictStr] = Field(default=None, alias="filterByLanguage")
    __properties: ClassVar[List[str]] = ["documentName", "filterByLanguage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filterByLanguage": obj.get("filterByLanguage")
        })
        return _obj
