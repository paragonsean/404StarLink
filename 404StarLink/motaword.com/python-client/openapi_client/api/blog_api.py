...
class BlogApi:
    ...
    def get_blog_posts(
        self,
        locale: Annotated[Optional[StrictStr], Field(description="Article language, default `en`. When no blog article is available and `fallback=true` is specified, it falls back to `en`.")] = None,
        fallback: Annotated[Optional[StrictBool], Field(description="When `true`, and no article is found in the locale, it falls back to `locale=en`.")] = None,
