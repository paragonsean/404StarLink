...
<a id="driveGroupsAdd"></a>
# **driveGroupsAdd**
> CreateDriveGroupResponse driveGroupsAdd(xApideckConsumerId, xApideckAppId, driveGroup, raw, xApideckServiceId)
...
<a id="driveGroupsAll"></a>
# **driveGroupsAll**
> GetDriveGroupsResponse driveGroupsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    DriveGroupsFilter filter = new DriveGroupsFilter(); // DriveGroupsFilter | Apply filters
    ...
    try {
      GetDriveGroupsResponse result = apiInstance.driveGroupsAll(xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, cursor, limit, filter, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DriveGroupsApi#driveGroupsAll");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="driveGroupsDelete"></a>
# **driveGroupsDelete**
> DeleteDriveGroupResponse driveGroupsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      DeleteDriveGroupResponse result = apiInstance.driveGroupsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DriveGroupsApi#driveGroupsDelete");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="driveGroupsOne"></a>
# **driveGroupsOne**
> GetDriveGroupResponse driveGroupsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields)
...
public class Example {
  public static void main(String[] args) {
    ...
    String fields = "id,updated_at"; // String | The 'fields' parameter allows API users to specify the fields they want to include in the API response. If this parameter is not present, the API will return all available fields. If this parameter is present, only the fields specified in the comma-separated string will be included in the response. Nested properties can also be requested by using a dot notation. <br /><br />Example: `fields=name,email,addresses.city`<br /><br />In the example above, the response will only include the fields \"name\", \"email\" and \"addresses.city\". If any other fields are available, they will be excluded.
    try {
      GetDriveGroupResponse result = apiInstance.driveGroupsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DriveGroupsApi#driveGroupsOne");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="driveGroupsUpdate"></a>
# **driveGroupsUpdate**
> UpdateDriveGroupResponse driveGroupsUpdate(id, xApideckConsumerId, xApideckAppId, driveGroup, xApideckServiceId, raw)
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean raw = false; // Boolean | Include raw response. Mostly used for debugging purposes
    try {
      UpdateDriveGroupResponse result = apiInstance.driveGroupsUpdate(id, xApideckConsumerId, xApideckAppId, driveGroup, xApideckServiceId, raw);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DriveGroupsApi#driveGroupsUpdate");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
