...
/**
 * API tests for UploadSessionsApi
 */
@Disabled
public class UploadSessionsApiTest {

    private final UploadSessionsApi api = new UploadSessionsApi();
     ...
     */
    @Test
    public void uploadSessionsAddTest() throws ApiException {
        ...
        CreateUploadSessionResponse response = api.uploadSessionsAdd(xApideckConsumerId, xApideckAppId, createUploadSessionRequest, raw, xApideckServiceId);
     ...
     */
    @Test
    public void uploadSessionsDeleteTest() throws ApiException {
        String id = null;
        String xApideckConsumerId = null;
        String xApideckAppId = null;
        String xApideckServiceId = null;
        Boolean raw = null;
        DeleteUploadSessionResponse response = api.uploadSessionsDelete(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void uploadSessionsFinishTest() throws ApiException {
        String id = null;
        String xApideckConsumerId = null;
        String xApideckAppId = null;
        Boolean raw = null;
        ...
        String digest = null;
        Object body = null;
        GetFileResponse response = api.uploadSessionsFinish(id, xApideckConsumerId, xApideckAppId, raw, xApideckServiceId, digest, body);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void uploadSessionsOneTest() throws ApiException {
        String id = null;
        String xApideckConsumerId = null;
        String xApideckAppId = null;
        String xApideckServiceId = null;
        Boolean raw = null;
        String fields = null;
        GetUploadSessionResponse response = api.uploadSessionsOne(id, xApideckConsumerId, xApideckAppId, xApideckServiceId, raw, fields);
        // TODO: test validations
    }
     ...
     */
    @Test
    public void uploadSessionsUploadTest() throws ApiException {
        String id = null;
        String xApideckConsumerId = null;
        String xApideckAppId = null;
        ...
        String digest = null;
        Boolean raw = null;
        UpdateUploadSessionResponse response = api.uploadSessionsUpload(id, xApideckConsumerId, xApideckAppId, partNumber, body, xApideckServiceId, digest, raw);
        // TODO: test validations
    }
