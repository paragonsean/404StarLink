...
public class BankAccountIdentificationValidationRequestAccountIdentification extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<BankAccountIdentificationValidationRequestAccountIdentification>() {
                ...
                public BankAccountIdentificationValidationRequestAccountIdentification read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for BankAccountIdentificationValidationRequestAccountIdentification: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public BankAccountIdentificationValidationRequestAccountIdentification(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to BankAccountIdentificationValidationRequestAccountIdentification
     */
