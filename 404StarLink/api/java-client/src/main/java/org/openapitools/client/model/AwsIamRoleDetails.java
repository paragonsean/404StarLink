...
public class AwsIamRoleDetails {
  ...
  public AwsIamRoleDetails assumeRolePolicyDocument(String assumeRolePolicyDocument) {
  ...
  public AwsIamRoleDetails attachedManagedPolicies(List attachedManagedPolicies) {
  ...
  public AwsIamRoleDetails createDate(String createDate) {
  ...
  public AwsIamRoleDetails instanceProfileList(List instanceProfileList) {
  ...
  public AwsIamRoleDetails permissionsBoundary(AwsIamPermissionsBoundary permissionsBoundary) {
  ...
  public AwsIamRoleDetails roleId(String roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  public AwsIamRoleDetails roleName(String roleName) {
  ...
  public AwsIamRoleDetails rolePolicyList(List rolePolicyList) {
  ...
  public AwsIamRoleDetails maxSessionDuration(Integer maxSessionDuration) {
  ...
  public AwsIamRoleDetails path(String path) {
    this.path = path;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AwsIamRoleDetails awsIamRoleDetails = (AwsIamRoleDetails) o;
    return Objects.equals(this.assumeRolePolicyDocument, awsIamRoleDetails.assumeRolePolicyDocument) &&
        Objects.equals(this.attachedManagedPolicies, awsIamRoleDetails.attachedManagedPolicies) &&
        Objects.equals(this.createDate, awsIamRoleDetails.createDate) &&
        Objects.equals(this.instanceProfileList, awsIamRoleDetails.instanceProfileList) &&
        Objects.equals(this.permissionsBoundary, awsIamRoleDetails.permissionsBoundary) &&
        Objects.equals(this.roleId, awsIamRoleDetails.roleId) &&
        Objects.equals(this.roleName, awsIamRoleDetails.roleName) &&
        Objects.equals(this.rolePolicyList, awsIamRoleDetails.rolePolicyList) &&
        Objects.equals(this.maxSessionDuration, awsIamRoleDetails.maxSessionDuration) &&
        Objects.equals(this.path, awsIamRoleDetails.path);
  }
  ...
  public String toString() {
    ...
    sb.append("class AwsIamRoleDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AwsIamRoleDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AwsIamRoleDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AwsIamRoleDetails is not found in the empty JSON string", AwsIamRoleDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AwsIamRoleDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AwsIamRoleDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AwsIamRoleDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AwsIamRoleDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AwsIamRoleDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AwsIamRoleDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<AwsIamRoleDetails>() {
           @Override
           public void write(JsonWriter out, AwsIamRoleDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AwsIamRoleDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AwsIamRoleDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AwsIamRoleDetails
   * @throws IOException if the JSON string is invalid with respect to AwsIamRoleDetails
   */
  public static AwsIamRoleDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AwsIamRoleDetails.class);
  }

  /**
   * Convert an instance of AwsIamRoleDetails to an JSON string
   *
   * @return JSON string
   */
