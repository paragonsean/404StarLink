...
public class GetFindingAggregatorResponse {
  ...
  public GetFindingAggregatorResponse findingAggregatorArn(String findingAggregatorArn) {
  ...
  public GetFindingAggregatorResponse findingAggregationRegion(String findingAggregationRegion) {
  ...
  public GetFindingAggregatorResponse regionLinkingMode(String regionLinkingMode) {
  ...
  public GetFindingAggregatorResponse regions(List regions) {
  ...
  public boolean equals(Object o) {
    ...
    GetFindingAggregatorResponse getFindingAggregatorResponse = (GetFindingAggregatorResponse) o;
    return Objects.equals(this.findingAggregatorArn, getFindingAggregatorResponse.findingAggregatorArn) &&
        Objects.equals(this.findingAggregationRegion, getFindingAggregatorResponse.findingAggregationRegion) &&
        Objects.equals(this.regionLinkingMode, getFindingAggregatorResponse.regionLinkingMode) &&
        Objects.equals(this.regions, getFindingAggregatorResponse.regions);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFindingAggregatorResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetFindingAggregatorResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetFindingAggregatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFindingAggregatorResponse is not found in the empty JSON string", GetFindingAggregatorResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetFindingAggregatorResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFindingAggregatorResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFindingAggregatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFindingAggregatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFindingAggregatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFindingAggregatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFindingAggregatorResponse>() {
           @Override
           public void write(JsonWriter out, GetFindingAggregatorResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFindingAggregatorResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetFindingAggregatorResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetFindingAggregatorResponse
   * @throws IOException if the JSON string is invalid with respect to GetFindingAggregatorResponse
   */
  public static GetFindingAggregatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFindingAggregatorResponse.class);
  }

  /**
   * Convert an instance of GetFindingAggregatorResponse to an JSON string
   *
   * @return JSON string
   */
