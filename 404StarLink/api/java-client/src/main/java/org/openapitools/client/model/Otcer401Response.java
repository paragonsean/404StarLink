 ...
 * Otcer401Response
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-10-11T02:04:39.840634-04:00[America/New_York]", comments = "Generator version: 7.9.0")
public class Otcer401Response {
  /**
   * Gets or Sets error
   */
  ...
  public Otcer401Response() {
  }

  public Otcer401Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Otcer401Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Otcer401Response otcer401Response = (Otcer401Response) o;
    return Objects.equals(this.error, otcer401Response.error) &&
        Objects.equals(this.errorDescription, otcer401Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Otcer401Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Otcer401Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Otcer401Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Otcer401Response is not found in the empty JSON string", Otcer401Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Otcer401Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Otcer401Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Otcer401Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Otcer401Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Otcer401Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Otcer401Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Otcer401Response>() {
           @Override
           public void write(JsonWriter out, Otcer401Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Otcer401Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Otcer401Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Otcer401Response
   * @throws IOException if the JSON string is invalid with respect to Otcer401Response
   */
  public static Otcer401Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Otcer401Response.class);
  }

  /**
   * Convert an instance of Otcer401Response to an JSON string
   *
   * @return JSON string
   */
