...
public class Otcer400Response {
  ...
  public Otcer400Response() {
  }

  public Otcer400Response error(ErrorEnum error) {
    this.error = error;
    return this;
  }
  ...
  public Otcer400Response errorDescription(ErrorDescriptionEnum errorDescription) {
  ...
  public boolean equals(Object o) {
    ...
    Otcer400Response otcer400Response = (Otcer400Response) o;
    return Objects.equals(this.error, otcer400Response.error) &&
        Objects.equals(this.errorDescription, otcer400Response.errorDescription);
  }
  ...
  public String toString() {
    ...
    sb.append("class Otcer400Response {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Otcer400Response
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Otcer400Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Otcer400Response is not found in the empty JSON string", Otcer400Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Otcer400Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Otcer400Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Otcer400Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Otcer400Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Otcer400Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Otcer400Response.class));

       return (TypeAdapter<T>) new TypeAdapter<Otcer400Response>() {
           @Override
           public void write(JsonWriter out, Otcer400Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Otcer400Response read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Otcer400Response given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Otcer400Response
   * @throws IOException if the JSON string is invalid with respect to Otcer400Response
   */
  public static Otcer400Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Otcer400Response.class);
  }

  /**
   * Convert an instance of Otcer400Response to an JSON string
   *
   * @return JSON string
   */
