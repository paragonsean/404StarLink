...
public class ResourceDetailsAwsElbLoadBalancer {
  ...
  public ResourceDetailsAwsElbLoadBalancer() {
  }

  public ResourceDetailsAwsElbLoadBalancer availabilityZones(List availabilityZones) {
  ...
  public ResourceDetailsAwsElbLoadBalancer backendServerDescriptions(List backendServerDescriptions) {
  ...
  public ResourceDetailsAwsElbLoadBalancer canonicalHostedZoneName(String canonicalHostedZoneName) {
  ...
  public ResourceDetailsAwsElbLoadBalancer canonicalHostedZoneNameID(String canonicalHostedZoneNameID) {
  ...
  public ResourceDetailsAwsElbLoadBalancer createdTime(String createdTime) {
  ...
  public ResourceDetailsAwsElbLoadBalancer dnsName(String dnsName) {
  ...
  public ResourceDetailsAwsElbLoadBalancer healthCheck(AwsElbLoadBalancerDetailsHealthCheck healthCheck) {
  ...
  public ResourceDetailsAwsElbLoadBalancer instances(List instances) {
  ...
  public ResourceDetailsAwsElbLoadBalancer listenerDescriptions(List listenerDescriptions) {
  ...
  public ResourceDetailsAwsElbLoadBalancer loadBalancerAttributes(AwsElbLoadBalancerDetailsLoadBalancerAttributes loadBalancerAttributes) {
  ...
  public ResourceDetailsAwsElbLoadBalancer loadBalancerName(String loadBalancerName) {
  ...
  public ResourceDetailsAwsElbLoadBalancer policies(AwsElbLoadBalancerDetailsPolicies policies) {
  ...
  public ResourceDetailsAwsElbLoadBalancer scheme(String scheme) {
    this.scheme = scheme;
    return this;
  }
  ...
  public ResourceDetailsAwsElbLoadBalancer securityGroups(List securityGroups) {
  ...
  public ResourceDetailsAwsElbLoadBalancer sourceSecurityGroup(AwsElbLoadBalancerDetailsSourceSecurityGroup sourceSecurityGroup) {
  ...
  public ResourceDetailsAwsElbLoadBalancer subnets(List subnets) {
  ...
  public ResourceDetailsAwsElbLoadBalancer vpcId(String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResourceDetailsAwsElbLoadBalancer resourceDetailsAwsElbLoadBalancer = (ResourceDetailsAwsElbLoadBalancer) o;
    return Objects.equals(this.availabilityZones, resourceDetailsAwsElbLoadBalancer.availabilityZones) &&
        Objects.equals(this.backendServerDescriptions, resourceDetailsAwsElbLoadBalancer.backendServerDescriptions) &&
        Objects.equals(this.canonicalHostedZoneName, resourceDetailsAwsElbLoadBalancer.canonicalHostedZoneName) &&
        Objects.equals(this.canonicalHostedZoneNameID, resourceDetailsAwsElbLoadBalancer.canonicalHostedZoneNameID) &&
        Objects.equals(this.createdTime, resourceDetailsAwsElbLoadBalancer.createdTime) &&
        Objects.equals(this.dnsName, resourceDetailsAwsElbLoadBalancer.dnsName) &&
        Objects.equals(this.healthCheck, resourceDetailsAwsElbLoadBalancer.healthCheck) &&
        Objects.equals(this.instances, resourceDetailsAwsElbLoadBalancer.instances) &&
        Objects.equals(this.listenerDescriptions, resourceDetailsAwsElbLoadBalancer.listenerDescriptions) &&
        Objects.equals(this.loadBalancerAttributes, resourceDetailsAwsElbLoadBalancer.loadBalancerAttributes) &&
        Objects.equals(this.loadBalancerName, resourceDetailsAwsElbLoadBalancer.loadBalancerName) &&
        Objects.equals(this.policies, resourceDetailsAwsElbLoadBalancer.policies) &&
        Objects.equals(this.scheme, resourceDetailsAwsElbLoadBalancer.scheme) &&
        Objects.equals(this.securityGroups, resourceDetailsAwsElbLoadBalancer.securityGroups) &&
        Objects.equals(this.sourceSecurityGroup, resourceDetailsAwsElbLoadBalancer.sourceSecurityGroup) &&
        Objects.equals(this.subnets, resourceDetailsAwsElbLoadBalancer.subnets) &&
        Objects.equals(this.vpcId, resourceDetailsAwsElbLoadBalancer.vpcId);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceDetailsAwsElbLoadBalancer {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResourceDetailsAwsElbLoadBalancer
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceDetailsAwsElbLoadBalancer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceDetailsAwsElbLoadBalancer is not found in the empty JSON string", ResourceDetailsAwsElbLoadBalancer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ResourceDetailsAwsElbLoadBalancer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResourceDetailsAwsElbLoadBalancer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResourceDetailsAwsElbLoadBalancer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResourceDetailsAwsElbLoadBalancer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResourceDetailsAwsElbLoadBalancer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResourceDetailsAwsElbLoadBalancer.class));

       return (TypeAdapter<T>) new TypeAdapter<ResourceDetailsAwsElbLoadBalancer>() {
           @Override
           public void write(JsonWriter out, ResourceDetailsAwsElbLoadBalancer value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ResourceDetailsAwsElbLoadBalancer read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ResourceDetailsAwsElbLoadBalancer given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ResourceDetailsAwsElbLoadBalancer
   * @throws IOException if the JSON string is invalid with respect to ResourceDetailsAwsElbLoadBalancer
   */
  public static ResourceDetailsAwsElbLoadBalancer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ResourceDetailsAwsElbLoadBalancer.class);
  }

  /**
   * Convert an instance of ResourceDetailsAwsElbLoadBalancer to an JSON string
   *
   * @return JSON string
   */
