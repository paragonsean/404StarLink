...
public class CustomFieldInputModel {
  ...
  public CustomFieldInputModel field1(String field1) {
    this.field1 = field1;
    return this;
  }
  ...
  public CustomFieldInputModel field10(String field10) {
  ...
  public CustomFieldInputModel field2(String field2) {
    this.field2 = field2;
    return this;
  }
  ...
  public CustomFieldInputModel field3(String field3) {
    this.field3 = field3;
    return this;
  }
  ...
  public CustomFieldInputModel field4(String field4) {
    this.field4 = field4;
    return this;
  }
  ...
  public CustomFieldInputModel field5(String field5) {
    this.field5 = field5;
    return this;
  }
  ...
  public CustomFieldInputModel field6(String field6) {
    this.field6 = field6;
    return this;
  }
  ...
  public CustomFieldInputModel field7(String field7) {
    this.field7 = field7;
    return this;
  }
  ...
  public CustomFieldInputModel field8(String field8) {
    this.field8 = field8;
    return this;
  }
  ...
  public CustomFieldInputModel field9(String field9) {
    this.field9 = field9;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CustomFieldInputModel customFieldInputModel = (CustomFieldInputModel) o;
    return Objects.equals(this.field1, customFieldInputModel.field1) &&
        Objects.equals(this.field10, customFieldInputModel.field10) &&
        Objects.equals(this.field2, customFieldInputModel.field2) &&
        Objects.equals(this.field3, customFieldInputModel.field3) &&
        Objects.equals(this.field4, customFieldInputModel.field4) &&
        Objects.equals(this.field5, customFieldInputModel.field5) &&
        Objects.equals(this.field6, customFieldInputModel.field6) &&
        Objects.equals(this.field7, customFieldInputModel.field7) &&
        Objects.equals(this.field8, customFieldInputModel.field8) &&
        Objects.equals(this.field9, customFieldInputModel.field9);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomFieldInputModel {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomFieldInputModel
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomFieldInputModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomFieldInputModel is not found in the empty JSON string", CustomFieldInputModel.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CustomFieldInputModel.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomFieldInputModel` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomFieldInputModel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomFieldInputModel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomFieldInputModel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomFieldInputModel.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomFieldInputModel>() {
           @Override
           public void write(JsonWriter out, CustomFieldInputModel value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CustomFieldInputModel read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CustomFieldInputModel given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CustomFieldInputModel
   * @throws IOException if the JSON string is invalid with respect to CustomFieldInputModel
   */
  public static CustomFieldInputModel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomFieldInputModel.class);
  }

  /**
   * Convert an instance of CustomFieldInputModel to an JSON string
   *
   * @return JSON string
   */
