...
public class HPOConfigAlgorithmHyperParameterRanges {
  ...
  public HPOConfigAlgorithmHyperParameterRanges() {
  }

  public HPOConfigAlgorithmHyperParameterRanges integerHyperParameterRanges(List integerHyperParameterRanges) {
  ...
  public HPOConfigAlgorithmHyperParameterRanges continuousHyperParameterRanges(List continuousHyperParameterRanges) {
  ...
  public HPOConfigAlgorithmHyperParameterRanges categoricalHyperParameterRanges(List categoricalHyperParameterRanges) {
  ...
  public boolean equals(Object o) {
    ...
    HPOConfigAlgorithmHyperParameterRanges hpOConfigAlgorithmHyperParameterRanges = (HPOConfigAlgorithmHyperParameterRanges) o;
    return Objects.equals(this.integerHyperParameterRanges, hpOConfigAlgorithmHyperParameterRanges.integerHyperParameterRanges) &&
        Objects.equals(this.continuousHyperParameterRanges, hpOConfigAlgorithmHyperParameterRanges.continuousHyperParameterRanges) &&
        Objects.equals(this.categoricalHyperParameterRanges, hpOConfigAlgorithmHyperParameterRanges.categoricalHyperParameterRanges);
  }
  ...
  public String toString() {
    ...
    sb.append("class HPOConfigAlgorithmHyperParameterRanges {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to HPOConfigAlgorithmHyperParameterRanges
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HPOConfigAlgorithmHyperParameterRanges.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HPOConfigAlgorithmHyperParameterRanges is not found in the empty JSON string", HPOConfigAlgorithmHyperParameterRanges.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HPOConfigAlgorithmHyperParameterRanges.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HPOConfigAlgorithmHyperParameterRanges` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HPOConfigAlgorithmHyperParameterRanges.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HPOConfigAlgorithmHyperParameterRanges' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HPOConfigAlgorithmHyperParameterRanges> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HPOConfigAlgorithmHyperParameterRanges.class));

       return (TypeAdapter<T>) new TypeAdapter<HPOConfigAlgorithmHyperParameterRanges>() {
           @Override
           public void write(JsonWriter out, HPOConfigAlgorithmHyperParameterRanges value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public HPOConfigAlgorithmHyperParameterRanges read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of HPOConfigAlgorithmHyperParameterRanges given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of HPOConfigAlgorithmHyperParameterRanges
   * @throws IOException if the JSON string is invalid with respect to HPOConfigAlgorithmHyperParameterRanges
   */
  public static HPOConfigAlgorithmHyperParameterRanges fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HPOConfigAlgorithmHyperParameterRanges.class);
  }

  /**
   * Convert an instance of HPOConfigAlgorithmHyperParameterRanges to an JSON string
   *
   * @return JSON string
   */
