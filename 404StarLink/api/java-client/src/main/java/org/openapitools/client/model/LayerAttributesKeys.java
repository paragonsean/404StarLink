...
/**
 * Gets or Sets LayerAttributesKeys
 */
@JsonAdapter(LayerAttributesKeys.Adapter.class)
public enum LayerAttributesKeys {
  ...
  LayerAttributesKeys(String value) {
    this.value = value;
  }
  ...
  public static LayerAttributesKeys fromValue(String value) {
    for (LayerAttributesKeys b : LayerAttributesKeys.values()) {
  ...
  public static class Adapter extends TypeAdapter<LayerAttributesKeys> {
    @Override
    public void write(final JsonWriter jsonWriter, final LayerAttributesKeys enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LayerAttributesKeys read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LayerAttributesKeys.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LayerAttributesKeys.fromValue(value);
  }
}
