...
class Integration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["client_id", "client_secret", "created_at", "description", "events", "external_url", "html_url", "id", "installations_count", "name", "node_id", "owner", "pem", "permissions", "slug", "updated_at", "webhook_secret"]
