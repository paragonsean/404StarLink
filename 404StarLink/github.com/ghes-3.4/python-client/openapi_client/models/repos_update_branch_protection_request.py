...
class ReposUpdateBranchProtectionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allow_deletions", "allow_force_pushes", "block_creations", "enforce_admins", "required_conversation_resolution", "required_linear_history", "required_pull_request_reviews", "required_status_checks", "restrictions"]
