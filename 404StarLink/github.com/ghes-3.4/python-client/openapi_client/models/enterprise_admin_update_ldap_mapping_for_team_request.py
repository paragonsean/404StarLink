...
class EnterpriseAdminUpdateLdapMappingForTeamRequest(BaseModel):
    """
    EnterpriseAdminUpdateLdapMappingForTeamRequest
    """ # noqa: E501
    ldap_dn: StrictStr = Field(description="The [distinguished name](https://www.ldap.com/ldap-dns-and-rdns) (DN) of the LDAP entry to map to a team.")
    __properties: ClassVar[List[str]] = ["ldap_dn"]
