...
class Environment(BaseModel):
    ...
    node_id: StrictStr
    protection_rules: Optional[List[EnvironmentProtectionRulesInner]] = None
    updated_at: datetime = Field(description="The time that the environment was last updated, in ISO 8601 format.")
    url: StrictStr
    __properties: ClassVar[List[str]] = ["created_at", "deployment_branch_policy", "html_url", "id", "name", "node_id", "protection_rules", "updated_at", "url"]
