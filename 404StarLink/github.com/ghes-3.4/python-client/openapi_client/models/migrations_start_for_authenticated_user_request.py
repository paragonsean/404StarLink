...
class MigrationsStartForAuthenticatedUserRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["exclude", "exclude_attachments", "exclude_git_data", "exclude_metadata", "exclude_owner_projects", "exclude_releases", "lock_repositories", "org_metadata_only", "repositories"]
