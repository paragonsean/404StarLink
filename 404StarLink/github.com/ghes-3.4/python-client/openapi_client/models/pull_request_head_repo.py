...
class PullRequestHeadRepo(BaseModel):
    """
    PullRequestHeadRepo
    """ # noqa: E501
    ...
    license: Optional[PullRequestHeadRepoLicense]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "license": PullRequestHeadRepoLicense.from_dict(obj["license"]) if obj.get("license") is not None else None,
