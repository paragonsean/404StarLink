...
class EnterpriseAdminUpdateSelfHostedRunnerGroupForEnterpriseRequest(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Name of the runner group.")
    visibility: Optional[StrictStr] = Field(default='all', description="Visibility of a runner group. You can select all organizations or select individual organizations.")
    __properties: ClassVar[List[str]] = ["allows_public_repositories", "name", "visibility"]
