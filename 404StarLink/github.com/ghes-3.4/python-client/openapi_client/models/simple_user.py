...
class SimpleUser(BaseModel):
    ...
    type: StrictStr
    url: StrictStr
    __properties: ClassVar[List[str]] = ["avatar_url", "email", "events_url", "followers_url", "following_url", "gists_url", "gravatar_id", "html_url", "id", "login", "name", "node_id", "organizations_url", "received_events_url", "repos_url", "site_admin", "starred_at", "starred_url", "subscriptions_url", "type", "url"]
