...
class TestPullRequestBaseRepo(unittest.TestCase):
    """PullRequestBaseRepo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PullRequestBaseRepo:
        """Test PullRequestBaseRepo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PullRequestBaseRepo`
        """
        model = PullRequestBaseRepo()
        if include_optional:
    ...
    def testPullRequestBaseRepo(self):
        """Test PullRequestBaseRepo"""
