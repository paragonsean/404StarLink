...
class TestEnterpriseSettingsEnterprise(unittest.TestCase):
    """EnterpriseSettingsEnterprise unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnterpriseSettingsEnterprise:
        """Test EnterpriseSettingsEnterprise
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnterpriseSettingsEnterprise`
        """
        model = EnterpriseSettingsEnterprise()
        if include_optional:
    ...
    def testEnterpriseSettingsEnterprise(self):
        """Test EnterpriseSettingsEnterprise"""
