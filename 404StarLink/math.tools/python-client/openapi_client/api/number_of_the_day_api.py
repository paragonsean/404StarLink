...
class NumberOfTheDayApi:
    ...
    def numbers_nod_get(
        ...
        _param = self._numbers_nod_get_serialize(
    ...
    @validate_call
    def numbers_nod_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def numbers_nod_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _numbers_nod_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
