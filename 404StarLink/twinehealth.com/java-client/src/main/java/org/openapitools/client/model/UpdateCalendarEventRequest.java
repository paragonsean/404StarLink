...
import org.openapitools.client.model.UpdateCalendarEventRequestData;
...
public class UpdateCalendarEventRequest {
  ...
  private UpdateCalendarEventRequestData data;

  public UpdateCalendarEventRequest() {
  }

  public UpdateCalendarEventRequest data(UpdateCalendarEventRequestData data) {
    this.data = data;
    return this;
  }
  ...
  public UpdateCalendarEventRequestData getData() {
    return data;
  }

  public void setData(UpdateCalendarEventRequestData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, updateCalendarEventRequest.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCalendarEventRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateCalendarEventRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `data`
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        UpdateCalendarEventRequestData.validateJsonElement(jsonObj.get("data"));
      }
  }
