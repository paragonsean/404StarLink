...
class HooksGet200Response(BaseModel):
    """
    HooksGet200Response
    """ # noqa: E501
    hooks: Optional[List[HooksGet200ResponseHooksInner]] = None
    success: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["hooks", "success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hooks": [HooksGet200ResponseHooksInner.from_dict(_item) for _item in obj["hooks"]] if obj.get("hooks") is not None else None,
