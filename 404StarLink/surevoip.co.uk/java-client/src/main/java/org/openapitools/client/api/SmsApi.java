...
public class SmsApi {
     ...
     */
    public okhttp3.Call smsGetCall(final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call smsGetValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        return smsGetCall(_callback);
     ...
     */
    public void smsGet() throws ApiException {
        smsGetWithHttpInfo();
    }
     ...
     */
    public ApiResponse<Void> smsGetWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = smsGetValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call smsGetAsync(final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = smsGetValidateBeforeCall(_callback);
