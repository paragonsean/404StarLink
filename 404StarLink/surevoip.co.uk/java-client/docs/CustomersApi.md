...
|------------- | ------------- | -------------|
| [**customersGet**](CustomersApi.md#customersGet) | **GET** /customers | List all customers or find your own account |
| [**getCustomer**](CustomersApi.md#getCustomer) | **GET** /customers/{account} | Represents a customer |
...
|-------------|-------------|------------------|
| **302** | Found |  * Location - URL of customer account <br>  |

<a id="getCustomer"></a>
# **getCustomer**
> GetCustomer200Response getCustomer(account)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetCustomer200Response result = apiInstance.getCustomer(account);
