...
class Paginator(BaseModel):
    ...
    """ # noqa: E501
    next_page_selector: Optional[StrictStr] = Field(default=None, alias="nextPageSelector")
    page_num: Optional[StrictInt] = Field(default=None, alias="pageNum")
    __properties: ClassVar[List[str]] = ["nextPageSelector", "pageNum"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nextPageSelector": obj.get("nextPageSelector"),
