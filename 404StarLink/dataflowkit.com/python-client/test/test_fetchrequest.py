...
class TestFetchrequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Fetchrequest:
        """Test Fetchrequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Fetchrequest`
        """
        model = Fetchrequest()
        if include_optional:
            return Fetchrequest(
