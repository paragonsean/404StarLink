...
public class MessageAttemptOut {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endpointId, messageAttemptOut.endpointId) &&
        Objects.equals(this.id, messageAttemptOut.id) &&
        ...
        Objects.equals(this.url, messageAttemptOut.url);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MessageAttemptOut
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MessageAttemptOut.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MessageAttemptOut.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MessageAttemptOut` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
