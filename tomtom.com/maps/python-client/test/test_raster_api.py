...
class TestRasterApi(unittest.TestCase):
    ...
    def test_map_version_number_staticimage_get(self) -> None:
    ...
    def test_map_version_number_tile_layer_style_zoom_xy_format_get(self) -> None:
