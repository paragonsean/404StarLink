...
public class ApiClient {
    ...
    private String basePath = "https://sts.amazonaws.com";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2011-06-15/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sts.amazonaws.com
