...
public class GifImagesDownsizedSmall {
  ...
  public GifImagesDownsizedSmall() {
  }

  public GifImagesDownsizedSmall frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesDownsizedSmall height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesDownsizedSmall mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesDownsizedSmall mp4Size(String mp4Size) {
  ...
  public GifImagesDownsizedSmall size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesDownsizedSmall url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesDownsizedSmall webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesDownsizedSmall webpSize(String webpSize) {
  ...
  public GifImagesDownsizedSmall width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesDownsizedSmall gifImagesDownsizedSmall = (GifImagesDownsizedSmall) o;
    return Objects.equals(this.frames, gifImagesDownsizedSmall.frames) &&
        Objects.equals(this.height, gifImagesDownsizedSmall.height) &&
        Objects.equals(this.mp4, gifImagesDownsizedSmall.mp4) &&
        Objects.equals(this.mp4Size, gifImagesDownsizedSmall.mp4Size) &&
        Objects.equals(this.size, gifImagesDownsizedSmall.size) &&
        Objects.equals(this.url, gifImagesDownsizedSmall.url) &&
        Objects.equals(this.webp, gifImagesDownsizedSmall.webp) &&
        Objects.equals(this.webpSize, gifImagesDownsizedSmall.webpSize) &&
        Objects.equals(this.width, gifImagesDownsizedSmall.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesDownsizedSmall {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesDownsizedSmall
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesDownsizedSmall.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesDownsizedSmall is not found in the empty JSON string", GifImagesDownsizedSmall.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesDownsizedSmall.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesDownsizedSmall` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesDownsizedSmall.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesDownsizedSmall' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesDownsizedSmall> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesDownsizedSmall.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesDownsizedSmall>() {
           @Override
           public void write(JsonWriter out, GifImagesDownsizedSmall value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesDownsizedSmall read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesDownsizedSmall given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesDownsizedSmall
   * @throws IOException if the JSON string is invalid with respect to GifImagesDownsizedSmall
   */
  public static GifImagesDownsizedSmall fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesDownsizedSmall.class);
  }

  /**
   * Convert an instance of GifImagesDownsizedSmall to an JSON string
   *
   * @return JSON string
   */
