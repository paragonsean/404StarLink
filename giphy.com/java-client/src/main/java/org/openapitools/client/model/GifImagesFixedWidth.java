...
public class GifImagesFixedWidth {
  ...
  public GifImagesFixedWidth() {
  }

  public GifImagesFixedWidth frames(String frames) {
    this.frames = frames;
    return this;
  }
  ...
  public GifImagesFixedWidth height(String height) {
    this.height = height;
    return this;
  }
  ...
  public GifImagesFixedWidth mp4(String mp4) {
    this.mp4 = mp4;
    return this;
  }
  ...
  public GifImagesFixedWidth mp4Size(String mp4Size) {
  ...
  public GifImagesFixedWidth size(String size) {
    this.size = size;
    return this;
  }
  ...
  public GifImagesFixedWidth url(String url) {
    this.url = url;
    return this;
  }
  ...
  public GifImagesFixedWidth webp(String webp) {
    this.webp = webp;
    return this;
  }
  ...
  public GifImagesFixedWidth webpSize(String webpSize) {
  ...
  public GifImagesFixedWidth width(String width) {
    this.width = width;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GifImagesFixedWidth gifImagesFixedWidth = (GifImagesFixedWidth) o;
    return Objects.equals(this.frames, gifImagesFixedWidth.frames) &&
        Objects.equals(this.height, gifImagesFixedWidth.height) &&
        Objects.equals(this.mp4, gifImagesFixedWidth.mp4) &&
        Objects.equals(this.mp4Size, gifImagesFixedWidth.mp4Size) &&
        Objects.equals(this.size, gifImagesFixedWidth.size) &&
        Objects.equals(this.url, gifImagesFixedWidth.url) &&
        Objects.equals(this.webp, gifImagesFixedWidth.webp) &&
        Objects.equals(this.webpSize, gifImagesFixedWidth.webpSize) &&
        Objects.equals(this.width, gifImagesFixedWidth.width);
  }
  ...
  public String toString() {
    ...
    sb.append("class GifImagesFixedWidth {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GifImagesFixedWidth
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GifImagesFixedWidth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GifImagesFixedWidth is not found in the empty JSON string", GifImagesFixedWidth.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GifImagesFixedWidth.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GifImagesFixedWidth` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GifImagesFixedWidth.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GifImagesFixedWidth' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GifImagesFixedWidth> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GifImagesFixedWidth.class));

       return (TypeAdapter<T>) new TypeAdapter<GifImagesFixedWidth>() {
           @Override
           public void write(JsonWriter out, GifImagesFixedWidth value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GifImagesFixedWidth read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GifImagesFixedWidth given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GifImagesFixedWidth
   * @throws IOException if the JSON string is invalid with respect to GifImagesFixedWidth
   */
  public static GifImagesFixedWidth fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GifImagesFixedWidth.class);
  }

  /**
   * Convert an instance of GifImagesFixedWidth to an JSON string
   *
   * @return JSON string
   */
