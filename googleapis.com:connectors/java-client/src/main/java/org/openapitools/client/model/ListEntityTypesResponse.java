...
public class ListEntityTypesResponse {
  ...
  public ListEntityTypesResponse nextPageToken(String nextPageToken) {
  ...
  public ListEntityTypesResponse types(List<EntityType> types) {
    this.types = types;
    return this;
  }
  ...
  public ListEntityTypesResponse unsupportedTypeNames(List<String> unsupportedTypeNames) {
  ...
  public void setUnsupportedTypeNames(List<String> unsupportedTypeNames) {
    this.unsupportedTypeNames = unsupportedTypeNames;
  }
  ...
  static {
    ...
    openapiFields.add("unsupportedTypeNames");
