...
public class SourceConnectionDetailLastSync {
  ...
  public SourceConnectionDetailLastSync() {
  }

  public SourceConnectionDetailLastSync lastSyncTime(OffsetDateTime lastSyncTime) {
  ...
  public SourceConnectionDetailLastSync lastSyncStatus(LastSyncStatus lastSyncStatus) {
  ...
  public SourceConnectionDetailLastSync lastSyncStatusMessage(String lastSyncStatusMessage) {
  ...
  public SourceConnectionDetailLastSync lastSuccessfulSyncTime(OffsetDateTime lastSuccessfulSyncTime) {
  ...
  public SourceConnectionDetailLastSync lastSuccessfulSyncProvisioningArtifactId(String lastSuccessfulSyncProvisioningArtifactId) {
  ...
  public boolean equals(Object o) {
    ...
    SourceConnectionDetailLastSync sourceConnectionDetailLastSync = (SourceConnectionDetailLastSync) o;
    return Objects.equals(this.lastSyncTime, sourceConnectionDetailLastSync.lastSyncTime) &&
        Objects.equals(this.lastSyncStatus, sourceConnectionDetailLastSync.lastSyncStatus) &&
        Objects.equals(this.lastSyncStatusMessage, sourceConnectionDetailLastSync.lastSyncStatusMessage) &&
        Objects.equals(this.lastSuccessfulSyncTime, sourceConnectionDetailLastSync.lastSuccessfulSyncTime) &&
        Objects.equals(this.lastSuccessfulSyncProvisioningArtifactId, sourceConnectionDetailLastSync.lastSuccessfulSyncProvisioningArtifactId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SourceConnectionDetailLastSync {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SourceConnectionDetailLastSync
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SourceConnectionDetailLastSync.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SourceConnectionDetailLastSync is not found in the empty JSON string", SourceConnectionDetailLastSync.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SourceConnectionDetailLastSync.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SourceConnectionDetailLastSync` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SourceConnectionDetailLastSync.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SourceConnectionDetailLastSync' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SourceConnectionDetailLastSync> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SourceConnectionDetailLastSync.class));

       return (TypeAdapter<T>) new TypeAdapter<SourceConnectionDetailLastSync>() {
           @Override
           public void write(JsonWriter out, SourceConnectionDetailLastSync value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SourceConnectionDetailLastSync read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SourceConnectionDetailLastSync given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SourceConnectionDetailLastSync
   * @throws IOException if the JSON string is invalid with respect to SourceConnectionDetailLastSync
   */
  public static SourceConnectionDetailLastSync fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SourceConnectionDetailLastSync.class);
  }

  /**
   * Convert an instance of SourceConnectionDetailLastSync to an JSON string
   *
   * @return JSON string
   */
