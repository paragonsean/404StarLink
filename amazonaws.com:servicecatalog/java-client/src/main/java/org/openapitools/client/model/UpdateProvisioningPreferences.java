...
public class UpdateProvisioningPreferences {
  ...
  public UpdateProvisioningPreferences stackSetAccounts(List stackSetAccounts) {
  ...
  public UpdateProvisioningPreferences stackSetRegions(List stackSetRegions) {
  ...
  public UpdateProvisioningPreferences stackSetFailureToleranceCount(Integer stackSetFailureToleranceCount) {
  ...
  public UpdateProvisioningPreferences stackSetFailureTolerancePercentage(Integer stackSetFailureTolerancePercentage) {
  ...
  public UpdateProvisioningPreferences stackSetMaxConcurrencyCount(Integer stackSetMaxConcurrencyCount) {
  ...
  public UpdateProvisioningPreferences stackSetMaxConcurrencyPercentage(Integer stackSetMaxConcurrencyPercentage) {
  ...
  public UpdateProvisioningPreferences stackSetOperationType(StackSetOperationType stackSetOperationType) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateProvisioningPreferences updateProvisioningPreferences = (UpdateProvisioningPreferences) o;
    return Objects.equals(this.stackSetAccounts, updateProvisioningPreferences.stackSetAccounts) &&
        Objects.equals(this.stackSetRegions, updateProvisioningPreferences.stackSetRegions) &&
        Objects.equals(this.stackSetFailureToleranceCount, updateProvisioningPreferences.stackSetFailureToleranceCount) &&
        Objects.equals(this.stackSetFailureTolerancePercentage, updateProvisioningPreferences.stackSetFailureTolerancePercentage) &&
        Objects.equals(this.stackSetMaxConcurrencyCount, updateProvisioningPreferences.stackSetMaxConcurrencyCount) &&
        Objects.equals(this.stackSetMaxConcurrencyPercentage, updateProvisioningPreferences.stackSetMaxConcurrencyPercentage) &&
        Objects.equals(this.stackSetOperationType, updateProvisioningPreferences.stackSetOperationType);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateProvisioningPreferences {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateProvisioningPreferences
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateProvisioningPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateProvisioningPreferences is not found in the empty JSON string", UpdateProvisioningPreferences.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateProvisioningPreferences.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateProvisioningPreferences` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateProvisioningPreferences.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateProvisioningPreferences' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateProvisioningPreferences> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateProvisioningPreferences.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateProvisioningPreferences>() {
           @Override
           public void write(JsonWriter out, UpdateProvisioningPreferences value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateProvisioningPreferences read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateProvisioningPreferences given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateProvisioningPreferences
   * @throws IOException if the JSON string is invalid with respect to UpdateProvisioningPreferences
   */
  public static UpdateProvisioningPreferences fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateProvisioningPreferences.class);
  }

  /**
   * Convert an instance of UpdateProvisioningPreferences to an JSON string
   *
   * @return JSON string
   */
