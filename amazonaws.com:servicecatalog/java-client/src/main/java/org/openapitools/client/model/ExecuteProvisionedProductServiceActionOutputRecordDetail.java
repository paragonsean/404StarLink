...
public class ExecuteProvisionedProductServiceActionOutputRecordDetail {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail() {
  }

  public ExecuteProvisionedProductServiceActionOutputRecordDetail recordId(String recordId) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail provisionedProductName(String provisionedProductName) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail status(RecordStatus status) {
    this.status = status;
    return this;
  }
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail createdTime(OffsetDateTime createdTime) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail updatedTime(OffsetDateTime updatedTime) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail provisionedProductType(String provisionedProductType) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail recordType(String recordType) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail provisionedProductId(String provisionedProductId) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail productId(String productId) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail provisioningArtifactId(String provisioningArtifactId) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail pathId(String pathId) {
    this.pathId = pathId;
    return this;
  }
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail recordErrors(List recordErrors) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail recordTags(List recordTags) {
  ...
  public ExecuteProvisionedProductServiceActionOutputRecordDetail launchRoleArn(String launchRoleArn) {
  ...
  public boolean equals(Object o) {
    ...
    ExecuteProvisionedProductServiceActionOutputRecordDetail executeProvisionedProductServiceActionOutputRecordDetail = (ExecuteProvisionedProductServiceActionOutputRecordDetail) o;
    return Objects.equals(this.recordId, executeProvisionedProductServiceActionOutputRecordDetail.recordId) &&
        Objects.equals(this.provisionedProductName, executeProvisionedProductServiceActionOutputRecordDetail.provisionedProductName) &&
        Objects.equals(this.status, executeProvisionedProductServiceActionOutputRecordDetail.status) &&
        Objects.equals(this.createdTime, executeProvisionedProductServiceActionOutputRecordDetail.createdTime) &&
        Objects.equals(this.updatedTime, executeProvisionedProductServiceActionOutputRecordDetail.updatedTime) &&
        Objects.equals(this.provisionedProductType, executeProvisionedProductServiceActionOutputRecordDetail.provisionedProductType) &&
        Objects.equals(this.recordType, executeProvisionedProductServiceActionOutputRecordDetail.recordType) &&
        Objects.equals(this.provisionedProductId, executeProvisionedProductServiceActionOutputRecordDetail.provisionedProductId) &&
        Objects.equals(this.productId, executeProvisionedProductServiceActionOutputRecordDetail.productId) &&
        Objects.equals(this.provisioningArtifactId, executeProvisionedProductServiceActionOutputRecordDetail.provisioningArtifactId) &&
        Objects.equals(this.pathId, executeProvisionedProductServiceActionOutputRecordDetail.pathId) &&
        Objects.equals(this.recordErrors, executeProvisionedProductServiceActionOutputRecordDetail.recordErrors) &&
        Objects.equals(this.recordTags, executeProvisionedProductServiceActionOutputRecordDetail.recordTags) &&
        Objects.equals(this.launchRoleArn, executeProvisionedProductServiceActionOutputRecordDetail.launchRoleArn);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExecuteProvisionedProductServiceActionOutputRecordDetail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExecuteProvisionedProductServiceActionOutputRecordDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExecuteProvisionedProductServiceActionOutputRecordDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExecuteProvisionedProductServiceActionOutputRecordDetail is not found in the empty JSON string", ExecuteProvisionedProductServiceActionOutputRecordDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExecuteProvisionedProductServiceActionOutputRecordDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExecuteProvisionedProductServiceActionOutputRecordDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExecuteProvisionedProductServiceActionOutputRecordDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExecuteProvisionedProductServiceActionOutputRecordDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExecuteProvisionedProductServiceActionOutputRecordDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExecuteProvisionedProductServiceActionOutputRecordDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<ExecuteProvisionedProductServiceActionOutputRecordDetail>() {
           @Override
           public void write(JsonWriter out, ExecuteProvisionedProductServiceActionOutputRecordDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExecuteProvisionedProductServiceActionOutputRecordDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExecuteProvisionedProductServiceActionOutputRecordDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExecuteProvisionedProductServiceActionOutputRecordDetail
   * @throws IOException if the JSON string is invalid with respect to ExecuteProvisionedProductServiceActionOutputRecordDetail
   */
  public static ExecuteProvisionedProductServiceActionOutputRecordDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExecuteProvisionedProductServiceActionOutputRecordDetail.class);
  }

  /**
   * Convert an instance of ExecuteProvisionedProductServiceActionOutputRecordDetail to an JSON string
   *
   * @return JSON string
   */
