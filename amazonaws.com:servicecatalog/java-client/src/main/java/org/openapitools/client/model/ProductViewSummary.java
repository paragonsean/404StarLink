...
public class ProductViewSummary {
  ...
  public ProductViewSummary id(String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductViewSummary productId(String productId) {
  ...
  public ProductViewSummary name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ProductViewSummary owner(String owner) {
    this.owner = owner;
    return this;
  }
  ...
  public ProductViewSummary shortDescription(String shortDescription) {
  ...
  public ProductViewSummary type(ProductType type) {
    this.type = type;
    return this;
  }
  ...
  public ProductViewSummary distributor(String distributor) {
  ...
  public ProductViewSummary hasDefaultPath(Boolean hasDefaultPath) {
  ...
  public ProductViewSummary supportEmail(String supportEmail) {
  ...
  public ProductViewSummary supportDescription(String supportDescription) {
  ...
  public ProductViewSummary supportUrl(String supportUrl) {
  ...
  public boolean equals(Object o) {
    ...
    ProductViewSummary productViewSummary = (ProductViewSummary) o;
    return Objects.equals(this.id, productViewSummary.id) &&
        Objects.equals(this.productId, productViewSummary.productId) &&
        Objects.equals(this.name, productViewSummary.name) &&
        Objects.equals(this.owner, productViewSummary.owner) &&
        Objects.equals(this.shortDescription, productViewSummary.shortDescription) &&
        Objects.equals(this.type, productViewSummary.type) &&
        Objects.equals(this.distributor, productViewSummary.distributor) &&
        Objects.equals(this.hasDefaultPath, productViewSummary.hasDefaultPath) &&
        Objects.equals(this.supportEmail, productViewSummary.supportEmail) &&
        Objects.equals(this.supportDescription, productViewSummary.supportDescription) &&
        Objects.equals(this.supportUrl, productViewSummary.supportUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductViewSummary {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ProductViewSummary
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductViewSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductViewSummary is not found in the empty JSON string", ProductViewSummary.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProductViewSummary.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProductViewSummary` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductViewSummary.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductViewSummary' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductViewSummary> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductViewSummary.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductViewSummary>() {
           @Override
           public void write(JsonWriter out, ProductViewSummary value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProductViewSummary read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ProductViewSummary given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ProductViewSummary
   * @throws IOException if the JSON string is invalid with respect to ProductViewSummary
   */
  public static ProductViewSummary fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductViewSummary.class);
  }

  /**
   * Convert an instance of ProductViewSummary to an JSON string
   *
   * @return JSON string
   */
