...
import org.openapitools.client.model.InToto;
...
public class Note {
  ...
  public Note attestationAuthority(Authority attestationAuthority) {
  ...
  public void setAttestationAuthority(Authority attestationAuthority) {
    this.attestationAuthority = attestationAuthority;
  }
  ...
  public Note intoto(InToto intoto) {
    this.intoto = intoto;
    return this;
  }
  ...
  public void setIntoto(InToto intoto) {
    this.intoto = intoto;
  }
  ...
  public Note vulnerability(Vulnerability vulnerability) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attestationAuthority, note.attestationAuthority) &&
        ...
        Objects.equals(this.intoto, note.intoto) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attestationAuthority, baseImage, build, createTime, deployable, discovery, expirationTime, intoto, kind, longDescription, name, _package, relatedNoteNames, relatedUrl, sbom, sbomReference, shortDescription, spdxFile, spdxPackage, spdxRelationship, updateTime, vulnerability, vulnerabilityAssessment);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attestationAuthority") != null && !jsonObj.get("attestationAuthority").isJsonNull()) {
        Authority.validateJsonElement(jsonObj.get("attestationAuthority"));
      }
      ...
      if (jsonObj.get("intoto") != null && !jsonObj.get("intoto").isJsonNull()) {
        InToto.validateJsonElement(jsonObj.get("intoto"));
      }
